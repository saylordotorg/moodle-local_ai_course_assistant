...
// This endpoint is authenticated by a bearer key compared with hash_equals(), not by a
// Moodle session, so require_login() would break the integration it exists for. Declared
// here as well as through NO_MOODLE_COOKIES so that every sessionless endpoint in this
// plugin states the same intent the same way, rather than two conventions a reviewer has
// to learn.
