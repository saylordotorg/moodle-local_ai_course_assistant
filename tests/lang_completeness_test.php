...
final class lang_completeness_test extends \basic_testcase {
    ...
    private const ADMIN_DIAGNOSTIC_UNTRANSLATED = [
        ...
        'privacy:metadata:bench:createdby',
        'privacy:metadata:models',
        'privacy:metadata:models:addedby',
        'privacy:metadata:pricesrc',
        'privacy:metadata:pricesrc:addedby',
        'privacy:metadata:sbx_assign',
        'privacy:metadata:sbx_assign:usermodified',
        'settings:soapbox_deprecated_inuse',
        'settings:soapbox_deprecated_off',
        'soapbox:assign_deprecated',
        ...
        'token_analytics:cat_authoring',
        'token_analytics:cat_essay',
        'token_analytics:cat_flashcards',
        'token_analytics:cat_insights',
        'token_analytics:cat_other',
        'token_analytics:cat_personalisation',
        'token_analytics:cat_premium_route',
        'token_analytics:cat_soapbox',
