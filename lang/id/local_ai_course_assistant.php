...
$string['settings:default_course_mode_desc'] = 'Mengontrol apakah [[tutorshort]] muncul pada kursus ketika tidak ada pilihan per-kursus yang dibuat. Instalasi baru secara default diatur ke "Dinonaktifkan secara default" sehingga admin dapat mengaktifkan per kursus dari halaman Analytics atau halaman Course AI Settings.';
...
$string['settings:auto_open_desc'] = 'Saat diaktifkan, laci [[tutorshort]] terbuka secara otomatis pertama kali siswa masuk ke setiap kursus. Pemuatan halaman berikutnya di kursus yang sama tidak membuka kembali laci — status dilacak per kursus di browser siswa melalui localStorage. Berlaku di desktop dan ponsel. Dapat ditimpa per kursus dari halaman Course AI Settings.';
...
$string['coursesettings:sola_enabled'] = '[[tutorshort]] di kursus ini';
$string['coursesettings:sola_enabled_toggle'] = 'Tampilkan widget [[tutorshort]] di kursus ini';
$string['coursesettings:sola_enabled_desc'] = 'Mengontrol apakah widget chat [[tutorshort]] muncul di kursus ini. Default seluruh situs diatur di pengaturan plugin di bawah General > Default for new courses.';
...
$string['chat:greeting'] = 'Halo, {$a}! Saya [[tutorshort]]. Bagaimana saya bisa membantu Anda hari ini?';
...
$string['chat:voice_speaking'] = '[[tutorshort]] sedang berbicara...';
$string['chat:voice_idle'] = 'Siap';
$string['chat:voice_error'] = 'Koneksi suara gagal. Periksa pengaturan Anda.';
$string['chat:quiz_locked'] = '[[tutorshort]] dijeda selama kuis untuk mendukung integritas akademik. Semoga berhasil!';
...
$string['settings:cdn_heading_desc'] = 'Sajikan aset frontend [[tutorshort]] (JS/CSS) dari CDN eksternal alih-alih sistem file Moodle. Ini memungkinkan pembaruan frontend tanpa peningkatan plugin. Biarkan URL CDN kosong untuk menggunakan file plugin lokal.';
...
$string['chat:voice_title'] = 'Bicara dengan [[tutorshort]]';
...
$string['mobile_welcome_sub'] = 'Saya [[tutorshort]], asisten belajar Anda. Bagaimana saya bisa membantu?';
...
$string['settings:rag_return_scope'] = 'Cakupan hasil pengambilan';
$string['settings:rag_return_scope_desc'] = 'Apa yang disisipkan untuk setiap hasil yang ditemukan. "chunk" (default) menyisipkan potongan ~400 kata yang cocok. "window" menyisipkan potongan yang cocok beserta potongan-potongan tetangga dari halaman yang sama. "page" menyisipkan seluruh halaman modul tempat kecocokan itu berada. window/page membantu ketika jawaban mencakup satu halaman penuh, dengan biaya prompt yang lebih besar.';
$string['settings:rag_window_size'] = 'Ukuran jendela pengambilan';
$string['settings:rag_window_size_desc'] = 'Untuk cakupan hasil "window": jumlah potongan tetangga yang disertakan di setiap sisi potongan yang cocok. Default 1.';
$string['settings:rag_parent_max_chars'] = 'Batas maksimum bagian induk (karakter)';
$string['settings:rag_parent_max_chars_desc'] = 'Jumlah karakter maksimum untuk bagian window/page yang diperluas. Halaman yang melebihi batas akan kembali ke window, lalu ke potongan tunggal. Default 6000.';
...
$string['demo:course_fullname'] = 'Kursus Pengujian [[tutorshort]] (tersembunyi)';
...
$string['chat:consent_body'] = '{$a->product} adalah asisten pembelajaran bertenaga AI. Pesan Anda dan balasan {$a->product} disimpan dalam basis data Moodle milik {$a->institution} dan sepuluh giliran terbaru dikirim ke penyedia model AI yang disetujui untuk menjawab pertanyaan Anda. Nama depan Anda dibagikan untuk personalisasi; tidak ada informasi pengenal lain yang dikirim ke penyedia AI. Jika Anda meminta bantuan manusia dan pertanyaan Anda dieskalasi, percakapan ini (termasuk nama dan email Anda) dapat dibagikan dengan tim dukungan kami. Anda dapat mengunduh, menghapus, atau berhenti menggunakan {$a->product} kapan saja.';
...
$string['settings:ssrf_trusted_endpoints_desc'] = 'Satu URL per baris. Host yang terdaftar melewati pemeriksaan loopback / IP-pribadi / hanya-https di validator SSRF [[tutorshort]]. Gunakan ini hanya untuk LLM swa-hosting di jaringan yang Anda kendalikan — misalnya <code>http://localhost:11434</code> untuk Ollama lokal, <code>http://10.0.0.5:8000</code> untuk pod vLLM di VPC yang sama. Perbandingan cocok dengan scheme + host + port; jalur apa pun diabaikan. Default kosong (memblokir semua yang internal). Baris yang dimulai dengan <code>#</code> adalah komentar.';
...
$string['flashcards:title'] = 'Flashcard';
$string['flashcards:link'] = 'Flashcard (tinjau sekarang)';
$string['flashcards:intro'] = 'Tinjauan dengan pengulangan berjarak. Ungkap jawabannya, lalu nilai diri Anda dengan Ulangi, Sulit, atau Mudah. Kartu yang Anda anggap sulit akan kembali lebih cepat; kartu yang mudah akan lebih jarang muncul.';
$string['flashcards:question'] = 'Pertanyaan';
$string['flashcards:answer'] = 'Jawaban';
$string['flashcards:reveal'] = 'Ungkap jawaban';
$string['flashcards:again'] = 'Ulangi';
$string['flashcards:hard'] = 'Sulit';
$string['flashcards:easy'] = 'Mudah';
$string['flashcards:no_due'] = 'Tidak ada yang perlu ditinjau saat ini. Buat flashcard dari halaman kursus di widget asisten, atau kembali lagi nanti.';
$string['flashcards:session_complete'] = 'Sesi selesai. Kerja bagus.';
$string['flashcards:disabled'] = 'Flashcard tidak diaktifkan untuk kursus ini.';
$string['flashcards:toggle'] = 'Aktifkan flashcard untuk kursus ini';
$string['flashcards:toggle_help'] = 'Menambahkan pemicu Buat-flashcard ke widget asisten dan halaman tinjauan pelajar di /local/ai_course_assistant/flashcards.php?courseid=X. Nonaktif secara default.';
$string['flashcards:starter_generate'] = 'Buat flashcard dari halaman ini';
$string['flashcards:generated'] = '{$a} flashcard telah disimpan. Buka halaman tinjauan untuk mempelajarinya.';
...
$string['settings:current_page_content_maxchars_desc'] = 'Jumlah maksimum karakter teks halaman saat ini yang disisipkan ke dalam prompt sistem sebagai bagian "Konten Halaman Saat Ini", ketika RAG nonaktif. Default 8,000 mendasari pertanyaan spesifik halaman dengan baik sambil menyisakan anggaran untuk struktur dan instruksi. (Dengan RAG aktif, halaman justru didasari oleh potongan-potongannya yang paling relevan, condong ke halaman saat ini, sehingga batas ini tidak berlaku.) Halaman yang sangat panjang dipotong dari awal hingga sebanyak karakter ini, sehingga akhir dari halaman yang amat panjang mungkin tidak dikutip; mengaktifkan RAG menghindari hal itu. Situs yang sadar biaya dapat membatasinya lebih rendah (mis. 3,000-4,000). Dibatasi pada rentang 500-8,000. Independen dari <code>prompt_budget_chars</code>: ini hanya membatasi bagian halaman; anggaran membatasi seluruh prompt.';
...
$string['settings:prompt_budget_auto_tune'] = 'Penyetelan otomatis harian anggaran prompt sistem (usang)';
$string['settings:prompt_budget_auto_tune_desc'] = 'Usang. Tidak melakukan apa pun kecuali mode anggaran di atas disetel ke <strong>Tetap</strong>. Sebuah tugas harian dulu menyimpulkan anggaran karakter dengan mengamati pemotongan dan mengejar prompt terbesar yang pernah dilihatnya. Menurunkan anggaran dari jendela konteks model melakukannya lebih baik: tidak berayun dan tidak butuh data awal. Keduanya juga bertentangan, karena tugas ini menulis anggaran karakter dan nilai apa pun selain bawaan mematikan anggaran turunan. Biarkan mati; akan dihapus pada rilis mendatang. Rekomendasinya tetap muncul di halaman <a href="/local/ai_course_assistant/prompt_metrics.php">Metrik prompt</a>.';
...
$string['comms:desc'] = 'Pilih email otomatis mana yang boleh dikirimkan [[tutorshort]] kepada Anda. Nonaktif secara default. Anda dapat mengubahnya kapan saja.';
$string['comms:milestones_label'] = 'Kirimi saya email saat saya mencapai tonggak pencapaian (rangkaian 7 hari, rangkaian 30 hari, penyelesaian kursus).';
$string['comms:audit_log_title'] = 'Apa yang telah [[tutorshort]] kirimkan kepada saya';
$string['comms:audit_log_empty'] = '[[tutorshort]] belum mengirimkan email apa pun kepada Anda.';
$string['comms:memory_title'] = 'Apa yang [[tutorshort]] ingat tentang cara saya belajar';
$string['comms:memory_desc'] = 'Catatan ini bersifat privat untuk obrolan Anda dengan [[tutorshort]]. Catatan ini membantu [[tutorshort]] memilih pendekatan lain saat suatu topik terasa sulit. Hapus kapan saja.';
$string['comms:memory_clear'] = 'Hapus semua catatan memori';
$string['milestone:streak_subject'] = 'Rangkaian {$a->days} hari di {$a->coursename}';
$string['milestone:streak_body_text'] = "Hai {\$a->firstname},\n\nAnda telah hadir {\$a->days} hari berturut-turut di {\$a->coursename}. Konsistensi seperti itu adalah bagian dari belajar yang paling sulit dipalsukan.\n\nKapan pun Anda siap, [[tutorshort]] ada di sini.\n\n— {\$a->institution}";
$string['milestone:completion_subject'] = 'Anda telah menyelesaikan {$a->coursename}';
$string['milestone:completion_body_text'] = "Hai {\$a->firstname},\n\nAnda telah menyelesaikan {\$a->coursename}. Itu pencapaian yang nyata.\n\nJika Anda ingin melanjutkan, [[tutorshort]] dapat membantu Anda memilih kursus terkait berikutnya atau meninjau kembali topik yang menurut Anda menarik.\n\n— {\$a->institution}";
$string['milestone:trigger_streak7'] = 'Rangkaian aktivitas 7 hari tercapai';
$string['milestone:trigger_streak30'] = 'Rangkaian aktivitas 30 hari tercapai';
$string['milestone:trigger_completion'] = 'Penyelesaian kursus tercatat';
...
$string['pedagogy:program_path_desc'] = 'Saat aktif, [[tutorshort]] dapat memberi tahu pelajar ke mana kursus saat ini akan mengarah berikutnya dalam program mereka (gelar atau sertifikat) dan bagaimana konsep hari ini menjembatani ke kursus-kursus selanjutnya. Membaca plugin Moodle Programs (Degrees dan Learn) dan menyebutkan kursus berikutnya yang spesifik hanya jika program tersebut menetapkan prasyarat atau urutan yang diwajibkan; jika tidak, ia mencatat posisi pelajar dalam jalur tersebut. Bersifat saran saja — tidak pernah mengubah pendaftaran atau penguasaan, dan hanya menggunakan alokasi program milik pelajar saat ini. Secara diam-diam tidak melakukan apa pun jika tidak ada program yang berlaku.';
...
$string['settings:backend_context_tokens'] = 'Jendela konteks backend (token)';
$string['settings:backend_context_tokens_desc'] = 'Panjang konteks maksimum (max_model_len) dari backend AI Anda, dalam token. Atur ke 0 untuk model yang dihosting dengan jendela besar (tanpa pembatasan). Bila diatur di atas 0 (misalnya 8192 pada backend vLLM yang dihosting sendiri), [[tutorshort]] memperkecil anggaran karakter prompt sistem di atas agar prompt beserta keluaran yang dicadangkan dan riwayat percakapan muat dalam jendela, bahkan dalam bahasa yang padat token. Lihat halaman wiki Deployment Sizing untuk mengetahui bagaimana hal ini berkaitan dengan pengguna bersamaan.';
$string['settings:backend_retry_attempts'] = 'Percobaan ulang backend';
$string['settings:backend_retry_attempts_desc'] = 'Berapa kali mencoba ulang galat backend sementara (HTTP 429 atau 503) sebelum menampilkan galat kepada siswa. Percobaan ulang hanya terjadi sebelum teks respons apa pun dialirkan, sehingga keluaran tidak pernah terduplikasi. Ditujukan untuk backend kecil yang dihosting sendiri yang menolak permintaan saat beban tinggi. Atur ke 0 untuk menonaktifkan. Bawaan 2.';
$string['settings:backend_retry_max_wait'] = 'Waktu tunggu maksimum percobaan ulang backend (detik)';
$string['settings:backend_retry_max_wait_desc'] = 'Batas atas, dalam detik, atas berapa lama menghormati header Retry-After dari backend sebelum mencoba ulang. Bila backend tidak mengirim Retry-After, [[tutorshort]] menggunakan backoff eksponensial singkat sebagai gantinya. Bawaan 5.';
$string['prompt:truncation_hint'] = 'CATATAN: Seluruh konten kursus tidak dapat ditelusuri pada giliran ini karena batasan panjang. Jika siswa menanyakan sesuatu yang tidak dapat Anda temukan dalam konten yang disediakan, katakan bahwa Anda tidak dapat menelusuri seluruh kursus dan sarankan agar mereka membuka halaman atau aktivitas spesifik tempat topik tersebut dibahas, alih-alih menyatakan bahwa topik itu tidak ada dalam kursus.';
$string['selftest:title'] = 'Uji mandiri backend';
$string['selftest:intro'] = 'Jalankan pemeriksaan langsung pada backend AI yang Anda konfigurasi: putaran obrolan kecil, deteksi otomatis jendela konteks (max_model_len) dan perbandingan terhadap pengaturan Jendela konteks backend Anda, batas bawah anggaran prompt sistem, dan (bila RAG aktif) putaran embedding. Panggilan jaringan hanya berjalan saat Anda menekan Jalankan.';
$string['selftest:run'] = 'Jalankan uji mandiri backend';
$string['selftest:check'] = 'Pemeriksaan';
$string['selftest:status'] = 'Status';
$string['selftest:detail'] = 'Rincian';
$string['selftest:link'] = 'Halaman uji mandiri backend';
$string['selftest:link_desc'] = 'Buka halaman <a href="{$a}">Uji mandiri backend</a> untuk memverifikasi bahwa backend AI Anda berfungsi dan berukuran dengan benar. Berguna tepat setelah mengonfigurasi backend yang dihosting sendiri.';
$string['profile:title'] = 'Praatur penerapan';
$string['profile:intro'] = 'Terapkan paket pengaturan yang direkomendasikan untuk jenis penerapan Anda. Nilai-nilai ditulis ke pengaturan plugin biasa dan tetap dapat disunting secara individual setelahnya. Menerapkan praatur menimpa pengaturan yang tercantum.';
$string['profile:current'] = 'Praatur terakhir yang diterapkan: {$a}';
$string['profile:setting'] = 'Pengaturan';
$string['profile:value'] = 'Nilai';
$string['profile:self_hosted_small'] = 'Konteks kecil yang dihosting sendiri (GPU tunggal, mis. A30 24GB / vLLM pada 8K)';
$string['profile:hosted_large'] = 'Konteks besar yang dihosting (bawaan)';
$string['profile:apply_self_hosted_small'] = 'Terapkan praatur konteks kecil yang dihosting sendiri';
$string['profile:apply_hosted_large'] = 'Terapkan bawaan konteks besar yang dihosting';
$string['profile:applied'] = 'Praatur {$a} telah diterapkan. Nilai-nilai kini ada di pengaturan plugin Anda.';
$string['profile:unknown'] = 'Praatur penerapan tidak dikenal.';
$string['profile:link'] = 'Halaman praatur penerapan';
$string['profile:link_desc'] = 'Buka halaman <a href="{$a}">Praatur penerapan</a> untuk menerapkan paket pengaturan yang direkomendasikan untuk backend yang dihosting atau dihosting sendiri.';
$string['coursesettings:apibaseurl_rejected'] = 'URL dasar API tidak disimpan: harus berupa endpoint HTTPS publik yang lolos pemeriksaan keamanan SSRF.';
$string['settings:escalation_intent_patterns'] = 'Pola maksud eskalasi';
$string['settings:escalation_intent_patterns_desc'] = 'PCRE, no delimiters. Satu ekspresi reguler per baris; baris yang diawali # diabaikan. Tiket dukungan hanya dibuka ketika pesan pemelajar sendiri cocok dengan salah satu pola ini, sehingga konten kursus tidak dapat memicu eskalasi atas nama pemelajar. Biarkan kosong untuk memakai nilai bawaan, yang mencakup bahasa Inggris serta beberapa ungkapan umum dalam bahasa Spanyol, Prancis, Jerman, dan Portugis. Situs yang pemelajarnya menulis dalam bahasa lain sebaiknya menambahkan pola di sini: pesan yang tidak cocok berarti tidak ada tiket yang dibuka.';
$string['settings:zendesk_require_consent'] = 'Memerlukan persetujuan sebelum eskalasi dukungan';
$string['settings:zendesk_require_consent_desc'] = 'Bila aktif (direkomendasikan), [[tutorshort]] hanya mengeskalasi percakapan ke meja dukungan Zendesk setelah pelajar menerima pemberitahuan persetujuan saat pertama kali dijalankan, yang menyatakan bahwa meminta bantuan manusia akan membagikan percakapan (termasuk nama dan email) dengan dukungan. Matikan ini hanya jika Anda memperoleh persetujuan tersebut dengan cara lain; bila dimatikan, eskalasi dikirim segera. Tidak berpengaruh kecuali eskalasi Zendesk diaktifkan.';
$string['chat:escalation_needs_consent'] = 'Sepertinya hal ini membutuhkan anggota tim dukungan kami. Untuk meneruskannya kepada mereka, saya harus membagikan percakapan ini, termasuk nama dan email Anda, dengan meja dukungan. Anda belum menyetujui hal itu, jadi saya belum mengirim apa pun. Jika Anda menginginkan bantuan manusia, silakan terima pemberitahuan berbagi data untuk asisten ini dan tanyakan lagi, atau hubungi dukungan secara langsung.';
$string['privacy:metadata:email_optout'] = 'Preferensi penolakan email per penerima (jenis email mana yang telah dibatalkan langganannya oleh penerima).';
...
$string['settings:rag_min_similarity'] = 'Relevansi minimum (kosinus)';
$string['settings:rag_min_similarity_desc'] = 'Membuang potongan yang diambil yang kemiripan kosinusnya terhadap pertanyaan berada di bawah nilai ini, sehingga pertanyaan yang melenceng dari topik atau jarang menyisipkan lebih sedikit bagian (atau nol) alih-alih selalu memenuhi hingga Top-K dengan kecocokan lemah. Rentang 0 hingga 1; 0 menonaktifkan gerbang. Nilai yang tepat bergantung pada model embedding: 0.25 cocok untuk text-embedding-3-small. Naikkan agar lebih ketat (lebih sedikit konteks, lebih sesuai topik), turunkan agar lebih permisif.';
$string['settings:rag_currentpage_boost'] = 'Boost halaman saat ini';
$string['settings:rag_currentpage_boost_desc'] = 'Bonus kecil yang ditambahkan ke skor relevansi potongan dari halaman yang sedang dilihat pelajar, sehingga pertanyaan seperti "jelaskan ini" lebih memilih halaman yang terlihat ketika skornya berdekatan. Hanya urutan: ini tidak memaksa potongan halaman yang tidak relevan melewati gerbang relevansi minimum. Atur 0 untuk menonaktifkan.';
$string['settings:history_mode'] = 'Mode pemilihan riwayat';
$string['settings:history_mode_desc'] = 'Bagaimana giliran percakapan sebelumnya dipilih sebelum dikirim ke model. <strong>Semantik</strong> hanya menyimpan giliran terbaru yang relevan dengan pertanyaan saat ini (dan selalu pertukaran terbaru), sehingga giliran sebelumnya yang usang dan melenceng dari topik tidak menambah biaya atau menyimpangkan jawaban; ini melakukan satu panggilan embedding tambahan per pesan. <strong>Keterbaruan</strong> menyimpan pasangan "Riwayat Percakapan Maksimum" terakhir terlepas dari relevansi (perilaku lama, tanpa panggilan tambahan). Jika embedding tidak tersedia, mode semantik secara otomatis beralih ke keterbaruan.';
$string['settings:history_mode_semantic'] = 'Semantik (giliran terbaru yang relevan)';
$string['settings:history_mode_recency'] = 'Keterbaruan (N pasangan terakhir)';
$string['settings:history_semantic_minscore'] = 'Ambang relevansi riwayat (kosinus)';
$string['settings:history_semantic_minscore_desc'] = 'Dalam mode riwayat semantik, giliran sebelumnya hanya disimpan jika kemiripannya terhadap pertanyaan saat ini setidaknya sebesar nilai ini (pertukaran terbaru selalu disimpan). Rentang 0 hingga 1; bergantung pada model. Naikkan agar lebih ketat (lebih sedikit riwayat), turunkan untuk menyimpan lebih banyak.';
$string['settings:history_candidates'] = 'Jendela kandidat riwayat';
$string['settings:history_candidates_desc'] = 'Dalam mode riwayat semantik, hanya sebanyak ini pasangan terbaru yang diberi skor relevansi (batas biaya). Pasangan yang lebih lama dari jendela ini tidak dikirim. Pertahankan nilai ini pada atau di atas "Riwayat Percakapan Maksimum".';

// v5.11.0 - v6.2.0 strings (added 2026-06-10).
$string['settings:embed_provider_voyage'] = 'Voyage AI (voyage-3.5 — direkomendasikan; +4 MTEB vs OpenAI 3-small, konteks 4x, multibahasa)';
$string['settings:rerank_heading'] = 'RAG: Pengambilan dua tahap (pemeringkatan ulang)';
$string['settings:rerank_heading_desc'] = 'Tahap pengambilan kedua yang opsional: kemiripan kosinus memilih N kandidat potongan teratas (bawaan 50), lalu pemeringkat ulang berbasis penyandi-silang menilai setiap pasang (kueri, potongan) dan K terbaik masuk ke dalam prompt. Nonaktif secara bawaan; kembali ke kosinus satu tahap bila pemeringkat ulang tidak dikonfigurasi atau gagal.';
$string['settings:rerank_enabled'] = 'Pengambilan dua tahap (Voyage rerank-2.5)';
$string['settings:rerank_enabled_desc'] = 'Bila diaktifkan, pengambilan RAG menjadi dua tahap: kemiripan kosinus mengembalikan N kandidat teratas (bawaan 50), lalu penyandi-silang Voyage rerank-2.5 menilai masing-masing dan K teratas masuk ke dalam prompt. Peningkatan yang dipublikasikan: +15 Recall@10 enterprise, +39% NDCG BEIR. Penagihan ~$0,05/MTok. Memerlukan <code>rerank_apikey</code> di bawah; kembali secara anggun ke kosinus satu tahap bila rerank gagal atau tidak dikonfigurasi.';
$string['settings:rerank_apikey'] = 'Kunci API Rerank';
$string['settings:rerank_apikey_desc'] = 'Kunci API Voyage AI untuk rerank-2.5. Biarkan kosong untuk menggunakan ulang Kunci API Penyematan di atas (penerapan Voyage biasanya berbagi satu kunci untuk embed + rerank).';
$string['settings:rerank_model'] = 'Model Rerank';
$string['settings:rerank_model_desc'] = 'Bawaan <code>rerank-2.5</code>. Model Voyage rerank yang lebih baru dapat ditentukan di sini.';
...
$string['settings:stt_selfhosted_url_desc'] = 'URL dasar server transkripsi yang kompatibel dengan OpenAI, misalnya <code>http://10.0.0.5:8000</code>. [[tutorshort]] secara otomatis menambahkan <code>/v1/audio/transcriptions</code>; jalur titik akhir lengkap juga diterima. Biarkan kosong untuk menonaktifkan STT yang dihosting sendiri.';
$string['settings:stt_selfhosted_model'] = 'Model STT yang Dihosting Sendiri';
$string['settings:stt_selfhosted_model_desc'] = 'Nama model yang diteruskan ke server, sesuai dengan model Whisper yang dimuat — misalnya <code>Systran/faster-whisper-small</code> untuk speaches atau <code>large-v3</code>. Biarkan kosong untuk mengirim <code>whisper-1</code>, yang diterima atau diabaikan oleh sebagian besar server yang dihosting sendiri.';
$string['settings:stt_selfhosted_apikey'] = 'Kunci API STT yang Dihosting Sendiri';
$string['settings:stt_selfhosted_apikey_desc'] = 'Opsional. Sebagian besar server yang dihosting sendiri tidak memerlukan kunci di balik jaringan tepercaya; atur ini hanya bila server Anda memerlukan token bearer.';
$string['emergency:title'] = 'Kontrol Darurat [[tutorshort]]';
$string['emergency:page_warning'] = 'Sakelar-sakelar ini langsung berlaku untuk setiap pelajar di situs. Setiap tindakan menulis baris audit. Sakelar granular membiarkan sisa [[tutorshort]] tetap berjalan; pemutus utama menghapus widget sepenuhnya.';
$string['emergency:back_to_settings'] = 'Pengaturan [[tutorshort]]';
$string['emergency:state_disabled'] = 'DINONAKTIFKAN';
$string['emergency:state_active'] = 'Aktif';
$string['emergency:confirm_label'] = 'Saya mengerti bahwa ini langsung memengaruhi setiap pelajar';
$string['emergency:confirm_required'] = 'Harap centang kotak konfirmasi sebelum menonaktifkan subsistem.';
$string['emergency:reason_placeholder'] = 'Alasan (dicatat dalam log audit)';
$string['emergency:disable_button'] = 'Nonaktifkan';
$string['emergency:restore_button'] = 'Pulihkan';
$string['emergency:disabled_notice'] = 'Subsistem "{$a->flag}" dinonaktifkan. Konfigurasi yang diubah: {$a->touched}';
...
$string['emergency:flag_rag_desc'] = 'Menonaktifkan pengambilan dan pengindeksan. Chat berlanjut tanpa pemelajaran berbasis konten kursus.';
$string['emergency:flag_outreach'] = 'Penjangkauan';
$string['emergency:flag_outreach_desc'] = 'Menghentikan email ringkasan, pencapaian, dan pengingat. Tidak memengaruhi chat.';
$string['emergency:flag_all'] = 'PEMUTUS UTAMA';
$string['emergency:flag_all_desc'] = 'Menonaktifkan seluruh plugin: widget hilang dari setiap halaman, tugas terjadwal berhenti, suara dihapus, RAG dimatikan, penjangkauan dimatikan. Sakelar terkuat — gunakan untuk insiden keamanan atau bila [[tutorshort]] harus diambil offline segera.';
$string['emergency:settings_link'] = 'Kontrol darurat';
$string['emergency:settings_link_desc'] = 'Sakelar pemutus per subsistem (chat / suara / RAG / penjangkauan / utama) dengan pencatatan audit — padanan web dari <code>admin/cli/emergency_disable.php</code>. Buka <a href="{$a}">Kontrol Darurat [[tutorshort]]</a>.';
$string['email_unsubscribe:done_title'] = 'Berhenti berlangganan';
$string['email_unsubscribe:done_body'] = 'Selesai — {$a->email} tidak akan lagi menerima jenis email ini dari {$a->product}. Jika Anda berubah pikiran, minta administrator {$a->product} untuk mengaktifkan kembali langganan, atau kirim permintaan opt-in baru melalui halaman admin Penerima [[tutorshort]].';
$string['email_unsubscribe:invalid_title'] = 'Tautan berhenti berlangganan tidak lagi valid';
$string['email_unsubscribe:invalid_body'] = 'Tautan berhenti berlangganan ini telah kedaluwarsa atau tidak valid. Cari email terbaru dari kami, atau hubungi administrator situs untuk dihapus secara manual.';
$string['settings:prompt_proportions_heading'] = 'Proporsi bagian prompt (v5.6.0)';
$string['settings:prompt_proportions_heading_desc'] = 'Alokasikan anggaran prompt sistem ke empat wadah: keamanan + identitas, struktur kursus, konten kursus, dan halaman saat ini. Bobot adalah persentase yang berjumlah 100. Bawaan yang disetel secara empiris (10 / 10 / 40 / 40) berasal dari benchmark penyetelan bobot v5.6.0; membiarkan area teks kosong menggunakan bawaan tersebut. Peningkatan otomatis menyesuaikan alokasi per giliran tergantung pada apakah halaman tertentu berada dalam cakupan.';
$string['settings:prompt_section_weights'] = 'Bobot bagian dasar (JSON)';
$string['settings:prompt_section_weights_desc'] = 'Objek JSON opsional yang memetakan setiap wadah ke persentase. Biarkan kosong untuk menggunakan bawaan yang telah diuji benchmark (10 / 10 / 40 / 40). Contoh: <code>{"safety_identity": 10, "course_structure": 10, "course_content": 40, "current_page": 40}</code>. Bobot harus berjumlah 100 (±5%). <code>safety_identity</code> memiliki lantai 10% agar ketahanan jailbreak dan penanda format keluaran selalu masuk sepenuhnya. <code>current_page + course_content</code> harus minimal 40% agar model memiliki materi substantif untuk didasarkan. Nilai di luar rentang kembali secara diam-diam ke bawaan yang diuji benchmark; admin harus memvalidasi dengan memeriksa log debug prompt setelah menyimpan.';
$string['settings:prompt_context_boost_mode'] = 'Mode peningkatan konteks';
$string['settings:prompt_context_boost_mode_desc'] = 'Penyesuaian otomatis yang menggeser bobot ke bagian halaman saat ini bila halaman tertentu berada dalam cakupan, dan ke konten kursus bila tidak ada halaman yang dipilih. <strong>page_focus</strong> (bawaan) menggeser sekitar 15 poin bobot. <strong>aggressive</strong> menggeser 25 poin dan paling cocok bila pelajar secara konsisten mengajukan pertanyaan spesifik halaman. <strong>off</strong> menonaktifkan peningkatan; bobot dasar yang ditetapkan admin berlaku di setiap giliran terlepas dari konteks halaman.';
$string['settings:prompt_context_boost_off'] = 'Mati (gunakan bobot dasar di setiap giliran)';
$string['settings:prompt_context_boost_page_focus'] = 'Fokus halaman (bawaan, pergeseran ~15 poin)';
$string['settings:prompt_context_boost_aggressive'] = 'Agresif (pergeseran ~25 poin)';
$string['settings:prompt_section_weights_coach'] = 'Ganti bobot mode pelatih (JSON, opsional)';
$string['settings:prompt_section_weights_coach_desc'] = 'Objek JSON opsional yang mengganti bobot bagian dasar khusus selama mode pelatih kuis bermutu (bila <code>quizmode=coach</code>). Berguna untuk memaksa alokasi <code>current_page</code> yang lebih berat selama kuis tanpa memengaruhi chat biasa. Biarkan kosong untuk mewarisi bobot dasar. Aturan validasi yang sama dengan pengaturan dasar.';
$string['prompt_debug_view:title'] = 'Penampil log debug prompt';
$string['prompt_debug_view:subtitle'] = 'Prompt sistem yang dirakit per giliran + perincian per bagian + riwayat percakapan + pesan pengguna saat ini + metadata lampiran, persis seperti yang diterima model. Gunakan ini untuk memverifikasi apakah bagian seperti Konten Halaman Saat Ini benar-benar masuk ke dalam prompt dan untuk men-debug masalah kualitas jawaban tanpa SSH ke server.';
$string['prompt_debug_view:disabled'] = 'Pencatatan log debug prompt saat ini MATI. Tidak ada entri baru yang akan ditulis hingga diaktifkan.';
$string['prompt_debug_view:enable_link'] = 'Buka pengaturan plugin untuk mengaktifkan "Catat prompt sistem yang dirakit ke file".';
$string['prompt_debug_view:no_log_yet'] = 'Belum ada file log. Kirim setidaknya satu giliran chat setelah mengaktifkan log debug; file dibuat saat pertama kali ditulis.';
$string['prompt_debug_view:empty'] = 'File log ada tetapi kosong. Kirim giliran chat dan segarkan.';
$string['prompt_debug_view:file_status'] = 'Ukuran file log';
$string['prompt_debug_view:showing'] = 'Menampilkan entri terbaru (terbaru lebih dulu), batas';
$string['prompt_debug_view:total'] = 'Total prompt';
$string['prompt_debug_view:budget'] = 'Anggaran saat ditangkap';
$string['prompt_debug_view:sections'] = 'Bagian (berdasarkan kategori)';
$string['prompt_debug_view:assembled_prompt'] = 'Prompt sistem yang dirakit';
$string['prompt_debug_view:history'] = 'Riwayat percakapan yang dikirim ke model';
$string['prompt_debug_view:current_message'] = 'Pesan pengguna saat ini';
$string['prompt_debug_view:attachment'] = 'Metadata lampiran';
$string['prompt_debug_view:show_more'] = 'Tampilkan lebih banyak entri';
$string['settings:mastery_classifier_provider'] = 'Penyedia pengklasifikasi';
$string['settings:mastery_classifier_provider_desc'] = 'ID penyedia yang digunakan untuk pengklasifikasi penguasaan per giliran. Biarkan kosong untuk mewarisi penyedia AI bawaan. <code>openai</code> bawaan dipasangkan dengan model pengklasifikasi <code>gpt-4o-mini</code> di bawah — opsi TIER 1 termurah untuk klasifikasi keluaran terstruktur (~penghematan $220/bulan pada 100 ribu MAU vs tier chat). Bila diatur, baris di Penyedia perbandingan dengan ID penyedia ini menyediakan kunci API, URL dasar, dan temperatur.';
$string['settings:premium_escalation_heading'] = 'Tier eskalasi premium (A.10)';
$string['settings:premium_escalation_heading_desc'] = 'Perutean opsional per giliran ke model premium (Claude Opus 4.8 secara bawaan) untuk prompt di mana tier chat utama terlihat berjuang — biasanya matematika multi-langkah, ilmu komputer, dan penalaran sains. Diselesaikan oleh bake-off A.10 pada 2026-06-09: Opus 4.8 menang dengan 14,97/15 vs 12,68/15 gpt-4o pada prompt sulit. Dua jalur pemicu: kecocokan regex pada pesan pengguna, ATAU daftar izin kursus yang mengeskalasi setiap giliran. Nonaktif secara bawaan. Pada ~5% eskalasi, perkirakan ~$700/bulan di atas pengeluaran chat dasar per 100 ribu MAU [[unishort]].';
$string['settings:premium_escalation_enabled'] = 'Aktifkan perutean eskalasi premium';
$string['settings:premium_escalation_enabled_desc'] = 'Bila aktif, router per giliran memeriksa daftar regex pemicu dan daftar izin kursus untuk setiap panggilan chat; giliran yang cocok diarahkan ke penyedia premium. Kembali ke penyedia utama bila baris premium hilang atau gagal diinstansiasi. Penggantian admin-LLM-picker selalu menang tanpa pengecualian.';
$string['settings:premium_escalation_provider'] = 'Penyedia premium';
$string['settings:premium_escalation_provider_desc'] = 'ID penyedia untuk merutekan panggilan premium. Harus cocok dengan baris di Penyedia perbandingan (sehingga kunci API, URL dasar, dan temperatur berasal dari tempat yang sama yang sudah dikelola admin). Bawaan <code>claude</code>.';
$string['settings:premium_escalation_model'] = 'Model premium';
$string['settings:premium_escalation_model_desc'] = 'Nama model yang diteruskan ke penyedia premium. Bawaan <code>claude-sonnet-5</code> berdasarkan putusan bake-off A.10.';
$string['settings:premium_escalation_triggers'] = 'Regex pemicu premium';
$string['settings:premium_escalation_triggers_desc'] = 'Satu regex PCRE per baris (tanpa pembatas; pencocokan tidak peka huruf besar/kecil diterapkan secara otomatis). Baris yang dimulai dengan # adalah komentar. Biarkan kosong untuk menggunakan set bawaan yang dikurasi dari bake-off A.10 (penanda STEM multi-langkah: "derive", "prove that", "step by step", matematika LaTeX, blok kode berpagar, big-O, integral, optimasi, dll.).';
$string['settings:premium_escalation_course_tags'] = 'Daftar izin kursus premium';
$string['settings:premium_escalation_course_tags_desc'] = 'Satu nama pendek kursus atau awalan idnumber per baris. Setiap giliran dalam kursus yang cocok dieskalasi secara otomatis terlepas dari regex pesan (gunakan untuk kursus berat-STEM di mana eskalasi harus menjadi bawaan). Pencocokan adalah awalan tidak peka huruf besar/kecil — "MATH" cocok dengan MATH121, MATH205, dll.';
$string['settings:spend_cap_per_course_default'] = 'Batas pengeluaran per kursus bawaan (USD)';
$string['settings:spend_cap_per_course_default_desc'] = 'Batas defensif yang diterapkan ke setiap kursus yang tidak memiliki batas pengeluaran per kursus sendiri yang dikonfigurasi. Atur misalnya ke <code>30</code> untuk membatasi pengeluaran bulanan kursus mana pun sebesar $30 tanpa harus menyetel kursus satu per satu. <code>0</code> = tidak ada bawaan (hanya batas seluruh situs dan batas penggantian per kursus yang berlaku). Bila kursus melewati 80% / 95% / 100% dari batas ini, saluran peringatan spend-guard yang ada mengirimkan notifikasi admin (daftar penerima: <code>spend_notify_emails</code>, kembali ke admin situs). Kursus tertentu selalu dapat menaikkan batasnya sendiri dengan menetapkan penggantian per kursus yang lebih tinggi.';
$string['settings:cost_anomaly_heading'] = 'Detektor anomali biaya (v6.0)';
$string['settings:cost_anomaly_heading_desc'] = 'Tugas terjadwal harian (<code>cost_anomaly_check</code>) yang membandingkan pengeluaran [[tutorshort]] seluruh situs hari ini dengan median bergulir 7 hari. Mengirim email ke daftar penerima <code>spend_notify_emails</code> (kembali ke admin situs) bila hari ini melebihi pengganda yang dikonfigurasi × median. Menangkap tiga mode kegagalan yang dilewatkan oleh ambang batas pengeluaran 80% / 95% / 100% yang ada: (1) kursus tak terkendali di mana batas absolut tidak dilanggar tetapi satu kursus tiba-tiba mendorong 10x volume biasanya, (2) pengaktifan tier premium yang tidak disengaja, (3) kesalahan rute penyedia. Nonaktif secara bawaan; setara [[tutorshort]]-internal dengan kueri Redash di <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
$string['settings:cost_anomaly_enabled'] = 'Aktifkan detektor anomali biaya';
$string['settings:cost_anomaly_enabled_desc'] = 'Bila aktif, tugas terjadwal harian mengevaluasi pengeluaran hari ini terhadap median bergulir 7 hari dan mengirim email admin bila ada anomali. 7 hari pertama setelah mengaktifkan menghasilkan status <code>insufficient_history</code> (belum ada baseline historis) dan tidak pernah mengeluarkan peringatan. Idempoten per hari: flag di <code>config_plugins</code> mencegah email berulang bila cron berjalan beberapa kali.';
$string['settings:cost_anomaly_multiplier'] = 'Pengganda anomali';
$string['settings:cost_anomaly_multiplier_desc'] = 'Pengeluaran hari ini harus melebihi pengganda ini × median 7 hari untuk memicu peringatan. Bawaan <code>2.0</code>. Turunkan ke <code>1.5</code> untuk peringatan lebih awal (lebih banyak positif palsu saat lonjakan pendaftaran). Naikkan ke <code>3.0</code> bila penggunaan [[unishort]] cukup berlonjak sehingga lonjakan 2x sudah biasa.';
$string['task:cost_anomaly_check'] = 'Pemeriksaan anomali biaya [[tutorshort]] (harian)';
...
$string['task:policy_bundle_sync'] = 'Sinkronisasi bundel kebijakan bertanda tangan [[tutorshort]]';
...
$string['analytics:exp_desc'] = 'Bandingkan keterlibatan antara dua kursus selama rentang waktu yang dipilih. Dibangun untuk eksperimen per kursus (misalnya uji animasi avatar): tempatkan penggantian di satu kursus, biarkan yang lain sebagai kontrol, dan baca perbedaannya di sini.';
...
$string['analytics:exp_enrolled'] = 'Peserta terdaftar';
$string['analytics:exp_active_users'] = 'Pengguna [[tutorshort]] aktif';
$string['analytics:exp_usage_rate'] = 'Tingkat penggunaan (%)';
$string['analytics:exp_sessions'] = 'Sesi';
$string['analytics:exp_messages'] = 'Pesan';
$string['analytics:exp_avg_msgs_session'] = 'Rata-rata pesan per sesi';
$string['analytics:exp_avg_session_minutes'] = 'Rata-rata durasi sesi (menit)';
...
$string['cachedef_ratelimit'] = 'Pembatasan laju permintaan per pengguna';
$string['cachedef_uistate'] = 'Pengalih tampilan UI per sesi (lihat sebagai siswa, tampilkan nama asli)';
$string['benchmark:pagetitle'] = 'Tolok ukur penyedia';
$string['benchmark:intro'] = 'Mengirim sekumpulan prompt umum yang tetap ke setiap penyedia AI yang dikonfigurasi, mencatat penggunaan token, biaya, dan latensi, lalu merekomendasikan satu penyedia per kemampuan. Setiap kali dijalankan akan membuat panggilan API sungguhan, jadi satu kali proses menghabiskan sekitar 5 hingga 20 sen tergantung pada berapa banyak penyedia yang dikonfigurasi.';
$string['cachedef_systemprompt'] = 'Prompt sistem AI yang telah dirakit (per kursus)';
$string['cachedef_remoteconfig'] = 'Konfigurasi jarak jauh yang diambil dari saluran pembaruan';
$string['cachedef_spend'] = 'Total pengeluaran AI per periode untuk penjaga pengeluaran';
$string['cachedef_failover_circuit'] = 'Status pemutus sirkuit failover penyedia';
$string['settings:rag_scope'] = 'Cakupan pengambilan';
$string['settings:rag_scope_desc'] = 'Ketika seorang pelajar sedang melihat dokumen tertentu (sebuah halaman, buku, atau PDF), apakah pengambilan dibatasi pada dokumen tersebut. <b>Dokumen-dahulu</b> mendasarkan jawaban pada dokumen saat ini bila memiliki potongan yang relevan dan beralih ke seluruh kursus jika tidak. <b>Dokumen-saja</b> tidak pernah beralih: jika dokumen saat ini tidak memiliki potongan yang relevan, tidak ada yang diambil, sehingga tutor menjawab dari pengetahuan umum alih-alih mengutip halaman yang tidak berkaitan. <b>Seluruh kursus</b> mencari seluruh konten kursus (halaman saat ini tetap mendapat peningkatan urutan di atas). Dokumen-dahulu direkomendasikan, sehingga jawaban tentang halaman yang sedang dibaca pelajar didasarkan pada halaman tersebut.';
$string['settings:rag_scope_document_first'] = 'Dokumen-dahulu (utamakan dokumen saat ini, beralih ke kursus)';
$string['settings:rag_scope_document_only'] = 'Dokumen-saja (batasi pada dokumen saat ini)';
$string['settings:rag_scope_course'] = 'Seluruh kursus (cari seluruh konten kursus)';
$string['ragadmin:no_content_documents'] = '{$a->count} dokumen tidak menghasilkan teks yang dapat diindeks dan tidak dipotong (biasanya halaman yang sebagian besar tersemat atau sangat singkat): {$a->titles}. Jika salah satunya seharusnya dapat dicari, tambahkan teks pada halaman atau transkrip, lalu indeks ulang.';
$string['privacy:metadata:sbx_rec'] = 'Rekaman presentasi Soapbox. Objek media dihapus setelah jendela retensi; transkrip disimpan untuk umpan balik dan permintaan akses.';
$string['privacy:metadata:sbx_rec:userid'] = 'Pelajar yang membuat rekaman.';
$string['privacy:metadata:sbx_rec:transcript'] = 'Transkrip hasil ucapan-ke-teks dari rekaman.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'Durasi rekaman dalam detik.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'Waktu rekaman dibuat.';
$string['privacy:metadata:ai_provider'] = 'Untuk menghasilkan respons tutoring, konten yang ditulis pelajar dikirim ke penyedia AI yang dikonfigurasi oleh administrator situs atau kursus.';
$string['privacy:metadata:ai_provider:message'] = 'Teks pesan dan lampiran yang dikirim pelajar ke tutor AI.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'Konteks kursus dan aktivitas (seperti nama kursus dan halaman saat ini) yang disertakan untuk mendasari respons.';
$string['privacy:metadata:voice_provider'] = 'Ketika input atau output suara digunakan, audio dan teks dikirim ke penyedia ucapan-ke-teks / teks-ke-ucapan yang dikonfigurasi.';
$string['privacy:metadata:voice_provider:audio'] = 'Rekaman audio pelajar yang berbicara, dikirim untuk transkripsi.';
$string['privacy:metadata:voice_provider:text'] = 'Teks yang dikirim ke penyedia untuk disintesis menjadi ucapan.';
$string['privacy:metadata:zendesk'] = 'Ketika eskalasi ke dukungan manusia diaktifkan dan pelajar menyetujui, detail kontak dan pesan mereka dikirim ke Zendesk untuk membuka tiket dukungan.';
$string['privacy:metadata:zendesk:name'] = 'Nama lengkap pelajar, digunakan untuk mengidentifikasi pemohon dukungan.';
$string['privacy:metadata:zendesk:email'] = 'Alamat email pelajar, digunakan untuk membalas permintaan dukungan.';
$string['privacy:metadata:zendesk:message'] = 'Isi pesan atau percakapan yang dipilih pelajar untuk dieskalasi.';
...
$string['analytics_js:hallucination_flags'] = 'Tanda Halusinasi';
$string['analytics_js:avg_star_rating'] = 'Peringkat Bintang Rata-rata';
$string['analytics_js:avg_msgs_resolution'] = 'Rata-rata Pesan hingga Penyelesaian';
$string['analytics_js:survey_respondents'] = 'Responden Survei';
$string['analytics_js:messages'] = 'Pesan';
$string['analytics_js:students'] = 'Siswa';
$string['analytics_js:frequency'] = 'Frekuensi';
$string['analytics_js:responses'] = 'Tanggapan';
$string['analytics_js:error_loading'] = 'Kesalahan saat memuat data';
$string['analytics_js:loading'] = 'Memuat analitik...';
$string['analytics_js:no_course_data'] = 'Tidak ada data kursus yang tersedia.';
$string['analytics_js:no_unit_data'] = 'Belum ada data unit. Pelacakan unit terkumpul seiring siswa menggunakan asisten.';
$string['analytics_js:no_keyword_data'] = 'Tidak ada data kata kunci yang tersedia untuk periode ini.';
$string['task:soapbox_cleanup'] = 'Retensi dan pembersihan rekaman Soapbox';
$string['admin:vendor_dpa:col_provider'] = 'Penyedia';
$string['admin:vendor_dpa:col_optout'] = 'Penolakan pelatihan';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Retensi';
$string['admin:vendor_dpa:col_tier'] = 'Batas tingkat';
$string['admin:vendor_dpa:col_link'] = 'Tautan';
$string['admin:vendor_dpa:vendor_terms'] = 'Ketentuan vendor';
$string['admin:vendor_dpa:tier'] = 'Tingkat {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'Kontraktual (telah menolak)';
$string['admin:vendor_dpa:too_default_on'] = 'Aktif secara bawaan';
$string['admin:vendor_dpa:too_none'] = 'Tidak ada penolakan';
$string['admin:vendor_dpa:too_local'] = 'Lokal (tanpa vendor)';
$string['admin:vendor_dpa:too_unknown'] = 'Belum ditinjau';
$string['admin:vendor_dpa:dpa_signed'] = 'Ditandatangani';
$string['admin:vendor_dpa:dpa_available'] = 'Tersedia';
$string['admin:vendor_dpa:dpa_negotiating'] = 'Dalam negosiasi';
...
$string['settings:soapbox_slide_vision'] = 'Umpan balik desain visual slide Soapbox';
$string['settings:soapbox_slide_vision_desc'] = 'Izinkan satu kali analisis penglihatan atas gambar slide yang dirender untuk menambahkan catatan desain visual singkat pada presentasi yang dinilai. Nonaktif secara bawaan dan menjaga privasi: tidak ada gambar yang disimpan, dan setiap tugas juga harus ikut serta dengan kotak centang Umpan balik desain visual slide-nya sendiri. Hanya presentasi slide dengan deck yang diunggah yang terpengaruh.';
$string['settings:soapbox_vision_provider'] = 'Penyedia penglihatan slide Soapbox';
$string['settings:soapbox_vision_provider_desc'] = 'Penyedia yang digunakan untuk analisis penglihatan slide. Bawaannya openai. Harus berupa penyedia yang mampu penglihatan dan dikonfigurasi dengan kunci API (melalui penyedia kursus atau daftar penyedia perbandingan).';
$string['settings:soapbox_vision_model'] = 'Model penglihatan slide Soapbox';
$string['settings:soapbox_vision_model_desc'] = 'Model yang mampu penglihatan untuk analisis penglihatan slide. Bawaannya gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'Desain slide:';
$string['soapbox:assign_manage'] = 'Tugas presentasi Soapbox';
$string['soapbox:copy_link'] = 'Tautan siswa';
$string['soapbox:deck_label'] = 'Slide (PDF). Unggah deck Anda, lalu lanjutkan slide saat Anda merekam.';
$string['soapbox:slide_prev'] = 'Slide sebelumnya';
$string['soapbox:slide_next'] = 'Slide berikutnya';
$string['soapbox:play_slides'] = 'Putar dengan slide';
$string['soapbox:audio_ready'] = 'Hanya audio. Mikrofon Anda akan direkam; kamera Anda tidak digunakan.';
$string['soapbox:audio_recording'] = 'Merekam audio...';
$string['soapbox:cap_reached'] = 'Anda telah mencapai jumlah maksimum rekaman untuk tugas ini.';
$string['soapbox:storage_unconfigured'] = 'Penyimpanan rekaman belum disiapkan. Silakan hubungi administrator Anda.';
$string['soapbox:bad_key'] = 'Unggahan itu bukan milik Anda.';
$string['soapbox:slides_disabled'] = 'Slide tidak diaktifkan untuk tugas ini.';
$string['soapbox:upload_missing'] = 'Unggahan tidak dapat ditemukan. Silakan coba merekam lagi.';
$string['soapbox:mode_label'] = 'Jenis presentasi';
$string['soapbox:mode_informative'] = 'Informatif (menjelaskan atau mengajar)';
$string['soapbox:mode_persuasive'] = 'Persuasif (meyakinkan)';
$string['soapbox:err_provider'] = 'Layanan penilaian AI tidak dapat dijangkau. Silakan coba lagi sesaat lagi.';
$string['soapbox:err_parse'] = 'AI mengembalikan respons yang tidak terduga. Silakan coba lagi.';
$string['soapbox:err_disabled'] = 'Latihan berbicara tidak diaktifkan untuk kursus ini.';
$string['soapbox:err_transcribe'] = 'Rekaman Anda tidak dapat ditranskripsikan. Silakan coba lagi, dan periksa apakah mikrofon Anda berfungsi.';
$string['settings:outcomes_benchmark_default'] = 'Tolok ukur capaian (persen)';
$string['settings:outcomes_benchmark_default_desc'] = 'Tolok ukur yang ditetapkan institusi untuk laporan capaian: seorang siswa memenuhi suatu capaian ketika penguasaannya berada pada atau di atas persentase ini. Ini adalah standar pelaporan (berbeda dari ambang penguasaan pembinaan). Bawaannya 70.';
$string['outcomes:title'] = 'Laporan capaian';
$string['outcomes:intro'] = 'Untuk setiap capaian kursus, tolok ukur dan persentase siswa yang dinilai yang memenuhi atau melampauinya. Tolok ukur situs adalah {$a}%.';
$string['outcomes:none'] = 'Belum ada capaian yang ditetapkan untuk kursus ini.';
$string['outcomes:export'] = 'Ekspor CSV';
$string['outcomes:col_outcome'] = 'Capaian';
$string['outcomes:col_benchmark'] = 'Tolok ukur';
$string['outcomes:col_assessed'] = 'Siswa yang dinilai';
$string['outcomes:col_met'] = 'Memenuhi tolok ukur';
...
$string['soapbox:present_audio'] = 'Presentasi audio';
$string['soapbox:present_video'] = 'Presentasi video';
$string['soapbox:present_target'] = 'target {$a->min}-{$a->max} menit';
$string['soapbox:choose_topic'] = 'Pilih topik';
$string['soapbox:record_short'] = 'Rekam';
$string['soapbox:my_recordings'] = 'Rekaman saya';
$string['soapbox:no_recordings'] = 'Belum ada rekaman.';
$string['soapbox:col_recorded'] = 'Direkam';
$string['soapbox:col_length'] = 'Durasi';
$string['soapbox:col_type'] = 'Jenis';
$string['soapbox:col_recording'] = 'Rekaman';
$string['soapbox:col_kept'] = 'Disimpan';
$string['soapbox:col_student_link'] = 'Tautan siswa';
$string['soapbox:view_download'] = 'Lihat / unduh';
$string['soapbox:expired'] = 'Kedaluwarsa';
$string['soapbox:retention_note'] = 'Rekaman dapat dilihat dan diunduh selama {$a} hari, lalu dihapus otomatis.';
$string['soapbox:assign_title'] = 'Tugas Soapbox';
$string['soapbox:assign_single_title'] = 'Tugas Soapbox';
$string['soapbox:assign_add'] = 'Tambah tugas';
$string['soapbox:assign_none'] = 'Belum ada tugas Soapbox.';
$string['soapbox:assign_deleted'] = 'Tugas dihapus.';
$string['soapbox:assign_updated'] = 'Tugas diperbarui.';
$string['soapbox:assign_created'] = 'Tugas dibuat.';
...
$string['settings:hidden_categories_desc'] = 'Daftar nama atau ID kategori kursus yang dipisahkan koma, tempat asisten tidak boleh muncul. Contoh: "Pengembangan kursus, 42". Asisten juga otomatis disembunyikan saat mode ubah sedang aktif.';
$string['settings:provider_heading'] = 'Penyedia AI dan percakapan';
$string['settings:provider_heading_desc'] = 'Atur platform AI, model, dan perilaku dalam percakapan.';
...
$string['settings:enable_thinking_desc'] = 'Mengaktifkan penalaran adaptif untuk model Claude. Claude sendiri yang menentukan kapan dan seberapa dalam memikirkan suatu masalah sebelum menjawab. Meningkatkan ketepatan pada pertanyaan rumit, tetapi menambah pemakaian token dan waktu tunggu. Isi penalaran tidak ditampilkan kepada pelajar. Penyedia lain mengabaikan pengaturan ini.';
$string['settings:rag_sources_heading'] = 'Sumber konten RAG';
$string['settings:rag_sources_heading_desc'] = 'Pilih dari jenis konten kursus mana pengindeks RAG mengambil teks. Indikator status pada <a href="{$a}">halaman administrasi RAG</a> menunjukkan apakah setiap pengekstrak memiliki yang dibutuhkannya untuk bekerja (misalnya perkakas pdftotext atau daftar izin Cloudflare).';
$string['settings:rag_extract_pdf'] = 'Indeks berkas PDF (mod_resource)';
$string['settings:rag_extract_pdf_desc'] = 'Mengambil teks dari berkas PDF yang diunggah melalui perkakas <code>pdftotext</code> (poppler). Jalur perkakas dideteksi otomatis; tentukan di bawah bila perlu.';
$string['settings:rag_pdftotext_path'] = 'Jalur perkakas pdftotext';
$string['settings:rag_pdftotext_path_desc'] = 'Kosongkan untuk deteksi otomatis (memeriksa <code>/usr/bin/pdftotext</code>, <code>/usr/local/bin/pdftotext</code>, dan <code>which pdftotext</code>). Isi hanya jika pemasangan Anda berada di lokasi lain.';
$string['settings:rag_extract_docx'] = 'Indeks berkas DOCX (mod_resource)';
$string['settings:rag_extract_docx_desc'] = 'Mengambil teks dari dokumen Word yang diunggah melalui ZipArchive PHP. Tidak memerlukan ketergantungan eksternal.';
$string['settings:rag_extract_pptx'] = 'Indeks berkas PPTX (mod_resource)';
$string['settings:rag_extract_pptx_desc'] = 'Mengambil teks dari presentasi PowerPoint modern yang diunggah melalui ZipArchive PHP. Menelusuri XML salindia dan catatan penyaji sesuai urutan salindia; tidak memerlukan ketergantungan eksternal. Berkas biner <code>.ppt</code> lama tidak didukung — simpan ulang presentasi tersebut sebagai <code>.pptx</code>.';
$string['settings:rag_extract_h5p'] = 'Indeks konten H5P (mod_h5p)';
$string['settings:rag_extract_h5p_desc'] = 'Menelusuri JSON konten H5P dan mengindeks semua ruas yang memuat teks (pertanyaan, jawaban, umpan balik, deskripsi). Metadata jenis konten H5P bersifat luas; beberapa kecocokan keliru wajar terjadi pada kasus batas.';
$string['settings:rag_extract_scorm'] = 'Indeks paket SCORM (mod_scorm)';
$string['settings:rag_extract_scorm_desc'] = 'Mengekstrak paket SCORM dan mengindeks <code>imsmanifest.xml</code>, semua berkas <code>.html</code>, serta untai konten Articulate Storyline. <strong>Nonaktif secara bawaan</strong> karena pemrosesan SCORM bisa mahal. Ukuran paket maksimum ditentukan oleh <code>rag_scorm_max_mb</code>.';
$string['settings:rag_scorm_max_mb'] = 'Ukuran paket SCORM maksimum untuk diindeks (MB)';
$string['settings:rag_scorm_max_mb_desc'] = 'Melewati paket SCORM yang lebih besar dari nilai ini untuk menghindari pemakaian memori berlebihan.';
$string['settings:rag_fetch_transcripts'] = 'Ambil transkrip untuk video dan konten interaktif yang disematkan';
$string['settings:rag_fetch_transcripts_desc'] = 'Memindai konten mod_page dan mod_book untuk mencari iframe yang disematkan (Synthesia, YouTube, Articulate, Genially) dan mengambil alamat transkrip yang menyertai setiap sematan (mencari di atas maupun di bawah bingkai). Memerlukan koneksi HTTPS keluar dari peladen ini ke host transkrip. <strong>Nonaktif secara bawaan</strong>; aktifkan setelah penyedia transkrip menambahkan peladen ini ke daftar izinnya (misalnya melalui aturan Cloudflare berbasis IP).';
$string['settings:rag_iframe_host_patterns'] = 'Pola host iframe';
$string['settings:rag_iframe_host_patterns_desc'] = 'Satu ekspresi reguler per baris yang dicocokkan dengan atribut <code>src</code> sebuah iframe. Setiap bingkai yang cocok diperlakukan sebagai sematan interaktif yang transkripnya perlu dipasangkan dan diindeks. Baris yang diawali <code>#</code> adalah komentar.';
$string['settings:rag_transcript_url_pattern'] = 'Pola alamat transkrip';
$string['settings:rag_transcript_url_pattern_desc'] = 'Ekspresi reguler yang dicocokkan dengan alamat tautan transkrip. Untuk setiap iframe yang terdeteksi, pengindeks memilih tautan cocok terdekat (di atas atau di bawahnya) lalu memasangkannya. Kosongkan untuk menonaktifkan pemasangan transkrip.';
$string['settings:performance_heading'] = 'Kinerja';
$string['settings:performance_heading_desc'] = 'Mengatur seberapa banyak konten kursus yang disertakan dalam prompt AI. Nilai yang lebih kecil berarti jawaban lebih cepat tetapi konteks bagi AI lebih sedikit.';
$string['settings:max_content_per_resource'] = 'Konten maksimum per sumber daya (karakter)';
$string['settings:max_content_per_resource_desc'] = 'Jumlah karakter konten maksimum yang diambil dari setiap halaman atau bab buku. Nilai yang lebih kecil memperkecil ukuran prompt dan mempercepat jawaban.';
$string['settings:max_total_content'] = 'Total konten maksimum (karakter)';
$string['settings:max_total_content_desc'] = 'Jumlah total karakter konten kursus maksimum yang disertakan dalam prompt sistem. Nilai yang lebih kecil memperkecil ukuran prompt dan mempercepat jawaban.';
$string['settings:spend_guard_heading'] = 'Pelindung biaya dan pengoptimal';
$string['settings:spend_guard_heading_desc'] = 'Tetapkan batas biaya LLM per periode. Saat batas tercapai, [[tutorshort]] menghentikan permintaan atau beralih ke penyedia yang lebih murah dalam rantai cadangan Anda. Lihat <a href="{$a}">halaman Biaya token</a> untuk status pengeluaran terkini dan rekomendasi pengoptimal.';
$string['settings:spend_cap_period'] = 'Periode batas biaya';
$string['settings:spend_cap_period_desc'] = 'Seberapa sering batas biaya diatur ulang. Selaras dengan kalender: bulanan dimulai tanggal 1, mingguan pada hari Senin, dan harian pada tengah malam.';
$string['settings:spend_cap_site'] = 'Batas biaya seluruh situs (USD)';
$string['settings:spend_cap_site_desc'] = 'Batas gabungan dalam USD untuk semua kursus dan fitur pada periode berjalan. <code>0</code> = tanpa batas. Batas per fitur di bawah lebih diutamakan bila diisi.';
$string['settings:spend_cap_chat'] = 'Batas obrolan (USD)';
$string['settings:spend_cap_chat_desc'] = 'Batas khusus untuk obrolan dan kuis pelajar. <code>0</code> = memakai batas seluruh situs.';
$string['settings:spend_cap_voice'] = 'Batas suara (USD)';
$string['settings:spend_cap_voice_desc'] = 'Batas untuk suara (Realtime + TTS + STT). Suara biasanya pos pengeluaran terbesar — batasi lebih dulu.';
$string['settings:spend_cap_rag'] = 'Batas RAG (USD)';
$string['settings:spend_cap_rag_desc'] = 'Batas untuk panggilan penyematan yang dilakukan saat pengindeksan kursus.';
$string['settings:spend_cap_analytics'] = 'Batas analitik (USD)';
$string['settings:spend_cap_analytics_desc'] = 'Batas untuk kueri Learning Radar oleh administrator.';
$string['settings:spend_failover_chain'] = 'Rantai cadangan';
$string['settings:spend_failover_chain_desc'] = 'Saat batas tercapai, [[tutorshort]] mencoba penyedia berikut secara berurutan. Satu entri per baris, dalam bentuk <code>capability:label</code>. Label merujuk ke entri pada Penyedia pembanding (untuk <code>chat</code> / <code>analytics</code>) atau Penyedia suara (untuk <code>voice</code>). Baris yang diawali <code>#</code> adalah komentar. Contoh:<br><code>chat:claude-haiku<br>chat:ollama-local<br>voice:openai-prod<br>analytics:deepseek</code>';
$string['settings:failover_per_call_enabled'] = 'Peralihan cadangan per panggilan (v5.5.0)';
$string['settings:failover_per_call_enabled_desc'] = 'Jika aktif, setiap panggilan obrolan membungkus penyedia utama dengan dekorator rantai cadangan. Bila suatu panggilan mengalami waktu habis atau galat 5xx, [[tutorshort]] beralih ke entri berikutnya pada <strong>rantai cadangan</strong> di atas dan membuka sirkuit 15 menit untuk penyedia yang gagal. Setiap peralihan menulis baris audit (<code>failover_fallthrough</code>); setelah diaktifkan, periksa Administrasi -> [[tutorshort]] -> Log audit untuk memastikan rantai bekerja. Nonaktif secara bawaan; aktifkan hanya setelah rantai divalidasi dan institusi Anda memastikan tersedianya perjanjian pemrosesan data yang diperlukan untuk setiap penyedia dalam rantai.';
$string['settings:failover_timeout_chat'] = 'Cadangan: waktu habis obrolan (detik)';
$string['settings:failover_timeout_chat_desc'] = 'Berapa lama menunggu token pertama dari penyedia obrolan sebelum beralih. Bawaan 8 dtk. Nilai yang lebih kecil menjauh lebih cepat dari penyedia yang lambat, dengan konsekuensi lebih banyak alarm palsu pada permintaan yang lambat sesaat; nilai yang lebih besar menahan rantai lebih lama pada penyedia utama. Hanya berlaku bila <strong>peralihan cadangan per panggilan</strong> aktif.';
$string['settings:spend_notify_emails'] = 'Penerima peringatan biaya';
$string['settings:spend_notify_emails_desc'] = 'Alamat surel yang dipisahkan koma dan akan diberi tahu pada 80%, 95%, dan 100% dari batas. Kosongkan untuk memberi tahu semua administrator situs.';
$string['settings:opt_cost_weight'] = 'Pengoptimal: bobot biaya';
$string['settings:opt_cost_weight_desc'] = 'Seberapa besar pengoptimal mempertimbangkan biaya saat memeringkat penyedia. 0.0 mengabaikan biaya, 1.0 mengoptimalkan murni berdasarkan biaya. Ditimbang bersama bobot kualitas.';
$string['settings:opt_quality_weight'] = 'Pengoptimal: bobot kualitas';
$string['settings:opt_quality_weight_desc'] = 'Seberapa besar pengoptimal mempertimbangkan kepuasan pelajar (proporsi penilaian positif) saat memeringkat penyedia. 0.0 mengabaikan kualitas.';
$string['settings:inactivity_reminder_enabled'] = 'Pengingat ketidakaktifan';
$string['settings:inactivity_reminder_enabled_desc'] = 'Mengirim surel mingguan kepada pelajar yang belum membuka kursusnya selama jumlah hari yang ditetapkan.';
$string['settings:inactivity_threshold_days'] = 'Ambang ketidakaktifan (hari)';
$string['settings:inactivity_threshold_days_desc'] = 'Berapa hari tidak aktif sebelum surel pengingat dikirim.';
$string['settings:voice_providers_heading'] = 'Penyedia suara (Realtime, TTS, STT)';
$string['settings:voice_providers_heading_desc'] = 'Konfigurasikan satu atau beberapa penyedia API suara. Pengaturan ini terpisah dari penyedia obrolan di atas dan penyedia penyematan untuk RAG — suara memiliki daftar penyedia sendiri karena saat ini hanya OpenAI dan xAI yang menyediakan titik akhir Realtime berbasis WebSocket, TTS, dan STT. Gunakan daftar pilihan di bawah untuk menentukan penyedia terdaftar mana yang menangani setiap fungsi. Jika tidak ada baris yang ditetapkan, perilaku lama dengan satu kunci berlaku (kunci API Realtime di atas atau kunci OpenAI utama). Situs yang memakai Together AI / Anthropic / DeepSeek / Gemini / Mistral untuk obrolan harus mengatur setidaknya satu baris di sini agar suara berfungsi.';
$string['settings:voice_active_realtime'] = 'Penyedia Realtime aktif';
$string['settings:voice_active_realtime_desc'] = 'Penyedia suara terkonfigurasi mana yang menangani sesi agen suara Realtime.';
$string['settings:voice_active_tts'] = 'Penyedia TTS aktif';
$string['settings:voice_active_tts_desc'] = 'Penyedia suara terkonfigurasi mana yang membacakan jawaban AI.';
$string['settings:voice_active_stt'] = 'Penyedia STT aktif';
$string['settings:voice_active_stt_desc'] = 'Penyedia mana yang mengubah ucapan pelajar menjadi teks. Kosongkan agar peladen Whisper swakelola diutamakan bila dikonfigurasi di bawah, lalu baris penyedia suara pertama atau kunci lama.';
$string['settings:stt_selfhosted_enabled'] = 'Aktifkan transkripsi swakelola';
$string['settings:stt_selfhosted_enabled_desc'] = 'Menggunakan peladen Whisper swakelola di bawah sebagai jalur ucapan-ke-teks untuk masukan suara dan Soapbox. Memerlukan alamat peladen di bawah. Jika nonaktif, transkripsi kembali ke jalur terkelola (OpenAI Whisper) atau jalur peramban, meskipun alamatnya sudah diisi.';
$string['settings:stt_selfhosted_warm'] = 'Panaskan saat rekaman Soapbox dimulai';
$string['settings:stt_selfhosted_warm_desc'] = 'Jika aktif, memulai rekaman Soapbox akan mengirim permintaan "pemanasan" ringan (sebisa mungkin) ke peladen transkripsi swakelola, sehingga host yang menyusut ke nol (misalnya Cloud Run) sempat menyala saat pelajar masih merekam — dengan begitu jeda mulai dingin tetap tersembunyi dari transkripsi yang berjalan ketika dikirim. Tidak berpengaruh jika alamat peladen swakelola belum diisi di atas. Nonaktif secara bawaan.';
$string['settings:voice_tab_enabled'] = 'Aktifkan tab Suara';
$string['settings:voice_tab_enabled_desc'] = 'Menampilkan tab Suara di bilah navigasi bawah. Jika nonaktif, pelajar hanya melihat tab Obrolan dan Catatan. Fitur suara (latihan percakapan, latihan pelafalan) tetap dapat diakses melalui pembuka percakapan bila diaktifkan tersendiri.';
$string['settings:soapbox_heading'] = 'Soapbox';
$string['settings:soapbox_heading_desc'] = 'Latihan presentasi lisan: bagaimana rekaman ditranskripsikan dan dinilai dengan rubrik apa. Aktifkan Soapbox per kursus dengan sakelar Soapbox di bagian Pedagogi.';
$string['settings:soapbox_max_seconds'] = 'Durasi rekaman Soapbox maksimum (detik)';
$string['settings:soapbox_max_seconds_desc'] = 'Batas atas mutlak durasi rekaman untuk tugas apa pun. Pengajar dapat menetapkan rentang yang lebih pendek. Bawaan 720 (12 menit).';
$string['settings:soapbox_max_recordings'] = 'Rekaman Soapbox maksimum per pelajar dan tugas';
$string['settings:soapbox_max_recordings_desc'] = 'Batas atas mutlak jumlah rekaman yang dapat dibuat pelajar untuk satu tugas, terlepas dari pengaturan percobaan per tugas. Bawaan 3.';
$string['settings:soapbox_retention_days'] = 'Masa simpan rekaman Soapbox (hari)';
$string['settings:soapbox_retention_days_desc'] = 'Berapa lama rekaman disimpan sebelum dihapus otomatis; transkrip, nilai, dan umpan balik tetap dipertahankan. Dibatasi pada 1–28 hari. Makin singkat makin baik untuk meminimalkan data. Bawaan 7.';
$string['settings:soapbox_video_quality'] = 'Kualitas video Soapbox';
$string['settings:soapbox_video_quality_desc'] = 'Resolusi dan laju bit rekaman. Ini faktor utama biaya dan lebar pita; penyaji dalam bidikan sedang tetap terlihat jelas pada kualitas standar. Kualitas rendah cocok untuk koneksi lemah; kualitas tinggi hanya bila detail visual penting.';
$string['settings:soapbox_storage_bucket'] = 'Bucket penyimpanan Soapbox';
$string['settings:soapbox_storage_bucket_desc'] = 'Bucket S3 untuk rekaman. Bawaan: bucket arsip bersama.';
$string['settings:soapbox_storage_region'] = 'Wilayah penyimpanan Soapbox';
$string['settings:soapbox_storage_region_desc'] = 'Wilayah AWS untuk bucket, misalnya us-east-1.';
$string['settings:soapbox_storage_prefix'] = 'Awalan kunci penyimpanan Soapbox';
$string['settings:soapbox_storage_prefix_desc'] = 'Awalan kunci di dalam bucket. Rekaman disimpan di bawah jalur ini agar dapat disasar oleh aturan siklus hidup.';
$string['settings:soapbox_storage_key'] = 'ID kunci akses penyimpanan Soapbox';
$string['settings:soapbox_storage_key_desc'] = 'ID kunci akses milik prinsipal IAM yang dibatasi pada PutObject/GetObject/DeleteObject untuk awalan di atas.';
$string['settings:soapbox_storage_secret'] = 'Kunci akses rahasia penyimpanan Soapbox';
$string['settings:soapbox_storage_secret_desc'] = 'Kunci akses rahasia yang berpasangan dengan ID kunci akses di atas.';
$string['settings:survey_heading'] = 'Survei pelajar';
$string['settings:survey_heading_desc'] = 'Konfigurasikan survei pengalaman pelajar di dalam obrolan. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Ubah pertanyaan survei &rarr;</a>';
$string['settings:survey_enabled'] = 'Aktifkan survei';
$string['settings:survey_enabled_desc'] = 'Jika aktif, pelajar akan ditawari untuk mengisi survei tentang pengalaman mereka dengan tutor AI.';
$string['settings:survey_trigger_messages'] = 'Tampilkan setelah N pesan';
$string['settings:survey_trigger_messages_desc'] = 'Menampilkan ajakan survei setelah pelajar mengirim sejumlah pesan ini dalam satu kursus. Setel 0 agar hanya tampil saat dipicu manual.';
$string['settings:survey_frequency'] = 'Frekuensi survei per pengguna';
$string['settings:survey_frequency_desc'] = 'Seberapa sering seorang pelajar dapat diajak mengisi survei di setiap kursus.';
$string['settings:rubric_heading'] = 'Rubrik latihan';
$string['settings:rubric_heading_desc'] = 'Konfigurasikan rubrik penilaian untuk sesi latihan percakapan dan pelafalan. Di akhir sesi latihan, pelajar menerima nilai dan umpan balik hasil AI. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Ubah rubrik &rarr;</a>';
$string['settings:practice_scoring_enabled'] = 'Aktifkan penilaian latihan';
$string['settings:practice_scoring_enabled_desc'] = 'Jika aktif, setelah sesi latihan percakapan dan pelafalan, pelajar menerima kartu nilai berisi penilaian per kriteria dan umpan balik.';
$string['settings:usertesting_heading'] = 'Uji kebergunaan';
$string['settings:usertesting_heading_desc'] = 'Uji kebergunaan di dalam widget dengan penilaian berbasis tugas. Pelajar menyelesaikan tugas di asisten dan menilai pengalamannya. Hasilnya muncul di dasbor analitik.';
$string['settings:usertesting_enabled'] = 'Aktifkan uji kebergunaan';
$string['settings:usertesting_enabled_desc'] = 'Menampilkan tautan "Uji kebergunaan" di kaki widget. Jika aktif, pelajar dapat mengakses tugas-tugas pengujian.';
$string['settings:usertesting_external_url'] = 'Alamat formulir eksternal (varian C)';
$string['settings:usertesting_external_url_desc'] = 'Opsional: alamat formulir eksternal (misalnya Google Forms atau Typeform). Gunakan penanda: {{userid}}, {{courseid}}, {{messages}}, {{session_minutes}}. Bila diisi, klik pada "Uji kebergunaan" membuka alamat ini dengan konteks yang sudah terisi. Kosongkan untuk hanya memakai panel pengujian di dalam widget.';
$string['settings:footer_links_heading'] = 'Tautan kaki';
$string['settings:footer_links_heading_desc'] = 'Sesuaikan tautan yang tampil di bagian bawah asisten: tautan opsional ke daftar kursus di bawah tautan umpan balik, serta redaksi tautan umpan balik dan panelnya.';
$string['settings:footer_courses_text'] = 'Teks tautan kursus';
$string['settings:footer_courses_text_desc'] = 'Teks tautan yang tampil di bawah tautan umpan balik. Kosongkan untuk menyembunyikan tautan sepenuhnya.';
$string['settings:footer_courses_url'] = 'Alamat tautan kursus';
$string['settings:footer_courses_url_desc'] = 'Tujuan tautan kursus (terbuka di tab baru). Tautan disembunyikan jika ruas ini kosong.';
$string['settings:feedback_link_label'] = 'Label tautan umpan balik';
$string['settings:feedback_link_label_desc'] = 'Mengganti teks tautan umpan balik di kaki halaman, misalnya "Kirim masukan tentang [[tutorshort]] ke tim TI". Kosongkan untuk memakai label terjemahan bawaan "Umpan balik".';
$string['settings:feedback_panel_intro'] = 'Pengantar panel umpan balik';
$string['settings:feedback_panel_intro_desc'] = 'Baris pengantar yang tampil di bagian atas panel umpan balik. Menjelaskan ke mana masukan dikirim. Kosongkan agar tidak ada baris pengantar.';
$string['settings:quiz_provider'] = 'Penyedia asisten kuis';
$string['settings:quiz_provider_desc'] = 'ID penyedia (misalnya <code>claude</code> atau <code>openai</code>) untuk pembuatan kuis. Harus cocok dengan salah satu baris pada Penyedia pembanding. Kosongkan untuk memakai penyedia obrolan.';
$string['settings:quiz_model'] = 'Model asisten kuis';
$string['settings:quiz_model_desc'] = 'Nama model untuk pembuatan kuis, misalnya <code>claude-haiku-4-5</code>. Baik ruas ini maupun penyedia harus diisi agar penggantian berlaku.';
$string['settings:branding_heading'] = 'Identitas merek';
$string['settings:branding_heading_desc'] = 'Sesuaikan nama dan tampilan asisten.';
$string['settings:institution_short_name'] = 'Nama singkat institusi';
$string['settings:institution_short_name_desc'] = 'Nama singkat institusi untuk elemen antarmuka yang sempit (misalnya "State U").';
$string['settings:display_name'] = 'Nama tampilan asisten';
$string['settings:display_name_desc'] = 'Nama lengkap asisten AI sebagaimana muncul dalam sapaan dan di layar sambutan (misalnya "Asisten Belajar Daring").';
$string['settings:short_name'] = 'Nama singkat asisten';
$string['settings:short_name_desc'] = 'Nama pendek yang dipakai di bilah judul dan elemen antarmuka yang sempit (misalnya "Asisten").';
$string['settings:welcome_message'] = 'Pesan layar sambutan';
$string['settings:welcome_message_desc'] = 'Pesan yang tampil di layar sambutan pada kunjungan pertama. Gunakan <code>{{firstname}}</code> untuk nama depan pelajar dan <code>{{coursename}}</code> untuk nama kursus. Kosongkan untuk teks bawaan.';
$string['settings:chat_greeting'] = 'Sapaan obrolan';
$string['settings:chat_greeting_desc'] = 'Pesan sapaan yang tampil saat jendela obrolan dibuka. Gunakan <code>{{firstname}}</code> untuk nama depan pelajar dan <code>{{coursename}}</code> untuk nama kursus. Kosongkan untuk teks bawaan.';
$string['settings:customavatars'] = 'Avatar khusus';
$string['settings:customavatars_desc'] = 'Unggah gambar PNG atau SVG berbentuk persegi di sini untuk menambahkannya ke daftar avatar di atas. Setiap berkas yang diunggah menjadi pilihan bawaan yang dapat dipilih (dengan awalan "Custom:"). Hapus berkas dari daftar ini untuk mengeluarkannya dari daftar pilihan. Tips: PNG 256×256 terlihat tajam di layar Retina.';
$string['settings:anomaly_digest_heading'] = 'Learning Radar — ringkasan anomali';
$string['settings:anomaly_digest_heading_desc'] = 'Pemeriksaan harian yang membandingkan rentang bergulir untuk penilaian negatif, pengeluaran token, dan penanda integritas. Bila suatu indikator melewati ambang yang ditetapkan, ringkasan dikirim ke saluran yang dikonfigurasi. Untuk laporan terjadwal per kueri, gunakan panel Jadwal di halaman analitik [[tutorshort]].';
$string['settings:anomaly_digest_enabled'] = 'Aktifkan ringkasan anomali';
$string['settings:anomaly_digest_enabled_desc'] = 'Menjalankan tugas harian ringkasan anomali. Secara bawaan senyap — hanya terpicu bila suatu indikator melewati ambang.';
$string['settings:anomaly_digest_threshold_pct'] = 'Ambang peringatan (%)';
$string['settings:anomaly_digest_threshold_pct_desc'] = 'Perubahan persentase antara rentang terkini dan rentang sebelumnya yang memicu peringatan. Bawaan: 50.';
$string['settings:anomaly_digest_recipient_email'] = 'Alamat surel penerima';
$string['settings:anomaly_digest_recipient_email_desc'] = 'Alamat surel yang menerima ringkasan anomali. Kosongkan untuk memakai alamat administrator situs.';
$string['settings:anomaly_digest_slack_webhook'] = 'Alamat webhook masuk Slack';
$string['settings:anomaly_digest_slack_webhook_desc'] = 'Alamat webhook masuk Slack (opsional). Ringkasan diposkan sebagai pesan blok Slack.';
$string['settings:anomaly_digest_teams_webhook'] = 'Alamat webhook masuk Microsoft Teams';
$string['settings:anomaly_digest_teams_webhook_desc'] = 'Alamat webhook masuk Teams (opsional). Ringkasan diposkan sebagai kartu konektor Office 365.';

$string['radar_report:title'] = 'Laporan Learning Radar [[tutorshort]]';
$string['radar_report:print'] = 'Cetak / simpan sebagai PDF';
$string['radar_report:generated'] = 'Dibuat pada {$a}';
...
$string['privacy:metadata:outreach_log:dryrun'] = 'Apakah baris ini ditulis dalam mode uji coba (dry-run) — tidak ada email yang benar-benar dikirim.';
$string['flashcards:starter_saved'] = '{$a} flashcard dari halaman ini telah disimpan.';
$string['flashcards:starter_open_review'] = 'Buka halaman tinjauan untuk mempelajarinya dengan pengulangan berjarak (spaced repetition).';
$string['flashcards:starter_failed'] = 'Saya tidak dapat membuat flashcard dari halaman ini ({$a}). Coba lagi atau pilih halaman dengan lebih banyak konten.';
$string['flashcards:starter_error'] = 'Saat ini saya tidak dapat membuat flashcard dari halaman ini. Coba lagi nanti.';
$string['soapbox:no_media_support'] = 'Browser ini tidak dapat merekam audio di sini. Gunakan Chrome, Edge, Firefox, atau Safari versi terbaru melalui koneksi aman (https).';
