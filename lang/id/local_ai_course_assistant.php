...
$string['settings:prompt_budget_mode_desc'] = 'Bagaimana anggaran karakter prompt sistem ditentukan. <strong>Turunkan dari model</strong> menghitung ruang yang benar-benar disediakan model yang dikonfigurasi — jendela konteksnya, dikurangi balasan yang dicadangkan dan riwayat percakapan — lalu memakai nilai yang lebih besar antara itu dan anggaran tetap di bawah. Ini pengaturan yang disarankan: angka tetap sudah dua kali ditentukan dengan mengukur satu konfigurasi, dan dua kali pula terbukti terlalu kecil pada konfigurasi lain. <strong>Tetap</strong> hanya memakai angka di bawah. Backend yang di-hosting sendiri sebaiknya menyetel jendela konteks backend, yang selalu didahulukan.';
