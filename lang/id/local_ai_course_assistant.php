...
$string['settings:backend_retry_max_wait_desc'] = 'Batas atas, dalam detik, atas berapa lama menghormati header Retry-After dari backend sebelum mencoba ulang. Bila backend tidak mengirim Retry-After, SOLA menggunakan backoff eksponensial singkat sebagai gantinya. Bawaan 5.';
...
$string['settings:stt_selfhosted_heading_desc'] = 'Jalankan pengenalan suara ke teks di perangkat keras Anda sendiri tanpa biaya per menit. Arahkan SOLA ke server transkripsi yang kompatibel dengan OpenAI: Docker <code>whisper-server</code>, <code>speaches</code> (faster-whisper), atau server <code>whisper.cpp</code>. Bila URL server diatur di sini, ini menjadi jalur STT bawaan; pilih penyedia berbayar di pengaturan Penyedia STT aktif di atas untuk menimpanya. Bila server berada di jaringan pribadi atau HTTP biasa, tambahkan juga hostnya ke daftar izin titik akhir tepercaya SSRF di bagian Keamanan.';
$string['settings:stt_selfhosted_url'] = 'URL Server STT yang Dihosting Sendiri';
$string['settings:stt_selfhosted_url_desc'] = 'URL dasar server transkripsi yang kompatibel dengan OpenAI, misalnya <code>http://10.0.0.5:8000</code>. SOLA secara otomatis menambahkan <code>/v1/audio/transcriptions</code>; jalur titik akhir lengkap juga diterima. Biarkan kosong untuk menonaktifkan STT yang dihosting sendiri.';
...
$string['emergency:title'] = 'Kontrol Darurat SOLA';
$string['emergency:page_warning'] = 'Sakelar-sakelar ini langsung berlaku untuk setiap pelajar di situs. Setiap tindakan menulis baris audit. Sakelar granular membiarkan sisa SOLA tetap berjalan; pemutus utama menghapus widget sepenuhnya.';
$string['emergency:back_to_settings'] = 'Pengaturan SOLA';
...
$string['emergency:flag_chat_desc'] = 'Memblokir lalu lintas chat melalui flag pemutus khusus (perbaikan v5.13). Widget tetap ditampilkan; pelajar melihat pesan "SOLA dijeda" yang ramah. Gunakan bila penyedia LLM bermasalah atau lonjakan biaya sedang terjadi.';
...
$string['emergency:flag_all_desc'] = 'Menonaktifkan seluruh plugin: widget hilang dari setiap halaman, tugas terjadwal berhenti, suara dihapus, RAG dimatikan, penjangkauan dimatikan. Sakelar terkuat — gunakan untuk insiden keamanan atau bila SOLA harus diambil offline segera.';
$string['emergency:settings_link'] = 'Kontrol darurat';
$string['emergency:settings_link_desc'] = 'Sakelar pemutus per subsistem (chat / suara / RAG / penjangkauan / utama) dengan pencatatan audit — padanan web dari <code>admin/cli/emergency_disable.php</code>. Buka <a href="{$a}">Kontrol Darurat SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Berhenti berlangganan';
$string['email_unsubscribe:done_body'] = 'Selesai — {$a->email} tidak akan lagi menerima jenis email ini dari {$a->product}. Jika Anda berubah pikiran, minta administrator {$a->product} untuk mengaktifkan kembali langganan, atau kirim permintaan opt-in baru melalui halaman admin Penerima SOLA.';
...
$string['settings:cost_anomaly_heading_desc'] = 'Tugas terjadwal harian (<code>cost_anomaly_check</code>) yang membandingkan pengeluaran SOLA seluruh situs hari ini dengan median bergulir 7 hari. Mengirim email ke daftar penerima <code>spend_notify_emails</code> (kembali ke admin situs) bila hari ini melebihi pengganda yang dikonfigurasi × median. Menangkap tiga mode kegagalan yang dilewatkan oleh ambang batas pengeluaran 80% / 95% / 100% yang ada: (1) kursus tak terkendali di mana batas absolut tidak dilanggar tetapi satu kursus tiba-tiba mendorong 10x volume biasanya, (2) pengaktifan tier premium yang tidak disengaja, (3) kesalahan rute penyedia. Nonaktif secara bawaan; setara SOLA-internal dengan kueri Redash di <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
