...
$string['settings:embed_input_type_mode_desc'] = 'Embedding Voyage rekk. "Shared space" day embed laaj yi ak dokimaan yi ci benn yoon, noonu ñaar ñi ñu mën leen comparer ci kanam benn soppi modèle. "Asymmetric" day jëfandikoo projection laaj bu Voyage bopp; mooy optimisation bi prestataire bi digal waaye antuwul a wone benn jariñ ci corpus bii ñaari yoon, noonu shared mooy bu defawu. Soppi lii soxlawul benn index bu bees.';
$string['settings:embed_input_type_shared'] = 'Shared space (ñu ko digal)';
