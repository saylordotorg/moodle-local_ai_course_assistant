...
$string['settings:stt_selfhosted_heading_desc'] = 'Kendi donanımınızda dakika başına sıfır maliyetle metne dönüştürme çalıştırın. SOLA\'yı herhangi bir OpenAI uyumlu transkripsiyon sunucusuna yönlendirin: <code>whisper-server</code> Docker, <code>speaches</code> (faster-whisper) veya <code>whisper.cpp</code> sunucusu. Burada bir sunucu URL\'si ayarlandığında varsayılan STT yolu olur; geçersiz kılmak için yukarıdaki Aktif STT sağlayıcısında ücretli bir sağlayıcı seçin. Sunucu özel bir ağda veya düz http üzerindeyse, Güvenlik bölümündeki SSRF güvenilir uç nokta allowlist\'ine host\'unu da ekleyin.';
$string['settings:stt_selfhosted_url'] = 'Selfhosted STT sunucu URL\'si';
$string['settings:stt_selfhosted_url_desc'] = 'OpenAI uyumlu transkripsiyon sunucusunun temel URL\'si, örneğin <code>http://10.0.0.5:8000</code>. SOLA, <code>/v1/audio/transcriptions</code> yolunu otomatik olarak ekler; tam uç nokta yolu da kabul edilir. Kendi barındırılan STT\'yi devre dışı bırakmak için boş bırakın.';
...
$string['emergency:title'] = 'SOLA Acil Durum Kontrolleri';
$string['emergency:page_warning'] = 'Bu anahtarlar, sitedeki her öğrenci için hemen geçerli olur. Her eylem bir denetim satırı yazar. Ayrıntılı anahtarlar SOLA\'nın geri kalanının çalışmaya devam etmesine izin verir; ana öldürme widget\'ı tamamen kaldırır.';
$string['emergency:back_to_settings'] = 'SOLA Ayarları';
...
$string['emergency:flag_chat_desc'] = 'Özel kill flag aracılığıyla sohbet trafiğini engeller (v5.13 düzeltmesi). Widget oluşturmaya devam eder; öğrenciler dostane "SOLA duraklatıldı" mesajını görür. Bir LLM sağlayıcısı hatalı davrandığında veya bir maliyet artışı yaşandığında kullanın.';
...
$string['emergency:flag_all_desc'] = 'Eklentinin tamamını devre dışı bırakır: her sayfadan widget kaybolur, zamanlanmış görevler durur, ses temizlenir, RAG kapalı, outreach kapalı. En güçlü anahtar — bir güvenlik olayı için veya SOLA\'nın hemen çevrimdışına alınması gerektiğinde kullanın.';
$string['emergency:settings_link'] = 'Acil durum kontrolleri';
$string['emergency:settings_link_desc'] = 'Denetim günlüğü kaydı ile alt sistem başına kill anahtarları (sohbet / ses / RAG / outreach / ana) — <code>admin/cli/emergency_disable.php</code> web eşdeğeri. <a href="{$a}">SOLA Acil Durum Kontrollerini</a> açın.';
$string['email_unsubscribe:done_title'] = 'Abonelik iptal edildi';
$string['email_unsubscribe:done_body'] = 'Tamam — {$a->email} artık {$a->product} üzerinden bu tür e-posta almayacak. Fikrinizi değiştirirseniz, aboneliği yeniden etkinleştirmek için bir {$a->product} yöneticisine sorun ya da SOLA Alıcıları yönetici sayfası aracılığıyla yeni bir onay gönderin.';
...
$string['analytics:exp_active_users'] = 'Aktif SOLA kullanıcıları';
