...
$string['chat:consent_body'] = '{$a->product}, AI destekli bir öğrenme asistanıdır. Mesajlarınız ve {$a->product} yanıtları {$a->institution} kuruluşunun Moodle veritabanında saklanır ve en son on tur, sorularınızı yanıtlamak için onaylı bir AI model sağlayıcısına gönderilir. Kişiselleştirme için adınız paylaşılır; AI sağlayıcısına başka hiçbir kimlik bilgisi gönderilmez. İnsan yardımı isterseniz ve sorunuz yükseltilirse, bu konuşma (adınız ve e-postanız dahil) destek ekibimizle paylaşılabilir. {$a->product} ürününü istediğiniz zaman indirebilir, silebilir veya kullanmayı bırakabilirsiniz.';
...
$string['settings:current_page_content_maxchars_desc'] = 'RAG kapalıyken sistem istemine "Current Page Content" bölümü olarak eklenen geçerli sayfa metninin maksimum karakter sayısı. Varsayılan 8,000, yapı ve talimatlar için bütçe bırakırken sayfaya özgü soruları iyi temellendirir. (RAG etkinleştirildiğinde sayfa, geçerli sayfaya yönelik kendi en ilgili parçalarıyla temellendirilir, bu nedenle bu sınır geçerli olmaz.) Çok uzun bir sayfa baştan bu kadar karaktere kırpılır, bu nedenle aşırı uzun bir sayfanın sonu alıntılanmayabilir; RAG\'ı etkinleştirmek bunu önler. Maliyete duyarlı siteler daha düşük ayarlayabilir (örn. 3,000-4,000). 500-8,000 aralığına sınırlandırılır. <code>prompt_budget_chars</code> değerinden bağımsızdır: bu yalnızca sayfa bölümünü sınırlar; bütçe ise istemin tamamını sınırlar.';
...
$string['settings:backend_context_tokens'] = 'Arka uç bağlam penceresi (token)';
$string['settings:backend_context_tokens_desc'] = 'AI arka ucunuzun token cinsinden maksimum bağlam uzunluğu (max_model_len). Büyük pencereye sahip barındırılan modeller için 0 olarak ayarlayın (kırpma yok). 0\'ın üzerine ayarlandığında (örneğin kendi barındırdığınız bir vLLM arka ucunda 8192), SOLA, istem ile birlikte ayrılmış çıktı ve konuşma geçmişinin pencereye sığması için yukarıdaki sistem istemi karakter bütçesini küçültür; bu, token açısından yoğun dillerde bile geçerlidir. Bunun eşzamanlı kullanıcılarla nasıl eşleştiğini öğrenmek için Deployment Sizing wiki sayfasına bakın.';
$string['settings:backend_retry_attempts'] = 'Arka uç yeniden deneme sayısı';
$string['settings:backend_retry_attempts_desc'] = 'Öğrenciye bir hata göstermeden önce geçici bir arka uç hatasının (HTTP 429 veya 503) kaç kez yeniden deneneceği. Yeniden denemeler yalnızca herhangi bir yanıt metni akmadan önce gerçekleşir, bu nedenle çıktı asla yinelenmez. Yük altında istekleri reddeden küçük, kendi barındırılan arka uçlar için tasarlanmıştır. Devre dışı bırakmak için 0 olarak ayarlayın. Varsayılan 2.';
$string['settings:backend_retry_max_wait'] = 'Arka uç yeniden deneme maksimum bekleme süresi (saniye)';
$string['settings:backend_retry_max_wait_desc'] = 'Yeniden denemeden önce arka uçtan gelen bir Retry-After başlığına ne kadar süre uyulacağına dair saniye cinsinden üst sınır. Arka uç Retry-After göndermediğinde, SOLA bunun yerine kısa bir üstel geri çekilme kullanır. Varsayılan 5.';
$string['prompt:truncation_hint'] = 'NOT: Uzunluk sınırlamaları nedeniyle bu turda kurs içeriğinin tamamı aranamadı. Öğrenci, sağlanan içerikte bulamadığınız bir şey hakkında soru sorarsa, kursun tamamını arayamadığınızı söyleyin ve konunun ele alındığı belirli sayfayı veya etkinliği açmalarını önerin; konunun kursta bulunmadığını belirtmek yerine.';
$string['selftest:title'] = 'Arka uç otomatik testi';
$string['selftest:intro'] = 'Yapılandırdığınız AI arka ucunun canlı bir kontrolünü çalıştırın: küçük bir sohbet gidiş-dönüşü, bağlam penceresinin (max_model_len) otomatik algılanması ve Arka uç bağlam penceresi ayarınızla karşılaştırılması, sistem istemi bütçe tabanı ve (RAG açıkken) bir gömme gidiş-dönüşü. Ağ çağrıları yalnızca Çalıştır\'a bastığınızda çalışır.';
$string['selftest:run'] = 'Arka uç otomatik testini çalıştır';
$string['selftest:check'] = 'Kontrol';
$string['selftest:status'] = 'Durum';
$string['selftest:detail'] = 'Ayrıntı';
$string['selftest:link'] = 'Arka uç otomatik test sayfası';
$string['selftest:link_desc'] = 'AI arka ucunuzun çalıştığını ve doğru boyutlandırıldığını doğrulamak için <a href="{$a}">Arka uç otomatik testi</a> sayfasını açın. Kendi barındırdığınız bir arka ucu yapılandırdıktan hemen sonra kullanışlıdır.';
$string['profile:title'] = 'Dağıtım ön ayarları';
$string['profile:intro'] = 'Dağıtım türünüz için önerilen bir ayar paketini uygulayın. Değerler normal eklenti ayarlarına yazılır ve sonrasında bireysel olarak düzenlenebilir kalır. Bir ön ayar uygulamak, listelenen ayarların üzerine yazar.';
$string['profile:current'] = 'Son uygulanan ön ayar: {$a}';
$string['profile:setting'] = 'Ayar';
$string['profile:value'] = 'Değer';
$string['profile:self_hosted_small'] = 'Kendi barındırılan küçük bağlam (tek GPU, örn. A30 24GB / 8K\'da vLLM)';
$string['profile:hosted_large'] = 'Barındırılan büyük bağlam (varsayılan)';
$string['profile:apply_self_hosted_small'] = 'Kendi barındırılan küçük bağlam ön ayarını uygula';
$string['profile:apply_hosted_large'] = 'Barındırılan büyük bağlam varsayılanlarını uygula';
$string['profile:applied'] = '{$a} ön ayarı uygulandı. Değerler artık eklenti ayarlarınızda.';
$string['profile:unknown'] = 'Bilinmeyen dağıtım ön ayarı.';
$string['profile:link'] = 'Dağıtım ön ayarları sayfası';
$string['profile:link_desc'] = 'Barındırılan veya kendi barındırılan bir arka uç için önerilen bir ayar paketini uygulamak amacıyla <a href="{$a}">Dağıtım ön ayarları</a> sayfasını açın.';
$string['settings:zendesk_require_consent'] = 'Destek yükseltmesinden önce onay iste';
$string['settings:zendesk_require_consent_desc'] = 'Açık olduğunda (önerilir), SOLA bir konuşmayı Zendesk destek masasına yalnızca öğrenci, insan yardımı istemenin konuşmayı (ad ve e-posta dahil) destekle paylaştığını açıklayan ilk çalıştırma onay bildirimini kabul ettikten sonra yükseltir. Bu onayı başka bir yolla aldığınız durumda bunu kapatın; kapalıyken yükseltmeler hemen gönderilir. Zendesk yükseltmesi etkinleştirilmedikçe hiçbir etkisi yoktur.';
$string['chat:escalation_needs_consent'] = 'Görünüşe göre bu, destek ekibimizden bir üyenin müdahalesini gerektiriyor. Bunu onlara iletmek için bu konuşmayı, adınız ve e-postanız dahil, destek masasıyla paylaşmam gerekirdi. Buna henüz onay vermediniz, bu nedenle hiçbir şey göndermedim. İnsan yardımı istiyorsanız, lütfen bu asistan için veri paylaşım bildirimini kabul edip tekrar sorun veya doğrudan destekle iletişime geçin.';
$string['privacy:metadata:email_optout'] = 'Alıcı bazında e-posta vazgeçme tercihleri (bir alıcının hangi e-posta türlerinden aboneliğini iptal ettiği).';
...
$string['settings:rag_min_similarity'] = 'Minimum İlgililik (kosinüs)';
$string['settings:rag_min_similarity_desc'] = 'Soruyla kosinüs benzerliği bu değerin altında olan getirilen parçaları çıkarır, böylece konu dışı veya yetersiz bir soru, zayıf eşleşmelerle her zaman Top-K\'ya kadar doldurmak yerine daha az (veya hiç) pasaj ekler. Aralık 0 ile 1 arasında; 0 bu kapıyı devre dışı bırakır. Doğru değer embedding modeline bağlıdır: 0.25, text-embedding-3-small için uygundur. Daha katı olması için yükseltin (daha az ama daha konuyla ilgili bağlam), daha esnek olması için düşürün.';
$string['settings:rag_currentpage_boost'] = 'Geçerli Sayfa Artışı';
$string['settings:rag_currentpage_boost_desc'] = 'Öğrencinin şu anda görüntülediği sayfadan gelen parçaların ilgililik puanına eklenen küçük bir bonus, böylece "bunu açıkla" gibi sorular puanlar yakın olduğunda görünür sayfayı tercih eder. Yalnızca sıralama: ilgisiz bir sayfa parçasını minimum ilgililik kapısından geçmeye zorlamaz. Devre dışı bırakmak için 0 olarak ayarlayın.';
$string['settings:history_mode'] = 'Geçmiş Seçim Modu';
$string['settings:history_mode_desc'] = 'Geçmiş konuşma turlarının modele gönderilmeden önce nasıl seçileceği. <strong>Anlamsal</strong> yalnızca geçerli soruyla ilgili son turları (ve her zaman en son alışverişi) tutar, böylece bayat, konu dışı bir önceki tur maliyeti artırmaz veya yanıtı yoldan çıkarmaz; mesaj başına bir ek embedding çağrısı yapar. <strong>Yakınlık</strong>, ilgililiğe bakılmaksızın son "Max Conversation History" çiftini tutar (uzun süredir devam eden davranış, ek çağrı yok). Embedding kullanılamıyorsa, anlamsal mod otomatik olarak yakınlığa geri döner.';
$string['settings:history_mode_semantic'] = 'Anlamsal (ilgili son turlar)';
$string['settings:history_mode_recency'] = 'Yakınlık (son N çift)';
$string['settings:history_semantic_minscore'] = 'Geçmiş İlgililik Tabanı (kosinüs)';
$string['settings:history_semantic_minscore_desc'] = 'Anlamsal geçmiş modunda, geçmiş bir tur yalnızca geçerli soruyla benzerliği en az bu değer olduğunda tutulur (en son alışveriş her zaman tutulur). Aralık 0 ile 1 arasında; modele bağlı. Daha katı olması için yükseltin (daha az geçmiş), daha fazla tutmak için düşürün.';
$string['settings:history_candidates'] = 'Geçmiş Aday Penceresi';
$string['settings:history_candidates_desc'] = 'Anlamsal geçmiş modunda, ilgililik için yalnızca en son bu kadar çift puanlanır (bir maliyet sınırı). Bu pencereden daha eski çiftler gönderilmez. Bunu "Max Conversation History" değerine eşit veya üzerinde tutun.';
