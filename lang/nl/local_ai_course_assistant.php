...
$string['settings:prompt_budget_mode_desc'] = 'Hoe het tekenbudget van de systeemprompt wordt bepaald. <strong>Afleiden uit het model</strong> berekent hoeveel ruimte het ingestelde model werkelijk biedt — het contextvenster, min het gereserveerde antwoord en de gespreksgeschiedenis — en gebruikt de grootste van die waarde en het vaste budget hieronder. Dit is de aanbevolen instelling: een vast getal is al twee keer bepaald door één configuratie te meten en bleek twee keer te klein op een andere. <strong>Vast</strong> gebruikt uitsluitend het getal hieronder. Een zelfgehoste backend stelt beter het contextvenster van de backend in; dat krijgt altijd voorrang.';
