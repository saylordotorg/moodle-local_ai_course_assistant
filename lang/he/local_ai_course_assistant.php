...
$string['soapbox:present_privacy'] = 'ההקלטה שלכם נטענת לאחסון של Saylor כדי שאפשר יהיה לתמלל ולהעריך אותה. רק אתם ומנהלי האתר יכולים לפתוח אותה. היא נמחקת אוטומטית {$a} ימים אחרי ההקלטה, יחד עם תמונות הסטילס ששימשו למשוב על שפת הגוף. התמלול, הציונים והמשוב נשמרים גם אחרי שהווידאו נעלם, אז הורידו את מה שתרצו לשמור.';
