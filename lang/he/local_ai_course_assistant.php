...
הקורסים חייבים להיות מאונדקסים כבר לצורך אחזור; שום דבר נוסף לא מוטמע, ולכן הוספה כאן פועלת מיד ואינה עולה דבר. קורסים מוסתרים מתעלמים מהם, כך שאי אפשר להשתמש בזה כדי לחשוף חומר שסטודנט לא אמור לראות. עד {$a} קורסים. הגדרה ברמת הקורס, היכן שקיימת, מחליפה את הרשימה הזאת במקום להוסיף אליה.';
