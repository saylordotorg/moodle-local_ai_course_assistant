...
$string['settings:escalation_intent_patterns_desc'] = 'ביטוי רגולרי אחד בכל שורה; שורות המתחילות ב-# מתעלמים מהן. כרטיס תמיכה נפתח רק כאשר ההודעה של הלומד עצמו תואמת לאחת מהתבניות, כך שתוכן הקורס אינו יכול לגרום להסלמה בשמו. השאירו ריק כדי להשתמש בברירות המחדל המובנות, המכסות אנגלית וכן ניסוחים נפוצים בספרדית, צרפתית, גרמנית ופורטוגזית. אתרים שהלומדים בהם כותבים בשפה אחרת צריכים להוסיף כאן תבניות: הודעה ללא התאמה משמעה שלא ייפתח כרטיס.';
