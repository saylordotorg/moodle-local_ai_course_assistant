...
$string['settings:embed_input_type_asymmetric'] = 'שאילתה/מסמך אסימטרי';
$string['settings:embed_input_type_mode'] = 'סוג קלט ה-embedding';
$string['settings:embed_input_type_mode_desc'] = 'embeddings של Voyage בלבד. "מרחב משותף" מבצע embedding לשאילתות ולמסמכים באותה דרך, כך שהשניים נשארים ברי השוואה גם לאחר שינוי מודל. "אסימטרי" משתמש בהטלת השאילתה הנפרדת של Voyage; זו האופטימיזציה שהספק מציע, אך היא נכשלה פעמיים בשחזור כל שיפור על הקורפוס הזה, ולכן מרחב משותף הוא ברירת המחדל. שינוי זה אינו דורש אינדוקס מחדש.';
$string['settings:embed_input_type_shared'] = 'מרחב משותף (מומלץ)';
