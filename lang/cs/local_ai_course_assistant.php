...
$string['emergency:title'] = 'Nouzové ovládání SOLA';
$string['emergency:page_warning'] = 'Tyto přepínače se okamžitě projeví u všech studentů na webu. Každá akce zapíše řádek do auditního záznamu. Dílčí přepínače nechávají zbytek SOLA fungovat; hlavní vypínač odstraní widget z každé stránky.';
$string['emergency:back_to_settings'] = 'Nastavení SOLA';
...
$string['emergency:flag_chat_desc'] = 'Blokuje chatovací provoz prostřednictvím vyhrazeného kill příznaku (oprava v5.13). Widget se nadále zobrazuje; studenti vidí přívětivou zprávu „SOLA je pozastaven". Použijte při špatném chování poskytovatele LLM nebo při prudkém nárůstu nákladů.';
...
$string['emergency:flag_all_desc'] = 'Deaktivuje celý zásuvný modul: widget zmizí ze všech stránek, naplánované úlohy se zastaví, hlas se vymaže, RAG je vypnut, oslovování je vypnuto. Nejsilnější přepínač — použijte při bezpečnostním incidentu nebo když musí být SOLA okamžitě odpojen.';
$string['emergency:settings_link'] = 'Nouzové ovládání';
$string['emergency:settings_link_desc'] = 'Kill přepínače pro každý subsystém (chat / hlas / RAG / oslovování / hlavní) s auditním záznamem — webový ekvivalent <code>admin/cli/emergency_disable.php</code>. Otevřete <a href="{$a}">Nouzové ovládání SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Odhlášeno';
$string['email_unsubscribe:done_body'] = 'Hotovo — {$a->email} již nebude dostávat tento typ e-mailů od {$a->product}. Pokud změníte názor, požádejte správce {$a->product} o opětovné aktivování odběru nebo odešlete nový souhlas přes stránku správy příjemců SOLA.';
...
$string['analytics:exp_active_users'] = 'Aktivní uživatelé SOLA';
