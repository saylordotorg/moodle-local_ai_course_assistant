...
$string['chat:consent_body'] = '{$a->product} je studijní asistent poháněný AI. Vaše zprávy a odpovědi {$a->product} se ukládají do databáze Moodle instituce {$a->institution} a nejnovějších deset tahů se odešle schválenému poskytovateli AI modelu, aby odpověděl na vaše otázky. Vaše křestní jméno se sdílí pro personalizaci; žádné další identifikační údaje se poskytovateli AI neodesílají. Pokud požádáte o lidskou pomoc a vaše otázka bude eskalována, tato konverzace (včetně vašeho jména a e-mailu) může být sdílena s naším týmem podpory. {$a->product} si můžete kdykoli stáhnout, odstranit nebo přestat používat.';
...
$string['settings:current_page_content_maxchars_desc'] = 'Maximální počet znaků textu aktuální stránky vložených do systémového promptu jako sekce "Current Page Content", když je RAG vypnutý. Výchozí hodnota 8,000 dobře ukotví otázky specifické pro stránku a přitom ponechá rozpočet na strukturu a instrukce. (Při zapnutém RAG je stránka místo toho ukotvena vlastními nejrelevantnějšími úryvky se sklonem k aktuální stránce, takže tento limit se neuplatní.) Velmi dlouhá stránka se zkrátí od začátku na tento počet znaků, takže konec extrémně dlouhé stránky nemusí být citován; zapnutí RAG tomu zabrání. Weby šetřící náklady mohou nastavit nižší hodnotu (např. 3,000-4,000). Omezeno na rozsah 500-8,000. Nezávislé na <code>prompt_budget_chars</code>: tato hodnota omezuje jen sekci stránky; rozpočet omezuje celý prompt.';
...
$string['pedagogy:learning_path'] = 'Mapa vzdělávací cesty a pobídka k dalšímu kurzu jsou ve výchozím nastavení zapnuty';
$string['pedagogy:learning_path_desc'] = 'Když je zapnuto, SOLA přidá vizuální panel vzdělávací cesty (tlačítko „moje cesta“ v záhlaví widgetu), který zobrazuje program studujícího jako posloupnost kurzů, z nichž každý lze rozbalit na jeho cíle a úroveň zvládnutí studujícím. Když studující splní laťku pro aktuální kurz (dokončení nebo zvládnutí vysokého podílu cílů), SOLA také zobrazí jemný banner „připraven na další kurz“ a zmíní jej v konverzaci. Pouze doporučující; používá vlastní programové přiřazení studujícího; tam, kde se žádný program neuplatní, tiše nedělá nic.';
$string['settings:learning_path_mastery_threshold'] = 'Práh připravenosti vzdělávací cesty (%)';
$string['settings:learning_path_mastery_threshold_desc'] = 'Procento sledovaných cílů kurzu, které musí studující zvládnout, než jej pobídka vzdělávací cesty bude považovat za připraveného na další kurz. Druhým spouštěčem je dokončení kurzu v Moodle; pobídku spustí to, co nastane dříve. Výchozí 80.';
$string['pathpanel_title'] = 'Moje vzdělávací cesta';
$string['pathpanel_open'] = 'Moje vzdělávací cesta';
$string['pathpanel_empty'] = 'Pro tento kurz zatím není k dispozici žádná programová cesta.';
$string['path_position'] = 'Kurz {$a->index} z {$a->total}';
$string['path_status_done'] = 'Hotovo';
$string['path_status_current'] = 'Jste zde';
$string['path_status_upcoming'] = 'Nadcházející';
$string['path_mastery_mastered'] = 'Zvládnuto';
$string['path_mastery_in_progress'] = 'Probíhá';
$string['path_mastery_not_started'] = 'Nezahájeno';
$string['path_mastery_demonstrated_elsewhere'] = 'Prokázáno v jiném kurzu';
$string['nudge_ready_title'] = 'Připraveni pokračovat';
$string['nudge_ready_body'] = 'Skvělá práce — jste připraveni na {$a}.';
$string['nudge_view_path'] = 'Zobrazit moji cestu';
$string['nudge_dismiss'] = 'Zavřít';

// v5.10.x strings (token-aware budgeting, backend retry, self-test, deployment presets, escalation consent, privacy).
$string['settings:backend_context_tokens'] = 'Kontextové okno backendu (tokeny)';
$string['settings:backend_context_tokens_desc'] = 'Maximální délka kontextu (max_model_len) vašeho AI backendu v tokenech. Nastavte na 0 pro hostované modely s velkým oknem (bez omezování). Při nastavení nad 0 (například 8192 na vlastním hostovaném vLLM backendu) SOLA zmenší výše uvedený rozpočet znaků systémové výzvy tak, aby se výzva spolu s rezervovaným výstupem a historií konverzace vešla do okna, a to i v jazycích s vysokou hustotou tokenů. Informace o tom, jak to souvisí se souběžnými uživateli, najdete na wiki stránce Deployment Sizing.';
$string['settings:backend_retry_attempts'] = 'Počet pokusů o opakování backendu';
$string['settings:backend_retry_attempts_desc'] = 'Kolikrát opakovat dočasnou chybu backendu (HTTP 429 nebo 503), než se studentovi zobrazí chyba. Opakování probíhá pouze před tím, než se začne streamovat jakýkoli text odpovědi, takže výstup se nikdy nezduplikuje. Zaměřeno na malé vlastní hostované backendy, které odmítají požadavky při zatížení. Nastavte na 0 pro vypnutí. Výchozí hodnota 2.';
$string['settings:backend_retry_max_wait'] = 'Maximální doba čekání na opakování backendu (sekundy)';
$string['settings:backend_retry_max_wait_desc'] = 'Horní mez v sekundách, jak dlouho respektovat hlavičku Retry-After z backendu před opakováním. Když backend žádnou hlavičku Retry-After neodešle, SOLA místo toho použije krátké exponenciální zpomalení. Výchozí hodnota 5.';
$string['prompt:truncation_hint'] = 'POZNÁMKA: Celý obsah kurzu nebylo možné v tomto tahu prohledat kvůli omezením délky. Pokud se student zeptá na něco, co v poskytnutém obsahu nemůžete najít, řekněte, že jste nemohli prohledat celý kurz, a navrhněte, aby otevřel konkrétní stránku nebo aktivitu, kde je téma probíráno, místo abyste tvrdili, že v kurzu chybí.';
$string['selftest:title'] = 'Vlastní test backendu';
$string['selftest:intro'] = 'Spusťte živou kontrolu vašeho nakonfigurovaného AI backendu: drobnou obousměrnou konverzaci, automatickou detekci kontextového okna (max_model_len) a porovnání s vaším nastavením kontextového okna backendu, dolní mez rozpočtu systémové výzvy a (když je zapnuto RAG) obousměrné vkládání. Síťová volání proběhnou pouze po stisknutí Spustit.';
$string['selftest:run'] = 'Spustit vlastní test backendu';
$string['selftest:check'] = 'Kontrola';
$string['selftest:status'] = 'Stav';
$string['selftest:detail'] = 'Podrobnost';
$string['selftest:link'] = 'Stránka vlastního testu backendu';
$string['selftest:link_desc'] = 'Otevřete stránku <a href="{$a}">Vlastní test backendu</a>, abyste ověřili, že váš AI backend funguje a je správně dimenzován. Užitečné hned po nakonfigurování vlastního hostovaného backendu.';
$string['profile:title'] = 'Předvolby nasazení';
$string['profile:intro'] = 'Použijte doporučený balíček nastavení pro váš typ nasazení. Hodnoty se zapíší do běžných nastavení pluginu a poté zůstanou jednotlivě upravitelné. Použití předvolby přepíše uvedená nastavení.';
$string['profile:current'] = 'Naposledy použitá předvolba: {$a}';
$string['profile:setting'] = 'Nastavení';
$string['profile:value'] = 'Hodnota';
$string['profile:self_hosted_small'] = 'Vlastní hostovaný malý kontext (jedna GPU, např. A30 24GB / vLLM na 8K)';
$string['profile:hosted_large'] = 'Hostovaný velký kontext (výchozí)';
$string['profile:apply_self_hosted_small'] = 'Použít předvolbu vlastního hostovaného malého kontextu';
$string['profile:apply_hosted_large'] = 'Použít výchozí hodnoty hostovaného velkého kontextu';
$string['profile:applied'] = 'Předvolba {$a} byla použita. Hodnoty jsou nyní ve vašich nastaveních pluginu.';
$string['profile:unknown'] = 'Neznámá předvolba nasazení.';
$string['profile:link'] = 'Stránka předvoleb nasazení';
$string['profile:link_desc'] = 'Otevřete stránku <a href="{$a}">Předvolby nasazení</a>, abyste použili doporučený balíček nastavení pro hostovaný nebo vlastní hostovaný backend.';
$string['settings:zendesk_require_consent'] = 'Vyžadovat souhlas před eskalací podpory';
$string['settings:zendesk_require_consent_desc'] = 'Pokud je zapnuto (doporučeno), SOLA eskaluje konverzaci na linku podpory Zendesk teprve poté, co student přijal souhlasné oznámení při prvním spuštění, které sděluje, že žádost o lidskou pomoc sdílí konverzaci (včetně jména a e-mailu) s podporou. Vypněte to pouze tehdy, pokud tento souhlas získáte jiným způsobem; při vypnutí se eskalace odešlou okamžitě. Nemá žádný účinek, pokud není povolena eskalace Zendesk.';
$string['chat:escalation_needs_consent'] = 'Vypadá to, že toto vyžaduje člena našeho týmu podpory. Abych to mohl předat jim, musel bych tuto konverzaci, včetně vašeho jména a e-mailu, sdílet s linkou podpory. S tím jste zatím nesouhlasili, takže jsem nic neodeslal. Pokud byste chtěli lidskou pomoc, přijměte prosím oznámení o sdílení dat tohoto asistenta a zeptejte se znovu, nebo kontaktujte podporu přímo.';
$string['privacy:metadata:email_optout'] = 'Předvolby odhlášení z e-mailů pro jednotlivé příjemce (z jakých typů e-mailů se příjemce odhlásil).';
...
$string['settings:rag_min_similarity'] = 'Minimální relevance (cosine)';
$string['settings:rag_min_similarity_desc'] = 'Vynechá načtené úryvky, jejichž kosinová podobnost s otázkou je pod touto hodnotou, takže otázka mimo téma nebo s malým obsahem vloží méně (nebo nula) pasáží, místo aby vždy doplňovala do Top-K slabými shodami. Rozsah 0 až 1; hodnota 0 bránu vypne. Správná hodnota závisí na modelu embedding: 0.25 se hodí pro text-embedding-3-small. Zvyšte ji pro větší přísnost (méně, ale tematicky relevantnější kontext), snižte ji pro větší benevolenci.';
$string['settings:rag_currentpage_boost'] = 'Zvýhodnění aktuální stránky';
$string['settings:rag_currentpage_boost_desc'] = 'Malý bonus přidaný ke skóre relevance úryvků ze stránky, kterou si student právě prohlíží, takže otázky jako "vysvětli toto" upřednostní viditelnou stránku, když jsou skóre blízká. Pouze pro řazení: nedonutí nerelevantní úryvek stránky projít branou minimální relevance. Nastavte 0 pro vypnutí.';
$string['settings:history_mode'] = 'Režim výběru historie';
$string['settings:history_mode_desc'] = 'Jak se vybírají předchozí kola konverzace, než se odešlou modelu. <strong>Semantic</strong> ponechá jen nedávná kola relevantní k aktuální otázce (a vždy nejnovější výměnu), takže zastaralé, tematicky nesouvisející dřívější kolo nezvyšuje náklady ani nesvádí odpověď z cesty; provádí jedno embedding volání navíc na zprávu. <strong>Recency</strong> ponechá poslední dvojice "Max Conversation History" bez ohledu na relevanci (dlouhodobé chování, bez volání navíc). Pokud embedding není k dispozici, sémantický režim se automaticky přepne na recency.';
$string['settings:history_mode_semantic'] = 'Semantic (relevantní nedávná kola)';
$string['settings:history_mode_recency'] = 'Recency (posledních N dvojic)';
$string['settings:history_semantic_minscore'] = 'Práh relevance historie (cosine)';
$string['settings:history_semantic_minscore_desc'] = 'V sémantickém režimu historie se předchozí kolo ponechá, jen pokud je jeho podobnost s aktuální otázkou alespoň této hodnoty (nejnovější výměna se ponechá vždy). Rozsah 0 až 1; závisí na modelu. Zvyšte pro větší přísnost (méně historie), snižte pro zachování více.';
$string['settings:history_candidates'] = 'Okno kandidátů historie';
$string['settings:history_candidates_desc'] = 'V sémantickém režimu historie se na relevanci hodnotí jen tolik nejnovějších dvojic (limit nákladů). Dvojice starší než toto okno se neodesílají. Udržujte tuto hodnotu na úrovni "Max Conversation History" nebo výše.';
