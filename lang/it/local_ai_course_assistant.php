...
$string['settings:rag_return_scope'] = 'Ambito di restituzione del recupero';
$string['settings:rag_return_scope_desc'] = 'Cosa inserire per ogni risultato recuperato. "chunk" (default) inserisce il chunk corrispondente di circa 400 parole. "window" inserisce il chunk corrispondente più i chunk adiacenti della stessa pagina. "page" inserisce l\'intera pagina del modulo a cui appartiene la corrispondenza. window/page sono utili quando una risposta si estende su più parti di una pagina, al costo di un prompt più grande.';
$string['settings:rag_window_size'] = 'Dimensione della finestra di recupero';
$string['settings:rag_window_size_desc'] = 'Per l\'ambito di restituzione "window": numero di chunk adiacenti da includere su ciascun lato di un chunk corrispondente. Default 1.';
$string['settings:rag_parent_max_chars'] = 'Limite del passaggio principale (caratteri)';
$string['settings:rag_parent_max_chars_desc'] = 'Numero massimo di caratteri per un passaggio window/page espanso. Le pagine che superano il limite tornano a una finestra (window), poi al singolo chunk. Default 6000.';
...
$string['flashcards:link'] = 'Flashcard (ripassa ora)';
$string['flashcards:intro'] = 'Ripasso con ripetizione spaziata. Rivela la risposta, poi autovalutati con Di nuovo, Difficile o Facile. Le carte che hai trovato difficili tornano prima; quelle che hai trovato facili si diradano nel tempo.';
$string['flashcards:question'] = 'Domanda';
$string['flashcards:answer'] = 'Risposta';
$string['flashcards:reveal'] = 'Rivela la risposta';
$string['flashcards:again'] = 'Di nuovo';
$string['flashcards:hard'] = 'Difficile';
$string['flashcards:easy'] = 'Facile';
$string['flashcards:no_due'] = 'Niente da ripassare al momento. Genera flashcard da una pagina del corso nel widget dell\'assistente, oppure torna più tardi.';
$string['flashcards:session_complete'] = 'Sessione completata. Ottimo lavoro.';
$string['flashcards:disabled'] = 'Le flashcard non sono abilitate per questo corso.';
$string['flashcards:toggle'] = 'Abilita le flashcard per questo corso';
$string['flashcards:toggle_help'] = 'Aggiunge al widget dell\'assistente uno starter «Genera flashcard» e una pagina di ripasso per gli studenti su /local/ai_course_assistant/flashcards.php?courseid=X. Disattivato per impostazione predefinita.';
$string['flashcards:starter_generate'] = 'Genera flashcard da questa pagina';
$string['flashcards:generated'] = 'Salvate {$a} flashcard. Apri la pagina di ripasso per studiarle.';
...
$string['settings:prompt_budget_auto_tune'] = 'Regolazione automatica giornaliera del budget del prompt di sistema (deprecato)';
$string['settings:prompt_budget_auto_tune_desc'] = 'Deprecato. Non fa nulla a meno che la modalità di budget qui sopra non sia impostata su <strong>Fisso</strong>. Un\'attività giornaliera deduceva il budget di caratteri osservando i troncamenti e inseguendo il prompt più grande che avesse visto. Derivare il budget dalla finestra di contesto del modello lo fa meglio: non può oscillare e non richiede dati iniziali. I due erano anche in conflitto, perché l\'attività scrive il budget di caratteri e qualsiasi valore diverso da quello predefinito disattiva il budget derivato. Lascia questo disattivato; sarà rimosso in una versione futura. Il suggerimento compare ancora nella pagina <a href="/local/ai_course_assistant/prompt_metrics.php">Metriche del prompt</a>.';
...
$string['comms:audit_log_title'] = 'Cosa mi ha inviato [[tutorshort]]';
$string['comms:audit_log_empty'] = '[[tutorshort]] non ti ha inviato nessuna email.';
$string['comms:memory_title'] = 'Cosa ha memorizzato [[tutorshort]] sul mio modo di imparare';
$string['comms:memory_desc'] = 'Queste note sono private e riguardano solo la tua chat con [[tutorshort]]. Aiutano [[tutorshort]] a scegliere un approccio diverso quando un argomento è difficile. Puoi cancellarle in qualsiasi momento.';
$string['comms:memory_clear'] = 'Cancella tutte le note di memoria';
$string['milestone:streak_subject'] = 'Serie di {$a->days} giorni in {$a->coursename}';
$string['milestone:streak_body_text'] = "Ciao {\$a->firstname},\n\nTi sei presentato per {\$a->days} giorni di fila in {\$a->coursename}. Questo tipo di costanza è la parte dell'apprendimento più difficile da fingere.\n\nQuando sei pronto, [[tutorshort]] è qui.\n\n— {\$a->institution}";
$string['milestone:completion_subject'] = 'Hai completato {$a->coursename}';
$string['milestone:completion_body_text'] = "Ciao {\$a->firstname},\n\nHai completato {\$a->coursename}. È un risultato concreto che hai ottenuto tu.\n\nSe vuoi continuare, [[tutorshort]] può aiutarti a scegliere un corso successivo correlato o a rivedere un argomento che hai trovato interessante.\n\n— {\$a->institution}";
$string['milestone:trigger_streak7'] = 'Serie di attività di 7 giorni raggiunta';
$string['milestone:trigger_streak30'] = 'Serie di attività di 30 giorni raggiunta';
$string['milestone:trigger_completion'] = 'Completamento del corso registrato';
...
$string['coursesettings:apibaseurl_rejected'] = 'L\'URL di base dell\'API non è stato salvato: deve essere un endpoint HTTPS pubblico che supera il controllo di sicurezza SSRF.';
$string['settings:escalation_intent_patterns'] = 'Modelli di intento di escalation';
$string['settings:escalation_intent_patterns_desc'] = 'PCRE, no delimiters. Un\'espressione regolare per riga; le righe che iniziano con # vengono ignorate. Un ticket di assistenza viene aperto solo quando il messaggio dello studente stesso corrisponde a uno di questi modelli, così che il contenuto del corso non possa innescare un\'escalation per suo conto. Lasciare vuoto per usare i valori predefiniti integrati, che coprono l\'inglese e alcune formulazioni comuni in spagnolo, francese, tedesco e portoghese. I siti i cui studenti scrivono in un\'altra lingua dovrebbero aggiungere qui i propri modelli: un messaggio senza corrispondenza significa che non viene aperto alcun ticket.';
...
$string['settings:premium_escalation_model_desc'] = 'Nome del modello passato al provider premium. Predefinito <code>claude-sonnet-5</code> secondo il verdetto del bake-off A.10.';
...
$string['analytics:exp_heading'] = 'Confronto dell\'esperimento A/B';
$string['analytics:exp_desc'] = 'Confronta il coinvolgimento tra due corsi nell\'intervallo di tempo selezionato. Progettato per esperimenti per corso (ad esempio la sonda di animazione avatar): inserisci la sostituzione in un corso, lascia l\'altro come controllo e leggi la differenza qui.';
$string['analytics:exp_course_a'] = 'Corso A';
$string['analytics:exp_course_b'] = 'Corso B';
$string['analytics:exp_compare'] = 'Confronta';
...
$string['analytics:exp_avg_msgs_session'] = 'Media messaggi per sessione';
$string['analytics:exp_avg_session_minutes'] = 'Durata media sessione (minuti)';
$string['analytics:exp_return_rate'] = 'Utenti di ritorno (%)';
$string['analytics:exp_tts_plays'] = 'Riproduzioni TTS';
$string['analytics:exp_tts_per_active'] = 'Riproduzioni TTS per utente attivo';

$string['settings:redash_allowed_origin'] = 'Origine consentita per Redash (CORS)';
$string['settings:redash_allowed_origin_desc'] = 'Lascia vuoto (consigliato): l\'esportazione viene recuperata da server a server da Redash e non necessita di alcuna intestazione CORS del browser. Imposta una singola origine esatta (per esempio https://redash.example.org) solo se una dashboard basata su browser deve leggere l\'esportazione direttamente. Non usare mai un carattere jolly.';

// Soapbox speech practice (v6.7.0).
$string['privacy:metadata:local_ai_course_assistant_practice_scores:session_meta'] = 'Metadati facoltativi forniti per la sessione, come il nome, l\'argomento e la durata prevista di un discorso Soapbox. Non include mai l\'audio o una trascrizione.';
$string['pedagogy:soapbox'] = 'Feedback sui discorsi Soapbox attivo per impostazione predefinita';
$string['pedagogy:soapbox_desc'] = 'Quando è attivo, lo strumento di esercitazione del discorso Soapbox è disponibile in ogni corso a meno che il corso non abbia una propria sostituzione. Lascialo disattivato e abilitalo solo nei corsi che ne hanno bisogno (in genere corsi di discorso e comunicazione).';
$string['settings:soapbox_stt_mode'] = 'Modalità di trascrizione di Soapbox';
$string['settings:soapbox_stt_mode_desc'] = 'Come Soapbox trasforma un discorso registrato in testo. Server utilizza il provider Whisper configurato (quello self-hosted è gratuito; OpenAI in hosting costa circa USD 0,006 al minuto). Browser utilizza il riconoscimento vocale integrato dello studente (gratuito, senza server, funziona solo in Chrome e Safari). Server è consigliato in modo che la qualità della trascrizione non dipenda dal browser dello studente.';
$string['settings:soapbox_stt_mode_server'] = 'Server (provider Whisper)';
$string['settings:soapbox_stt_mode_browser'] = 'Browser (gratuito, senza server)';
$string['soapbox:title'] = 'Soapbox';
$string['soapbox:link'] = 'Esercitazione del discorso Soapbox';
$string['soapbox:disabled'] = 'Soapbox non è abilitato per questo corso.';
$string['soapbox:intro'] = 'Tieni un discorso e ricevi consigli. Facoltativamente imposta un nome, un argomento e una durata prevista, poi registrati mentre parli. Soapbox trascrive il tuo discorso, lo valuta in base a una rubrica di esposizione e ti offre suggerimenti concreti. L\'audio e la trascrizione non vengono mai memorizzati, solo i tuoi punteggi e il feedback.';
$string['soapbox:optional'] = 'facoltativo';
$string['soapbox:name_label'] = 'Assegna un nome a questo discorso';
$string['soapbox:topic_label'] = 'Argomento';
$string['soapbox:time_label'] = 'Durata prevista';
$string['soapbox:no_target'] = 'Nessun obiettivo';
$string['soapbox:record'] = 'Registra discorso';
$string['soapbox:stop'] = 'Ferma';
$string['soapbox:recording'] = 'Registrazione in corso. Parla con naturalezza; fai clic su interrompi quando hai finito.';
$string['soapbox:transcribing'] = 'Trascrizione del tuo discorso in corso…';
$string['soapbox:scoring'] = 'Valutazione del tuo discorso in corso…';
$string['soapbox:too_short'] = 'Quella registrazione era troppo breve per essere valutata. Punta ad almeno una o due frasi e riprova.';
$string['soapbox:mic_denied'] = 'È necessario l\'accesso al microfono per registrare. Consenti l\'accesso al microfono e riprova.';
$string['soapbox:no_browser_stt'] = 'Questo browser non supporta il riconoscimento vocale nel browser. Prova Chrome o Safari, oppure chiedi al tuo amministratore di impostare Soapbox sulla trascrizione lato server.';
...
$string['soapbox:tips_heading'] = 'Suggerimenti per la prossima volta';
$string['soapbox:col_criterion'] = 'Criterio';
$string['soapbox:col_score'] = 'Punteggio';
$string['soapbox:col_feedback'] = 'Feedback';
$string['soapbox:history_heading'] = 'I miei discorsi';
$string['soapbox:history_empty'] = 'Non hai ancora registrato un discorso. Registrane uno sopra per iniziare a costruire la tua cronologia.';
$string['soapbox:untitled'] = 'Discorso senza titolo';
...
$string['cachedef_ratelimit'] = 'Limitazione della frequenza di richieste per utente';
$string['cachedef_uistate'] = 'Interruttori dell\'interfaccia per sessione (visualizza come studente, mostra i nomi reali)';
$string['benchmark:pagetitle'] = 'Benchmark dei provider';
$string['benchmark:intro'] = 'Invia un set fisso di prompt tipici a ogni provider AI configurato, registra l\'utilizzo dei token, il costo e la latenza, e consiglia un provider per ogni capacità. Ogni esecuzione effettua chiamate API reali, quindi un\'esecuzione costa all\'incirca da 5 a 20 centesimi a seconda di quanti provider sono configurati.';
$string['cachedef_systemprompt'] = 'Prompt di sistema AI assemblato (per corso)';
$string['cachedef_remoteconfig'] = 'Configurazione remota recuperata dal canale di aggiornamento';
$string['cachedef_spend'] = 'Totali di spesa AI per periodo per il controllo della spesa';
$string['cachedef_failover_circuit'] = 'Stato dell\'interruttore automatico di failover del provider';
$string['settings:rag_scope'] = 'Ambito di recupero';
$string['settings:rag_scope_desc'] = 'Quando un discente sta visualizzando un documento specifico (una pagina, un libro o un PDF), stabilisce se limitare il recupero a quel documento. <b>Documento prima</b> fonda la risposta sul documento corrente quando contiene frammenti pertinenti e altrimenti ricade sull\'intero corso. <b>Solo documento</b> non ricade mai: se il documento corrente non contiene alcun frammento pertinente non recupera nulla, quindi il tutor risponde in base alle conoscenze generali anziché citare pagine non correlate. <b>Intero corso</b> cerca in tutti i contenuti del corso (la pagina corrente riceve comunque il potenziamento di ordinamento sopra descritto). Documento prima è consigliato, così una risposta sulla pagina che un discente sta leggendo è fondata su quella pagina.';
$string['settings:rag_scope_document_first'] = 'Documento prima (preferisci il documento corrente, ricadi sul corso)';
$string['settings:rag_scope_document_only'] = 'Solo documento (limita al documento corrente)';
$string['settings:rag_scope_course'] = 'Intero corso (cerca in tutti i contenuti del corso)';
$string['ragadmin:no_content_documents'] = '{$a->count} documento/i non hanno prodotto testo indicizzabile e non sono stati suddivisi in frammenti (di solito pagine quasi interamente incorporate o molto brevi): {$a->titles}. Se alcuni di questi devono essere ricercabili, aggiungi testo nella pagina o una trascrizione, poi reindicizza.';
$string['privacy:metadata:sbx_rec'] = 'Registrazioni di presentazioni Soapbox. L\'oggetto multimediale viene eliminato dopo il periodo di conservazione; la trascrizione viene mantenuta per il feedback e le richieste di accesso.';
$string['privacy:metadata:sbx_rec:userid'] = 'Il discente che ha effettuato la registrazione.';
$string['privacy:metadata:sbx_rec:transcript'] = 'La trascrizione da voce a testo della registrazione.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'La durata della registrazione in secondi.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'Quando è stata effettuata la registrazione.';
$string['privacy:metadata:ai_provider'] = 'Per generare le risposte di tutoraggio, i contenuti creati dal discente vengono inviati al provider AI configurato dall\'amministratore del sito o del corso.';
$string['privacy:metadata:ai_provider:message'] = 'Il testo del messaggio e gli allegati che il discente invia al tutor AI.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'Il contesto del corso e dell\'attività (come il nome del corso e la pagina corrente) incluso per fondare la risposta.';
$string['privacy:metadata:voice_provider'] = 'Quando si utilizza l\'input o l\'output vocale, l\'audio e il testo vengono inviati al provider da voce a testo / da testo a voce configurato.';
$string['privacy:metadata:voice_provider:audio'] = 'L\'audio registrato del discente che parla, inviato per la trascrizione.';
$string['privacy:metadata:voice_provider:text'] = 'Il testo inviato al provider per essere sintetizzato in voce.';
$string['privacy:metadata:zendesk'] = 'Quando l\'inoltro al supporto umano è abilitato e il discente acconsente, i suoi dati di contatto e il messaggio vengono inviati a Zendesk per aprire un ticket di supporto.';
$string['privacy:metadata:zendesk:name'] = 'Il nome completo del discente, utilizzato per identificare chi richiede il supporto.';
$string['privacy:metadata:zendesk:email'] = 'L\'indirizzo email del discente, utilizzato per rispondere alla richiesta di supporto.';
$string['privacy:metadata:zendesk:message'] = 'Il messaggio o il contenuto della conversazione che il discente ha scelto di inoltrare.';
...
$string['analytics_js:ai_users'] = 'Utenti AI';
$string['analytics_js:non_users'] = 'Non utenti';
$string['analytics_js:thumbs_up'] = 'Pollici in su';
$string['analytics_js:thumbs_down'] = 'Pollici in giù';
$string['analytics_js:hallucination_flags'] = 'Segnalazioni di allucinazioni';
$string['analytics_js:avg_star_rating'] = 'Valutazione media in stelle';
$string['analytics_js:avg_msgs_resolution'] = 'Msg medi alla risoluzione';
$string['analytics_js:survey_respondents'] = 'Partecipanti al sondaggio';
$string['analytics_js:messages'] = 'Messaggi';
$string['analytics_js:students'] = 'Studenti';
$string['analytics_js:frequency'] = 'Frequenza';
$string['analytics_js:responses'] = 'Risposte';
$string['analytics_js:error_loading'] = 'Errore durante il caricamento dei dati';
$string['analytics_js:loading'] = 'Caricamento delle statistiche...';
$string['analytics_js:no_course_data'] = 'Nessun dato del corso disponibile.';
$string['analytics_js:no_unit_data'] = 'Nessun dato di unità ancora. Il tracciamento delle unità si accumula man mano che gli studenti utilizzano l\'assistente.';
$string['analytics_js:no_keyword_data'] = 'Nessun dato di parole chiave disponibile per questo periodo.';
$string['task:soapbox_cleanup'] = 'Conservazione e pulizia delle registrazioni Soapbox';
$string['admin:vendor_dpa:col_provider'] = 'Provider';
$string['admin:vendor_dpa:col_optout'] = 'Rifiuto dell\'addestramento';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Conservazione';
$string['admin:vendor_dpa:col_tier'] = 'Limite di livello';
$string['admin:vendor_dpa:col_link'] = 'Collegamento';
$string['admin:vendor_dpa:vendor_terms'] = 'Termini del fornitore';
$string['admin:vendor_dpa:tier'] = 'Livello {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'Contrattuale (rifiutato)';
$string['admin:vendor_dpa:too_default_on'] = 'Attivo per impostazione predefinita';
$string['admin:vendor_dpa:too_none'] = 'Nessun rifiuto';
$string['admin:vendor_dpa:too_local'] = 'Locale (nessun fornitore)';
$string['admin:vendor_dpa:too_unknown'] = 'Non ancora esaminato';
$string['admin:vendor_dpa:dpa_signed'] = 'Firmato';
$string['admin:vendor_dpa:dpa_available'] = 'Disponibile';
$string['admin:vendor_dpa:dpa_negotiating'] = 'In negoziazione';
$string['admin:vendor_dpa:dpa_not_offered'] = 'Non offerto';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'N/D';
$string['admin:vendor_dpa:dpa_unknown'] = 'Sconosciuto';
$string['settings:soapbox_slide_vision'] = 'Feedback sul design visivo delle diapositive Soapbox';
$string['settings:soapbox_slide_vision_desc'] = 'Consenti un singolo passaggio di visione sulle immagini delle diapositive renderizzate per aggiungere una breve nota di design visivo a una presentazione valutata. Disattivato per impostazione predefinita e attento alla privacy: non viene memorizzata alcuna immagine e ogni compito deve inoltre attivare l\'opzione con la propria casella di controllo Feedback sul design visivo delle diapositive. Sono interessate solo le presentazioni con diapositive dotate di un mazzo caricato.';
$string['settings:soapbox_vision_provider'] = 'Provider di visione diapositive Soapbox';
$string['settings:soapbox_vision_provider_desc'] = 'Provider utilizzato per il passaggio di visione delle diapositive. L\'impostazione predefinita è openai. Deve essere un provider con capacità di visione configurato con una chiave API (tramite il provider del corso o l\'elenco dei provider di confronto).';
$string['settings:soapbox_vision_model'] = 'Modello di visione diapositive Soapbox';
$string['settings:soapbox_vision_model_desc'] = 'Modello con capacità di visione per il passaggio di visione delle diapositive. L\'impostazione predefinita è gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'Design delle diapositive:';
$string['soapbox:assign_manage'] = 'Compiti di presentazione Soapbox';
$string['soapbox:copy_link'] = 'Collegamento per lo studente';
$string['soapbox:deck_label'] = 'Diapositive (PDF). Carica il tuo mazzo, poi fai avanzare le diapositive mentre registri.';
$string['soapbox:slide_prev'] = 'Diapositiva precedente';
$string['soapbox:slide_next'] = 'Diapositiva successiva';
$string['soapbox:play_slides'] = 'Riproduci con le diapositive';
$string['soapbox:audio_ready'] = 'Solo audio. Il tuo microfono verrà registrato; la tua fotocamera non viene utilizzata.';
$string['soapbox:audio_recording'] = 'Registrazione audio in corso...';
$string['soapbox:cap_reached'] = 'Hai raggiunto il numero massimo di registrazioni per questo compito.';
$string['soapbox:storage_unconfigured'] = 'L\'archiviazione delle registrazioni non è ancora configurata. Contatta il tuo amministratore.';
$string['soapbox:bad_key'] = 'Questo caricamento non ti appartiene.';
$string['soapbox:slides_disabled'] = 'Le diapositive non sono abilitate per questo compito.';
$string['soapbox:upload_missing'] = 'Impossibile trovare il caricamento. Prova a registrare di nuovo.';
$string['soapbox:mode_label'] = 'Tipo di presentazione';
$string['soapbox:mode_informative'] = 'Informativa (spiega o insegna)';
$string['soapbox:mode_persuasive'] = 'Persuasiva (convinci)';
$string['soapbox:err_provider'] = 'Impossibile raggiungere il servizio di valutazione AI. Riprova tra un momento.';
$string['soapbox:err_parse'] = 'L\'AI ha restituito una risposta inattesa. Riprova.';
$string['soapbox:err_disabled'] = 'La pratica del parlato non è abilitata per questo corso.';
$string['soapbox:err_transcribe'] = 'Impossibile trascrivere la tua registrazione. Riprova e verifica che il tuo microfono funzioni.';
$string['settings:outcomes_benchmark_default'] = 'Benchmark dei risultati (percentuale)';
$string['settings:outcomes_benchmark_default_desc'] = 'Il benchmark stabilito dall\'istituzione per il report dei risultati: uno studente raggiunge un risultato quando la sua padronanza è pari o superiore a questa percentuale. Questo è lo standard di rendicontazione (distinto dalla soglia di padronanza per il coaching). Predefinito 70.';
$string['outcomes:title'] = 'Report dei risultati';
$string['outcomes:intro'] = 'Per ogni risultato del corso, il benchmark e la percentuale di studenti valutati che lo hanno raggiunto o superato. Il benchmark del sito è {$a}%.';
$string['outcomes:none'] = 'Nessun risultato è ancora definito per questo corso.';
$string['outcomes:export'] = 'Esporta CSV';
$string['outcomes:col_outcome'] = 'Risultato';
$string['outcomes:col_benchmark'] = 'Benchmark';
$string['outcomes:col_assessed'] = 'Studenti valutati';
$string['outcomes:col_met'] = 'Benchmark raggiunto';
...
$string['soapbox:present_audio'] = 'Presentazione audio';
$string['soapbox:present_video'] = 'Presentazione video';
$string['soapbox:present_target'] = 'obiettivo {$a->min}-{$a->max} min';
$string['soapbox:choose_topic'] = 'Scegli un argomento';
$string['soapbox:record_short'] = 'Registra';
$string['soapbox:my_recordings'] = 'Le mie registrazioni';
$string['soapbox:no_recordings'] = 'Nessuna registrazione per ora.';
$string['soapbox:col_recorded'] = 'Registrato';
$string['soapbox:col_length'] = 'Durata';
$string['soapbox:col_type'] = 'Tipo';
$string['soapbox:col_recording'] = 'Registrazione';
$string['soapbox:col_kept'] = 'Conservato';
$string['soapbox:col_student_link'] = 'Link per lo studente';
$string['soapbox:view_download'] = 'Visualizza / scarica';
$string['soapbox:expired'] = 'Scaduto';
$string['soapbox:retention_note'] = 'Le registrazioni possono essere viste e scaricate per {$a} giorni, poi vengono eliminate automaticamente.';
$string['soapbox:assign_title'] = 'Compiti Soapbox';
$string['soapbox:assign_single_title'] = 'Compito Soapbox';
$string['soapbox:assign_add'] = 'Aggiungi compito';
$string['soapbox:assign_none'] = 'Nessun compito Soapbox per ora.';
$string['soapbox:assign_deleted'] = 'Compito eliminato.';
$string['soapbox:assign_updated'] = 'Compito aggiornato.';
$string['soapbox:assign_created'] = 'Compito creato.';
...
$string['settings:hidden_categories'] = 'Categorie di corso nascoste';
$string['settings:hidden_categories_desc'] = 'Elenco separato da virgole di nomi o ID di categorie di corso in cui l\'assistente non deve comparire. Esempio: "Sviluppo corsi, 42". L\'assistente viene inoltre nascosto automaticamente quando è attiva la modalità di modifica.';
$string['settings:provider_heading'] = 'Fornitore IA e conversazione';
$string['settings:provider_heading_desc'] = 'Configura il backend IA, il modello e il comportamento della conversazione.';
$string['settings:claude_temperature_allow_prefixes'] = 'Modelli Claude che accettano temperature';
$string['settings:claude_temperature_allow_prefixes_desc'] = 'Un prefisso di nome modello per riga. I modelli Anthropic il cui nome inizia con uno di questi prefissi accettano ancora il parametro di campionamento <code>temperature</code>. Per qualsiasi modello Claude che NON corrisponda a un prefisso, temperature viene omesso (i modelli di tipo ragionamento a partire da Opus 4.7 lo rifiutano con un errore HTTP 400). Lascia vuoto per usare il valore predefinito incluso.';
$string['settings:max_tokens'] = 'Lunghezza massima della risposta (token)';
$string['settings:max_tokens_desc'] = 'Numero massimo di token per ogni risposta dell\'IA. Valori più bassi producono risposte più brevi e rapide. 512 = circa 2-3 frasi, 1024 = circa 1-2 paragrafi, 2048 = spiegazioni più lunghe. Imposta 0 per non applicare alcun limite (valore predefinito del fornitore).';
$string['settings:profile_update_interval'] = 'Intervallo di aggiornamento del profilo dello studente';
$string['settings:profile_update_interval_desc'] = 'Dopo questo numero di messaggi dello studente in un corso, l\'assistente genera (o aggiorna) un profilo di apprendimento che riassume punti di forza, difficoltà, stile di apprendimento e interessi. Il profilo viene inserito nel prompt di sistema per fornire risposte personalizzate. Imposta 0 per disattivare. Predefinito: 10.';
$string['settings:enable_thinking'] = 'Ragionamento esteso (solo Claude)';
$string['settings:enable_thinking_desc'] = 'Abilita il ragionamento adattivo per i modelli Claude. Claude decide autonomamente quando e quanto ragionare su un problema prima di rispondere. Migliora l\'accuratezza sulle domande complesse, ma aumenta il consumo di token e la latenza. Il contenuto del ragionamento non viene mostrato agli studenti. Gli altri fornitori ignorano questa impostazione.';
$string['settings:rag_sources_heading'] = 'Fonti di contenuto per il RAG';
$string['settings:rag_sources_heading_desc'] = 'Scegli da quali tipi di contenuto del corso l\'indicizzatore RAG estrae il testo. Gli indicatori di stato nella <a href="{$a}">pagina di amministrazione RAG</a> mostrano se ciascun estrattore dispone di quanto necessario per funzionare (ad esempio il binario pdftotext o l\'elenco di autorizzazioni di Cloudflare).';
$string['settings:rag_extract_pdf'] = 'Indicizza i file PDF (mod_resource)';
$string['settings:rag_extract_pdf_desc'] = 'Estrae il testo dai PDF caricati tramite il binario <code>pdftotext</code> (poppler). Rileva automaticamente il percorso del binario; indicalo qui sotto se necessario.';
$string['settings:rag_pdftotext_path'] = 'Percorso del binario pdftotext';
$string['settings:rag_pdftotext_path_desc'] = 'Lascia vuoto per il rilevamento automatico (verifica <code>/usr/bin/pdftotext</code>, <code>/usr/local/bin/pdftotext</code> e <code>which pdftotext</code>). Compila questo campo solo se la tua installazione si trova altrove.';
$string['settings:rag_extract_docx'] = 'Indicizza i file DOCX (mod_resource)';
$string['settings:rag_extract_docx_desc'] = 'Estrae il testo dai documenti Word caricati tramite ZipArchive di PHP. Non richiede alcuna dipendenza esterna.';
$string['settings:rag_extract_pptx'] = 'Indicizza i file PPTX (mod_resource)';
$string['settings:rag_extract_pptx_desc'] = 'Estrae il testo dalle presentazioni PowerPoint moderne caricate tramite ZipArchive di PHP. Percorre l\'XML delle diapositive e delle note del relatore nell\'ordine della presentazione; non richiede dipendenze esterne. I vecchi file binari <code>.ppt</code> non sono supportati: salva nuovamente quelle presentazioni come <code>.pptx</code>.';
$string['settings:rag_extract_h5p'] = 'Indicizza i contenuti H5P (mod_h5p)';
$string['settings:rag_extract_h5p_desc'] = 'Percorre il JSON dei contenuti H5P e indicizza tutti i campi che contengono testo (domande, risposte, feedback, descrizioni). I metadati dei tipi di contenuto H5P sono molto ampi; in casi limite sono possibili alcuni falsi positivi.';
$string['settings:rag_extract_scorm'] = 'Indicizza i pacchetti SCORM (mod_scorm)';
$string['settings:rag_extract_scorm_desc'] = 'Decomprime i pacchetti SCORM e indicizza <code>imsmanifest.xml</code>, tutti i file <code>.html</code> e le stringhe di contenuto di Articulate Storyline. <strong>Disattivato per impostazione predefinita</strong>, perché l\'analisi di SCORM può risultare onerosa. La dimensione massima del pacchetto è controllata da <code>rag_scorm_max_mb</code>.';
$string['settings:rag_scorm_max_mb'] = 'Dimensione massima del pacchetto SCORM da indicizzare (MB)';
$string['settings:rag_scorm_max_mb_desc'] = 'Salta i pacchetti SCORM più grandi di questo valore per evitare un uso eccessivo di memoria.';
$string['settings:rag_fetch_transcripts'] = 'Recupera le trascrizioni di video e contenuti interattivi incorporati';
$string['settings:rag_fetch_transcripts_desc'] = 'Analizza i contenuti di mod_page e mod_book alla ricerca di iframe incorporati (Synthesia, YouTube, Articulate, Genially) e recupera l\'URL della trascrizione associata a ciascun elemento incorporato (cercando sia sopra sia sotto l\'iframe). Richiede una connessione HTTPS in uscita da questo server verso l\'host delle trascrizioni. <strong>Disattivato per impostazione predefinita</strong>; attivalo dopo che l\'host delle trascrizioni ha inserito questo server nel proprio elenco di autorizzazioni (ad esempio una regola di accesso per IP di Cloudflare).';
$string['settings:rag_iframe_host_patterns'] = 'Pattern degli host iframe';
...
$string['settings:max_content_per_resource_desc'] = 'Numero massimo di caratteri di contenuto estratti da ciascuna pagina o capitolo di libro. Valori più bassi riducono la dimensione del prompt e velocizzano le risposte.';
$string['settings:max_total_content'] = 'Contenuto totale massimo (caratteri)';
$string['settings:max_total_content_desc'] = 'Numero massimo complessivo di caratteri di contenuto del corso inclusi nel prompt di sistema. Valori più bassi riducono la dimensione del prompt e velocizzano le risposte.';
$string['settings:spend_guard_heading'] = 'Protezione della spesa e ottimizzatore';
$string['settings:spend_guard_heading_desc'] = 'Imposta tetti di spesa per gli LLM per ciascun periodo. Al raggiungimento di un tetto [[tutorshort]] mette in pausa le richieste oppure passa a un fornitore più economico della tua catena di failover. Consulta la <a href="{$a}">pagina dei costi dei token</a> per lo stato attuale della spesa e i suggerimenti dell\'ottimizzatore.';
$string['settings:spend_cap_period'] = 'Periodo del tetto di spesa';
$string['settings:spend_cap_period_desc'] = 'Con quale frequenza il tetto di spesa viene azzerato. Allineato al calendario: mensile inizia il primo giorno del mese, settimanale il lunedì e giornaliero a mezzanotte.';
$string['settings:spend_cap_site'] = 'Tetto di spesa per l\'intero sito (USD)';
$string['settings:spend_cap_site_desc'] = 'Tetto complessivo in USD per tutti i corsi e tutte le funzionalità nel periodo corrente. <code>0</code> = illimitato. I tetti per singola funzionalità qui sotto, se impostati, hanno la precedenza su questo valore.';
$string['settings:spend_cap_chat'] = 'Tetto della chat (USD)';
$string['settings:spend_cap_chat_desc'] = 'Tetto riservato al carico di chat e quiz degli studenti. <code>0</code> = usa il tetto dell\'intero sito.';
$string['settings:spend_cap_voice'] = 'Tetto della voce (USD)';
$string['settings:spend_cap_voice_desc'] = 'Tetto per la voce (Realtime + TTS + STT). La voce è di solito la voce di costo più consistente: limitala per prima.';
$string['settings:spend_cap_rag'] = 'Tetto del RAG (USD)';
$string['settings:spend_cap_rag_desc'] = 'Tetto per le chiamate di embedding effettuate durante l\'indicizzazione dei corsi.';
$string['settings:spend_cap_analytics'] = 'Tetto delle analisi (USD)';
$string['settings:spend_cap_analytics_desc'] = 'Tetto per le query amministrative di Learning Radar.';
$string['settings:spend_failover_chain'] = 'Catena di failover';
$string['settings:spend_failover_chain_desc'] = 'Al raggiungimento di un tetto, [[tutorshort]] prova questi fornitori nell\'ordine indicato. Una voce per riga, nel formato <code>capability:label</code>. Le etichette fanno riferimento alle voci in Fornitori di confronto (per <code>chat</code> / <code>analytics</code>) o in Fornitori voce (per <code>voice</code>). Le righe che iniziano con <code>#</code> sono commenti. Esempio:<br><code>chat:claude-haiku<br>chat:ollama-local<br>voice:openai-prod<br>analytics:deepseek</code>';
$string['settings:failover_per_call_enabled'] = 'Failover per singola chiamata (v5.5.0)';
$string['settings:failover_per_call_enabled_desc'] = 'Se attivo, ogni chiamata di chat racchiude il fornitore principale in un decoratore della catena di failover. In caso di timeout della chiamata o di errore 5xx, [[tutorshort]] passa alla voce successiva della <strong>catena di failover</strong> qui sopra e apre un circuito di 15 minuti sul fornitore in errore. A ogni passaggio viene registrata una riga di audit (<code>failover_fallthrough</code>); dopo l\'attivazione controlla Amministrazione -> [[tutorshort]] -> Registro di audit per verificare che la catena funzioni correttamente. Disattivato per impostazione predefinita; attivalo solo dopo aver validato la catena e dopo che il tuo istituto ha confermato che per ciascun fornitore che ne fa parte sono in essere le necessarie condizioni di trattamento dei dati.';
$string['settings:failover_timeout_chat'] = 'Failover per chiamata: timeout della chat (secondi)';
$string['settings:failover_timeout_chat_desc'] = 'Quanto attendere il primo token da un fornitore di chat prima di passare al successivo. Predefinito 8 s. Valori più bassi rendono più rapido il passaggio con fornitori lenti, al costo di falsi positivi su richieste temporaneamente lente; valori più alti mantengono la catena sul fornitore principale più a lungo. Viene considerato solo quando il <strong>failover per singola chiamata</strong> è attivo.';
$string['settings:spend_notify_emails'] = 'Destinatari degli avvisi di spesa';
$string['settings:spend_notify_emails_desc'] = 'Indirizzi e-mail separati da virgole da avvisare all\'80%, 95% e 100% del tetto. Lascia vuoto per avvisare tutti gli amministratori del sito.';
$string['settings:opt_cost_weight'] = 'Ottimizzatore: peso del costo';
$string['settings:opt_cost_weight_desc'] = 'Quanto l\'ottimizzatore dà priorità al costo nell\'ordinare i fornitori. 0.0 ignora il costo, 1.0 ottimizza esclusivamente in base al costo. Va considerato insieme al peso della qualità.';
$string['settings:opt_quality_weight'] = 'Ottimizzatore: peso della qualità';
$string['settings:opt_quality_weight_desc'] = 'Quanto l\'ottimizzatore dà priorità alla soddisfazione degli studenti (percentuale di valutazioni positive) nell\'ordinare i fornitori. 0.0 ignora la qualità.';
$string['settings:inactivity_reminder_enabled'] = 'Promemoria di inattività';
$string['settings:inactivity_reminder_enabled_desc'] = 'Invia un\'e-mail settimanale agli studenti che non accedono al proprio corso da un numero di giorni configurato.';
$string['settings:inactivity_threshold_days'] = 'Soglia di inattività (giorni)';
$string['settings:inactivity_threshold_days_desc'] = 'Numero di giorni di inattività prima dell\'invio di un\'e-mail di promemoria.';
$string['settings:voice_providers_heading'] = 'Fornitori voce (Realtime, TTS, STT)';
$string['settings:voice_providers_heading_desc'] = 'Configura uno o più fornitori di API vocali. Queste impostazioni sono indipendenti dal fornitore di chat indicato sopra e dal fornitore di embedding del RAG: la voce ha un proprio elenco di fornitori perché al momento solo OpenAI e xAI espongono endpoint Realtime via WebSocket, TTS e STT. Usa i menu a discesa qui sotto per scegliere quale fornitore registrato gestisce ciascuna funzionalità. Se non viene definita alcuna riga, si usa il vecchio meccanismo a chiave singola (la chiave API Realtime qui sopra oppure la chiave OpenAI principale). Un sito che usa Together AI / Anthropic / DeepSeek / Gemini / Mistral per la chat deve configurare qui almeno una riga affinché la voce funzioni.';
$string['settings:voice_active_realtime'] = 'Fornitore Realtime attivo';
$string['settings:voice_active_realtime_desc'] = 'Quale fornitore voce configurato gestisce le sessioni dell\'agente vocale Realtime.';
$string['settings:voice_active_tts'] = 'Fornitore TTS attivo';
$string['settings:voice_active_tts_desc'] = 'Quale fornitore voce configurato gestisce la riproduzione vocale delle risposte dell\'IA.';
$string['settings:voice_active_stt'] = 'Fornitore STT attivo';
$string['settings:voice_active_stt_desc'] = 'Quale fornitore gestisce la trascrizione da voce a testo dell\'audio degli studenti. Lascia vuoto per preferire il server Whisper self-hosted, se configurato qui sotto, ricorrendo poi alla prima riga dei fornitori voce o alla vecchia chiave.';
$string['settings:stt_selfhosted_enabled'] = 'Abilita la trascrizione self-hosted';
$string['settings:stt_selfhosted_enabled_desc'] = 'Usa il server Whisper self-hosted indicato qui sotto come canale da voce a testo per l\'input vocale e per Soapbox. Richiede l\'URL del server qui sotto. Se disattivato, la trascrizione ricorre al canale ospitato (OpenAI Whisper) o a quello del browser, anche se è stato impostato un URL.';
$string['settings:stt_selfhosted_warm'] = 'Preriscalda all\'avvio di una registrazione Soapbox';
$string['settings:stt_selfhosted_warm_desc'] = 'Se attivo, l\'avvio di una registrazione Soapbox invia al server di trascrizione self-hosted un leggero ping di riscaldamento, con logica best-effort, in modo che un host con scalabilità a zero (ad esempio Cloud Run) si avvii mentre lo studente sta ancora registrando, nascondendo così il ritardo di avvio a freddo alla trascrizione che parte all\'invio. Non ha effetto se qui sopra non è impostato l\'URL di un server self-hosted. Disattivato per impostazione predefinita.';
$string['settings:voice_tab_enabled'] = 'Abilita la scheda Voce';
$string['settings:voice_tab_enabled_desc'] = 'Mostra la scheda Voce nella barra di navigazione inferiore. Se disattivata, gli studenti vedono solo le schede Chat e Note. Le funzioni vocali (pratica di conversazione, pratica di pronuncia) restano accessibili dagli spunti di conversazione se attivate separatamente.';
$string['settings:soapbox_heading'] = 'Soapbox';
$string['settings:soapbox_heading_desc'] = 'Esercitazione alla presentazione orale: come vengono trascritte le registrazioni e in base a quale griglia di valutazione vengono valutate. Attiva Soapbox per singolo corso tramite l\'interruttore Soapbox nella sezione Didattica.';
$string['settings:soapbox_max_seconds'] = 'Durata massima della registrazione Soapbox (secondi)';
$string['settings:soapbox_max_seconds_desc'] = 'Limite massimo assoluto della durata di registrazione per qualsiasi consegna. I docenti possono impostare un intervallo più breve. Predefinito 720 (12 minuti).';
$string['settings:soapbox_max_recordings'] = 'Numero massimo di registrazioni Soapbox per studente e per consegna';
$string['settings:soapbox_max_recordings_desc'] = 'Limite massimo assoluto del numero di registrazioni che uno studente può effettuare per una consegna, indipendentemente dall\'impostazione dei tentativi della singola consegna. Predefinito 3.';
$string['settings:soapbox_retention_days'] = 'Conservazione delle registrazioni Soapbox (giorni)';
$string['settings:soapbox_retention_days_desc'] = 'Per quanto tempo una registrazione viene conservata prima dell\'eliminazione automatica; la trascrizione, il punteggio e il feedback vengono mantenuti. Limitato tra 1 e 28 giorni. Più breve è, migliore è la minimizzazione dei dati. Predefinito 7.';
$string['settings:soapbox_video_quality'] = 'Qualità video di Soapbox';
$string['settings:soapbox_video_quality_desc'] = 'Risoluzione e bitrate della registrazione. È la principale leva su costi e banda; un relatore inquadrato a mezzo busto resta leggibile con la qualità Standard. La qualità bassa è adatta a connessioni deboli; quella alta solo quando il dettaglio visivo è importante.';
$string['settings:soapbox_storage_bucket'] = 'Bucket di archiviazione di Soapbox';
$string['settings:soapbox_storage_bucket_desc'] = 'Bucket S3 per le registrazioni. Predefinito: il bucket di archivio condiviso.';
$string['settings:soapbox_storage_region'] = 'Regione di archiviazione di Soapbox';
$string['settings:soapbox_storage_region_desc'] = 'Regione AWS del bucket, ad esempio us-east-1.';
$string['settings:soapbox_storage_prefix'] = 'Prefisso delle chiavi di archiviazione di Soapbox';
$string['settings:soapbox_storage_prefix_desc'] = 'Prefisso delle chiavi all\'interno del bucket. Le registrazioni vengono archiviate sotto questo percorso, così che una regola di ciclo di vita possa individuarle.';
$string['settings:soapbox_storage_key'] = 'ID della chiave di accesso dell\'archiviazione di Soapbox';
$string['settings:soapbox_storage_key_desc'] = 'ID della chiave di accesso di un principal IAM limitato a PutObject/GetObject/DeleteObject sul prefisso indicato sopra.';
$string['settings:soapbox_storage_secret'] = 'Chiave di accesso segreta dell\'archiviazione di Soapbox';
$string['settings:soapbox_storage_secret_desc'] = 'Chiave di accesso segreta corrispondente all\'ID della chiave di accesso indicato sopra.';
$string['settings:survey_heading'] = 'Sondaggio per gli studenti';
$string['settings:survey_heading_desc'] = 'Configura il sondaggio sull\'esperienza degli studenti integrato nella chat. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Modifica le domande del sondaggio &rarr;</a>';
$string['settings:survey_enabled'] = 'Abilita i sondaggi';
$string['settings:survey_enabled_desc'] = 'Se attivo, agli studenti verrà proposto un sondaggio sulla loro esperienza con il tutor IA.';
$string['settings:survey_trigger_messages'] = 'Attiva dopo N messaggi';
$string['settings:survey_trigger_messages_desc'] = 'Mostra l\'invito al sondaggio dopo che lo studente ha inviato questo numero di messaggi in un corso. Imposta 0 per mostrarlo solo tramite attivazione manuale.';
$string['settings:survey_frequency'] = 'Frequenza del sondaggio per utente';
$string['settings:survey_frequency_desc'] = 'Con quale frequenza a uno studente può essere proposto di rispondere al sondaggio in ciascun corso.';
$string['settings:rubric_heading'] = 'Griglie di valutazione delle esercitazioni';
$string['settings:rubric_heading_desc'] = 'Configura le griglie di valutazione per le sessioni di pratica di conversazione e di pronuncia. Al termine di una sessione di pratica gli studenti ricevono punteggi e feedback generati dall\'IA. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Modifica le griglie &rarr;</a>';
$string['settings:practice_scoring_enabled'] = 'Abilita la valutazione delle esercitazioni';
$string['settings:practice_scoring_enabled_desc'] = 'Se attivo, dopo le sessioni di pratica di conversazione e di pronuncia gli studenti ricevono una scheda di valutazione con i giudizi per ciascun criterio e il relativo feedback.';
$string['settings:usertesting_heading'] = 'Test di usabilità';
$string['settings:usertesting_heading_desc'] = 'Test di usabilità all\'interno del widget con valutazione basata su attività. Gli studenti svolgono attività dentro l\'assistente e valutano la propria esperienza. I risultati compaiono nel cruscotto di analisi.';
$string['settings:usertesting_enabled'] = 'Abilita i test di usabilità';
$string['settings:usertesting_enabled_desc'] = 'Mostra il collegamento "Test di usabilità" nel piè di pagina del widget. Se attivo, gli studenti possono accedere alle attività di test.';
$string['settings:usertesting_external_url'] = 'URL del modulo esterno (opzione C)';
$string['settings:usertesting_external_url_desc'] = 'Facoltativo: l\'URL di un modulo esterno (ad esempio Google Moduli o Typeform). Usa i segnaposto: {{userid}}, {{courseid}}, {{messages}}, {{session_minutes}}. Se impostato, facendo clic su "Test di usabilità" si apre questo URL con il contesto già compilato. Lascia vuoto per usare solo il pannello di test integrato nel widget.';
$string['settings:footer_links_heading'] = 'Collegamenti del piè di pagina';
$string['settings:footer_links_heading_desc'] = 'Personalizza i collegamenti mostrati in fondo all\'assistente: un collegamento facoltativo per esplorare i corsi sotto il collegamento di feedback, e la formulazione del collegamento di feedback e del relativo pannello.';
$string['settings:footer_courses_text'] = 'Testo del collegamento ai corsi';
$string['settings:footer_courses_text_desc'] = 'Testo di un collegamento mostrato sotto il collegamento di feedback. Lascia vuoto per nascondere completamente il collegamento.';
$string['settings:footer_courses_url'] = 'URL del collegamento ai corsi';
$string['settings:footer_courses_url_desc'] = 'Destinazione del collegamento ai corsi (si apre in una nuova scheda). Se il campo è vuoto, il collegamento viene nascosto.';
$string['settings:feedback_link_label'] = 'Etichetta del collegamento di feedback';
$string['settings:feedback_link_label_desc'] = 'Sostituisce il testo del collegamento di feedback nel piè di pagina, ad esempio "Invia un feedback su [[tutorshort]] al team IT". Lascia vuoto per usare l\'etichetta tradotta predefinita "Feedback".';
$string['settings:feedback_panel_intro'] = 'Introduzione del pannello di feedback';
$string['settings:feedback_panel_intro_desc'] = 'Riga introduttiva mostrata in cima al pannello di feedback. Chiarisce a chi arrivano i commenti. Lascia vuoto per non mostrare alcuna introduzione.';
$string['settings:quiz_provider'] = 'Fornitore del coach dei quiz';
$string['settings:quiz_provider_desc'] = 'ID del fornitore (ad esempio <code>claude</code> o <code>openai</code>) per la generazione dei quiz. Deve corrispondere a una riga in Fornitori di confronto. Lascia vuoto per usare il fornitore della chat.';
$string['settings:quiz_model'] = 'Modello del coach dei quiz';
$string['settings:quiz_model_desc'] = 'Nome del modello per la generazione dei quiz, ad esempio <code>claude-haiku-4-5</code>. Perché la sostituzione abbia effetto devono essere impostati sia questo campo sia il fornitore.';
$string['settings:branding_heading'] = 'Identità visiva';
$string['settings:branding_heading_desc'] = 'Personalizza il nome e l\'aspetto dell\'assistente.';
$string['settings:institution_short_name'] = 'Nome breve dell\'istituto';
$string['settings:institution_short_name_desc'] = 'Nome abbreviato dell\'istituto per gli elementi compatti dell\'interfaccia (ad esempio "State U").';
$string['settings:display_name'] = 'Nome visualizzato dell\'assistente';
$string['settings:display_name_desc'] = 'Nome completo dell\'assistente IA mostrato nei saluti e nella schermata di benvenuto (ad esempio "Assistente per l\'apprendimento online").';
$string['settings:short_name'] = 'Nome breve dell\'assistente';
$string['settings:short_name_desc'] = 'Nome breve mostrato nella barra di intestazione e negli elementi compatti dell\'interfaccia (ad esempio "Assistente").';
$string['settings:welcome_message'] = 'Messaggio della schermata di benvenuto';
$string['settings:welcome_message_desc'] = 'Messaggio mostrato nella schermata di benvenuto alla prima visita. Usa <code>{{firstname}}</code> per il nome dello studente e <code>{{coursename}}</code> per il nome del corso. Lascia vuoto per il messaggio predefinito.';
$string['settings:chat_greeting'] = 'Saluto della chat';
$string['settings:chat_greeting_desc'] = 'Messaggio di saluto mostrato all\'apertura della finestra di chat. Usa <code>{{firstname}}</code> per il nome dello studente e <code>{{coursename}}</code> per il nome del corso. Lascia vuoto per il messaggio predefinito.';
$string['settings:customavatars'] = 'Avatar personalizzati';
$string['settings:customavatars_desc'] = 'Carica qui immagini quadrate in PNG o SVG per aggiungerle al menu a discesa degli avatar qui sopra. Ogni file caricato diventa un\'opzione predefinita selezionabile (con prefisso "Custom:"). Rimuovi un file da questo elenco per toglierlo dal menu a discesa. Suggerimento: un PNG di 256×256 funziona bene sui display Retina.';
$string['settings:anomaly_digest_heading'] = 'Learning Radar — riepilogo delle anomalie';
$string['settings:anomaly_digest_heading_desc'] = 'Controllo giornaliero che confronta finestre mobili di valutazioni negative, spesa in token e segnalazioni di integrità. Quando una metrica supera la soglia configurata, viene inviato un riepilogo ai canali configurati. Per i report pianificati per singola query, usa il pannello Pianificazioni nella pagina di analisi di [[tutorshort]].';
$string['settings:anomaly_digest_enabled'] = 'Abilita il riepilogo delle anomalie';
$string['settings:anomaly_digest_enabled_desc'] = 'Esegue l\'attività giornaliera di riepilogo delle anomalie. Silenziosa per impostazione predefinita: si attiva solo quando una metrica supera la soglia.';
$string['settings:anomaly_digest_threshold_pct'] = 'Soglia di avviso (%)';
$string['settings:anomaly_digest_threshold_pct_desc'] = 'Variazione percentuale tra la finestra recente e quella precedente che genera un avviso. Predefinito: 50.';
$string['settings:anomaly_digest_recipient_email'] = 'E-mail del destinatario';
$string['settings:anomaly_digest_recipient_email_desc'] = 'Indirizzo e-mail che riceve il riepilogo delle anomalie. Lascia vuoto per usare quello dell\'amministratore del sito.';
$string['settings:anomaly_digest_slack_webhook'] = 'URL del webhook in entrata di Slack';
$string['settings:anomaly_digest_slack_webhook_desc'] = 'URL facoltativo di un webhook in entrata di Slack. Il riepilogo viene pubblicato come messaggio a blocchi di Slack.';
$string['settings:anomaly_digest_teams_webhook'] = 'URL del webhook in entrata di Microsoft Teams';
...
$string['settings:prompt_budget_mode_desc'] = 'Come viene deciso il budget di caratteri del prompt di sistema. <strong>Deriva dal modello</strong> calcola lo spazio che il modello configurato offre davvero — la sua finestra di contesto, meno la risposta riservata e la cronologia della conversazione — e usa quel valore, con un tetto perché una finestra molto grande non giustifichi un prompt molto grande. Vale solo finché il budget di caratteri qui sotto resta al valore predefinito di 36.000: se cambi quel numero, prevale lui, in entrambe le direzioni, perché una cifra digitata da chi amministra è una decisione e non una congettura. <strong>Fisso</strong> usa sempre il numero qui sotto. Un backend self-hosted dovrebbe impostare la finestra di contesto del backend, che ha la precedenza su tutto quanto qui.';
...
$string['quizlock:scope'] = 'Fin dove arriva il blocco';
$string['quizlock:scope_course'] = 'Solo questo corso (consigliato)';
$string['quizlock:scope_site'] = 'Tutti i corsi';
...
$string['privacy:metadata:outreach_log:dryrun'] = 'Indica se la riga è stata scritta in modalità dry-run (nessuna email è stata effettivamente inviata).';
$string['flashcards:starter_saved'] = 'Salvate {$a} flashcard da questa pagina.';
$string['flashcards:starter_open_review'] = 'Apri la pagina di ripasso per studiarle con la ripetizione spaziata.';
$string['flashcards:starter_failed'] = 'Non sono riuscito a generare flashcard da questa pagina ({$a}). Riprova o scegli una pagina con più contenuto.';
$string['flashcards:starter_error'] = 'Al momento non riesco a generare flashcard da questa pagina. Riprova più tardi.';
$string['soapbox:no_media_support'] = 'Questo browser non può registrare audio qui. Usa una versione recente di Chrome, Edge, Firefox o Safari con una connessione sicura (https).';
