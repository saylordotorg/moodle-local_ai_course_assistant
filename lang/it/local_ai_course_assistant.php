...
$string['settings:embed_input_type_asymmetric'] = 'Query/documento asimmetrici';
$string['settings:embed_input_type_mode'] = 'Tipo di input per l\'embedding';
$string['settings:embed_input_type_mode_desc'] = 'Solo per gli embedding Voyage. "Spazio condiviso" effettua l\'embedding di query e documenti nello stesso modo, così i due restano confrontabili anche al cambio di modello. "Asimmetrico" usa la proiezione separata delle query di Voyage; è l\'ottimizzazione suggerita dal vendor ma su questo corpus non ha riprodotto alcun guadagno per due volte, quindi il valore predefinito è condiviso. Cambiare questa impostazione non richiede una reindicizzazione.';
$string['settings:embed_input_type_shared'] = 'Spazio condiviso (consigliato)';
