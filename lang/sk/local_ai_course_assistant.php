...
$string['emergency:title'] = 'Núdzové ovládanie SOLA';
$string['emergency:page_warning'] = 'Tieto prepínače nadobúdajú účinnosť okamžite pre každého študenta na stránke. Každá akcia zapíše riadok auditu. Granulárne prepínače nechajú zvyšok SOLA bežať; hlavné vypnutie kompletne odstráni widget.';
$string['emergency:back_to_settings'] = 'Nastavenia SOLA';
...
$string['emergency:flag_chat_desc'] = 'Blokuje chatovú prevádzku pomocou dedikovaného kill flagu (oprava v5.13). Widget sa naďalej renderuje; študenti vidia priateľskú správu „SOLA pozastavená". Použite, keď sa poskytovateľ LLM správa nesprávne alebo prebieha nárast nákladov.';
...
$string['emergency:flag_all_desc'] = 'Zakáže celý plugin: widget zmizne zo každej stránky, naplánované úlohy sa zastavia, hlas sa vymaže, RAG vypnutý, komunikácia vypnutá. Najsilnejší prepínač — použite pri bezpečnostnom incidente alebo keď musí byť SOLA okamžite odpojená.';
$string['emergency:settings_link'] = 'Núdzové ovládanie';
$string['emergency:settings_link_desc'] = 'Kill prepínače per-subsystém (chat / hlas / RAG / komunikácia / hlavný) so zápisom auditu — webový ekvivalent <code>admin/cli/emergency_disable.php</code>. Otvorte <a href="{$a}">Núdzové ovládanie SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Odhlásenie z odberu';
$string['email_unsubscribe:done_body'] = 'Hotovo — {$a->email} už nebude dostávať tento typ e-mailov od {$a->product}. Ak si to rozmyslíte, požiadajte administrátora {$a->product} o opätovné aktivovanie odberu alebo odošlite nový opt-in cez stránku SOLA Recipients v administrátorskom paneli.';
...
$string['analytics:exp_active_users'] = 'Aktívni používatelia SOLA';
