...
$string['chat:consent_body'] = '{$a->product} je učebný asistent poháňaný umelou inteligenciou. Vaše správy a odpovede {$a->product} sa ukladajú do databázy Moodle inštitúcie {$a->institution} a desať najnovších ťahov sa odosiela schválenému poskytovateľovi modelu AI na zodpovedanie vašich otázok. Vaše krstné meno sa zdieľa na personalizáciu; žiadne iné identifikačné údaje sa poskytovateľovi AI neodosielajú. Ak požiadate o ľudskú pomoc a vaša otázka sa eskaluje, táto konverzácia (vrátane vášho mena a e-mailu) môže byť zdieľaná s naším tímom podpory. {$a->product} si môžete kedykoľvek stiahnuť, odstrániť alebo prestať používať.';
...
$string['settings:current_page_content_maxchars_desc'] = 'Maximálny počet znakov textu aktuálnej stránky vložených do systémovej výzvy ako sekcia „Current Page Content“, keď je RAG vypnutý. Predvolená hodnota 8,000 dobre ukotvuje otázky špecifické pre stránku a zároveň ponecháva rozpočet na štruktúru a inštrukcie. (Pri zapnutom RAG je stránka namiesto toho ukotvená vlastnými najrelevantnejšími úryvkami s preferenciou aktuálnej stránky, takže toto obmedzenie sa neuplatňuje.) Veľmi dlhá stránka sa od začiatku skráti na tento počet znakov, takže koniec mimoriadne dlhej stránky nemusí byť citovaný; zapnutie RAG tomu zabráni. Stránky dbajúce na náklady môžu túto hodnotu obmedziť nižšie (napr. 3,000-4,000). Obmedzené na rozsah 500-8,000. Nezávislé od <code>prompt_budget_chars</code>: toto obmedzuje iba sekciu stránky; rozpočet obmedzuje celú výzvu.';
...
$string['settings:backend_context_tokens_desc'] = 'Maximálna dĺžka kontextu (max_model_len) vášho AI backendu v tokenoch. Nastavte na 0 pre hostované modely s veľkým oknom (bez orezávania). Pri nastavení nad 0 (napríklad 8192 na vlastne hostovanom vLLM backende) SOLA zmenší vyššie uvedený znakový rozpočet systémového promptu tak, aby sa prompt spolu s rezervovaným výstupom a históriou konverzácie zmestil do okna, dokonca aj v jazykoch s vysokou hustotou tokenov. Pozrite si stránku wiki Deployment Sizing, ako to súvisí s počtom súbežných používateľov.';
$string['settings:backend_retry_attempts'] = 'Pokusy o opakovanie backendu';
$string['settings:backend_retry_attempts_desc'] = 'Koľkokrát zopakovať prechodnú chybu backendu (HTTP 429 alebo 503) pred zobrazením chyby študentovi. Opakovania prebiehajú iba predtým, ako bol odoslaný akýkoľvek text odpovede, takže výstup sa nikdy nezduplikuje. Určené pre malé vlastne hostované backendy, ktoré odmietajú požiadavky pri zaťažení. Nastavte na 0 pre vypnutie. Predvolené 2.';
$string['settings:backend_retry_max_wait'] = 'Maximálny čas čakania na opakovanie backendu (sekundy)';
$string['settings:backend_retry_max_wait_desc'] = 'Horná hranica v sekundách, ako dlho rešpektovať hlavičku Retry-After z backendu pred opakovaním. Keď backend neodošle Retry-After, SOLA namiesto toho použije krátke exponenciálne čakanie. Predvolené 5.';
$string['prompt:truncation_hint'] = 'POZNÁMKA: Úplný obsah kurzu sa v tomto ťahu nepodarilo prehľadať z dôvodu obmedzení dĺžky. Ak sa študent opýta na niečo, čo nemôžete nájsť v poskytnutom obsahu, povedzte, že ste nedokázali prehľadať celý kurz, a navrhnite, aby otvoril konkrétnu stránku alebo aktivitu, kde je téma pokrytá, namiesto toho, aby ste tvrdili, že v kurze chýba.';
$string['selftest:title'] = 'Samotest backendu';
$string['selftest:intro'] = 'Spustite živú kontrolu vášho nakonfigurovaného AI backendu: malá výmena správ v chate, automatická detekcia kontextového okna (max_model_len) a porovnanie s vaším nastavením kontextového okna backendu, spodná hranica rozpočtu systémového promptu a (keď je RAG zapnutý) výmena vkladania. Sieťové volania prebiehajú iba po stlačení Spustiť.';
$string['selftest:run'] = 'Spustiť samotest backendu';
$string['selftest:check'] = 'Kontrola';
$string['selftest:status'] = 'Stav';
$string['selftest:detail'] = 'Podrobnosť';
$string['selftest:link'] = 'Stránka samotestu backendu';
$string['selftest:link_desc'] = 'Otvorte stránku <a href="{$a}">Samotest backendu</a>, aby ste overili, že váš AI backend funguje a je správne dimenzovaný. Užitočné hneď po konfigurácii vlastne hostovaného backendu.';
$string['profile:title'] = 'Predvoľby nasadenia';
$string['profile:intro'] = 'Aplikujte odporúčaný balík nastavení pre váš typ nasadenia. Hodnoty sa zapíšu do bežných nastavení pluginu a zostanú následne jednotlivo upraviteľné. Aplikovanie predvoľby prepíše uvedené nastavenia.';
$string['profile:current'] = 'Naposledy aplikovaná predvoľba: {$a}';
$string['profile:setting'] = 'Nastavenie';
$string['profile:value'] = 'Hodnota';
$string['profile:self_hosted_small'] = 'Vlastne hostovaný malý kontext (jeden GPU, napr. A30 24GB / vLLM pri 8K)';
$string['profile:hosted_large'] = 'Hostovaný veľký kontext (predvolené)';
$string['profile:apply_self_hosted_small'] = 'Aplikovať predvoľbu vlastne hostovaného malého kontextu';
$string['profile:apply_hosted_large'] = 'Aplikovať predvolené hodnoty hostovaného veľkého kontextu';
$string['profile:applied'] = 'Predvoľba {$a} bola aplikovaná. Hodnoty sú teraz vo vašich nastaveniach pluginu.';
$string['profile:unknown'] = 'Neznáma predvoľba nasadenia.';
$string['profile:link'] = 'Stránka predvolieb nasadenia';
$string['profile:link_desc'] = 'Otvorte stránku <a href="{$a}">Predvoľby nasadenia</a>, aby ste aplikovali odporúčaný balík nastavení pre hostovaný alebo vlastne hostovaný backend.';
$string['settings:zendesk_require_consent'] = 'Vyžadovať súhlas pred eskaláciou na podporu';
$string['settings:zendesk_require_consent_desc'] = 'Keď je zapnuté (odporúčané), SOLA eskaluje konverzáciu na pult podpory Zendesk až po tom, čo študent prijal oznámenie o súhlase pri prvom spustení, ktoré uvádza, že požiadanie o ľudskú pomoc zdieľa konverzáciu (vrátane mena a e-mailu) s podporou. Vypnite to iba vtedy, ak tento súhlas získate iným spôsobom; pri vypnutom nastavení sa eskalácie odosielajú okamžite. Nemá žiadny účinok, pokiaľ nie je zapnutá eskalácia Zendesk.';
$string['chat:escalation_needs_consent'] = 'Zdá sa, že toto si vyžaduje člena nášho tímu podpory. Aby som to mohol odovzdať im, musel by som zdieľať túto konverzáciu vrátane vášho mena a e-mailu s pultom podpory. S tým ste zatiaľ nesúhlasili, takže som nič neodoslal. Ak chcete ľudskú pomoc, prosím prijmite oznámenie o zdieľaní údajov pre tohto asistenta a opýtajte sa znova, alebo kontaktujte podporu priamo.';
$string['privacy:metadata:email_optout'] = 'Predvoľby odhlásenia z e-mailov pre jednotlivých príjemcov (z ktorých typov e-mailov sa príjemca odhlásil).';
$string['privacy:metadata:email_optout:email'] = 'E-mailová adresa príjemcu, na ktorú sa odhlásenie vzťahuje.';
$string['privacy:metadata:email_optout:optout_type'] = 'Typ e-mailu, z ktorého sa príjemca odhlásil.';
$string['privacy:metadata:email_optout:userid'] = 'Používateľ Moodle, ktorému odhlásenie patrí, ak je známy.';
$string['chat:consent_scroll_hint'] = 'Pred pokračovaním sa prosím posuňte nadol a prečítajte si celé oznámenie.';
$string['settings:rag_min_similarity'] = 'Minimálna relevancia (kosínus)';
$string['settings:rag_min_similarity_desc'] = 'Zahoď načítané úryvky, ktorých kosínusová podobnosť s otázkou je pod touto hodnotou, aby otázka mimo tému alebo s riedkym obsahom vložila menej (alebo nula) pasáží namiesto toho, aby vždy doplnila do Top-K slabými zhodami. Rozsah 0 až 1; 0 vypína bránu. Správna hodnota závisí od modelu vnorenia: 0.25 sa hodí pre text-embedding-3-small. Zvýš ju, aby si bol prísnejší (menej kontextu, viac k téme), zníž ju, aby si bol zhovievavejší.';
$string['settings:rag_currentpage_boost'] = 'Bonus za aktuálnu stránku';
$string['settings:rag_currentpage_boost_desc'] = 'Malý bonus pridaný k skóre relevancie úryvkov zo stránky, ktorú si študujúci práve prezerá, aby otázky ako „vysvetli toto“ uprednostnili viditeľnú stránku, keď sú skóre blízko seba. Iba poradie: nenúti nerelevantný úryvok stránky prejsť cez bránu minimálnej relevancie. Nastav 0 na vypnutie.';
$string['settings:history_mode'] = 'Režim výberu histórie';
$string['settings:history_mode_desc'] = 'Ako sa vyberajú predchádzajúce ťahy konverzácie pred odoslaním modelu. <strong>Sémantický</strong> ponecháva iba nedávne ťahy relevantné k aktuálnej otázke (a vždy najnovšiu výmenu), takže zastaraný, mimo témy ležiaci skorší ťah nezvyšuje náklady ani neodvádza odpoveď nesprávnym smerom; vykoná jedno dodatočné volanie vnorenia na správu. <strong>Podľa nedávnosti</strong> ponecháva posledné páry „Max Conversation History“ bez ohľadu na relevanciu (dlhodobé správanie, bez dodatočného volania). Ak vnorenie nie je dostupné, sémantický režim sa automaticky prepne na režim podľa nedávnosti.';
$string['settings:history_mode_semantic'] = 'Sémantický (relevantné nedávne ťahy)';
$string['settings:history_mode_recency'] = 'Podľa nedávnosti (posledných N párov)';
$string['settings:history_semantic_minscore'] = 'Spodná hranica relevancie histórie (kosínus)';
$string['settings:history_semantic_minscore_desc'] = 'V sémantickom režime histórie sa predchádzajúci ťah ponechá iba vtedy, ak je jeho podobnosť s aktuálnou otázkou aspoň táto hodnota (najnovšia výmena sa ponecháva vždy). Rozsah 0 až 1; závisí od modelu. Zvýš, aby si bol prísnejší (menej histórie), zníž, aby si ponechal viac.';
$string['settings:history_candidates'] = 'Okno kandidátov histórie';
$string['settings:history_candidates_desc'] = 'V sémantickom režime histórie sa na relevanciu hodnotí iba tento počet najnovších párov (obmedzenie nákladov). Páry staršie než toto okno sa neodosielajú. Ponechaj túto hodnotu rovnú alebo vyššiu ako „Max Conversation History“.';
