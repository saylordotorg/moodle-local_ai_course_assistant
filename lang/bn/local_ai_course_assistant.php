...
$string['settings:comparison_providers_desc'] = 'উইজেটের মধ্যে LLM পিকারে অতিরিক্ত AI প্রদানকারী যোগ করুন যাতে প্রশাসকরা বিভিন্ন প্রদানকারীর প্রতিক্রিয়া তুলনা করতে পারেন। প্রতি লাইনে একটি প্রদানকারী এই ফরম্যাটে: provider_id|api_key|model1,model2। উপরে কনফিগার করা প্রাথমিক প্রদানকারী সর্বদা স্বয়ংক্রিয়ভাবে অন্তর্ভুক্ত থাকে। শুধুমাত্র পরিচালনার ক্ষমতা সম্পন্ন প্রশাসকরা পিকারটি দেখতে পান; শিক্ষার্থীরা কখনও দেখতে পান না। উদাহরণ:<br><code>claude|sk-ant-api03-...|claude-sonnet-4-5-20250929,claude-3-5-haiku-20241022<br>gemini|AIzaSy...|gemini-2.0-flash<br>deepseek|sk-...|deepseek-chat</code><br>বৈধ provider IDs: openai, claude, deepseek, gemini, ollama, minimax, mistral, groq, openrouter, xai, coreai, custom.';
