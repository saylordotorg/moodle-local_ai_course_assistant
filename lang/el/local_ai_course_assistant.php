...
$string['settings:embed_input_type_asymmetric'] = 'Ασύμμετρο ερώτημα/έγγραφο';
$string['settings:embed_input_type_mode'] = 'Τύπος εισόδου ενσωμάτωσης';
$string['settings:embed_input_type_mode_desc'] = 'Μόνο για ενσωματώσεις Voyage. Ο «κοινός χώρος» ενσωματώνει ερωτήματα και έγγραφα με τον ίδιο τρόπο, οπότε τα δύο παραμένουν συγκρίσιμα μετά από αλλαγή μοντέλου. Το «ασύμμετρο» χρησιμοποιεί τη χωριστή προβολή ερωτήματος της Voyage· είναι η βελτιστοποίηση που προτείνει ο προμηθευτής, αλλά δεν κατάφερε να αναπαραγάγει κανένα κέρδος σε αυτό το σώμα κειμένων δύο φορές, οπότε προεπιλογή είναι ο κοινός χώρος. Η αλλαγή αυτού δεν απαιτεί εκ νέου δημιουργία ευρετηρίου.';
$string['settings:embed_input_type_shared'] = 'Κοινός χώρος (συνιστάται)';
