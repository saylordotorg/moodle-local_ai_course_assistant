...
Τα μαθήματα πρέπει να έχουν ήδη ευρετηριαστεί για ανάκτηση· δεν ενσωματώνεται τίποτα επιπλέον, οπότε η προσθήκη εδώ ισχύει αμέσως και δεν κοστίζει τίποτα. Τα κρυφά μαθήματα αγνοούνται, άρα αυτό δεν μπορεί να χρησιμοποιηθεί για να εμφανιστεί υλικό που δεν πρέπει να δει ο φοιτητής. Το πολύ {$a} μαθήματα. Μια ρύθμιση σε επίπεδο μαθήματος, όπου υπάρχει, αντικαθιστά αυτή τη λίστα αντί να προστίθεται σε αυτήν.';
