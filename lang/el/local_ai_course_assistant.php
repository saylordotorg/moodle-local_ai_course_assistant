...
$string['pedagogy:crossmastery_desc'] = 'Όταν είναι ενεργό, το SOLA αναγνωρίζει πότε ένας εκπαιδευόμενος έχει ήδη κατακτήσει έναν στόχο σε άλλο μάθημα (με αντιστοίχιση βάσει αναφοράς δεξιότητας ή τίτλου) και επιβεβαιώνει αυτή την προϋπάρχουσα δεξιότητα αντί να την εξασκεί ξανά. Απαιτεί παρακολούθηση μάθησης· τα μαθήματα χωρίς στόχους υποχωρούν ομαλά. Αποκλειστικά συμβουλευτικό — δεν αλλάζει ποτέ την αποθηκευμένη βαθμολογία μάθησης ενός εκπαιδευόμενου σε κανένα μάθημα.';
...
$string['pedagogy:learning_path_desc'] = 'Όταν είναι ενεργό, το SOLA προσθέτει ένα οπτικό πάνελ μαθησιακής διαδρομής (ένα κουμπί «η διαδρομή μου» στην κεφαλίδα του widget) που εμφανίζει το πρόγραμμα του εκπαιδευόμενου ως μια ακολουθία μαθημάτων, καθένα από τα οποία μπορεί να αναπτυχθεί στους στόχους του και στην κατάκτηση του εκπαιδευόμενου. Όταν ο εκπαιδευόμενος έχει φτάσει το όριο για το τρέχον μάθημα (ολοκλήρωση ή υψηλό ποσοστό κατακτημένων στόχων), το SOLA εμφανίζει επίσης ένα διακριτικό banner «έτοιμος για το επόμενο μάθημα» και το αναφέρει στη συνομιλία. Μόνο συμβουλευτικό· χρησιμοποιεί τη δική του κατανομή προγράμματος του εκπαιδευόμενου· δεν κάνει τίποτα σιωπηλά όπου δεν ισχύει κανένα πρόγραμμα.';
...
$string['settings:backend_retry_max_wait_desc'] = 'Άνω όριο, σε δευτερόλεπτα, για το πόσο θα τηρείται μια κεφαλίδα Retry-After από το backend πριν την επανάληψη. Όταν το backend δεν στέλνει Retry-After, το SOLA χρησιμοποιεί αντ\' αυτού μια σύντομη εκθετική υποχώρηση. Προεπιλογή 5.';
...
$string['emergency:title'] = 'Έκτακτοι έλεγχοι SOLA';
$string['emergency:page_warning'] = 'Αυτοί οι διακόπτες τίθενται σε ισχύ αμέσως για όλους τους εκπαιδευόμενους στον ιστότοπο. Κάθε ενέργεια γράφει μια γραμμή ελέγχου. Οι λεπτομερείς διακόπτες αφήνουν το υπόλοιπο SOLA να λειτουργεί· ο κύριος διακόπτης απενεργοποίησης αφαιρεί πλήρως το widget από κάθε σελίδα.';
$string['emergency:back_to_settings'] = 'Ρυθμίσεις SOLA';
...
$string['emergency:flag_chat_desc'] = 'Αποκλείει την κίνηση συνομιλίας μέσω ειδικής σημαίας kill (διόρθωση v5.13). Το widget συνεχίζει να εμφανίζεται· οι εκπαιδευόμενοι βλέπουν το φιλικό μήνυμα «Το SOLA έχει τεθεί σε παύση». Χρησιμοποιήστε όταν ένας πάροχος LLM συμπεριφέρεται εσφαλμένα ή κατά τη διάρκεια έξαρσης κόστους.';
...
$string['emergency:flag_all_desc'] = 'Απενεργοποιεί ολόκληρο το πρόσθετο: το widget εξαφανίζεται από κάθε σελίδα, οι προγραμματισμένες εργασίες σταματούν, η φωνή διαγράφεται, το RAG είναι απενεργοποιημένο, το outreach είναι απενεργοποιημένο. Ο πιο ισχυρός διακόπτης — χρησιμοποιείστε σε περίπτωση συμβάντος ασφαλείας ή όταν το SOLA πρέπει να τεθεί εκτός σύνδεσης άμεσα.';
$string['emergency:settings_link'] = 'Έκτακτοι έλεγχοι';
$string['emergency:settings_link_desc'] = 'Διακόπτες kill ανά υποσύστημα (συνομιλία / φωνή / RAG / outreach / κύριος) με καταγραφή ελέγχου — ισοδύναμο ιστού του <code>admin/cli/emergency_disable.php</code>. Ανοίξτε τους <a href="{$a}">Έκτακτους ελέγχους SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Κατάργηση εγγραφής';
$string['email_unsubscribe:done_body'] = 'Ολοκληρώθηκε — το {$a->email} δεν θα λαμβάνει πλέον αυτόν τον τύπο email από {$a->product}. Αν αλλάξετε γνώμη, ζητήστε από έναν διαχειριστή {$a->product} να επανενεργοποιήσει τη συνδρομή ή στείλτε νέα αποδοχή μέσω της σελίδας διαχείρισης παραληπτών SOLA.';
...
$string['task:policy_bundle_sync'] = 'SOLA συγχρονισμός υπογεγραμμένου πακέτου πολιτικής';
...
$string['analytics:exp_active_users'] = 'Ενεργοί χρήστες SOLA';
