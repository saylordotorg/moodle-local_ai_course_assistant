...
$string['settings:default_course_mode_desc'] = 'ஒவ்வொரு பாடநெறிக்கும் எந்த தேர்வும் செய்யப்படாதபோது ஒரு பாடநெறியில் [[tutorshort]] தோன்றுமா என்பதைக் கட்டுப்படுத்துகிறது. புதிய நிறுவல்கள் இயல்பாக "இயல்பாக முடக்கப்பட்டுள்ளது" என்பதற்கு அமைக்கப்பட்டுள்ளன, இதனால் நிர்வாகிகள் Analytics பக்கம் அல்லது Course AI Settings பக்கத்திலிருந்து பாடநெறி-வாரியாக ஒப்புக்கொள்ள முடியும்.';
...
$string['coursesettings:sola_enabled'] = 'இந்த பாடநெறியில் [[tutorshort]]';
$string['coursesettings:sola_enabled_toggle'] = 'இந்த பாடநெறியில் [[tutorshort]] விட்ஜெட்டைக் காட்டு';
$string['coursesettings:sola_enabled_desc'] = 'இந்த பாடநெறியில் [[tutorshort]] அரட்டை விட்ஜெட் தோன்றுமா என்பதைக் கட்டுப்படுத்துகிறது. தள-வியாபக இயல்புநிலை செருகுநிரல் அமைப்புகளில் General > Default for new courses கீழ் அமைக்கப்படுகிறது.';
...
$string['chat:greeting'] = 'வணக்கம், {$a}! நான் [[tutorshort]]. இன்று நான் உங்களுக்கு எப்படி உதவ முடியும்?';
$string['chat:title'] = '[[tutorshort]]';
$string['chat:assistant'] = '[[tutorshort]]';
$string['chat:open'] = '[[tutorshort]]-வை திற';
...
$string['chat:voice_speaking'] = '[[tutorshort]] பேசுகிறது...';
$string['chat:voice_idle'] = 'தயார்';
$string['chat:voice_error'] = 'குரல் இணைப்பு தோல்வியுற்றது. அமைப்புகளை சரிபார்க்கவும்.';
$string['chat:quiz_locked'] = 'கல்வி நேர்மையை ஆதரிக்க வினாடி வினாக்களின் போது [[tutorshort]] இடைநிறுத்தப்பட்டுள்ளது. வாழ்த்துக்கள்!';
...
$string['settings:cdn_heading_desc'] = 'Moodle கோப்பு அமைப்புக்குப் பதிலாக வெளிப்புற CDN இலிருந்து [[tutorshort]] முன்னோக்கு சொத்துக்களை (JS/CSS) வழங்கவும். இது செருகுநிரல் மேம்படுத்தல் இல்லாமல் முன்னோக்கு புதுப்பிப்புகளை செயல்படுத்துகிறது. உள்ளூர் செருகுநிரல் கோப்புகளைப் பயன்படுத்த CDN URL ஐ காலியாக விடவும்.';
...
$string['chat:voice_title'] = '[[tutorshort]] உடன் பேசு';
...
$string['mobile_disabled'] = '[[tutorshort]] இந்த பாடத்திற்கு கிடைக்கவில்லை.';
$string['mobile_placeholder'] = 'கேள்வி கேளுங்கள்...';
$string['mobile_welcome'] = 'வணக்கம், {$a}!';
$string['mobile_welcome_sub'] = 'நான் [[tutorshort]], உங்கள் கற்றல் உதவியாளர். இன்று எவ்வாறு உதவ முடியும்?';
...
$string['settings:rag_return_scope'] = 'மீட்பு திரும்பும் வரம்பு';
$string['settings:rag_return_scope_desc'] = 'ஒவ்வொரு மீட்கப்பட்ட பொருத்தத்திற்கும் எதைச் செருக வேண்டும் என்பது. "chunk" (இயல்பு) பொருந்திய ~400-வார்த்தை பகுதியைச் செருகும். "window" பொருந்திய பகுதியுடன் அதே பக்கத்திலிருந்து அருகிலுள்ள பகுதிகளையும் செருகும். "page" பொருத்தம் சேர்ந்துள்ள முழு தொகுதி பக்கத்தையும் செருகும். window/page ஆகியவை பதில் ஒரு பக்கம் முழுவதும் பரவும்போது உதவுகின்றன, ஆனால் பெரிய prompt-ஐ ஏற்படுத்தும்.';
$string['settings:rag_window_size'] = 'மீட்பு சாளர அளவு';
$string['settings:rag_window_size_desc'] = '"window" திரும்பும் வரம்புக்கு: பொருந்திய பகுதியின் ஒவ்வொரு பக்கத்திலும் சேர்க்க வேண்டிய அருகிலுள்ள பகுதிகளின் எண்ணிக்கை. இயல்பு 1.';
$string['settings:rag_parent_max_chars'] = 'மூல பத்தியின் வரம்பு (எழுத்துகள்)';
$string['settings:rag_parent_max_chars_desc'] = 'விரிவாக்கப்பட்ட window/page பத்திக்கான அதிகபட்ச எழுத்துகள். வரம்பை மீறும் பக்கங்கள் window-க்கும், பின்னர் ஒற்றை chunk-க்கும் திரும்பும். இயல்பு 6000.';
...
$string['demo:course_fullname'] = '[[tutorshort]] சோதனை பாடநெறி (மறைக்கப்பட்டது)';
...
$string['settings:xai_proxy_url_desc'] = '[[tutorshort]] xAI Realtime proxy சேவையின் பொது wss URL (உதாரணமாக wss://voice.example.com/xai-rt/rt). இது JWT ரகசியத்துடன் சேர்த்து அமைக்கப்பட்டால், xAI குரல் proxy வழியாக செல்கிறது மற்றும் முதன்மை xAI API சாவி உலாவிக்கு ஒருபோதும் அடைவதில்லை. நேரடி இணைப்புக்குத் திரும்ப காலியாக விடவும் (உற்பத்திக்குப் பரிந்துரைக்கப்படவில்லை).';
...
$string['objectives:rebuild_links_help'] = 'ஒரு கற்பவர் வேறு இடத்தில் ஒரு தலைப்பில் தேர்ச்சி பெற்றிருந்தால் அவர் மீண்டும் பயிற்சி செய்யப்படாமல் இருக்கும்படி, பாடநெறிகளுக்கு இடையே (திறன் குறிப்பு அல்லது தலைப்பு மூலம்) பொருந்தும் நோக்கங்களை [[tutorshort]] இணைக்கிறது. இணைப்புகள் ஒவ்வொரு இரவும் தானாகவே மீண்டும் உருவாக்கப்படும்; நோக்கங்களைத் திருத்திய பிறகு இப்போதே மீண்டும் உருவாக்க இந்தப் பொத்தானைப் பயன்படுத்தவும்.';
...
$string['pedagogy:learning_path_desc'] = 'இயக்கப்பட்டால், [[tutorshort]] ஒரு காட்சி கற்றல்-பாதை பலகத்தை (விட்ஜெட் தலைப்பில் "எனது பாதை" பொத்தான்) சேர்க்கிறது, இது கற்பவரின் திட்டத்தை பாடநெறிகளின் வரிசையாகக் காட்டுகிறது, ஒவ்வொன்றையும் அதன் இலக்குகள் மற்றும் கற்பவரின் தேர்ச்சியைக் காண விரிவாக்கலாம். கற்பவர் தற்போதைய பாடநெறிக்கான வரம்பை அடைந்தால் (நிறைவு அல்லது தேர்ச்சி பெற்ற இலக்குகளின் அதிக பங்கு), [[tutorshort]] "அடுத்த பாடநெறிக்குத் தயார்" என்ற மென்மையான பேனரையும் காட்டி அதை உரையாடலில் குறிப்பிடுகிறது. ஆலோசனை மட்டுமே; கற்பவரின் சொந்த திட்ட ஒதுக்கீட்டைப் பயன்படுத்துகிறது; எந்தத் திட்டமும் பொருந்தாத இடத்தில் அமைதியாக எதுவும் செய்யாது.';
...
$string['settings:backend_retry_max_wait_desc'] = 'மறுமுயற்சி செய்வதற்கு முன், பின்தளத்திலிருந்து வரும் Retry-After தலைப்பை எவ்வளவு நேரம் மதிக்க வேண்டும் என்பதற்கான மேல் எல்லை, வினாடிகளில். பின்தளம் Retry-After அனுப்பாதபோது, [[tutorshort]] அதற்குப் பதிலாக ஒரு குறுகிய அதிவேக பின்வாங்கலைப் பயன்படுத்துகிறது. இயல்புநிலை 5.';
...
$string['settings:zendesk_require_consent_desc'] = 'இயக்கப்பட்டிருக்கும்போது (பரிந்துரைக்கப்படுகிறது), மனித உதவியைக் கோருவது உரையாடலை (பெயர் மற்றும் மின்னஞ்சல் உட்பட) ஆதரவுடன் பகிர்கிறது என்பதை வெளிப்படுத்தும் முதல்-முறை ஒப்புதல் அறிவிப்பைக் கற்றவர் ஏற்ற பிறகே [[tutorshort]] உரையாடலை Zendesk ஆதரவு மையத்திற்கு மேம்படுத்தும். அந்த ஒப்புதலை வேறு வழியில் பெற்றால் மட்டுமே இதை முடக்கவும்; முடக்கப்பட்டிருந்தால், மேம்படுத்தல்கள் உடனடியாக அனுப்பப்படும். Zendesk மேம்படுத்தல் இயக்கப்படாதவரை எந்த விளைவும் இல்லை.';
...
$string['settings:rerank_candidates_desc'] = 'மறுவரிசைப்படுத்தல் நிலைக்கு எத்தனை கொசைன் top-N வேட்பாளர்கள் அனுப்பப்படுவார்கள். இயல்புநிலை 20. 1,008 வினவல்களில் அளவிடப்பட்டது: நினைவுத்திறனில் 20 என்பது 30-க்குச் சமம் (R@3 89.0% எதிராக 89.3%), செலவு மூன்றில் ஒரு பங்கு குறைவு; 50 என்பது 2.5 மடங்கு செலவாகும், அளவிடத்தக்க பயன் இல்லை. 10-க்குக் கீழே நினைவுத்திறன் குறைகிறது. இந்த மதிப்புக்கு ஏற்ப செலவு நேர்கோட்டில் அதிகரிக்கிறது.';
$string['settings:stt_selfhosted_heading'] = 'சுய-நேசப்படுத்தப்பட்ட படியெடுத்தல் (Whisper)';
$string['settings:stt_selfhosted_heading_desc'] = 'நிமிட செலவு இல்லாமல் உங்கள் சொந்த வன்பொருளில் speech-to-text இயக்கவும். [[tutorshort]]-ஐ எந்த OpenAI-இணக்கமான படியெடுத்தல் சேவையகத்திலும் சுட்டுங்கள்: Docker <code>whisper-server</code>, <code>speaches</code> (faster-whisper), அல்லது <code>whisper.cpp</code> சேவையகம். ஒரு சேவையக URL இங்கே அமைக்கப்படும்போது, அது இயல்புநிலை STT பாதையாக மாறுகிறது; மேலெழுத மேலே உள்ள செயலில் STT வழங்குனர் அமைப்பில் கட்டண வழங்குனரை தேர்வு செய்யுங்கள். சேவையகம் தனியார் நெட்வொர்க்கில் அல்லது plain http-ல் இருந்தால், பாதுகாப்பு பிரிவில் SSRF நம்பகமான இறுதிப்புள்ளிகள் அனுமதிப்பட்டியலில் அதன் ஹோஸ்டையும் சேர்க்கவும்.';
$string['settings:stt_selfhosted_url'] = 'சுய-நேசப்படுத்தப்பட்ட STT சேவையக URL';
$string['settings:stt_selfhosted_url_desc'] = 'OpenAI-இணக்கமான படியெடுத்தல் சேவையகத்தின் அடிப்படை URL, எடுத்துக்காட்டாக <code>http://10.0.0.5:8000</code>. [[tutorshort]] தானாகவே <code>/v1/audio/transcriptions</code>-ஐ சேர்க்கிறது; முழு இறுதிப்புள்ளி பாதையும் ஏற்றுக்கொள்ளப்படுகிறது. சுய-நேசப்படுத்தப்பட்ட STT-ஐ முடக்க வெறுமையாக விடுங்கள்.';
...
$string['emergency:title'] = '[[tutorshort]] அவசர கட்டுப்பாடுகள்';
$string['emergency:page_warning'] = 'இந்த சுவிட்சுகள் தளத்தில் உள்ள ஒவ்வொரு கற்போருக்கும் உடனடியாக நடைமுறைக்கு வருகின்றன. ஒவ்வொரு செயலும் ஒரு தணிக்கை வரிசையை எழுதுகிறது. விரிவான சுவிட்சுகள் [[tutorshort]]-வின் மற்ற பகுதிகளை இயங்கவிட்டுவிடுகின்றன; மாஸ்டர் கில் விட்ஜெட்டை முழுமையாக அகற்றுகிறது.';
$string['emergency:back_to_settings'] = '[[tutorshort]] அமைப்புகள்';
...
$string['emergency:flag_chat_desc'] = 'அர்ப்பணிக்கப்பட்ட kill கொடி மூலம் அரட்டை போக்குவரத்தை தடுக்கிறது (v5.13 திருத்தம்). விட்ஜெட் தொடர்ந்து தோன்றுகிறது; கற்போர்கள் "[[tutorshort]] இடைநிறுத்தப்பட்டது" என்ற நட்பான செய்தியைப் பார்க்கிறார்கள். LLM வழங்குனர் மோசமாக நடந்துகொள்ளும்போது அல்லது செலவு அதிகரிப்பு நடந்துகொண்டிருக்கும்போது பயன்படுத்தவும்.';
...
$string['emergency:flag_all_desc'] = 'முழு செருகுநிரலை முடக்குகிறது: விட்ஜெட் ஒவ்வொரு பக்கத்திலிருந்தும் மறைகிறது, திட்டமிட்ட பணிகள் நிறுத்தப்படுகின்றன, குரல் அழிக்கப்படுகிறது, RAG அணைக்கப்படுகிறது, வெளிச்செல்லும் தொடர்பு அணைக்கப்படுகிறது. மிகவும் வலிமையான சுவிட்ச் — பாதுகாப்பு சம்பவத்திற்கு அல்லது [[tutorshort]] உடனடியாக ஆஃப்லைனில் எடுக்கப்பட வேண்டியிருக்கும்போது பயன்படுத்தவும்.';
$string['emergency:settings_link'] = 'அவசர கட்டுப்பாடுகள்';
$string['emergency:settings_link_desc'] = 'தணிக்கை பதிவுசெய்தலுடன் துணை அமைப்பு-வாரியான kill சுவிட்சுகள் (அரட்டை / குரல் / RAG / வெளிச்செல்லும் தொடர்பு / மாஸ்டர்) — <code>admin/cli/emergency_disable.php</code>-இன் இணைய சமதுல்யம். <a href="{$a}">[[tutorshort]] அவசர கட்டுப்பாடுகள்</a> திறக்கவும்.';
$string['email_unsubscribe:done_title'] = 'குழுவிலகியது';
$string['email_unsubscribe:done_body'] = 'முடிந்தது — {$a->email} இனி {$a->product}-லிருந்து இந்த வகை மின்னஞ்சலை பெறாது. மனம் மாறினால், {$a->product} நிர்வாகியிடம் சந்தாவை மீண்டும் இயக்கும்படி கேளுங்கள், அல்லது நிர்வாக குழுவில் [[tutorshort]] Recipients பக்கம் மூலம் புதிய opt-in அனுப்புங்கள்.';
...
$string['settings:premium_escalation_heading_desc'] = 'வேலை செய்யும் அரட்டை நிலை வெளிப்படையாக திணறும் prompt-களுக்கு பிரீமியம் மாதிரிக்கு (இயல்புநிலையில் Claude Opus 4.8) விருப்பமான திருப்பு-வாரியான திசைவு — பொதுவாக பல-படி கணிதம், CS மற்றும் அறிவியல் சிந்தனை. 2026-06-09 A.10 bake-off மூலம் தீர்க்கப்பட்டது: Opus 4.8 கடினமான prompt-களில் 14.97/15 vs gpt-4o-வின் 12.68/15 என வென்றது. இரண்டு தூண்டுதல் பாதைகள்: பயனர் செய்தியில் regex பொருத்தங்கள், அல்லது ஒவ்வொரு திருப்பையும் தரமுயர்த்தும் பாட அனுமதிப்பட்டியல். இயல்புநிலையில் அணைக்கப்பட்டுள்ளது. ~5% தரமுயர்வில், 100k [[unishort]] MAU-ல் அடிப்படை அரட்டை செலவிற்கு மேல் ~$700/மாதம் எதிர்பார்க்கவும்.';
...
$string['settings:cost_anomaly_heading_desc'] = 'தினசரி திட்டமிட்ட பணி (<code>cost_anomaly_check</code>) இன்றைய தள-அகல [[tutorshort]] செலவை 7-நாள் உருளும் சராசரியுடன் ஒப்பிடுகிறது. இன்று கட்டமைக்கப்பட்ட பெருக்கி × சராசரியை மீறும்போது <code>spend_notify_emails</code> பெறுநர் பட்டியலுக்கு (தள நிர்வாகிகளுக்கு fallback) மின்னஞ்சல் அனுப்புகிறது. தற்போதுள்ள 80% / 95% / 100% செலவு-வரம்பு வரம்புகள் தவறவிடும் மூன்று தோல்வி பயன்முறைகளை கண்டுபிடிக்கிறது: (1) முழுமையான உச்சவரம்பு தாண்டப்படாத ஓட்டப் படம் ஆனால் ஒரு படம் திடீரென்று வழக்கமான அளவை விட 10x இயக்குகிறது, (2) தற்செயலான பிரீமியம்-நிலை இயக்கல், (3) வழங்குனர் தவறான திசைவு. இயல்புநிலையில் அணைக்கப்பட்டுள்ளது; <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>-ல் Redash வினவலின் [[tutorshort]]-க்குள்ளான சமதுல்யம்.';
...
$string['settings:cost_anomaly_multiplier_desc'] = 'இன்றைய செலவு ஒரு எச்சரிக்கையை தூண்ட இந்த பெருக்கி × 7-நாள் சராசரியை மீற வேண்டும். இயல்புநிலை <code>2.0</code>. முந்தைய எச்சரிக்கைகளுக்கு <code>1.5</code>-க்கு குறைக்கவும் (சேர்ப்பு அதிகரிப்பின் போது அதிக பொய்-நேர்மறைகள்). 2x கூர்முனைகள் வழக்கமானவையாக இருக்கும் அளவுக்கு [[unishort]] பயன்பாடு burst ஆனால் <code>3.0</code>-க்கு உயர்த்தவும்.';
$string['task:cost_anomaly_check'] = '[[tutorshort]] தினசரி செலவு அசாதாரண சரிபார்ப்பு';
...
$string['task:policy_bundle_sync'] = '[[tutorshort]] கையொப்பமிட்ட கொள்கை தொகுப்பு ஒத்திசைவு';
...
$string['settings:policy_bundle_status'] = 'கடைசி ஒத்திசைவு';
$string['settings:policy_bundle_applied_version'] = 'பயன்படுத்தப்பட்ட பதிப்பு';
$string['task:policy_bundle_sync'] = '[[tutorshort]] கையொப்பமிடப்பட்ட கொள்கை தொகுப்பு ஒத்திசைவு';
$string['policy_bundle:invalid'] = 'கொள்கை தொகுப்பு நிராகரிக்கப்பட்டது: {$a}';
...
$string['analytics:exp_active_users'] = 'செயலில் உள்ள [[tutorshort]] பயனர்கள்';
...
$string['cachedef_ratelimit'] = 'ஒவ்வொரு பயனருக்கான கோரிக்கை வேக வரம்பு';
$string['cachedef_uistate'] = 'ஒவ்வொரு அமர்வுக்கான UI நிலைமாற்றிகள் (மாணவராகக் காண்க, உண்மைப் பெயர்களைக் காட்டு)';
$string['benchmark:pagetitle'] = 'வழங்குநர் தரப்படுத்தல்';
$string['benchmark:intro'] = 'உள்ளமைக்கப்பட்ட ஒவ்வொரு AI வழங்குநருக்கும் நிலையான வழக்கமான தூண்டுதல்களின் தொகுப்பை அனுப்பி, டோக்கன் பயன்பாடு, செலவு மற்றும் தாமதத்தைப் பதிவுசெய்து, ஒவ்வொரு திறனுக்கும் ஒரு வழங்குநரைப் பரிந்துரைக்கிறது. ஒவ்வொரு இயக்கமும் உண்மையான API அழைப்புகளை மேற்கொள்கிறது, எனவே எத்தனை வழங்குநர்கள் உள்ளமைக்கப்பட்டுள்ளனர் என்பதைப் பொறுத்து ஒரு இயக்கத்திற்குத் தோராயமாக 5 முதல் 20 சென்ட் வரை செலவாகும்.';
$string['cachedef_systemprompt'] = 'தொகுக்கப்பட்ட AI கணினித் தூண்டுதல் (ஒவ்வொரு பாடத்திற்கும்)';
$string['cachedef_remoteconfig'] = 'புதுப்பிப்பு சேனலிலிருந்து பெறப்பட்ட தொலைநிலை உள்ளமைவு';
$string['cachedef_spend'] = 'செலவுக் காவலருக்கான ஒவ்வொரு காலகட்டத்தின் AI செலவு மொத்தங்கள்';
$string['cachedef_failover_circuit'] = 'வழங்குநர் தோல்வி-மாற்று மின்சுற்று-முறிப்பு நிலை';
$string['settings:rag_scope'] = 'மீட்டெடுப்பு நோக்கம்';
$string['settings:rag_scope_desc'] = 'ஒரு கற்பவர் ஒரு குறிப்பிட்ட ஆவணத்தைப் (ஒரு பக்கம், புத்தகம் அல்லது PDF) பார்க்கும்போது, மீட்டெடுப்பை அந்த ஆவணத்திற்கு மட்டுப்படுத்தலாமா என்பது. <b>ஆவணம்-முதலில்</b> நடப்பு ஆவணத்தில் தொடர்புடைய பகுதிகள் இருக்கும்போது அதன் அடிப்படையில் பதிலை நிலைநிறுத்துகிறது, இல்லையெனில் முழுப் பாடத்திற்கும் திரும்புகிறது. <b>ஆவணம்-மட்டும்</b> ஒருபோதும் திரும்பாது: நடப்பு ஆவணத்தில் தொடர்புடைய பகுதி எதுவும் இல்லையென்றால் எதையும் மீட்டெடுக்காது, எனவே பயிற்றுவிப்பாளர் தொடர்பற்ற பக்கங்களை மேற்கோள் காட்டுவதைவிட பொது அறிவிலிருந்து பதிலளிக்கிறார். <b>பாடம்-முழுவதும்</b> அனைத்து பாட உள்ளடக்கத்தையும் தேடுகிறது (நடப்புப் பக்கத்திற்கு மேலே உள்ள வரிசைப்படுத்தல் மேம்பாடு இன்னும் கிடைக்கும்). ஆவணம்-முதலில் பரிந்துரைக்கப்படுகிறது, இதனால் ஒரு கற்பவர் படிக்கும் பக்கத்தைப் பற்றிய பதில் அந்தப் பக்கத்தின் அடிப்படையில் நிலைநிறுத்தப்படுகிறது.';
$string['settings:rag_scope_document_first'] = 'ஆவணம்-முதலில் (நடப்பு ஆவணத்திற்கு முன்னுரிமை, பாடத்திற்குத் திரும்பு)';
$string['settings:rag_scope_document_only'] = 'ஆவணம்-மட்டும் (நடப்பு ஆவணத்திற்கு மட்டுப்படுத்து)';
$string['settings:rag_scope_course'] = 'பாடம்-முழுவதும் (அனைத்து பாட உள்ளடக்கத்தையும் தேடு)';
$string['ragadmin:no_content_documents'] = '{$a->count} ஆவணம்(கள்) அட்டவணைப்படுத்தக்கூடிய உரை எதையும் உருவாக்கவில்லை மற்றும் பகுதிப்படுத்தப்படவில்லை (பொதுவாக பெரும்பாலும் உட்பொதிக்கப்பட்ட அல்லது மிகக் குறுகிய பக்கங்கள்): {$a->titles}. இவற்றில் ஏதேனும் தேடக்கூடியதாக இருக்க வேண்டுமெனில், பக்கத்தில் உரை அல்லது படியெடுத்தலைச் சேர்த்து, பின்னர் மீண்டும் அட்டவணைப்படுத்தவும்.';
$string['privacy:metadata:sbx_rec'] = 'Soapbox விளக்கக்காட்சிப் பதிவுகள். வைத்திருப்புக் காலத்திற்குப் பிறகு ஊடகப் பொருள் நீக்கப்படுகிறது; படியெடுத்தல் கருத்துக்கும் அணுகல் கோரிக்கைகளுக்கும் வைக்கப்படுகிறது.';
$string['privacy:metadata:sbx_rec:userid'] = 'பதிவைச் செய்த கற்பவர்.';
$string['privacy:metadata:sbx_rec:transcript'] = 'பதிவின் பேச்சு-முதல்-உரை படியெடுத்தல்.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'பதிவின் நீளம் விநாடிகளில்.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'பதிவு எப்போது செய்யப்பட்டது.';
$string['privacy:metadata:ai_provider'] = 'பயிற்றுவிப்புப் பதில்களை உருவாக்க, கற்பவர் எழுதிய உள்ளடக்கம் தளம் அல்லது பாட நிர்வாகியால் உள்ளமைக்கப்பட்ட AI வழங்குநருக்கு அனுப்பப்படுகிறது.';
$string['privacy:metadata:ai_provider:message'] = 'கற்பவர் AI பயிற்றுவிப்பாளருக்கு அனுப்பும் செய்தி உரை மற்றும் இணைப்புகள்.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'பதிலை நிலைநிறுத்த சேர்க்கப்பட்ட பாடம் மற்றும் செயல்பாட்டுச் சூழல் (பாடத்தின் பெயர் மற்றும் நடப்புப் பக்கம் போன்றவை).';
$string['privacy:metadata:voice_provider'] = 'குரல் உள்ளீடு அல்லது வெளியீடு பயன்படுத்தப்படும்போது, ஒலி மற்றும் உரை உள்ளமைக்கப்பட்ட பேச்சு-முதல்-உரை / உரை-முதல்-பேச்சு வழங்குநருக்கு அனுப்பப்படுகிறது.';
$string['privacy:metadata:voice_provider:audio'] = 'கற்பவர் பேசுவதைப் பதிவுசெய்யப்பட்ட ஒலி, படியெடுப்பதற்காக அனுப்பப்படுகிறது.';
$string['privacy:metadata:voice_provider:text'] = 'பேச்சாக ஒருங்கிணைக்கப்படுவதற்கு வழங்குநருக்கு அனுப்பப்படும் உரை.';
$string['privacy:metadata:zendesk'] = 'மனித-ஆதரவு அதிகரிப்பு இயக்கப்பட்டு கற்பவர் ஒப்புதல் அளிக்கும்போது, ஒரு ஆதரவு டிக்கெட்டைத் திறக்க அவரது தொடர்பு விவரங்களும் செய்தியும் Zendesk-க்கு அனுப்பப்படுகின்றன.';
$string['privacy:metadata:zendesk:name'] = 'ஆதரவு கோரியவரை அடையாளம் காண பயன்படுத்தப்படும் கற்பவரின் முழுப் பெயர்.';
$string['privacy:metadata:zendesk:email'] = 'ஆதரவு கோரிக்கைக்குப் பதிலளிக்கப் பயன்படுத்தப்படும் கற்பவரின் மின்னஞ்சல் முகவரி.';
$string['privacy:metadata:zendesk:message'] = 'கற்பவர் அதிகரிக்கத் தேர்ந்தெடுத்த செய்தி அல்லது உரையாடல் உள்ளடக்கம்.';
$string['privacy:metadata:radar_webhook'] = 'Learning Radar வழங்கல் ஒரு Slack அல்லது Microsoft Teams webhook-க்கு உள்ளமைக்கப்பட்டிருக்கும்போது, உருவாக்கப்பட்ட அறிக்கை அந்த வெளிப்புற இறுதிப்புள்ளியில் இடுகையிடப்படுகிறது.';
$string['privacy:metadata:radar_webhook:report'] = 'Learning Radar அறிக்கை உள்ளடக்கம், இது பாடத்தில் கற்பவரின் செயல்பாட்டைக் குறிப்பிடலாம்.';
$string['instructor_dashboard:navlink'] = 'AI பயிற்றுவிப்பாளர் டாஷ்போர்டு';
$string['analytics_js:total_students'] = 'மொத்த மாணவர்கள்';
$string['analytics_js:active_ai_users'] = 'செயலில் உள்ள AI பயனர்கள்';
$string['analytics_js:msgs_per_student'] = 'செய்திகள் / மாணவர்';
$string['analytics_js:avg_session'] = 'சராசரி அமர்வு';
$string['analytics_js:return_rate'] = 'திரும்பும் விகிதம்';
$string['analytics_js:total_sessions'] = 'மொத்த அமர்வுகள்';
$string['analytics_js:ai_users'] = 'AI பயனர்கள்';
$string['analytics_js:non_users'] = 'பயன்படுத்தாதவர்கள்';
$string['analytics_js:thumbs_up'] = 'பிடித்தது';
$string['analytics_js:thumbs_down'] = 'பிடிக்கவில்லை';
$string['analytics_js:hallucination_flags'] = 'மாயத்தோற்றக் கொடிகள்';
$string['analytics_js:avg_star_rating'] = 'சராசரி நட்சத்திர மதிப்பீடு';
$string['analytics_js:avg_msgs_resolution'] = 'தீர்வுக்கான சராசரி செய்திகள்';
$string['analytics_js:survey_respondents'] = 'கணக்கெடுப்பில் பதிலளித்தவர்கள்';
$string['analytics_js:messages'] = 'செய்திகள்';
$string['analytics_js:students'] = 'மாணவர்கள்';
$string['analytics_js:frequency'] = 'அதிர்வெண்';
$string['analytics_js:responses'] = 'பதில்கள்';
$string['analytics_js:error_loading'] = 'தரவை ஏற்றுவதில் பிழை';
$string['analytics_js:loading'] = 'பகுப்பாய்வு ஏற்றப்படுகிறது...';
$string['analytics_js:no_course_data'] = 'பாடத் தரவு எதுவும் கிடைக்கவில்லை.';
$string['analytics_js:no_unit_data'] = 'இன்னும் அலகுத் தரவு இல்லை. மாணவர்கள் உதவியாளரைப் பயன்படுத்தும்போது அலகுக் கண்காணிப்பு திரட்டப்படுகிறது.';
$string['analytics_js:no_keyword_data'] = 'இந்தக் காலகட்டத்திற்கு முக்கியச்சொல் தரவு எதுவும் கிடைக்கவில்லை.';
$string['task:soapbox_cleanup'] = 'Soapbox பதிவு வைத்திருப்பு மற்றும் சுத்தம் செய்தல்';
$string['admin:vendor_dpa:col_provider'] = 'வழங்குநர்';
$string['admin:vendor_dpa:col_optout'] = 'பயிற்சி விலகல்';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'வைத்திருப்பு';
$string['admin:vendor_dpa:col_tier'] = 'அடுக்கு உச்சவரம்பு';
$string['admin:vendor_dpa:col_link'] = 'இணைப்பு';
$string['admin:vendor_dpa:vendor_terms'] = 'விற்பனையாளர் விதிமுறைகள்';
$string['admin:vendor_dpa:tier'] = 'அடுக்கு {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'ஒப்பந்தப்படி (விலகியது)';
$string['admin:vendor_dpa:too_default_on'] = 'இயல்பாக இயக்கப்பட்டது';
$string['admin:vendor_dpa:too_none'] = 'விலகல் இல்லை';
$string['admin:vendor_dpa:too_local'] = 'உள்ளூர் (விற்பனையாளர் இல்லை)';
$string['admin:vendor_dpa:too_unknown'] = 'இன்னும் மதிப்பாய்வு செய்யப்படவில்லை';
$string['admin:vendor_dpa:dpa_signed'] = 'கையொப்பமிடப்பட்டது';
$string['admin:vendor_dpa:dpa_available'] = 'கிடைக்கிறது';
$string['admin:vendor_dpa:dpa_negotiating'] = 'பேச்சுவார்த்தை நடக்கிறது';
$string['admin:vendor_dpa:dpa_not_offered'] = 'வழங்கப்படவில்லை';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'பொருந்தாது';
$string['admin:vendor_dpa:dpa_unknown'] = 'தெரியவில்லை';
$string['settings:soapbox_slide_vision'] = 'Soapbox ஸ்லைடு காட்சி-வடிவமைப்புக் கருத்து';
$string['settings:soapbox_slide_vision_desc'] = 'மதிப்பீடு செய்யப்பட்ட விளக்கக்காட்சிக்கு ஒரு குறுகிய காட்சி-வடிவமைப்புக் குறிப்பைச் சேர்க்க, வழங்கப்பட்ட ஸ்லைடு படங்களின் மீது ஒற்றைக் காட்சிப் பரிசோதனையை அனுமதிக்கவும். இயல்பாக முடக்கப்பட்டுள்ளது மற்றும் தனியுரிமை-உணர்வுள்ளது: எந்தப் படங்களும் சேமிக்கப்படுவதில்லை, மேலும் ஒவ்வொரு பணியும் அதன் சொந்த ஸ்லைடு காட்சி-வடிவமைப்புக் கருத்துப் பெட்டியுடன் தேர்ந்தெடுக்க வேண்டும். பதிவேற்றப்பட்ட தொகுப்புடன் கூடிய ஸ்லைடு விளக்கக்காட்சிகள் மட்டுமே பாதிக்கப்படும்.';
$string['settings:soapbox_vision_provider'] = 'Soapbox ஸ்லைடு-காட்சி வழங்குநர்';
$string['settings:soapbox_vision_provider_desc'] = 'ஸ்லைடு-காட்சிப் பரிசோதனைக்குப் பயன்படுத்தப்படும் வழங்குநர். இயல்பாக openai. API விசையுடன் உள்ளமைக்கப்பட்ட காட்சி-திறன் கொண்ட வழங்குநராக இருக்க வேண்டும் (பாட வழங்குநர் அல்லது ஒப்பீடு-வழங்குநர்கள் பட்டியல் வழியாக).';
$string['settings:soapbox_vision_model'] = 'Soapbox ஸ்லைடு-காட்சி மாதிரி';
$string['settings:soapbox_vision_model_desc'] = 'ஸ்லைடு-காட்சிப் பரிசோதனைக்கான காட்சி-திறன் கொண்ட மாதிரி. இயல்பாக gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'ஸ்லைடு வடிவமைப்பு:';
$string['soapbox:assign_manage'] = 'Soapbox விளக்கக்காட்சிப் பணிகள்';
$string['soapbox:copy_link'] = 'மாணவர் இணைப்பு';
$string['soapbox:deck_label'] = 'ஸ்லைடுகள் (PDF). உங்கள் தொகுப்பைப் பதிவேற்றி, பின்னர் பதிவுசெய்யும்போது ஸ்லைடுகளை முன்னேற்றவும்.';
$string['soapbox:slide_prev'] = 'முந்தைய ஸ்லைடு';
$string['soapbox:slide_next'] = 'அடுத்த ஸ்லைடு';
$string['soapbox:play_slides'] = 'ஸ்லைடுகளுடன் இயக்கு';
$string['soapbox:audio_ready'] = 'ஒலி மட்டும். உங்கள் மைக்ரோஃபோன் பதிவுசெய்யப்படும்; உங்கள் கேமரா பயன்படுத்தப்படாது.';
$string['soapbox:audio_recording'] = 'ஒலி பதிவுசெய்யப்படுகிறது...';
$string['soapbox:cap_reached'] = 'இந்தப் பணிக்கான அதிகபட்ச பதிவுகளின் எண்ணிக்கையை நீங்கள் அடைந்துவிட்டீர்கள்.';
$string['soapbox:storage_unconfigured'] = 'பதிவுச் சேமிப்பகம் இன்னும் அமைக்கப்படவில்லை. உங்கள் நிர்வாகியைத் தொடர்பு கொள்ளவும்.';
$string['soapbox:bad_key'] = 'அந்தப் பதிவேற்றம் உங்களுக்குச் சொந்தமானது அல்ல.';
$string['soapbox:slides_disabled'] = 'இந்தப் பணிக்கு ஸ்லைடுகள் இயக்கப்படவில்லை.';
$string['soapbox:upload_missing'] = 'பதிவேற்றத்தைக் கண்டுபிடிக்க முடியவில்லை. மீண்டும் பதிவுசெய்ய முயற்சிக்கவும்.';
$string['soapbox:mode_label'] = 'விளக்கக்காட்சி வகை';
$string['soapbox:mode_informative'] = 'தகவல் தரும் (விளக்கு அல்லது கற்பி)';
$string['soapbox:mode_persuasive'] = 'வற்புறுத்தும் (சம்மதிக்கச் செய்)';
$string['soapbox:err_provider'] = 'AI மதிப்பீட்டுச் சேவையை அடைய முடியவில்லை. சிறிது நேரத்தில் மீண்டும் முயற்சிக்கவும்.';
$string['soapbox:err_parse'] = 'AI எதிர்பாராத பதிலை வழங்கியது. மீண்டும் முயற்சிக்கவும்.';
$string['soapbox:err_disabled'] = 'இந்தப் பாடத்திற்குப் பேச்சுப் பயிற்சி இயக்கப்படவில்லை.';
$string['soapbox:err_transcribe'] = 'உங்கள் பதிவைப் படியெடுக்க முடியவில்லை. மீண்டும் முயற்சிக்கவும், மேலும் உங்கள் மைக்ரோஃபோன் வேலை செய்கிறதா என்பதைச் சரிபார்க்கவும்.';
$string['settings:outcomes_benchmark_default'] = 'விளைவு தரப்படுத்தல் (சதவீதம்)';
$string['settings:outcomes_benchmark_default_desc'] = 'விளைவுகள் அறிக்கைக்கான நிறுவனம்-அமைத்த தரப்படுத்தல்: ஒரு மாணவரின் தேர்ச்சி இந்தச் சதவீதத்திற்குச் சமமாக அல்லது அதற்கு மேல் இருக்கும்போது அவர் ஒரு விளைவை அடைகிறார். இது அறிக்கையிடல் தரநிலை (பயிற்றுவிப்புத் தேர்ச்சி வரம்பிலிருந்து வேறுபட்டது). இயல்பு 70.';
$string['outcomes:title'] = 'விளைவுகள் அறிக்கை';
$string['outcomes:intro'] = 'ஒவ்வொரு பாட விளைவுக்கும், தரப்படுத்தல் மற்றும் அதை அடைந்த அல்லது தாண்டிய மதிப்பீடு செய்யப்பட்ட மாணவர்களின் சதவீதம். தள தரப்படுத்தல் {$a}%.';
$string['outcomes:none'] = 'இந்தப் பாடத்திற்கு இன்னும் விளைவுகள் எதுவும் வரையறுக்கப்படவில்லை.';
$string['outcomes:export'] = 'CSV ஏற்றுமதி';
$string['outcomes:col_outcome'] = 'விளைவு';
$string['outcomes:col_benchmark'] = 'தரப்படுத்தல்';
$string['outcomes:col_assessed'] = 'மதிப்பீடு செய்யப்பட்ட மாணவர்கள்';
$string['outcomes:col_met'] = 'தரப்படுத்தலை அடைந்தவர்கள்';
$string['outcomes:col_pct'] = 'அடைந்த சதவீதம்';
$string['outcomes:footnote'] = 'மதிப்பீடு செய்யப்பட்ட மாணவர்கள் என்பது விளைவில் குறைந்தபட்சம் ஒரு முயற்சியாவது செய்தவர்கள். சாதனை மொத்தமாக அறிக்கையிடப்படுகிறது; தனிப்பட்ட முன்னேற்றம் ஒருபோதும் எந்த ஒற்றை விளைவின் அடிப்படையிலும் தடுக்கப்படுவதில்லை.';
$string['outcomes:navlink'] = 'விளைவுகள் அறிக்கை';

// v6.9.5 i18n batch: RAG budget cap, Redash export window and de-anonymisation gate.
$string['chat:refused'] = 'இந்த வேண்டுகோளுக்கு நான் உதவ முடியாது. உங்கள் பாடத்திற்குத் திரும்புவோம்: இப்போது எதில் வேலை செய்ய விரும்புகிறீர்கள்?';
$string['settings:rerank_margin_threshold'] = 'மறுவரிசைப்படுத்தலின் தெளிவின்மை வரம்பு';
$string['settings:rerank_margin_threshold_desc'] = 'முதல் மற்றும் மூன்றாவது வேட்பாளர்களுக்கு இடையேயான கொசைன் இடைவெளி இந்த மதிப்பை விடக் குறைவாக இருக்கும்போது மட்டுமே மறுவரிசைப்படுத்துங்கள், அதாவது மீட்டெடுப்பு தெளிவற்றதாக இருக்கும்போது. 1,008 வினவல்களில் அளவிடப்பட்டது: இயல்புநிலை 0.086-இல் சுமார் 30% வினவல்கள் தவிர்க்கப்படுகின்றன, நினைவுத்திறனில் அளவிடத்தக்க இழப்பு இல்லை, மேலும் ஏற்கெனவே சரியான முதல் முடிவை மறுவரிசைப்படுத்தல் விலக்கும் நிலைகள் தவிர்க்கப்படுகின்றன. ஒவ்வொரு வினவலையும் மறுவரிசைப்படுத்த 0 என அமைக்கவும்.';
$string['rag_cap_blocked'] = 'அகரவரிசைப்படுத்தல் இயங்கவில்லை: இந்தக் காலத்திற்கான RAG செலவு வரம்பு எட்டப்பட்டுவிட்டது. வரம்பை உயர்த்துங்கள் அல்லது அடுத்த காலத்திற்குக் காத்திருங்கள். தற்போதைய அகரவரிசை மாற்றப்படாமல் இருக்கும்.';
$string['settings:redash_export_window_days'] = 'ஏற்றுமதியின் பின்நோக்கு காலம் (நாட்கள்)';
$string['settings:redash_export_window_days_desc'] = 'அழைப்பாளர் "since" நேர முத்திரையை அனுப்பாதபோது ஏற்றுமதி எவ்வளவு பின்னோக்கிச் செல்கிறது. இயல்புநிலை 90 நாட்கள், இந்த அளவுருவை விட்டுவிடும் தரவு மூலம் இதுவரை பதிவான ஒவ்வொரு வரிசையையும் இழுப்பதைத் தடுக்கிறது; அழைப்பாளர் இன்னும் குறிப்பிட்ட காலத்தைக் கோரலாம் அல்லது முழு வரலாற்றுக்கு since=0 அனுப்பலாம். முழு வரலாற்றை மீண்டும் இயல்புநிலையாக்க 0 என அமைக்கவும்.';
$string['settings:redash_allow_deanonymized'] = 'அநாமதேயமற்ற ஏற்றுமதியை அனுமதி';
$string['settings:redash_allow_deanonymized_desc'] = 'இயல்பாக அணைக்கப்பட்டுள்ளது. அணைக்கப்பட்டிருக்கும்போது anonymize=0 கொண்ட வேண்டுகோள் மறுக்கப்படும், கற்பவர்கள் எப்போதும் புனைபெயரில் தோன்றுவர். வெளிப்புற அறிக்கைக்கு உண்மையான பெயர்கள் உண்மையிலேயே தேவைப்படும்போது மட்டுமே இதை இயக்குங்கள்; ஏற்றுமதி உள்நுழைந்த நிர்வாகியை விட பங்கிடப்பட்ட API விசையால் அங்கீகரிக்கப்படுகிறது என்பதை நினைவில் கொள்ளுங்கள், எனவே விசையை வைத்திருக்கும் எவரும் அப் பெயர்களைப் பெற முடியும். இரு நிலைகளிலும், அநாமதேயமற்ற வேண்டுகோள்கள் கோரிய IP முகவரியுடன் தணிக்கைப் பதிவில் சேமிக்கப்படும்.';

// i18n batch appended by scripts/apply_i18n.py.
$string['soapbox:present_audio'] = 'ஒலி விளக்கவுரை';
$string['soapbox:present_video'] = 'காணொளி விளக்கவுரை';
$string['soapbox:present_target'] = 'இலக்கு {$a->min}-{$a->max} நிமிடம்';
$string['soapbox:choose_topic'] = 'ஒரு தலைப்பைத் தேர்ந்தெடுக்கவும்';
$string['soapbox:record_short'] = 'பதிவு';
$string['soapbox:my_recordings'] = 'எனது பதிவுகள்';
$string['soapbox:no_recordings'] = 'இதுவரை பதிவுகள் இல்லை.';
$string['soapbox:col_recorded'] = 'பதிவு செய்யப்பட்டது';
$string['soapbox:col_length'] = 'நீளம்';
$string['soapbox:col_type'] = 'வகை';
$string['soapbox:col_recording'] = 'பதிவு';
$string['soapbox:col_kept'] = 'சேமிக்கப்பட்டது';
$string['soapbox:col_student_link'] = 'மாணவர் இணைப்பு';
$string['soapbox:view_download'] = 'பார்க்க / பதிவிறக்க';
$string['soapbox:expired'] = 'காலாவதியானது';
$string['soapbox:retention_note'] = 'பதிவுகளை {$a} நாட்களுக்குப் பார்க்கவும் பதிவிறக்கவும் முடியும், அதன் பிறகு தானாகவே நீக்கப்படும்.';
$string['soapbox:assign_title'] = 'Soapbox பணிகள்';
$string['soapbox:assign_single_title'] = 'Soapbox பணி';
$string['soapbox:assign_add'] = 'பணியைச் சேர்';
$string['soapbox:assign_none'] = 'இதுவரை Soapbox பணிகள் இல்லை.';
$string['soapbox:assign_deleted'] = 'பணி நீக்கப்பட்டது.';
$string['soapbox:assign_updated'] = 'பணி புதுப்பிக்கப்பட்டது.';
$string['soapbox:assign_created'] = 'பணி உருவாக்கப்பட்டது.';
$string['soapbox:assign_delete_confirm'] = '"{$a}" மற்றும் அதன் அனைத்துப் பதிவுகளையும் நீக்கவா? இதைத் திரும்பப் பெற முடியாது.';
$string['soapbox:assign_edit_heading'] = 'Soapbox பணியைத் திருத்து';
$string['soapbox:assign_new_heading'] = 'புதிய Soapbox பணி';

$string['settings:active_learners_enabled'] = 'செயலில் உள்ள கற்பவர்களின் குறியீட்டைக் காட்டு';
$string['settings:active_learners_enabled_desc'] = 'இப்போது வேறு எத்தனை பேர் கற்கிறார்கள் என்பதை அரட்டைப் பலகத்தில் காட்டுகிறது. இது கற்பித்தல் அம்சம் அல்ல, சமூக ஊக்கமே; திறந்திருக்கும் ஒவ்வொரு பலகத்திற்கும் நிமிடத்திற்கு ஒருமுறை சேவையகத்தைக் கேட்கிறது, எனவே இயல்பாக அணைக்கப்பட்டுள்ளது. குறைந்தது இரண்டு பேர் செயலில் இருந்தால் மட்டுமே இது தோன்றும்.';

$string['task:unanswered_check'] = '[[tutorshort]] பதிலளிக்கப்படாத கேள்விகள் சரிபார்ப்பு';
$string['settings:unanswered_check_enabled'] = 'கேள்விகளுக்குப் பதில் இல்லாதபோது எச்சரிக்கவும்';
$string['settings:unanswered_check_enabled_desc'] = 'கற்பவர்கள் [[tutorshort]]-இடம் கேட்டும் பதில் கிடைக்காதபோது செலவு அறிவிப்புப் பெறுநர்களுக்கு மின்னஞ்சல் அனுப்பும். செலவு முரண்பாடு கண்டறிதல் செலவு <em>அதிகரிக்கும்</em>போது மட்டுமே இயங்கும்; அனைத்து அழைப்புகளையும் நிராகரிக்கும் வழங்குநருக்குச் செலவே இல்லை, எனவே எச்சரிக்கையும் வராது. இங்கு கேள்வி–பதில் விகிதம் கண்காணிக்கப்படுகிறது; வழங்குநர் செயலிழந்தவுடன் அது பூஜ்ஜியமாகும். பட்டியல் காலியாக இருந்தால் தள நிர்வாகிகள் பயன்படுத்தப்படுவர்.';
$string['settings:unanswered_window_hours'] = 'சரிபார்ப்பு காலஅளவு (மணி)';
$string['settings:unanswered_window_hours_desc'] = 'ஒவ்வொரு இயக்கமும் எவ்வளவு பின்னோக்கிப் பார்க்கும். குறைவானது விரைவாகச் செயல்படும் ஆனால் போதிய பயன்பாடு தேவை.';
$string['settings:unanswered_min_questions'] = 'எச்சரிக்கைக்கு முன் குறைந்தபட்ச கேள்விகள்';
