...
$string['settings:default_course_mode_desc'] = 'Ilawula ukuthi ngabe i-[[tutorshort]] ivela yini esifundweni uma kungekho ukukhetha ngesifundo ngasinye okwenziwe. Ukufakwa okusha kuzenzakalela ku-"Kukhutshaziwe ngokuzenzakalelayo" ukuze ababengameli bakwazi ukukhetha ngesifundo ngasinye ekhasini le-Analytics noma ekhasini le-Course AI Settings.';
...
$string['coursesettings:sola_enabled'] = 'I-[[tutorshort]] kulesi sifundo';
$string['coursesettings:sola_enabled_toggle'] = 'Bonisa iwijethi ye-[[tutorshort]] kulesi sifundo';
$string['coursesettings:sola_enabled_desc'] = 'Ilawula ukuthi iwijethi yengxoxo ye-[[tutorshort]] ivela yini kulesi sifundo. Okuzenzakalelayo kwesizindalwazi sonke kusethwa kuzilungiselelo zesengezo ngaphansi kwe-General > Default for new courses.';
...
$string['chat:greeting'] = 'Sawubona, {$a}! Ngingu-[[tutorshort]]. Ngingakusiza kanjani namuhla?';
$string['chat:title'] = '[[tutorshort]]';
$string['chat:assistant'] = '[[tutorshort]]';
$string['chat:open'] = 'Vula [[tutorshort]]';
...
$string['chat:voice_speaking'] = '[[tutorshort]] ikhuluma...';
...
$string['settings:cdn_heading_desc'] = 'Nikeza ama-asset e-frontend e-[[tutorshort]] (JS/CSS) kusuka ku-CDN yangaphandle esikhundleni sohlelo lwamafayela lwe-Moodle. Lokhu kuvumela izibuyekezo ze-frontend ngaphandle kokuthuthukisa i-plugin. Shiya i-CDN URL ingenalutho ukusebenzisa amafayela e-plugin wendawo.';
...
$string['chat:voice_title'] = 'Khuluma ne-[[tutorshort]]';
...
$string['mobile_disabled'] = '[[tutorshort]] ayitholakali kulesi sifundo.';
...
$string['settings:rag_return_scope'] = 'Isilinganiso sokubuyiselwa sokulanda';
$string['settings:rag_return_scope_desc'] = 'Yini efakwayo kukho konke okutholwe. I-"chunk" (okuzenzakalelayo) ifaka isiqephu esifanayo esingaba ngu-400 wamagama. I-"window" ifaka isiqephu esifanayo kanye nezingqephu ezakhelene nemibhalo kuleyo khasi. I-"page" ifaka lonke ikhasi lemojuli okutholakala kulo umfanekiso. I-window/page kusiza uma impendulo yendlala ikhasi lonke, ngentengo yesiphakamiso (prompt) esikhulu.';
$string['settings:rag_window_size'] = 'Usayizi wewindi lokulanda';
$string['settings:rag_window_size_desc'] = 'Kusilinganiso sokubuyiselwa se-"window": inani lezingqephu ezakhelene okufanele zifakwe uhlangothi ngalunye lwesiqephu esifanayo. Okuzenzakalelayo ngu-1.';
$string['settings:rag_parent_max_chars'] = 'Umkhawulo wesiqephu esiyinhloko (izinhlamvu)';
$string['settings:rag_parent_max_chars_desc'] = 'Inani elikhulu lezinhlamvu lesiqephu se-window/page esandisiwe. Amakhasi angaphezu komkhawulo abuyela ku-window, bese ebuyela esiqephini esisodwa. Okuzenzakalelayo ngu-6000.';
...
$string['settings:ssrf_trusted_endpoints_desc'] = 'I-URL eyodwa ngomugqa ngamunye. Ama-host afakwe ohlwini abhalo i-loopback / i-IP-eyimfihlo / i-https-kuphela kuvali we-SSRF se-[[tutorshort]]. Sebenzisa lokhu kuphela kuma-LLM aphethwe-uqobo enethiwekhi oyiphethe — isibonelo <code>http://localhost:11434</code> ku-Ollama wendawo, <code>http://10.0.0.5:8000</code> kwi-pod ye-vLLM ku-VPC efanayo. Ukuqhathanisa kufana ne-scheme + host + port; noma yiyiphi indlela iyaliwa. Okuzenzakalelayo akuna lutho (vimba konke kwangaphakathi). Imigqa eqala nge-<code>#</code> ngamazwana.';
...
$string['settings:xai_proxy_url_desc'] = 'I-URL ye-wss yomphakathi yenkonzo ye-proxy ye-[[tutorshort]] xAI Realtime (isibonelo wss://voice.example.com/xai-rt/rt). Lapho lokhu kusethwa kanye nesihloko se-JWT, izwi le-xAI lihamba nge-proxy futhi ukhiye omkhulu we-xAI API awufiki ku-isiphequluli. Yishiye ingenalutho ukuze ubuyele ekuxhumeni okuqondile (akunconywa ngokukhiqiza).';
...
$string['flashcards:title'] = 'Amakhadi okufunda';
$string['flashcards:link'] = 'Amakhadi okufunda (buyekeza manje)';
$string['flashcards:intro'] = 'Ukubuyekeza ngokuphindaphinda ngezikhathi ezihlukanisiwe. Veza impendulo, bese uzinika amamaki ngo-Phinda, Kunzima noma Kulula. Amakhadi owathole enzima azobuya masinyane; awathole elula azoqhela kakhulu.';
$string['flashcards:question'] = 'Umbuzo';
$string['flashcards:answer'] = 'Impendulo';
$string['flashcards:reveal'] = 'Veza impendulo';
$string['flashcards:again'] = 'Phinda';
$string['flashcards:hard'] = 'Kunzima';
$string['flashcards:easy'] = 'Kulula';
$string['flashcards:no_due'] = 'Akukho okufanele kubuyekezwe njengamanje. Yakha amakhadi okufunda kusuka ekhasini lekhosi kwiwijethi yomsizi, noma ubuye kamuva.';
$string['flashcards:session_complete'] = 'Iseshini iqediwe. Umsebenzi omuhle.';
$string['flashcards:disabled'] = 'Amakhadi okufunda awavuliwe kule khosi.';
$string['flashcards:toggle'] = 'Vula amakhadi okufunda kule khosi';
$string['flashcards:toggle_help'] = 'Kungeza isiqalisi sokwakha amakhadi okufunda kwiwijethi yomsizi kanye nekhasi lokubuyekeza lomfundi ku-/local/ai_course_assistant/flashcards.php?courseid=X. Kuvaliwe ngokuzenzakalela.';
$string['flashcards:starter_generate'] = 'Yakha amakhadi okufunda kusuka kuleli khasi';
$string['flashcards:generated'] = 'Kulondolozwe amakhadi okufunda angu-{$a}. Vula ikhasi lokubuyekeza ukuze uwafunde.';
...
$string['settings:prompt_budget_auto_tune'] = 'Ukulungisa okuzenzakalelayo kwansuku zonke kwesabelomali sesicelo sesistimu (kuyekwe)';
$string['settings:prompt_budget_auto_tune_desc'] = 'Kuyekwe. Akwenzi lutho ngaphandle uma imodi yesabelomali engenhla imisiwe ku-<strong>Emisiwe</strong>. Umsebenzi wansuku zonke wawuqagela isabelomali sezinhlamvu ngokubheka ukunqunywa nangokuxosha isicelo esikhulu kunazo zonke esasibonile. Ukuthola isabelomali kuwindi lomongo lemodeli kwenza lokho kangcono: akunyakazi futhi akudingi idatha yokuqala. Lokhu kubili nakho kwakushayisana, ngoba umsebenzi ubhala isabelomali sezinhlamvu futhi noma yiliphi inani elingelona elizenzakalelayo licisha isabelomali esitholakele. Kushiye kucishiwe; kuyosuswa esikhishweni esizayo. Isincomo sisabonakala ekhasini <a href="/local/ai_course_assistant/prompt_metrics.php">Izilinganiso zesicelo</a>.';
...
$string['comms:audit_log_title'] = 'Lokho u-[[tutorshort]] angithumelele khona';
$string['comms:audit_log_empty'] = 'U-[[tutorshort]] akakaze akuthumelele noma iyiphi i-imeyili.';
$string['comms:memory_title'] = 'Lokho u-[[tutorshort]] akukhumbulayo ngendlela engifunda ngayo';
$string['comms:memory_desc'] = 'La manothi ayimfihlo yengxoxo yakho no-[[tutorshort]]. Asiza u-[[tutorshort]] ukuthi akhethe enye indlela uma isihloko sinzima. Ungawasula noma nini.';
$string['comms:memory_clear'] = 'Sula wonke amanothi enkumbulo';
$string['milestone:streak_subject'] = 'Izinsuku ezingu-{$a->days} zilandelana ku-{$a->coursename}';
$string['milestone:streak_body_text'] = "Sawubona {\$a->firstname},\n\nUvele izinsuku ezingu-{\$a->days} zilandelana ku-{\$a->coursename}. Lolo hlobo lokuzimisela luyingxenye yokufunda okunzima kakhulu ukuyilingisa.\n\nNoma nini uma usulungele, u-[[tutorshort]] ulapha.\n\n— {\$a->institution}";
$string['milestone:completion_subject'] = 'Uqedile i-{$a->coursename}';
$string['milestone:completion_body_text'] = "Sawubona {\$a->firstname},\n\nUqedile i-{\$a->coursename}. Lokho yinto yangempela oyenzile.\n\nUma ufuna ukuqhubeka, u-[[tutorshort]] angakusiza ukhethe ikhosi elandelayo ehlobene noma ubuyele esihlokweni osithole sithakazelisa.\n\n— {\$a->institution}";
$string['milestone:trigger_streak7'] = 'Kufinyelelwe izinsuku ezingu-7 zomsebenzi zilandelana';
$string['milestone:trigger_streak30'] = 'Kufinyelelwe izinsuku ezingu-30 zomsebenzi zilandelana';
$string['milestone:trigger_completion'] = 'Ukuqedwa kwekhosi kurekhodiwe';
...
$string['settings:backend_retry_max_wait_desc'] = 'Umkhawulo ophezulu, ngamasekhondi, wokuthi kuhloniphwe isikhathi esingakanani isihloko se-Retry-After esivela ku-backend ngaphambi kokuzama futhi. Lapho i-backend ingathumeli i-Retry-After, i-[[tutorshort]] isebenzisa i-exponential backoff emfushane esikhundleni. Okuzenzakalelayo ngu-5.';
...
$string['coursesettings:apibaseurl_rejected'] = 'I-URL eyisisekelo ye-API ayizange ilondolozwe: kufanele ibe yindawo yokugcina ye-HTTPS yomphakathi edlula ukuhlolwa kokuphepha kwe-SSRF.';
$string['settings:escalation_intent_patterns'] = 'Amaphethini enhloso yokukhuphula';
$string['settings:escalation_intent_patterns_desc'] = 'PCRE, no delimiters. Inkulumo evamile eyodwa emugqeni ngamunye; imigqa eqala ngo-# iyanganakwa. Ithikithi lokusekela livulwa kuphela lapho umlayezo womfundi ngokwakhe uhambisana nelinye lawa, ukuze okuqukethwe kwenkambo kungakwazi ukubangela ukukhuphuka egameni lomfundi. Shiya kungenalutho ukuze usebenzise okuzenzakalelayo okwakhelwe ngaphakathi, okuhlanganisa isiNgisi kanye namanye amagama avamile esiSpanishi, isiFulentshi, isiJalimane nesiPutukezi. Amasayithi abafundi bawo ababhala ngolunye ulimi kufanele engeze amaphethini lapha: umlayezo ongahambisani usho ukuthi alikho ithikithi elivulwayo.';
$string['settings:zendesk_require_consent'] = 'Funa imvume ngaphambi kokukhushulwa kosekelo';
$string['settings:zendesk_require_consent_desc'] = 'Lapho kuvuliwe (kunconyiwe), i-[[tutorshort]] ikhuphulela ingxoxo edeskini yosekelo le-Zendesk kuphela ngemva kokuba umfundi amukele isaziso semvume sokusebenza kokuqala, esidalula ukuthi ukucela usizo lomuntu kwabelana ngengxoxo (kufaka phakathi igama ne-imeyili) nosekelo. Vala lokhu kuphela uma uthola leyo mvume ngenye indlela; uma kuvaliwe, ukukhushulwa kuthunyelwa ngokushesha. Akunamthelela ngaphandle uma ukukhushulwa kwe-Zendesk kunikwe amandla.';
...
$string['emergency:title'] = 'Izilawuli Eziphuthumayo ze-[[tutorshort]]';
...
$string['emergency:back_to_settings'] = 'Izilungiselelo ze-[[tutorshort]]';
...
$string['emergency:flag_all_desc'] = 'Ikhubaza i-plugin yonke: i-widget inyamalala kuwo wonke amakhasi, imisebenzi ehleliwe iyama, izwi lisuliwe, i-RAG ivalwe, ukufinyelela kuvaliwe. Ikhiye enamandla kakhulu — sebenzisa ngesikhathi sezigameko zokuphepha noma lapho i-[[tutorshort]] kufanele ithathwe offline ngokushesha.';
$string['emergency:settings_link'] = 'Izilawuli eziphuthumayo';
$string['emergency:settings_link_desc'] = 'Izikhiye ze-kill ze-subsystem ngasinye (ukuxhumana / izwi / RAG / ukufinyelela / enkulu) ngokugcina i-audit — efana ne-web <code>admin/cli/emergency_disable.php</code>. Vula <a href="{$a}">Izilawuli Eziphuthumayo ze-[[tutorshort]]</a>.';
$string['email_unsubscribe:done_title'] = 'Akubhaliswanga';
$string['email_unsubscribe:done_body'] = 'Kuqedwe — {$a->email} ngeke isithola lolu hlobo lwe-imeyili evela ku-{$a->product}. Uma ushintsha umqondo wakho, cela umlawuli we-{$a->product} ukuze avuse kabusha ukubhalisa, noma uthumele i-opt-in entsha ngekhasi le-admin le-[[tutorshort]] Recipients.';
...
$string['settings:premium_escalation_model_desc'] = 'Igama lemodeli elithunyelwa kumhlinzeki wephelemende. Okuzenzakalelayo <code>claude-sonnet-5</code> ngesigwebo se-A.10 bake-off.';
...
$string['settings:cost_anomaly_multiplier_desc'] = 'Izindleko zanamuhla kufanele zigqabuke le multiplier × inhlalo yezinsuku ezi-7 ukuze kuqalise isixwayiso. Okuzenzakalelayo <code>2.0</code>. Yehlisa ku-<code>1.5</code> ukuze uxwayise nangaphambili (izixwayiso ezinhle ezingekho ngaphambili ngesikhathi sokulayisha okwengeziwe). Phakamisa ku-<code>3.0</code> uma ukusetshenziswa kwe-[[unishort]] kuvamile ukwedlula i-2x.';
$string['task:cost_anomaly_check'] = 'Ukuhlola kwensalela yentengo ye-[[tutorshort]] (nsuku zonke)';
...
$string['settings:policy_bundle_applied_version'] = 'inguqulo esetshenzisiwe';
$string['task:policy_bundle_sync'] = '[[tutorshort]] ukuvumelanisa kwe-policy bundle esiniywe';
...
$string['analytics:exp_heading'] = 'Ukuqhathanisa uhlelo lwe-A/B';
$string['analytics:exp_desc'] = 'Qhathanisa ukuzibandakanya phakathi kwezifundo ezimbili ngesikhathi esikhethiwe. Yakhelwe izivivinyo zezifundo ngezifundo (isibonelo isihlungu se-avatar animation): faka ukubhekelelwa kwesifundo esisodwa, shiya esinye njengentando, bese ufunda umehluko lapha.';
$string['analytics:exp_course_a'] = 'Isifundo A';
$string['analytics:exp_course_b'] = 'Isifundo B';
$string['analytics:exp_compare'] = 'Qhathanisa';
$string['analytics:exp_metric'] = 'Izilinganiso';
$string['analytics:exp_delta'] = 'B vs A';
$string['analytics:exp_enrolled'] = 'Abafundi ababhalisile';
$string['analytics:exp_active_users'] = 'Abasebenzisi be-[[tutorshort]] abasheshayo';
$string['analytics:exp_usage_rate'] = 'Izinga lokusetshenziswa (%)';
$string['analytics:exp_sessions'] = 'Izikhathi';
$string['analytics:exp_messages'] = 'Imiyalezo';
$string['analytics:exp_avg_msgs_session'] = 'Imiyalezo eyimvamisa ngesikhathi';
$string['analytics:exp_avg_session_minutes'] = 'Ubude besikhathi esimvamisa (amaminithi)';
...
$string['privacy:metadata:local_ai_course_assistant_practice_scores:session_meta'] = 'Imethadatha ozikhethelayo oyinikeze iseshini, njengegama, isihloko, kanye nobude obuhlosiwe benkulumo ye-Soapbox. Ayikaze ifake umsindo noma umbhalo wokushiwo.';
$string['pedagogy:soapbox'] = 'Impendulo yenkulumo ye-Soapbox ivuliwe ngokuzenzakalela';
$string['pedagogy:soapbox_desc'] = 'Uma ivuliwe, ithuluzi lokuzilolonga inkulumo le-Soapbox liyatholakala kuyo yonke inkambo ngaphandle uma inkambo inenketho yayo yokushintsha. Yiyeke ivaliwe bese uyivula kuphela ezinkambeni ezidingayo (imvamisa izinkambo zenkulumo nokuxhumana).';
$string['settings:soapbox_stt_mode'] = 'Imodi yokubhala phansi ye-Soapbox';
$string['settings:soapbox_stt_mode_desc'] = 'Indlela i-Soapbox eguqula ngayo inkulumo eqoshiwe ibe ngumbhalo. Iseva isebenzisa umhlinzeki we-Whisper omisiwe (ukuzibamba mahhala; i-OpenAI ebanjisiwe icishe ibe yi-USD 0.006 ngomzuzu ngamunye). Isiphequluli sisebenzisa ukubona inkulumo okwakhelwe ngaphakathi komfundi (mahhala, ayikho iseva, isebenza ku-Chrome ne-Safari kuphela). Iseva inconywa ukuze ikhwalithi yokubhala phansi ingancikeli kusiphequluli somfundi.';
$string['settings:soapbox_stt_mode_server'] = 'Iseva (umhlinzeki we-Whisper)';
$string['settings:soapbox_stt_mode_browser'] = 'Isiphequluli (mahhala, ayikho iseva)';
$string['soapbox:title'] = 'Soapbox';
$string['soapbox:link'] = 'Ukuzilolonga inkulumo ye-Soapbox';
$string['soapbox:disabled'] = 'I-Soapbox ayivuliwe kule nkambo.';
$string['soapbox:intro'] = 'Yenza inkulumo bese uthola usizo. Ngokuzikhethela ungasetha igama, isihloko, kanye nobude obuhlosiwe, bese uziqopha ukhuluma. I-Soapbox ibhala phansi inkulumo yakho, iyiphe amaphuzu ngokwesilinganiso senkulumo, futhi ikunike amathiphu acacile. Umsindo wakho kanye nombhalo awukaze ugcinwe, kugcinwa kuphela amaphuzu nempendulo yakho.';
$string['soapbox:optional'] = 'ngokuzikhethela';
$string['soapbox:name_label'] = 'Yetha leli gama lale nkulumo';
$string['soapbox:topic_label'] = 'Isihloko';
$string['soapbox:time_label'] = 'Ubude obuhlosiwe';
$string['soapbox:no_target'] = 'Ayikho inhloso';
$string['soapbox:record'] = 'Qopha inkulumo';
$string['soapbox:stop'] = 'Misa';
$string['soapbox:recording'] = 'Iyaqopha. Khuluma ngokwemvelo; chofoza umise uma usuqedile.';
$string['soapbox:transcribing'] = 'Ibhala phansi inkulumo yakho…';
$string['soapbox:scoring'] = 'Inika amaphuzu inkulumo yakho…';
$string['soapbox:too_short'] = 'Lokho kuqoshwa bekufushane kakhulu ukuthi kunikwe amaphuzu. Zama okungenani umusho owodwa noma emibili bese uzama futhi.';
$string['soapbox:mic_denied'] = 'Ukufinyelela kumakrofoni kuyadingeka ukuze uqophe. Vumela ukufinyelela kumakrofoni bese uzama futhi.';
$string['soapbox:no_browser_stt'] = 'Lesi siphequluli asisekeli ukubona inkulumo ngaphakathi kwesiphequluli. Zama i-Chrome noma i-Safari, noma ucele umlawuli wakho ukuthi ashintshele i-Soapbox kube ngumbhalo weseva.';
...
$string['soapbox:tips_heading'] = 'Amathiphu okwesikhathi esizayo';
$string['soapbox:col_criterion'] = 'Isimiso';
$string['soapbox:col_score'] = 'Iphuzu';
$string['soapbox:col_feedback'] = 'Impendulo';
$string['soapbox:history_heading'] = 'Izinkulumo zami';
$string['soapbox:history_empty'] = 'Awukaqophi inkulumo okwamanje. Qopha eyodwa ngenhla ukuze uqale ukwakha umlando wakho.';
$string['soapbox:untitled'] = 'Inkulumo engenasihloko';
...
$string['cachedef_ratelimit'] = 'Ukukhawulela izinga lezicelo ngomsebenzisi ngamunye';
$string['cachedef_uistate'] = 'Ukushintsha kwe-UI ngeseshini ngayinye (buka njengomfundi, veza amagama angempela)';
$string['benchmark:pagetitle'] = 'Isikali somhlinzeki';
$string['benchmark:intro'] = 'Ithumela iqoqo elimisiwe lezimemezelo ezijwayelekile kubo bonke abahlinzeki be-AI abamisiwe, ibhale ukusetshenziswa kwamathokheni, izindleko nesikhathi sokusabela, futhi incoma umhlinzeki oyedwa ngekhono ngalinye. Ukusebenza ngakunye kwenza izingcingo ze-API ezingempela, ngakho ukusebenza kubiza cishe amasenti angu-5 kuya kwangu-20 kuya ngokuthi bangaki abahlinzeki abamisiwe.';
$string['cachedef_systemprompt'] = 'Isimemezelo sohlelo lwe-AI esihlanganisiwe (ngesifundo ngasinye)';
$string['cachedef_remoteconfig'] = 'Ukumiswa okukude okulandwe esiteshini sokubuyekeza';
$string['cachedef_spend'] = 'Isamba sokusetshenziswa kwemali ye-AI ngesikhathi ngasinye somqaphi wokusetshenziswa kwemali';
$string['cachedef_failover_circuit'] = 'Isimo sesivimbi sesifunda sokuphambuka komhlinzeki';
$string['settings:rag_scope'] = 'Ububanzi bokuthola';
$string['settings:rag_scope_desc'] = 'Uma umfundi ebuka idokhumenti ethile (ikhasi, incwadi, noma i-PDF), ukuthi ukukhawulela yini ukutholwa kuleyo dokhumenti. <b>Idokhumenti kuqala</b> isekela impendulo kudokhumenti yamanje uma inezingcezu ezifanele futhi ibuyele kuso sonke isifundo ngenye indlela. <b>Idokhumenti kuphela</b> ayilokothi ibuyele emuva: uma idokhumenti yamanje ingenayo ingcezu efanele ayitholi lutho, ngakho uthisha uphendula ngolwazi olujwayelekile kunokuthi acaphune amakhasi angahlobene. <b>Isifundo sonke</b> isesha konke okuqukethwe kwesifundo (ikhasi lamanje lisathola ukukhuphuka kohlelo ngenhla). Idokhumenti kuqala inconyiwe, ukuze impendulo ephathelene nekhasi umfundi alifundayo isekelwe kulelo khasi.';
$string['settings:rag_scope_document_first'] = 'Idokhumenti kuqala (khetha idokhumenti yamanje, buyela esifundweni)';
$string['settings:rag_scope_document_only'] = 'Idokhumenti kuphela (khawulela kudokhumenti yamanje)';
$string['settings:rag_scope_course'] = 'Isifundo sonke (sesha konke okuqukethwe kwesifundo)';
$string['ragadmin:no_content_documents'] = 'Amadokhumenti angu-{$a->count} akhiphanga umbhalo ongafakwa enkomba futhi awahlukaniswanga aba yizingcezu (ngokuvamile amakhasi ashumekiwe kakhulu noma amafushane kakhulu): {$a->titles}. Uma noma yikuphi kwalokhu kufanele kwesheshiswe, engeza umbhalo ekhasini noma umbhalo obhaliwe, bese ufaka kabusha enkomba.';
$string['privacy:metadata:sbx_rec'] = 'Okuqoshiwe kokwethula kwe-Soapbox. Into yemidiya iyasuswa ngemva kwesikhathi sokugcina; umbhalo obhaliwe ugcinwa ukuze kunikezwe impendulo nezicelo zokufinyelela.';
$string['privacy:metadata:sbx_rec:userid'] = 'Umfundi owenze ukuqoshwa.';
$string['privacy:metadata:sbx_rec:transcript'] = 'Umbhalo obhaliwe wokukhuluma-kuya-embhalweni wokuqoshiwe.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'Ubude bokuqoshiwe ngamasekhondi.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'Ukuthi ukuqoshwa kwenziwa nini.';
$string['privacy:metadata:ai_provider'] = 'Ukuze kukhiqizwe izimpendulo zokufundisa, okuqukethwe okubhalwe umfundi kuthunyelwa kumhlinzeki we-AI omiswe umlawuli wesayithi noma wesifundo.';
$string['privacy:metadata:ai_provider:message'] = 'Umbhalo womlayezo nezingcezu umfundi azithumela kuthisha we-AI.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'Umongo wesifundo nomsebenzi (njengegama lesifundo nekhasi lamanje) ofakiwe ukusekela impendulo.';
$string['privacy:metadata:voice_provider'] = 'Uma kusetshenziswa ukufaka noma ukukhipha izwi, umsindo nombhalo kuthunyelwa kumhlinzeki wokukhuluma-kuya-embhalweni / umbhalo-kuya-ekukhulumeni omisiwe.';
$string['privacy:metadata:voice_provider:audio'] = 'Umsindo oqoshiwe womfundi okhulumayo, othunyelwe ukubhalwa.';
$string['privacy:metadata:voice_provider:text'] = 'Umbhalo othunyelwe kumhlinzeki ukuze uhlanganiswe ube inkulumo.';
$string['privacy:metadata:zendesk'] = 'Uma ukukhuphula kokusekelwa kwabantu kunikwe amandla futhi umfundi evuma, imininingwane yakhe yokuxhumana nomlayezo kuthunyelwa e-Zendesk ukuvula ithikithi lokusekela.';
$string['privacy:metadata:zendesk:name'] = 'Igama eliphelele lomfundi, elisetshenziselwa ukuhlonza ocela usekelo.';
$string['privacy:metadata:zendesk:email'] = 'Ikheli le-imeyili lomfundi, elisetshenziselwa ukuphendula isicelo sosekelo.';
$string['privacy:metadata:zendesk:message'] = 'Umlayezo noma okuqukethwe kwengxoxo umfundi akhethe ukukukhuphula.';
...
$string['analytics_js:ai_users'] = 'Abasebenzisi be-AI';
$string['analytics_js:non_users'] = 'Abangebona Abasebenzisi';
$string['analytics_js:thumbs_up'] = 'Isithupha Phezulu';
$string['analytics_js:thumbs_down'] = 'Isithupha Phansi';
$string['analytics_js:hallucination_flags'] = 'Amafulege Okubhinca';
$string['analytics_js:avg_star_rating'] = 'Isilinganiso Sezinkanyezi Esimaphakathi';
$string['analytics_js:avg_msgs_resolution'] = 'Imilayezo Emaphakathi Kuze Kuxazululwe';
$string['analytics_js:survey_respondents'] = 'Abaphenduli Bocwaningo';
$string['analytics_js:messages'] = 'Imilayezo';
$string['analytics_js:students'] = 'Abafundi';
$string['analytics_js:frequency'] = 'Ukuvama';
$string['analytics_js:responses'] = 'Izimpendulo';
$string['analytics_js:error_loading'] = 'Iphutha lokulayisha idatha';
$string['analytics_js:loading'] = 'Ilayisha izibalo...';
$string['analytics_js:no_course_data'] = 'Ayikho idatha yesifundo etholakalayo.';
$string['analytics_js:no_unit_data'] = 'Ayikho idatha yeyunithi okwamanje. Ukulandelela iyunithi kuqongelela njengoba abafundi besebenzisa umsizi.';
$string['analytics_js:no_keyword_data'] = 'Ayikho idatha yamagama angukhiye etholakalayo kule nkathi.';
$string['task:soapbox_cleanup'] = 'Ukugcinwa nokuhlanzwa kokuqoshiwe kwe-Soapbox';
$string['admin:vendor_dpa:col_provider'] = 'Umhlinzeki';
$string['admin:vendor_dpa:col_optout'] = 'Ukuphuma ekuqeqeshweni';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Ukugcinwa';
$string['admin:vendor_dpa:col_tier'] = 'Uphahla lweziqongo';
$string['admin:vendor_dpa:col_link'] = 'Isixhumanisi';
$string['admin:vendor_dpa:vendor_terms'] = 'Imigomo yomthengisi';
$string['admin:vendor_dpa:tier'] = 'Iqophelo {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'Ngokwenkontileka (ukhethe ukuphuma)';
$string['admin:vendor_dpa:too_default_on'] = 'Ivuliwe ngokuzenzakalelayo';
$string['admin:vendor_dpa:too_none'] = 'Akukho ukuphuma';
$string['admin:vendor_dpa:too_local'] = 'Endaweni (akukho mthengisi)';
$string['admin:vendor_dpa:too_unknown'] = 'Ayikabuyekezwa';
$string['admin:vendor_dpa:dpa_signed'] = 'Isayiniwe';
$string['admin:vendor_dpa:dpa_available'] = 'Iyatholakala';
$string['admin:vendor_dpa:dpa_negotiating'] = 'Iyaxoxisana';
$string['admin:vendor_dpa:dpa_not_offered'] = 'Ayinikeziwe';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'Akusebenzi';
$string['admin:vendor_dpa:dpa_unknown'] = 'Akwaziwa';
$string['settings:soapbox_slide_vision'] = 'Impendulo yokuklama okubonakalayo kweslayidi se-Soapbox';
$string['settings:soapbox_slide_vision_desc'] = 'Vumela ukudlula okukodwa kombono ezithombeni zeslayidi ezinikeziwe ukuze kwengezwe inothi elifushane lokuklama okubonakalayo kokwethula okuklonyisiwe. Kuvaliwe ngokuzenzakalelayo futhi kunakekela ubumfihlo: azikho izithombe ezigcinwayo, futhi umsebenzi ngamunye kufanele futhi ukhethe ukungenela ngebhokisi lakhe lokuhlola lempendulo yokuklama okubonakalayo kweslayidi. Kuthintwa kuphela ukwethula kweslayidi okunombuthano olayishiwe.';
$string['settings:soapbox_vision_provider'] = 'Umhlinzeki wombono weslayidi se-Soapbox';
$string['settings:soapbox_vision_provider_desc'] = 'Umhlinzeki osetshenziselwa ukudlula kombono weslayidi. Uzenzakalela ku-openai. Kufanele abe umhlinzeki onekhono lombono omiswe ngekhi ye-API (ngomhlinzeki wesifundo noma uhlu lwabahlinzeki bokuqhathanisa).';
$string['settings:soapbox_vision_model'] = 'Imodeli yombono weslayidi se-Soapbox';
$string['settings:soapbox_vision_model_desc'] = 'Imodeli enekhono lombono yokudlula kombono weslayidi. Izenzakalela ku-gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'Ukuklama kweslayidi:';
$string['soapbox:assign_manage'] = 'Imisebenzi yokwethula kwe-Soapbox';
$string['soapbox:copy_link'] = 'Isixhumanisi somfundi';
$string['soapbox:deck_label'] = 'Amaslayidi (PDF). Layisha umbuthano wakho, bese uqhubekisela phambili amaslayidi njengoba uqopha.';
$string['soapbox:slide_prev'] = 'Islayidi esidlule';
$string['soapbox:slide_next'] = 'Islayidi esilandelayo';
$string['soapbox:play_slides'] = 'Dlala namaslayidi';
$string['soapbox:audio_ready'] = 'Umsindo kuphela. Imakrofoni yakho izoqoshwa; ikhamera yakho ayisetshenziswa.';
$string['soapbox:audio_recording'] = 'Iqopha umsindo...';
$string['soapbox:cap_reached'] = 'Usufinyelele inani eliphezulu lokuqoshiwe kulo msebenzi.';
$string['soapbox:storage_unconfigured'] = 'Isitoreji sokuqoshwa asikamiswa okwamanje. Sicela uxhumane nomlawuli wakho.';
$string['soapbox:bad_key'] = 'Lokho okulayishiwe akusikho okwakho.';
$string['soapbox:slides_disabled'] = 'Amaslayidi awanikwanga amandla kulo msebenzi.';
$string['soapbox:upload_missing'] = 'Okulayishiwe akukwazekanga ukutholakala. Sicela uzame ukuqopha futhi.';
$string['soapbox:mode_label'] = 'Uhlobo lokwethula';
$string['soapbox:mode_informative'] = 'Ukwazisa (chaza noma fundisa)';
$string['soapbox:mode_persuasive'] = 'Ukuncenga (yenza bakholwe)';
$string['soapbox:err_provider'] = 'Insizakalo yokuklonyisa ye-AI ayikwazanga ukufinyelelwa. Sicela uzame futhi ngomzuzwana.';
$string['soapbox:err_parse'] = 'I-AI ibuyise impendulo engalindelekile. Sicela uzame futhi.';
$string['soapbox:err_disabled'] = 'Ukuzijwayeza kwenkulumo akunikwanga amandla kulesi sifundo.';
$string['soapbox:err_transcribe'] = 'Ukuqoshwa kwakho akukwazanga ukubhalwa. Sicela uzame futhi, futhi uhlole ukuthi imakrofoni yakho iyasebenza.';
$string['settings:outcomes_benchmark_default'] = 'Isikali semiphumela (iphesenti)';
$string['settings:outcomes_benchmark_default_desc'] = 'Isikali esimiswe isikhungo sombiko wemiphumela: umfundi ufeza umphumela uma ukwazi kwakhe kukuleli phesenti noma ngaphezulu kwalo. Lokhu kuyizinga lokubika (elihlukile kumkhawulo wokwazi wokufundisa). Okuzenzakalelayo 70.';
$string['outcomes:title'] = 'Umbiko wemiphumela';
$string['outcomes:intro'] = 'Ngomphumela ngamunye wesifundo, isikali nephesenti labafundi abahloliwe abawufezayo noma abawedlulayo. Isikali sesayithi singama-{$a}%.';
$string['outcomes:none'] = 'Ayikho imiphumela echaziwe kulesi sifundo okwamanje.';
$string['outcomes:export'] = 'Thumela ngaphandle i-CSV';
$string['outcomes:col_outcome'] = 'Umphumela';
$string['outcomes:col_benchmark'] = 'Isikali';
$string['outcomes:col_assessed'] = 'Abafundi abahloliwe';
$string['outcomes:col_met'] = 'Bafeze isikali';
...
$string['soapbox:present_audio'] = 'Isethulo somsindo';
$string['soapbox:present_video'] = 'Isethulo sevidiyo';
$string['soapbox:present_target'] = 'okuqondiwe {$a->min}-{$a->max} imizuzu';
$string['soapbox:choose_topic'] = 'Khetha isihloko';
$string['soapbox:record_short'] = 'Qopha';
$string['soapbox:my_recordings'] = 'Okuqoshiwe kwami';
$string['soapbox:no_recordings'] = 'Akukho okuqoshiwe okwamanje.';
$string['soapbox:col_recorded'] = 'Kuqoshwe';
$string['soapbox:col_length'] = 'Ubude';
$string['soapbox:col_type'] = 'Uhlobo';
$string['soapbox:col_recording'] = 'Ukuqopha';
$string['soapbox:col_kept'] = 'Kugciniwe';
$string['soapbox:col_student_link'] = 'Isixhumanisi somfundi';
$string['soapbox:view_download'] = 'Buka / landa';
$string['soapbox:expired'] = 'Kuphelelwe yisikhathi';
$string['soapbox:retention_note'] = 'Okuqoshiwe kungabukwa futhi kulandwe izinsuku ezingu-{$a}, bese kususwa ngokuzenzakalela.';
$string['soapbox:assign_title'] = 'Imisebenzi ye-Soapbox';
$string['soapbox:assign_single_title'] = 'Umsebenzi we-Soapbox';
$string['soapbox:assign_add'] = 'Engeza umsebenzi';
$string['soapbox:assign_none'] = 'Ayikho imisebenzi ye-Soapbox okwamanje.';
$string['soapbox:assign_deleted'] = 'Umsebenzi ususiwe.';
$string['soapbox:assign_updated'] = 'Umsebenzi ubuyekeziwe.';
$string['soapbox:assign_created'] = 'Umsebenzi wenziwe.';
...
$string['radar_report:title'] = 'Umbiko we-Learning Radar we-[[tutorshort]]';
$string['radar_report:print'] = 'Phrinta / londoloza njenge-PDF';
$string['radar_report:generated'] = 'Kwenziwe ngo-{$a}';
$string['radar_report:query'] = 'Umbuzo';
$string['radar_report:response'] = 'Impendulo';
$string['radar_report:privacy_note'] = 'Yonke idatha yabafundi kulo mbiko ayidalulwa. Ungayabelani nomphakathi.';

$string['settings:hidden_categories'] = 'Izigaba zezifundo ezifihliwe';
$string['settings:hidden_categories_desc'] = 'Uhlu lwamagama noma ama-ID wezigaba zezifundo, ahlukanisiwe ngokhefana, lapho umsizi kungafanele avele. Isibonelo: "Ukwakhiwa kwezifundo, 42". Umsizi ufihlwa nangokuzenzakalela lapho imodi yokuhlela ivulekile.';
$string['settings:provider_heading'] = 'Umhlinzeki we-AI nengxoxo';
$string['settings:provider_heading_desc'] = 'Lungisa inkundla ye-AI, imodeli, kanye nokuziphatha engxoxweni.';
$string['settings:claude_temperature_allow_prefixes'] = 'Amamodeli e-Claude asekela ipharamitha ye-temperature';
$string['settings:claude_temperature_allow_prefixes_desc'] = 'Isiqalo esisodwa segama lemodeli kulayini ngamunye. Amamodeli e-Anthropic anegama eliqala ngesinye salezi asalokhu amukela ipharamitha yesampula <code>temperature</code>. Kunoma yiliphi imodeli ye-Claude engahambisani nanoma yisiphi isiqalo, i-temperature iyekwa (amamodeli okucabanga kusukela ku-Opus 4.7 ayenqaba ngephutha le-HTTP 400). Shiya kungenalutho ukuze usebenzise inzalo evamile efika nengeziwe.';
$string['settings:max_tokens'] = 'Ubude bempendulo obukhulu (amathokheni)';
$string['settings:max_tokens_desc'] = 'Inani eliphezulu lamathokheni empendulweni ngayinye ye-AI. Amanani aphansi anikeza izimpendulo ezimfushane nezishesha. 512 = cishe imisho emi-2-3, 1024 = cishe iziqephu ezi-1-2, 2048 = izincazelo ezinde. Beka 0 ukuze kungabi khona umkhawulo (inzalo yomhlinzeki iyasebenza).';
$string['settings:profile_update_interval'] = 'Isikhathi sokubuyekeza iphrofayela yomfundi';
$string['settings:profile_update_interval_desc'] = 'Ngemva kwaleli nani lemiyalezo evela kumfundi esifundweni, umsizi wakha (noma uvuselele) iphrofayela yokufunda efingqa amandla, ubuthakathaka, isitayela sokufunda, nezintandokazi. Iphrofayela ifakwa esiqalisweni sesistimu ukuze izimpendulo zibe zomuntu siqu. Beka 0 ukuyivala. Okuvamile: 10.';
$string['settings:enable_thinking'] = 'Ukucabanga okwandisiwe (i-Claude kuphela)';
$string['settings:enable_thinking_desc'] = 'Ivula ukucabanga okuzivumelanisayo kumamodeli e-Claude. I-Claude uqobo inquma ukuthi nini nokuthi kangakanani icabanga ngenkinga ngaphambi kokuphendula. Ikhulisa ukunemba emibuzweni eyinkimbinkimbi, kodwa yandisa ukusetshenziswa kwamathokheni nokubambezeleka. Okuqukethwe kokucabanga akuboniswa abafundi. Abanye abahlinzeki bayashaya indiva lesi silungiselelo.';
$string['settings:rag_sources_heading'] = 'Imithombo yokuqukethwe kwe-RAG';
$string['settings:rag_sources_heading_desc'] = 'Khetha ukuthi yiziphi izinhlobo zokuqukethwe kwesifundo lapho isihleli sohlu lwe-RAG sizokhipha umbhalo kuzo. Izinkomba zesimo <a href="{$a}">ekhasini lokulawula i-RAG</a> zibonisa ukuthi ngabe umkhiphi ngamunye unalokho akudingayo ukuze asebenze (isibonelo ithuluzi le-pdftotext noma uhlu lokuvumela lwe-Cloudflare).';
$string['settings:rag_extract_pdf'] = 'Hlela amafayela e-PDF (mod_resource)';
$string['settings:rag_extract_pdf_desc'] = 'Ikhipha umbhalo kumafayela e-PDF alayishiwe ngethuluzi le-<code>pdftotext</code> (poppler). Indlela yethuluzi itholwa ngokuzenzakalela; ibonise ngezansi uma kudingeka.';
$string['settings:rag_pdftotext_path'] = 'Indlela yethuluzi le-pdftotext';
$string['settings:rag_pdftotext_path_desc'] = 'Shiya kungenalutho ukuze kutholwe ngokuzenzakalela (kuhlolwa <code>/usr/bin/pdftotext</code>, <code>/usr/local/bin/pdftotext</code> kanye ne-<code>which pdftotext</code>). Gcwalisa kuphela uma ukufakwa kwakho kukwenye indawo.';
$string['settings:rag_extract_docx'] = 'Hlela amafayela e-DOCX (mod_resource)';
$string['settings:rag_extract_docx_desc'] = 'Ikhipha umbhalo kumidwebo ye-Word elayishiwe nge-ZipArchive ye-PHP. Akudingeki okuncikile kwangaphandle.';
$string['settings:rag_extract_pptx'] = 'Hlela amafayela e-PPTX (mod_resource)';
$string['settings:rag_extract_pptx_desc'] = 'Ikhipha umbhalo kuzethulo ze-PowerPoint zesimanje ezilayishiwe nge-ZipArchive ye-PHP. Ihamba ku-XML yamaslayidi nezinothi zesikhulumi ngokulandelana kwamaslayidi; akudingeki okuncikile kwangaphandle. Amafayela amadala e-binary <code>.ppt</code> awasekelwa — londoloza kabusha lezo zethulo njenge-<code>.pptx</code>.';
$string['settings:rag_extract_h5p'] = 'Hlela okuqukethwe kwe-H5P (mod_h5p)';
$string['settings:rag_extract_h5p_desc'] = 'Ihamba ku-JSON yokuqukethwe kwe-H5P futhi ihlela wonke amasimu anombhalo (imibuzo, izimpendulo, impendulo, izincazelo). Imethadatha yezinhlobo zokuqukethwe kwe-H5P ibanzi; ezimweni ezisemngceleni kulindeleke ukufana okuncane okungalungile.';
$string['settings:rag_extract_scorm'] = 'Hlela amaphakethe e-SCORM (mod_scorm)';
$string['settings:rag_extract_scorm_desc'] = 'Ivula amaphakethe e-SCORM futhi ihlela i-<code>imsmanifest.xml</code>, wonke amafayela e-<code>.html</code>, nezintambo zokuqukethwe kwe-Articulate Storyline. <strong>Kuvalwe ngokuvamile</strong>, ngoba ukucubungula i-SCORM kungabiza. Usayizi omkhulu wephakethe unqunywa ngu-<code>rag_scorm_max_mb</code>.';
$string['settings:rag_scorm_max_mb'] = 'Usayizi omkhulu wephakethe le-SCORM elizohlelwa (MB)';
$string['settings:rag_scorm_max_mb_desc'] = 'Yeqa amaphakethe e-SCORM amakhulu kunaleli nani ukugwema ukusetshenziswa okweqile kwenkumbulo.';
$string['settings:rag_fetch_transcripts'] = 'Landa amabhalwa amavidiyo nokuqukethwe okusebenzisanayo okufakiwe';
$string['settings:rag_fetch_transcripts_desc'] = 'Ihlola okuqukethwe kwe-mod_page ne-mod_book ifuna ama-iframe afakiwe (Synthesia, YouTube, Articulate, Genially) bese ilanda ikheli lebhalwa elihambisana nokufakwa ngakunye (ifuna ngenhla nangaphansi kwohlaka). Idinga uxhumano lwe-HTTPS oluphumayo kusuka kule seva luye kumbungazi wamabhalwa. <strong>Kuvalwe ngokuvamile</strong>; vula ngemva kokuthi umhlinzeki wamabhalwa ehlanganise le seva ohlwini lwakhe lokuvumela (isibonelo ngomthetho we-Cloudflare osekelwe ku-IP).';
$string['settings:rag_iframe_host_patterns'] = 'Amaphethini wababungazi be-iframe';
...
$string['settings:max_content_per_resource_desc'] = 'Inani eliphezulu lezinhlamvu zokuqukethwe ezikhishwa kwikhasi ngalinye noma isahluko sencwadi. Amanani aphansi anciphisa usayizi wesiqaliso futhi asheshise izimpendulo.';
$string['settings:max_total_content'] = 'Okuqukethwe okuphelele okukhulu (izinhlamvu)';
$string['settings:max_total_content_desc'] = 'Inani eliphezulu eliphelele lezinhlamvu zokuqukethwe kwesifundo ezifakwa esiqalisweni sesistimu. Amanani aphansi anciphisa usayizi wesiqaliso futhi asheshise izimpendulo.';
$string['settings:spend_guard_heading'] = 'Ukuvikela ukusetshenziswa kwemali nomthuthukisi';
$string['settings:spend_guard_heading_desc'] = 'Beka imikhawulo yokusebenzisa imali ye-LLM ngesikhathi ngasinye. Lapho umkhawulo ufinyelelwa, [[tutorshort]] imisa izicelo noma ishintshela kumhlinzeki oshibhile ochungechungeni lwakho lokusekela. Bheka <a href="{$a}">ikhasi lezindleko zamathokheni</a> ukuthola isimo samanje sokusetshenziswa kwemali nezincomo zomthuthukisi.';
$string['settings:spend_cap_period'] = 'Isikhathi somkhawulo wokusetshenziswa kwemali';
$string['settings:spend_cap_period_desc'] = 'Ukuthi kangaki umkhawulo wokusetshenziswa kwemali usethwa kabusha. Kuqondaniswe nekhalenda: owanyanga uqala ngomhla ka-1, owesonto ngoMsombuluko, nowansuku ngamabili.';
$string['settings:spend_cap_site'] = 'Umkhawulo wokusetshenziswa kwemali kwesizinda sonke (USD)';
$string['settings:spend_cap_site_desc'] = 'Umkhawulo ohlangene nge-USD kuzo zonke izifundo namakhono kulesi sikhathi samanje. <code>0</code> = akunamkhawulo. Imikhawulo yamakhono ngezansi ibalulekile lapho isethiwe.';
$string['settings:spend_cap_chat'] = 'Umkhawulo wengxoxo (USD)';
$string['settings:spend_cap_chat_desc'] = 'Umkhawulo wengxoxo nezivivinyo zabafundi kuphela. <code>0</code> = umkhawulo wesizinda sonke uyasetshenziswa.';
$string['settings:spend_cap_voice'] = 'Umkhawulo wezwi (USD)';
$string['settings:spend_cap_voice_desc'] = 'Umkhawulo wezwi (Realtime + TTS + STT). Izwi imvamisha yiyona indleko enkulu kakhulu — yinciphise kuqala.';
$string['settings:spend_cap_rag'] = 'Umkhawulo we-RAG (USD)';
$string['settings:spend_cap_rag_desc'] = 'Umkhawulo wamakholi e-embedding enzeka ngesikhathi sokuhlela izifundo.';
$string['settings:spend_cap_analytics'] = 'Umkhawulo wokuhlaziya (USD)';
$string['settings:spend_cap_analytics_desc'] = 'Umkhawulo wemibuzo ye-Learning Radar yabalawuli.';
$string['settings:spend_failover_chain'] = 'Uchungechunge lokusekela';
$string['settings:spend_failover_chain_desc'] = 'Lapho umkhawulo ufinyelelwa, [[tutorshort]] izama laba bahlinzeki ngokulandelana. Ukungena okukodwa kulayini ngamunye, ngefomu <code>capability:label</code>. Amalebula abhekisa kokungeniswe kuBahlinzeki bokuqhathanisa (ku-<code>chat</code> / <code>analytics</code>) noma kuBahlinzeki bezwi (ku-<code>voice</code>). Imigqa eqala ngo-<code>#</code> imibhalo yokuchaza. Isibonelo:<br><code>chat:claude-haiku<br>chat:ollama-local<br>voice:openai-prod<br>analytics:deepseek</code>';
$string['settings:failover_per_call_enabled'] = 'Ukushintshela kokusekela kukholi ngayinye (v5.5.0)';
$string['settings:failover_per_call_enabled_desc'] = 'Uma kuvulwe, ikholi ngayinye yengxoxo isonga umhlinzeki oyinhloko ngaphakathi kwesivalo sochungechunge lokusekela. Uma isikhathi siphela kwikholi noma iphutha le-5xx lenzeka, [[tutorshort]] ishintshela kokungeniswe okulandelayo ku<strong>chungechunge lokusekela</strong> ngenhla futhi ivula isekethe lemizuzu engu-15 kumhlinzeki ohlulekile. Ukushintsha ngakunye kubhala umugqa wokucwaninga (<code>failover_fallthrough</code>); ngemva kokuvula, bheka Ukulawula -> [[tutorshort]] -> Irekhodi lokucwaninga ukuqinisekisa ukuthi uchungechunge luyasebenza. Kuvalwe ngokuvamile; vula kuphela ngemva kokuthi uchungechunge luqinisekisiwe nangemva kokuthi isikhungo sakho siqinisekise ukuthi izivumelwano zokucubungula idatha ezidingekayo zikhona kumhlinzeki ngamunye ochungechungeni.';
$string['settings:failover_timeout_chat'] = 'Ukusekela: isikhathi sokulinda kwengxoxo (amasekhondi)';
$string['settings:failover_timeout_chat_desc'] = 'Isikhathi sokulinda ithokheni lokuqala kumhlinzeki wengxoxo ngaphambi kokushintsha. Okuvamile amasekhondi ayi-8. Amanani aphansi asuka ngokushesha kubahlinzeki abahamba kancane, kodwa abangela izexwayiso eziningi zamanga kuzicelo ezihamba kancane okwesikhashana; amanani aphezulu abamba uchungechunge kumhlinzeki oyinhloko isikhathi eside. Kubhekwa kuphela lapho <strong>ukushintshela kokusekela kukholi ngayinye</strong> kuvulwe.';
$string['settings:spend_notify_emails'] = 'Abathola izexwayiso zokusetshenziswa kwemali';
$string['settings:spend_notify_emails_desc'] = 'Amakheli e-imeyili ahlukanisiwe ngokhefana azokwaziswa ku-80%, 95%, no-100% womkhawulo. Shiya kungenalutho ukwazisa bonke abalawuli besizinda.';
$string['settings:opt_cost_weight'] = 'Umthuthukisi: isisindo sezindleko';
$string['settings:opt_cost_weight_desc'] = 'Ubungako obukhulu umthuthukisi obheka izindleko lapho ehlela abahlinzeki. U-0.0 ushaya indiva izindleko, u-1.0 uthuthukisa ngezindleko kuphela. Kukalwa kanye nesisindo sekhwalithi.';
$string['settings:opt_quality_weight'] = 'Umthuthukisi: isisindo sekhwalithi';
$string['settings:opt_quality_weight_desc'] = 'Ubungako obukhulu umthuthukisi obheka ukwaneliseka komfundi (ingxenye yezilinganiso ezinhle) lapho ehlela abahlinzeki. U-0.0 ushaya indiva ikhwalithi.';
$string['settings:inactivity_reminder_enabled'] = 'Izikhumbuzi zokungasebenzi';
$string['settings:inactivity_reminder_enabled_desc'] = 'Ithumela i-imeyili yamasonto onke kubafundi abangavulanga isifundo sabo esikhathini sezinsuku esimisiwe.';
$string['settings:inactivity_threshold_days'] = 'Umkhawulo wokungasebenzi (izinsuku)';
$string['settings:inactivity_threshold_days_desc'] = 'Izinsuku ezingaki zokungasebenzi ngaphambi kokuthi i-imeyili yesikhumbuzo ithumelwe.';
$string['settings:voice_providers_heading'] = 'Abahlinzeki bezwi (Realtime, TTS, STT)';
$string['settings:voice_providers_heading_desc'] = 'Lungisa umhlinzeki oyedwa noma ngaphezulu we-API yezwi. Lezi zilungiselelo azincikile kumhlinzeki wengxoxo ongenhla nakumhlinzeki we-embedding we-RAG — izwi linohlu lwabahlinzeki lwalo, ngoba okwamanje i-OpenAI ne-xAI kuphela ezinikeza amaphuzu okugcina e-Realtime asekelwe ku-WebSocket, i-TTS, ne-STT. Sebenzisa amalungiselelo angezansi ukukhetha ukuthi imuphi umhlinzeki obhalisiwe uzophatha ikhono ngalinye. Uma kungachaziwe umugqa, ukuziphatha okudala kwesihluthulelo esisodwa kuyasebenza (isihluthulelo se-API se-Realtime ngenhla noma isihluthulelo esiyinhloko se-OpenAI). Isizinda esisebenzisa i-Together AI / Anthropic / DeepSeek / Gemini / Mistral kwengxoxo kumele lilungise okungenani umugqa owodwa lapha ukuze izwi lisebenze.';
$string['settings:voice_active_realtime'] = 'Umhlinzeki we-Realtime osebenzayo';
$string['settings:voice_active_realtime_desc'] = 'Umuphi umhlinzeki wezwi olungisiwe ozophatha izikhathi zomenzeli wezwi we-Realtime.';
$string['settings:voice_active_tts'] = 'Umhlinzeki we-TTS osebenzayo';
$string['settings:voice_active_tts_desc'] = 'Umuphi umhlinzeki wezwi olungisiwe ozofunda ngokuzwakalayo izimpendulo ze-AI.';
$string['settings:voice_active_stt'] = 'Umhlinzeki we-STT osebenzayo';
$string['settings:voice_active_stt_desc'] = 'Umuphi umhlinzeki ozoguqula inkulumo yomfundi ibe umbhalo. Shiya kungenalutho ukuze kukhethwe iseva ye-Whisper yakho uma ilungisiwe ngezansi, bese umugqa wokuqala wabahlinzeki bezwi noma isihluthulelo esidala.';
$string['settings:stt_selfhosted_enabled'] = 'Vula ukubhala inkulumo eseveni yakho';
$string['settings:stt_selfhosted_enabled_desc'] = 'Isebenzisa iseva ye-Whisper yakho engezansi njengendlela yokuguqula inkulumo ibe umbhalo kokufakwa kwezwi nase-Soapbox. Kudingeka ikheli leseva ngezansi. Uma kuvalwe, ukubhala inkulumo kubuyela endleleni ebungazwayo (OpenAI Whisper) noma indlela yesiphequluli, ngisho noma ikheli lisethiwe.';
$string['settings:stt_selfhosted_warm'] = 'Fudumeza lapho ukurekhoda kwe-Soapbox kuqala';
$string['settings:stt_selfhosted_warm_desc'] = 'Uma kuvulwe, ukuqala ukurekhoda kwe-Soapbox kuthumela isicelo esilula sokufudumeza (ngokusemandleni) kuseva yakho yokubhala inkulumo, ukuze umbungazi onciphela kuziro (isibonelo i-Cloud Run) athole ithuba lokuqala ngenkathi umfundi esarekhoda — ngaleyo ndlela ukubambezeleka kokuqala okubandayo kuhlala kufihliwe kokubhala inkulumo okusebenza lapho kuthunyelwa. Akunamthelela uma ikheli leseva yakho lingasethiwe ngenhla. Kuvalwe ngokuvamile.';
$string['settings:voice_tab_enabled'] = 'Vula ithebhu yeZwi';
$string['settings:voice_tab_enabled_desc'] = 'Ibonisa ithebhu yeZwi kubha yokuzulazula engaphansi. Uma kuvalwe, abafundi babona kuphela amathebhu Ingxoxo namaNothi. Amakhono ezwi (ukuzilolonga ingxoxo, ukuzilolonga ukubiza) ahlala afinyeleleka ngezisusa zengxoxo uma zivulwe ngokwehlukene.';
$string['settings:soapbox_heading'] = 'Soapbox';
$string['settings:soapbox_heading_desc'] = 'Ukuzilolonga ukwethula ngomlomo: ukuthi amarekhodi abhalwa kanjani nokuthi ahlolwa ngesiphi isilinganiso. Vula i-Soapbox esifundweni ngasinye ngesivulo se-Soapbox esigabeni sokuFundisa.';
$string['settings:soapbox_max_seconds'] = 'Ubude obukhulu bokurekhoda kwe-Soapbox (amasekhondi)';
$string['settings:soapbox_max_seconds_desc'] = 'Umkhawulo ophezulu ophelele wobude bokurekhoda kunoma yimuphi umsebenzi. Abafundisi bangabeka ibanga elifushane. Okuvamile 720 (imizuzu engu-12).';
$string['settings:soapbox_max_recordings'] = 'Amarekhodi amaningi e-Soapbox ngomfundi nomsebenzi ngamunye';
$string['settings:soapbox_max_recordings_desc'] = 'Umkhawulo ophezulu ophelele wenani lamarekhodi umfundi angawenza kumsebenzi owodwa, kungakhathaliseki isilungiselelo sezinye izinhlolo ngomsebenzi ngamunye. Okuvamile 3.';
$string['settings:soapbox_retention_days'] = 'Isikhathi sokugcina amarekhodi e-Soapbox (izinsuku)';
$string['settings:soapbox_retention_days_desc'] = 'Isikhathi irekhodi ligcinwa ngaphambi kokususwa ngokuzenzakalela; ibhalwa, amaphuzu, nempendulo agcinwa. Kunciphiswa kubanga lezinsuku ezi-1–28. Lapho kufushane kangcono ekunciphiseni idatha. Okuvamile 7.';
$string['settings:soapbox_video_quality'] = 'Ikhwalithi yevidiyo ye-Soapbox';
$string['settings:soapbox_video_quality_desc'] = 'Ukucaca nesivinini samabhithi ekurekhoda. Yilokhu okuyimbangela eyinhloko yezindleko nebhandiwidi; umkhulumi othwebulwe ebangeni eliphakathi ubonakala kahle ngisho nakwikhwalithi ejwayelekile. Ikhwalithi ephansi ifanele uxhumano olubuthakathaka; ikhwalithi ephakeme kuphela lapho imininingwane ebonakalayo ibalulekile.';
$string['settings:soapbox_storage_bucket'] = 'Ibhakede lokugcina i-Soapbox';
$string['settings:soapbox_storage_bucket_desc'] = 'Ibhakede le-S3 lamarekhodi. Okuvamile: ibhakede lokugcina elihlanganyelwe.';
$string['settings:soapbox_storage_region'] = 'Isifunda sokugcina i-Soapbox';
$string['settings:soapbox_storage_region_desc'] = 'Isifunda se-AWS sebhakede, isibonelo us-east-1.';
$string['settings:soapbox_storage_prefix'] = 'Isiqalo sezihluthulelo zokugcina i-Soapbox';
$string['settings:soapbox_storage_prefix_desc'] = 'Isiqalo sezihluthulelo ngaphakathi kwebhakede. Amarekhodi agcinwa ngaphansi kwale ndlela, ukuze umthetho womjikelezo wempilo ukwazi ukuwaqondisa.';
$string['settings:soapbox_storage_key'] = 'I-ID yesihluthulelo sokufinyelela sokugcina i-Soapbox';
$string['settings:soapbox_storage_key_desc'] = 'I-ID yesihluthulelo sokufinyelela somthethisisekelo we-IAM okhawulelwe ku-PutObject/GetObject/DeleteObject kusiqalo esingenhla.';
$string['settings:soapbox_storage_secret'] = 'Isihluthulelo esiyimfihlo sokufinyelela sokugcina i-Soapbox';
$string['settings:soapbox_storage_secret_desc'] = 'Isihluthulelo esiyimfihlo sokufinyelela esihambisana ne-ID yesihluthulelo sokufinyelela esingenhla.';
$string['settings:survey_heading'] = 'Inhlolovo yabafundi';
$string['settings:survey_heading_desc'] = 'Lungisa inhlolovo yesipiliyoni somfundi ngaphakathi kwengxoxo. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Hlela imibuzo yenhlolovo &rarr;</a>';
$string['settings:survey_enabled'] = 'Vula izinhlolovo';
$string['settings:survey_enabled_desc'] = 'Uma kuvulwe, abafundi bazocelwa ukugcwalisa inhlolovo mayelana nesipiliyoni sabo ngomfundisi we-AI.';
$string['settings:survey_trigger_messages'] = 'Bonisa ngemva kwemiyalezo engu-N';
$string['settings:survey_trigger_messages_desc'] = 'Ibonisa isimemo senhlolovo ngemva kokuthi umfundi ethumele leli nani lemiyalezo esifundweni. Beka 0 ukuze kuboniswe kuphela lapho kuqaliswa ngesandla.';
$string['settings:survey_frequency'] = 'Ukuvama kwenhlolovo ngomsebenzisi ngamunye';
$string['settings:survey_frequency_desc'] = 'Ukuthi kangaki umfundi angamenywa ukugcwalisa inhlolovo esifundweni ngasinye.';
$string['settings:rubric_heading'] = 'Izilinganiso zokuzilolonga';
$string['settings:rubric_heading_desc'] = 'Lungisa izilinganiso zokunika amaphuzu kuzikhathi zokuzilolonga ingxoxo nokubiza. Ekupheleni kwesikhathi sokuzilolonga, abafundi bathola amaphuzu nempendulo eyenziwe yi-AI. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Hlela izilinganiso &rarr;</a>';
$string['settings:practice_scoring_enabled'] = 'Vula ukunika amaphuzu kokuzilolonga';
$string['settings:practice_scoring_enabled_desc'] = 'Uma kuvulwe, ngemva kwezikhathi zokuzilolonga ingxoxo nokubiza abafundi bathola ikhadi lamaphuzu elinokuhlolwa kwesici ngasinye kanye nempendulo.';
$string['settings:usertesting_heading'] = 'Ukuhlolwa kokusebenziseka';
$string['settings:usertesting_heading_desc'] = 'Ukuhlolwa kokusebenziseka ngaphakathi kwe-widget kunokuhlolwa okusekelwe emisebenzini. Abafundi baqedela imisebenzi kumsizi bese behlola isipiliyoni sabo. Imiphumela ivela kudeshibhodi yokuhlaziya.';
$string['settings:usertesting_enabled'] = 'Vula ukuhlolwa kokusebenziseka';
$string['settings:usertesting_enabled_desc'] = 'Ibonisa isixhumanisi "Ukuhlolwa kokusebenziseka" ngaphansi kwe-widget. Uma kuvulwe, abafundi bangafinyelela emisebenzini yokuhlola.';
$string['settings:usertesting_external_url'] = 'Ikheli lefomu langaphandle (uhlobo C)';
$string['settings:usertesting_external_url_desc'] = 'Okuzikhethelayo: ikheli lefomu langaphandle (isibonelo i-Google Forms noma i-Typeform). Sebenzisa lezi zibambeli: {{userid}}, {{courseid}}, {{messages}}, {{session_minutes}}. Uma kusethiwe, ukuchofoza "Ukuhlolwa kokusebenziseka" kuvula leli kheli linomongo ogcwalisiwe. Shiya kungenalutho ukusebenzisa kuphela iphaneli yokuhlola ngaphakathi kwe-widget.';
$string['settings:footer_links_heading'] = 'Izixhumanisi zangaphansi';
$string['settings:footer_links_heading_desc'] = 'Lungisa izixhumanisi eziboniswa ngaphansi komsizi: isixhumanisi esizikhethelayo lokuhlelwa kwezifundo ngaphansi kwesixhumanisi sempendulo, kanye namagama esixhumanisi sempendulo nephaneli yalo.';
$string['settings:footer_courses_text'] = 'Umbhalo wesixhumanisi sezifundo';
$string['settings:footer_courses_text_desc'] = 'Umbhalo wesixhumanisi esiboniswa ngaphansi kwesixhumanisi sempendulo. Shiya kungenalutho ukufihla isixhumanisi ngokuphelele.';
$string['settings:footer_courses_url'] = 'Ikheli lesixhumanisi sezifundo';
$string['settings:footer_courses_url_desc'] = 'Indawo isixhumanisi sezifundo esiya kuyo (kuvuleka kuthebhu entsha). Isixhumanisi sifihlwa uma leli simu lingenalutho.';
$string['settings:feedback_link_label'] = 'Ilebula lesixhumanisi sempendulo';
$string['settings:feedback_link_label_desc'] = 'Ishintsha umbhalo wesixhumanisi sempendulo ngaphansi, isibonelo "Thumela imibono mayelana no-[[tutorshort]] eqenjini le-IT". Shiya kungenalutho ukusebenzisa ilebula elivamile elihunyushiwe "Impendulo".';
$string['settings:feedback_panel_intro'] = 'Isingeniso sephaneli yempendulo';
$string['settings:feedback_panel_intro_desc'] = 'Umugqa wesingeniso oboniswa ngenhla kwephaneli yempendulo. Ucacisa ukuthi imibono iya kuphi. Shiya kungenalutho ukuze kungabi khona umugqa wesingeniso.';
$string['settings:quiz_provider'] = 'Umhlinzeki womsizi wesivivinyo';
$string['settings:quiz_provider_desc'] = 'I-ID yomhlinzeki (isibonelo <code>claude</code> noma <code>openai</code>) yokwakha izivivinyo. Kumele ihambisane nomugqa owodwa kuBahlinzeki bokuqhathanisa. Shiya kungenalutho ukusebenzisa umhlinzeki wengxoxo.';
$string['settings:quiz_model'] = 'Imodeli yomsizi wesivivinyo';
$string['settings:quiz_model_desc'] = 'Igama lemodeli yokwakha izivivinyo, isibonelo <code>claude-haiku-4-5</code>. Kumele ligcwaliswe leli simu nomhlinzeki ukuze ukushintsha kusebenze.';
$string['settings:branding_heading'] = 'Ubunikazi bomkhiqizo';
$string['settings:branding_heading_desc'] = 'Lungisa igama nokubukeka komsizi.';
$string['settings:institution_short_name'] = 'Igama elifushane lesikhungo';
$string['settings:institution_short_name_desc'] = 'Igama elinciphisiwe lesikhungo lezinto zesixhumi ezinesikhala esincane (isibonelo "State U").';
$string['settings:display_name'] = 'Igama eliboniswayo lomsizi';
$string['settings:display_name_desc'] = 'Igama eliphelele lomsizi we-AI, njengoba livela ekubingelelweni nasesikrinini sokwamukela (isibonelo "Umsizi Wokufunda Ku-inthanethi").';
$string['settings:short_name'] = 'Igama elifushane lomsizi';
$string['settings:short_name_desc'] = 'Igama elifushane elisetshenziswa kubha yesihloko nezinto zesixhumi ezinesikhala esincane (isibonelo "Umsizi").';
$string['settings:welcome_message'] = 'Umyalezo wesikrini sokwamukela';
$string['settings:welcome_message_desc'] = 'Umyalezo oboniswa esikrinini sokwamukela ekuvakasheni kokuqala. Sebenzisa <code>{{firstname}}</code> igama lomfundi kanye no-<code>{{coursename}}</code> igama lesifundo. Shiya kungenalutho ukuze kube umbhalo ovamile.';
$string['settings:chat_greeting'] = 'Ukubingelela kwengxoxo';
$string['settings:chat_greeting_desc'] = 'Umyalezo wokubingelela oboniswa lapho iwindi lengxoxo livulwa. Sebenzisa <code>{{firstname}}</code> igama lomfundi kanye no-<code>{{coursename}}</code> igama lesifundo. Shiya kungenalutho ukuze kube umbhalo ovamile.';
$string['settings:customavatars'] = 'Ama-avatar azenzelwe';
$string['settings:customavatars_desc'] = 'Layisha izithombe ze-PNG noma i-SVG eziyisikwele lapha ukuze uzengeze ohlwini lwama-avatar olungenhla. Ifayela ngalinye elilayishiwe liba ukukhetha okuvamile (elinesiqalo "Custom:"). Susa ifayela kulolu hlu ukulikhipha ohlwini oluwelayo. Ithiphu: i-PNG engu-256×256 ibonakala kahle kuzikrini ze-Retina.';
$string['settings:anomaly_digest_heading'] = 'Learning Radar — isifingqo sokungajwayelekile';
$string['settings:anomaly_digest_heading_desc'] = 'Ukuhlolwa kwansuku zonke okuqhathanisa izikhathi ezihamba zezilinganiso ezimbi, ukusetshenziswa kwamathokheni, nezinkomba zobuqotho. Lapho inkomba idlula umkhawulo omisiwe, isifingqo sithunyelwa emizileni elungisiwe. Ngemibiko ehlelwe ngombuzo ngamunye, sebenzisa iphaneli yeziHlelo ekhasini lokuhlaziya le-[[tutorshort]].';
$string['settings:anomaly_digest_enabled'] = 'Vula isifingqo sokungajwayelekile';
$string['settings:anomaly_digest_enabled_desc'] = 'Isebenzisa umsebenzi wansuku zonke wesifingqo sokungajwayelekile. Uthule ngokuvamile — usebenza kuphela lapho inkomba idlula umkhawulo.';
$string['settings:anomaly_digest_threshold_pct'] = 'Umkhawulo wesexwayiso (%)';
$string['settings:anomaly_digest_threshold_pct_desc'] = 'Ushintsho lwephesenti phakathi kwesikhathi sakuqeda nesikhathi esandulele okubangela isexwayiso. Okuvamile: 50.';
$string['settings:anomaly_digest_recipient_email'] = 'Ikheli le-imeyili lomthola';
$string['settings:anomaly_digest_recipient_email_desc'] = 'Ikheli le-imeyili elithola isifingqo sokungajwayelekile. Shiya kungenalutho ukusebenzisa ikheli lomlawuli wesizinda.';
$string['settings:anomaly_digest_slack_webhook'] = 'Ikheli le-webhook elingenayo le-Slack';
...
$string['privacy:metadata:outreach_log:dryrun'] = 'Ukuthi umugqa ubhalwe ngemodi yokuzama (dry-run) yini (akukho i-imeyili ethunyelwe ngempela).';
$string['flashcards:starter_saved'] = 'Kulondolozwe amakhadi okufunda angu-{$a} kusuka kuleli khasi.';
$string['flashcards:starter_open_review'] = 'Vula ikhasi lokubuyekeza ukuze uwafunde ngendlela yokuphindaphinda ngezikhathi ezihlukanisiwe.';
$string['flashcards:starter_failed'] = 'Angikwazanga ukwakha amakhadi okufunda kusuka kuleli khasi ({$a}). Zama futhi noma ukhethe ikhasi elinokuqukethwe okwengeziwe.';
$string['flashcards:starter_error'] = 'Angikwazi ukwakha amakhadi okufunda kusuka kuleli khasi njengamanje. Zama futhi kamuva.';
$string['soapbox:no_media_support'] = 'Le bhrawuza ayikwazi ukuqopha umsindo lapha. Sebenzisa i-Chrome, i-Edge, i-Firefox noma i-Safari yakamuva ngoxhumano oluphephile (https).';
