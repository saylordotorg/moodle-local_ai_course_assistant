...
$string['settings:embed_input_type_asymmetric'] = 'Umbuzo/idokhumenti engalingani';
$string['settings:embed_input_type_mode'] = 'Uhlobo lokufakwayo lwe-embedding';
$string['settings:embed_input_type_mode_desc'] = 'Ama-embedding e-Voyage kuphela. I-"Shared space" yenza i-embedding yemibuzo neyamadokhumenti ngendlela efanayo, ngakho lokhu kokubili kuhlala kuqhathaniseka nakuba imodeli ishintshiwe. I-"Asymmetric" isebenzisa iprojekshini yemibuzo ehlukile ye-Voyage; iyona optimization ehlongozwa ngumthengisi kodwa yehlulekile ukukhiqiza inzuzo kule khophasi izikhathi ezimbili, ngakho okuzenzakalelayo ngukwabelana ngesikhala. Ukushintsha lokhu akudingi ukwenza kabusha i-indeksi.';
$string['settings:embed_input_type_shared'] = 'I-shared space (kunconywa)';
