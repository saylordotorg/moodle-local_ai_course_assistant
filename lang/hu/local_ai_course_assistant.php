...
$string['settings:prompt_budget_mode_desc'] = 'Hogyan dől el a rendszerprompt karakterkerete. A <strong>Származtatás a modellből</strong> kiszámolja, mennyi helyet kínál valójában a beállított modell — a kontextusablakát, mínusz a fenntartott válasz és a beszélgetés előzményei —, majd ennek és az alábbi rögzített keretnek a nagyobbikát használja. Ez az ajánlott beállítás: rögzített számot már kétszer határoztak meg egyetlen konfiguráció megmérésével, és kétszer bizonyult túl kicsinek egy másikban. A <strong>Rögzített</strong> kizárólag az alábbi számot használja. Saját üzemeltetésű háttérrendszer esetén inkább a háttérrendszer kontextusablakát kell megadni, amely mindig elsőbbséget élvez.';
