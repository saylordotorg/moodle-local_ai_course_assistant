...
$string['settings:rag_return_scope'] = 'Visszakeresési visszaadási hatókör';
$string['settings:rag_return_scope_desc'] = 'Mit illesszünk be minden egyes visszakeresett találathoz. A "chunk" (alapértelmezett) beilleszti az egyező, kb. 400 szavas darabot. A "window" beilleszti az egyező darabot, valamint az ugyanazon az oldalon lévő szomszédos darabokat. A "page" beilleszti azt a teljes modul-oldalt, amelyhez a találat tartozik. A window/page akkor segít, ha egy válasz egy egész oldalra terjed ki, egy nagyobb prompt árán.';
$string['settings:rag_window_size'] = 'Visszakeresési ablak mérete';
$string['settings:rag_window_size_desc'] = 'A "window" visszaadási hatókörhöz: az egyező darab mindkét oldalán beillesztendő szomszédos darabok száma. Alapértelmezett: 1.';
$string['settings:rag_parent_max_chars'] = 'Szülő szakasz korlátja (karakter)';
$string['settings:rag_parent_max_chars_desc'] = 'A kibővített window/page szakasz maximális karakterszáma. A korlátot túllépő oldalak visszaesnek egy ablakra, majd az egyetlen darabra. Alapértelmezett: 6000.';
...
$string['chat:consent_body'] = 'A(z) {$a->product} egy AI-alapú tanulási asszisztens. Az üzeneteidet és a(z) {$a->product} válaszait a(z) {$a->institution} Moodle-adatbázisában tároljuk, és a legutóbbi tíz kört egy jóváhagyott AI-modellszolgáltatónak küldjük el a kérdéseid megválaszolásához. A keresztnevedet a személyre szabás érdekében megosztjuk; semmilyen más azonosító információt nem küldünk az AI-szolgáltatónak. Ha emberi segítséget kérsz, és a kérdésedet továbbítjuk, ez a beszélgetés (a neveddel és az e-mail-címeddel együtt) megosztásra kerülhet a támogatási csapatunkkal. Bármikor letöltheted, törölheted, vagy abbahagyhatod a(z) {$a->product} használatát.';
...
$string['flashcards:title'] = 'Tanulókártyák';
$string['flashcards:link'] = 'Tanulókártyák (ismétlés most)';
$string['flashcards:intro'] = 'Időzített ismétléses gyakorlás. Fedd fel a választ, majd értékeld magad az Újra, Nehéz vagy Könnyű gombbal. A nehéznek talált kártyák hamarabb visszatérnek; a könnyűnek találtak ritkábban jönnek elő.';
$string['flashcards:question'] = 'Kérdés';
$string['flashcards:answer'] = 'Válasz';
$string['flashcards:reveal'] = 'Válasz felfedése';
$string['flashcards:again'] = 'Újra';
$string['flashcards:hard'] = 'Nehéz';
$string['flashcards:easy'] = 'Könnyű';
$string['flashcards:no_due'] = 'Most nincs mit ismételni. Készíts tanulókártyákat egy kurzusoldalról az asszisztens widgetben, vagy nézz vissza később.';
$string['flashcards:session_complete'] = 'A gyakorlás kész. Szép munka.';
$string['flashcards:disabled'] = 'A tanulókártyák nincsenek engedélyezve ebben a kurzusban.';
$string['flashcards:toggle'] = 'Tanulókártyák engedélyezése ebben a kurzusban';
$string['flashcards:toggle_help'] = 'Hozzáad egy tanulókártya-készítő indítót az asszisztens widgethez, valamint egy tanulói ismétlőoldalt a /local/ai_course_assistant/flashcards.php?courseid=X címen. Alapértelmezés szerint kikapcsolva.';
$string['flashcards:starter_generate'] = 'Tanulókártyák készítése erről az oldalról';
$string['flashcards:generated'] = '{$a} tanulókártya elmentve. Nyisd meg az ismétlőoldalt, hogy tanulhasd őket.';
...
$string['settings:current_page_content_maxchars_desc'] = 'Az aktuális oldal szövegéből a rendszerpromptba „Aktuális oldal tartalma” szakaszként beszúrt karakterek maximális száma, amikor a RAG ki van kapcsolva. Az alapértelmezett 8,000 jól megalapozza az oldalspecifikus kérdéseket, miközben keretet hagy a szerkezetnek és az utasításoknak. (Bekapcsolt RAG esetén az oldalt ehelyett saját legrelevánsabb szakaszai alapozzák meg, az aktuális oldal felé torzítva, így ez a korlát nem érvényesül.) Egy nagyon hosszú oldal az elejétől ennyi karakterre csonkolódik, így egy rendkívül hosszú oldal vége esetleg nem kerül idézésre; a RAG bekapcsolása ezt elkerüli. A költségtudatos webhelyek alacsonyabbra szoríthatják (pl. 3,000-4,000). A 500-8,000 tartományra korlátozva. Független a <code>prompt_budget_chars</code> beállítástól: ez csak az oldalszakaszt korlátozza; a keret az egész promptot korlátozza.';
...
$string['settings:prompt_budget_auto_tune'] = 'A rendszerprompt keretének napi automatikus hangolása (elavult)';
$string['settings:prompt_budget_auto_tune_desc'] = 'Elavult. Nem tesz semmit, kivéve ha a fenti keretmód <strong>Rögzített</strong>. Egy napi feladat a karakterkeretet a csonkolás figyelésével és a valaha látott legnagyobb prompt hajszolásával következtette ki. A keret levezetése a modell kontextusablakából jobban végzi ezt: nem tud oszcillálni, és nincs szüksége bemelegítő adatra. A kettő emellett ütközött is, mert a feladat írja a karakterkeretet, és bármely, az alapértéktől eltérő érték kikapcsolja a származtatott keretet. Hagyja kikapcsolva; egy későbbi kiadásban eltűnik. A javaslat továbbra is megjelenik a <a href="/local/ai_course_assistant/prompt_metrics.php">Prompt-mutatók</a> lapon.';
...
$string['comms:title'] = 'Kommunikációim';
$string['comms:desc'] = 'Válaszd ki, milyen automatikus e-maileket küldhet neked [[tutorshort]]. Alapértelmezés szerint kikapcsolva. Bármikor módosíthatod.';
$string['comms:milestones_label'] = 'Küldjön e-mailt, amikor mérföldkövet érek el (7 napos sorozat, 30 napos sorozat, kurzus befejezése).';
$string['comms:audit_log_title'] = 'Amit [[tutorshort]] küldött nekem';
$string['comms:audit_log_empty'] = '[[tutorshort]] még nem küldött neked e-mailt.';
$string['comms:memory_title'] = 'Amit [[tutorshort]] megjegyzett arról, hogyan tanulok';
$string['comms:memory_desc'] = 'Ezek a jegyzetek a [[tutorshort]] asszisztenssel folytatott csevegésedhez tartoznak, és privátak. Segítenek [[tutorshort]] számára más megközelítést választani, ha egy téma nehéz. Bármikor törölheted őket.';
$string['comms:memory_clear'] = 'Összes memóriajegyzet törlése';
$string['milestone:streak_subject'] = '{$a->days} napos sorozat a(z) {$a->coursename} kurzusban';
$string['milestone:streak_body_text'] = "Szia {\$a->firstname}!\n\n{\$a->days} napja jelensz meg egymás után a(z) {\$a->coursename} kurzusban. Az ilyen következetesség a tanulás legnehezebben megjátszható része.\n\nAmikor készen állsz, [[tutorshort]] itt van.\n\n— {\$a->institution}";
$string['milestone:completion_subject'] = 'Befejezted a(z) {$a->coursename} kurzust';
$string['milestone:completion_body_text'] = "Szia {\$a->firstname}!\n\nBefejezted a(z) {\$a->coursename} kurzust. Ez igazi teljesítmény.\n\nHa folytatnád, [[tutorshort]] segíthet kiválasztani egy kapcsolódó következő kurzust, vagy újra átnézni egy érdekesnek talált témát.\n\n— {\$a->institution}";
$string['milestone:trigger_streak7'] = '7 napos aktivitási sorozat elérve';
$string['milestone:trigger_streak30'] = '30 napos aktivitási sorozat elérve';
$string['milestone:trigger_completion'] = 'Kurzus befejezése rögzítve';
...
$string['selftest:run'] = 'Háttérrendszer önellenőrzésének futtatása';
$string['selftest:check'] = 'Ellenőrzés';
$string['selftest:status'] = 'Állapot';
$string['selftest:detail'] = 'Részlet';
$string['selftest:link'] = 'Háttérrendszer önellenőrző oldala';
$string['selftest:link_desc'] = 'Nyisd meg a <a href="{$a}">Háttérrendszer önellenőrzése</a> oldalt, hogy ellenőrizd, az AI-háttérrendszered működik-e és megfelelően van-e méretezve. Hasznos közvetlenül egy saját üzemeltetésű háttérrendszer beállítása után.';
$string['profile:title'] = 'Telepítési előbeállítások';
$string['profile:intro'] = 'Alkalmazz egy ajánlott beállításcsomagot a telepítési típusodhoz. Az értékek a normál bővítménybeállításokba kerülnek, és utána egyenként szerkeszthetők maradnak. Egy előbeállítás alkalmazása felülírja a felsorolt beállításokat.';
$string['profile:current'] = 'Utoljára alkalmazott előbeállítás: {$a}';
$string['profile:setting'] = 'Beállítás';
$string['profile:value'] = 'Érték';
$string['profile:self_hosted_small'] = 'Saját üzemeltetésű kis kontextus (egyetlen GPU, pl. A30 24GB / vLLM 8K-n)';
$string['profile:hosted_large'] = 'Üzemeltetett nagy kontextus (alapértelmezett)';
$string['profile:apply_self_hosted_small'] = 'Saját üzemeltetésű kis kontextus előbeállítás alkalmazása';
$string['profile:apply_hosted_large'] = 'Üzemeltetett nagy kontextus alapértelmezéseinek alkalmazása';
$string['profile:applied'] = 'A(z) {$a} előbeállítás alkalmazva. Az értékek most már a bővítménybeállításaidban vannak.';
$string['profile:unknown'] = 'Ismeretlen telepítési előbeállítás.';
...
$string['coursesettings:apibaseurl_rejected'] = 'Az API alap-URL-címe nem lett elmentve: nyilvános HTTPS-végpontnak kell lennie, amely megfelel az SSRF biztonsági ellenőrzésnek.';
$string['settings:escalation_intent_patterns'] = 'Eszkalációs szándék mintái';
$string['settings:escalation_intent_patterns_desc'] = 'PCRE, no delimiters. Soronként egy reguláris kifejezés; a # jellel kezdődő sorokat figyelmen kívül hagyjuk. Támogatási jegy csak akkor nyílik, ha a tanuló saját üzenete illeszkedik valamelyik mintára, így a kurzus tartalma nem válthat ki eszkalációt a tanuló nevében. Hagyja üresen a beépített alapértelmezések használatához, amelyek az angolt, valamint néhány gyakori spanyol, francia, német és portugál megfogalmazást fednek le. Azoknak a webhelyeknek, amelyek tanulói más nyelven írnak, ide kell mintákat felvenniük: az illeszkedés hiánya azt jelenti, hogy nem nyílik jegy.';
...
$string['settings:rag_min_similarity'] = 'Minimális relevancia (koszinusz)';
$string['settings:rag_min_similarity_desc'] = 'Elveti azokat a lekért szakaszokat, amelyek koszinusz-hasonlósága a kérdéshez ezen érték alatt van, így egy témán kívüli vagy szűkös kérdés kevesebb (vagy nulla) szövegrészt szúr be, ahelyett, hogy mindig Top-K-ig töltené fel gyenge találatokkal. Tartomány 0-tól 1-ig; a 0 kikapcsolja a kaput. A helyes érték az embedding modelltől függ: a 0.25 a text-embedding-3-small modellhez illik. Emelje szigorúbbá tételhez (kevesebb, témára fókuszáltabb kontextus), csökkentse megengedőbbé tételhez.';
$string['settings:rag_currentpage_boost'] = 'Aktuális oldal kiemelése';
$string['settings:rag_currentpage_boost_desc'] = 'Egy kis bónusz, amely hozzáadódik a tanuló által éppen megtekintett oldalról származó szakaszok relevanciapontszámához, így az olyan kérdések, mint a „magyarázd el ezt”, a látható oldalt részesítik előnyben, amikor a pontszámok közel vannak egymáshoz. Csak a sorrendet érinti: nem kényszerít át egy nem releváns oldalszakaszt a minimális relevancia kapun. Állítsa 0-ra a kikapcsoláshoz.';
$string['settings:history_mode'] = 'Előzmény-kiválasztási mód';
$string['settings:history_mode_desc'] = 'Hogyan választódnak ki a korábbi beszélgetési fordulók, mielőtt elküldésre kerülnének a modellnek. A <strong>Szemantikus</strong> csak az aktuális kérdéshez kapcsolódó friss fordulókat tartja meg (és mindig a legutóbbi eszmecserét), így egy elavult, témán kívüli korábbi forduló nem növeli a költséget és nem tereli félre a választ; üzenetenként egy extra embedding hívást végez. A <strong>Frissesség</strong> az utolsó „Maximális beszélgetési előzmény” párokat tartja meg a relevanciától függetlenül (a régóta fennálló viselkedés, extra hívás nélkül). Ha az embedding nem érhető el, a szemantikus mód automatikusan a frissességre vált vissza.';
$string['settings:history_mode_semantic'] = 'Szemantikus (releváns friss fordulók)';
$string['settings:history_mode_recency'] = 'Frissesség (utolsó N pár)';
$string['settings:history_semantic_minscore'] = 'Előzmény-relevancia küszöb (koszinusz)';
$string['settings:history_semantic_minscore_desc'] = 'Szemantikus előzmény módban egy korábbi forduló csak akkor marad meg, ha az aktuális kérdéshez való hasonlósága legalább ennyi (a legutóbbi eszmecsere mindig megmarad). Tartomány 0-tól 1-ig; modellfüggő. Emelje a szigorúbbá tételhez (kevesebb előzmény), csökkentse több megtartásához.';
$string['settings:history_candidates'] = 'Előzmény-jelölt ablak';
$string['settings:history_candidates_desc'] = 'Szemantikus előzmény módban csak ennyi legutóbbi pár relevanciáját pontozza a rendszer (költségkorlát). Az ennél az ablaknál régebbi párok nem kerülnek elküldésre. Tartsa ezt a „Maximális beszélgetési előzmény” értékén vagy felette.';

// v5.11.0 - v6.2.0 strings (added 2026-06-10).
$string['settings:embed_provider_voyage'] = 'Voyage AI (voyage-3.5 — ajánlott; +4 MTEB az OpenAI 3-small-hoz képest, 4× kontextus, többnyelvű)';
$string['settings:rerank_heading'] = 'RAG: Kétlépéses visszakeresés (újrarangsorolás)';
$string['settings:rerank_heading_desc'] = 'Opcionális második visszakeresési lépés: a koszinusz-hasonlóság kiválasztja a legjobb N jelölt szegmenst (alapértelmezés: 50), majd egy kereszt-kódolású újrarangsoroló minden (kérdés, szegmens) párhoz pontszámot rendel, és a legjobb K szegmens kerül a promptba. Alapértelmezés szerint kikapcsolva; ha az újrarangsoroló nincs konfigurálva vagy meghibásodik, visszaesik egylépéses koszinusz-visszakeresésre.';
$string['settings:rerank_enabled'] = 'Kétlépéses visszakeresés (Voyage rerank-2.5)';
$string['settings:rerank_enabled_desc'] = 'Bekapcsolva a RAG visszakeresés kétlépéses lesz: a koszinusz-hasonlóság visszaadja a legjobb N jelöltet (alapértelmezés: 50), majd a Voyage rerank-2.5 kereszt-kódolója mindegyiket pontozza, és a legjobb K kerül a promptba. Közzétett javulások: +15 Recall@10 vállalati szinten, +39% NDCG BEIR. ~$0,05/MTok számlázás. A <code>rerank_apikey</code> megadása szükséges (lásd alább); ha az újrarangsorolás meghibásodik vagy nincs konfigurálva, a rendszer egylépéses koszinuszra esik vissza.';
$string['settings:rerank_apikey'] = 'Rerank API-kulcs';
$string['settings:rerank_apikey_desc'] = 'Voyage AI API-kulcs a rerank-2.5-höz. Ha üresen hagyja, a fenti Beágyazási API-kulcsot használja újra (a tipikus Voyage-telepítések egy kulcsot osztanak meg a beágyazás és az újrarangsorolás között).';
$string['settings:rerank_model'] = 'Rerank-modell';
$string['settings:rerank_model_desc'] = 'Alapértelmezés: <code>rerank-2.5</code>. Újabb Voyage rerank-modellek megadhatók itt.';
...
$string['emergency:confirm_required'] = 'Kérjük, jelölje be a megerősítő jelölőnégyzetet az alrendszer letiltása előtt.';
$string['emergency:reason_placeholder'] = 'Ok (a naplóba rögzítve)';
$string['emergency:disable_button'] = 'Letiltás';
$string['emergency:restore_button'] = 'Visszaállítás';
$string['emergency:disabled_notice'] = 'A(z) „{$a->flag}" alrendszer letiltva. Érintett beállítások: {$a->touched}';
...
$string['emergency:flag_rag_desc'] = 'Letiltja a visszakeresést és az indexelést. A chat tanfolyam-tartalmi megalapozás nélkül folytatódik.';
...
$string['settings:prompt_proportions_heading_desc'] = 'Ossza fel a rendszer-prompt keretét négy részre: biztonság + azonosító, tanfolyamszerkezet, tanfolyamtartalom és aktuális oldal. A súlyok 100-ra összegződő százalékok. Az empirikusan hangolt alapértelmezések (10 / 10 / 40 / 40) a v5.6.0 súlyhangolási benchmarkból származnak; ha a szövegmezőt üresen hagyja, ezeket az alapértelmezéseket használja. Az automatikus kiemelés fordulóként állítja a felosztást attól függően, hogy egy adott oldal hatókörben van-e.';
$string['settings:prompt_section_weights'] = 'Alapszakasz-súlyok (JSON)';
$string['settings:prompt_section_weights_desc'] = 'Opcionális JSON-objektum, amely minden részt egy százalékhoz rendel. Hagyja üresen a teljesítménymért alapértelmezések (10 / 10 / 40 / 40) használatához. Példa: <code>{"safety_identity": 10, "course_structure": 10, "course_content": 40, "current_page": 40}</code>. A súlyoknak 100-ra kell összegződniük (±5%). A <code>safety_identity</code> minimum 10%, hogy a jailbreak-elhárítás és a kimeneti jelölők mindig teljes egészében beleférjenek. A <code>current_page + course_content</code> legalább 40% kell legyen, hogy a modellnek legyen elegendő anyaga. Tartományon kívüli értékek visszaesnek a teljesítménymért alapértelmezésekre; a rendszergazdák az ellenőrzést a prompt-hibakeresési napló mentés utáni megtekintésével végezhetik.';
$string['settings:prompt_context_boost_mode'] = 'Kontextus-kiemelési mód';
$string['settings:prompt_context_boost_mode_desc'] = 'Automatikus beállítás, amely az aktuális oldal szakasza felé tolja a súlyokat, ha egy adott oldal hatókörben van, illetve a tanfolyamtartalom felé, ha nincs kiválasztott oldal. A <strong>page_focus</strong> (alapértelmezett) körülbelül 15 súlypontot tolja el. Az <strong>aggressive</strong> 25 pontot tolja, és akkor a legjobb, ha a tanulók következetesen oldal-specifikus kérdéseket tesznek fel. Az <strong>off</strong> letiltja a kiemelést; a rendszergazda által beállított alapsúlyok érvényesülnek minden fordulatban, az oldalkontextustól függetlenül.';
$string['settings:prompt_context_boost_off'] = 'Ki (alapsúlyok alkalmazása minden fordulaton)';
$string['settings:prompt_context_boost_page_focus'] = 'Oldal-fókusz (alapértelmezett, ~15 pontos eltolás)';
$string['settings:prompt_context_boost_aggressive'] = 'Agresszív (~25 pontos eltolás)';
$string['settings:prompt_section_weights_coach'] = 'Coach-módus felülbírálat (JSON, opcionális)';
$string['settings:prompt_section_weights_coach_desc'] = 'Opcionális JSON-objektum, amely felülbírálja az alapszakasz-súlyokat kifejezetten az értékelt kvíz coach-módusában (amikor <code>quizmode=coach</code>). Hasznos, ha a kvízek során nehezebb <code>current_page</code> felosztást szeretne kényszeríteni anélkül, hogy a normál chatra hatással lenne. Hagyja üresen az alapsúlyok öröklésére. Ugyanazok az érvényesítési szabályok érvényesek, mint az alap beállításnál.';
$string['prompt_debug_view:title'] = 'Prompt hibakeresési naplónézegető';
$string['prompt_debug_view:subtitle'] = 'Fordulatonként összeállított rendszer-prompt + szakaszonkénti bontás + társalgási előzmények + aktuális felhasználói üzenet + melléklet-metaadatok, pontosan ahogy a modell kapta. Segítségével ellenőrizheti, hogy egy szakasz (pl. Aktuális oldalak tartalma) valóban belekerült-e a promptba, és hibakeresést végezhet a válaszminőségi problémákban SSH nélkül.';
$string['prompt_debug_view:disabled'] = 'A prompt hibakeresési naplózás jelenleg KI van kapcsolva. Nem íródnak új bejegyzések, amíg engedélyezve nem lesz.';
$string['prompt_debug_view:enable_link'] = 'Nyissa meg a bővítmény beállításait az „Összeállított rendszer-prompt naplózása fájlba" lehetőség engedélyezéséhez.';
$string['prompt_debug_view:no_log_yet'] = 'Még nincs naplófájl. A hibakeresési napló engedélyezése után küldjön legalább egy chat-fordulatot; a fájl az első írásakor jön létre.';
$string['prompt_debug_view:empty'] = 'A naplófájl létezik, de üres. Küldjön egy chat-fordulatot, és frissítsen.';
$string['prompt_debug_view:file_status'] = 'Naplófájl mérete';
$string['prompt_debug_view:showing'] = 'Legújabb bejegyzések megjelenítése (legújabb elöl), limit';
$string['prompt_debug_view:total'] = 'Teljes prompt';
$string['prompt_debug_view:budget'] = 'Keret rögzítéskor';
$string['prompt_debug_view:sections'] = 'Szakaszok (kategória szerint)';
$string['prompt_debug_view:assembled_prompt'] = 'Összeállított rendszer-prompt';
$string['prompt_debug_view:history'] = 'A modellnek elküldött társalgási előzmények';
$string['prompt_debug_view:current_message'] = 'Aktuális felhasználói üzenet';
$string['prompt_debug_view:attachment'] = 'Melléklet-metaadatok';
$string['prompt_debug_view:show_more'] = 'További bejegyzések megjelenítése';
...
$string['settings:premium_escalation_provider_desc'] = 'A prémium hívások útválasztásához használt szolgáltatói azonosító. Egyeznie kell az összehasonlító szolgáltatók egy sorával (hogy az API-kulcs, az alap-URL és a hőmérséklet ugyanonnan érkezzen, ahol a rendszergazdák már kezelik). Alapértelmezés: <code>claude</code>.';
$string['settings:premium_escalation_model'] = 'Prémium modell';
$string['settings:premium_escalation_model_desc'] = 'A prémium szolgáltatónak átadott modellnév. Alapértelmezés: <code>claude-sonnet-5</code> az A.10 bake-off döntése alapján.';
$string['settings:premium_escalation_triggers'] = 'Prémium aktiválási regex-ek';
$string['settings:premium_escalation_triggers_desc'] = 'Soronként egy PCRE regex (határolójelek nélkül; a kis- és nagybetűktől független egyezés automatikusan érvényes). A #-tel kezdődő sorok megjegyzések. Hagyja üresen az A.10 bake-offból összeállított alapértelmezett készlet használatához (többlépéses STEM-jelzők: „derive", „prove that", „step by step", LaTeX-matematika, bekerített kódblokkban, big-O, integrálok, optimalizálás stb.).';
$string['settings:premium_escalation_course_tags'] = 'Prémium tanfolyam-engedélyezési lista';
$string['settings:premium_escalation_course_tags_desc'] = 'Soronként egy tanfolyam-rövid-nevet vagy azonosítószám-előtagot. Az egyező tanfolyamokban minden fordulat automatikusan eszkalál az üzenet regex-étől függetlenül (használja olyan STEM-nehéz tanfolyamoknál, ahol az eszkaláció legyen az alapértelmezés). Az egyezés kis- és nagybetűktől független előtag-egyezés — a „MATH" egyezik a MATH121, MATH205 stb. elemekkel.';
...
$string['analytics:exp_heading'] = 'A/B kísérlet összehasonlítása';
$string['analytics:exp_desc'] = 'Hasonlítsa össze az elkötelezettséget két tanfolyam között a kiválasztott időszakban. Tanfolyamonkénti kísérletekhez készült (például az avatar animációs szonda): helyezze a felülírást az egyik tanfolyamba, hagyja a másikat kontrollként, és olvassa el itt a különbséget.';
$string['analytics:exp_course_a'] = 'A tanfolyam';
$string['analytics:exp_course_b'] = 'B tanfolyam';
$string['analytics:exp_compare'] = 'Összehasonlítás';
...
$string['analytics:exp_avg_msgs_session'] = 'Átlagos üzenetek munkamenetenként';
$string['analytics:exp_avg_session_minutes'] = 'Átlagos munkamenet hossza (perc)';
...
$string['privacy:metadata:local_ai_course_assistant_practice_scores:session_meta'] = 'A munkamenethez megadott opcionális metaadatok, például egy Soapbox beszéd neve, témája és célhossza. Soha nem tartalmaz hangfelvételt vagy átiratot.';
$string['pedagogy:soapbox'] = 'A Soapbox beszédvisszajelzés alapértelmezetten bekapcsolva';
$string['pedagogy:soapbox_desc'] = 'Ha be van kapcsolva, a Soapbox beszédgyakorló eszköz minden kurzusban elérhető, kivéve, ha a kurzusnak saját felülbírálása van. Hagyja kikapcsolva, és csak azokban a kurzusokban engedélyezze, amelyeknek szükségük van rá (jellemzően beszéd- és kommunikációs kurzusok).';
$string['settings:soapbox_stt_mode'] = 'Soapbox átírási mód';
$string['settings:soapbox_stt_mode_desc'] = 'Hogyan alakítja a Soapbox a felvett beszédet szöveggé. A Szerver a beállított Whisper szolgáltatót használja (a saját üzemeltetésű ingyenes; a felhőalapú OpenAI körülbelül 0,006 USD percenként). A Böngésző a tanuló beépített beszédfelismerését használja (ingyenes, nincs szükség szerverre, csak Chrome és Safari böngészőben működik). A Szerver használata ajánlott, hogy az átírás minősége ne függjön a tanuló böngészőjétől.';
$string['settings:soapbox_stt_mode_server'] = 'Szerver (Whisper szolgáltató)';
$string['settings:soapbox_stt_mode_browser'] = 'Böngésző (ingyenes, nincs szükség szerverre)';
$string['soapbox:title'] = 'Soapbox';
$string['soapbox:link'] = 'Soapbox beszédgyakorlás';
$string['soapbox:disabled'] = 'A Soapbox nincs engedélyezve ehhez a kurzushoz.';
$string['soapbox:intro'] = 'Mondjon el egy beszédet, és kapjon visszajelzést. Megadhat egy nevet, témát és célhosszt, majd vegye fel magát beszéd közben. A Soapbox átírja a beszédét, egy beszédértékelési szempontrendszer alapján pontozza, és konkrét tippeket ad. A hangfelvételt és az átiratot soha nem tároljuk, csak a pontszámokat és a visszajelzéseket.';
$string['soapbox:optional'] = 'opcionális';
$string['soapbox:name_label'] = 'Nevezze el ezt a beszédet';
$string['soapbox:topic_label'] = 'Téma';
$string['soapbox:time_label'] = 'Célhossz';
$string['soapbox:no_target'] = 'Nincs cél';
$string['soapbox:record'] = 'Beszéd felvétele';
$string['soapbox:stop'] = 'Leállítás';
$string['soapbox:recording'] = 'Felvétel folyamatban. Beszéljen természetesen; kattintson a leállításra, amikor végzett.';
$string['soapbox:transcribing'] = 'A beszéd átírása folyamatban…';
$string['soapbox:scoring'] = 'A beszéd pontozása folyamatban…';
$string['soapbox:too_short'] = 'Ez a felvétel túl rövid volt a pontozáshoz. Próbáljon meg legalább egy-két mondatot, és próbálja újra.';
$string['soapbox:mic_denied'] = 'A felvételhez mikrofon-hozzáférés szükséges. Engedélyezze a mikrofon-hozzáférést, és próbálja újra.';
$string['soapbox:no_browser_stt'] = 'Ez a böngésző nem támogatja a böngészőn belüli beszédfelismerést. Próbálja meg a Chrome vagy a Safari böngészőt, vagy kérje meg a rendszergazdát, hogy állítsa át a Soapboxot szerveroldali átírásra.';
...
$string['soapbox:tips_heading'] = 'Tippek a következő alkalomra';
$string['soapbox:col_criterion'] = 'Szempont';
$string['soapbox:col_score'] = 'Pontszám';
$string['soapbox:col_feedback'] = 'Visszajelzés';
$string['soapbox:history_heading'] = 'Beszédeim';
$string['soapbox:history_empty'] = 'Még nem vett fel beszédet. Vegyen fel egyet fent, hogy elkezdje építeni az előzményeit.';
$string['soapbox:untitled'] = 'Cím nélküli beszéd';
...
$string['cachedef_ratelimit'] = 'Felhasználónkénti kéréssebesség-korlátozás';
$string['cachedef_uistate'] = 'Munkamenetenkénti felületi kapcsolók (megtekintés diákként, valódi nevek felfedése)';
$string['benchmark:pagetitle'] = 'Szolgáltató-teljesítménymérés';
$string['benchmark:intro'] = 'Egy rögzített, jellemző kérdéskészletet küld minden beállított AI-szolgáltatónak, rögzíti a token-felhasználást, a költséget és a késleltetést, majd képességenként ajánl egy szolgáltatót. Minden futtatás valós API-hívásokat végez, ezért egy futtatás nagyjából 5–20 centbe kerül attól függően, hány szolgáltató van beállítva.';
$string['cachedef_systemprompt'] = 'Összeállított AI-rendszerprompt (kurzusonként)';
$string['cachedef_remoteconfig'] = 'A frissítési csatornáról lekért távoli konfiguráció';
$string['cachedef_spend'] = 'Időszakonkénti AI-költés összegek a költésőr számára';
$string['cachedef_failover_circuit'] = 'A szolgáltató-átkapcsolás megszakítójának állapota';
$string['settings:rag_scope'] = 'Visszakeresési hatókör';
$string['settings:rag_scope_desc'] = 'Amikor a tanuló egy adott dokumentumot néz (oldalt, könyvet vagy PDF-et), meghatározza, hogy a visszakeresés az adott dokumentumra korlátozódjon-e. A <b>Dokumentum-elsőbbség</b> az aktuális dokumentumra alapozza a választ, ha annak vannak releváns részletei, egyébként a teljes kurzusra tér vissza. A <b>Csak dokumentum</b> soha nem tér vissza: ha az aktuális dokumentumnak nincs releváns részlete, semmit sem keres vissza, így a segítő inkább általános tudásból válaszol, mintsem nem kapcsolódó oldalakat idézne. A <b>Kurzus-szintű</b> a teljes kurzustartalomban keres (az aktuális oldal továbbra is megkapja a fenti sorrendi kiemelést). A Dokumentum-elsőbbség ajánlott, így egy, a tanuló által éppen olvasott oldalról szóló válasz arra az oldalra alapozódik.';
$string['settings:rag_scope_document_first'] = 'Dokumentum-elsőbbség (előnyben részesíti az aktuális dokumentumot, visszatér a kurzusra)';
$string['settings:rag_scope_document_only'] = 'Csak dokumentum (az aktuális dokumentumra korlátozódik)';
$string['settings:rag_scope_course'] = 'Kurzus-szintű (a teljes kurzustartalomban keres)';
$string['ragadmin:no_content_documents'] = '{$a->count} dokumentum nem tartalmazott indexelhető szöveget, és nem lett feldarabolva (általában többségében beágyazott vagy nagyon rövid oldalak): {$a->titles}. Ha ezek közül bármelyiknek kereshetőnek kellene lennie, adjon hozzá oldalon lévő szöveget vagy átiratot, majd indexelje újra.';
$string['privacy:metadata:sbx_rec'] = 'Soapbox előadás-felvételek. A médiaobjektum a megőrzési időszak után törlődik; az átirat visszajelzés és hozzáférési kérelmek céljából megmarad.';
$string['privacy:metadata:sbx_rec:userid'] = 'A felvételt készítő tanuló.';
$string['privacy:metadata:sbx_rec:transcript'] = 'A felvétel beszéd-szöveg átirata.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'A felvétel hossza másodpercben.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'A felvétel elkészítésének időpontja.';
$string['privacy:metadata:ai_provider'] = 'A tanári válaszok generálásához a tanuló által írt tartalom elküldésre kerül a webhely vagy a kurzus rendszergazdája által beállított AI-szolgáltatónak.';
$string['privacy:metadata:ai_provider:message'] = 'Az üzenet szövege és a mellékletek, amelyeket a tanuló az AI-oktatónak küld.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'A válasz megalapozásához mellékelt kurzus- és tevékenységkörnyezet (például a kurzus neve és az aktuális oldal).';
$string['privacy:metadata:voice_provider'] = 'Hangbemenet vagy -kimenet használatakor a hang és a szöveg elküldésre kerül a beállított beszéd-szöveg / szöveg-beszéd szolgáltatónak.';
$string['privacy:metadata:voice_provider:audio'] = 'A tanuló beszédéről készült hangfelvétel, átírás céljából elküldve.';
$string['privacy:metadata:voice_provider:text'] = 'A szolgáltatónak beszéddé alakítás céljából elküldött szöveg.';
$string['privacy:metadata:zendesk'] = 'Ha az emberi ügyfélszolgálati továbbítás engedélyezett, és a tanuló hozzájárul, elérhetőségi adatai és üzenete elküldésre kerül a Zendesk rendszerbe egy ügyfélszolgálati jegy megnyitásához.';
$string['privacy:metadata:zendesk:name'] = 'A tanuló teljes neve, az ügyfélszolgálati kérelmet benyújtó azonosítására.';
$string['privacy:metadata:zendesk:email'] = 'A tanuló e-mail-címe, az ügyfélszolgálati kérelemre való válaszadáshoz.';
$string['privacy:metadata:zendesk:message'] = 'Az üzenet vagy beszélgetés tartalma, amelyet a tanuló továbbításra kiválasztott.';
...
$string['analytics_js:ai_users'] = 'AI-felhasználók';
$string['analytics_js:non_users'] = 'Nem felhasználók';
$string['analytics_js:thumbs_up'] = 'Tetszik';
$string['analytics_js:thumbs_down'] = 'Nem tetszik';
$string['analytics_js:hallucination_flags'] = 'Hallucinációjelzések';
$string['analytics_js:avg_star_rating'] = 'Átlagos csillagos értékelés';
$string['analytics_js:avg_msgs_resolution'] = 'Átlagos üzenetszám a megoldásig';
$string['analytics_js:survey_respondents'] = 'Felmérés válaszadói';
$string['analytics_js:messages'] = 'Üzenetek';
$string['analytics_js:students'] = 'Diákok';
$string['analytics_js:frequency'] = 'Gyakoriság';
$string['analytics_js:responses'] = 'Válaszok';
$string['analytics_js:error_loading'] = 'Hiba az adatok betöltésekor';
$string['analytics_js:loading'] = 'Elemzések betöltése...';
$string['analytics_js:no_course_data'] = 'Nincs elérhető kurzusadat.';
$string['analytics_js:no_unit_data'] = 'Még nincs egységadat. Az egységkövetés akkor gyűlik, ahogy a diákok használják a segítőt.';
$string['analytics_js:no_keyword_data'] = 'Ehhez az időszakhoz nincs elérhető kulcsszóadat.';
$string['task:soapbox_cleanup'] = 'Soapbox felvételek megőrzése és tisztítása';
$string['admin:vendor_dpa:col_provider'] = 'Szolgáltató';
$string['admin:vendor_dpa:col_optout'] = 'Betanítási letiltás';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Megőrzés';
$string['admin:vendor_dpa:col_tier'] = 'Szint felső korlátja';
$string['admin:vendor_dpa:col_link'] = 'Hivatkozás';
$string['admin:vendor_dpa:vendor_terms'] = 'Szállítói feltételek';
$string['admin:vendor_dpa:tier'] = '{$a}. szint';
$string['admin:vendor_dpa:too_contractual'] = 'Szerződéses (letiltva)';
$string['admin:vendor_dpa:too_default_on'] = 'Alapértelmezetten be';
$string['admin:vendor_dpa:too_none'] = 'Nincs letiltási lehetőség';
$string['admin:vendor_dpa:too_local'] = 'Helyi (nincs szállító)';
$string['admin:vendor_dpa:too_unknown'] = 'Még nem ellenőrizve';
$string['admin:vendor_dpa:dpa_signed'] = 'Aláírva';
$string['admin:vendor_dpa:dpa_available'] = 'Elérhető';
$string['admin:vendor_dpa:dpa_negotiating'] = 'Egyeztetés alatt';
$string['admin:vendor_dpa:dpa_not_offered'] = 'Nem kínált';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'N/A';
$string['admin:vendor_dpa:dpa_unknown'] = 'Ismeretlen';
$string['settings:soapbox_slide_vision'] = 'Soapbox diavizuáldesign-visszajelzés';
$string['settings:soapbox_slide_vision_desc'] = 'Egyetlen vizuális áttekintés engedélyezése a megjelenített diaképeken, hogy rövid vizuáldesign-megjegyzést fűzzön egy értékelt előadáshoz. Alapértelmezetten kikapcsolva és adatvédelem-tudatos: nem tárol képeket, és minden feladatnak külön be kell kapcsolnia a saját Diavizuáldesign-visszajelzés jelölőnégyzetével. Csak a feltöltött diakészlettel rendelkező diaelőadásokat érinti.';
$string['settings:soapbox_vision_provider'] = 'Soapbox diavízió-szolgáltató';
$string['settings:soapbox_vision_provider_desc'] = 'A diavízió-áttekintéshez használt szolgáltató. Alapértelmezés szerint openai. Vízióképes, API-kulccsal beállított szolgáltatónak kell lennie (a kurzus szolgáltatóján vagy az összehasonlító szolgáltatók listáján keresztül).';
$string['settings:soapbox_vision_model'] = 'Soapbox diavízió-modell';
$string['settings:soapbox_vision_model_desc'] = 'Vízióképes modell a diavízió-áttekintéshez. Alapértelmezés szerint gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'Diadizájn:';
$string['soapbox:assign_manage'] = 'Soapbox előadás-feladatok';
$string['soapbox:copy_link'] = 'Diáklink';
$string['soapbox:deck_label'] = 'Diák (PDF). Töltse fel a diakészletét, majd léptesse a diákat felvétel közben.';
$string['soapbox:slide_prev'] = 'Előző dia';
$string['soapbox:slide_next'] = 'Következő dia';
$string['soapbox:play_slides'] = 'Lejátszás diákkal';
$string['soapbox:audio_ready'] = 'Csak hang. A mikrofonja rögzítésre kerül; a kamerája nem lesz használva.';
$string['soapbox:audio_recording'] = 'Hang rögzítése...';
$string['soapbox:cap_reached'] = 'Elérte a felvételek maximális számát ehhez a feladathoz.';
$string['soapbox:storage_unconfigured'] = 'A felvételtárolás még nincs beállítva. Kérjük, lépjen kapcsolatba a rendszergazdával.';
$string['soapbox:bad_key'] = 'Ez a feltöltés nem az öné.';
$string['soapbox:slides_disabled'] = 'A diák nincsenek engedélyezve ehhez a feladathoz.';
$string['soapbox:upload_missing'] = 'A feltöltés nem található. Kérjük, próbálja meg újra a felvételt.';
$string['soapbox:mode_label'] = 'Előadás típusa';
$string['soapbox:mode_informative'] = 'Tájékoztató (magyarázat vagy tanítás)';
$string['soapbox:mode_persuasive'] = 'Meggyőző (rábeszélés)';
$string['soapbox:err_provider'] = 'Az AI-értékelő szolgáltatás nem érhető el. Kérjük, próbálja újra egy pillanat múlva.';
$string['soapbox:err_parse'] = 'Az AI váratlan választ adott. Kérjük, próbálja újra.';
$string['soapbox:err_disabled'] = 'A beszédgyakorlás nincs engedélyezve ehhez a kurzushoz.';
$string['soapbox:err_transcribe'] = 'A felvételét nem sikerült átírni. Kérjük, próbálja újra, és ellenőrizze, hogy a mikrofonja működik-e.';
$string['settings:outcomes_benchmark_default'] = 'Tanulási eredmény referenciaértéke (százalék)';
$string['settings:outcomes_benchmark_default_desc'] = 'Az intézmény által beállított referenciaérték a tanulási eredmények jelentéséhez: egy diák akkor teljesít egy tanulási eredményt, ha az elsajátítottsága eléri vagy meghaladja ezt a százalékot. Ez a jelentési szabvány (különbözik a coaching elsajátítási küszöbtől). Alapértelmezés 70.';
$string['outcomes:title'] = 'Tanulási eredmények jelentése';
$string['outcomes:intro'] = 'Minden kurzus tanulási eredményéhez a referenciaérték és az azt elérő vagy meghaladó, értékelt diákok százalékos aránya. A webhely referenciaértéke {$a}%.';
$string['outcomes:none'] = 'Ehhez a kurzushoz még nincsenek tanulási eredmények meghatározva.';
$string['outcomes:export'] = 'CSV exportálása';
$string['outcomes:col_outcome'] = 'Tanulási eredmény';
$string['outcomes:col_benchmark'] = 'Referenciaérték';
$string['outcomes:col_assessed'] = 'Értékelt diákok';
$string['outcomes:col_met'] = 'Referenciaértéket elérte';
...
$string['soapbox:present_audio'] = 'Hangos előadás';
$string['soapbox:present_video'] = 'Videós előadás';
$string['soapbox:present_target'] = 'cél {$a->min}-{$a->max} perc';
$string['soapbox:choose_topic'] = 'Válassz témát';
$string['soapbox:record_short'] = 'Felvétel';
$string['soapbox:my_recordings'] = 'Felvételeim';
$string['soapbox:no_recordings'] = 'Még nincsenek felvételek.';
$string['soapbox:col_recorded'] = 'Rögzítve';
$string['soapbox:col_length'] = 'Hossz';
$string['soapbox:col_type'] = 'Típus';
$string['soapbox:col_recording'] = 'Felvétel';
$string['soapbox:col_kept'] = 'Megőrizve';
$string['soapbox:col_student_link'] = 'Hallgatói hivatkozás';
$string['soapbox:view_download'] = 'Megtekintés / letöltés';
$string['soapbox:expired'] = 'Lejárt';
$string['soapbox:retention_note'] = 'A felvételek {$a} napig tekinthetők meg és tölthetők le, utána automatikusan törlődnek.';
$string['soapbox:assign_title'] = 'Soapbox feladatok';
$string['soapbox:assign_single_title'] = 'Soapbox feladat';
$string['soapbox:assign_add'] = 'Feladat hozzáadása';
$string['soapbox:assign_none'] = 'Még nincsenek Soapbox feladatok.';
$string['soapbox:assign_deleted'] = 'A feladat törölve.';
$string['soapbox:assign_updated'] = 'A feladat frissítve.';
$string['soapbox:assign_created'] = 'A feladat létrehozva.';
...
$string['settings:hidden_categories'] = 'Rejtett kurzuskategóriák';
$string['settings:hidden_categories_desc'] = 'Azon kurzuskategóriák nevének vagy azonosítójának vesszővel elválasztott listája, ahol az asszisztens ne jelenjen meg. Például: "Kurzusfejlesztés, 42". Az asszisztens automatikusan rejtve marad akkor is, ha a szerkesztés mód be van kapcsolva.';
$string['settings:provider_heading'] = 'MI-szolgáltató és beszélgetés';
$string['settings:provider_heading_desc'] = 'Az MI-platform, a modell és a beszélgetési viselkedés beállítása.';
...
$string['settings:enable_thinking_desc'] = 'Bekapcsolja az alkalmazkodó gondolkodást a Claude-modelleknél. A Claude maga dönti el, mikor és mennyit gondolkodik egy feladaton, mielőtt válaszol. Javítja az összetett kérdésekre adott válaszok pontosságát, de növeli a tokenfelhasználást és a késleltetést. A gondolkodás tartalma nem jelenik meg a tanulóknak. A többi szolgáltató figyelmen kívül hagyja ezt a beállítást.';
$string['settings:rag_sources_heading'] = 'RAG-tartalomforrások';
$string['settings:rag_sources_heading_desc'] = 'Válassza ki, milyen kurzustartalom-típusokból nyerjen ki szöveget a RAG-indexelő. A <a href="{$a}">RAG adminisztrációs oldal</a> állapotjelzői mutatják, hogy az egyes kinyerőknek megvan-e minden szükséges feltétele (például a pdftotext program vagy a Cloudflare-engedélyezőlista).';
$string['settings:rag_extract_pdf'] = 'PDF-fájlok indexelése (mod_resource)';
$string['settings:rag_extract_pdf_desc'] = 'Szöveget nyer ki a feltöltött PDF-fájlokból a <code>pdftotext</code> (poppler) programmal. A program elérési útja automatikusan felismerésre kerül; szükség esetén alább adja meg.';
$string['settings:rag_pdftotext_path'] = 'A pdftotext program elérési útja';
$string['settings:rag_pdftotext_path_desc'] = 'Hagyja üresen az automatikus felismeréshez (megnézi a <code>/usr/bin/pdftotext</code> és <code>/usr/local/bin/pdftotext</code> helyeket, valamint a <code>which pdftotext</code> eredményét). Csak akkor töltse ki, ha a telepítés máshol található.';
$string['settings:rag_extract_docx'] = 'DOCX-fájlok indexelése (mod_resource)';
$string['settings:rag_extract_docx_desc'] = 'Szöveget nyer ki a feltöltött Word-dokumentumokból a PHP ZipArchive segítségével. Nincs szükség külső függőségre.';
$string['settings:rag_extract_pptx'] = 'PPTX-fájlok indexelése (mod_resource)';
$string['settings:rag_extract_pptx_desc'] = 'Szöveget nyer ki a feltöltött modern PowerPoint-bemutatókból a PHP ZipArchive segítségével. Végigmegy a diák és az előadói jegyzetek XML-jén dia sorrendben; nincs szükség külső függőségre. A régi bináris <code>.ppt</code> fájlok nem támogatottak — mentse újra ezeket a bemutatókat <code>.pptx</code> formátumban.';
$string['settings:rag_extract_h5p'] = 'H5P-tartalom indexelése (mod_h5p)';
$string['settings:rag_extract_h5p_desc'] = 'Végigmegy a H5P-tartalom JSON-adatain, és minden szöveget tartalmazó mezőt indexel (kérdések, válaszok, visszajelzések, leírások). A H5P-tartalomtípusok metaadatai tágak, ezért határesetekben előfordulhat néhány téves találat.';
$string['settings:rag_extract_scorm'] = 'SCORM-csomagok indexelése (mod_scorm)';
$string['settings:rag_extract_scorm_desc'] = 'Kicsomagolja a SCORM-csomagokat, és indexeli az <code>imsmanifest.xml</code> fájlt, az összes <code>.html</code> fájlt, valamint az Articulate Storyline szöveges karakterláncait. <strong>Alapértelmezés szerint kikapcsolva</strong>, mert a SCORM-feldolgozás költséges lehet. A csomagméret felső határát a <code>rag_scorm_max_mb</code> szabja meg.';
$string['settings:rag_scorm_max_mb'] = 'Az indexelendő SCORM-csomag legnagyobb mérete (MB)';
$string['settings:rag_scorm_max_mb_desc'] = 'Az ennél nagyobb SCORM-csomagokat kihagyja a túlzott memóriahasználat elkerülése érdekében.';
$string['settings:rag_fetch_transcripts'] = 'Átiratok letöltése a beágyazott videókhoz és interaktív tartalmakhoz';
$string['settings:rag_fetch_transcripts_desc'] = 'Végignézi a mod_page és mod_book tartalmát beágyazott iframe-ekért (Synthesia, YouTube, Articulate, Genially), és letölti az egyes beágyazásokhoz tartozó átirat URL-címét (a keret fölött és alatt is keres). Kimenő HTTPS-kapcsolatot igényel erről a kiszolgálóról az átiratok kiszolgálója felé. <strong>Alapértelmezés szerint kikapcsolva</strong>; akkor kapcsolja be, ha az átiratokat kiszolgáló fél már felvette ezt a kiszolgálót az engedélyezőlistájára (például IP-alapú Cloudflare-szabállyal).';
$string['settings:rag_iframe_host_patterns'] = 'Iframe-kiszolgálók mintái';
...
$string['settings:max_content_per_resource_desc'] = 'Az egyes oldalakból vagy könyvfejezetekből kinyert tartalom legnagyobb karakterszáma. A kisebb érték csökkenti a prompt méretét és gyorsítja a válaszokat.';
$string['settings:max_total_content'] = 'Legnagyobb összes tartalom (karakter)';
$string['settings:max_total_content_desc'] = 'A rendszerpromptba bekerülő kurzustartalom legnagyobb összes karakterszáma. A kisebb érték csökkenti a prompt méretét és gyorsítja a válaszokat.';
$string['settings:spend_guard_heading'] = 'Költségvédelem és optimalizáló';
$string['settings:spend_guard_heading_desc'] = 'Állítson be időszakonkénti LLM-költségkeretet. A keret elérésekor a [[tutorshort]] felfüggeszti a kéréseket, vagy a tartaléklánc egy olcsóbb szolgáltatójára vált. Az aktuális költések és az optimalizáló javaslatai a <a href="{$a}">Tokenköltség oldalon</a> találhatók.';
$string['settings:spend_cap_period'] = 'Költségkeret időszaka';
$string['settings:spend_cap_period_desc'] = 'Milyen gyakran áll vissza a költségkeret. Naptárhoz igazodik: a havi a hónap 1. napján, a heti hétfőn, a napi éjfélkor indul.';
$string['settings:spend_cap_site'] = 'Webhelyszintű költségkeret (USD)';
$string['settings:spend_cap_site_desc'] = 'Összesített keret USD-ben az összes kurzusra és funkcióra az aktuális időszakban. <code>0</code> = korlátlan. Az alábbi funkciónkénti keretek felülbírálják, ha be vannak állítva.';
$string['settings:spend_cap_chat'] = 'Csevegési keret (USD)';
$string['settings:spend_cap_chat_desc'] = 'Keret kizárólag a tanulói csevegésre és tesztekre. <code>0</code> = a webhelyszintű keret érvényes.';
$string['settings:spend_cap_voice'] = 'Hangkeret (USD)';
$string['settings:spend_cap_voice_desc'] = 'Keret a hangfunkciókra (Realtime + TTS + STT). A hang jellemzően a legnagyobb költségtétel — ezt korlátozza először.';
$string['settings:spend_cap_rag'] = 'RAG-keret (USD)';
$string['settings:spend_cap_rag_desc'] = 'Keret a kurzusindexelés során végzett beágyazási hívásokra.';
$string['settings:spend_cap_analytics'] = 'Elemzési keret (USD)';
$string['settings:spend_cap_analytics_desc'] = 'Keret az adminisztrátori Learning Radar lekérdezésekre.';
$string['settings:spend_failover_chain'] = 'Tartaléklánc';
$string['settings:spend_failover_chain_desc'] = 'Ha egy keret betelik, a [[tutorshort]] sorrendben megpróbálja ezeket a szolgáltatókat. Soronként egy bejegyzés, <code>capability:label</code> formában. A címkék az Összehasonlító szolgáltatók (a <code>chat</code> / <code>analytics</code> esetén) vagy a Hangszolgáltatók (a <code>voice</code> esetén) bejegyzéseire hivatkoznak. A <code>#</code> jellel kezdődő sorok megjegyzések. Például:<br><code>chat:claude-haiku<br>chat:ollama-local<br>voice:openai-prod<br>analytics:deepseek</code>';
$string['settings:failover_per_call_enabled'] = 'Hívásonkénti átváltás (v5.5.0)';
$string['settings:failover_per_call_enabled_desc'] = 'Bekapcsolva minden csevegési hívás az elsődleges szolgáltatót egy tartalékláncot kezelő burkolóba csomagolja. Ha egy hívás időtúllépéssel vagy 5xx hibával jár, a [[tutorshort]] a fenti <strong>tartaléklánc</strong> következő bejegyzésére vált, és 15 percre megszakítja a hibás szolgáltatóhoz vezető kört. Minden átváltás naplósort ír (<code>failover_fallthrough</code>); bekapcsolás után nézze meg az Adminisztráció -> [[tutorshort]] -> Naplózás oldalt, hogy meggyőződjön a lánc működéséről. Alapértelmezés szerint kikapcsolva; csak azután kapcsolja be, hogy a lánc ellenőrzött, és az intézménye megerősítette, hogy a lánc minden szolgáltatójára megvannak a szükséges adatkezelési megállapodások.';
$string['settings:failover_timeout_chat'] = 'Átváltás: csevegési időtúllépés (másodperc)';
$string['settings:failover_timeout_chat_desc'] = 'Mennyi ideig várjon egy csevegési szolgáltató első tokenjére az átváltás előtt. Alapérték 8 mp. A kisebb érték gyorsabban vált el a lassú szolgáltatóktól, cserébe több téves riasztást okoz átmenetileg lassú kéréseknél; a nagyobb érték tovább tartja a láncot az elsődleges szolgáltatónál. Csak akkor számít, ha a <strong>hívásonkénti átváltás</strong> be van kapcsolva.';
$string['settings:spend_notify_emails'] = 'Költségriasztások címzettjei';
$string['settings:spend_notify_emails_desc'] = 'Vesszővel elválasztott e-mail-címek, amelyek értesítést kapnak a keret 80%-ánál, 95%-ánál és 100%-ánál. Hagyja üresen az összes webhely-adminisztrátor értesítéséhez.';
$string['settings:opt_cost_weight'] = 'Optimalizáló: költségsúly';
$string['settings:opt_cost_weight_desc'] = 'Mennyire vegye figyelembe az optimalizáló a költséget a szolgáltatók rangsorolásakor. A 0.0 figyelmen kívül hagyja a költséget, az 1.0 kizárólag költség szerint optimalizál. A minőségsúllyal együtt érvényesül.';
$string['settings:opt_quality_weight'] = 'Optimalizáló: minőségsúly';
$string['settings:opt_quality_weight_desc'] = 'Mennyire vegye figyelembe az optimalizáló a tanulói elégedettséget (a pozitív visszajelzések aránya) a szolgáltatók rangsorolásakor. A 0.0 figyelmen kívül hagyja a minőséget.';
$string['settings:inactivity_reminder_enabled'] = 'Inaktivitási emlékeztetők';
$string['settings:inactivity_reminder_enabled_desc'] = 'Heti e-mailt küld azoknak a tanulóknak, akik a beállított napszám óta nem nyitották meg a kurzusukat.';
$string['settings:inactivity_threshold_days'] = 'Inaktivitási küszöb (nap)';
$string['settings:inactivity_threshold_days_desc'] = 'Hány nap inaktivitás után menjen ki az emlékeztető e-mail.';
$string['settings:voice_providers_heading'] = 'Hangszolgáltatók (Realtime, TTS, STT)';
$string['settings:voice_providers_heading_desc'] = 'Egy vagy több hang-API-szolgáltató beállítása. Ezek a beállítások függetlenek a fenti csevegési szolgáltatótól és a RAG beágyazási szolgáltatójától — a hangnak saját szolgáltatói listája van, mert jelenleg csak az OpenAI és az xAI kínál WebSocket-alapú Realtime, TTS és STT végpontokat. Az alábbi legördülő listákkal választhatja ki, melyik regisztrált szolgáltató kezelje az egyes funkciókat. Ha egyetlen sor sincs megadva, a régi egykulcsos működés érvényes (a fenti Realtime API-kulcs vagy a fő OpenAI-kulcs). Az olyan webhelyeknek, amelyek a csevegéshez Together AI-t / Anthropicot / DeepSeeket / Geminit / Mistralt használnak, itt legalább egy sort be kell állítaniuk ahhoz, hogy a hangfunkciók működjenek.';
$string['settings:voice_active_realtime'] = 'Aktív Realtime szolgáltató';
$string['settings:voice_active_realtime_desc'] = 'Melyik beállított hangszolgáltató kezelje a Realtime hangügynök munkameneteit.';
$string['settings:voice_active_tts'] = 'Aktív TTS-szolgáltató';
$string['settings:voice_active_tts_desc'] = 'Melyik beállított hangszolgáltató olvassa fel az MI válaszait.';
$string['settings:voice_active_stt'] = 'Aktív STT-szolgáltató';
$string['settings:voice_active_stt_desc'] = 'Melyik szolgáltató alakítsa szöveggé a tanulók beszédét. Hagyja üresen, hogy először az alább beállított saját üzemeltetésű Whisper-kiszolgálót, majd az első hangszolgáltatói sort vagy a régi kulcsot használja.';
$string['settings:stt_selfhosted_enabled'] = 'Saját üzemeltetésű átírás bekapcsolása';
$string['settings:stt_selfhosted_enabled_desc'] = 'Az alább megadott saját üzemeltetésű Whisper-kiszolgálót használja a beszéd-szöveg átalakításhoz a hangbevitelnél és a Soapboxnál. Alább kiszolgáló-URL megadása szükséges. Kikapcsolva az átírás a felhőalapú útvonalra (OpenAI Whisper) vagy a böngészőbeli útvonalra tér vissza, még akkor is, ha az URL be van állítva.';
$string['settings:stt_selfhosted_warm'] = 'Előmelegítés Soapbox-felvétel indításakor';
$string['settings:stt_selfhosted_warm_desc'] = 'Bekapcsolva egy Soapbox-felvétel elindítása egy könnyű, legjobb szándékú "bemelegítő" kérést küld a saját üzemeltetésű átíró kiszolgálónak, így a nullára skálázódó gazdagép (például Cloud Run) elindulhat, amíg a tanuló még felvételt készít — ezzel a hidegindítási késleltetés rejtve marad a beküldéskor futó átírás elől. Nincs hatása, ha fent nincs megadva saját üzemeltetésű kiszolgáló URL-je. Alapértelmezés szerint kikapcsolva.';
$string['settings:voice_tab_enabled'] = 'Hang fül bekapcsolása';
$string['settings:voice_tab_enabled_desc'] = 'Megjeleníti a Hang fület az alsó navigációs sávban. Kikapcsolva a tanulók csak a Csevegés és a Jegyzetek fület látják. A hangfunkciók (beszélgetésgyakorlás, kiejtésgyakorlás) továbbra is elérhetők a beszélgetésindítókon keresztül, ha külön be vannak kapcsolva.';
$string['settings:soapbox_heading'] = 'Soapbox';
$string['settings:soapbox_heading_desc'] = 'Szóbeli előadásgyakorlás: hogyan történjen a felvételek átírása, és milyen értékelőlap alapján kapjanak pontszámot. A Soapboxot kurzusonként a Pedagógia szakasz Soapbox kapcsolójával kapcsolhatja be.';
$string['settings:soapbox_max_seconds'] = 'A Soapbox-felvétel legnagyobb hossza (másodperc)';
$string['settings:soapbox_max_seconds_desc'] = 'Abszolút felső korlát a felvétel hosszára bármely feladatnál. Az oktatók ennél rövidebb tartományt is beállíthatnak. Alapérték 720 (12 perc).';
$string['settings:soapbox_max_recordings'] = 'Legtöbb Soapbox-felvétel tanulónként és feladatonként';
$string['settings:soapbox_max_recordings_desc'] = 'Abszolút felső korlát arra, hány felvételt készíthet egy tanuló egy feladathoz, a feladatonkénti próbálkozásszám beállításától függetlenül. Alapérték 3.';
$string['settings:soapbox_retention_days'] = 'Soapbox-felvételek megőrzési ideje (nap)';
$string['settings:soapbox_retention_days_desc'] = 'Meddig őrizze meg a rendszer a felvételt az automatikus törlés előtt; az átirat, a pontszám és a visszajelzés megmarad. 1–28 nap közé szorítva. Minél rövidebb, annál jobb az adattakarékosság szempontjából. Alapérték 7.';
$string['settings:soapbox_video_quality'] = 'Soapbox videóminőség';
$string['settings:soapbox_video_quality_desc'] = 'A felvétel felbontása és bitsebessége. Ez a fő költség- és sávszélesség-tényező; egy félközeliben látszó előadó szabványos minőségben is jól olvasható. Az alacsony minőség gyenge kapcsolatokhoz való; a magas csak akkor, ha a képi részletek számítanak.';
$string['settings:soapbox_storage_bucket'] = 'Soapbox tárolótároló (bucket)';
$string['settings:soapbox_storage_bucket_desc'] = 'A felvételeket tároló S3 bucket. Alapérték: a közös archív bucket.';
$string['settings:soapbox_storage_region'] = 'Soapbox tárolási régió';
$string['settings:soapbox_storage_region_desc'] = 'A bucket AWS-régiója, például us-east-1.';
$string['settings:soapbox_storage_prefix'] = 'Soapbox tárolókulcs-előtag';
$string['settings:soapbox_storage_prefix_desc'] = 'A kulcsok előtagja a bucketen belül. A felvételek ez alá az útvonal alá kerülnek, hogy egy életciklus-szabály célozni tudja őket.';
$string['settings:soapbox_storage_key'] = 'Soapbox tároló hozzáférési kulcsának azonosítója';
$string['settings:soapbox_storage_key_desc'] = 'Egy olyan IAM-résztvevő hozzáférésikulcs-azonosítója, amely a fenti előtagon a PutObject/GetObject/DeleteObject műveletekre korlátozódik.';
$string['settings:soapbox_storage_secret'] = 'Soapbox tároló titkos hozzáférési kulcsa';
$string['settings:soapbox_storage_secret_desc'] = 'A fenti hozzáférésikulcs-azonosítóhoz tartozó titkos hozzáférési kulcs.';
$string['settings:survey_heading'] = 'Tanulói kérdőív';
$string['settings:survey_heading_desc'] = 'A csevegésen belüli tanulói élménykérdőív beállítása. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Kérdőívkérdések szerkesztése &rarr;</a>';
$string['settings:survey_enabled'] = 'Kérdőívek bekapcsolása';
$string['settings:survey_enabled_desc'] = 'Bekapcsolva a tanulóknak felajánlja a rendszer, hogy kitöltsenek egy kérdőívet az MI-tutorral szerzett tapasztalataikról.';
$string['settings:survey_trigger_messages'] = 'Megjelenítés N üzenet után';
$string['settings:survey_trigger_messages_desc'] = 'A kérdőívfelkérés megjelenítése azután, hogy a tanuló ennyi üzenetet küldött egy kurzusban. A 0 esetén csak kézi indítással jelenik meg.';
$string['settings:survey_frequency'] = 'Kérdőív gyakorisága felhasználónként';
$string['settings:survey_frequency_desc'] = 'Milyen gyakran kérhető fel egy tanuló a kérdőív kitöltésére az egyes kurzusokon.';
$string['settings:rubric_heading'] = 'Gyakorlási értékelőlapok';
$string['settings:rubric_heading_desc'] = 'A beszélgetés- és kiejtésgyakorló munkamenetek értékelőlapjainak beállítása. A gyakorlás végén a tanulók MI által készített pontszámokat és visszajelzést kapnak. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Értékelőlapok szerkesztése &rarr;</a>';
$string['settings:practice_scoring_enabled'] = 'Gyakorlásértékelés bekapcsolása';
$string['settings:practice_scoring_enabled_desc'] = 'Bekapcsolva a tanulók a beszélgetés- és kiejtésgyakorlás után pontlapot kapnak, amely szempontonkénti értékelést és visszajelzést tartalmaz.';
$string['settings:usertesting_heading'] = 'Használhatósági tesztelés';
$string['settings:usertesting_heading_desc'] = 'Widgeten belüli használhatósági tesztelés feladatalapú értékeléssel. A tanulók feladatokat oldanak meg az asszisztensben, és értékelik az élményt. Az eredmények az elemzési irányítópulton jelennek meg.';
$string['settings:usertesting_enabled'] = 'Használhatósági tesztelés bekapcsolása';
$string['settings:usertesting_enabled_desc'] = 'Megjeleníti a "Használhatósági tesztelés" hivatkozást a widget láblécében. Bekapcsolva a tanulók elérhetik a tesztelési feladatokat.';
$string['settings:usertesting_external_url'] = 'Külső űrlap URL-címe (C változat)';
$string['settings:usertesting_external_url_desc'] = 'Nem kötelező: egy külső űrlap URL-címe (például Google Forms vagy Typeform). Használható helyőrzők: {{userid}}, {{courseid}}, {{messages}}, {{session_minutes}}. Ha meg van adva, a "Használhatósági tesztelés" hivatkozásra kattintva ez az URL nyílik meg a kitöltött környezeti adatokkal. Hagyja üresen, ha csak a widgetbeli tesztelőpanelt szeretné használni.';
$string['settings:footer_links_heading'] = 'Lábléchivatkozások';
$string['settings:footer_links_heading_desc'] = 'Az asszisztens alján megjelenő hivatkozások testreszabása: egy nem kötelező kurzuskínálat-hivatkozás a visszajelzési hivatkozás alatt, valamint a visszajelzési hivatkozás és panelje szövegezése.';
$string['settings:footer_courses_text'] = 'Kurzushivatkozás szövege';
$string['settings:footer_courses_text_desc'] = 'A visszajelzési hivatkozás alatt megjelenő hivatkozás szövege. Hagyja üresen a hivatkozás teljes elrejtéséhez.';
$string['settings:footer_courses_url'] = 'Kurzushivatkozás URL-címe';
$string['settings:footer_courses_url_desc'] = 'A kurzushivatkozás célja (új lapon nyílik meg). A hivatkozás rejtve marad, ha ez a mező üres.';
$string['settings:feedback_link_label'] = 'Visszajelzési hivatkozás címkéje';
$string['settings:feedback_link_label_desc'] = 'Felülírja a lábléc visszajelzési hivatkozásának szövegét, például "Visszajelzés küldése a [[tutorshort]] informatikai csapatának". Hagyja üresen az alapértelmezett lefordított "Visszajelzés" címke használatához.';
$string['settings:feedback_panel_intro'] = 'Visszajelzési panel bevezetője';
$string['settings:feedback_panel_intro_desc'] = 'A visszajelzési panel tetején megjelenő bevezető sor. Tisztázza, hová jut a visszajelzés. Hagyja üresen, ha nem szeretne bevezető sort.';
$string['settings:quiz_provider'] = 'Tesztasszisztens szolgáltatója';
$string['settings:quiz_provider_desc'] = 'A tesztek készítéséhez használt szolgáltató azonosítója (például <code>claude</code> vagy <code>openai</code>). Meg kell egyeznie az Összehasonlító szolgáltatók egyik sorával. Hagyja üresen a csevegési szolgáltató használatához.';
$string['settings:quiz_model'] = 'Tesztasszisztens modellje';
$string['settings:quiz_model_desc'] = 'A tesztek készítéséhez használt modell neve, például <code>claude-haiku-4-5</code>. A felülbíráláshoz ezt és a szolgáltatót is ki kell tölteni.';
$string['settings:branding_heading'] = 'Arculat';
$string['settings:branding_heading_desc'] = 'Az asszisztens nevének és megjelenésének testreszabása.';
$string['settings:institution_short_name'] = 'Az intézmény rövid neve';
$string['settings:institution_short_name_desc'] = 'Az intézmény rövidített neve a szűk helyen megjelenő felületi elemekhez (például "State U").';
$string['settings:display_name'] = 'Az asszisztens megjelenített neve';
$string['settings:display_name_desc'] = 'Az MI-asszisztens teljes neve, amely a köszöntésekben és az üdvözlőképernyőn jelenik meg (például "Online tanulási asszisztens").';
$string['settings:short_name'] = 'Az asszisztens rövid neve';
$string['settings:short_name_desc'] = 'A címsorban és a szűk helyen megjelenő felületi elemekben használt rövid név (például "Asszisztens").';
$string['settings:welcome_message'] = 'Üdvözlőképernyő üzenete';
$string['settings:welcome_message_desc'] = 'Az első látogatáskor az üdvözlőképernyőn megjelenő üzenet. A <code>{{firstname}}</code> a tanuló keresztnevét, a <code>{{coursename}}</code> a kurzus nevét helyettesíti. Hagyja üresen az alapértelmezett szöveghez.';
$string['settings:chat_greeting'] = 'Csevegési köszöntés';
$string['settings:chat_greeting_desc'] = 'A csevegőablak megnyitásakor megjelenő köszöntő üzenet. A <code>{{firstname}}</code> a tanuló keresztnevét, a <code>{{coursename}}</code> a kurzus nevét helyettesíti. Hagyja üresen az alapértelmezett szöveghez.';
$string['settings:customavatars'] = 'Egyéni avatarok';
$string['settings:customavatars_desc'] = 'Töltsön fel ide négyzetes PNG- vagy SVG-képeket, hogy hozzáadja őket a fenti avatarlistához. Minden feltöltött fájl kiválasztható alapértelmezéssé válik ("Custom:" előtaggal). Töröljön egy fájlt ebből a listából, hogy eltávolítsa a legördülő listából. Tipp: egy 256×256 képpontos PNG jól mutat Retina-kijelzőkön.';
$string['settings:anomaly_digest_heading'] = 'Learning Radar — anomáliaösszefoglaló';
$string['settings:anomaly_digest_heading_desc'] = 'Napi ellenőrzés, amely csúszó időszakokat hasonlít össze a negatív visszajelzések, a tokenköltés és az integritásjelzések tekintetében. Ha egy mutató átlépi a beállított küszöböt, összefoglaló megy ki a beállított csatornákra. A lekérdezésenként ütemezett jelentésekhez használja az Ütemezések panelt a [[tutorshort]] elemzési oldalán.';
$string['settings:anomaly_digest_enabled'] = 'Anomáliaösszefoglaló bekapcsolása';
$string['settings:anomaly_digest_enabled_desc'] = 'Futtatja a napi anomáliaösszefoglaló feladatot. Alapból csendes — csak akkor jelez, ha egy mutató átlépi a küszöböt.';
$string['settings:anomaly_digest_threshold_pct'] = 'Riasztási küszöb (%)';
$string['settings:anomaly_digest_threshold_pct_desc'] = 'A friss és a korábbi időszak közötti százalékos változás, amely riasztást vált ki. Alapérték: 50.';
$string['settings:anomaly_digest_recipient_email'] = 'Címzett e-mail-címe';
$string['settings:anomaly_digest_recipient_email_desc'] = 'Az anomáliaösszefoglalót fogadó e-mail-cím. Hagyja üresen a webhely-adminisztrátor címének használatához.';
$string['settings:anomaly_digest_slack_webhook'] = 'Slack bejövő webhook URL-címe';
$string['settings:anomaly_digest_slack_webhook_desc'] = 'Nem kötelező Slack bejövő webhook URL-cím. Az összefoglaló Slack-blokküzenetként kerül közzétételre.';
$string['settings:anomaly_digest_teams_webhook'] = 'Microsoft Teams bejövő webhook URL-címe';
$string['settings:anomaly_digest_teams_webhook_desc'] = 'Nem kötelező Teams bejövő webhook URL-cím. Az összefoglaló Office 365 összekötőkártyaként kerül közzétételre.';

$string['radar_report:title'] = '[[tutorshort]] Learning Radar jelentés';
$string['radar_report:print'] = 'Nyomtatás / mentés PDF-be';
$string['radar_report:generated'] = 'Létrehozva: {$a}';
...
$string['transcripts:title'] = 'Anonimizált beszélgetési átiratok';
$string['transcripts:privacynote'] = 'A tanulók személyazonosságát jelentésenként külön álnevekre cseréljük, még mielőtt bármit megjelenítenénk vagy letöltenénk. A címke egy jelentésen belül állandó, így követhető egy beszélgetés, a jelentések között viszont nincs jelentése, ezért két letöltés nem kapcsolható össze ez alapján. A letöltéseket az auditnapló rögzíti.';
$string['transcripts:mode'] = 'Megjelenítés';
$string['transcripts:met'] = 'Teljesült';
$string['transcripts:notmet'] = 'Nem teljesült';
$string['transcripts:to'] = 'Eddig';
$string['transcripts:truncated'] = 'Az első {$a} sor látható. A többi megtekintéséhez szűkítse az időszakot vagy a tananyagelemet.';
$string['transcripts:rowcount'] = '{$a} sor.';
$string['transcripts:col_conversation'] = 'Beszélgetés';
...
$string['privacy:metadata:outreach_log:dryrun'] = 'Azt jelzi, hogy a sor próbaüzemmódban (dry-run) készült-e — e-mail ténylegesen nem került kiküldésre.';
$string['flashcards:starter_saved'] = '{$a} tanulókártya elmentve erről az oldalról.';
$string['flashcards:starter_open_review'] = 'Nyisd meg az ismétlőoldalt, hogy időzített ismétléssel tanulhasd őket.';
$string['flashcards:starter_failed'] = 'Nem tudtam tanulókártyákat készíteni erről az oldalról ({$a}). Próbáld újra, vagy válassz több tartalmat kínáló oldalt.';
$string['flashcards:starter_error'] = 'Most nem tudok tanulókártyákat készíteni erről az oldalról. Próbáld újra később.';
$string['soapbox:no_media_support'] = 'Ez a böngésző itt nem tud hangot rögzíteni. Használj friss Chrome-ot, Edge-et, Firefoxot vagy Safarit biztonságos (https) kapcsolaton.';
