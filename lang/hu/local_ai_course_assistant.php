...
$string['settings:premium_escalation_model_desc'] = 'A prémium szolgáltatónak átadott modellnév. Alapértelmezés: <code>claude-opus-4-8</code> az A.10 bake-off döntése alapján.';
