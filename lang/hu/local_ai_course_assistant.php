...
$string['settings:embed_input_type_asymmetric'] = 'Aszimmetrikus lekérdezés/dokumentum';
$string['settings:embed_input_type_mode'] = 'Beágyazási bemeneti típus';
$string['settings:embed_input_type_mode_desc'] = 'Csak Voyage-beágyazásoknál. A "Közös tér" a lekérdezéseket és a dokumentumokat ugyanúgy ágyazza be, így a kettő modellváltás után is összehasonlítható marad. Az "Aszimmetrikus" a Voyage külön lekérdezés-projekcióját használja; ez a gyártó által javasolt optimalizáció, de ezen a korpuszon kétszer sem sikerült reprodukálni bármilyen nyereséget, ezért a közös tér az alapérték. A módosítása nem igényel újraindexelést.';
$string['settings:embed_input_type_shared'] = 'Közös tér (ajánlott)';
