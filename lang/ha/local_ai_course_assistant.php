...
$string['settings:backend_context_tokens_desc'] = 'Matsakaicin tsawon mahalli (max_model_len) na backend ɗin AI ɗinka, a tokens. Saita zuwa 0 don samfuran da aka karɓi bakuncinsu masu babbar taga (babu ƙuntatawa). Lokacin da aka saita sama da 0 (alal misali 8192 a kan backend vLLM da kai kanka kake karɓar bakuncinsa), SOLA na rage kasafin haruffa na umarnin tsarin da ke sama domin umarnin tare da fitarwar da aka ware da tarihin tattaunawa su shiga cikin tagar, ko da a cikin harsunan da ke da yawan tokens. Duba shafin wiki na Deployment Sizing domin yadda wannan ke daidaita da masu amfani a lokaci guda.';
...
$string['settings:backend_retry_max_wait_desc'] = 'Iyaka ta sama, a sakanni, kan tsawon lokacin girmama kanun Retry-After daga backend kafin sake gwadawa. Lokacin da backend bai aika Retry-After ba, SOLA na amfani da ɗan gajeren jinkiri mai girma maimakon haka. Tsoho 5.';
...
$string['settings:zendesk_require_consent_desc'] = 'Lokacin da yake kunne (an ba da shawara), SOLA na tura tattaunawa zuwa teburin tallafi na Zendesk ne kawai bayan mai koyo ya karɓi sanarwar yarda ta farko, wadda ke bayyana cewa neman taimakon mutum yana raba tattaunawa (haɗe da suna da imel) tare da tallafi. Kashe wannan ne kawai idan ka samu wannan yarda ta wata hanya; idan an kashe shi, ana aika tura nan take. Ba ya da tasiri sai dai idan an kunna tura zuwa Zendesk.';
...
$string['emergency:title'] = 'Sarrafa Gaggawar SOLA';
$string['emergency:page_warning'] = 'Waɗannan maɓallai suna aiki nan take don kowane mai koyo a rukunin yanar gizo. Kowane aikin yana rubuta layin bincike. Maɓallai masu tsarki sun bar sauran SOLA yana gudana; kashe mai iko da uban yana cire widget gaba ɗaya.';
$string['emergency:back_to_settings'] = 'Saitunan SOLA';
...
$string['emergency:flag_chat_desc'] = 'Yana toshe zirga-zirgar tattaunawa ta hanyar tutar kashe musamman (gyare-gyaren v5.13). Widget yana ci gaba da bayyanawa; masu koyo suna ganin saƙon "SOLA ya tsaya" mai alheri. Yi amfani lokacin da mai bayar da LLM yana ɓarna ko farashin ya ƙaru.';
...
$string['emergency:flag_all_desc'] = 'Yana kashe plugin gaba ɗaya: widget ya ɓace daga kowane shafi, ayyukan da aka tsara sun tsaya, murya ta kau, RAG an kashe, sadarwa an kashe. Maɓalin mafi ƙarfi — yi amfani don lamarin tsaro ko lokacin da dole ne a kai SOLA a layi nan take.';
$string['emergency:settings_link'] = 'Sarrafa gaggawa';
$string['emergency:settings_link_desc'] = 'Maɓallai na kashe kowane tsarin (tattaunawa / murya / RAG / sadarwa / babba) tare da rikodin bincike — daidaitar yanar gizo na <code>admin/cli/emergency_disable.php</code>. Buɗe <a href="{$a}">Sarrafa Gaggawar SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'An cire rajista';
$string['email_unsubscribe:done_body'] = 'Yana da kyau — {$a->email} ba zai ƙara karɓar wannan nau\'in imel daga {$a->product} ba. Idan ka canza ra\'ayin ka, ka tambayi mai gudanar da {$a->product} don sake kunna biyan kuɗin, ko ka aika sabon yarda ta cikin shafin masu karɓar SOLA.';
...
$string['analytics:exp_active_users'] = 'Masu amfani da SOLA masu aiki';
