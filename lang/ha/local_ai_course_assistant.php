...
$string['settings:default_course_mode_desc'] = 'Yana sarrafa ko [[tutorshort]] za ta bayyana akan kwas idan ba a yi zaɓi na kowane kwas ba. Sabbin shigarwa suna zuwa da tsoho "An kashe ta tsoho" domin masu gudanarwa su iya ba da izini kwas-da-kwas daga shafin Analytics ko shafin Course AI Settings.';
...
$string['settings:auto_open_desc'] = 'Lokacin da aka kunna, drawer na [[tutorshort]] yana buɗewa kai tsaye a karon farko da ɗalibi ya isa kowane kwas. Loadings na shafuka na gaba a cikin kwas ɗaya ba sa sake buɗe drawer — ana bin diddigin yanayin kowane kwas a cikin browser na ɗalibi ta hanyar localStorage. Yana aiki a desktop da mobile. Ana iya soke shi kowane kwas daga shafin Course AI Settings.';
...
$string['coursesettings:sola_enabled'] = '[[tutorshort]] akan wannan kwas';
$string['coursesettings:sola_enabled_toggle'] = 'Nuna kayan aikin [[tutorshort]] akan wannan kwas';
$string['coursesettings:sola_enabled_desc'] = 'Yana sarrafa ko kayan aikin tattaunawa na [[tutorshort]] yana bayyana akan wannan kwas. An saita tsohon na dukkan shafin a cikin saitunan plugin a General > Default for new courses.';
...
$string['chat:greeting'] = 'Sannu, {$a}! Ni ne [[tutorshort]]. Ta yaya zan taimake ka yau?';
$string['chat:title'] = '[[tutorshort]]';
$string['chat:assistant'] = '[[tutorshort]]';
$string['chat:open'] = 'Bude [[tutorshort]]';
...
$string['chat:voice_speaking'] = '[[tutorshort]] na magana...';
...
$string['settings:cdn_heading_desc'] = 'Bayar kadarorin gaban [[tutorshort]] (JS/CSS) daga CDN na waje maimakon tsarin fayilolin Moodle. Wannan yana ba da damar sabunta gaban ba tare da haɓaka plugin ba. Bar CDN URL fanko don amfani da fayilolin plugin na gida.';
...
$string['chat:voice_title'] = 'Yi magana da [[tutorshort]]';
...
$string['mobile_disabled'] = '[[tutorshort]] ba ya samuwa ga wannan kwas.';
$string['mobile_placeholder'] = 'Yi tambaya...';
$string['mobile_welcome'] = 'Sannu, {$a}!';
$string['mobile_welcome_sub'] = 'Ni ne [[tutorshort]], mataimakinka na koyo. Yaya zan taimaka?';
...
$string['settings:rag_return_scope'] = 'Faɗin mayarwa na nema';
$string['settings:rag_return_scope_desc'] = 'Abin da za a saka wa kowane sakamakon da aka samo. "chunk" (tsoho) yana saka guntun kalmomi kusan 400 da suka dace. "window" yana saka guntun da ya dace tare da gutsuttsuran da ke kusa da shi a wannan shafi. "page" yana saka duk shafin module da sakamakon ya kasance a ciki. window/page suna taimakawa idan amsa ta shafi shafi baki daya, sai dai farashinsu shi ne babban prompt.';
$string['settings:rag_window_size'] = 'Girman taga na nema';
$string['settings:rag_window_size_desc'] = 'Ga fadin mayarwa "window": adadin gutsuttsuran da ke kusa da za a hada a kowane gefen guntun da ya dace. Tsoho 1.';
$string['settings:rag_parent_max_chars'] = 'Iyakar sakin layi na uba (haruffa)';
$string['settings:rag_parent_max_chars_desc'] = 'Mafi yawan haruffa don sakin layi na window/page da aka fadada. Shafukan da suka wuce iyaka za su koma zuwa window, sannan zuwa guntu daya. Tsoho 6000.';
...
$string['chat:consent_body'] = '{$a->product} mataimaki ne na koyo da AI ke ƙarfafawa. Ana adana saƙonninka da amsoshin {$a->product} a cikin bayanan Moodle na {$a->institution} kuma ana aika zagaye goma na baya-bayan nan zuwa mai samar da samfurin AI da aka amince da shi don amsa tambayoyinka. Ana raba sunanka na farko don keɓancewa; ba a aika wani ƙarin bayani na ganewa zuwa mai samar da AI ba. Idan ka nemi taimakon mutum kuma aka tura tambayarka, ana iya raba wannan tattaunawa (haɗe da sunanka da imel) tare da ƙungiyar tallafinmu. Za ka iya saukewa, gogewa, ko daina amfani da {$a->product} a kowane lokaci.';
...
$string['settings:xai_proxy_url_desc'] = 'URL na wss na jama\'a na sabis na proxy na [[tutorshort]] xAI Realtime (misali wss://voice.example.com/xai-rt/rt). Lokacin da aka saita wannan tare da sirrin JWT, muryar xAI tana wucewa ta hanyar proxy kuma maɓallin master na API na xAI ba ya isa burauzar. Bar shi babu komai don dawowa zuwa hanyar tuntuɓa kai tsaye (ba a bada shawara ba a samarwa).';
...
$string['settings:current_page_content_maxchars_desc'] = 'Mafi yawan adadin haruffa na rubutun shafin yanzu da aka saka cikin tambayar tsarin a matsayin sashin "Abun cikin shafin yanzu", lokacin da RAG ke kashe. Tsohon 8,000 yana goyon bayan tambayoyi na musamman na shafi da kyau yayin barin kasafin kuɗi don tsari da umarni. (Da RAG a kunne, ana goyon bayan shafin maimakon ta hanyar ɓangarorin sa mafi dacewa, masu son shafin yanzu, don haka wannan iyaka ba ta aiki.) Ana yanke shafi mai tsayi sosai daga kai zuwa wannan adadin haruffa, don haka ƙarshen shafi mai tsayi sosai ƙila ba za a ambata ba; kunna RAG yana guje wa hakan. Shafukan da ke kula da tsada za su iya rage shi (misali 3,000-4,000). An iyakance zuwa iyaka 500-8,000. Mai zaman kansa daga <code>prompt_budget_chars</code>: wannan yana iyakance sashin shafi kawai; kasafin kuɗi yana iyakance dukkan tambayar.';
...
$string['pedagogy:program_path_desc'] = 'Lokacin da yake a buɗe, [[tutorshort]] na iya gaya wa mai koyo inda darasin yanzu ke kaiwa na gaba a cikin shirinsa (digiri ko takardar shaida) da yadda dabarun yau suke haɗawa zuwa darussan baya. Yana karanta plugin ɗin Moodle Programs (Degrees da Learn) kuma yana ambaton wani takamaiman darasi na gaba kawai inda shirin ya bayyana sharaɗin gaba ko tsari da ake buƙata; in ba haka ba sai ya lura da matsayin mai koyo a cikin hanyar. Don shawara kawai — ba ya taɓa canza rajista ko ƙwarewa, kuma yana amfani da rabon shirin mai koyo na yanzu kawai. Yana yin shiru ba tare da yin komai ba inda babu shirin da ya dace.';
...
$string['pedagogy:learning_path_desc'] = 'Idan an kunna, [[tutorshort]] na ƙara faifan gani na hanyar koyo (maɓallin "hanyata" a saman widget) wanda ke nuna shirin ɗalibi a matsayin jerin kwasakwasai, kowanne ana iya buɗewa don nuna manufofinsa da ƙwarewar ɗalibi. Idan ɗalibi ya cimma matakin kwas ɗin yanzu (kammalawa ko babban kaso na manufofin da aka ƙware), [[tutorshort]] na kuma nuna kintinkiri mai laushi na "a shirye yake don kwas na gaba" tare da ambata shi a cikin tattaunawa. Don shawara kawai; yana amfani da rabon shirin ɗalibi kansa; ba ya yin komai a shiru inda babu wani shiri da ya dace.';
...
$string['settings:backend_context_tokens'] = 'Tagar mahallin backend (tokens)';
$string['settings:backend_context_tokens_desc'] = 'Matsakaicin tsawon mahalli (max_model_len) na backend ɗin AI ɗinka, a tokens. Saita zuwa 0 don samfuran da aka karɓi bakuncinsu masu babbar taga (babu ƙuntatawa). Lokacin da aka saita sama da 0 (alal misali 8192 a kan backend vLLM da kai kanka kake karɓar bakuncinsa), [[tutorshort]] na rage kasafin haruffa na umarnin tsarin da ke sama domin umarnin tare da fitarwar da aka ware da tarihin tattaunawa su shiga cikin tagar, ko da a cikin harsunan da ke da yawan tokens. Duba shafin wiki na Deployment Sizing domin yadda wannan ke daidaita da masu amfani a lokaci guda.';
$string['settings:backend_retry_attempts'] = 'Yunƙurin sake gwada backend';
$string['settings:backend_retry_attempts_desc'] = 'Sau nawa za a sake gwada kuskuren backend na ɗan lokaci (HTTP 429 ko 503) kafin nuna wa ɗalibi kuskure. Sake gwadawa na faruwa ne kawai kafin a watsa wani rubutun amsa, don haka ba a taɓa ninka fitarwa ba. An yi niyya ga ƙananan backends da kai kanka kake karɓar bakuncinsu waɗanda ke ƙin buƙatu yayin nauyi. Saita zuwa 0 don kashewa. Tsoho 2.';
$string['settings:backend_retry_max_wait'] = 'Matsakaicin jiran sake gwada backend (sakanni)';
$string['settings:backend_retry_max_wait_desc'] = 'Iyaka ta sama, a sakanni, kan tsawon lokacin girmama kanun Retry-After daga backend kafin sake gwadawa. Lokacin da backend bai aika Retry-After ba, [[tutorshort]] na amfani da ɗan gajeren jinkiri mai girma maimakon haka. Tsoho 5.';
$string['prompt:truncation_hint'] = 'LURA: Ba a iya bincika dukan abun cikin kwas a wannan zagayen ba saboda ƙayyadaddun tsawo. Idan ɗalibi ya yi tambaya game da wani abu da ba za ka iya samu a cikin abun cikin da aka bayar ba, ka faɗi cewa ba ka iya bincika dukan kwas ɗin ba kuma ka ba da shawara su buɗe takamaiman shafi ko aiki inda aka rufe batun, maimakon faɗin cewa ba ya cikin kwas.';
$string['selftest:title'] = 'Gwajin kai na backend';
$string['selftest:intro'] = 'Gudanar da binciken kai tsaye na backend ɗin AI da ka saita: ƙaramin zagayen taɗi, gano taga mahalli (max_model_len) ta atomatik da kwatanta da saitin Tagar mahallin backend ɗinka, mafi ƙarancin kasafin umarnin tsarin, da (lokacin da RAG ke aiki) zagayen embedding. Kiran cibiyar sadarwa na gudana ne kawai lokacin da ka danna Gudanar.';
$string['selftest:run'] = 'Gudanar da gwajin kai na backend';
$string['selftest:check'] = 'Bincike';
$string['selftest:status'] = 'Matsayi';
$string['selftest:detail'] = 'Cikakken bayani';
$string['selftest:link'] = 'Shafin gwajin kai na backend';
$string['selftest:link_desc'] = 'Buɗe shafin <a href="{$a}">Gwajin kai na backend</a> domin tabbatar da cewa backend ɗin AI ɗinka yana aiki kuma an girmama shi daidai. Yana da amfani nan da nan bayan saita backend da kai kanka kake karɓar bakuncinsa.';
$string['profile:title'] = 'Saitunan tura aiki da aka shirya';
$string['profile:intro'] = 'Yi amfani da fakitin saituna da aka ba da shawara don nau\'in tura aikinka. Ana rubuta ƙimomin a cikin saitunan plugin na yau da kullun kuma suna nan a sauya su ɗaiɗai daga baya. Yin amfani da saitin da aka shirya yana rubutawa kan saitunan da aka jera.';
$string['profile:current'] = 'Saitin ƙarshe da aka yi amfani da shi: {$a}';
$string['profile:setting'] = 'Saiti';
$string['profile:value'] = 'Ƙima';
$string['profile:self_hosted_small'] = 'Ƙaramin mahalli da kai kanka kake karɓar bakuncinsa (GPU ɗaya, misali A30 24GB / vLLM a 8K)';
$string['profile:hosted_large'] = 'Babban mahalli da aka karɓi bakuncinsa (tsoho)';
$string['profile:apply_self_hosted_small'] = 'Yi amfani da saitin ƙaramin mahalli da kai kanka kake karɓar bakuncinsa';
$string['profile:apply_hosted_large'] = 'Yi amfani da tsohon babban mahalli da aka karɓi bakuncinsa';
$string['profile:applied'] = 'An yi amfani da saitin {$a}. Ƙimomin yanzu suna cikin saitunan plugin ɗinka.';
$string['profile:unknown'] = 'Saitin tura aiki da ba a sani ba.';
$string['profile:link'] = 'Shafin saitunan tura aiki da aka shirya';
$string['profile:link_desc'] = 'Buɗe shafin <a href="{$a}">Saitunan tura aiki da aka shirya</a> domin yin amfani da fakitin saituna da aka ba da shawara don backend da aka karɓi bakuncinsa ko da kai kanka kake karɓar bakuncinsa.';
$string['settings:zendesk_require_consent'] = 'Buƙatar yarda kafin tura zuwa tallafi';
$string['settings:zendesk_require_consent_desc'] = 'Lokacin da yake kunne (an ba da shawara), [[tutorshort]] na tura tattaunawa zuwa teburin tallafi na Zendesk ne kawai bayan mai koyo ya karɓi sanarwar yarda ta farko, wadda ke bayyana cewa neman taimakon mutum yana raba tattaunawa (haɗe da suna da imel) tare da tallafi. Kashe wannan ne kawai idan ka samu wannan yarda ta wata hanya; idan an kashe shi, ana aika tura nan take. Ba ya da tasiri sai dai idan an kunna tura zuwa Zendesk.';
$string['chat:escalation_needs_consent'] = 'Ya bayyana cewa wannan na buƙatar wani memba na ƙungiyar tallafinmu. Domin in mika musu shi, sai na raba wannan tattaunawa, haɗe da sunanka da imel ɗinka, tare da teburin tallafi. Ba ka yarda da hakan ba tukuna, don haka ban aika kome ba. Idan kana son taimakon mutum, ka karɓi sanarwar raba bayanai na wannan mataimaki ka sake tambaya, ko ka tuntuɓi tallafi kai tsaye.';
$string['privacy:metadata:email_optout'] = 'Zaɓuɓɓukan ƙin imel na kowane mai karɓa (waɗanne nau\'ikan imel mai karɓa ya cire rajista daga gare su).';
...
$string['settings:rag_min_similarity'] = 'Mafi ƙarancin dacewa (cosine)';
$string['settings:rag_min_similarity_desc'] = 'Yana watsar da ɓangarorin da aka dawo da su waɗanda kamanceceniyar cosine ɗinsu da tambayar ke ƙasa da wannan ƙimar, don tambaya da ba ta dace ko mai ƙanƙanta ta saka ƙarancin sassa (ko sifili) maimakon koyaushe cika zuwa Top-K da raunanan daidaitawa. Iyaka daga 0 zuwa 1; 0 yana kashe ƙofar. Ƙimar da ta dace ta dogara ne da samfurin embedding: 0.25 ya dace da text-embedding-3-small. Ɗaga shi don zama mai tsanani (ƙarancin mahallin, mai dacewa da batun), rage shi don zama mai sassauci.';
$string['settings:rag_currentpage_boost'] = 'Ƙarin shafin yanzu';
$string['settings:rag_currentpage_boost_desc'] = 'Ƙaramin ƙari da aka ƙara a kan maƙin dacewa na ɓangarorin daga shafin da mai koyo ke kallo a yanzu, don tambayoyi kamar "bayyana wannan" su gwammace shafin da ake gani lokacin da maƙi suka kusanci juna. Tsari kawai: ba ya tilasta ɓangaren shafi mara dacewa ya wuce ƙofar mafi ƙarancin dacewa. Saita 0 don kashewa.';
$string['settings:history_mode'] = 'Yanayin zaɓin tarihi';
$string['settings:history_mode_desc'] = 'Yadda ake zaɓar tsofaffin juyawar tattaunawa kafin a aika su zuwa samfurin. <strong>Ma\'ana</strong> yana riƙe kawai juyawar kwanan nan da suka dace da tambayar yanzu (kuma koyaushe musayar kwanan nan), don juyawa mai tsufa, mara dacewa kada ta ƙara tsada ko ta janye amsar daga hanya; yana yin ƙarin kira ɗaya na embedding kowane saƙo. <strong>Sabuntawa</strong> yana riƙe nau\'i-nau\'i na ƙarshe na "Mafi ƙarancin tarihin tattaunawa" ba tare da la\'akari da dacewa ba (halin da aka daɗe, babu ƙarin kira). Idan embedding ba ya samuwa, yanayin ma\'ana yana komawa zuwa sabuntawa ta atomatik.';
$string['settings:history_mode_semantic'] = 'Ma\'ana (juyawar kwanan nan da suka dace)';
$string['settings:history_mode_recency'] = 'Sabuntawa (nau\'i-nau\'i N na ƙarshe)';
$string['settings:history_semantic_minscore'] = 'Mafi ƙarancin dacewar tarihi (cosine)';
$string['settings:history_semantic_minscore_desc'] = 'A yanayin tarihin ma\'ana, ana riƙe juyawar baya kawai idan kamanceceniyarta da tambayar yanzu ta kai aƙalla wannan ƙimar (koyaushe ana riƙe musayar kwanan nan). Iyaka daga 0 zuwa 1; ya dogara da samfuri. Ɗaga don zama mai tsanani (ƙarancin tarihi), rage don riƙe ƙari.';
$string['settings:history_candidates'] = 'Tagar \'yan takarar tarihi';
$string['settings:history_candidates_desc'] = 'A yanayin tarihin ma\'ana, ana ƙididdige dacewar kawai na nau\'i-nau\'i na kwanan nan har wannan adadin (iyakar tsada). Ba a aika nau\'i-nau\'i da suka girmi wannan tagar ba. Riƙe wannan a ko sama da "Mafi ƙarancin tarihin tattaunawa".';

// v5.11.0 - v6.2.0 strings (added 2026-06-10).
$string['settings:embed_provider_voyage'] = 'Voyage AI (voyage-3.5 — ana ba da shawara; +4 MTEB vs OpenAI 3-small, mahallin 4x, multilingual)';
$string['settings:rerank_heading'] = 'RAG: Dawo da matakai biyu (re-ranking)';
$string['settings:rerank_heading_desc'] = 'Matakin dawo da zaɓi na biyu: kamancen cosine na zaɓar manyan ɓangarori masu yawa-N (tsoho 50), sannan re-ranker wanda yake mai tantancewa na ƙididdiga kowane nau\'i (tambaya, ɓangare) kuma mafiya kyau masu yawa-K sun shiga cikin buɗe. An kashe ta tsoho; yana komawa zuwa matakin cosine guda ɗaya idan ba a saita re-ranker ba ko ya kasa.';
$string['settings:rerank_enabled'] = 'Dawo da matakai biyu (Voyage rerank-2.5)';
$string['settings:rerank_enabled_desc'] = 'Lokacin da aka kunna, dawo da RAG yana zama matakai biyu: kamancen cosine na dawo da manyan-N (tsoho 50), sannan Voyage rerank-2.5 mai tantancewa na ƙididdiga kowannensu kuma manyan-K sun shiga cikin buɗe. An buga nasarorin: +15 Recall@10 kasuwanci, +39% NDCG BEIR. ~$0.05/MTok lissafi. Yana buƙatar <code>rerank_apikey</code> a ƙasa; yana komawa cikin nutsuwa zuwa matakin cosine guda ɗaya idan re-rank ya kasa ko ba a saita ba.';
$string['settings:rerank_apikey'] = 'Maɓallin API na Rerank';
$string['settings:rerank_apikey_desc'] = 'Maɓallin API na Voyage AI don rerank-2.5. Bar fanko don sake amfani da Maɓallin API na Embedding da ke sama (yawancin ayyukan Voyage suna raba maɓalli ɗaya a fadin embed + rerank).';
$string['settings:rerank_model'] = 'Model na Rerank';
$string['settings:rerank_model_desc'] = 'Tsoho <code>rerank-2.5</code>. Ana iya ƙayyade sabbin models na Voyage rerank a nan.';
...
$string['settings:stt_selfhosted_url_desc'] = 'URL na tushen sabar fassarar da ta dace da OpenAI, misali <code>http://10.0.0.5:8000</code>. [[tutorshort]] na ƙara <code>/v1/audio/transcriptions</code> ta atomatik; ana karɓar hanyar cikakken ƙarshe kuma. Bar fanko don kashe STT da kai kanka kake karɓar bakuncinsa.';
$string['settings:stt_selfhosted_model'] = 'Model na STT da kai kanka kake karɓar bakuncinsa';
$string['settings:stt_selfhosted_model_desc'] = 'Sunan model da aka wuce zuwa sabar, yana daidaita model na Whisper da ta loda — misali <code>Systran/faster-whisper-small</code> don speaches ko <code>large-v3</code>. Bar fanko don aika <code>whisper-1</code>, wanda mafi yawancin sabarori masu karɓar bakuncinsa suna karɓa ko sakewa.';
$string['settings:stt_selfhosted_apikey'] = 'Maɓallin API na STT da kai kanka kake karɓar bakuncinsa';
$string['settings:stt_selfhosted_apikey_desc'] = 'Zaɓi. Mafi yawancin sabarori masu karɓar bakuncinsa ba su buƙatar maɓalli a bayan hanyar sadarwa da aka amince da ita; saita wannan ne kawai idan sabarinka yana buƙatar alamar mai ɗaukar kaya.';
$string['emergency:title'] = 'Sarrafa Gaggawar [[tutorshort]]';
$string['emergency:page_warning'] = 'Waɗannan maɓallai suna aiki nan take don kowane mai koyo a rukunin yanar gizo. Kowane aikin yana rubuta layin bincike. Maɓallai masu tsarki sun bar sauran [[tutorshort]] yana gudana; kashe mai iko da uban yana cire widget gaba ɗaya.';
$string['emergency:back_to_settings'] = 'Saitunan [[tutorshort]]';
$string['emergency:state_disabled'] = 'AN KASHE';
$string['emergency:state_active'] = 'Ana aiki';
$string['emergency:confirm_label'] = 'Na fahimci wannan yana shafar kowane mai koyo nan take';
$string['emergency:confirm_required'] = 'Da fatan a duba akwatin tabbatarwa kafin kashe tsarin ƙarami.';
$string['emergency:reason_placeholder'] = 'Dalilin (an rubuta a cikin tarihin bincike)';
$string['emergency:disable_button'] = 'Kashe';
$string['emergency:restore_button'] = 'Maido';
$string['emergency:disabled_notice'] = 'An kashe tsarin "{$a->flag}". Config da aka taba: {$a->touched}';
...
$string['emergency:flag_rag_desc'] = 'Yana kashe dawo da bayanai da lissafi. Tattaunawa tana ci gaba ba tare da kafa kan abun cikin kwas ba.';
$string['emergency:flag_outreach'] = 'Sadarwa';
$string['emergency:flag_outreach_desc'] = 'Yana tsaida takardun taƙaitawa, nasarar aiki, da imel na tuna. Ba ya shafar tattaunawa.';
$string['emergency:flag_all'] = 'KASHE BABBA';
$string['emergency:flag_all_desc'] = 'Yana kashe plugin gaba ɗaya: widget ya ɓace daga kowane shafi, ayyukan da aka tsara sun tsaya, murya ta kau, RAG an kashe, sadarwa an kashe. Maɓalin mafi ƙarfi — yi amfani don lamarin tsaro ko lokacin da dole ne a kai [[tutorshort]] a layi nan take.';
$string['emergency:settings_link'] = 'Sarrafa gaggawa';
$string['emergency:settings_link_desc'] = 'Maɓallai na kashe kowane tsarin (tattaunawa / murya / RAG / sadarwa / babba) tare da rikodin bincike — daidaitar yanar gizo na <code>admin/cli/emergency_disable.php</code>. Buɗe <a href="{$a}">Sarrafa Gaggawar [[tutorshort]]</a>.';
$string['email_unsubscribe:done_title'] = 'An cire rajista';
$string['email_unsubscribe:done_body'] = 'Yana da kyau — {$a->email} ba zai ƙara karɓar wannan nau\'in imel daga {$a->product} ba. Idan ka canza ra\'ayin ka, ka tambayi mai gudanar da {$a->product} don sake kunna biyan kuɗin, ko ka aika sabon yarda ta cikin shafin masu karɓar [[tutorshort]].';
$string['email_unsubscribe:invalid_title'] = 'Hanyar cire rajista ba ta da inganci ƙara';
$string['email_unsubscribe:invalid_body'] = 'Wannan hanyar cire rajista ta ƙare ko tana da lalacewar tsari. Nemi imel mafi kwanan nan daga gare mu, ko tuntuɓi mai gudanar da rukunin yanar gizo don a cire ka da hannu.';
$string['settings:prompt_proportions_heading'] = 'Rabe-raben ɓangarori na buɗe (v5.6.0)';
$string['settings:prompt_proportions_heading_desc'] = 'Ware kasafin kuɗin buɗe na tsarin a cikin kwalabe huɗu: aminci + asali, tsarin kwas, abun cikin kwas, da shafi na yanzu. Nauyin sune kashi cikin ɗari da ke jimiltar 100. Yawan da aka daidaita ta gwaji (10 / 10 / 40 / 40) sun fito ne daga binciken daidaita nauyi na v5.6.0; bar yankin rubutu a fanko don amfani da waɗannan yawancin. Ƙaruwar atomatik tana daidaita raba-rabe kowane juzu\'i dangane da ko shafi na musamman yana cikin kewayen.';
$string['settings:prompt_section_weights'] = 'Nauyoyin ɓangare na tushe (JSON)';
$string['settings:prompt_section_weights_desc'] = 'Abin da za a zaɓa shi ne kwalba zuwa kashi. Bar fanko don amfani da yawancin da aka bincika (10 / 10 / 40 / 40). Misali: <code>{"safety_identity": 10, "course_structure": 10, "course_content": 40, "current_page": 40}</code>. Nauyin dole su jimiltar 100 (±5%). <code>safety_identity</code> yana da bene na 10% don tsayin jailbreak da alamu na tsarin fitarwa suna sauka cikakke. <code>current_page + course_content</code> dole su kasance aƙalla 40% don model yana da kayan aiki na kafa. Ƙimomin da ba su cikin kewayen suna komawa cikin nutsuwa zuwa yawancin da aka bincika; masu gudanar da rukunin yanar gizo su tabbatar ta duba tarihin haɗa buɗe bayan ajiyewa.';
$string['settings:prompt_context_boost_mode'] = 'Yanayin ƙaruwar mahallin';
$string['settings:prompt_context_boost_mode_desc'] = 'Daidaitawa ta atomatik wanda ke jujjuya nauyi zuwa ɓangaren shafi na yanzu lokacin da shafi na musamman yana cikin kewayen, da zuwa abun cikin kwas lokacin da babu shafi da aka zaɓa. <strong>page_focus</strong> (tsoho) yana jujjuya kimanin maki 15 na nauyi. <strong>aggressive</strong> yana jujjuya maki 25 kuma yana mafi kyau lokacin da masu koyo kullum suna tambayar tambayoyi na musamman ga shafi. <strong>off</strong> yana kashe ƙaruwar; nauyoyin tushe da mai gudanar da rukunin yanar gizo ya saita suna amfani kowane juzu\'i ba tare da la\'akari da mahallin shafi ba.';
$string['settings:prompt_context_boost_off'] = 'Kashe (yi amfani da nauyoyin tushe kowane juzu\'i)';
$string['settings:prompt_context_boost_page_focus'] = 'Mayar da hankali kan shafi (tsoho, jujjuyawar ~15)';
$string['settings:prompt_context_boost_aggressive'] = 'Tsananin ƙarfi (~25 jujjuyawar)';
$string['settings:prompt_section_weights_coach'] = 'Soke nauyoyin yanayin koci (JSON, zaɓi)';
$string['settings:prompt_section_weights_coach_desc'] = 'Abin da za a zaɓa shi ne JSON wanda ke soke nauyoyin ɓangare na tushe musamman yayin yanayin koci ta gwaji mai ƙima (lokacin da <code>quizmode=coach</code>). Yana da amfani don tilas da raba-rabe mafi nauyi na <code>current_page</code> yayin gwaje-gwaje ba tare da shafar tattaunawa ta yau da kullun ba. Bar fanko don gado nauyoyin tushe. Ƙa\'idodin tantancewa iri ɗaya kamar saiti na tushe.';
$string['prompt_debug_view:title'] = 'Mai duba tarihin haɗa buɗe';
$string['prompt_debug_view:subtitle'] = 'Buɗe tsarin da aka haɗa kowane juzu\'i + rushewar kowane ɓangare + tarihin tattaunawa + saƙon mai amfani na yanzu + bayanin kari, daidai kamar model ya karɓa. Yi amfani don tabbatar da ko ɓangare kamar Abun Cikin Shafi na Yanzu ya shiga cikin buɗe da kuma gyara matsalolin ingancin amsa ba tare da SSH zuwa sabar ba.';
$string['prompt_debug_view:disabled'] = 'Rikodin haɗa buɗe ta bincike yana KASHE a yanzu. Ba za a rubuta sabbin shigarwa ba sai an kunna shi.';
$string['prompt_debug_view:enable_link'] = 'Buɗe saitunan plugin don kunna "Rubuta buɗe tsarin da aka haɗa zuwa fayil".';
$string['prompt_debug_view:no_log_yet'] = 'Babu fayil din tarihin tukuna. Aika aƙalla juzu\'i guda na tattaunawa bayan kunna tarihin bincike; ana ƙirƙirar fayil din a rubuce na farko.';
$string['prompt_debug_view:empty'] = 'Fayil din tarihin yana nan amma fanko. Aika juzu\'i na tattaunawa kuma sabunta.';
$string['prompt_debug_view:file_status'] = 'Girman fayil din tarihin';
$string['prompt_debug_view:showing'] = 'Nuna shigarwa mafi kwanan nan (sabon farko), iyaka';
$string['prompt_debug_view:total'] = 'Jimillar buɗe';
$string['prompt_debug_view:budget'] = 'Kasafin kuɗi a kama';
$string['prompt_debug_view:sections'] = 'Ɓangarori (ta rukuni)';
$string['prompt_debug_view:assembled_prompt'] = 'Buɗe tsarin da aka haɗa';
$string['prompt_debug_view:history'] = 'Tarihin tattaunawa da aka aika zuwa model';
$string['prompt_debug_view:current_message'] = 'Saƙon mai amfani na yanzu';
$string['prompt_debug_view:attachment'] = 'Bayanin kari';
$string['prompt_debug_view:show_more'] = 'Nuna ƙarin shigarwa';
$string['settings:mastery_classifier_provider'] = 'Mai bayarwa na mai rarrabewa';
$string['settings:mastery_classifier_provider_desc'] = 'ID na mai bayarwa da ake amfani da shi don mai rarrabewa na ƙware kowane juzu\'i. Bar fanko don gado mai bayarwa na AI na tsoho. <code>openai</code> tsoho yana nuna da model mai rarrabewa <code>gpt-4o-mini</code> a ƙasa — mafi arha zaɓi na TIER 1 don rarrabewa ta fitarwa tsari (~$220/wata tanadi a 100k MAU vs tier tattaunawa). Lokacin da aka saita, layin a cikin Masu bayarwa na kwatancen tare da wannan ID mai bayarwa yana bayarwa maɓallin API, URL na tushe, da zafin.';
$string['settings:premium_escalation_heading'] = 'Tier ɗaukaka mai kyau (A.10)';
$string['settings:premium_escalation_heading_desc'] = 'Hanya zaɓi ta kowane juzu\'i zuwa model mai kyau (Claude Opus 4.8 ta tsoho) don buɗe inda tier tattaunawa mai aiki yana fama da fafutuka — yawanci ƙididdiga matakai da yawa, CS, da kimiyya. An warware ta A.10 bake-off na 2026-06-09: Opus 4.8 ya ci nasara a 14.97/15 vs 12.68/15 na gpt-4o akan buɗe masu wahala. Hanyoyi biyu na kunna: regex ya dace da saƙon mai amfani, KO jerin kwas da ke ɗaukaka kowane juzu\'i. An kashe ta tsoho. A ~5% ɗaukaka, ana tsammanin ~$700/wata a 100k MAU na [[unishort]] a saman kashe tattaunawa na tushe.';
$string['settings:premium_escalation_enabled'] = 'Kunna hanyar ɗaukaka mai kyau';
$string['settings:premium_escalation_enabled_desc'] = 'Lokacin da yake a kan, mai hanya kowane juzu\'i yana duba jerin regex na kunna da jerin kwas don kowane kiran tattaunawa; juzu\'in da ya dace ana hanya su zuwa mai bayarwa mai kyau. Yana komawa zuwa mai bayarwa mai aiki idan layin mai kyau yana ɓace ko ya kasa ƙirƙira. Soke masu gudanar da LLM-picker koyaushe sun ci nasara ba tare da la\'akari ba.';
$string['settings:premium_escalation_provider'] = 'Mai bayarwa mai kyau';
$string['settings:premium_escalation_provider_desc'] = 'ID mai bayarwa don hanya kiran mai kyau. Dole ya dace da layi a cikin Masu bayarwa na kwatancen (don haka maɓallin API, URL na tushe, da zafin sun fito daga wuri ɗaya da masu gudanar da rukunin yanar gizo suna gudanar da su). Tsoho <code>claude</code>.';
$string['settings:premium_escalation_model'] = 'Model mai kyau';
$string['settings:premium_escalation_model_desc'] = 'Sunan model da aka wuce zuwa mai bayarwa mai kyau. Tsoho <code>claude-opus-4-8</code> bisa hukuncin A.10 bake-off.';
$string['settings:premium_escalation_triggers'] = 'Regex na kunna mai kyau';
$string['settings:premium_escalation_triggers_desc'] = 'PCRE regex guda ɗaya a kowace layi (ba tare da delimiters ba; ana amfani da kamancen da bai hango girman haruffa ba ta atomatik). Layin da ke farawa da # sune sharhi. Bar fanko don amfani da tarin tsoho da aka shirya daga A.10 bake-off (alamu na STEM matakai da yawa: "derive", "prove that", "step by step", lissafin LaTeX, katanga code, big-O, lissafin integral, ingantawa, da dai sauransu).';
$string['settings:premium_escalation_course_tags'] = 'Jerin kwas na ɗaukaka mai kyau';
$string['settings:premium_escalation_course_tags_desc'] = 'Gajeren sunan kwas guda ɗaya ko prefix na idnumber kowace layi. Kowane juzu\'i a kwas da ya dace yana ɗaukaka ta atomatik ba tare da la\'akari da regex saƙo (yi amfani don kwase-kwase masu nauyi na STEM inda ɗaukaka ya kamata ya zama tsoho). Kamancen prefix da bai hango girman haruffa ba — "MATH" ya dace MATH121, MATH205, da dai sauransu.';
$string['settings:spend_cap_per_course_default'] = 'Tsoho iyakar kashe kowane kwas (USD)';
$string['settings:spend_cap_per_course_default_desc'] = 'Iyaka ta tsaro da aka yi amfani da ita ga kowane kwas wanda ba shi da iyakar kashe ta musamman kowane kwas da aka saita. Saita zuwa misali <code>30</code> don iyakance kashen wata-wata na kwas guda zuwa $30 ba tare da daidaita kwase-kwase na mutum ɗaya ba. <code>0</code> = babu tsoho (ana amfani ne da iyaka ta rukunin yanar gizo da iyaka ta canza-canza kowane kwas kawai). Lokacin da kwas ya ƙetare 80% / 95% / 100% na wannan iyaka, aikin pipeline na sanarwar spend-guard da ke akwai yana aika sanarwar mai gudanar da rukunin yanar gizo (jerin masu karɓa: <code>spend_notify_emails</code>, yana komawa zuwa masu gudanar da rukunin yanar gizo). Kwas na musamman koyaushe yana iya ɗago gaban ta kansa ta saita iyaka mafi girma ta canza-canza kowane kwas.';
$string['settings:cost_anomaly_heading'] = 'Mai gano bambancin farashin (v6.0)';
$string['settings:cost_anomaly_heading_desc'] = 'Aikin da aka tsara na yau da kullun (<code>cost_anomaly_check</code>) wanda ke kwatanta kashen [[tutorshort]] na yau da yawa na rukunin yanar gizo da matsakaicin kwanaki 7 da ke gudana. Yana aika imel zuwa jerin masu karɓa na <code>spend_notify_emails</code> (yana komawa zuwa masu gudanar da rukunin yanar gizo) lokacin da yau ya zarce mai daidaitawa da aka saita × matsakaici. Yana kama nau\'i uku na kuskuren da iyakokin kashe-kuɗi 80% / 95% / 100% na yanzu suka rasa: (1) kwas da ya yi gudu inda bai ƙetare babban iyaka amma kwas guda yana driving 10x ƙarar ta yau da kullun, (2) kunna tier mai kyau ta haɗari, (3) misroute na mai bayarwa. An kashe ta tsoho; daidaitar cikin-[[tutorshort]] na tambayar Redash a <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
$string['settings:cost_anomaly_enabled'] = 'Kunna mai gano bambancin farashin';
$string['settings:cost_anomaly_enabled_desc'] = 'Lokacin da yake a kan, aikin da aka tsara na yau da kullun yana kimanta kashen yau da matsakaicin kwanaki 7 da ke gudana kuma yana aika imel zuwa masu gudanar da rukunin yanar gizo akan bambanci. Kwanaki 7 na farko bayan kunna suna samar da matsayi na <code>insufficient_history</code> (babu tarihin tushe tukuna) kuma ba sa fitar da faɗakarwa. Idempotent kowane rana: tutar da ke cikin <code>config_plugins</code> na tsaida imel mara iyaka idan cron yana gudana sau da yawa.';
$string['settings:cost_anomaly_multiplier'] = 'Mai daidaitawa na bambanci';
$string['settings:cost_anomaly_multiplier_desc'] = 'Kashen yau dole ya zarce wannan mai daidaitawa × matsakaicin kwanaki 7 don kunna faɗakarwa. Tsoho <code>2.0</code>. Rage zuwa <code>1.5</code> don faɗakarwa na farko (ƙarin ƙirgar ƙarya yayin fashewar rajista). Ɗago zuwa <code>3.0</code> idan amfanin [[unishort]] yana da yawa ƙarfin burst da ƙarfin 2x yana yau da kullum.';
$string['task:cost_anomaly_check'] = 'Duba bambancin farashin [[tutorshort]] (yau da kullun)';
...
$string['settings:avatar_animation_enabled'] = 'Motsin avatar';
$string['settings:avatar_animation_enabled_desc'] = 'Motsa SVG avatar da aka ƙirƙira: yin ido lokacin hutawa, da kuma motsin baki da aka haɗa da sauti na rubutu zuwa magana yayinda mataimaki yana magana. Yana mutunta zaɓin ƙarancin motsi na na\'urar mai koyo. Keta kowace hanya don auna A/B: saita darajar tsarin avatar_animation_course_COURSEID zuwa 0 ko 1.';
$string['analytics:exp_heading'] = 'Kwatanta gwajin A/B';
$string['analytics:exp_desc'] = 'Kwatanta shiga tsakanin darussan biyu a kan lokacin da aka zaɓa. An gina shi don gwaje-gwaje na kowane darasi (misali gwajin motsi na avatar): sanya sauya a darasi ɗaya, bar ɗayan a matsayin kulawa, kuma karanta bambancin a nan.';
$string['analytics:exp_course_a'] = 'Darasi A';
$string['analytics:exp_course_b'] = 'Darasi B';
$string['analytics:exp_compare'] = 'Kwatanta';
$string['analytics:exp_metric'] = 'Ma\'auni';
$string['analytics:exp_delta'] = 'B vs A';
$string['analytics:exp_enrolled'] = 'Ɗalibai da aka yi rajista';
$string['analytics:exp_active_users'] = 'Masu amfani da [[tutorshort]] masu aiki';
$string['analytics:exp_usage_rate'] = 'Adadin amfani (%)';
$string['analytics:exp_sessions'] = 'Zama';
$string['analytics:exp_messages'] = 'Saƙonni';
$string['analytics:exp_avg_msgs_session'] = 'Matsakaicin saƙonni a kowace zama';
$string['analytics:exp_avg_session_minutes'] = 'Matsakaicin tsawon zama (mintuna)';
...
$string['cachedef_ratelimit'] = 'Iyakance yawan buqatun kowane mai amfani';
$string['cachedef_uistate'] = 'Sauya UI na kowace zama (dubawa a matsayin xalibi, bayyana sunaye na gaskiya)';
$string['benchmark:pagetitle'] = 'Awon masu bayarwa';
$string['benchmark:intro'] = 'Yana aika saitin qayyadaddun tambayoyi na yau da kullum zuwa kowane mai bayar da AI da aka saita, yana rubuta amfani da token, kuxi da jinkiri, sannan yana ba da shawarar mai bayarwa xaya ga kowace iyawa. Kowace gudanarwa tana yin ainihin kiran API, don haka gudanarwa xaya na kashe kusan cents 5 zuwa 20 ya danganta da yawan masu bayarwa da aka saita.';
$string['cachedef_systemprompt'] = 'Tsararren tsarin AI system prompt (na kowane kwas)';
$string['cachedef_remoteconfig'] = 'Sanyi mai nisa da aka samo daga tashar sabuntawa';
$string['cachedef_spend'] = 'Jimillar kashe kuxin AI na kowane lokaci don mai tsaron kashe kuxi';
$string['cachedef_failover_circuit'] = 'Yanayin circuit-breaker na sauya mai bayarwa';
$string['settings:rag_scope'] = 'Iyakar dawowa';
$string['settings:rag_scope_desc'] = 'Lokacin da xalibi yake kallon takamaiman takarda (shafi, littafi, ko PDF), ko za a taqaita dawowa zuwa wannan takarda. <b>Takarda-farko</b> yana kafa amsar akan takardar yanzu idan tana da qananan sassa masu dacewa kuma yana koma zuwa dukan kwas idan ba haka ba. <b>Takarda-kaxai</b> ba ya taxa komawa: idan takardar yanzu ba ta da qaramin sashi mai dacewa ba ya dawo da komai, don haka mai koyarwa yana amsa daga ilimin gaba xaya maimakon nuni ga shafuka marasa dacewa. <b>Faxin-kwas</b> yana bincika dukan abun cikin kwas (shafin yanzu har yanzu yana samun qarin oda a sama). Ana ba da shawarar Takarda-farko, don amsa game da shafin da xalibi yake karantawa ta kafu akan wannan shafin.';
$string['settings:rag_scope_document_first'] = 'Takarda-farko (fifita takardar yanzu, koma zuwa kwas)';
$string['settings:rag_scope_document_only'] = 'Takarda-kaxai (taqaita zuwa takardar yanzu)';
$string['settings:rag_scope_course'] = 'Faxin-kwas (bincika dukan abun cikin kwas)';
$string['ragadmin:no_content_documents'] = 'Takardu {$a->count} ba su samar da rubutu mai iya lissafawa ba kuma ba a raba su ba (yawanci shafuka masu yawan hotuna ko gajeru sosai): {$a->titles}. Idan wani daga cikin waxannan ya kamata ya kasance mai iya bincike, qara rubutu a shafin ko rubutaccen magana, sannan sake lissafawa.';
$string['privacy:metadata:sbx_rec'] = 'Rikodin gabatarwar Soapbox. Ana share abun media bayan lokacin ajiyewa; ana ajiye rubutaccen magana don ba da amsa da buqatun samun dama.';
$string['privacy:metadata:sbx_rec:userid'] = 'Xalibin da ya yi rikodin.';
$string['privacy:metadata:sbx_rec:transcript'] = 'Rubutaccen magana daga rikodin (speech-to-text).';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'Tsawon rikodin cikin sakan.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'Lokacin da aka yi rikodin.';
$string['privacy:metadata:ai_provider'] = 'Don samar da amsoshin koyarwa, ana aika abun ciki da xalibi ya rubuta zuwa mai bayar da AI da mai gudanar da rukunin yanar gizo ko kwas ya saita.';
$string['privacy:metadata:ai_provider:message'] = 'Rubutun saqo da abubuwan haxewa da xalibi ke aikawa ga mai koyarwa na AI.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'Mahallin kwas da ayyuka (kamar sunan kwas da shafin yanzu) da aka haxa don kafa amsar.';
$string['privacy:metadata:voice_provider'] = 'Lokacin da aka yi amfani da shigar da murya ko fitarwa, ana aika sauti da rubutu zuwa mai bayar da speech-to-text / text-to-speech da aka saita.';
$string['privacy:metadata:voice_provider:audio'] = 'Rikoxin sautin xalibi yana magana, an aika don rubutawa.';
$string['privacy:metadata:voice_provider:text'] = 'Rubutu da aka aika ga mai bayarwa don a mai da shi zuwa magana.';
$string['privacy:metadata:zendesk'] = 'Lokacin da aka kunna qarawa zuwa taimakon xan adam kuma xalibi ya yarda, ana aika bayanan tuntuvarsa da saqonsa zuwa Zendesk don buxe tikitin taimako.';
$string['privacy:metadata:zendesk:name'] = 'Cikakken sunan xalibi, ana amfani da shi don gano mai neman taimako.';
$string['privacy:metadata:zendesk:email'] = 'Adireshin imel na xalibi, ana amfani da shi don amsa buqatar taimako.';
$string['privacy:metadata:zendesk:message'] = 'Saqo ko abun cikin tattaunawa da xalibi ya zavi qarawa.';
...
$string['analytics_js:ai_users'] = 'Masu Amfani da AI';
$string['analytics_js:non_users'] = 'Waxanda Ba sa Amfani';
$string['analytics_js:thumbs_up'] = 'Yatsan Sama';
$string['analytics_js:thumbs_down'] = 'Yatsan Qasa';
$string['analytics_js:hallucination_flags'] = 'Alamun Qagaggu';
$string['analytics_js:avg_star_rating'] = 'Matsakaicin Qimar Tauraro';
$string['analytics_js:avg_msgs_resolution'] = 'Matsakaicin Saqonni zuwa Warwarewa';
$string['analytics_js:survey_respondents'] = 'Masu Amsa Bincike';
$string['analytics_js:messages'] = 'Saqonni';
$string['analytics_js:students'] = 'Xalibai';
$string['analytics_js:frequency'] = 'Yawaita';
$string['analytics_js:responses'] = 'Amsoshi';
$string['analytics_js:error_loading'] = 'Kuskure wajen loda bayanai';
$string['analytics_js:loading'] = 'Ana loda bincike...';
$string['analytics_js:no_course_data'] = 'Babu bayanan kwas da ake da su.';
$string['analytics_js:no_unit_data'] = 'Babu bayanan naxi tukuna. Bin diddigin naxi yana taruwa yayin da xalibai ke amfani da mataimakin.';
$string['analytics_js:no_keyword_data'] = 'Babu bayanan kalmar-mabuxi da ake da su na wannan lokacin.';
$string['task:soapbox_cleanup'] = 'Ajiye da tsaftace rikodin Soapbox';
$string['admin:vendor_dpa:col_provider'] = 'Mai Bayarwa';
$string['admin:vendor_dpa:col_optout'] = 'Fita daga horarwa';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Ajiyewa';
$string['admin:vendor_dpa:col_tier'] = 'Iyakar matsayi';
$string['admin:vendor_dpa:col_link'] = 'Hanyar haxi';
$string['admin:vendor_dpa:vendor_terms'] = 'Sharuxxan mai bayarwa';
$string['admin:vendor_dpa:tier'] = 'Matsayi {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'Na yarjejeniya (an fita)';
$string['admin:vendor_dpa:too_default_on'] = 'A kunne ta tsohuwa';
$string['admin:vendor_dpa:too_none'] = 'Babu fita';
$string['admin:vendor_dpa:too_local'] = 'Na cikin gida (babu mai bayarwa)';
$string['admin:vendor_dpa:too_unknown'] = 'Ba a duba tukuna';
$string['admin:vendor_dpa:dpa_signed'] = 'An sanya hannu';
$string['admin:vendor_dpa:dpa_available'] = 'Akwai';
$string['admin:vendor_dpa:dpa_negotiating'] = 'Ana tattaunawa';
$string['admin:vendor_dpa:dpa_not_offered'] = 'Ba a bayar ba';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'N/A';
$string['admin:vendor_dpa:dpa_unknown'] = 'Ba a sani ba';
$string['settings:soapbox_slide_vision'] = 'Amsar zane-zanen gani na slide na Soapbox';
$string['settings:soapbox_slide_vision_desc'] = 'Barin wucewar gani xaya akan hotunan slide da aka fitar don qara gajeriyar bayanin zane-zanen gani ga gabatarwar da aka qididdige. A kashe ta tsohuwa kuma mai kula da sirri: ba a ajiye hotuna ba, kuma kowane aiki dole ne ya yarda da nasa akwatin duba na Amsar zane-zanen gani na slide. Gabatarwar slide da ke da deck da aka loda kaxai ke shafa.';
$string['settings:soapbox_vision_provider'] = 'Mai bayar da slide-vision na Soapbox';
$string['settings:soapbox_vision_provider_desc'] = 'Mai bayarwa da ake amfani da shi don wucewar slide-vision. Yana koma zuwa openai ta tsohuwa. Dole ne ya kasance mai bayarwa mai iya gani da aka saita da API key (ta hanyar mai bayar da kwas ko jerin masu bayar da kwatanci).';
$string['settings:soapbox_vision_model'] = 'Samfurin slide-vision na Soapbox';
$string['settings:soapbox_vision_model_desc'] = 'Samfuri mai iya gani don wucewar slide-vision. Yana koma zuwa gpt-4o-mini ta tsohuwa.';
$string['soapbox:slide_design_note'] = 'Zanen slide:';
$string['soapbox:assign_manage'] = 'Ayyukan gabatarwar Soapbox';
$string['soapbox:copy_link'] = 'Hanyar haxi na xalibi';
$string['soapbox:deck_label'] = 'Slides (PDF). Loda deck xinka, sannan ka ci gaba da slides yayin da kake yin rikodin.';
$string['soapbox:slide_prev'] = 'Slide na baya';
$string['soapbox:slide_next'] = 'Slide na gaba';
$string['soapbox:play_slides'] = 'Kunna tare da slides';
$string['soapbox:audio_ready'] = 'Sauti kaxai. Za a yi rikodin makirufo xinka; ba a amfani da kyamararka ba.';
$string['soapbox:audio_recording'] = 'Ana yin rikodin sauti...';
$string['soapbox:cap_reached'] = 'Ka kai iyakar yawan rikoxin da aka baiwa wannan aiki.';
$string['soapbox:storage_unconfigured'] = 'Ba a saita wurin ajiye rikodin tukuna ba. Da fatan za ka tuntuvi mai gudanarwa.';
$string['soapbox:bad_key'] = 'Wannan lodawa ba naka ba ne.';
$string['soapbox:slides_disabled'] = 'Ba a kunna slides ba na wannan aiki.';
$string['soapbox:upload_missing'] = 'Ba a sami lodawar ba. Da fatan za ka sake gwada yin rikodin.';
$string['soapbox:mode_label'] = 'Nau\'in gabatarwa';
$string['soapbox:mode_informative'] = 'Bayarwa (bayyanawa ko koyarwa)';
$string['soapbox:mode_persuasive'] = 'Lallashi (shawo kai)';
$string['soapbox:err_provider'] = 'Ba a iya kaiwa ga sabis xin qididdigar AI ba. Da fatan za ka sake gwadawa cikin xan lokaci.';
$string['soapbox:err_parse'] = 'AI ya dawo da amsa da ba a zata ba. Da fatan za ka sake gwadawa.';
$string['soapbox:err_disabled'] = 'Ba a kunna aikin maganar ba na wannan kwas.';
$string['soapbox:err_transcribe'] = 'Ba a iya rubuta rikodin ka ba. Da fatan za ka sake gwadawa, kuma ka duba cewa makirufo xinka na aiki.';
$string['settings:outcomes_benchmark_default'] = 'Ma\'aunin sakamako (kaso)';
$string['settings:outcomes_benchmark_default_desc'] = 'Ma\'aunin da hukuma ta saita don rahoton sakamako: xalibi yana cika sakamako lokacin da qwarewarsa ta kai ko ta wuce wannan kaso. Wannan shine ma\'aunin bayar da rahoto (ya bambanta da qofar qwarewar koyarwa). Tsohuwa 70.';
$string['outcomes:title'] = 'Rahoton sakamako';
$string['outcomes:intro'] = 'Ga kowane sakamakon kwas, ma\'auni da kason xalibai da aka tantance da suka cika ko suka wuce shi. Ma\'aunin rukunin yanar gizo shine {$a}%.';
$string['outcomes:none'] = 'Ba a bayyana sakamako ba na wannan kwas tukuna.';
$string['outcomes:export'] = 'Fitar da CSV';
$string['outcomes:col_outcome'] = 'Sakamako';
$string['outcomes:col_benchmark'] = 'Ma\'auni';
$string['outcomes:col_assessed'] = 'Xalibai da aka tantance';
$string['outcomes:col_met'] = 'Cika ma\'auni';
...
$string['soapbox:present_audio'] = 'Gabatarwa ta sauti';
$string['soapbox:present_video'] = 'Gabatarwa ta bidiyo';
$string['soapbox:present_target'] = 'manufa minti {$a->min}-{$a->max}';
$string['soapbox:choose_topic'] = 'Zaɓi jigo';
$string['soapbox:record_short'] = 'Yi rikodi';
$string['soapbox:my_recordings'] = 'Rikodina';
$string['soapbox:no_recordings'] = 'Babu rikodi tukuna.';
$string['soapbox:col_recorded'] = 'An yi rikodi';
$string['soapbox:col_length'] = 'Tsawo';
$string['soapbox:col_type'] = 'Nau\'i';
$string['soapbox:col_recording'] = 'Rikodi';
$string['soapbox:col_kept'] = 'An ajiye';
$string['soapbox:col_student_link'] = 'Hanyar haɗi ta ɗalibi';
$string['soapbox:view_download'] = 'Duba / sauke';
$string['soapbox:expired'] = 'Ya ƙare';
$string['soapbox:retention_note'] = 'Ana iya duba da sauke rikodi na kwanaki {$a}, sannan a share su ta atomatik.';
$string['soapbox:assign_title'] = 'Ayyukan Soapbox';
$string['soapbox:assign_single_title'] = 'Aikin Soapbox';
$string['soapbox:assign_add'] = 'Ƙara aiki';
$string['soapbox:assign_none'] = 'Babu ayyukan Soapbox tukuna.';
$string['soapbox:assign_deleted'] = 'An share aikin.';
$string['soapbox:assign_updated'] = 'An sabunta aikin.';
$string['soapbox:assign_created'] = 'An ƙirƙiri aikin.';
