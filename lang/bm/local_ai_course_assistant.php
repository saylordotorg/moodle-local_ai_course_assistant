...
$string['settings:embed_input_type_asymmetric'] = 'Ɲininkali/sɛbɛn tɛ kelen (asymmetric)';
$string['settings:embed_input_type_mode'] = 'Embedding donni suguya';
$string['settings:embed_input_type_mode_desc'] = 'Voyage embeddings dɔrɔn. "Yɔrɔ jɛlen" bɛ ɲininkaliw ni sɛbɛnw embedding kɛ cogo kelen na, o de kosɔn u fila bɛ to ka se ka suman ɲɔgɔn na modɛli yɛlɛmali kɔ. "Tɛ-kelen" bɛ Voyage ka ɲininkali projeksiyɔn danmakɛnɛ baara; o ye dibaga ka lasɔmini ye nka a ma se ka nafa si jira nin sɛbɛn jɛkulu in kan siɲɛ fila, o de kosɔn "jɛlen" ye fɔlɔ ye. Nin yɛlɛmali mago tɛ index kokura la.';
$string['settings:embed_input_type_shared'] = 'Yɔrɔ jɛlen (laadilen)';
