...
$string['settings:default_course_mode_desc'] = 'A bɛ [[tutorshort]] jira kalan na ni kalan kelen-kelen sugandili ma kɛ. Kabini-kura bɛ daminɛ ni "Dabɔlen ye i sababu ye", walisa ɲɛmɔgɔw ka se ka a da kalan kelen-kelen kan ka bɔ Analytics ɲɛ walima Course AI Settings ɲɛ kan.';
...
$string['settings:auto_open_desc'] = 'Ni a bɛ baara la, [[tutorshort]] papier bɛ a yɛrɛ wuli kalanden mana don kalansow kelen-kelen na siɲɛ fɔlɔ. Ni kalanden tora kalanso kelen kɔnɔ, page weleli wɛrɛw tɛna papier wuli tugun — cogo bɛ kɛ kalanso kelen-kelen na kalanden ka navigateur kɔnɔ ni localStorage ye. A bɛ baara kɛ desktop ni telefonin kan. A bɛ se ka yɛlɛma kalanso kelen-kelen kama Course AI Settings page la.';
...
$string['coursesettings:sola_enabled'] = '[[tutorshort]] bɛ nin kalan in na';
$string['coursesettings:sola_enabled_toggle'] = '[[tutorshort]] minɛn jira nin kalan in kan';
$string['coursesettings:sola_enabled_desc'] = 'A bɛ [[tutorshort]] baro minɛn jira nin kalan in kan walima a ma kɛ. Sitiri-bɛɛ i sababu bɛ dabɔ palogin nafaw la General > Default for new courses kɔrɔ.';
...
$string['chat:greeting'] = 'I ni ce, {$a}! Ne ye [[tutorshort]] ye. Bɛɛ bɛ se ka i dɛmɛ bi wa?';
$string['chat:title'] = '[[tutorshort]]';
$string['chat:assistant'] = '[[tutorshort]]';
$string['chat:open'] = '[[tutorshort]] dayɛlɛ';
...
$string['chat:voice_speaking'] = '[[tutorshort]] bɛ kuma...';
$string['chat:voice_idle'] = 'Lakɛlɛn';
$string['chat:voice_error'] = 'Kuma jɔyɔrɔ ma se. I ka laadiliw lajɛ.';
$string['chat:quiz_locked'] = '[[tutorshort]] datugun kɛra ɲɛtaa waati la kalansen tiɲɛya kɔlɔsili kama. I ni baara ɲuman!';
...
$string['settings:cdn_heading_desc'] = '[[tutorshort]] ɲɛfɛla nafaw (JS/CSS) bɔ CDN kɛnɛ kan Moodle dosiyew nɔ na. Nin bɛ se ka ɲɛfɛla ladoni kɛ plugin yɛlɛma kɔfɛ. CDN URL to lankolon walasa ka plugin dosiyew kɛ.';
...
$string['mobile_welcome_sub'] = 'Je suis [[tutorshort]], votre assistant. Comment puis-je vous aider ?';
...
$string['settings:rag_return_scope'] = 'Ɲinini kɔsegin cogo';
$string['settings:rag_return_scope_desc'] = 'Fɛn min bɛ don sɔrɔli kelen-kelen bɛɛ kama. "chunk" (a b\'a bla yɛrɛ) bɛ kabakuru min bɛnna a bɛ daba kuma 400 ɲɔgɔn don. "window" bɛ kabakuru bɛnnen don, ka fara kabakuru bɛrɛbɛrɛw kan minnu bɛ ɲɛ kelen na. "page" bɛ modil ɲɛ bɛɛ don, min kɔnɔ sɔrɔli bɛnna. window ni page bɛ dɛmɛ don ni jaabi bɛ ɲɛ kelen bɛɛ makɔnɔ, nka o bɛ prompt bonya.';
$string['settings:rag_window_size'] = 'Window bonya';
$string['settings:rag_window_size_desc'] = 'Ni kɔsegin cogo ye "window" ye: kabakuru bɛrɛbɛrɛ hakɛ min bɛ don fan bɛɛ fɛ kabakuru bɛnnen na. A b\'a bla yɛrɛ ye 1.';
$string['settings:rag_parent_max_chars'] = 'Bangebaga sɛbɛnni dan (sɛbɛnkolo)';
$string['settings:rag_parent_max_chars_desc'] = 'Sɛbɛnkolo hakɛ caman min bɛ se ka don window/page sɛbɛnni bonyalen kɔnɔ. Ɲɛ minnu tɛmɛna dan kan, olu bɛ segin window ma, o kɔ kabakuru kelen ma. A b\'a bla yɛrɛ ye 6000.';
...
$string['settings:xai_proxy_url_desc'] = '[[tutorshort]] xAI Realtime nɔnabila baara ka wss URL kɛnɛma (misali wss://voice.example.com/xai-rt/rt). Ni nin sigilen don ni JWT gundo ye, xAI kuma-ye bɛ tɛmɛn nɔnabila la, wa xAI API kunnafoni-konkon ɲɛ tɛ se navigatɛri ma abada. A bila lankolon walisa ka segin sɛrɛya jɔlen kan (a tɛ laadi baara la).';
...
$string['objectives:rebuild_links_help'] = '[[tutorshort]] bɛ sirakanw jɛsira minnu bɛ bɛn kalansow ni ɲɔgɔn cɛ (sebaaya hakili ɲɛsinni walima tɔgɔ fɛ) walisa kalanden min ye barokun dɔ se sɔrɔ yɔrɔ wɛrɛ la, o kana segin a kan tugun. Jɛsiraw bɛ labɛnkura a yɛrɛ ma su o su; o butɔn in baara kɛ ka labɛnkura kɛ sisan kɔfɛ ni i ye sirakanw yɛlɛma.';
...
$string['pedagogy:program_path_desc'] = 'Ni a sigilen don, [[tutorshort]] bɛ se ka kalanden ɲɛfɔ kalansen min bɛ taa yɔrɔ min na a ka kalan porogaramu kɔnɔ (jatebɔsɛbɛn walima sɛbɛnni) ani cogo min na bi ka hakililaw bɛ jɛnsɛn kalansenw na minnu bɛ taa ɲɛfɛ. A bɛ Moodle Programs plugin (Degrees ani Learn) kalan ka kalansen kelen tɔgɔ fɔ yɔrɔ dɔrɔn na min na porogaramu bɛ kɔɲɛn walima labɛnni kɛrɛn-kɛrɛnnen sigi senkan; ni o tɛ, a bɛ kalanden yɔrɔ jira sira kan. Ladilikan dɔrɔn don — a tɛ tɔgɔsɛbɛn walima dɔnniya yɛlɛma abada, ani a bɛ kalanden yɛrɛ ka porogaramu tilali dama de baara la. A bɛ ka je dɔrɔn yɔrɔ min na porogaramu si tɛ baara la.';
...
$string['pedagogy:learning_path_desc'] = 'Ni a dara, [[tutorshort]] bɛ kalanko-sira ɲɛjira pano fara a kan ("ne ka sira" butɔni minɛn kunfɔla la) min bɛ kalanden ka porogaramu jira i n\'a fɔ kalanko caman tɔn, u kelen-kelen bɛ se ka da ka u kuntilennaw n\'a kalanden ka dɔnniya jira. Ni kalanden ye sariya dafa min bɛ kalanko sisan na (a labanni walima kuntilennaw caman dɔn), [[tutorshort]] fana bɛ banɛri nɔgɔman jira "i labɛnnen don kalanko nata kama" ani a b\'a fɔ baro la. Laadilikan dɔrɔn de don; a bɛ baara kɛ ni kalanden yɛrɛ ka porogaramu tilali ye; a tɛ foyi kɛ ni porogaramu si tɛ se ka kɛ yɔrɔ min na.';
...
$string['settings:backend_context_tokens_desc'] = 'I ka AI kɔfɛla baarakɛyɔrɔ ka kɔnɔkow janya hakɛ bɛɛ la kɔrɔta (max_model_len), tokenw la. A bila 0 la modɛliw kama minnu sigilen don ni fɛnɛ belebele ye (dannabaliya tɛ). Ni a sigilen don 0 sanfɛ (misali la 8192 vLLM kɔfɛla baarakɛyɔrɔ kan i yɛrɛ bolo), [[tutorshort]] bɛ sistɛmu-cɛsiri ka sɛbɛnni-yɔrɔ wari dɔgɔya sanfɛla la, walisa cɛsiri ani jaabi marani ani baro tariku ka se ka don fɛnɛ kɔnɔ, hali kan minnu na tokenw ka ca. A lajɛ Deployment Sizing wiki ɲɛ kan walisa ka a dɔn nin bɛ basigi cogo min na baarakɛlaw minnu bɛ kɛ waati kelen na.';
...
$string['settings:backend_retry_max_wait_desc'] = 'Sanfɛla dan, segondiw la, kɔfɛla ka Retry-After kunnafoni bonya waati janya kan sani segin-segin ka kɛ. Ni kɔfɛla ma Retry-After ci, [[tutorshort]] bɛ kɔsegin surun kɛ o nɔ na. Dafalan 5.';
...
$string['settings:zendesk_require_consent_desc'] = 'Ni a bilalen don (laadili), [[tutorshort]] bɛ baro yɛlɛ Zendesk dɛmɛ baarakɛyɔrɔ ma dɔrɔn ni kalanden ye sigili-fɔlɔ sɔn kunnafoni minɛ, min bɛ a jira ko mɔgɔ ka dɛmɛ ɲinini bɛ baro (tɔgɔ ani imɛli sen na) tila ni dɛmɛ ye. Nin faga dɔrɔn ni i ye o sɔn sɔrɔ siralen wɛrɛ kan; ni a falen don, yɛlɛliw bɛ ci joona. Nafa si t\'a la fo ni Zendesk yɛlɛli bilalen don.';
...
$string['settings:stt_selfhosted_url_desc'] = 'OpenAI-jɛkulu sɛbɛnni server gɛrɛfɛ URL, misali la <code>http://10.0.0.5:8000</code>. [[tutorshort]] bɛ <code>/v1/audio/transcriptions</code> farala a la ɲɔgɔn na; endpoint yɔrɔ bɛɛ bɛ minɛ. Nɛgɛso ye walisa ka i yɛrɛ bolo STT jɛ.';
...
$string['emergency:title'] = '[[tutorshort]] Joona Dalilikɛlaw';
$string['emergency:page_warning'] = 'Nin jɛjɛbaw bɛ sɛgɛn joona kalanden bɛɛ kama siɲɛ kan. Kɛwale o kɛwale bɛ gafe-ɲɔgɔn sɛbɛ audit kɔnɔ. Jɛjɛba dɔnkilidaw bɛ [[tutorshort]] tɔ to a baara la; jɛjɛba gɛlɛya bɛ widget bɛɛ bɔ siɲɛ bɛɛ la.';
$string['emergency:back_to_settings'] = '[[tutorshort]] Labɛnniw';
...
$string['emergency:flag_all_desc'] = 'Plugin bɛɛ jɛ: widget bɛ bɔ siɲɛ bɛɛ la, taskiw jɛ, kumakan ɲɛnabɔlen, RAG jɛlen, kɔrɔsɛgɛnli jɛlen. Jɛjɛba ɲɛnabɔlen — a baara kɛ ni sabalibali don walima [[tutorshort]] ka kan ka jɛ joona.';
$string['emergency:settings_link'] = 'Joona Dalilikɛlaw';
$string['emergency:settings_link_desc'] = 'Kill switches subsystem kelen-kelen kama (baro / kumakan / RAG / kɔrɔsɛgɛnli / gɛlɛya) ni audit log fana — <code>admin/cli/emergency_disable.php</code> ka weeb jɛkulu. <a href="{$a}">[[tutorshort]] Joona Dalilikɛlaw</a> da yɛlɛ.';
$string['email_unsubscribe:done_title'] = 'Kumakanbanni kɛra';
$string['email_unsubscribe:done_body'] = 'Kɛra — {$a->email} tɛ {$a->product} ka imɛli suguya min caman sɔrɔ tun. Ni i b\'a fɛ k\'i miiri yɛlɛ, {$a->product} baarakɛla dɔ ɲini walisa ka kumakan segin don, walima ka imɛli kuraw ci [[tutorshort]] Recipients admin ɲɛ fɛ.';
...
$string['settings:cost_anomaly_multiplier_desc'] = 'Tile sara ka kan ka multiplier × 7-tile median bɔ walisa ka kunnafoni bila. Sɔrɔminɛ <code>2.0</code>. <code>1.5</code> kama bɛ ɲɛna kunnafoni (false positives caaman enrollment waati). <code>3.0</code> kama bɛ yɛlɛma ni [[unishort]] ka 2× spike bɛ kɛ sɔrɔminɛ ye.';
$string['task:cost_anomaly_check'] = '[[tutorshort]] sara wɛrɛya sɛgɛsɛgɛli (tile kelen-kelen)';
...
$string['analytics:exp_active_users'] = '[[tutorshort]] baara bɛ kɛ cogo min na';
...
$string['cachedef_ratelimit'] = 'Baarakɛla kelen-kelen ka ɲininkali hakɛ dan';
$string['cachedef_uistate'] = 'Baaraɲɛnabɔ kelen kɔnɔ UI yɛlɛmani (a filɛli i n\'a fɔ kalanden, tɔgɔ yɛrɛyɛrɛw jira)';
$string['benchmark:pagetitle'] = 'Dilanbaga sumaninkɛli';
$string['benchmark:intro'] = 'A bɛ ɲininkali sugu suguya minnu ka teli ci AI dilanbaga bɛɛ ma minnu labɛnna, a bɛ token baarakɛcogo, musaka ani suma taamaɲɛ sɛbɛn, ani a bɛ dilanbaga kelen ladilan seko kelen-kelen na. Baara kelen-kelen bɛɛ bɛ API weleli sɛbɛ kɛ, o de kosɔn baara kelen bɛ musaka kɛ kobɛ 5 fo 20 cents la ka kɛɲɛ ni dilanbaga hakɛ min labɛnna.';
$string['cachedef_systemprompt'] = 'AI sistɛmu ladilanni min lajɛra (kalansen kelen-kelen na)';
$string['cachedef_remoteconfig'] = 'Yɔrɔjan labɛnni min minɛna kabɔ kuraya sira fɛ';
$string['cachedef_spend'] = 'AI musaka hakɛw waati kelen-kelen na musaka lakanabaga kama';
$string['cachedef_failover_circuit'] = 'Dilanbaga falenni sira-datugulan cogoya';
$string['settings:rag_scope'] = 'Ɲinini danyɔrɔ';
$string['settings:rag_scope_desc'] = 'Ni kalanden bɛ sɛbɛn kɛrɛnkɛrɛnnen dɔ lajɛ (ɲɛ, gafe, walima PDF), yala ɲinini ka dan o sɛbɛn de ma wa. <b>Sɛbɛn-fɔlɔ</b> bɛ jaabi jɔsigi sɛbɛn nin kan ni a fanba bɛ a la, n\'o tɛ a bɛ segin kalansen bɛɛ ma. <b>Sɛbɛn-dɔrɔn</b> tɛ segin abada: ni sɛbɛn nin ma foyi sɔrɔ min bɛ ɲɛ, a tɛ foyi minɛ, o de kosɔn karamɔgɔ bɛ jaabi kabɔ dɔnniya jɛlen na ka sɔrɔ a tɛ ɲɛ minnu tɛ tali kɛ olu sɛbɛn. <b>Kalansen-bɛɛ</b> bɛ kalansen kɔnɔfɛn bɛɛ ɲini (sisan ɲɛ nin bɛ nɔfɛ-ta sɔrɔ i n\'a fɔ sanfɛ). Sɛbɛn-fɔlɔ de ladilanna, walisa jaabi min bɛ ɲɛ kan kalanden bɛ min kalan ka jɔsigi o ɲɛ kan.';
$string['settings:rag_scope_document_first'] = 'Sɛbɛn-fɔlɔ (sɛbɛn nin fɔlɔ, ka segin kalansen ma)';
$string['settings:rag_scope_document_only'] = 'Sɛbɛn-dɔrɔn (ka dan sɛbɛn nin dɔrɔn ma)';
$string['settings:rag_scope_course'] = 'Kalansen-bɛɛ (ka kalansen kɔnɔfɛn bɛɛ ɲini)';
$string['ragadmin:no_content_documents'] = 'Sɛbɛn {$a->count} ma sɛbɛn si di min bɛ se ka ɲini, o de kosɔn u ma tila-tila (a ka teli ka kɛ ɲɛ minnu fanba ye ja ye walima minnu ka surun kojugu): {$a->titles}. Ni olu dɔ ka kan ka se ka ɲini, sɛbɛn walima transcript kɛ ɲɛ kan, o kɔ i ka kunnafoni segin ka don.';
$string['privacy:metadata:sbx_rec'] = 'Soapbox jiralikan sɛbɛnw. Media fɛn nin bɛ jɔsi ni marali waati banna; transcript bɛ mara ladilanni ni sɔrɔli ɲininkali kama.';
$string['privacy:metadata:sbx_rec:userid'] = 'Kalanden min ye sɛbɛnni nin kɛ.';
$string['privacy:metadata:sbx_rec:transcript'] = 'Sɛbɛnni nin ka kuma-ka-sɛbɛn transcript.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'Sɛbɛnni janya segondiw la.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'Tuma min na sɛbɛnni nin kɛra.';
$string['privacy:metadata:ai_provider'] = 'Walisa ka karamɔgɔya jaabiw dilan, kalanden yɛrɛ ka sɛbɛnnifɛnw bɛ ci AI dilanbaga ma min labɛnna sigidatigi walima kalansen ɲɛmɔgɔ fɛ.';
$string['privacy:metadata:ai_provider:message'] = 'Cikan sɛbɛn ni nɔfɛfɛnw kalanden bɛ minnu ci AI karamɔgɔ ma.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'Kalansen ni baarakɛ kunnafoni (i n\'a fɔ kalansen tɔgɔ ani sisan ɲɛ) minnu donna walisa ka jaabi jɔsigi.';
$string['privacy:metadata:voice_provider'] = 'Ni kanko donni walima bɔli kɛra, kan ni sɛbɛn bɛ ci kuma-ka-sɛbɛn / sɛbɛn-ka-kuma dilanbaga ma min labɛnna.';
$string['privacy:metadata:voice_provider:audio'] = 'Kalanden ka kumakan sɛbɛnnen, min cira transcript kama.';
$string['privacy:metadata:voice_provider:text'] = 'Sɛbɛn min cira dilanbaga ma walisa ka kɛ kumakan ye.';
$string['privacy:metadata:zendesk'] = 'Ni mɔgɔ-ka-dɛmɛ yɛlɛli dara sen kan ani kalanden sɔnna, a ka jɛkulu kunnafoniw ni a ka cikan bɛ ci Zendesk ma walisa ka dɛmɛ tikiti dayɛlɛ.';
$string['privacy:metadata:zendesk:name'] = 'Kalanden tɔgɔ dafalen, min bɛ baara ka dɛmɛ ɲinibaga dɔn.';
$string['privacy:metadata:zendesk:email'] = 'Kalanden email adɛrɛsi, min bɛ baara ka dɛmɛ ɲinini jaabi.';
$string['privacy:metadata:zendesk:message'] = 'Cikan walima baro kɔnɔfɛn kalanden ye min sugandi ka yɛlɛ.';
...
$string['analytics_js:ai_users'] = 'AI Baarakɛlaw';
$string['analytics_js:non_users'] = 'Baarakɛbaliw';
$string['analytics_js:thumbs_up'] = 'Sɔnni';
$string['analytics_js:thumbs_down'] = 'Sɔnbaliya';
$string['analytics_js:hallucination_flags'] = 'Nkalon Taamasiɲɛw';
$string['analytics_js:avg_star_rating'] = 'Dolo Jateminɛ Cɛmancɛ';
$string['analytics_js:avg_msgs_resolution'] = 'Cikan Cɛmancɛ fo Ɲɛnabɔli';
$string['analytics_js:survey_respondents'] = 'Ɲininkali Jaabibagaw';
$string['analytics_js:messages'] = 'Cikanw';
$string['analytics_js:students'] = 'Kalandenw';
$string['analytics_js:frequency'] = 'Sigicogo';
$string['analytics_js:responses'] = 'Jaabiw';
$string['analytics_js:error_loading'] = 'Fili donni kunnafoni na';
$string['analytics_js:loading'] = 'Kunnafoniw bɛ don...';
$string['analytics_js:no_course_data'] = 'Kalansen kunnafoni tɛ yen.';
$string['analytics_js:no_unit_data'] = 'Yɔrɔ kunnafoni tɛ yen fɔlɔ. Yɔrɔ nɔminɛni bɛ jate ka taa a fɛ kalandenw bɛ dɛmɛbaga baara.';
$string['analytics_js:no_keyword_data'] = 'Kumakolo kunnafoni tɛ yen waati nin na.';
$string['task:soapbox_cleanup'] = 'Soapbox sɛbɛnni marali ni saniyali';
$string['admin:vendor_dpa:col_provider'] = 'Dilanbaga';
$string['admin:vendor_dpa:col_optout'] = 'Kalanni-bɔli';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Marali';
$string['admin:vendor_dpa:col_tier'] = 'Hakɛ sanfɛla';
$string['admin:vendor_dpa:col_link'] = 'Jɛgin';
$string['admin:vendor_dpa:vendor_terms'] = 'Dilanbaga sariyaw';
$string['admin:vendor_dpa:tier'] = 'Hakɛ {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'Bɛn-sɛbɛn (bɔra kalanni na)';
$string['admin:vendor_dpa:too_default_on'] = 'A bɛ sen kan k\'a daminɛ';
$string['admin:vendor_dpa:too_none'] = 'Kalanni-bɔli tɛ yen';
$string['admin:vendor_dpa:too_local'] = 'Sigida (dilanbaga tɛ)';
$string['admin:vendor_dpa:too_unknown'] = 'A ma lajɛ fɔlɔ';
$string['admin:vendor_dpa:dpa_signed'] = 'Bolonɔ don na';
$string['admin:vendor_dpa:dpa_available'] = 'A bɛ sɔrɔ';
$string['admin:vendor_dpa:dpa_negotiating'] = 'Bɛnkan bɛ ka kɛ';
$string['admin:vendor_dpa:dpa_not_offered'] = 'A ma di';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'T/A';
$string['admin:vendor_dpa:dpa_unknown'] = 'Dɔnbali';
$string['settings:soapbox_slide_vision'] = 'Soapbox slide ɲɛfilɛ-dilanni jaabi';
$string['settings:soapbox_slide_vision_desc'] = 'Sɔn ka yeli kelen kɛ slide jaw kan minnu dilanna walisa ka ɲɛfilɛ-dilanni sɛbɛn surun fara jiralikan jatelen kan. A tɛ sen kan k\'a daminɛ ani a bɛ gundo mara: ja si tɛ mara, ani baara kelen-kelen bɛɛ ka kan ka sɔn ni a yɛrɛ ka Slide ɲɛfilɛ-dilanni jaabi kɔnɔ. Slide jiralikanw dɔrɔn minnu ye gafe kɔrɔ ta olu bɛ nɔ sɔrɔ.';
$string['settings:soapbox_vision_provider'] = 'Soapbox slide-yeli dilanbaga';
$string['settings:soapbox_vision_provider_desc'] = 'Dilanbaga min bɛ baara slide-yeli kama. A jɔyɔrɔ ye openai. A ka kan ka kɛ dilanbaga yebaga ye min labɛnna ni API kɔlɔsi ye (kalansen dilanbaga walima suma-dilanbaga lisi fɛ).';
$string['settings:soapbox_vision_model'] = 'Soapbox slide-yeli mɔdɛli';
$string['settings:soapbox_vision_model_desc'] = 'Mɔdɛli yebaga slide-yeli kama. A jɔyɔrɔ ye gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'Slide dilanni:';
$string['soapbox:assign_manage'] = 'Soapbox jiralikan baaraw';
$string['soapbox:copy_link'] = 'Kalanden jɛgin';
$string['soapbox:deck_label'] = 'Slidew (PDF). I ka gafe da kan, o kɔ i ka slidew taama ka taa i n\'i bɛ sɛbɛnni kɛ.';
$string['soapbox:slide_prev'] = 'Slide tɛmɛnen';
$string['soapbox:slide_next'] = 'Slide nata';
$string['soapbox:play_slides'] = 'Fɔli ni slidew ye';
$string['soapbox:audio_ready'] = 'Kumakan dɔrɔn. I ka mikɔrɔfɔni bɛ sɛbɛn; i ka kamera tɛ baara.';
$string['soapbox:audio_recording'] = 'Kumakan bɛ ka sɛbɛn...';
$string['soapbox:cap_reached'] = 'I sera sɛbɛnni hakɛ dan ma baara nin na.';
$string['soapbox:storage_unconfigured'] = 'Sɛbɛnni marayɔrɔ ma labɛn fɔlɔ. I ka i ka ɲɛmɔgɔ ladɔn.';
$string['soapbox:bad_key'] = 'O donni tɛ i ta ye.';
$string['soapbox:slides_disabled'] = 'Slidew ma sigi sen kan baara nin na.';
$string['soapbox:upload_missing'] = 'Donni ma sɔrɔ. I ka a ɲini ka sɛbɛnni kɛ tugun.';
$string['soapbox:mode_label'] = 'Jiralikan sugu';
$string['soapbox:mode_informative'] = 'Kunnafonidiya (ɲɛfɔli walima kalanni)';
$string['soapbox:mode_persuasive'] = 'Lasɔmini (dusukun yɛlɛma)';
$string['soapbox:err_provider'] = 'AI jatemini baara ma se ka sɔrɔ. I ka a ɲini tugun sisan.';
$string['soapbox:err_parse'] = 'AI ye jaabi di min ma jate. I ka a ɲini tugun.';
$string['soapbox:err_disabled'] = 'Kumakan degeli ma sigi sen kan kalansen nin na.';
$string['soapbox:err_transcribe'] = 'I ka sɛbɛnni ma se ka kɛ transcript ye. I ka a ɲini tugun, ani i ka i ka mikɔrɔfɔni lajɛ ni a bɛ baara.';
$string['settings:outcomes_benchmark_default'] = 'Ɲɛtaa hakɛdama (kɛmɛ sɔrɔ)';
$string['settings:outcomes_benchmark_default_desc'] = 'Kalanso ka hakɛdama sigilen ɲɛtaa rapɔɔri kama: kalanden bɛ ɲɛtaa sɔrɔ ni a ka dɔnniya bɛ nin kɛmɛ sɔrɔ hakɛ la walima ka tɛmɛn a kan. Nin ye rapɔɔri hakɛ ye (min ni ladilanni dɔnniya hakɛdan tɛ kelen ye). Jɔyɔrɔ 70.';
$string['outcomes:title'] = 'Ɲɛtaa rapɔɔri';
$string['outcomes:intro'] = 'Kalansen ɲɛtaa kelen-kelen kama, hakɛdama ani kalanden jatelenw kɛmɛ sɔrɔ minnu ye a sɔrɔ walima ka tɛmɛn a kan. Sigidayɔrɔ hakɛdama ye {$a}% ye.';
$string['outcomes:none'] = 'Ɲɛtaa si ma sigi kalansen nin na fɔlɔ.';
$string['outcomes:export'] = 'CSV bɔli';
$string['outcomes:col_outcome'] = 'Ɲɛtaa';
$string['outcomes:col_benchmark'] = 'Hakɛdama';
$string['outcomes:col_assessed'] = 'Kalanden jatelenw';
$string['outcomes:col_met'] = 'Hakɛdama sɔrɔla';
...
$string['soapbox:present_audio'] = 'Kumakan jira';
$string['soapbox:present_video'] = 'Wideyo jira';
$string['soapbox:present_target'] = 'laɲini {$a->min}-{$a->max} miniti';
$string['soapbox:choose_topic'] = 'Barokun sugandi';
$string['soapbox:record_short'] = 'A minɛ';
$string['soapbox:my_recordings'] = 'N ka kumakanw';
$string['soapbox:no_recordings'] = 'Kumakan si tɛ yen fɔlɔ.';
$string['soapbox:col_recorded'] = 'A minɛna';
$string['soapbox:col_length'] = 'Janya';
$string['soapbox:col_type'] = 'Suguya';
$string['soapbox:col_recording'] = 'Kumakan';
$string['soapbox:col_kept'] = 'A marana';
$string['soapbox:col_student_link'] = 'Kalanden ka jɛɲɔgɔnya';
$string['soapbox:view_download'] = 'A filɛ / a jigin';
$string['soapbox:expired'] = 'A waati tɛmɛna';
$string['soapbox:retention_note'] = 'Kumakanw bɛ se ka filɛ ani ka jigin tile {$a} kɔnɔ, o kɔ u bɛ jɔsi u yɛrɛ ma.';
$string['soapbox:assign_title'] = 'Soapbox baaraw';
$string['soapbox:assign_single_title'] = 'Soapbox baara';
$string['soapbox:assign_add'] = 'Baara fara a kan';
$string['soapbox:assign_none'] = 'Soapbox baara si tɛ yen fɔlɔ.';
$string['soapbox:assign_deleted'] = 'Baara jɔsira.';
$string['soapbox:assign_updated'] = 'Baara kuranna.';
$string['soapbox:assign_created'] = 'Baara dara.';
