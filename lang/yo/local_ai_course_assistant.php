...
$string['chat:voice_title'] = 'Sọ̀rọ̀ pẹ̀lú SOLA';
...
$string['mobile_disabled'] = 'SOLA kò sí fún ẹ̀kọ́ yìí.';
$string['mobile_placeholder'] = 'Béèrè ìbéèrè...';
$string['mobile_welcome'] = 'Ẹ kú, {$a}!';
$string['mobile_welcome_sub'] = 'Mo jẹ́ SOLA, olùrànlọ́wọ́ ẹ̀kọ́ rẹ. Báwo ni mo ṣe lè ràn ọ́ lọ́wọ́?';
...
$string['settings:xai_proxy_url_desc'] = 'URL wss ti gbogbogbò fún iṣẹ́ aṣojú xAI Realtime ti SOLA (fún àpẹẹrẹ wss://voice.example.com/xai-rt/rt). Nígbà tí a bá gbé èyí àti àṣírí JWT kalẹ̀, ohùn xAI ń kọjá nípasẹ̀ aṣojú náà, kọ́kọ́rọ́ API xAI ọ̀gá kò sì dé ojú-ìwé. Fi sílẹ̀ ní òfò láti padà sí ìsopọ̀ tààrà (a kò gbà á níyànjú fún ìmújáde).';
...
$string['settings:backend_retry_max_wait_desc'] = 'Ààlà òkè, ní àwọn ìṣẹ́jú-àáyá, lórí bí a ṣe pẹ́ tó láti bọ̀wọ̀ fún àkọlé Retry-After láti ọ̀dọ̀ backend kí a tó tún gbìyànjú. Nígbà tí backend kò bá fi Retry-After ránṣẹ́, SOLA máa ń lo backoff exponential kúkúrú dípò. Àpèjúwe 5.';
...
$string['emergency:title'] = 'SOLA Àwọn Ìṣàkóso Ìpayà';
$string['emergency:page_warning'] = 'Àwọn ọ̀nà yìí wà ní ipa lẹ́sẹ̀kẹsẹ̀ fún akẹ́kọ̀ọ́ gbogbo lórí ojú ìwé. Ìgbésẹ̀ kọ̀ọ̀kan kọ àwọn ìlà audit. Àwọn ọ̀nà alásọtẹ̀lẹ̀ jẹ́ kí iyókù SOLA ṣiṣẹ́; kill akọ́kọ́ mú widget kúrò lórí ojú gbogbo.';
...
$string['emergency:flag_chat_desc'] = 'Dí ìsànsé chat ní kill flag ìpínrẹ̀ (atunṣe v5.13). Widget máa ń ṣe títúnṣe; akẹ́kọ̀ọ́ máa ń rí ìfiránṣẹ́ àánú "SOLA ti dúró". Lo nígbà tí olùpèsè LLM ń ṣe àṣìṣe tàbí nígbà tí ìjà iye ń ṣẹlẹ̀.';
...
$string['emergency:flag_all_desc'] = 'Pa plugin gbogbo: widget tí kò sí lórí ojú gbogbo, àwọn iṣẹ́ tí a ṣètò dúró, voice pa, RAG pa, outreach pa. Ọ̀nà tó lágbára jùlọ — lo fún ìṣẹ̀lẹ̀ ààbò tàbí nígbà tí a gbọ́dọ̀ mú SOLA offline lẹ́sẹ̀kẹsẹ̀.';
$string['emergency:settings_link'] = 'Àwọn ìṣàkóso ìpayà';
$string['emergency:settings_link_desc'] = 'Àwọn ọ̀nà kill ẹ̀ka ọ̀nà (chat / voice / RAG / outreach / master) pẹ̀lú àkọsílẹ̀ audit — ìdọ́gba wẹ́ẹ̀bù ti <code>admin/cli/emergency_disable.php</code>. Ṣí <a href="{$a}">Àwọn Ìṣàkóso Ìpayà SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Ìfagilee ìforukọsílẹ̀';
$string['email_unsubscribe:done_body'] = 'Ó ti parí — {$a->email} kò ní gba irú ímeèlì yìí mọ́ láti ọ̀dọ̀ {$a->product}. Bí o bá yí èrò rẹ pa dà, béèrè lọ́wọ́ alábòójútó {$a->product} láti tún mú ìforukọsílẹ̀ ṣiṣẹ́, tàbí fi ìfọwọ́si tuntun ránṣẹ́ nípa ojú ewé admin SOLA Recipients.';
...
$string['settings:cost_anomaly_heading_desc'] = 'Iṣẹ́ tí a ṣètò ojoojúmọ́ (<code>cost_anomaly_check</code>) tí ó fi ìnáwó SOLA ojú ìwé lónìí ṣe ìfiwéra pẹ̀lú ìgbà-àárín rolling ọjọ́ 7. Máa ń fi ímeèlì ránṣẹ́ sí àkójọ olùgba <code>spend_notify_emails</code> nígbà tí lónìí bá rekọjá multiplier tí a ṣètò × ìgbà-àárín. Mú àwọn ìṣòro mẹ́ta tí àwọn ìwọ̀n 80% / 95% / 100% spend-cap tẹ́lẹ̀ ò gba: (1) ẹ̀kọ́ tí ń sáré, (2) jíjẹ́ kí ìpele premium ṣiṣẹ́ láìmọ̀, (3) misroute olùpèsè. Pa nígbà àpèjúwe.';
...
$string['analytics:exp_active_users'] = 'Awọn olumulo SOLA ti nṣiṣẹ';
