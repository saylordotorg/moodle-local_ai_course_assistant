...
$string['pedagogy:learning_path_desc'] = 'जब चालू होता है, तो SOLA एक दृश्य लर्निंग-पाथ पैनल जोड़ता है (विजेट हेडर में "मेरा पाथ" बटन) जो शिक्षार्थी के कार्यक्रम को कोर्सों के अनुक्रम के रूप में दिखाता है, जिनमें से प्रत्येक को उसके उद्देश्यों और शिक्षार्थी की महारत दिखाने के लिए विस्तृत किया जा सकता है। जब शिक्षार्थी वर्तमान कोर्स की सीमा पूरी कर लेता है (पूर्णता या महारत हासिल उद्देश्यों का उच्च हिस्सा), तो SOLA एक सौम्य "अगले कोर्स के लिए तैयार" बैनर भी दिखाता है और बातचीत में इसका उल्लेख करता है। केवल सलाहकारी; शिक्षार्थी के अपने कार्यक्रम आवंटन का उपयोग करता है; जहाँ कोई कार्यक्रम लागू नहीं होता वहाँ चुपचाप कुछ नहीं करता।';
...
$string['settings:backend_context_tokens_desc'] = 'आपके AI बैकएंड की अधिकतम संदर्भ लंबाई (max_model_len), टोकन में। बड़ी विंडो वाले होस्टेड मॉडलों के लिए 0 पर सेट करें (कोई क्लैम्पिंग नहीं)। जब 0 से ऊपर सेट किया जाता है (उदाहरण के लिए स्व-होस्टेड vLLM बैकएंड पर 8192), तो SOLA ऊपर दिए गए सिस्टम-प्रॉम्प्ट के वर्ण बजट को घटा देता है ताकि प्रॉम्प्ट के साथ आरक्षित आउटपुट और बातचीत का इतिहास विंडो में समा जाए, यहाँ तक कि टोकन-सघन भाषाओं में भी। यह समवर्ती उपयोगकर्ताओं से कैसे मेल खाता है, इसके लिए Deployment Sizing विकी पृष्ठ देखें।';
...
$string['settings:backend_retry_max_wait_desc'] = 'पुनः प्रयास करने से पहले बैकएंड से Retry-After हेडर का कितनी देर तक सम्मान करना है, इसकी ऊपरी सीमा, सेकंड में। जब बैकएंड कोई Retry-After नहीं भेजता, तो SOLA इसके बजाय एक छोटे एक्सपोनेंशियल बैकऑफ़ का उपयोग करता है। डिफ़ॉल्ट 5।';
...
$string['settings:stt_selfhosted_heading_desc'] = 'अपने स्वयं के हार्डवेयर पर शून्य प्रति-मिनट लागत पर वाक्-से-पाठ चलाएँ। SOLA को किसी भी OpenAI-संगत ट्रांसक्रिप्शन सर्वर पर इंगित करें: <code>whisper-server</code> Docker, <code>speaches</code> (faster-whisper), या <code>whisper.cpp</code> सर्वर। जब यहाँ सर्वर URL सेट किया जाता है तो यह डिफ़ॉल्ट STT पथ बन जाता है; ओवरराइड करने के लिए ऊपर सक्रिय STT प्रदाता में एक भुगतान प्रदाता चुनें। यदि सर्वर किसी निजी नेटवर्क या सादे http पर है, तो सुरक्षा अनुभाग में SSRF विश्वसनीय endpoints allowlist में उसका होस्ट भी जोड़ें।';
$string['settings:stt_selfhosted_url'] = 'स्व-होस्टेड STT सर्वर URL';
$string['settings:stt_selfhosted_url_desc'] = 'OpenAI-संगत ट्रांसक्रिप्शन सर्वर का base URL, उदाहरण के लिए <code>http://10.0.0.5:8000</code>। SOLA स्वचालित रूप से <code>/v1/audio/transcriptions</code> जोड़ता है; एक पूर्ण endpoint पथ भी स्वीकार किया जाता है। स्व-होस्टेड STT अक्षम करने के लिए खाली छोड़ें।';
...
$string['emergency:title'] = 'SOLA आपातकालीन नियंत्रण';
$string['emergency:page_warning'] = 'ये स्विच साइट पर हर शिक्षार्थी के लिए तुरंत प्रभावी होते हैं। प्रत्येक क्रिया एक ऑडिट पंक्ति लिखती है। ग्रैन्युलर स्विच SOLA के बाकी हिस्से को चालू रखते हैं; मास्टर kill widget को पूरी तरह हटा देता है।';
$string['emergency:back_to_settings'] = 'SOLA सेटिंग्स';
...
$string['emergency:flag_chat_desc'] = 'समर्पित kill flag के माध्यम से chat ट्रैफ़िक को ब्लॉक करता है (v5.13 सुधार)। Widget रेंडर करता रहता है; शिक्षार्थी मित्रवत "SOLA रुका हुआ" संदेश देखते हैं। जब कोई LLM प्रदाता गलत व्यवहार कर रहा हो या लागत में उछाल जारी हो तब उपयोग करें।';
...
$string['emergency:flag_all_desc'] = 'पूरे plugin को अक्षम करता है: widget हर पेज से गायब हो जाता है, शेड्यूल किए गए कार्य रुक जाते हैं, आवाज़ साफ़ होती है, RAG बंद, आउटरीच बंद। सबसे मज़बूत स्विच — किसी सुरक्षा घटना के लिए या जब SOLA को तुरंत ऑफलाइन करना हो तब उपयोग करें।';
$string['emergency:settings_link'] = 'आपातकालीन नियंत्रण';
$string['emergency:settings_link_desc'] = 'ऑडिट लॉगिंग के साथ प्रति-उपतंत्र kill स्विच (chat / आवाज़ / RAG / आउटरीच / मास्टर) — <code>admin/cli/emergency_disable.php</code> का वेब समकक्ष। <a href="{$a}">SOLA आपातकालीन नियंत्रण</a> खोलें।';
$string['email_unsubscribe:done_title'] = 'सदस्यता समाप्त';
$string['email_unsubscribe:done_body'] = 'हो गया — {$a->email} को अब {$a->product} से इस प्रकार का ईमेल प्राप्त नहीं होगा। यदि आप अपना मन बदलते हैं, तो सदस्यता पुनः सक्षम करने के लिए किसी {$a->product} व्यवस्थापक से अनुरोध करें, या SOLA Recipients व्यवस्थापक पेज के माध्यम से एक नया opt-in भेजें।';
...
$string['settings:cost_anomaly_heading_desc'] = 'दैनिक शेड्यूल किया गया कार्य (<code>cost_anomaly_check</code>) जो आज के साइट-व्यापी SOLA खर्च की तुलना 7-दिन के रोलिंग मीडियन से करता है। <code>spend_notify_emails</code> प्राप्तकर्ता सूची (साइट व्यवस्थापकों पर वापस आती है) को ईमेल करता है जब आज कॉन्फ़िगर किए गए गुणक × मीडियन से अधिक हो। तीन विफलता मोड पकड़ता है जो मौजूदा 80% / 95% / 100% spend-cap थ्रेशोल्ड चूक जाते हैं: (1) बेकाबू कोर्स जहाँ निरपेक्ष सीमा नहीं पार की जाती लेकिन एक कोर्स अचानक अपने सामान्य वॉल्यूम का 10x उत्पन्न करता है, (2) प्रीमियम tier का आकस्मिक सक्षम होना, (3) प्रदाता गलत रूटिंग। डिफ़ॉल्ट रूप से बंद; <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code> पर Redash क्वेरी का SOLA-में समकक्ष।';
...
$string['analytics:exp_active_users'] = 'सक्रिय SOLA उपयोगकर्ता';
