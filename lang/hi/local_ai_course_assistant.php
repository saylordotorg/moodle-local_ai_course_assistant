...
$string['settings:premium_escalation_model_desc'] = 'प्रीमियम प्रदाता को पास किया गया मॉडल नाम। A.10 bake-off के फ़ैसले के अनुसार डिफ़ॉल्ट <code>claude-opus-4-8</code>।';
...
$string['analytics_js:total_students'] = 'कुल छात्र';
$string['analytics_js:active_ai_users'] = 'सक्रिय AI उपयोगकर्ता';
$string['analytics_js:msgs_per_student'] = 'संदेश / छात्र';
