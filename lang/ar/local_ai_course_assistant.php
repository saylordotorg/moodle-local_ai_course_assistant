...
$string['settings:prompt_budget_mode_desc'] = 'كيفية تحديد ميزانية أحرف موجّه النظام. <strong>الاشتقاق من النموذج</strong> يحسب المساحة التي يوفّرها النموذج المُهيّأ فعليًا: نافذة سياقه مطروحًا منها الرد المحجوز وسجل المحادثة، ثم يستخدم الأكبر بين ذلك والميزانية الثابتة أدناه. هذا هو الإعداد الموصى به: فقد جرى ضبط رقم ثابت مرتين بقياس تهيئة واحدة، وتبيّن مرتين أنه أصغر من اللازم في تهيئة أخرى. <strong>ثابت</strong> يستخدم الرقم أدناه فقط. أمّا الخادم الذاتي الاستضافة فينبغي أن يضبط نافذة سياق الخلفية بدلًا من ذلك، ولها الأسبقية دائمًا.';
