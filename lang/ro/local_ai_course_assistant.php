...
$string['settings:backend_retry_max_wait_desc'] = 'Limita superioară, în secunde, a duratei de respectare a unui antet Retry-After de la backend înainte de reîncercare. Când backendul nu trimite Retry-After, SOLA folosește în schimb o scurtă temporizare exponențială. Implicit 5.';
