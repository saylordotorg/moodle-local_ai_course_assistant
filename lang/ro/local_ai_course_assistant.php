...
$string['emergency:title'] = 'Controale de urgență SOLA';
$string['emergency:page_warning'] = 'Aceste comutatoare intră în vigoare imediat pentru fiecare cursant de pe site. Fiecare acțiune scrie un rând de audit. Comutatoarele granulare lasă restul SOLA să funcționeze; uciderea master elimină widgetul complet.';
$string['emergency:back_to_settings'] = 'Setări SOLA';
...
$string['emergency:flag_chat_desc'] = 'Blochează traficul de chat prin flag-ul de kill dedicat (remediere v5.13). Widgetul continuă să se randeze; cursanții văd mesajul prietenos „SOLA în pauză". Utilizați când un furnizor LLM se comportă necorespunzător sau un vârf de costuri este în desfășurare.';
...
$string['emergency:flag_all_desc'] = 'Dezactivează întregul plugin: widgetul dispare de pe fiecare pagină, sarcinile programate se opresc, vocea este golită, RAG dezactivat, comunicarea dezactivată. Cel mai puternic comutator — utilizați pentru un incident de securitate sau când SOLA trebuie scos offline imediat.';
$string['emergency:settings_link'] = 'Controale de urgență';
$string['emergency:settings_link_desc'] = 'Comutatoare kill per-subsistem (chat / voce / RAG / comunicare / master) cu jurnalizare de audit — echivalentul web al <code>admin/cli/emergency_disable.php</code>. Deschideți <a href="{$a}">Controale de urgență SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Dezabonat';
$string['email_unsubscribe:done_body'] = 'Gata — {$a->email} nu va mai primi acest tip de e-mail de la {$a->product}. Dacă vă răzgândiți, cereți unui administrator {$a->product} să reactiveze abonamentul sau trimiteți un nou opt-in prin pagina SOLA Recipients din panoul de administrare.';
...
$string['analytics:exp_active_users'] = 'Utilizatori SOLA activi';
