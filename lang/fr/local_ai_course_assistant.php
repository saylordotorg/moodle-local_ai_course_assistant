...
$string['emergency:title'] = 'Contrôles d\'urgence SOLA';
$string['emergency:page_warning'] = 'Ces interrupteurs prennent effet immédiatement pour tous les apprenants du site. Chaque action écrit une ligne d\'audit. Les interrupteurs granulaires laissent le reste de SOLA fonctionner ; le kill maître supprime entièrement le widget.';
$string['emergency:back_to_settings'] = 'Paramètres SOLA';
...
$string['emergency:flag_chat_desc'] = 'Bloque le trafic de chat via le drapeau kill dédié (correctif v5.13). Le widget continue de s\'afficher ; les apprenants voient le message amical "SOLA en pause". À utiliser quand un fournisseur LLM se comporte mal ou qu\'un pic de coûts est en cours.';
...
$string['emergency:flag_all_desc'] = 'Désactive l\'ensemble du plugin : widget supprimé de toutes les pages, tâches planifiées arrêtées, voix effacée, RAG désactivé, communication désactivée. L\'interrupteur le plus puissant — à utiliser pour un incident de sécurité ou quand SOLA doit être mis hors ligne immédiatement.';
$string['emergency:settings_link'] = 'Contrôles d\'urgence';
$string['emergency:settings_link_desc'] = 'Interrupteurs kill par sous-système (chat / voix / RAG / communication / maître) avec journalisation d\'audit — l\'équivalent web de <code>admin/cli/emergency_disable.php</code>. Ouvrir <a href="{$a}">Contrôles d\'urgence SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Désinscription effectuée';
$string['email_unsubscribe:done_body'] = 'C\'est fait — {$a->email} ne recevra plus ce type d\'e-mail de la part de {$a->product}. Si vous changez d\'avis, demandez à un administrateur {$a->product} de réactiver l\'abonnement, ou envoyez un nouvel opt-in via la page d\'administration des destinataires SOLA.';
...
$string['settings:premium_escalation_heading_desc'] = 'Routage optionnel par tour vers un modèle premium (Claude Opus 4.8 par défaut) pour les prompts où le tier chat de base peine visiblement — typiquement les mathématiques multi-étapes, CS et le raisonnement scientifique. Résolu par le bake-off A.10 du 09/06/2026 : Opus 4.8 a remporté 14,97/15 contre 12,68/15 pour gpt-4o sur les prompts difficiles. Deux chemins de déclenchement : correspondances regex sur le message utilisateur, OU une liste d\'autorisation de cours qui escalade à chaque tour. Désactivé par défaut. À ~5 % d\'escalade, attendez ~700 $/mois à 100 000 Saylor MAU en plus des dépenses de chat de base.';
...
$string['settings:cost_anomaly_heading_desc'] = 'Tâche planifiée quotidienne (<code>cost_anomaly_check</code>) qui compare les dépenses SOLA du site d\'aujourd\'hui à la médiane glissante sur 7 jours. Envoie un e-mail à la liste de destinataires <code>spend_notify_emails</code> (revenant aux administrateurs du site) quand aujourd\'hui dépasse le multiplicateur configuré × la médiane. Détecte trois modes de défaillance que les seuils 80 % / 95 % / 100 % du plafond de dépenses existant ne détectent pas : (1) cours emballé où le plafond absolu n\'est pas franchi mais un seul cours génère soudainement 10 fois son volume habituel, (2) activation accidentelle du tier premium, (3) mauvais routage fournisseur. Désactivé par défaut ; l\'équivalent interne à SOLA de la requête Redash de <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
...
$string['analytics:exp_active_users'] = 'Utilisateurs SOLA actifs';
