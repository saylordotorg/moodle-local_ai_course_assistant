...
$string['settings:backend_retry_max_wait_desc'] = 'Limite supérieure, en secondes, du temps pendant lequel honorer un en-tête Retry-After du backend avant de réessayer. Lorsque le backend n\'envoie aucun Retry-After, SOLA utilise à la place un court délai exponentiel. Par défaut 5.';
