...
$string['settings:backend_retry_max_wait_desc'] = 'Daangaa ol\'aanaa, sekoondiidhaan, irra deebi\'uun dura mata-duree Retry-After baackandii irraa hammam dheeraa kabajamu. Yeroo baackandiin Retry-After hin ergine, SOLA qooda isaa baakooffii eksipooneenshiyaalii gabaabaa fayyadama. Durtii 5.';
...
$string['emergency:title'] = 'SOLA Qindaa\'inoota Yeroo Balaa';
$string['emergency:page_warning'] = 'Geejjibbiiwwan kun battalumatti barataa marsaa irra jiru hundaaf hojiirra oolu. Gochaan tokko tokko tarree audit katabaa. Geejjibbiiwwan bal\'aan SOLA hafu hojjechaa jiru dhiisu; ajajni guyyaa guutuu widget guutuu fuula irraa kaasa.';
...
$string['emergency:flag_chat_desc'] = 'Daandii chat kill flag addaa (v5.13 sirreeffama) dhaan cufaa. Widget hojjechaa itti fufa; barattoonni ergaa gaarii "SOLA dhaabate" arguu. LLM fornidarii badaa ta\'u ykn baasii olfufiinsa jirtu yeroo fayyadami.';
...
$string['emergency:flag_all_desc'] = 'Plugin guutuu cufaa: widget fuula hundaa irraa dhabama, hojiileen qindaa\'an dhaabatu, voice kassa, RAG cufame, outreach cufame. Geejjibbii jabaadha — balaa nageenyaa ykn SOLA battalumatti offline ta\'uu qabdu yeroo fayyadami.';
$string['emergency:settings_link'] = 'Qindaa\'inoota yeroo balaa';
$string['emergency:settings_link_desc'] = 'Geejjibbiiwwan kill sadarkaa tokkoo tokkoo (chat / voice / RAG / outreach / master) audit loggingiin — walfakkaata web <code>admin/cli/emergency_disable.php</code>. <a href="{$a}">SOLA Qindaa\'inoota Yeroo Balaa</a> bani.';
$string['email_unsubscribe:done_title'] = 'Galmee ba\'ame';
$string['email_unsubscribe:done_body'] = 'Xumurame — {$a->email} irraanfatoo gosa imeelii kanaa {$a->product} irraa hin fudhatu. Yaada kee yoo jijjiirte, galmeessa deebi\'sisuuf bulchaa {$a->product} gaafadhu, ykn fuula admin SOLA Recipients dhaan filannoowwan galmeessuu haaraa ergadi.';
...
$string['settings:premium_escalation_model_desc'] = 'Maqaa modeelii fornidarii premiuumitti ergamu. Durtii <code>claude-opus-4-8</code> murtoo A.10 bake-off irratti hundaa\'uun.';
...
$string['settings:cost_anomaly_heading_desc'] = 'Hojii qindaa\'uu guyyaa guyyaa (<code>cost_anomaly_check</code>) baasii SOLA marsaa marsaa guyyaa har\'aa median rolling 7-guyyaa waliin wal-bira qabu. Tarree fudhataa <code>spend_notify_emails</code> imeelii ergiti (bulchaa marsaatti deebi\'uun) guyyaa har\'aa multiplier × median qaqqabe yeroo. Garagalchi sadii dhaabbiiwwan 80% / 95% / 100% spend-cap daangaa jiran: (1) koorsii dadhabiinsa koorsii tokkoo ol-guddina isaa dhaala ceiling dhufuu dhabee baay\'oo guddaa, (2) dandeessisuu sadarkaa premium doo\'amiinsa, (3) fornidarii misroute. Durtii cufaa; walfakkaata SOLA keessaa gaaffii Redash <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code> irratti.';
...
$string['analytics:exp_active_users'] = 'Fayyadamtoota SOLA hojii irra jiran';
