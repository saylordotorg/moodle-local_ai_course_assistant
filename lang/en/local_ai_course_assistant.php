...
$string['selftest:storage_intro']  = 'Round-trips a small test object through the configured bucket: upload, size check, download with a byte comparison, delete, then a re-check that it is gone. Each step is reported separately, because which one fails is the diagnosis. This performs real writes and deletes under a __selftest/ prefix.';
