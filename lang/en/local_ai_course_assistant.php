...
$string['settings:profile_update_interval_desc'] = 'After this many student messages in a course, the assistant generates (or refreshes) a learning profile summarising the student\'s strengths, weaknesses, learning style, and interests. The profile is injected into the system prompt for personalised responses. Set to 0 to disable. Default: 10.';
...
$string['settings:attachments_heading'] = 'Student attachments';
$string['settings:attachments_heading_desc'] = 'Let students attach an image or PDF to their chat messages. Images are sent to multimodal providers (OpenAI, Anthropic, Gemini, xAI); PDFs are always text-extracted on the server so every provider can read them.';
$string['settings:allow_student_attachments'] = 'Allow attachments';
$string['settings:allow_student_attachments_desc'] = 'When enabled, students see a paperclip button in the chat composer. Files are stored under the course context and linked from their message bubble.';
$string['settings:attachment_max_size_mb'] = 'Max attachment size (MB)';
$string['settings:attachment_max_size_mb_desc'] = 'Hard cap on the size of an individual attachment. Clamped to 1–25 MB at runtime.';
$string['settings:attachment_allowed_types'] = 'Allowed MIME types';
$string['settings:attachment_allowed_types_desc'] = 'Comma-separated MIME allowlist. The server also sniffs the uploaded file; a spoofed Content-Type will be rejected.';
