...
$string['settings:default_course_mode_desc'] = 'Controla si [[tutorshort]] aparece en un curso cuando no se ha hecho una elección específica para ese curso. Las instalaciones nuevas tienen por defecto "Deshabilitado por defecto" para que los administradores puedan activar curso por curso desde la página de Analytics o la página de Course AI Settings.';
...
$string['coursesettings:sola_enabled'] = '[[tutorshort]] en este curso';
$string['coursesettings:sola_enabled_toggle'] = 'Mostrar el widget de [[tutorshort]] en este curso';
$string['coursesettings:sola_enabled_desc'] = 'Controla si el widget de chat de [[tutorshort]] aparece en este curso. El valor predeterminado para todo el sitio se establece en la configuración del plugin en General > Default for new courses.';
...
$string['chat:greeting'] = '¡Hola, {$a}! Soy [[tutorshort]]. ¿Cómo puedo ayudarte hoy?';
...
$string['chat:voice_speaking'] = '[[tutorshort]] está hablando...';
$string['chat:voice_idle'] = 'Listo';
$string['chat:voice_error'] = 'Error de conexión de voz. Por favor, revisa tu configuración.';
$string['chat:quiz_locked'] = '[[tutorshort]] está en pausa durante los cuestionarios para apoyar la integridad académica. ¡Buena suerte!';
...
$string['settings:cdn_heading_desc'] = 'Servir los recursos frontend de [[tutorshort]] (JS/CSS) desde un CDN externo en lugar del sistema de archivos de Moodle. Esto permite actualizaciones del frontend sin actualizar el plugin. Deje la URL del CDN vacía para usar los archivos locales del plugin.';
...
$string['chat:voice_title'] = 'Habla con [[tutorshort]]';
...
$string['mobile_disabled'] = '[[tutorshort]] no está disponible para este curso.';
$string['mobile_placeholder'] = 'Haz una pregunta...';
$string['mobile_welcome'] = '¡Hola, {$a}!';
$string['mobile_welcome_sub'] = 'Soy [[tutorshort]], tu asistente de aprendizaje. ¿Cómo puedo ayudarte?';
...
$string['settings:rag_return_scope'] = 'Ámbito de retorno de recuperación';
$string['settings:rag_return_scope_desc'] = 'Qué se inyecta para cada resultado recuperado. "chunk" (predeterminado) inyecta el fragmento coincidente de unas 400 palabras. "window" inyecta el fragmento coincidente más los fragmentos vecinos de la misma página. "page" inyecta toda la página del módulo a la que pertenece el resultado. window/page ayudan cuando una respuesta abarca toda una página, a costa de un prompt más grande.';
$string['settings:rag_window_size'] = 'Tamaño de la ventana de recuperación';
$string['settings:rag_window_size_desc'] = 'Para el ámbito de retorno "window": número de fragmentos vecinos que se incluirán a cada lado de un fragmento coincidente. Predeterminado 1.';
$string['settings:rag_parent_max_chars'] = 'Límite del pasaje principal (caracteres)';
$string['settings:rag_parent_max_chars_desc'] = 'Número máximo de caracteres para un pasaje window/page ampliado. Las páginas que superan el límite recurren a una ventana y, después, al fragmento único. Predeterminado 6000.';
...
$string['demo:course_fullname'] = 'Curso de pruebas [[tutorshort]] (oculto)';
...
$string['chat:consent_body'] = '{$a->product} es un asistente de aprendizaje impulsado por IA. Tus mensajes y las respuestas de {$a->product} se almacenan en la base de datos Moodle de {$a->institution} y los diez turnos más recientes se envían a un proveedor de modelos de IA aprobado para responder tus preguntas. Tu nombre se comparte para la personalización; no se envía ninguna otra información identificativa al proveedor de IA. Si solicitas ayuda humana y tu pregunta es escalada, esta conversación (incluidos tu nombre y correo electrónico) puede compartirse con nuestro equipo de soporte. Puedes descargar, eliminar o dejar de usar {$a->product} en cualquier momento.';
...
$string['settings:current_page_content_maxchars_desc'] = 'Número máximo de caracteres del texto de la página actual que se inyecta en el prompt del sistema como la sección "Contenido de la página actual", cuando RAG está desactivado. El valor predeterminado de 8,000 fundamenta bien las preguntas específicas de la página dejando margen para la estructura y las instrucciones. (Con RAG activado, la página se fundamenta en cambio mediante sus propios fragmentos más relevantes, sesgados hacia la página actual, por lo que este límite no se aplica). Una página muy larga se trunca por el principio hasta esta cantidad de caracteres, por lo que el final de una página extremadamente larga podría no citarse; activar RAG evita eso. Los sitios atentos al costo pueden reducirlo (p. ej. 3,000-4,000). Limitado al rango 500-8,000. Independiente de <code>prompt_budget_chars</code>: esto limita solo la sección de la página; el presupuesto limita todo el prompt.';
...
$string['settings:backend_context_tokens'] = 'Ventana de contexto del backend (tokens)';
$string['settings:backend_context_tokens_desc'] = 'La longitud máxima de contexto (max_model_len) de tu backend de IA, en tokens. Establécela en 0 para modelos alojados con una ventana amplia (sin recorte). Cuando se establece por encima de 0 (por ejemplo, 8192 en un backend vLLM autoalojado), [[tutorshort]] reduce el presupuesto de caracteres del prompt del sistema indicado arriba para que el prompt más la salida reservada y el historial de conversación quepan en la ventana, incluso en idiomas con alta densidad de tokens. Consulta la página wiki de Dimensionamiento de Despliegue para ver cómo se relaciona esto con los usuarios concurrentes.';
$string['settings:backend_retry_attempts'] = 'Intentos de reintento del backend';
$string['settings:backend_retry_attempts_desc'] = 'Cuántas veces reintentar un error transitorio del backend (HTTP 429 o 503) antes de mostrar un error al estudiante. Los reintentos solo ocurren antes de que se haya transmitido cualquier texto de respuesta, por lo que la salida nunca se duplica. Está orientado a backends pequeños autoalojados que rechazan solicitudes bajo carga. Establécelo en 0 para desactivarlo. Predeterminado: 2.';
$string['settings:backend_retry_max_wait'] = 'Espera máxima de reintento del backend (segundos)';
$string['settings:backend_retry_max_wait_desc'] = 'Límite superior, en segundos, del tiempo que se respeta una cabecera Retry-After del backend antes de reintentar. Cuando el backend no envía Retry-After, [[tutorshort]] utiliza en su lugar un breve retroceso exponencial. Predeterminado: 5.';
$string['prompt:truncation_hint'] = 'NOTA: No se pudo buscar todo el contenido del curso en este turno debido a límites de longitud. Si el estudiante pregunta por algo que no puedes encontrar en el contenido proporcionado, indica que no pudiste buscar en todo el curso y sugiere que abra la página o actividad específica donde se trata el tema, en lugar de afirmar que está ausente del curso.';
$string['selftest:title'] = 'Autodiagnóstico del backend';
$string['selftest:intro'] = 'Ejecuta una comprobación en vivo de tu backend de IA configurado: una pequeña ida y vuelta de chat, detección automática de la ventana de contexto (max_model_len) y una comparación con tu ajuste de Ventana de contexto del backend, el mínimo del presupuesto del prompt del sistema y (cuando RAG está activado) una ida y vuelta de embeddings. Las llamadas de red se ejecutan solo cuando pulsas Ejecutar.';
$string['selftest:run'] = 'Ejecutar autodiagnóstico del backend';
$string['selftest:check'] = 'Comprobación';
$string['selftest:status'] = 'Estado';
$string['selftest:detail'] = 'Detalle';
$string['selftest:link'] = 'Página de autodiagnóstico del backend';
$string['selftest:link_desc'] = 'Abre la página de <a href="{$a}">Autodiagnóstico del backend</a> para verificar que tu backend de IA funciona y está dimensionado correctamente. Útil justo después de configurar un backend autoalojado.';
$string['profile:title'] = 'Preajustes de despliegue';
$string['profile:intro'] = 'Aplica un paquete recomendado de ajustes para tu tipo de despliegue. Los valores se escriben en los ajustes normales del plugin y permanecen editables individualmente después. Aplicar un preajuste sobrescribe los ajustes listados.';
$string['profile:current'] = 'Último preajuste aplicado: {$a}';
$string['profile:setting'] = 'Ajuste';
$string['profile:value'] = 'Valor';
$string['profile:self_hosted_small'] = 'Contexto pequeño autoalojado (GPU única, p. ej. A30 24GB / vLLM a 8K)';
$string['profile:hosted_large'] = 'Contexto grande alojado (predeterminado)';
$string['profile:apply_self_hosted_small'] = 'Aplicar preajuste de contexto pequeño autoalojado';
$string['profile:apply_hosted_large'] = 'Aplicar valores predeterminados de contexto grande alojado';
$string['profile:applied'] = 'Se aplicó el preajuste {$a}. Los valores están ahora en los ajustes de tu plugin.';
$string['profile:unknown'] = 'Preajuste de despliegue desconocido.';
$string['profile:link'] = 'Página de preajustes de despliegue';
$string['profile:link_desc'] = 'Abre la página de <a href="{$a}">Preajustes de despliegue</a> para aplicar un paquete recomendado de ajustes para un backend alojado o autoalojado.';
$string['settings:zendesk_require_consent'] = 'Requerir consentimiento antes de escalar al soporte';
$string['settings:zendesk_require_consent_desc'] = 'Cuando está activado (recomendado), [[tutorshort]] escala una conversación al servicio de soporte de Zendesk solo después de que el estudiante haya aceptado el aviso de consentimiento de primera ejecución, que revela que solicitar ayuda humana comparte la conversación (incluidos el nombre y el correo electrónico) con el soporte. Desactívalo solo si obtienes ese consentimiento de otra manera; con esto desactivado, las escalaciones se envían de inmediato. No tiene efecto a menos que la escalación a Zendesk esté habilitada.';
$string['chat:escalation_needs_consent'] = 'Parece que esto necesita a un miembro de nuestro equipo de soporte. Para remitírselo, tendría que compartir esta conversación, incluidos tu nombre y correo electrónico, con el servicio de soporte. Aún no has aceptado eso, así que no he enviado nada. Si deseas ayuda humana, acepta el aviso de uso compartido de datos de este asistente y vuelve a preguntar, o contacta directamente con el soporte.';
$string['privacy:metadata:email_optout'] = 'Preferencias de exclusión de correo electrónico por destinatario (de qué tipos de correo se ha dado de baja un destinatario).';
...
$string['settings:rag_min_similarity'] = 'Relevancia mínima (coseno)';
$string['settings:rag_min_similarity_desc'] = 'Descarta los fragmentos recuperados cuya similitud de coseno con la pregunta esté por debajo de este valor, de modo que una pregunta fuera de tema o dispersa inyecte menos pasajes (o ninguno) en lugar de rellenar siempre hasta Top-K con coincidencias débiles. Rango de 0 a 1; 0 desactiva el filtro. El valor adecuado depende del modelo de embedding: 0.25 es apropiado para text-embedding-3-small. Súbelo para ser más estricto (menos contexto, más centrado en el tema), bájalo para ser más permisivo.';
$string['settings:rag_currentpage_boost'] = 'Bonificación de la página actual';
$string['settings:rag_currentpage_boost_desc'] = 'Una pequeña bonificación añadida a la puntuación de relevancia de los fragmentos de la página que el estudiante está viendo actualmente, de modo que preguntas como "explica esto" prefieran la página visible cuando las puntuaciones están próximas. Solo afecta al orden: no fuerza el paso de un fragmento de página irrelevante por encima del filtro de relevancia mínima. Establece 0 para desactivarla.';
$string['settings:history_mode'] = 'Modo de selección del historial';
$string['settings:history_mode_desc'] = 'Cómo se eligen los turnos de conversación anteriores antes de enviarse al modelo. <strong>Semántico</strong> conserva solo los turnos recientes relevantes para la pregunta actual (y siempre el intercambio más reciente), de modo que un turno anterior obsoleto y fuera de tema no infle el costo ni desvíe la respuesta; realiza una llamada de embedding adicional por mensaje. <strong>Recencia</strong> conserva los últimos pares de "Historial máximo de conversación" sin importar su relevancia (el comportamiento de siempre, sin llamada adicional). Si el embedding no está disponible, el modo semántico recurre automáticamente a la recencia.';
$string['settings:history_mode_semantic'] = 'Semántico (turnos recientes relevantes)';
$string['settings:history_mode_recency'] = 'Recencia (últimos N pares)';
$string['settings:history_semantic_minscore'] = 'Umbral de relevancia del historial (coseno)';
$string['settings:history_semantic_minscore_desc'] = 'En el modo de historial semántico, un turno anterior se conserva solo si su similitud con la pregunta actual es al menos este valor (el intercambio más reciente siempre se conserva). Rango de 0 a 1; depende del modelo. Súbelo para ser más estricto (menos historial), bájalo para conservar más.';
$string['settings:history_candidates'] = 'Ventana de candidatos del historial';
$string['settings:history_candidates_desc'] = 'En el modo de historial semántico, solo se puntúa la relevancia de los pares más recientes hasta esta cantidad (un límite de costo). Los pares anteriores a esta ventana no se envían. Mantén este valor en o por encima de "Historial máximo de conversación".';

// v5.11.0 - v6.2.0 strings (added 2026-06-10).
$string['settings:embed_provider_voyage'] = 'Voyage AI (voyage-3.5 — recomendado; +4 MTEB vs OpenAI 3-small, 4x contexto, multilingüe)';
$string['settings:rerank_heading'] = 'RAG: Recuperación en dos etapas (reordenamiento)';
$string['settings:rerank_heading_desc'] = 'Segunda etapa de recuperación opcional: la similitud coseno selecciona los N fragmentos candidatos superiores (por defecto 50), luego un reordenador de codificador cruzado puntúa cada par (consulta, fragmento) y los mejores K entran en el prompt. Desactivado por defecto; cae a coseno de una sola etapa si el reordenador no está configurado o falla.';
$string['settings:rerank_enabled'] = 'Recuperación en dos etapas (Voyage rerank-2.5)';
$string['settings:rerank_enabled_desc'] = 'Cuando está activado, la recuperación RAG se convierte en dos etapas: la similitud coseno devuelve los N candidatos superiores (por defecto 50), luego el codificador cruzado Voyage rerank-2.5 puntúa cada uno y los K superiores entran en el prompt. Mejoras publicadas: +15 Recall@10 empresarial, +39% NDCG BEIR. ~$0,05/MTok de facturación. Requiere <code>rerank_apikey</code> más abajo; cae correctamente a coseno de una sola etapa si el reordenamiento falla o no está configurado.';
$string['settings:rerank_apikey'] = 'Clave API de reordenamiento';
$string['settings:rerank_apikey_desc'] = 'Clave API de Voyage AI para rerank-2.5. Déjela en blanco para reutilizar la clave API de embedding de arriba (los despliegues típicos de Voyage comparten una clave entre embed y rerank).';
$string['settings:rerank_model'] = 'Modelo de reordenamiento';
$string['settings:rerank_model_desc'] = 'Por defecto <code>rerank-2.5</code>. Aquí se pueden especificar modelos de reordenamiento Voyage más recientes.';
$string['settings:rerank_apibaseurl'] = 'URL base de la API de reordenamiento';
$string['settings:rerank_apibaseurl_desc'] = 'Anula la URL base de reordenamiento de Voyage. Déjela en blanco para usar la URL base de la API de embedding de arriba, o el valor predeterminado de Voyage (<code>https://api.voyageai.com/v1</code>).';
$string['settings:rerank_candidates'] = 'Ventana de candidatos para reordenamiento';
$string['settings:rerank_candidates_desc'] = 'Cuántos candidatos coseno N superiores se envían a la etapa de reordenamiento. Por defecto 20. Medido en 1.008 consultas: 20 iguala a 30 en exhaustividad (R@3 89,0 % frente a 89,3 %) con un tercio menos de coste, y 50 cuesta 2,5 veces más sin ganancia medible. Por debajo de 10 la exhaustividad se degrada. El coste crece de forma lineal con este valor.';
$string['settings:stt_selfhosted_heading'] = 'Transcripción autoalojada (Whisper)';
$string['settings:stt_selfhosted_heading_desc'] = 'Ejecute la conversión de voz a texto en su propio hardware a coste cero por minuto. Apunte [[tutorshort]] a cualquier servidor de transcripción compatible con OpenAI: Docker de <code>whisper-server</code>, <code>speaches</code> (faster-whisper) o servidor <code>whisper.cpp</code>. Cuando se establece una URL de servidor aquí, se convierte en la ruta STT predeterminada; seleccione un proveedor de pago en Proveedor STT activo arriba para anularlo. Si el servidor está en una red privada o http simple, también añada su host a la lista de endpoints de confianza para SSRF en la sección de Seguridad.';
$string['settings:stt_selfhosted_url'] = 'URL del servidor STT autoalojado';
$string['settings:stt_selfhosted_url_desc'] = 'URL base del servidor de transcripción compatible con OpenAI, por ejemplo <code>http://10.0.0.5:8000</code>. [[tutorshort]] añade <code>/v1/audio/transcriptions</code> automáticamente; también se acepta una ruta de endpoint completa. Déjela vacía para desactivar el STT autoalojado.';
$string['settings:stt_selfhosted_model'] = 'Modelo STT autoalojado';
$string['settings:stt_selfhosted_model_desc'] = 'Nombre del modelo pasado al servidor, que coincida con el modelo Whisper que tiene cargado — por ejemplo <code>Systran/faster-whisper-small</code> para speaches o <code>large-v3</code>. Déjelo vacío para enviar <code>whisper-1</code>, que la mayoría de los servidores autoalojados aceptan o ignoran.';
$string['settings:stt_selfhosted_apikey'] = 'Clave API STT autoalojada';
$string['settings:stt_selfhosted_apikey_desc'] = 'Opcional. La mayoría de los servidores autoalojados no requieren clave en redes de confianza; establézcala solo si su servidor requiere un token bearer.';
$string['emergency:title'] = 'Controles de emergencia de [[tutorshort]]';
$string['emergency:page_warning'] = 'Estos interruptores surten efecto de inmediato para todos los estudiantes del sitio. Cada acción escribe una fila de auditoría. Los interruptores detallados dejan el resto de [[tutorshort]] en funcionamiento; el kill maestro elimina el widget completamente.';
$string['emergency:back_to_settings'] = 'Configuración de [[tutorshort]]';
$string['emergency:state_disabled'] = 'DESACTIVADO';
$string['emergency:state_active'] = 'Activo';
$string['emergency:confirm_label'] = 'Entiendo que esto afecta a todos los estudiantes de inmediato';
$string['emergency:confirm_required'] = 'Por favor, marque la casilla de confirmación antes de desactivar un subsistema.';
$string['emergency:reason_placeholder'] = 'Motivo (registrado en el registro de auditoría)';
$string['emergency:disable_button'] = 'Desactivar';
$string['emergency:restore_button'] = 'Restaurar';
$string['emergency:disabled_notice'] = 'Subsistema "{$a->flag}" desactivado. Configuración modificada: {$a->touched}';
$string['emergency:restored_notice'] = 'Subsistema "{$a->flag}" restaurado. Configuración modificada: {$a->touched}';
$string['emergency:cli_reference'] = 'Los mismos controles están disponibles desde el shell de guardia:';
$string['emergency:flag_chat'] = 'Chat';
$string['emergency:flag_chat_desc'] = 'Bloquea el tráfico de chat mediante el indicador de kill dedicado (corrección v5.13). El widget sigue renderizándose; los estudiantes ven el mensaje amigable "[[tutorshort]] pausado". Úselo cuando un proveedor de LLM se comporta mal o hay un pico de costes en curso.';
$string['emergency:flag_voice'] = 'Voz';
$string['emergency:flag_voice_desc'] = 'Borra el proveedor de voz en tiempo real activo (guardado para restauración exacta). El chat de texto sigue funcionando.';
$string['emergency:flag_rag'] = 'RAG';
$string['emergency:flag_rag_desc'] = 'Desactiva la recuperación y la indexación. El chat continúa sin anclaje en el contenido del curso.';
$string['emergency:flag_outreach'] = 'Difusión';
$string['emergency:flag_outreach_desc'] = 'Detiene los correos de resumen, hitos y recordatorios. El chat no se ve afectado.';
$string['emergency:flag_all'] = 'KILL MAESTRO';
$string['emergency:flag_all_desc'] = 'Desactiva el plugin completo: el widget desaparece de todas las páginas, las tareas programadas se detienen, la voz se borra, RAG desactivado, difusión desactivada. El interruptor más potente — úselo para un incidente de seguridad o cuando [[tutorshort]] deba desconectarse de inmediato.';
$string['emergency:settings_link'] = 'Controles de emergencia';
$string['emergency:settings_link_desc'] = 'Interruptores de kill por subsistema (chat / voz / RAG / difusión / maestro) con registro de auditoría — el equivalente web de <code>admin/cli/emergency_disable.php</code>. Abrir <a href="{$a}">Controles de emergencia de [[tutorshort]]</a>.';
$string['email_unsubscribe:done_title'] = 'Cancelada la suscripción';
$string['email_unsubscribe:done_body'] = 'Listo — {$a->email} ya no recibirá este tipo de correo electrónico de {$a->product}. Si cambia de opinión, pida a un administrador de {$a->product} que reactive la suscripción, o envíe un nuevo opt-in a través de la página de administración de Destinatarios de [[tutorshort]].';
$string['email_unsubscribe:invalid_title'] = 'El enlace de cancelación ya no es válido';
$string['email_unsubscribe:invalid_body'] = 'Este enlace de cancelación ha caducado o no tiene el formato correcto. Busque un correo más reciente de nuestra parte, o contacte con un administrador del sitio para que le eliminen manualmente.';
$string['settings:prompt_proportions_heading'] = 'Proporciones de secciones del prompt (v5.6.0)';
$string['settings:prompt_proportions_heading_desc'] = 'Asigne el presupuesto del prompt del sistema entre cuatro bloques: seguridad + identidad, estructura del curso, contenido del curso y página actual. Los pesos son porcentajes que suman 100. Los valores predeterminados ajustados empíricamente (10 / 10 / 40 / 40) provienen del benchmark de ajuste de pesos v5.6.0; dejar el área de texto en blanco usa esos valores predeterminados. El impulso automático ajusta la asignación por turno según si hay una página específica en el ámbito.';
$string['settings:prompt_section_weights'] = 'Pesos de sección base (JSON)';
$string['settings:prompt_section_weights_desc'] = 'Objeto JSON opcional que asigna a cada bloque un porcentaje. Déjelo en blanco para usar los valores predeterminados del benchmark (10 / 10 / 40 / 40). Ejemplo: <code>{"safety_identity": 10, "course_structure": 10, "course_content": 40, "current_page": 40}</code>. Los pesos deben sumar 100 (±5%). <code>safety_identity</code> tiene un mínimo del 10% para que la resistencia a jailbreak y los marcadores de formato de salida siempre queden completos. <code>current_page + course_content</code> debe ser al menos el 40% para que el modelo tenga material sustantivo en el que anclarse. Los valores fuera de rango vuelven silenciosamente a los valores predeterminados del benchmark; los administradores deben validar comprobando el registro de depuración del prompt tras guardar.';
$string['settings:prompt_context_boost_mode'] = 'Modo de impulso de contexto';
$string['settings:prompt_context_boost_mode_desc'] = 'Ajuste automático que desplaza el peso hacia la sección de página actual cuando hay una página específica en el ámbito, y hacia el contenido del curso cuando no hay ninguna página seleccionada. <strong>page_focus</strong> (por defecto) desplaza unos 15 puntos de peso. <strong>aggressive</strong> desplaza 25 puntos y es mejor cuando los estudiantes hacen preguntas consistentemente específicas de la página. <strong>off</strong> desactiva el impulso; los pesos base establecidos por el administrador se aplican en cada turno independientemente del contexto de la página.';
$string['settings:prompt_context_boost_off'] = 'Desactivado (usar pesos base en cada turno)';
$string['settings:prompt_context_boost_page_focus'] = 'Enfoque de página (por defecto, desplazamiento de ~15 puntos)';
$string['settings:prompt_context_boost_aggressive'] = 'Agresivo (desplazamiento de ~25 puntos)';
$string['settings:prompt_section_weights_coach'] = 'Anulación en modo entrenador (JSON, opcional)';
$string['settings:prompt_section_weights_coach_desc'] = 'Objeto JSON opcional que anula los pesos de sección base específicamente durante el modo de entrenador de cuestionario evaluado (cuando <code>quizmode=coach</code>). Útil para forzar una asignación más pesada de <code>current_page</code> durante los cuestionarios sin afectar al chat normal. Déjelo en blanco para heredar los pesos base. Las mismas reglas de validación que la configuración base.';
$string['prompt_debug_view:title'] = 'Visor del registro de depuración del prompt';
$string['prompt_debug_view:subtitle'] = 'Prompt del sistema ensamblado por turno + desglose por sección + historial de conversación + mensaje actual del usuario + metadatos de adjuntos, exactamente como los recibió el modelo. Use esto para verificar si una sección como Contenido de la página actual realmente entró en el prompt y para depurar problemas de calidad de respuesta sin acceder al servidor por SSH.';
$string['prompt_debug_view:disabled'] = 'El registro de depuración del prompt está actualmente DESACTIVADO. No se escribirán nuevas entradas hasta que se active.';
$string['prompt_debug_view:enable_link'] = 'Abra la configuración del plugin para activar "Registrar el prompt del sistema ensamblado en archivo".';
$string['prompt_debug_view:no_log_yet'] = 'Todavía no hay archivo de registro. Envíe al menos un turno de chat después de activar el registro de depuración; el archivo se crea en la primera escritura.';
$string['prompt_debug_view:empty'] = 'El archivo de registro existe pero está vacío. Envíe un turno de chat y actualice.';
$string['prompt_debug_view:file_status'] = 'Tamaño del archivo de registro';
$string['prompt_debug_view:showing'] = 'Mostrando las entradas más recientes (más nuevas primero), límite';
$string['prompt_debug_view:total'] = 'Prompt total';
$string['prompt_debug_view:budget'] = 'Presupuesto en la captura';
$string['prompt_debug_view:sections'] = 'Secciones (por categoría)';
$string['prompt_debug_view:assembled_prompt'] = 'Prompt del sistema ensamblado';
$string['prompt_debug_view:history'] = 'Historial de conversación enviado al modelo';
$string['prompt_debug_view:current_message'] = 'Mensaje actual del usuario';
$string['prompt_debug_view:attachment'] = 'Metadatos del adjunto';
$string['prompt_debug_view:show_more'] = 'Mostrar más entradas';
$string['settings:mastery_classifier_provider'] = 'Proveedor del clasificador';
$string['settings:mastery_classifier_provider_desc'] = 'ID de proveedor usado para el clasificador de dominio por turno. Déjelo vacío para heredar el proveedor de IA predeterminado. El valor predeterminado <code>openai</code> se combina con el modelo de clasificador <code>gpt-4o-mini</code> de abajo — la opción TIER 1 más económica para clasificación de salida estructurada (~$220/mes de ahorro a 100k MAU frente al tier de chat). Cuando se establece, la fila en Proveedores de comparación con este ID de proveedor proporciona la clave API, la URL base y la temperatura.';
$string['settings:premium_escalation_heading'] = 'Tier de escalada premium (A.10)';
$string['settings:premium_escalation_heading_desc'] = 'Enrutamiento opcional por turno a un modelo premium (Claude Opus 4.8 por defecto) para prompts donde el tier de chat de trabajo visible tiene dificultades — típicamente matemáticas de varios pasos, CS y razonamiento científico. Resuelto por el bake-off A.10 del 2026-06-09: Opus 4.8 ganó con 14,97/15 vs 12,68/15 de gpt-4o en prompts difíciles. Dos rutas de activación: coincidencias de regex en el mensaje del usuario, O una lista de cursos permitidos que escala cada turno. Desactivado por defecto. Con ~5% de escalada, espere ~$700/mes a 100k [[unishort]] MAU además del gasto base de chat.';
$string['settings:premium_escalation_enabled'] = 'Activar enrutamiento de escalada premium';
$string['settings:premium_escalation_enabled_desc'] = 'Cuando está activado, el enrutador por turno comprueba la lista de regex de activación y la lista de cursos permitidos para cada llamada de chat; los turnos que coinciden se enrutan al proveedor premium. Cae al proveedor de trabajo si la fila premium falta o no puede instanciarse. Las anulaciones del selector de LLM de administrador siempre ganan independientemente.';
$string['settings:premium_escalation_provider'] = 'Proveedor premium';
$string['settings:premium_escalation_provider_desc'] = 'ID de proveedor para enrutar llamadas premium. Debe coincidir con una fila en Proveedores de comparación (para que la clave API, la URL base y la temperatura vengan del mismo lugar que los administradores ya gestionan). Por defecto <code>claude</code>.';
$string['settings:premium_escalation_model'] = 'Modelo premium';
$string['settings:premium_escalation_model_desc'] = 'Nombre del modelo pasado al proveedor premium. Por defecto <code>claude-opus-4-8</code> según el veredicto del bake-off A.10.';
$string['settings:premium_escalation_triggers'] = 'Regex de activación premium';
$string['settings:premium_escalation_triggers_desc'] = 'Un regex PCRE por línea (sin delimitadores; la coincidencia sin distinción de mayúsculas/minúsculas se aplica automáticamente). Las líneas que comienzan con # son comentarios. Déjelo en blanco para usar el conjunto predeterminado seleccionado del bake-off A.10 (marcadores STEM de varios pasos: "derive", "prove that", "step by step", LaTeX math, bloques de código delimitados, big-O, integrales, optimización, etc.).';
$string['settings:premium_escalation_course_tags'] = 'Lista de cursos permitidos para premium';
$string['settings:premium_escalation_course_tags_desc'] = 'Un nombre corto de curso o prefijo de idnumber por línea. Cada turno en un curso coincidente escala automáticamente independientemente del regex del mensaje (úselo para cursos con mucho contenido STEM donde la escalada debe ser el comportamiento predeterminado). La coincidencia es por prefijo sin distinción de mayúsculas/minúsculas — "MATH" coincide con MATH121, MATH205, etc.';
$string['settings:spend_cap_per_course_default'] = 'Límite de gasto por curso predeterminado (USD)';
$string['settings:spend_cap_per_course_default_desc'] = 'Límite defensivo aplicado a cada curso que no tiene su propio límite de gasto por curso configurado. Establézcalo en p.ej. <code>30</code> para limitar el gasto mensual de cualquier curso individual a $30 sin tener que ajustar los cursos individuales. <code>0</code> = sin límite predeterminado (solo se aplican los límites de todo el sitio y de anulación por curso). Cuando un curso supera el 80% / 95% / 100% de este límite, la canalización existente de alertas del spend-guard envía la notificación de administrador (lista de destinatarios: <code>spend_notify_emails</code>, cayendo a los administradores del sitio). Un curso específico siempre puede aumentar su propio techo estableciendo una anulación por curso más alta.';
$string['settings:cost_anomaly_heading'] = 'Detector de anomalías de costes (v6.0)';
$string['settings:cost_anomaly_heading_desc'] = 'Tarea programada diaria (<code>cost_anomaly_check</code>) que compara el gasto de [[tutorshort]] del sitio de hoy con la mediana móvil de 7 días. Envía un correo electrónico a la lista de destinatarios de <code>spend_notify_emails</code> (cayendo a los administradores del sitio) cuando hoy supera el multiplicador configurado × la mediana. Detecta tres modos de fallo que los umbrales del 80% / 95% / 100% del límite de gasto existente no detectan: (1) curso desbocado donde no se supera el techo absoluto pero un único curso genera de repente 10x su volumen habitual, (2) activación accidental del tier premium, (3) enrutamiento incorrecto del proveedor. Desactivado por defecto; el equivalente dentro de [[tutorshort]] de la consulta Redash en <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
$string['settings:cost_anomaly_enabled'] = 'Activar detector de anomalías de costes';
$string['settings:cost_anomaly_enabled_desc'] = 'Cuando está activado, la tarea programada diaria evalúa el gasto de hoy frente a la mediana móvil de 7 días y envía un correo electrónico a los administradores ante una anomalía. Los primeros 7 días después de activarlo producen un estado <code>insufficient_history</code> (todavía no hay línea base histórica) y nunca emiten una alerta. Idempotente por día: un indicador en <code>config_plugins</code> detiene los correos repetidos si cron se ejecuta varias veces.';
$string['settings:cost_anomaly_multiplier'] = 'Multiplicador de anomalía';
$string['settings:cost_anomaly_multiplier_desc'] = 'El gasto de hoy debe superar este multiplicador × la mediana de 7 días para activar una alerta. Por defecto <code>2.0</code>. Reducir a <code>1.5</code> para advertencias más tempranas (más falsos positivos durante ráfagas de matriculación). Aumentar a <code>3.0</code> si el uso de [[unishort]] es suficientemente fluctuante como para que los picos de 2x sean habituales.';
$string['task:cost_anomaly_check'] = 'Comprobación de anomalías de costes de [[tutorshort]] (diaria)';
...
$string['task:policy_bundle_sync'] = 'Sincronización del paquete de políticas firmado de [[tutorshort]]';
...
$string['settings:avatar_animation_enabled'] = 'Animación de avatar';
$string['settings:avatar_animation_enabled_desc'] = 'Anima el avatar SVG generado: parpadeo en reposo, más movimiento de boca sincronizado con el audio de texto a voz mientras el asistente habla. Respeta la preferencia de movimiento reducido del dispositivo del estudiante. Anulación por curso para medición A/B: establezca el valor de configuración avatar_animation_course_COURSEID en 0 o 1.';
$string['analytics:exp_heading'] = 'Comparación del experimento A/B';
$string['analytics:exp_desc'] = 'Compare la participación entre dos cursos durante el rango de tiempo seleccionado. Diseñado para experimentos por curso (por ejemplo, la sonda de animación de avatar): coloque la anulación en un curso, deje el otro como control y lea la diferencia aquí.';
...
$string['analytics:exp_enrolled'] = 'Estudiantes matriculados';
$string['analytics:exp_active_users'] = 'Usuarios activos de [[tutorshort]]';
$string['analytics:exp_usage_rate'] = 'Tasa de uso (%)';
$string['analytics:exp_sessions'] = 'Sesiones';
$string['analytics:exp_messages'] = 'Mensajes';
$string['analytics:exp_avg_msgs_session'] = 'Promedio de mensajes por sesión';
$string['analytics:exp_avg_session_minutes'] = 'Duración promedio de sesión (minutos)';
...
$string['cachedef_ratelimit'] = 'Limitación de frecuencia de solicitudes por usuario';
$string['cachedef_uistate'] = 'Conmutadores de interfaz por sesión (ver como estudiante, mostrar nombres reales)';
$string['benchmark:pagetitle'] = 'Comparativa de proveedores';
$string['benchmark:intro'] = 'Envía un conjunto fijo de indicaciones típicas a cada proveedor de AI configurado, registra el uso de tokens, el costo y la latencia, y recomienda un proveedor por capacidad. Cada ejecución realiza llamadas reales a la API, por lo que una ejecución cuesta aproximadamente entre 5 y 20 centavos según cuántos proveedores estén configurados.';
$string['cachedef_systemprompt'] = 'Indicación del sistema de AI ensamblada (por curso)';
$string['cachedef_remoteconfig'] = 'Configuración remota obtenida del canal de actualización';
$string['cachedef_spend'] = 'Totales de gasto de AI por período para el control de gasto';
$string['cachedef_failover_circuit'] = 'Estado del disyuntor de conmutación por error del proveedor';
$string['settings:rag_scope'] = 'Alcance de la recuperación';
$string['settings:rag_scope_desc'] = 'Cuando un estudiante está viendo un documento específico (una página, un libro o un PDF), determina si se debe restringir la recuperación a ese documento. <b>Documento primero</b> fundamenta la respuesta en el documento actual cuando tiene fragmentos relevantes y recurre al curso completo en caso contrario. <b>Solo documento</b> nunca recurre a otras fuentes: si el documento actual no tiene ningún fragmento relevante, no recupera nada, por lo que el tutor responde a partir de conocimientos generales en lugar de citar páginas no relacionadas. <b>Todo el curso</b> busca en todo el contenido del curso (la página actual sigue recibiendo la ventaja de ordenación mencionada arriba). Se recomienda Documento primero, para que una respuesta sobre la página que está leyendo un estudiante se fundamente en esa página.';
$string['settings:rag_scope_document_first'] = 'Documento primero (preferir el documento actual, recurrir al curso)';
$string['settings:rag_scope_document_only'] = 'Solo documento (restringir al documento actual)';
$string['settings:rag_scope_course'] = 'Todo el curso (buscar en todo el contenido del curso)';
$string['ragadmin:no_content_documents'] = '{$a->count} documento(s) no produjeron texto indexable y no se fragmentaron (por lo general, páginas mayormente incrustadas o muy cortas): {$a->titles}. Si alguno de estos debería poder buscarse, agregue texto en la página o una transcripción y luego vuelva a indexar.';
$string['privacy:metadata:sbx_rec'] = 'Grabaciones de presentaciones de Soapbox. El objeto multimedia se elimina tras el período de retención; la transcripción se conserva para la retroalimentación y las solicitudes de acceso.';
$string['privacy:metadata:sbx_rec:userid'] = 'El estudiante que realizó la grabación.';
$string['privacy:metadata:sbx_rec:transcript'] = 'La transcripción de voz a texto de la grabación.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'La duración de la grabación en segundos.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'Cuándo se realizó la grabación.';
$string['privacy:metadata:ai_provider'] = 'Para generar respuestas de tutoría, el contenido creado por el estudiante se envía al proveedor de AI configurado por el administrador del sitio o del curso.';
$string['privacy:metadata:ai_provider:message'] = 'El texto del mensaje y los archivos adjuntos que el estudiante envía al tutor de AI.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'Contexto del curso y de la actividad (como el nombre del curso y la página actual) incluido para fundamentar la respuesta.';
$string['privacy:metadata:voice_provider'] = 'Cuando se utiliza la entrada o salida de voz, el audio y el texto se envían al proveedor de voz a texto / texto a voz configurado.';
$string['privacy:metadata:voice_provider:audio'] = 'Audio grabado del estudiante hablando, enviado para su transcripción.';
$string['privacy:metadata:voice_provider:text'] = 'Texto enviado al proveedor para sintetizarlo en voz.';
$string['privacy:metadata:zendesk'] = 'Cuando la derivación a soporte humano está habilitada y el estudiante da su consentimiento, sus datos de contacto y su mensaje se envían a Zendesk para abrir un ticket de soporte.';
$string['privacy:metadata:zendesk:name'] = 'El nombre completo del estudiante, usado para identificar a quien solicita soporte.';
$string['privacy:metadata:zendesk:email'] = 'La dirección de correo electrónico del estudiante, usada para responder a la solicitud de soporte.';
$string['privacy:metadata:zendesk:message'] = 'El contenido del mensaje o la conversación que el estudiante decidió derivar.';
...
$string['analytics_js:ai_users'] = 'Usuarios de AI';
$string['analytics_js:non_users'] = 'No usuarios';
$string['analytics_js:thumbs_up'] = 'Me gusta';
$string['analytics_js:thumbs_down'] = 'No me gusta';
$string['analytics_js:hallucination_flags'] = 'Marcas de alucinación';
$string['analytics_js:avg_star_rating'] = 'Calificación promedio en estrellas';
$string['analytics_js:avg_msgs_resolution'] = 'Promedio de mensajes hasta la resolución';
$string['analytics_js:survey_respondents'] = 'Encuestados';
$string['analytics_js:messages'] = 'Mensajes';
$string['analytics_js:students'] = 'Estudiantes';
$string['analytics_js:frequency'] = 'Frecuencia';
$string['analytics_js:responses'] = 'Respuestas';
$string['analytics_js:error_loading'] = 'Error al cargar los datos';
$string['analytics_js:loading'] = 'Cargando analíticas...';
$string['analytics_js:no_course_data'] = 'No hay datos del curso disponibles.';
$string['analytics_js:no_unit_data'] = 'Aún no hay datos de unidades. El seguimiento de unidades se acumula a medida que los estudiantes usan el asistente.';
$string['analytics_js:no_keyword_data'] = 'No hay datos de palabras clave disponibles para este período.';
$string['task:soapbox_cleanup'] = 'Retención y limpieza de grabaciones de Soapbox';
$string['admin:vendor_dpa:col_provider'] = 'Proveedor';
$string['admin:vendor_dpa:col_optout'] = 'Exclusión del entrenamiento';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Retención';
$string['admin:vendor_dpa:col_tier'] = 'Nivel máximo';
$string['admin:vendor_dpa:col_link'] = 'Enlace';
$string['admin:vendor_dpa:vendor_terms'] = 'Términos del proveedor';
$string['admin:vendor_dpa:tier'] = 'Nivel {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'Contractual (excluido)';
$string['admin:vendor_dpa:too_default_on'] = 'Activado de forma predeterminada';
$string['admin:vendor_dpa:too_none'] = 'Sin exclusión';
$string['admin:vendor_dpa:too_local'] = 'Local (sin proveedor)';
$string['admin:vendor_dpa:too_unknown'] = 'Aún no revisado';
$string['admin:vendor_dpa:dpa_signed'] = 'Firmado';
$string['admin:vendor_dpa:dpa_available'] = 'Disponible';
$string['admin:vendor_dpa:dpa_negotiating'] = 'En negociación';
$string['admin:vendor_dpa:dpa_not_offered'] = 'No ofrecido';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'N/D';
$string['admin:vendor_dpa:dpa_unknown'] = 'Desconocido';
$string['settings:soapbox_slide_vision'] = 'Retroalimentación de diseño visual de diapositivas de Soapbox';
$string['settings:soapbox_slide_vision_desc'] = 'Permite un único pase de visión sobre las imágenes de las diapositivas renderizadas para añadir una breve nota de diseño visual a una presentación calificada. Desactivado de forma predeterminada y respetuoso con la privacidad: no se almacena ninguna imagen y cada tarea también debe activarlo con su propia casilla de retroalimentación de diseño visual de diapositivas. Solo se ven afectadas las presentaciones con diapositivas que tengan un mazo cargado.';
$string['settings:soapbox_vision_provider'] = 'Proveedor de visión de diapositivas de Soapbox';
$string['settings:soapbox_vision_provider_desc'] = 'Proveedor usado para el pase de visión de diapositivas. De forma predeterminada es openai. Debe ser un proveedor con capacidad de visión configurado con una clave de API (a través del proveedor del curso o de la lista de proveedores de comparación).';
$string['settings:soapbox_vision_model'] = 'Modelo de visión de diapositivas de Soapbox';
$string['settings:soapbox_vision_model_desc'] = 'Modelo con capacidad de visión para el pase de visión de diapositivas. De forma predeterminada es gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'Diseño de diapositivas:';
$string['soapbox:assign_manage'] = 'Tareas de presentaciones de Soapbox';
$string['soapbox:copy_link'] = 'Enlace para estudiantes';
$string['soapbox:deck_label'] = 'Diapositivas (PDF). Cargue su mazo y luego avance las diapositivas mientras graba.';
$string['soapbox:slide_prev'] = 'Diapositiva anterior';
$string['soapbox:slide_next'] = 'Diapositiva siguiente';
$string['soapbox:play_slides'] = 'Reproducir con diapositivas';
$string['soapbox:audio_ready'] = 'Solo audio. Se grabará su micrófono; su cámara no se utiliza.';
$string['soapbox:audio_recording'] = 'Grabando audio...';
$string['soapbox:cap_reached'] = 'Ha alcanzado el número máximo de grabaciones para esta tarea.';
$string['soapbox:storage_unconfigured'] = 'El almacenamiento de grabaciones aún no está configurado. Comuníquese con su administrador.';
$string['soapbox:bad_key'] = 'Esa carga no le pertenece.';
$string['soapbox:slides_disabled'] = 'Las diapositivas no están habilitadas para esta tarea.';
$string['soapbox:upload_missing'] = 'No se pudo encontrar la carga. Intente grabar de nuevo.';
$string['soapbox:mode_label'] = 'Tipo de presentación';
$string['soapbox:mode_informative'] = 'Informativa (explicar o enseñar)';
$string['soapbox:mode_persuasive'] = 'Persuasiva (convencer)';
$string['soapbox:err_provider'] = 'No se pudo contactar con el servicio de calificación de AI. Inténtelo de nuevo en un momento.';
$string['soapbox:err_parse'] = 'La AI devolvió una respuesta inesperada. Inténtelo de nuevo.';
$string['soapbox:err_disabled'] = 'La práctica de oratoria no está habilitada para este curso.';
$string['soapbox:err_transcribe'] = 'No se pudo transcribir su grabación. Inténtelo de nuevo y compruebe que su micrófono funciona.';
$string['settings:outcomes_benchmark_default'] = 'Referencia de resultado (porcentaje)';
$string['settings:outcomes_benchmark_default_desc'] = 'La referencia establecida por la institución para el informe de resultados: un estudiante cumple un resultado cuando su dominio es igual o superior a este porcentaje. Este es el estándar de reporte (distinto del umbral de dominio para el acompañamiento). Predeterminado 70.';
$string['outcomes:title'] = 'Informe de resultados';
$string['outcomes:intro'] = 'Para cada resultado del curso, la referencia y el porcentaje de estudiantes evaluados que la cumplieron o superaron. La referencia del sitio es del {$a}%.';
$string['outcomes:none'] = 'Aún no hay resultados definidos para este curso.';
$string['outcomes:export'] = 'Exportar CSV';
$string['outcomes:col_outcome'] = 'Resultado';
$string['outcomes:col_benchmark'] = 'Referencia';
$string['outcomes:col_assessed'] = 'Estudiantes evaluados';
$string['outcomes:col_met'] = 'Cumplió la referencia';
$string['outcomes:col_pct'] = 'Porcentaje que cumplió';
$string['outcomes:footnote'] = 'Los estudiantes evaluados son aquellos con al menos un intento en el resultado. El logro se reporta de forma agregada; la progresión individual nunca queda condicionada a ningún resultado por sí solo.';
$string['outcomes:navlink'] = 'Informe de resultados';
...
$string['settings:redash_export_window_days'] = 'Ventana de consulta de la exportación (días)';
$string['settings:redash_export_window_days_desc'] = 'Hasta cuándo llega la exportación cuando quien la solicita no envía una marca de tiempo «since». El valor por defecto de 90 días evita que una fuente de datos que omite el parámetro descargue todos los registros existentes; quien la solicita puede pedir una ventana concreta o enviar since=0 para una recarga completa. Ponlo en 0 para que la opción por defecto vuelva a ser todo el historial.';
$string['settings:redash_allow_deanonymized'] = 'Permitir exportación no anonimizada';
$string['settings:redash_allow_deanonymized_desc'] = 'Desactivado por defecto. Cuando está desactivado, se rechaza cualquier solicitud con anonymize=0 y los estudiantes aparecen siempre como seudónimos. Actívalo solo si un informe externo necesita realmente los nombres reales, y recuerda que la exportación se autentica con una clave de API compartida y no con un administrador que haya iniciado sesión, por lo que cualquiera que tenga la clave podrá obtener esos nombres. En cualquier caso, las solicitudes no anonimizadas se registran en la auditoría junto con la IP solicitante.';

// i18n batch appended by scripts/apply_i18n.py.
$string['soapbox:present_audio'] = 'Presentación de audio';
$string['soapbox:present_video'] = 'Presentación de vídeo';
$string['soapbox:present_target'] = 'objetivo {$a->min}-{$a->max} min';
$string['soapbox:choose_topic'] = 'Elige un tema';
$string['soapbox:record_short'] = 'Grabar';
$string['soapbox:my_recordings'] = 'Mis grabaciones';
$string['soapbox:no_recordings'] = 'Aún no hay grabaciones.';
$string['soapbox:col_recorded'] = 'Grabado';
$string['soapbox:col_length'] = 'Duración';
$string['soapbox:col_type'] = 'Tipo';
$string['soapbox:col_recording'] = 'Grabación';
$string['soapbox:col_kept'] = 'Conservado';
$string['soapbox:col_student_link'] = 'Enlace del estudiante';
$string['soapbox:view_download'] = 'Ver / descargar';
$string['soapbox:expired'] = 'Caducado';
$string['soapbox:retention_note'] = 'Las grabaciones se pueden ver y descargar durante {$a} días; después se eliminan automáticamente.';
$string['soapbox:assign_title'] = 'Tareas de Soapbox';
$string['soapbox:assign_single_title'] = 'Tarea de Soapbox';
$string['soapbox:assign_add'] = 'Añadir tarea';
$string['soapbox:assign_none'] = 'Todavía no hay tareas de Soapbox.';
$string['soapbox:assign_deleted'] = 'Tarea eliminada.';
$string['soapbox:assign_updated'] = 'Tarea actualizada.';
$string['soapbox:assign_created'] = 'Tarea creada.';
$string['soapbox:assign_delete_confirm'] = '¿Eliminar "{$a}" y todas sus grabaciones? Esta acción no se puede deshacer.';
$string['soapbox:assign_edit_heading'] = 'Editar tarea de Soapbox';
$string['soapbox:assign_new_heading'] = 'Nueva tarea de Soapbox';
