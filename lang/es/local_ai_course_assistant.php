...
$string['settings:rerank_candidates_desc'] = 'Cuántos candidatos coseno N superiores se envían a la etapa de reordenamiento. Por defecto 50. Ventanas más grandes dan al reordenador más material con el que trabajar con un pequeño coste adicional (~10k tokens por operación de reordenamiento).';
