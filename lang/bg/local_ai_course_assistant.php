...
$string['settings:rerank_candidates_desc'] = 'Колко косинусни топ-N кандидати да захранват стъпката за преподреждане. По подразбиране 50. По-големите прозорци дават повече материал на преподредителя при малка допълнителна цена (~10k токена на операция за преподреждане).';
