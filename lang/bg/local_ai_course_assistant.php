...
$string['settings:stt_selfhosted_heading_desc'] = 'Стартирайте преобразуване на реч в текст на собствен хардуер без разходи на минута. Насочете SOLA към всеки сървър за транскрибиране, съвместим с OpenAI: Docker <code>whisper-server</code>, <code>speaches</code> (faster-whisper) или сървър <code>whisper.cpp</code>. При зададен тук URL на сървър той се превръща в пътя по подразбиране за STT; изберете платен доставчик в Активен STT доставчик по-горе, за да го заместите. Ако сървърът е в частна мрежа или на обикновен http, добавете неговия хост и в списъка с доверени SSRF крайни точки в раздел Сигурност.';
$string['settings:stt_selfhosted_url'] = 'URL на самостоятелно хоствания STT сървър';
$string['settings:stt_selfhosted_url_desc'] = 'Базов URL на OpenAI-съвместимия сървър за транскрибиране, например <code>http://10.0.0.5:8000</code>. SOLA добавя автоматично <code>/v1/audio/transcriptions</code>; приема се и пълен URL на крайна точка. Оставете празно, за да деактивирате самостоятелно хосвания STT.';
...
$string['emergency:title'] = 'Аварийни контроли на SOLA';
$string['emergency:page_warning'] = 'Тези превключватели влизат в сила незабавно за всички обучаващи се в сайта. Всяко действие записва ред в одитния журнал. Детайлните превключватели оставят останалата част от SOLA работеща; главният убива цялата приставка от всяка страница.';
$string['emergency:back_to_settings'] = 'Настройки на SOLA';
...
$string['emergency:flag_chat_desc'] = 'Блокира чат трафика чрез специален kill флаг (поправка v5.13). Приставката продължава да се визуализира; обучаващите се виждат приятелското съобщение „SOLA е паузиран". Използвайте при неправилно поведение на LLM доставчик или при нарастване на разходите.';
...
$string['emergency:flag_all_desc'] = 'Деактивира цялата приставка: приставката изчезва от всяка страница, планираните задачи спират, гласовото изчиства се, RAG е изключен, обхватът е изключен. Най-мощният превключвател — използвайте при инцидент по сигурността или когато SOLA трябва да бъде изключен незабавно.';
$string['emergency:settings_link'] = 'Аварийни контроли';
$string['emergency:settings_link_desc'] = 'Kill switches за всяка подсистема (чат / глас / RAG / обхват / главен) с одитно журналиране — уеб еквивалент на <code>admin/cli/emergency_disable.php</code>. Отворете <a href="{$a}">Аварийни контроли на SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Отписан';
$string['email_unsubscribe:done_body'] = 'Готово — {$a->email} вече няма да получава този вид имейли от {$a->product}. Ако промените решението си, помолете администратор на {$a->product} да активира отново абонамента или изпратете нова заявка за включване чрез административната страница SOLA Recipients.';
...
$string['settings:cost_anomaly_multiplier_desc'] = 'Днешните разходи трябва да надхвърлят този множител × 7-дневния медиан, за да се задейства сигнал. По подразбиране <code>2.0</code>. Намалете до <code>1.5</code> за по-ранни предупреждения (повече фалшиви положителни при записвателни пикове). Увеличете до <code>3.0</code>, ако употребата на Saylor е достатъчно нередовна, за да са рутинни 2× пикове.';
$string['task:cost_anomaly_check'] = 'Проверка за аномалии в разходите на SOLA (ежедневна)';
...
$string['task:policy_bundle_sync'] = 'SOLA синхронизиране на подписан пакет с политики';
...
$string['analytics:exp_active_users'] = 'Активни SOLA потребители';
