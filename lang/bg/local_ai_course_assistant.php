...
$string['pedagogy:learning_path_desc'] = 'Когато е включено, SOLA добавя визуален панел за учебния път (бутон „моят път“ в заглавката на инструмента), показващ програмата на обучаемия като последователност от курсове, всеки от които може да се разгъне до целите си и нивото на овладяване от обучаемия. Когато обучаемият достигне летвата за текущия курс (завършване или висок дял овладени цели), SOLA показва и деликатен банер „готов за следващия курс“ и го споменава в разговора. Само препоръчително; използва собственото разпределение по програмата на обучаемия; не прави нищо безмълвно там, където не се прилага програма.';
...
$string['settings:backend_retry_max_wait_desc'] = 'Горна граница, в секунди, за това колко дълго да се зачита заглавката Retry-After от бекенда, преди да се направи повторен опит. Когато бекендът не изпрати Retry-After, SOLA вместо това използва кратко експоненциално отлагане. По подразбиране 5.';
...
$string['settings:zendesk_require_consent_desc'] = 'Когато е включено (препоръчително), SOLA ескалира разговор до бюрото за поддръжка на Zendesk едва след като обучаемият е приел уведомлението за съгласие при първо стартиране, което разкрива, че заявката за човешка помощ споделя разговора (включително име и имейл) с поддръжката. Изключете това само ако получавате това съгласие по друг начин; при изключено ескалациите се изпращат незабавно. Няма ефект, освен ако ескалацията до Zendesk не е активирана.';
