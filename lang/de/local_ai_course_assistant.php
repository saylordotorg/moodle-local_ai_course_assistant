...
$string['chat:consent_body'] = '{$a->product} ist ein KI-gestützter Lernassistent. Ihre Nachrichten und die Antworten von {$a->product} werden in der Moodle-Datenbank von {$a->institution} gespeichert, und die jüngsten zehn Runden werden an einen genehmigten KI-Modellanbieter gesendet, um Ihre Fragen zu beantworten. Ihr Vorname wird zur Personalisierung weitergegeben; keine weiteren identifizierenden Informationen werden an den KI-Anbieter gesendet. Wenn Sie um menschliche Hilfe bitten und Ihre Frage eskaliert wird, kann dieses Gespräch (einschließlich Ihres Namens und Ihrer E-Mail) mit unserem Support-Team geteilt werden. Sie können {$a->product} jederzeit herunterladen, löschen oder die Nutzung beenden.';
...
$string['settings:current_page_content_maxchars_desc'] = 'Die maximale Anzahl an Zeichen des Textes der aktuellen Seite, die als Abschnitt "Current Page Content" in den System-Prompt eingefügt werden, wenn RAG ausgeschaltet ist. Der Standardwert 8,000 verankert seitenspezifische Fragen gut und lässt zugleich Budget für Struktur und Anweisungen. (Bei aktiviertem RAG wird die Seite stattdessen durch ihre eigenen relevantesten Abschnitte verankert, mit Vorzug für die aktuelle Seite, sodass diese Obergrenze nicht greift.) Eine sehr lange Seite wird vom Anfang her auf diese Zeichenzahl gekürzt, sodass das Ende einer extrem langen Seite möglicherweise nicht zitiert wird; das Aktivieren von RAG vermeidet dies. Kostenbewusste Sites können niedriger begrenzen (z. B. 3,000-4,000). Begrenzt auf den Bereich 500-8,000. Unabhängig von <code>prompt_budget_chars</code>: Dies begrenzt nur den Seitenabschnitt; das Budget begrenzt den gesamten Prompt.';
...
$string['settings:backend_context_tokens'] = 'Backend-Kontextfenster (Tokens)';
$string['settings:backend_context_tokens_desc'] = 'Die maximale Kontextlänge (max_model_len) Ihres KI-Backends, in Tokens. Auf 0 setzen für gehostete Modelle mit großem Fenster (keine Begrenzung). Bei Werten über 0 (zum Beispiel 8192 bei einem selbst gehosteten vLLM-Backend) verkleinert SOLA das oben angegebene Zeichenbudget des System-Prompts, sodass der Prompt zusammen mit dem reservierten Output und dem Gesprächsverlauf in das Fenster passt, auch bei token-dichten Sprachen. Auf der Wiki-Seite Deployment Sizing erfahren Sie, wie dies mit gleichzeitigen Nutzern zusammenhängt.';
$string['settings:backend_retry_attempts'] = 'Backend-Wiederholungsversuche';
$string['settings:backend_retry_attempts_desc'] = 'Wie oft ein vorübergehender Backend-Fehler (HTTP 429 oder 503) wiederholt werden soll, bevor dem Studierenden ein Fehler angezeigt wird. Wiederholungen erfolgen nur, bevor Antworttext gestreamt wurde, sodass die Ausgabe niemals dupliziert wird. Ausgerichtet auf kleine selbst gehostete Backends, die Anfragen unter Last ablehnen. Auf 0 setzen, um zu deaktivieren. Standard 2.';
$string['settings:backend_retry_max_wait'] = 'Maximale Wartezeit für Backend-Wiederholung (Sekunden)';
$string['settings:backend_retry_max_wait_desc'] = 'Obergrenze in Sekunden dafür, wie lange ein Retry-After-Header vom Backend vor einer Wiederholung berücksichtigt wird. Wenn das Backend keinen Retry-After sendet, verwendet SOLA stattdessen einen kurzen exponentiellen Backoff. Standard 5.';
$string['prompt:truncation_hint'] = 'HINWEIS: Der gesamte Kursinhalt konnte in dieser Runde aufgrund von Längenbeschränkungen nicht durchsucht werden. Wenn der Studierende nach etwas fragt, das Sie im bereitgestellten Inhalt nicht finden können, sagen Sie, dass Sie nicht den gesamten Kurs durchsuchen konnten, und schlagen Sie vor, die konkrete Seite oder Aktivität zu öffnen, auf der das Thema behandelt wird, anstatt zu behaupten, dass es im Kurs fehlt.';
$string['selftest:title'] = 'Backend-Selbsttest';
$string['selftest:intro'] = 'Führen Sie eine Live-Prüfung Ihres konfigurierten KI-Backends durch: einen winzigen Chat-Hin-und-Rückweg, automatische Erkennung des Kontextfensters (max_model_len) und einen Vergleich mit Ihrer Einstellung für das Backend-Kontextfenster, die Untergrenze des System-Prompt-Budgets und (wenn RAG aktiviert ist) einen Embedding-Hin-und-Rückweg. Netzwerkaufrufe werden nur ausgeführt, wenn Sie auf Ausführen drücken.';
$string['selftest:run'] = 'Backend-Selbsttest ausführen';
$string['selftest:check'] = 'Prüfung';
$string['selftest:status'] = 'Status';
$string['selftest:detail'] = 'Detail';
$string['selftest:link'] = 'Seite zum Backend-Selbsttest';
$string['selftest:link_desc'] = 'Öffnen Sie die Seite <a href="{$a}">Backend-Selbsttest</a>, um zu überprüfen, ob Ihr KI-Backend funktioniert und korrekt dimensioniert ist. Nützlich direkt nach dem Konfigurieren eines selbst gehosteten Backends.';
$string['profile:title'] = 'Bereitstellungsvorlagen';
$string['profile:intro'] = 'Wenden Sie ein empfohlenes Paket von Einstellungen für Ihren Bereitstellungstyp an. Die Werte werden in die normalen Plugin-Einstellungen geschrieben und bleiben danach einzeln bearbeitbar. Das Anwenden einer Vorlage überschreibt die aufgeführten Einstellungen.';
$string['profile:current'] = 'Zuletzt angewendete Vorlage: {$a}';
$string['profile:setting'] = 'Einstellung';
$string['profile:value'] = 'Wert';
$string['profile:self_hosted_small'] = 'Selbst gehosteter kleiner Kontext (einzelne GPU, z. B. A30 24GB / vLLM mit 8K)';
$string['profile:hosted_large'] = 'Gehosteter großer Kontext (Standard)';
$string['profile:apply_self_hosted_small'] = 'Vorlage für selbst gehosteten kleinen Kontext anwenden';
$string['profile:apply_hosted_large'] = 'Standards für gehosteten großen Kontext anwenden';
$string['profile:applied'] = 'Die Vorlage {$a} wurde angewendet. Die Werte befinden sich jetzt in Ihren Plugin-Einstellungen.';
$string['profile:unknown'] = 'Unbekannte Bereitstellungsvorlage.';
$string['profile:link'] = 'Seite mit Bereitstellungsvorlagen';
$string['profile:link_desc'] = 'Öffnen Sie die Seite <a href="{$a}">Bereitstellungsvorlagen</a>, um ein empfohlenes Paket von Einstellungen für ein gehostetes oder selbst gehostetes Backend anzuwenden.';
$string['settings:zendesk_require_consent'] = 'Einwilligung vor Support-Eskalation verlangen';
$string['settings:zendesk_require_consent_desc'] = 'Wenn aktiviert (empfohlen), eskaliert SOLA ein Gespräch erst dann an den Zendesk-Supportdesk, nachdem der Lernende den Einwilligungshinweis beim ersten Start akzeptiert hat, der offenlegt, dass das Anfordern menschlicher Hilfe das Gespräch (einschließlich Name und E-Mail) mit dem Support teilt. Deaktivieren Sie dies nur, wenn Sie diese Einwilligung auf andere Weise einholen; bei deaktivierter Option werden Eskalationen sofort gesendet. Hat keine Wirkung, sofern die Zendesk-Eskalation nicht aktiviert ist.';
$string['chat:escalation_needs_consent'] = 'Es sieht so aus, als ob dies ein Mitglied unseres Support-Teams erfordert. Um es an sie weiterzugeben, müsste ich dieses Gespräch, einschließlich Ihres Namens und Ihrer E-Mail, mit dem Supportdesk teilen. Sie haben dem noch nicht zugestimmt, daher habe ich nichts gesendet. Wenn Sie menschliche Hilfe wünschen, akzeptieren Sie bitte den Hinweis zur Datenweitergabe für diesen Assistenten und fragen Sie erneut, oder kontaktieren Sie den Support direkt.';
$string['privacy:metadata:email_optout'] = 'E-Mail-Abmeldeeinstellungen pro Empfänger (von welchen E-Mail-Typen sich ein Empfänger abgemeldet hat).';
...
$string['settings:rag_min_similarity'] = 'Minimale Relevanz (cosine)';
$string['settings:rag_min_similarity_desc'] = 'Verwirft abgerufene Abschnitte, deren cosine-Ähnlichkeit zur Frage unter diesem Wert liegt, sodass eine themenfremde oder informationsarme Frage weniger (oder null) Passagen einfügt, statt stets bis Top-K mit schwachen Treffern aufzufüllen. Bereich 0 bis 1; 0 deaktiviert die Schranke. Der richtige Wert hängt vom embedding-Modell ab: 0.25 passt zu text-embedding-3-small. Erhöhen Sie ihn, um strenger zu sein (weniger, dafür themenrelevanterer Kontext), senken Sie ihn, um großzügiger zu sein.';
$string['settings:rag_currentpage_boost'] = 'Boost der aktuellen Seite';
$string['settings:rag_currentpage_boost_desc'] = 'Ein kleiner Bonus, der dem Relevanzwert von Abschnitten der Seite hinzugefügt wird, die der Lernende gerade ansieht, sodass Fragen wie "erkläre dies" bei ähnlichen Werten die sichtbare Seite bevorzugen. Nur für die Reihenfolge: Es zwingt keinen irrelevanten Seitenabschnitt an der Schranke für minimale Relevanz vorbei. Auf 0 setzen, um es zu deaktivieren.';
$string['settings:history_mode'] = 'Modus der Verlaufsauswahl';
$string['settings:history_mode_desc'] = 'Wie vergangene Gesprächsrunden ausgewählt werden, bevor sie an das Modell gesendet werden. <strong>Semantic</strong> behält nur die jüngsten Runden, die für die aktuelle Frage relevant sind (und stets den jüngsten Austausch), sodass eine veraltete, themenfremde frühere Runde die Kosten nicht aufbläht und die Antwort nicht vom Kurs abbringt; es führt einen zusätzlichen embedding-Aufruf pro Nachricht aus. <strong>Recency</strong> behält die letzten "Max Conversation History" Paare unabhängig von der Relevanz (das langjährige Verhalten, kein zusätzlicher Aufruf). Ist embedding nicht verfügbar, fällt der semantische Modus automatisch auf recency zurück.';
$string['settings:history_mode_semantic'] = 'Semantic (relevante jüngste Runden)';
$string['settings:history_mode_recency'] = 'Recency (letzte N Paare)';
$string['settings:history_semantic_minscore'] = 'Relevanzuntergrenze des Verlaufs (cosine)';
$string['settings:history_semantic_minscore_desc'] = 'Im semantischen Verlaufsmodus wird eine vergangene Runde nur behalten, wenn ihre Ähnlichkeit zur aktuellen Frage mindestens diesem Wert entspricht (der jüngste Austausch wird stets behalten). Bereich 0 bis 1; modellabhängig. Erhöhen, um strenger zu sein (weniger Verlauf), senken, um mehr zu behalten.';
$string['settings:history_candidates'] = 'Kandidatenfenster des Verlaufs';
$string['settings:history_candidates_desc'] = 'Im semantischen Verlaufsmodus werden nur so viele der jüngsten Paare auf Relevanz bewertet (eine Kostengrenze). Paare, die älter als dieses Fenster sind, werden nicht gesendet. Halten Sie diesen Wert auf oder über "Max Conversation History".';
