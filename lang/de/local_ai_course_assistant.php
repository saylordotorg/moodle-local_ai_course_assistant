...
$string['emergency:title'] = 'SOLA-Notfallsteuerung';
$string['emergency:page_warning'] = 'Diese Schalter wirken sofort für alle Lernenden auf der Website. Jede Aktion schreibt eine Zeile in das Auditprotokoll. Granulare Schalter lassen den Rest von SOLA laufen; der Master-Kill entfernt das Widget vollständig von jeder Seite.';
$string['emergency:back_to_settings'] = 'SOLA-Einstellungen';
...
$string['emergency:flag_chat_desc'] = 'Blockiert Chat-Datenverkehr über das dedizierte Kill-Flag (Behebung v5.13). Das Widget wird weiterhin angezeigt; Lernende sehen die freundliche Meldung „SOLA ist pausiert". Verwenden Sie dies bei fehlerhaftem Verhalten des LLM-Anbieters oder bei einem Kostenanstieg.';
...
$string['emergency:flag_all_desc'] = 'Deaktiviert das gesamte Plugin: Widget verschwindet von jeder Seite, geplante Aufgaben werden gestoppt, Sprache wird gelöscht, RAG ist aus, Outreach ist aus. Der stärkste Schalter — bei einem Sicherheitsvorfall oder wenn SOLA sofort offline genommen werden muss.';
$string['emergency:settings_link'] = 'Notfallsteuerung';
$string['emergency:settings_link_desc'] = 'Kill-Schalter pro Teilsystem (Chat / Sprache / RAG / Outreach / Master) mit Auditprotokollierung — das Web-Äquivalent von <code>admin/cli/emergency_disable.php</code>. Öffnen Sie die <a href="{$a}">SOLA-Notfallsteuerung</a>.';
$string['email_unsubscribe:done_title'] = 'Abgemeldet';
$string['email_unsubscribe:done_body'] = 'Erledigt — {$a->email} erhält keine E-Mails dieser Art mehr von {$a->product}. Falls Sie Ihre Meinung ändern, bitten Sie einen {$a->product}-Administrator, das Abonnement wieder zu aktivieren, oder senden Sie eine neue Einwilligung über die SOLA-Empfänger-Verwaltungsseite.';
...
$string['analytics:exp_active_users'] = 'Aktive SOLA-Benutzer';
