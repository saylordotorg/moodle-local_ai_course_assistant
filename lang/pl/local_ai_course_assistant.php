...
$string['emergency:title'] = 'Sterowanie awaryjne SOLA';
$string['emergency:page_warning'] = 'Te przełączniki działają natychmiast dla każdego ucznia na stronie. Każda akcja zapisuje wiersz audytu. Granularne przełączniki pozostawiają resztę SOLA działającą; główne wyłączenie całkowicie usuwa widżet.';
$string['emergency:back_to_settings'] = 'Ustawienia SOLA';
...
$string['emergency:flag_chat_desc'] = 'Blokuje ruch czatu za pomocą dedykowanej flagi wyłączania (poprawka v5.13). Widżet nadal się renderuje; uczniowie widzą przyjazny komunikat „SOLA wstrzymana". Użyj gdy dostawca LLM zachowuje się nieprawidłowo lub trwa wzrost kosztów.';
...
$string['emergency:flag_all_desc'] = 'Wyłącza cały plugin: widżet znika z każdej strony, zaplanowane zadania zatrzymują się, głos wyczyszczony, RAG wyłączony, komunikacja wyłączona. Najsilniejszy przełącznik — użyj przy incydencie bezpieczeństwa lub gdy SOLA musi zostać natychmiast odłączona.';
$string['emergency:settings_link'] = 'Sterowanie awaryjne';
$string['emergency:settings_link_desc'] = 'Przełączniki wyłączania per-podsystem (czat / głos / RAG / komunikacja / główny) z rejestrowaniem audytu — webowy odpowiednik <code>admin/cli/emergency_disable.php</code>. Otwórz <a href="{$a}">Sterowanie awaryjne SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Wypisano';
$string['email_unsubscribe:done_body'] = 'Gotowe — {$a->email} nie będzie już otrzymywać tego rodzaju e-maili od {$a->product}. Jeśli zmienisz zdanie, poproś administratora {$a->product} o ponowne włączenie subskrypcji lub złóż nowe zgłoszenie opt-in na stronie SOLA Recipients w panelu administratora.';
...
$string['settings:premium_escalation_heading_desc'] = 'Opcjonalne per-tura routowanie do modelu premium (domyślnie Claude Opus 4.8) dla podpowiedzi, z którymi poziom czatu roboczy wyraźnie sobie nie radzi — zazwyczaj matematyka wieloetapowa, informatyka i rozumowanie naukowe. Rozstrzygnięty przez bake-off A.10 z 2026-06-09: Opus 4.8 wygrał z 14,97/15 vs 12,68/15 gpt-4o na trudnych podpowiedziach. Dwie ścieżki wyzwalania: dopasowania regex do wiadomości użytkownika LUB lista dozwolonych kursów eskalująca każdą turę. Domyślnie wyłączone. Przy ~5% eskalacji, oczekuj ~$700/miesiąc przy 100k Saylor MAU ponad wydatki bazowe czatu.';
...
$string['settings:cost_anomaly_heading_desc'] = 'Codzienne zaplanowane zadanie (<code>cost_anomaly_check</code>) porównujące dzisiejsze ogólnosystemowe wydatki SOLA z krocząca medianą z 7 dni. Wysyła e-mail do listy odbiorców <code>spend_notify_emails</code> (z fallbackiem do administratorów strony), gdy dzisiejsze wydatki przekraczają skonfigurowany mnożnik × mediana. Wykrywa trzy tryby awarii, które istniejące progi 80% / 95% / 100% limitu wydatków pomijają: (1) rozbiegany kurs, gdzie bezwzględny pułap nie jest przekroczony, ale jeden kurs nagle generuje 10x normalnego wolumenu, (2) przypadkowe włączenie poziomu premium, (3) błędne routowanie dostawcy. Domyślnie wyłączone; wewnętrzny odpowiednik SOLA zapytania Redash pod adresem <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
...
$string['analytics:exp_active_users'] = 'Aktywni użytkownicy SOLA';
