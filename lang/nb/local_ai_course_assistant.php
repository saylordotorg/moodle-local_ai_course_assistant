...
$string['settings:embed_input_type_asymmetric'] = 'Asymmetrisk spørring/dokument';
$string['settings:embed_input_type_mode'] = 'Inndatatype for embedding';
$string['settings:embed_input_type_mode_desc'] = 'Gjelder bare Voyage-embeddinger. "Delt rom" embeder spørringer og dokumenter på samme måte, slik at de to holder seg sammenlignbare på tvers av et modellbytte. "Asymmetrisk" bruker Voyages egen spørringsprojeksjon; det er leverandørens foreslåtte optimalisering, men den har to ganger ikke klart å gjenskape noen gevinst på dette korpuset, så delt er standard. Å endre dette krever ingen ny indeksering.';
$string['settings:embed_input_type_shared'] = 'Delt rom (anbefalt)';
