...
$string['settings:backend_retry_max_wait_desc'] = 'Oke elu, na sekọnd, kan ogologo oge a ga-asọpụrụ isiokwu Retry-After site na backend tupu ịnwalegharị. Mgbe backend na-ezighị Retry-After, SOLA na-eji obere nlaghachi azụ kọlọ kama. Ndabara 5.';
...
$string['emergency:title'] = 'Njikwa Ihe Mberede SOLA';
$string['emergency:page_warning'] = 'Mgbanwe ndị a na-arụ ọrụ ozugbo maka onye mmụta ọ bụla n\'ọnọdụ. Ọrụ ọ bụla na-ede ahịrị nyocha. Mgbanwe ndị nwere nha na-ahapụ SOLA ndị ọzọ na-agba ọsọ; ihe mgbanyụ isi na-ewepụ widget n\'ụzọ ọzuzu.';
$string['emergency:back_to_settings'] = 'Ntọala SOLA';
...
$string['emergency:flag_chat_desc'] = 'Na-egbochi okporo ụzọ chat site na flag ihe mgbanyụ nwere nnọchiteanya (ngwọta v5.13). Widget na-aga n\'ihu na-egosi; ndị mmụta na-ahụ ozi "SOLA kwusịrị" dị mma. Jiri ya mgbe onye na-enye LLM na-adịghị mma ma ọ bụ ọnụahịa na-arị elu.';
...
$string['emergency:flag_all_desc'] = 'Na-gbanyụọ plugin n\'ozuzu ya: widget apụọ n\'ibe ọ bụla, ọrụ nhazi kwụsịrị, olu ewepụrụ, RAG gbanyụọ, nrubeọnụ gbanyụọ. Mgbanwe kachasị ike — jiri maka ihe mberede nchedo ma ọ bụ mgbe a ga-ewere SOLA offline ozugbo.';
$string['emergency:settings_link'] = 'Njikwa ihe mberede';
$string['emergency:settings_link_desc'] = 'Mgbanwe ihe mgbanyụ kwa usoro (chat / olu / RAG / nrubeọnụ / isi) na nlekọta nyocha — nha weebụ nke <code>admin/cli/emergency_disable.php</code>. Mepee <a href="{$a}">Njikwa Ihe Mberede SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Fụọ aha';
$string['email_unsubscribe:done_body'] = 'Emechara — {$a->email} agaghị ọzọ nata ụdị email a si n\'aka {$a->product}. Ọ bụrụ na ị gbanwee uche gị, rịọ onye nlekọta {$a->product} ka ha weghachi ndebanye aha, ma ọ bụ ziga nkwenye ọhụrụ site na ibe admin Ndị Nnata SOLA.';
...
$string['settings:cost_anomaly_heading_desc'] = 'Ọrụ nhazi kwa ụbọchị (<code>cost_anomaly_check</code>) nke na-atụ ihe eji ọnọdụ n\'ozuzu SOLA taa na median ịgba ọsọ 7-ụbọchị. Na-eziga email na ndepụta nnata <code>spend_notify_emails</code> (na-alata n\'ndị nlekọta ọnọdụ) mgbe taa gaara ihe dị oke × median. Na-enwe ụdị ihe daa atọ ndị oke 80% / 95% / 100% dị ugbu a gbafuoro: (1) kosi ọsọ ọsọ ebe oke dị elu n\'ozuzu ya azụrụ ọ bụ kosi otu na-akpali ihe 10x ọ bụ na ya n\'ọsọ nkịtị ya, (2) igba ụzọ tier elu n\'ihe ọjọọ, (3) misroute onye na-enye. Gbanyụọ site na ndabara; nha n\'ime-SOLA nke ajụjụ Redash na <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
...
$string['analytics:exp_active_users'] = 'Ndị oji SOLA na-arụ ọrụ';
