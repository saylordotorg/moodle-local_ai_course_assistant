...
$string['pedagogy:program_path_desc'] = 'ሲበራ፣ SOLA ለተማሪ የአሁኑ ኮርስ በፕሮግራማቸው (ዲግሪ ወይም የምስክር ወረቀት) ውስጥ ቀጥሎ ወዴት እንደሚያደርስ እና የዛሬዎቹ ጽንሰ-ሐሳቦች ወደ ቀጣዮቹ ኮርሶች እንዴት እንደሚያገናኙ ሊነግር ይችላል። የMoodle Programs ተሰኪን (Degrees እና Learn) ያነባል እና ፕሮግራሙ ቅድመ-ሁኔታ ወይም የሚያስፈልግ ቅደም ተከተል በሚገልጽበት ቦታ ብቻ የተወሰነ ቀጣይ ኮርስ ይሰይማል፤ ካልሆነ ግን የተማሪውን በመንገዱ ላይ ያለውን ቦታ ይጠቁማል። የምክር ብቻ ነው — ምዝገባን ወይም ብቃትን በፍጹም አይለውጥም፣ እና ሁልጊዜ የአሁኑን ተማሪ የራሱን የፕሮግራም ድልድል ብቻ ይጠቀማል። ምንም ፕሮግራም በማይተገበርበት ቦታ በፀጥታ ምንም አያደርግም።';

// Learning path map + next-course nudge (v5.9.0).
$string['pedagogy:learning_path'] = 'የመማር መንገድ ካርታ እና የቀጣይ ኮርስ ግፊት በነባሪ የበራ';
$string['pedagogy:learning_path_desc'] = 'ሲበራ፣ SOLA የእይታ የመማር-መንገድ ፓነል ይጨምራል (በመሣሪያው ራስጌ ላይ "የእኔ መንገድ" አዝራር) የተማሪውን ፕሮግራም እንደ ተከታታይ ኮርሶች ያሳያል፣ እያንዳንዱም ወደ ግቦቹ እና ወደ ተማሪው ብቃት ሊዘረጋ ይችላል። ተማሪው ለአሁኑ ኮርስ የተቀመጠውን መለኪያ ሲያሟላ (ማጠናቀቅ ወይም ከፍተኛ ድርሻ ያላቸውን ግቦች መቆጣጠር)፣ SOLA ደግሞ ለስላሳ "ለቀጣዩ ኮርስ ዝግጁ" ባነር ያሳያል እና በውይይት ውስጥ ይጠቅሰዋል። የማማከር ብቻ ነው፤ የተማሪውን የራሱን የፕሮግራም ድልድል ይጠቀማል፤ ምንም ፕሮግራም በማይተገበርበት ቦታ በዝምታ ምንም አያደርግም።';
...
$string['settings:backend_retry_max_wait_desc'] = 'ከመልሶ ሙከራ በፊት ከጀርባው የ Retry-After ራስጌን ለማክበር ምን ያህል ጊዜ እንደሚቆይ የላይኛው ገደብ፣ በሰከንዶች። ጀርባው Retry-After ካልላከ፣ SOLA በምትኩ አጭር አርቢ ኋላ-መመለስ ይጠቀማል። ነባሪ 5።';
...
$string['settings:zendesk_require_consent_desc'] = 'ሲበራ (የሚመከር)፣ SOLA ንግግርን ወደ Zendesk የድጋፍ ዴስክ የሚያሳልፈው ተማሪው የመጀመሪያ-ሩጫ የፈቃድ ማስታወቂያን ከተቀበለ በኋላ ብቻ ነው፣ ይህም የሰው እርዳታ መጠየቅ ንግግሩን (ስም እና ኢሜይልን ጨምሮ) ከድጋፍ ጋር እንደሚያጋራ ይገልጻል። ይህን ያጥፉ ብቻ ያን ፈቃድ በሌላ መንገድ ካገኙ፤ ሲጠፋ፣ ማሳለፊያዎች ወዲያውኑ ይላካሉ። የ Zendesk ማሳለፍ ካልነቃ በስተቀር ምንም ውጤት የለውም።';
...
$string['emergency:title'] = 'SOLA የአደጋ ቁጥጥሮች';
$string['emergency:page_warning'] = 'እነዚህ መቀያሪያዎች ወዲያውኑ ለሁሉም ሳይቱ ተማሪዎች ተፅዕኖ ያሳርፋሉ። እያንዳንዱ ድርጊት የኦዲት ረድፍ ይጽፋል። ዝርዝር መቀያሪያዎች የቀሩትን SOLA ን ሲሠሩ ይተዋሉ፤ ዋናው ማጥፊያ widget ን ከሁሉም ገጽ ሙሉ ለሙሉ ያስወግዳል።';
$string['emergency:back_to_settings'] = 'SOLA ቅንብሮች';
...
$string['emergency:flag_chat_desc'] = 'የውይይት ትራፊክን በተዘጋጀ kill flag አማካኝነት ይዘጋል (v5.13 ማስተካከያ)። Widget መሳቢያ ይቀጥላል፤ ተማሪዎች ወዳጃዊ "SOLA ቆሟል" መልዕክት ያዩ ናቸው። LLM አቅራቢ ሲቸገር ወይም ወጪ ሲንፈሰፈስ ይጠቀሙ።';
...
$string['emergency:flag_all_desc'] = 'ሙሉ plugin ን ያሰናክላል፦ widget ከሁሉም ገጽ ይጠፋል፣ ዝግጁ ተግባሮች ያቆማሉ፣ ድምጽ ይጠፋል፣ RAG ጠፍቷል፣ outreach ጠፍቷል። ጠንካራ መቀያሪያ — ለደህንነት አደጋ ወይም SOLA ወዲያውኑ offline ሲሆን ብቻ ይጠቀሙ።';
$string['emergency:settings_link'] = 'አደጋ ቁጥጥሮች';
$string['emergency:settings_link_desc'] = 'ከኦዲት ምዝብ ጋር ዝርዝር kill switches (ውይይት / ድምጽ / RAG / outreach / ዋናው) — <code>admin/cli/emergency_disable.php</code> ለዌብ ቀዳሚ። <a href="{$a}">SOLA አደጋ ቁጥጥሮችን</a> ይክፈቱ።';
$string['email_unsubscribe:done_title'] = 'ምዝገባ ተሰርዟል';
$string['email_unsubscribe:done_body'] = 'ተጠናቅቋል — {$a->email} ከ{$a->product} ይህን አይነት ኢሜይል ሙሉ ለሙሉ አይቀበልም። ሃሳብዎን ቢቀይሩ፣ ምዝገባን ዳግም ለማነቃቃት የ{$a->product} አስተዳዳሪ ያናግሩ፣ ወይም በ SOLA Recipients admin ገጽ አዲስ opt-in ይላኩ።';
...
$string['settings:cost_anomaly_heading_desc'] = 'ዕለታዊ ዝግጁ ተግባር (<code>cost_anomaly_check</code>) የዛሬ ጠቅላላ ሳይቱ SOLA ወጪ ከ7-ቀን መዘዋወሪያ አሻሽ ጋር ያወዳድራል። ዛሬ ቅናሽ multiplier × አሻሽ ሲበልጥ <code>spend_notify_emails</code> ተቀባዩ ዝርዝር (ወደ ሳይት አስተዳዳሪዎች ሲወድቅ) ኢሜይል ይልካል። ነባሪ 80% / 95% / 100% spend-cap ወለሎቹ የሚሳቱ ሦስቱ ችሎታ ሁነቶችን ይቃኛል፦ (1) ፍጹም ወለሉ ሳይሸፈን ነገር ግን አንድ ኮርስ ድንገተኛ 10x ያሻቅባል (2) ያለ ስህተት premium-tier አብሯ (3) አቅራቢ misroute። ነባሪ ጠፍቷል፤ <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code> ላይ ያለ Redash query ን ያህል በ-SOLA ውስጥ ያለ ቀዳሚ።';
...
$string['settings:cost_anomaly_multiplier_desc'] = 'ማሳወቂያ ለማስነሳት የዛሬ ወጪ ይህን multiplier × 7-ቀን አሻሽ ሊበልጥ አለበት። ነባሪ <code>2.0</code>። ቀደምት ማስጠንቀቂያዎች ለ <code>1.5</code> ዝቅ ያድርጉ (ምዝገባ ፍሰቶች ጊዜ ተጨማሪ ስህተት-አወዛዛቢ)። Saylor ወጪ 2x spikes ስትረዝም ወደ <code>3.0</code> ያሳድጉ።';
$string['task:cost_anomaly_check'] = 'SOLA ወጪ ያልተለመደ ቁጥጥሮ (ዕለታዊ)';
...
$string['analytics:exp_active_users'] = 'ንቁ SOLA ተጠቃሚዎች';
