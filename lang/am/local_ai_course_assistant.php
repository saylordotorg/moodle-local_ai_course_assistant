...
$string['settings:comparison_providers_desc'] = 'ተጨማሪ AI አቅራቢዎችን ወደ ምግብር ውስጥ ያለው LLM መራጭ ያክሉ ስለዚህ አስተዳዳሪዎች ከአቅራቢዎች ጋር ምላሾችን ማወዳደር ይችላሉ። በሚከተለው ቅርጸት በአንድ መስመር አንድ አቅራቢ: provider_id|api_key|model1,model2። ከላይ የተዋቀረው ዋናው አቅራቢ ሁልጊዜ በራስ-ሰር ይካተታል። የማስተዳደር ችሎታ ያላቸው አስተዳዳሪዎች ብቻ መራጩን ያያሉ፤ ተማሪዎች በጭራሽ አያዩትም። ምሳሌ:<br><code>claude|sk-ant-api03-...|claude-sonnet-4-5-20250929,claude-3-5-haiku-20241022<br>gemini|AIzaSy...|gemini-2.0-flash<br>deepseek|sk-...|deepseek-chat</code><br>ትክክለኛ provider IDs: openai, claude, deepseek, gemini, ollama, minimax, mistral, groq, openrouter, xai, coreai, custom.';
...
$string['task:run_meta_ai_query'] = 'የታቀደውን Meta-AI ትንታኔ ጥያቄ አስኪድ';
$string['messageprovider:study_notes'] = 'የጥናት ክፍለ ጊዜ ማስታወሻዎች';
