...
$string['settings:escalation_intent_patterns_desc'] = 'በአንድ መስመር አንድ መደበኛ አገላለጽ፤ በ# የሚጀምሩ መስመሮች ችላ ይባላሉ። የድጋፍ ትኬት የሚከፈተው የተማሪው የራሱ መልእክት ከእነዚህ አንዱን ሲያሟላ ብቻ ነው፤ ስለዚህ የኮርስ ይዘት በተማሪው ስም ማሳደግ አያስነሳም። ባዶ ከተውት ውስጠ-ግንብ ነባሪዎች ይሠራሉ፤ እነሱም እንግሊዝኛን እንዲሁም በስፓኒሽ፣ ፈረንሳይኛ፣ ጀርመንኛና ፖርቱጋልኛ የተለመዱ አገላለጾችን ይሸፍናሉ። ተማሪዎቻቸው በሌላ ቋንቋ የሚጽፉ ጣቢያዎች እዚህ ቅጦችን ማከል አለባቸው፤ ያልተዛመደ መልእክት ማለት ትኬት አይከፈትም ማለት ነው።';
