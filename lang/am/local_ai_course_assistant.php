...
$string['settings:rag_return_scope'] = 'የማምጣት መመለሻ ወሰን';
$string['settings:rag_return_scope_desc'] = 'ለእያንዳንዱ የተገኘ ግጥሚያ ምን እንደሚካተት። "chunk" (ነባሪ) የተዛመደውን ~400 ቃላት ያለው ቁራጭ ያስገባል። "window" የተዛመደውን ቁራጭ ከተመሳሳይ ገጽ አጎራባች ቁራጮች ጋር ያስገባል። "page" ግጥሚያው የሚገኝበትን ሙሉ የሞጁል ገጽ ያስገባል። window/page ትልቅ ጥያቄ (prompt) ወጪ ቢያስከትሉም መልስ አንድን ገጽ ሙሉ በሙሉ ሲሸፍን ይረዳሉ።';
$string['settings:rag_window_size'] = 'የማምጣት መስኮት መጠን';
$string['settings:rag_window_size_desc'] = '"window" ለተባለው የመመለሻ ወሰን: በተዛመደው ቁራጭ በእያንዳንዱ ጎን የሚካተቱ አጎራባች ቁራጮች ብዛት። ነባሪ 1.';
$string['settings:rag_parent_max_chars'] = 'የወላጅ ምንባብ ገደብ (ፊደላት)';
$string['settings:rag_parent_max_chars_desc'] = 'ለተስፋፋ window/page ምንባብ ከፍተኛው የፊደላት ብዛት። ገደቡን የሚያልፉ ገጾች ወደ window፣ ከዚያም ወደ ነጠላ ቁራጭ ይመለሳሉ። ነባሪ 6000.';
...
$string['cachedef_ratelimit'] = 'የተጠቃሚ ጥያቄ ፍጥነት ገደብ';
$string['cachedef_uistate'] = 'የክፍለ-ጊዜ UI ማብሪያ/ማጥፊያዎች (እንደ ተማሪ መመልከት፣ እውነተኛ ስሞችን ማሳየት)';
$string['benchmark:pagetitle'] = 'የአቅራቢ ንጽጽር ፈተና';
$string['benchmark:intro'] = 'ተመሳሳይ የሆኑ የተለመዱ ጥያቄዎችን ወደ እያንዳንዱ የተዋቀረ AI አቅራቢ ይልካል፣ የቶከን አጠቃቀምን፣ ወጪንና መዘግየትን ይመዘግባል፣ ለእያንዳንዱ ችሎታ አንድ አቅራቢ ይመክራል። እያንዳንዱ ሙከራ እውነተኛ የ API ጥሪዎችን ስለሚያደርግ፣ ስንት አቅራቢዎች እንደተዋቀሩ በመወሰን አንድ ሙከራ ግምት 5 እስከ 20 ሳንቲም ያስከፍላል።';
$string['cachedef_systemprompt'] = 'የተሰበሰበ የ AI ስርዓት ጥያቄ (በኮርስ)';
$string['cachedef_remoteconfig'] = 'ከዝማኔ ቻናል የተገኘ የርቀት ውቅረት';
$string['cachedef_spend'] = 'ለወጪ ጠባቂ የወቅት-ወጪ ድምሮች';
$string['cachedef_failover_circuit'] = 'የአቅራቢ ተለዋጭ ወደ ሌላ የመዞር ወረዳ-ሰባሪ ሁኔታ';
$string['settings:rag_scope'] = 'የማውጣት ወሰን';
$string['settings:rag_scope_desc'] = 'አንድ ተማሪ የተወሰነ ሰነድ (ገጽ፣ መጽሐፍ ወይም PDF) እየተመለከተ ሲሆን፣ ማውጣትን ወደ ያ ሰነድ መገደብ ወይም አለመገደብ። <b>ሰነድ-መጀመሪያ</b> አግባብ ያላቸው ክፍልፋዮች ሲኖሩት መልሱን በአሁኑ ሰነድ ላይ ያደርገዋል፣ ካለበለዚያ ወደ ሙሉ ኮርሱ ይመለሳል። <b>ሰነድ-ብቻ</b> ወደ ሌላ አይመለስም፦ አሁኑ ሰነድ አግባብ ያለው ክፍልፋይ ከሌለው ምንም አያወጣም፣ ስለዚህ አስተማሪው ካልተዛመዱ ገጾችን ከመጥቀስ ይልቅ ከጠቅላላ እውቀት ይመልሳል። <b>ኮርስ-አቀፍ</b> ሁሉንም የኮርስ ይዘት ይፈልጋል (አሁኑ ገጽ አሁንም ከላይ ያለውን የቅደም ተከተል ማጎልበቻ ያገኛል)። ስለ ተማሪው እያነበበ ስላለው ገጽ ያለ መልስ በዚያ ገጽ ላይ እንዲመሠረት ሰነድ-መጀመሪያ ይመከራል።';
$string['settings:rag_scope_document_first'] = 'ሰነድ-መጀመሪያ (አሁኑን ሰነድ ይመርጣል፣ ወደ ኮርሱ ይመለሳል)';
$string['settings:rag_scope_document_only'] = 'ሰነድ-ብቻ (በአሁኑ ሰነድ ላይ ይገድባል)';
$string['settings:rag_scope_course'] = 'ኮርስ-አቀፍ (ሁሉንም የኮርስ ይዘት ይፈልጋል)';
$string['ragadmin:no_content_documents'] = '{$a->count} ሰነድ(ዎች) ሊጠቆም የሚችል ጽሑፍ አላመነጩም እና በክፍልፋይ አልተከፋፈሉም (ብዙውን ጊዜ አብዛኛው የተቀረጹ ወይም በጣም አጭር ገጾች)፦ {$a->titles}። ከእነዚህ ውስጥ ማንኛቸውም ሊፈለጉ የሚገባ ከሆነ በገጽ ላይ ጽሑፍ ወይም ግልባጭ ይጨምሩ፣ ከዚያ እንደገና ይጠቁሙ።';
$string['privacy:metadata:sbx_rec'] = 'የ Soapbox አቀራረብ ቅጂዎች። የሚዲያ ነገሩ ከማቆያ ጊዜው በኋላ ይሰረዛል፤ ግልባጩ ለግብረ መልስና ለመዳረሻ ጥያቄዎች ይቀመጣል።';
$string['privacy:metadata:sbx_rec:userid'] = 'ቅጂውን ያደረገው ተማሪ።';
$string['privacy:metadata:sbx_rec:transcript'] = 'የቅጂው ንግግር-ወደ-ጽሑፍ ግልባጭ።';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'የቅጂው ርዝመት በሰከንዶች።';
$string['privacy:metadata:sbx_rec:timecreated'] = 'ቅጂው መቼ እንደተደረገ።';
$string['privacy:metadata:ai_provider'] = 'የአስተማሪ ምላሾችን ለማመንጨት፣ ተማሪ የደረሰው ይዘት በጣቢያው ወይም በኮርስ አስተዳዳሪው ወደተዋቀረው AI አቅራቢ ይላካል።';
$string['privacy:metadata:ai_provider:message'] = 'ተማሪው ወደ AI አስተማሪ የሚልከው የመልእክት ጽሑፍና አባሪዎች።';
$string['privacy:metadata:ai_provider:coursecontext'] = 'መልሱን ለማመሥረት የተካተተ የኮርስና የእንቅስቃሴ ዐውድ (እንደ የኮርሱ ስም እና አሁኑ ገጽ)።';
$string['privacy:metadata:voice_provider'] = 'የድምጽ ግብዓት ወይም ውጤት ሲጠቀም፣ ድምጽና ጽሑፍ ወደተዋቀረው ንግግር-ወደ-ጽሑፍ / ጽሑፍ-ወደ-ንግግር አቅራቢ ይላካሉ።';
$string['privacy:metadata:voice_provider:audio'] = 'ተማሪው ሲናገር የተቀዳ ድምጽ፣ ለግልባጭ የተላከ።';
$string['privacy:metadata:voice_provider:text'] = 'ወደ ንግግር እንዲሠራ ወደ አቅራቢው የተላከ ጽሑፍ።';
$string['privacy:metadata:zendesk'] = 'የሰው-ድጋፍ ማሳደግ ሲንቀሳቀስ እና ተማሪው ሲፈቅድ፣ የመገናኛ ዝርዝሮቻቸውና መልእክታቸው የድጋፍ ትኬት ለመክፈት ወደ Zendesk ይላካሉ።';
$string['privacy:metadata:zendesk:name'] = 'የድጋፍ ጠያቂውን ለመለየት የሚያገለግል የተማሪው ሙሉ ስም።';
$string['privacy:metadata:zendesk:email'] = 'የድጋፍ ጥያቄውን ለመመለስ የሚያገለግል የተማሪው የኢሜይል አድራሻ።';
$string['privacy:metadata:zendesk:message'] = 'ተማሪው ለማሳደግ የመረጠው መልእክት ወይም የውይይት ይዘት።';
...
$string['analytics_js:ai_users'] = 'የ AI ተጠቃሚዎች';
$string['analytics_js:non_users'] = 'ተጠቃሚ ያልሆኑ';
$string['analytics_js:thumbs_up'] = 'አውራ ጣት ወደ ላይ';
$string['analytics_js:thumbs_down'] = 'አውራ ጣት ወደ ታች';
$string['analytics_js:hallucination_flags'] = 'የቅዠት ምልክቶች';
$string['analytics_js:avg_star_rating'] = 'አማካይ የኮከብ ደረጃ';
$string['analytics_js:avg_msgs_resolution'] = 'እስከ መፍትሔ አማካይ መልእክቶች';
$string['analytics_js:survey_respondents'] = 'የዳሰሳ ጥናት ተሳታፊዎች';
$string['analytics_js:messages'] = 'መልእክቶች';
$string['analytics_js:students'] = 'ተማሪዎች';
$string['analytics_js:frequency'] = 'ድግግሞሽ';
$string['analytics_js:responses'] = 'ምላሾች';
$string['analytics_js:error_loading'] = 'ውሂብ በመጫን ላይ ስህተት';
$string['analytics_js:loading'] = 'ትንታኔዎችን በመጫን ላይ...';
$string['analytics_js:no_course_data'] = 'ምንም የኮርስ ውሂብ የለም።';
$string['analytics_js:no_unit_data'] = 'እስካሁን ምንም የክፍል ውሂብ የለም። የክፍል ክትትል ተማሪዎች ረዳቱን ሲጠቀሙ ይጠራቀማል።';
$string['analytics_js:no_keyword_data'] = 'ለዚህ ወቅት ምንም የቁልፍ-ቃል ውሂብ የለም።';
$string['task:soapbox_cleanup'] = 'የ Soapbox ቅጂ ማቆያና ጽዳት';
$string['admin:vendor_dpa:col_provider'] = 'አቅራቢ';
$string['admin:vendor_dpa:col_optout'] = 'ከስልጠና መውጣት';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'ማቆያ';
$string['admin:vendor_dpa:col_tier'] = 'የደረጃ ጣሪያ';
$string['admin:vendor_dpa:col_link'] = 'አገናኝ';
$string['admin:vendor_dpa:vendor_terms'] = 'የአቅራቢ ውሎች';
$string['admin:vendor_dpa:tier'] = 'ደረጃ {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'በውል (ወጥቷል)';
$string['admin:vendor_dpa:too_default_on'] = 'በነባሪ በርቷል';
$string['admin:vendor_dpa:too_none'] = 'መውጣት የለም';
$string['admin:vendor_dpa:too_local'] = 'አካባቢያዊ (ያለ አቅራቢ)';
$string['admin:vendor_dpa:too_unknown'] = 'እስካሁን አልተገመገመም';
$string['admin:vendor_dpa:dpa_signed'] = 'የተፈረመ';
$string['admin:vendor_dpa:dpa_available'] = 'ይገኛል';
$string['admin:vendor_dpa:dpa_negotiating'] = 'በድርድር ላይ';
$string['admin:vendor_dpa:dpa_not_offered'] = 'አልቀረበም';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'አይመለከትም';
$string['admin:vendor_dpa:dpa_unknown'] = 'ያልታወቀ';
$string['settings:soapbox_slide_vision'] = 'የ Soapbox ስላይድ የእይታ-ንድፍ ግብረ መልስ';
$string['settings:soapbox_slide_vision_desc'] = 'ወደ ተመዘኑ አቀራረብ አጭር የእይታ-ንድፍ ማስታወሻ ለመጨመር በተሳሉ የስላይድ ምስሎች ላይ አንድ ነጠላ የእይታ ማለፊያ ይፍቀዱ። በነባሪ ጠፍቷል እና ግላዊነትን ያገናዘበ ነው፦ ምንም ምስሎች አይቀመጡም፣ እያንዳንዱ ስራም በራሱ የ Slide የእይታ-ንድፍ ግብረ መልስ ሳጥን በኩል መስማማት አለበት። የተጫነ ስብስብ ያላቸው የስላይድ አቀራረቦች ብቻ ተጽዕኖ ይደረግባቸዋል።';
$string['settings:soapbox_vision_provider'] = 'የ Soapbox ስላይድ-እይታ አቅራቢ';
$string['settings:soapbox_vision_provider_desc'] = 'ለስላይድ-እይታ ማለፊያ ጥቅም ላይ የሚውል አቅራቢ። በነባሪ openai ነው። በ API ቁልፍ የተዋቀረ (በኮርስ አቅራቢው ወይም በንጽጽር-አቅራቢዎች ዝርዝር በኩል) የእይታ-ችሎታ ያለው አቅራቢ መሆን አለበት።';
$string['settings:soapbox_vision_model'] = 'የ Soapbox ስላይድ-እይታ ሞዴል';
$string['settings:soapbox_vision_model_desc'] = 'ለስላይድ-እይታ ማለፊያ የእይታ-ችሎታ ያለው ሞዴል። በነባሪ gpt-4o-mini ነው።';
$string['soapbox:slide_design_note'] = 'የስላይድ ንድፍ:';
$string['soapbox:assign_manage'] = 'የ Soapbox አቀራረብ ስራዎች';
$string['soapbox:copy_link'] = 'የተማሪ አገናኝ';
$string['soapbox:deck_label'] = 'ስላይዶች (PDF)። ስብስብዎን ይጫኑ፣ ከዚያ ሲቀዱ ስላይዶቹን ያራምዱ።';
$string['soapbox:slide_prev'] = 'የቀድሞ ስላይድ';
$string['soapbox:slide_next'] = 'ቀጣይ ስላይድ';
$string['soapbox:play_slides'] = 'ከስላይዶች ጋር አጫውት';
$string['soapbox:audio_ready'] = 'ድምጽ ብቻ። ማይክሮፎንዎ ይቀዳል፤ ካሜራዎ ጥቅም ላይ አይውልም።';
$string['soapbox:audio_recording'] = 'ድምጽ በመቅዳት ላይ...';
$string['soapbox:cap_reached'] = 'ለዚህ ስራ ከፍተኛውን የቅጂዎች ብዛት ደርሰዋል።';
$string['soapbox:storage_unconfigured'] = 'የቅጂ ማከማቻ ገና አልተዋቀረም። እባክዎ አስተዳዳሪዎን ያነጋግሩ።';
$string['soapbox:bad_key'] = 'ያ ጭነት የእርስዎ አይደለም።';
$string['soapbox:slides_disabled'] = 'ለዚህ ስራ ስላይዶች አልነቁም።';
$string['soapbox:upload_missing'] = 'ጭነቱ ሊገኝ አልቻለም። እባክዎ እንደገና ለመቅዳት ይሞክሩ።';
$string['soapbox:mode_label'] = 'የአቀራረብ ዓይነት';
$string['soapbox:mode_informative'] = 'መረጃ ሰጪ (ማብራራት ወይም ማስተማር)';
$string['soapbox:mode_persuasive'] = 'አሳማኝ (ማሳመን)';
$string['soapbox:err_provider'] = 'የ AI ውጤት አሰጣጥ አገልግሎት ሊደረስበት አልቻለም። እባክዎ ከቅጽበት በኋላ እንደገና ይሞክሩ።';
$string['soapbox:err_parse'] = 'AI ያልተጠበቀ ምላሽ መልሷል። እባክዎ እንደገና ይሞክሩ።';
$string['soapbox:err_disabled'] = 'ለዚህ ኮርስ የንግግር ልምምድ አልነቃም።';
$string['soapbox:err_transcribe'] = 'ቅጂዎ ሊገለበጥ አልቻለም። እባክዎ እንደገና ይሞክሩ፣ እና ማይክሮፎንዎ እየሠራ መሆኑን ያረጋግጡ።';
$string['settings:outcomes_benchmark_default'] = 'የውጤት መለኪያ (መቶኛ)';
$string['settings:outcomes_benchmark_default_desc'] = 'ለውጤቶች ሪፖርት በተቋም-የተቀመጠ መለኪያ፦ አንድ ተማሪ ብቃታቸው በዚህ መቶኛ ላይ ወይም ከዚያ በላይ ሲሆን ውጤትን ያሟላል። ይህ የሪፖርት አቀራረብ መስፈርት ነው (ከአሰልጣኝ ብቃት ደረጃ ጋር የተለየ)። ነባሪ 70።';
$string['outcomes:title'] = 'የውጤቶች ሪፖርት';
$string['outcomes:intro'] = 'ለእያንዳንዱ የኮርስ ውጤት፣ መለኪያውና ያሟሉ ወይም ያለፉ የተገመገሙ ተማሪዎች መቶኛ። የጣቢያው መለኪያ {$a}% ነው።';
$string['outcomes:none'] = 'ለዚህ ኮርስ ገና ምንም ውጤቶች አልተገለጹም።';
$string['outcomes:export'] = 'CSV ወደ ውጭ ላክ';
$string['outcomes:col_outcome'] = 'ውጤት';
$string['outcomes:col_benchmark'] = 'መለኪያ';
$string['outcomes:col_assessed'] = 'የተገመገሙ ተማሪዎች';
$string['outcomes:col_met'] = 'መለኪያ ያሟሉ';
...
$string['soapbox:present_audio'] = 'የድምፅ አቀራረብ';
$string['soapbox:present_video'] = 'የቪዲዮ አቀራረብ';
$string['soapbox:present_target'] = 'ዒላማ {$a->min}-{$a->max} ደቂቃ';
$string['soapbox:choose_topic'] = 'ርዕስ ይምረጡ';
$string['soapbox:record_short'] = 'ቅዳ';
$string['soapbox:my_recordings'] = 'የእኔ ቅጂዎች';
$string['soapbox:no_recordings'] = 'እስካሁን ምንም ቅጂ የለም።';
$string['soapbox:col_recorded'] = 'የተቀዳበት';
$string['soapbox:col_length'] = 'ርዝመት';
$string['soapbox:col_type'] = 'ዓይነት';
$string['soapbox:col_recording'] = 'ቅጂ';
$string['soapbox:col_kept'] = 'ተጠብቋል';
$string['soapbox:col_student_link'] = 'የተማሪ አገናኝ';
$string['soapbox:view_download'] = 'ይመልከቱ / ያውርዱ';
$string['soapbox:expired'] = 'ጊዜው አልፎበታል';
$string['soapbox:retention_note'] = 'ቅጂዎች ለ{$a} ቀናት ሊታዩና ሊወርዱ ይችላሉ፣ ከዚያ በኋላ በራስ-ሰር ይሰረዛሉ።';
$string['soapbox:assign_title'] = 'የSoapbox ስራዎች';
$string['soapbox:assign_single_title'] = 'የSoapbox ስራ';
$string['soapbox:assign_add'] = 'ስራ ጨምር';
$string['soapbox:assign_none'] = 'እስካሁን የSoapbox ስራ የለም።';
$string['soapbox:assign_deleted'] = 'ስራው ተሰርዟል።';
$string['soapbox:assign_updated'] = 'ስራው ተዘምኗል።';
$string['soapbox:assign_created'] = 'ስራው ተፈጥሯል።';
