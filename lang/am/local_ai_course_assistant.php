...
$string['soapbox:present_privacy'] = 'ቀረጻዎ እንዲገለበጥና እንዲገመገም ወደ Saylor ማከማቻ ይሰቀላል። እርስዎና የጣቢያው አስተዳዳሪዎች ብቻ ሊከፍቱት ይችላሉ። ከቀረጹ ከ{$a} ቀናት በኋላ ለሰውነት ቋንቋ አስተያየት ከተጠቀሙባቸው ቋሚ ምስሎች ጋር በራስ-ሰር ይሰረዛል። ቪዲዮው ከጠፋ በኋላም ግልባጭዎ፣ ውጤቶችዎና አስተያየትዎ ይቆያሉ፣ ስለዚህ ማቆየት የሚፈልጉትን ያውርዱ።';
