...
$string['settings:embed_input_type_asymmetric'] = 'ያልተመጣጠነ query/document';
$string['settings:embed_input_type_mode'] = 'የEmbedding ግብዓት ዓይነት';
$string['settings:embed_input_type_mode_desc'] = 'Voyage embeddings ብቻ። "Shared space" queries እና documents ን በአንድ መንገድ embed ያደርጋል፣ ስለዚህ ሞዴል ሲቀየር ሁለቱ ሊነጻጸሩ ይቀጥላሉ። "Asymmetric" የVoyage ን የተለየ query projection ይጠቀማል፤ የአቅራቢው የሚመክረው ማሻሻያ ነው ግን በዚህ corpus ላይ ሁለት ጊዜ ምንም ጥቅም ማስገኘት አልቻለም፣ ስለዚህ shared ነባሪው ነው። ይህን መቀየር ዳግም ኢንዴክስ ማድረግ አያስፈልገውም።';
$string['settings:embed_input_type_shared'] = 'Shared space (የሚመከር)';
