...
$string['emergency:title'] = 'SOLA nödkontroller';
$string['emergency:page_warning'] = 'Dessa reglage träder i kraft omedelbart för varje elev på webbplatsen. Varje åtgärd skriver en granskningsrad. Granulära reglage låter resten av SOLA fortsätta köra; huvudavstängningen tar bort widgeten helt.';
$string['emergency:back_to_settings'] = 'SOLA-inställningar';
...
$string['emergency:flag_chat_desc'] = 'Blockerar chatttrafik via den dedikerade kill-flaggan (korrigering v5.13). Widgeten fortsätter att renderas; elever ser det vänliga meddelandet "SOLA pausad". Använd när en LLM-leverantör beter sig felaktigt eller en kostnadsspigg pågår.';
...
$string['emergency:flag_all_desc'] = 'Inaktiverar hela pluginet: widgeten försvinner från varje sida, schemalagda uppgifter stoppas, röst rensas, RAG av, utskick av. Den starkaste reglaget — använd vid säkerhetsincident eller när SOLA måste tas offline omedelbart.';
$string['emergency:settings_link'] = 'Nödkontroller';
$string['emergency:settings_link_desc'] = 'Kill-reglage per delsystem (chatt / röst / RAG / utskick / huvud) med granskningsloggning — webbmotsvarigheten till <code>admin/cli/emergency_disable.php</code>. Öppna <a href="{$a}">SOLA nödkontroller</a>.';
$string['email_unsubscribe:done_title'] = 'Avregistrerad';
$string['email_unsubscribe:done_body'] = 'Klart — {$a->email} kommer inte längre att ta emot den här typen av e-post från {$a->product}. Om du ändrar dig, be en {$a->product}-administratör att återaktivera prenumerationen, eller skicka ett nytt opt-in via sidan SOLA Recipients i administrationspanelen.';
...
$string['analytics:exp_active_users'] = 'Aktiva SOLA-användare';
