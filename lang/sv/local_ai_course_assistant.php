...
$string['chat:consent_body'] = '{$a->product} är en AI-driven inlärningsassistent. Dina meddelanden och {$a->product}s svar lagras i {$a->institution}s Moodle-databas och de tio senaste turerna skickas till en godkänd AI-modellleverantör för att besvara dina frågor. Ditt förnamn delas för personalisering; ingen annan identifierande information skickas till AI-leverantören. Om du ber om mänsklig hjälp och din fråga eskaleras kan denna konversation (inklusive ditt namn och din e-post) delas med vårt supportteam. Du kan när som helst ladda ner, radera eller sluta använda {$a->product}.';
...
$string['settings:current_page_content_maxchars_desc'] = 'Maximalt antal tecken av den aktuella sidans text som injiceras i systemprompten som avsnittet "Current Page Content", när RAG är avstängt. Standardvärdet 8,000 förankrar sidspecifika frågor väl samtidigt som det lämnar utrymme för struktur och instruktioner. (Med RAG aktiverat förankras sidan i stället av sina egna mest relevanta avsnitt, med tendens mot aktuell sida, så denna gräns gäller inte.) En mycket lång sida trunkeras från början till så här många tecken, så slutet på en extremt lång sida kanske inte citeras; att aktivera RAG undviker detta. Kostnadsmedvetna webbplatser kan begränsa lägre (t.ex. 3,000-4,000). Begränsat till intervallet 500-8,000. Oberoende av <code>prompt_budget_chars</code>: detta begränsar endast sidavsnittet; budgeten begränsar hela prompten.';
...
$string['settings:backend_context_tokens'] = 'Backend-kontextfönster (tokens)';
$string['settings:backend_context_tokens_desc'] = 'Den maximala kontextlängden (max_model_len) för din AI-backend, i tokens. Sätt till 0 för värdmodeller med ett stort fönster (ingen begränsning). När det sätts över 0 (till exempel 8192 på en självhostad vLLM-backend) krymper SOLA teckenbudgeten för systemprompten ovan så att prompten plus reserverad utdata och konversationshistorik får plats i fönstret, även i tokentäta språk. Se wikisidan Deployment Sizing för hur detta motsvarar samtidiga användare.';
$string['settings:backend_retry_attempts'] = 'Backend-återförsök';
$string['settings:backend_retry_attempts_desc'] = 'Hur många gånger ett tillfälligt backend-fel (HTTP 429 eller 503) ska försökas igen innan ett fel visas för studenten. Återförsök sker endast innan någon svarstext har strömmats, så utdata dupliceras aldrig. Avsett för små självhostade backends som avvisar förfrågningar under belastning. Sätt till 0 för att inaktivera. Standard 2.';
$string['settings:backend_retry_max_wait'] = 'Maximal väntetid för backend-återförsök (sekunder)';
$string['settings:backend_retry_max_wait_desc'] = 'Övre gräns, i sekunder, för hur länge ett Retry-After-huvud från backend ska respekteras innan återförsök. När backend inte skickar något Retry-After använder SOLA i stället en kort exponentiell backoff. Standard 5.';
$string['prompt:truncation_hint'] = 'OBS: Det fullständiga kursinnehållet kunde inte sökas igenom denna gång på grund av längdbegränsningar. Om studenten frågar om något du inte kan hitta i det tillhandahållna innehållet, säg att du inte kunde söka igenom hela kursen och föreslå att de öppnar den specifika sida eller aktivitet där ämnet behandlas, i stället för att uppge att det saknas i kursen.';
$string['selftest:title'] = 'Självtest av backend';
$string['selftest:intro'] = 'Kör en livekontroll av din konfigurerade AI-backend: en liten chattutväxling, automatisk identifiering av kontextfönstret (max_model_len) och en jämförelse mot din inställning för backend-kontextfönster, det lägsta golvet för systempromptens budget och (när RAG är på) en inbäddningsutväxling. Nätverksanrop körs endast när du trycker på Kör.';
$string['selftest:run'] = 'Kör självtest av backend';
$string['selftest:check'] = 'Kontroll';
$string['selftest:status'] = 'Status';
$string['selftest:detail'] = 'Detalj';
$string['selftest:link'] = 'Sida för självtest av backend';
$string['selftest:link_desc'] = 'Öppna sidan <a href="{$a}">Självtest av backend</a> för att verifiera att din AI-backend fungerar och är korrekt dimensionerad. Användbart direkt efter att du konfigurerat en självhostad backend.';
$string['profile:title'] = 'Distributionsförinställningar';
$string['profile:intro'] = 'Tillämpa ett rekommenderat paket med inställningar för din distributionstyp. Värdena skrivs in i de vanliga plugin-inställningarna och förblir individuellt redigerbara efteråt. Att tillämpa en förinställning skriver över de listade inställningarna.';
$string['profile:current'] = 'Senast tillämpade förinställning: {$a}';
$string['profile:setting'] = 'Inställning';
$string['profile:value'] = 'Värde';
$string['profile:self_hosted_small'] = 'Självhostad liten kontext (enkel GPU, t.ex. A30 24GB / vLLM vid 8K)';
$string['profile:hosted_large'] = 'Värdbaserad stor kontext (standard)';
$string['profile:apply_self_hosted_small'] = 'Tillämpa förinställning för självhostad liten kontext';
$string['profile:apply_hosted_large'] = 'Tillämpa standardvärden för värdbaserad stor kontext';
$string['profile:applied'] = 'Förinställningen {$a} tillämpades. Värdena finns nu i dina plugin-inställningar.';
$string['profile:unknown'] = 'Okänd distributionsförinställning.';
$string['profile:link'] = 'Sida för distributionsförinställningar';
$string['profile:link_desc'] = 'Öppna sidan <a href="{$a}">Distributionsförinställningar</a> för att tillämpa ett rekommenderat paket med inställningar för en värdbaserad eller självhostad backend.';
$string['settings:zendesk_require_consent'] = 'Kräv samtycke före eskalering till support';
$string['settings:zendesk_require_consent_desc'] = 'När det är på (rekommenderas) eskalerar SOLA en konversation till Zendesk-supportdesken först efter att eleven har accepterat samtyckesmeddelandet vid första körningen, som upplyser om att en begäran om mänsklig hjälp delar konversationen (inklusive namn och e-post) med supporten. Stäng endast av detta om du inhämtar det samtycket på något annat sätt; med det avstängt skickas eskaleringar omedelbart. Har ingen effekt om inte Zendesk-eskalering är aktiverad.';
$string['chat:escalation_needs_consent'] = 'Det verkar som att detta behöver en medlem i vårt supportteam. För att lämna över det till dem skulle jag behöva dela denna konversation, inklusive ditt namn och din e-post, med supportdesken. Du har inte gått med på det än, så jag har inte skickat något. Om du vill ha mänsklig hjälp, vänligen acceptera meddelandet om datadelning för denna assistent och fråga igen, eller kontakta supporten direkt.';
$string['privacy:metadata:email_optout'] = 'Inställningar för e-postavanmälan per mottagare (vilka e-posttyper en mottagare har avanmält sig från).';
...
$string['settings:rag_min_similarity'] = 'Lägsta relevans (cosinus)';
$string['settings:rag_min_similarity_desc'] = 'Förkasta hämtade textavsnitt vars cosinuslikhet med frågan är under detta värde, så att en fråga utanför ämnet eller med tunt innehåll injicerar färre (eller noll) avsnitt i stället för att alltid fylla upp till Top-K med svaga träffar. Intervall 0 till 1; 0 inaktiverar spärren. Rätt värde beror på inbäddningsmodellen: 0.25 passar text-embedding-3-small. Höj det för att vara striktare (mindre, mer ämnesrelevant kontext), sänk det för att vara mer tillåtande.';
$string['settings:rag_currentpage_boost'] = 'Bonus för aktuell sida';
$string['settings:rag_currentpage_boost_desc'] = 'En liten bonus som läggs till relevanspoängen för avsnitt från sidan som den studerande för närvarande tittar på, så att frågor som "förklara detta" föredrar den synliga sidan när poängen ligger nära varandra. Endast ordning: det tvingar inte ett irrelevant sidavsnitt förbi spärren för lägsta relevans. Ställ in 0 för att inaktivera.';
$string['settings:history_mode'] = 'Läge för val av historik';
$string['settings:history_mode_desc'] = 'Hur tidigare turer i konversationen väljs ut innan de skickas till modellen. <strong>Semantiskt</strong> behåller endast de senaste turerna som är relevanta för den aktuella frågan (och alltid det senaste utbytet), så att en föråldrad, ämnesfrämmande tidigare tur inte blåser upp kostnaden eller styr svaret fel; det gör ett extra inbäddningsanrop per meddelande. <strong>Senaste</strong> behåller de senaste paren "Max Conversation History" oavsett relevans (det sedan länge etablerade beteendet, inget extra anrop). Om inbäddning inte är tillgänglig faller det semantiska läget automatiskt tillbaka på senaste.';
$string['settings:history_mode_semantic'] = 'Semantiskt (relevanta senaste turer)';
$string['settings:history_mode_recency'] = 'Senaste (de N senaste paren)';
$string['settings:history_semantic_minscore'] = 'Lägsta relevansgräns för historik (cosinus)';
$string['settings:history_semantic_minscore_desc'] = 'I semantiskt historikläge behålls en tidigare tur endast om dess likhet med den aktuella frågan är minst detta värde (det senaste utbytet behålls alltid). Intervall 0 till 1; modellberoende. Höj för att vara striktare (mindre historik), sänk för att behålla mer.';
$string['settings:history_candidates'] = 'Kandidatfönster för historik';
$string['settings:history_candidates_desc'] = 'I semantiskt historikläge bedöms endast så här många av de senaste paren för relevans (en kostnadsgräns). Par som är äldre än detta fönster skickas inte. Håll detta värde på eller över "Max Conversation History".';
