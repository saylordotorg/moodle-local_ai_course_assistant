...
$string['emergency:title'] = 'SOLA:n hätäkontrollit';
$string['emergency:page_warning'] = 'Nämä kytkimet astuvat voimaan välittömästi kaikille sivuston oppijoille. Jokainen toiminto kirjoittaa tarkastusrivin. Yksityiskohtaiset kytkimet jättävät muun SOLA:n toimintaan; pääkytkin poistaa widgetin kokonaan.';
$string['emergency:back_to_settings'] = 'SOLA:n asetukset';
...
$string['emergency:flag_chat_desc'] = 'Estää chat-liikenteen omistautuneen kill-lipun kautta (v5.13-korjaus). Widget jatkaa renderöintiä; oppijat näkevät ystävällisen "SOLA tauolla" -viestin. Käytä, kun LLM-palveluntarjoaja käyttäytyy huonosti tai kustannuspiikki on käynnissä.';
...
$string['emergency:flag_all_desc'] = 'Poistaa koko laajennuksen käytöstä: widget poistuu kaikilta sivuilta, ajastetut tehtävät pysähtyvät, ääni tyhjennetään, RAG pois päältä, tavoittaminen pois päältä. Vahvin kytkin — käytä tietoturvaloukkauksen yhteydessä tai kun SOLA on poistettava käytöstä välittömästi.';
$string['emergency:settings_link'] = 'Hätäkontrollit';
$string['emergency:settings_link_desc'] = 'Alijärjestelmäkohtaiset kill-kytkimet (chat / ääni / RAG / tavoittaminen / pää) tarkastuslokin kanssa — <code>admin/cli/emergency_disable.php</code>:n verkkovastine. Avaa <a href="{$a}">SOLA:n hätäkontrollit</a>.';
$string['email_unsubscribe:done_title'] = 'Tilaus peruutettu';
$string['email_unsubscribe:done_body'] = 'Valmis — {$a->email} ei enää vastaanota tämäntyyppisiä sähköposteja kohteelta {$a->product}. Jos muutat mieltäsi, pyydä {$a->product}-järjestelmänvalvojaa ottamaan tilaus uudelleen käyttöön tai lähetä uusi hyväksyntä SOLA-vastaanottajien hallintasivun kautta.';
...
$string['analytics:exp_active_users'] = 'Aktiiviset SOLA-käyttäjät';
