...
$string['soapbox:present_audio'] = 'Bài thuyết trình âm thanh';
$string['soapbox:present_video'] = 'Bài thuyết trình video';
$string['soapbox:present_target'] = 'mục tiêu {$a->min}-{$a->max} phút';
$string['soapbox:choose_topic'] = 'Chọn một chủ đề';
$string['soapbox:record_short'] = 'Ghi âm';
$string['soapbox:my_recordings'] = 'Bản ghi của tôi';
$string['soapbox:no_recordings'] = 'Chưa có bản ghi nào.';
$string['soapbox:col_recorded'] = 'Đã ghi';
$string['soapbox:col_length'] = 'Thời lượng';
$string['soapbox:col_type'] = 'Loại';
$string['soapbox:col_recording'] = 'Bản ghi';
$string['soapbox:col_kept'] = 'Lưu giữ';
$string['soapbox:col_student_link'] = 'Liên kết cho học viên';
$string['soapbox:view_download'] = 'Xem / tải xuống';
$string['soapbox:expired'] = 'Đã hết hạn';
$string['soapbox:retention_note'] = 'Các bản ghi có thể xem và tải xuống trong {$a} ngày, sau đó sẽ tự động bị xóa.';
$string['soapbox:assign_title'] = 'Bài tập Soapbox';
$string['soapbox:assign_single_title'] = 'Bài tập Soapbox';
$string['soapbox:assign_add'] = 'Thêm bài tập';
$string['soapbox:assign_none'] = 'Chưa có bài tập Soapbox nào.';
$string['soapbox:assign_deleted'] = 'Đã xóa bài tập.';
$string['soapbox:assign_updated'] = 'Đã cập nhật bài tập.';
$string['soapbox:assign_created'] = 'Đã tạo bài tập.';
