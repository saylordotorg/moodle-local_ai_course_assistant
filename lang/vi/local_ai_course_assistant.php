...
$string['settings:embed_input_type_mode_desc'] = 'Chỉ áp dụng cho embedding của Voyage. "Shared space" embed truy vấn và tài liệu theo cùng một cách, nên cả hai vẫn so sánh được với nhau qua một lần đổi mô hình. "Asymmetric" dùng phép chiếu truy vấn riêng của Voyage; đó là tối ưu hóa mà nhà cung cấp gợi ý nhưng đã hai lần không tái lập được lợi ích nào trên corpus này, nên shared là mặc định. Đổi thiết lập này không cần lập chỉ mục lại.';
$string['settings:embed_input_type_shared'] = 'Shared space (khuyến nghị)';
