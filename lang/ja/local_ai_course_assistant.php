...
$string['settings:escalation_intent_patterns_desc'] = '1行に1つの正規表現を記述します。# で始まる行は無視されます。サポートチケットが作成されるのは、学習者自身のメッセージがいずれかのパターンに一致した場合のみです。そのため、コース教材が学習者に代わってエスカレーションを引き起こすことはありません。空欄のままにすると組み込みの既定値が使われ、英語に加えてスペイン語・フランス語・ドイツ語・ポルトガル語の一般的な言い回しに対応します。学習者が他の言語で書くサイトでは、ここにパターンを追加してください。一致しないメッセージではチケットは作成されません。';
