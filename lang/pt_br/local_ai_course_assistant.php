...
$string['settings:default_course_mode_desc'] = 'Controla se o [[tutorshort]] aparece em um curso quando nenhuma escolha por curso foi feita. Novas instalações usam por padrão "Desativado por padrão" para que os administradores possam ativar curso por curso pela página Analytics ou pela página Course AI Settings.';
...
$string['settings:auto_open_desc'] = 'Quando habilitado, a gaveta do [[tutorshort]] abre automaticamente na primeira vez que um aluno entra em cada curso. Carregamentos de página subsequentes no mesmo curso não reabrem a gaveta — o estado é rastreado por curso no navegador do aluno via localStorage. Aplica-se em desktop e celular. Pode ser substituído por curso na página Course AI Settings.';
...
$string['coursesettings:sola_enabled'] = '[[tutorshort]] neste curso';
$string['coursesettings:sola_enabled_toggle'] = 'Mostrar o widget do [[tutorshort]] neste curso';
$string['coursesettings:sola_enabled_desc'] = 'Controla se o widget de chat do [[tutorshort]] aparece neste curso. O padrão para todo o site é definido nas configurações do plugin em General > Default for new courses.';
...
$string['chat:greeting'] = 'Olá, {$a}! Sou [[tutorshort]]. Como posso ajudá-lo hoje?';
$string['chat:title'] = '[[tutorshort]]';
$string['chat:assistant'] = '[[tutorshort]]';
$string['chat:open'] = 'Abrir [[tutorshort]]';
...
$string['chat:voice_speaking'] = '[[tutorshort]] está falando...';
$string['chat:voice_idle'] = 'Pronto';
$string['chat:voice_error'] = 'Falha na conexão de voz. Verifique suas configurações.';
$string['chat:quiz_locked'] = '[[tutorshort]] está pausado durante os quizzes para apoiar a integridade acadêmica. Boa sorte!';
...
$string['settings:cdn_heading_desc'] = 'Sirva os recursos de frontend do [[tutorshort]] (JS/CSS) a partir de um CDN externo em vez do sistema de arquivos do Moodle. Isso permite atualizações de frontend sem atualização do plugin. Deixe a URL do CDN vazia para usar os arquivos locais do plugin.';
...
$string['chat:voice_title'] = 'Fale com [[tutorshort]]';
...
$string['mobile_disabled'] = '[[tutorshort]] não está disponível para este curso.';
$string['mobile_placeholder'] = 'Faça uma pergunta...';
$string['mobile_welcome'] = 'Olá, {$a}!';
$string['mobile_welcome_sub'] = 'Sou [[tutorshort]], seu assistente de aprendizagem. Como posso ajudar?';
...
$string['settings:rag_return_scope'] = 'Escopo de retorno da recuperação';
$string['settings:rag_return_scope_desc'] = 'O que injetar para cada resultado recuperado. "chunk" (padrão) injeta o trecho correspondente de ~400 palavras. "window" injeta o trecho correspondente mais os trechos vizinhos da mesma página. "page" injeta a página inteira do módulo à qual o resultado pertence. window/page ajudam quando uma resposta abrange uma página inteira, ao custo de um prompt maior.';
$string['settings:rag_window_size'] = 'Tamanho da janela de recuperação';
$string['settings:rag_window_size_desc'] = 'Para o escopo de retorno "window": número de trechos vizinhos a incluir de cada lado de um trecho correspondente. Padrão: 1.';
$string['settings:rag_parent_max_chars'] = 'Limite do trecho pai (caracteres)';
$string['settings:rag_parent_max_chars_desc'] = 'Número máximo de caracteres para um trecho expandido de window/page. Páginas que excedem o limite recuam para uma window e, em seguida, para o trecho único. Padrão: 6000.';
...
$string['demo:course_fullname'] = 'Curso de teste [[tutorshort]] (oculto)';
...
$string['chat:consent_body'] = 'O {$a->product} é um assistente de aprendizagem com tecnologia de IA. Suas mensagens e as respostas do {$a->product} são armazenadas no banco de dados Moodle da {$a->institution}, e os dez turnos mais recentes são enviados a um provedor de modelo de IA aprovado para responder às suas perguntas. Seu primeiro nome é compartilhado para personalização; nenhuma outra informação de identificação é enviada ao provedor de IA. Se você pedir ajuda humana e sua pergunta for escalonada, esta conversa (incluindo seu nome e e-mail) pode ser compartilhada com a nossa equipe de suporte. Você pode baixar, excluir ou parar de usar o {$a->product} a qualquer momento.';
...
$string['settings:ssrf_trusted_endpoints_desc'] = 'Uma URL por linha. Os hosts listados ignoram as verificações de loopback / IP-privado / somente-https no validador SSRF do [[tutorshort]]. Use isso apenas para LLMs auto-hospedados em uma rede que você controla — por exemplo <code>http://localhost:11434</code> para Ollama local, <code>http://10.0.0.5:8000</code> para um pod vLLM na mesma VPC. A comparação corresponde a scheme + host + port; qualquer caminho é ignorado. Padrão vazio (bloqueia tudo interno). Linhas que começam com <code>#</code> são comentários.';
...
$string['settings:xai_proxy_url_desc'] = 'URL wss público do serviço de proxy [[tutorshort]] xAI Realtime (por exemplo, wss://voice.example.com/xai-rt/rt). Quando definido junto com o segredo JWT, a voz do xAI passa pelo proxy e a chave mestra da API xAI nunca chega ao navegador. Deixe vazio para retornar à conexão direta (não recomendado em produção).';
...
$string['settings:current_page_content_maxchars_desc'] = 'Número máximo de caracteres do texto da página atual injetados no prompt do sistema como a seção "Current Page Content", quando o RAG está desativado. O padrão de 8,000 fundamenta bem as perguntas específicas da página, deixando orçamento para estrutura e instruções. (Com o RAG ativado, a página é, em vez disso, fundamentada por seus próprios trechos mais relevantes, com preferência pela página atual, portanto este limite não se aplica.) Uma página muito longa é truncada a partir do início até esta quantidade de caracteres, de modo que o final de uma página extremamente longa pode não ser citado; ativar o RAG evita isso. Sites preocupados com custo podem limitar esse valor para menos (ex.: 3,000-4,000). Limitado ao intervalo 500-8,000. Independente de <code>prompt_budget_chars</code>: isto limita apenas a seção da página; o orçamento limita o prompt inteiro.';
...
$string['pedagogy:crossmastery'] = 'Consolidação de domínio entre cursos ativada por padrão';
$string['pedagogy:crossmastery_desc'] = 'Quando ativado, o [[tutorshort]] reconhece quando um aluno já dominou um objetivo em outro curso (correspondido por referência de competência ou por título) e reconhece essa competência prévia em vez de exercitá-la novamente. Requer o acompanhamento de domínio; cursos sem objetivos têm um comportamento alternativo seguro. Apenas consultivo: nunca altera a pontuação de domínio armazenada do aluno em nenhum curso.';
$string['pedagogy:mastery_starter'] = 'Sugestão inicial baseada no domínio ativada por padrão';
$string['pedagogy:mastery_starter_desc'] = 'Quando ativado, a sugestão inicial de conversa "Em que devo focar?" é personalizada para nomear o objetivo mais fraco do aluno (e qualquer competência já dominada em outro lugar). Requer o acompanhamento de domínio; recorre à sugestão inicial genérica quando ainda não há dados de domínio.';
$string['task:rebuild_objective_links'] = 'Reconstruir os vínculos de objetivos entre cursos para a consolidação de domínio (v5.7.0)';
$string['mastery_starter:practice_label'] = 'Praticar: {$a}';
$string['objectives:rebuild_links_heading'] = 'Vínculos de domínio entre cursos';
$string['objectives:rebuild_links_help'] = 'O [[tutorshort]] vincula objetivos que correspondem entre cursos (por referência de competência ou por título) para que um aluno que dominou um tópico em outro lugar não precise exercitá-lo novamente. Os vínculos são reconstruídos automaticamente todas as noites; use este botão para reconstruí-los agora após editar os objetivos.';
...
$string['pedagogy:program_path_desc'] = 'Quando ativado, o [[tutorshort]] pode dizer ao aluno para onde o curso atual leva em seguida em seu programa (diploma ou certificado) e como os conceitos de hoje se conectam aos cursos posteriores. Lê o plugin Programs do Moodle (Degrees e Learn) e nomeia um curso seguinte específico apenas quando o programa define um pré-requisito ou uma ordem obrigatória; caso contrário, indica a posição do aluno no caminho. Apenas consultivo — nunca altera matrículas ou domínio, e usa somente a alocação de programa do próprio aluno atual. Não faz nada de forma silenciosa quando nenhum programa se aplica.';
...
$string['pedagogy:learning_path_desc'] = 'Quando ativado, o [[tutorshort]] adiciona um painel visual de percurso de aprendizagem (um botão "meu percurso" no cabeçalho do widget) mostrando o programa do aluno como uma sequência de cursos, cada um expansível para seus objetivos e o domínio do aluno. Quando o aluno atinge o limite do curso atual (conclusão ou uma alta proporção de objetivos dominados), o [[tutorshort]] também exibe um discreto banner "pronto para o próximo curso" e o menciona na conversa. Apenas consultivo; usa a alocação de programa do próprio aluno; não faz nada silenciosamente quando nenhum programa se aplica.';
...
$string['settings:backend_context_tokens'] = 'Janela de contexto do backend (tokens)';
$string['settings:backend_context_tokens_desc'] = 'O comprimento máximo de contexto (max_model_len) do seu backend de IA, em tokens. Defina como 0 para modelos hospedados com uma janela grande (sem limitação). Quando definido acima de 0 (por exemplo, 8192 em um backend vLLM auto-hospedado), o [[tutorshort]] reduz o orçamento de caracteres do prompt do sistema acima, para que o prompt mais a saída reservada e o histórico de conversa caibam na janela, mesmo em idiomas com alta densidade de tokens. Consulte a página wiki Deployment Sizing para saber como isso se relaciona com usuários simultâneos.';
$string['settings:backend_retry_attempts'] = 'Tentativas de repetição do backend';
$string['settings:backend_retry_attempts_desc'] = 'Quantas vezes repetir um erro transitório do backend (HTTP 429 ou 503) antes de mostrar um erro ao aluno. As repetições ocorrem apenas antes de qualquer texto de resposta ter sido transmitido, portanto a saída nunca é duplicada. Voltado para pequenos backends auto-hospedados que rejeitam solicitações sob carga. Defina como 0 para desativar. Padrão 2.';
$string['settings:backend_retry_max_wait'] = 'Tempo máximo de espera para repetição do backend (segundos)';
$string['settings:backend_retry_max_wait_desc'] = 'Limite superior, em segundos, de quanto tempo honrar um cabeçalho Retry-After do backend antes de repetir. Quando o backend não envia Retry-After, o [[tutorshort]] usa, em vez disso, um curto recuo exponencial. Padrão 5.';
$string['prompt:truncation_hint'] = 'OBSERVAÇÃO: O conteúdo completo do curso não pôde ser pesquisado neste turno por causa de limites de comprimento. Se o aluno perguntar sobre algo que você não consegue encontrar no conteúdo fornecido, diga que você não conseguiu pesquisar o curso inteiro e sugira que ele abra a página ou atividade específica onde o tópico é abordado, em vez de afirmar que ele está ausente do curso.';
$string['selftest:title'] = 'Autoteste do backend';
$string['selftest:intro'] = 'Execute uma verificação ao vivo do seu backend de IA configurado: uma pequena troca de mensagens de chat, detecção automática da janela de contexto (max_model_len) e uma comparação com a sua configuração de janela de contexto do backend, o piso do orçamento do prompt do sistema e (quando o RAG está ativado) uma troca de incorporação. As chamadas de rede são executadas apenas quando você pressiona Executar.';
$string['selftest:run'] = 'Executar autoteste do backend';
$string['selftest:check'] = 'Verificação';
$string['selftest:status'] = 'Status';
$string['selftest:detail'] = 'Detalhe';
$string['selftest:link'] = 'Página de autoteste do backend';
$string['selftest:link_desc'] = 'Abra a página <a href="{$a}">Autoteste do backend</a> para verificar se o seu backend de IA funciona e está dimensionado corretamente. Útil logo após configurar um backend auto-hospedado.';
$string['profile:title'] = 'Predefinições de implantação';
$string['profile:intro'] = 'Aplique um pacote recomendado de configurações para o seu tipo de implantação. Os valores são gravados nas configurações normais do plugin e permanecem editáveis individualmente depois. Aplicar uma predefinição sobrescreve as configurações listadas.';
$string['profile:current'] = 'Última predefinição aplicada: {$a}';
$string['profile:setting'] = 'Configuração';
$string['profile:value'] = 'Valor';
$string['profile:self_hosted_small'] = 'Contexto pequeno auto-hospedado (GPU única, por exemplo A30 24GB / vLLM a 8K)';
$string['profile:hosted_large'] = 'Contexto grande hospedado (padrão)';
$string['profile:apply_self_hosted_small'] = 'Aplicar predefinição de contexto pequeno auto-hospedado';
$string['profile:apply_hosted_large'] = 'Aplicar padrões de contexto grande hospedado';
$string['profile:applied'] = 'Predefinição {$a} aplicada. Os valores agora estão nas configurações do seu plugin.';
$string['profile:unknown'] = 'Predefinição de implantação desconhecida.';
$string['profile:link'] = 'Página de predefinições de implantação';
$string['profile:link_desc'] = 'Abra a página <a href="{$a}">Predefinições de implantação</a> para aplicar um pacote recomendado de configurações para um backend hospedado ou auto-hospedado.';
$string['settings:zendesk_require_consent'] = 'Exigir consentimento antes do escalonamento ao suporte';
$string['settings:zendesk_require_consent_desc'] = 'Quando ativado (recomendado), o [[tutorshort]] escalona uma conversa para a central de suporte Zendesk somente após o aluno ter aceitado o aviso de consentimento da primeira execução, que divulga que solicitar ajuda humana compartilha a conversa (incluindo nome e e-mail) com o suporte. Desative isso somente se você obtiver esse consentimento de outra maneira; com a opção desativada, os escalonamentos são enviados imediatamente. Não tem efeito a menos que o escalonamento do Zendesk esteja ativado.';
$string['chat:escalation_needs_consent'] = 'Parece que isso precisa de um membro da nossa equipe de suporte. Para repassar isso a eles, eu teria que compartilhar esta conversa, incluindo seu nome e e-mail, com a central de suporte. Você ainda não concordou com isso, então não enviei nada. Se você quiser ajuda humana, por favor aceite o aviso de compartilhamento de dados deste assistente e pergunte novamente, ou entre em contato diretamente com o suporte.';
$string['privacy:metadata:email_optout'] = 'Preferências de cancelamento de e-mail por destinatário (de quais tipos de e-mail um destinatário cancelou a inscrição).';
...
$string['settings:rag_min_similarity'] = 'Relevância mínima (cosseno)';
$string['settings:rag_min_similarity_desc'] = 'Descarta os trechos recuperados cuja similaridade de cosseno com a pergunta esteja abaixo deste valor, de modo que uma pergunta fora do tema ou pobre em conteúdo injete menos (ou nenhuma) passagem, em vez de sempre completar até o Top-K com correspondências fracas. Intervalo de 0 a 1; 0 desativa o filtro. O valor ideal depende do modelo de embedding: 0.25 é adequado para text-embedding-3-small. Aumente-o para ser mais rigoroso (menos contexto, mais focado no tema), reduza-o para ser mais permissivo.';
$string['settings:rag_currentpage_boost'] = 'Bônus da página atual';
$string['settings:rag_currentpage_boost_desc'] = 'Um pequeno bônus adicionado à pontuação de relevância dos trechos da página que o estudante está visualizando no momento, para que perguntas como "explique isto" prefiram a página visível quando as pontuações forem próximas. Apenas ordenação: não força um trecho irrelevante da página a passar pelo filtro de relevância mínima. Defina 0 para desativar.';
$string['settings:history_mode'] = 'Modo de seleção do histórico';
$string['settings:history_mode_desc'] = 'Como os turnos anteriores da conversa são escolhidos antes de serem enviados ao modelo. <strong>Semântico</strong> mantém apenas os turnos recentes relevantes para a pergunta atual (e sempre a troca mais recente), de modo que um turno anterior desatualizado e fora do tema não infle o custo nem desvie a resposta do rumo; faz uma chamada extra de embedding por mensagem. <strong>Recência</strong> mantém os últimos pares de "Max Conversation History" independentemente da relevância (o comportamento tradicional, sem chamada extra). Se o embedding não estiver disponível, o modo semântico recorre automaticamente à recência.';
$string['settings:history_mode_semantic'] = 'Semântico (turnos recentes relevantes)';
$string['settings:history_mode_recency'] = 'Recência (últimos N pares)';
$string['settings:history_semantic_minscore'] = 'Piso de relevância do histórico (cosseno)';
$string['settings:history_semantic_minscore_desc'] = 'No modo de histórico semântico, um turno anterior só é mantido se sua similaridade com a pergunta atual for pelo menos este valor (a troca mais recente é sempre mantida). Intervalo de 0 a 1; depende do modelo. Aumente para ser mais rigoroso (menos histórico), reduza para manter mais.';
$string['settings:history_candidates'] = 'Janela de candidatos do histórico';
$string['settings:history_candidates_desc'] = 'No modo de histórico semântico, apenas a quantidade indicada de pares mais recentes é avaliada quanto à relevância (um limite de custo). Pares mais antigos que esta janela não são enviados. Mantenha este valor igual ou superior a "Max Conversation History".';

// v5.11.0 - v6.2.0 strings (added 2026-06-10).
$string['settings:embed_provider_voyage'] = 'Voyage AI (voyage-3.5 — recomendado; +4 MTEB vs OpenAI 3-small, 4x contexto, multilíngue)';
$string['settings:rerank_heading'] = 'RAG: Recuperação em dois estágios (re-ranking)';
$string['settings:rerank_heading_desc'] = 'Segundo estágio de recuperação opcional: a similaridade cosseno seleciona os top-N fragmentos candidatos (padrão 50), depois um cross-encoder re-ranker pontua cada par (consulta, fragmento) e os melhores top-K vão para o prompt. Desativado por padrão; recorre à recuperação cosseno de estágio único se o re-ranker não estiver configurado ou falhar.';
$string['settings:rerank_enabled'] = 'Recuperação em dois estágios (Voyage rerank-2.5)';
$string['settings:rerank_enabled_desc'] = 'Quando ativado, a recuperação RAG torna-se de dois estágios: a similaridade cosseno retorna os top-N candidatos (padrão 50), depois o cross-encoder Voyage rerank-2.5 pontua cada um e os top-K vão para o prompt. Melhorias publicadas: +15 Recall@10 enterprise, +39% NDCG BEIR. Cobrança de ~$0,05/MTok. Requer <code>rerank_apikey</code> abaixo; recorre graciosamente à recuperação cosseno de estágio único se o rerank falhar ou não estiver configurado.';
$string['settings:rerank_apikey'] = 'Chave de API do re-ranker';
$string['settings:rerank_apikey_desc'] = 'Chave de API Voyage AI para rerank-2.5. Deixe em branco para reutilizar a Chave de API de Incorporação acima (implantações Voyage típicas compartilham uma chave entre embed + rerank).';
$string['settings:rerank_model'] = 'Modelo de re-ranking';
$string['settings:rerank_model_desc'] = 'Padrão <code>rerank-2.5</code>. Modelos Voyage rerank mais novos podem ser especificados aqui.';
...
$string['settings:stt_selfhosted_url_desc'] = 'URL base do servidor de transcrição compatível com OpenAI, por exemplo <code>http://10.0.0.5:8000</code>. O [[tutorshort]] acrescenta <code>/v1/audio/transcriptions</code> automaticamente; um caminho de endpoint completo também é aceito. Deixe vazio para desativar o STT auto-hospedado.';
$string['settings:stt_selfhosted_model'] = 'Modelo STT auto-hospedado';
$string['settings:stt_selfhosted_model_desc'] = 'Nome do modelo passado ao servidor, correspondendo ao modelo Whisper carregado — por exemplo <code>Systran/faster-whisper-small</code> para speaches ou <code>large-v3</code>. Deixe vazio para enviar <code>whisper-1</code>, que a maioria dos servidores auto-hospedados aceita ou ignora.';
$string['settings:stt_selfhosted_apikey'] = 'Chave de API do STT auto-hospedado';
$string['settings:stt_selfhosted_apikey_desc'] = 'Opcional. A maioria dos servidores auto-hospedados não requer chave em rede confiável; defina isso apenas se o servidor exigir um token bearer.';
$string['emergency:title'] = 'Controles de emergência do [[tutorshort]]';
$string['emergency:page_warning'] = 'Esses switches têm efeito imediato para todos os alunos do site. Cada ação grava uma linha de auditoria. Switches granulares deixam o restante do [[tutorshort]] funcionando; o kill master remove o widget completamente.';
$string['emergency:back_to_settings'] = 'Configurações do [[tutorshort]]';
$string['emergency:state_disabled'] = 'DESATIVADO';
$string['emergency:state_active'] = 'Ativo';
$string['emergency:confirm_label'] = 'Entendo que isso afeta todos os alunos imediatamente';
$string['emergency:confirm_required'] = 'Marque a caixa de confirmação antes de desativar um subsistema.';
$string['emergency:reason_placeholder'] = 'Motivo (registrado no log de auditoria)';
$string['emergency:disable_button'] = 'Desativar';
$string['emergency:restore_button'] = 'Restaurar';
$string['emergency:disabled_notice'] = 'Subsistema "{$a->flag}" desativado. Configuração tocada: {$a->touched}';
...
$string['emergency:flag_rag_desc'] = 'Desativa a recuperação e indexação. O chat continua sem ancoragem no conteúdo do curso.';
$string['emergency:flag_outreach'] = 'Comunicações';
$string['emergency:flag_outreach_desc'] = 'Para e-mails de resumo, marcos e lembretes. O chat não é afetado.';
$string['emergency:flag_all'] = 'KILL MASTER';
$string['emergency:flag_all_desc'] = 'Desativa o plugin inteiro: widget removido de todas as páginas, tarefas agendadas param, voz limpa, RAG desativado, comunicações desativadas. O switch mais forte — use para incidente de segurança ou quando o [[tutorshort]] precisar ser retirado do ar imediatamente.';
$string['emergency:settings_link'] = 'Controles de emergência';
$string['emergency:settings_link_desc'] = 'Switches de kill por subsistema (chat / voz / RAG / comunicações / master) com registro de auditoria — o equivalente web de <code>admin/cli/emergency_disable.php</code>. Abra <a href="{$a}">Controles de emergência do [[tutorshort]]</a>.';
$string['email_unsubscribe:done_title'] = 'Descadastrado';
$string['email_unsubscribe:done_body'] = 'Pronto — {$a->email} não receberá mais este tipo de e-mail de {$a->product}. Se mudar de ideia, peça a um administrador do {$a->product} para reativar a assinatura, ou envie um novo opt-in pela página [[tutorshort]] Recipients no painel de administração.';
$string['email_unsubscribe:invalid_title'] = 'Link de descadastramento não é mais válido';
$string['email_unsubscribe:invalid_body'] = 'Este link de descadastramento expirou ou está malformado. Procure um e-mail mais recente nosso, ou entre em contato com um administrador do site para ser removido manualmente.';
$string['settings:prompt_proportions_heading'] = 'Proporções das seções do prompt (v5.6.0)';
$string['settings:prompt_proportions_heading_desc'] = 'Aloque o orçamento do prompt do sistema em quatro segmentos: segurança + identidade, estrutura do curso, conteúdo do curso e página atual. Os pesos são percentuais que somam 100. Os padrões ajustados empiricamente (10 / 10 / 40 / 40) vêm do benchmark de ajuste de pesos v5.6.0; deixar a área de texto em branco usa esses padrões. O boost automático ajusta a alocação por turno dependendo de se uma página específica está em escopo.';
$string['settings:prompt_section_weights'] = 'Pesos de seção base (JSON)';
$string['settings:prompt_section_weights_desc'] = 'Objeto JSON opcional mapeando cada segmento a uma porcentagem. Deixe em branco para usar os padrões do benchmark (10 / 10 / 40 / 40). Exemplo: <code>{"safety_identity": 10, "course_structure": 10, "course_content": 40, "current_page": 40}</code>. Os pesos devem somar 100 (±5%). <code>safety_identity</code> tem um piso de 10% para que a resistência a jailbreak e os marcadores de formato de saída sempre apareçam completos. <code>current_page + course_content</code> deve ser pelo menos 40% para que o modelo tenha material substantivo no qual se ancorar. Valores fora do intervalo recorrem silenciosamente aos padrões do benchmark; os administradores devem validar verificando o log de depuração do prompt após salvar.';
$string['settings:prompt_context_boost_mode'] = 'Modo de boost de contexto';
$string['settings:prompt_context_boost_mode_desc'] = 'Ajuste automático que desloca o peso em direção à seção da página atual quando uma página específica está em escopo, e em direção ao conteúdo do curso quando nenhuma página está selecionada. <strong>page_focus</strong> (padrão) desloca cerca de 15 pontos de peso. <strong>aggressive</strong> desloca 25 pontos e é melhor quando os alunos consistentemente fazem perguntas específicas sobre páginas. <strong>off</strong> desativa o boost; os pesos base definidos pelo administrador se aplicam a cada turno independentemente do contexto da página.';
$string['settings:prompt_context_boost_off'] = 'Desativado (usar pesos base em cada turno)';
$string['settings:prompt_context_boost_page_focus'] = 'Foco na página (padrão, ~15 pontos de deslocamento)';
$string['settings:prompt_context_boost_aggressive'] = 'Agressivo (~25 pontos de deslocamento)';
$string['settings:prompt_section_weights_coach'] = 'Substituição no modo coach (JSON, opcional)';
$string['settings:prompt_section_weights_coach_desc'] = 'Objeto JSON opcional substituindo os pesos de seção base especificamente durante o modo coach de quiz avaliado (quando <code>quizmode=coach</code>). Útil para forçar uma alocação mais pesada de <code>current_page</code> durante quizzes sem afetar o chat normal. Deixe em branco para herdar os pesos base. Mesmas regras de validação que a configuração base.';
$string['prompt_debug_view:title'] = 'Visualizador de log de depuração do prompt';
$string['prompt_debug_view:subtitle'] = 'Prompt do sistema montado por turno + detalhamento por seção + histórico de conversa + mensagem atual do usuário + metadados de anexo, exatamente como o modelo os recebeu. Use isso para verificar se uma seção como Conteúdo da Página Atual realmente chegou ao prompt e para depurar problemas de qualidade de resposta sem SSH no servidor.';
$string['prompt_debug_view:disabled'] = 'O registro de depuração do prompt está atualmente DESATIVADO. Nenhuma nova entrada será gravada até que seja ativado.';
$string['prompt_debug_view:enable_link'] = 'Abra as configurações do plugin para ativar "Registrar prompt do sistema montado em arquivo".';
$string['prompt_debug_view:no_log_yet'] = 'Nenhum arquivo de log ainda. Envie pelo menos um turno de chat após ativar o log de depuração; o arquivo é criado na primeira gravação.';
$string['prompt_debug_view:empty'] = 'O arquivo de log existe, mas está vazio. Envie um turno de chat e atualize.';
$string['prompt_debug_view:file_status'] = 'Tamanho do arquivo de log';
$string['prompt_debug_view:showing'] = 'Exibindo entradas mais recentes (mais novas primeiro), limite';
$string['prompt_debug_view:total'] = 'Prompt total';
$string['prompt_debug_view:budget'] = 'Orçamento na captura';
$string['prompt_debug_view:sections'] = 'Seções (por categoria)';
$string['prompt_debug_view:assembled_prompt'] = 'Prompt do sistema montado';
$string['prompt_debug_view:history'] = 'Histórico de conversa enviado ao modelo';
$string['prompt_debug_view:current_message'] = 'Mensagem atual do usuário';
$string['prompt_debug_view:attachment'] = 'Metadados do anexo';
$string['prompt_debug_view:show_more'] = 'Mostrar mais entradas';
$string['settings:mastery_classifier_provider'] = 'Provedor do classificador';
$string['settings:mastery_classifier_provider_desc'] = 'ID do provedor usado para o classificador de domínio por turno. Deixe vazio para herdar o provedor de AI padrão. O padrão <code>openai</code> emparelhado com o modelo de classificador <code>gpt-4o-mini</code> abaixo — a opção TIER 1 mais barata para classificação com saída estruturada (~$220/mês de economia a 100k MAU vs o nível de chat). Quando definido, a linha em Provedores de comparação com esse ID de provedor fornece a chave de API, URL base e temperatura.';
$string['settings:premium_escalation_heading'] = 'Nível de escalação premium (A.10)';
$string['settings:premium_escalation_heading_desc'] = 'Roteamento opcional por turno para um modelo premium (Claude Opus 4.8 por padrão) para prompts onde o nível de chat de trabalho visivelmente luta — tipicamente matemática multietapas, CS e raciocínio científico. Resolvido pelo bake-off A.10 de 2026-06-09: Opus 4.8 venceu com 14,97/15 vs 12,68/15 do gpt-4o em prompts difíceis. Dois caminhos de acionamento: correspondências regex na mensagem do usuário, OU uma lista de permissões de curso que escalona cada turno. Desativado por padrão. Com ~5% de escalação, espere ~$700/mês a 100k [[unishort]] MAU além dos gastos base com chat.';
$string['settings:premium_escalation_enabled'] = 'Ativar roteamento de escalação premium';
$string['settings:premium_escalation_enabled_desc'] = 'Quando ativado, o roteador por turno verifica a lista de regex de acionadores e a lista de permissões de curso para cada chamada de chat; turnos correspondentes são roteados para o provedor premium. Recorre ao provedor de trabalho se a linha premium estiver ausente ou falhar ao instanciar. Substituições do seletor de LLM do administrador sempre vencem independentemente.';
$string['settings:premium_escalation_provider'] = 'Provedor premium';
$string['settings:premium_escalation_provider_desc'] = 'ID do provedor para rotear chamadas premium. Deve corresponder a uma linha em Provedores de comparação (para que a chave de API, URL base e temperatura venham do mesmo lugar que os administradores já gerenciam). Padrão <code>claude</code>.';
$string['settings:premium_escalation_model'] = 'Modelo premium';
$string['settings:premium_escalation_model_desc'] = 'Nome do modelo passado ao provedor premium. Padrão <code>claude-opus-4-8</code> conforme o veredito do bake-off A.10.';
$string['settings:premium_escalation_triggers'] = 'Regexes de acionadores premium';
$string['settings:premium_escalation_triggers_desc'] = 'Um regex PCRE por linha (sem delimitadores; correspondência sem distinção entre maiúsculas e minúsculas é aplicada automaticamente). Linhas começando com # são comentários. Deixe em branco para usar o conjunto padrão do bake-off A.10 (marcadores STEM multietapas: "derive", "prove that", "step by step", matemática LaTeX, blocos de código delimitados, big-O, integrais, otimização, etc.).';
$string['settings:premium_escalation_course_tags'] = 'Lista de permissões de cursos premium';
$string['settings:premium_escalation_course_tags_desc'] = 'Um prefixo de nome curto ou idnumber de curso por linha. Cada turno em um curso correspondente é escalado automaticamente independentemente do regex da mensagem (use para cursos com muita STEM onde a escalação deve ser o padrão). A correspondência é um prefixo sem distinção entre maiúsculas e minúsculas — "MATH" corresponde a MATH121, MATH205, etc.';
$string['settings:spend_cap_per_course_default'] = 'Limite de gastos padrão por curso (USD)';
$string['settings:spend_cap_per_course_default_desc'] = 'Limite defensivo aplicado a todo curso que não tem seu próprio limite de gastos por curso configurado. Defina como <code>30</code>, por exemplo, para limitar os gastos mensais de qualquer curso em $30 sem precisar ajustar cursos individuais. <code>0</code> = sem padrão (apenas limites gerais do site e de substituição por curso se aplicam). Quando um curso ultrapassa 80% / 95% / 100% desse limite, o pipeline de alertas spend-guard existente envia a notificação de administrador (lista de destinatários: <code>spend_notify_emails</code>, com fallback para administradores do site). Um curso específico sempre pode elevar seu próprio teto definindo uma substituição por curso mais alta.';
$string['settings:cost_anomaly_heading'] = 'Detector de anomalias de custo (v6.0)';
$string['settings:cost_anomaly_heading_desc'] = 'Tarefa agendada diária (<code>cost_anomaly_check</code>) que compara os gastos [[tutorshort]] do site de hoje com a mediana dos 7 dias anteriores. Envia e-mail para a lista de destinatários <code>spend_notify_emails</code> (com fallback para administradores do site) quando hoje supera o multiplicador configurado × mediana. Detecta três modos de falha que os limiares 80% / 95% / 100% de limite de gastos existentes não capturam: (1) curso descontrolado onde o teto absoluto não é cruzado mas um único curso de repente gera 10x seu volume habitual, (2) ativação acidental do nível premium, (3) roteamento incorreto de provedor. Desativado por padrão; o equivalente interno do [[tutorshort]] da consulta Redash em <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
$string['settings:cost_anomaly_enabled'] = 'Ativar detector de anomalias de custo';
$string['settings:cost_anomaly_enabled_desc'] = 'Quando ativado, a tarefa agendada diária avalia os gastos de hoje em relação à mediana dos 7 dias anteriores e envia e-mail para administradores em caso de anomalia. Os primeiros 7 dias após a ativação produzem um status <code>insufficient_history</code> (ainda sem histórico de base) e nunca emitem um alerta. Idempotente por dia: um sinalizador em <code>config_plugins</code> para e-mails repetidos se o cron executar várias vezes.';
$string['settings:cost_anomaly_multiplier'] = 'Multiplicador de anomalia';
$string['settings:cost_anomaly_multiplier_desc'] = 'Os gastos de hoje devem superar este multiplicador × a mediana de 7 dias para acionar um alerta. Padrão <code>2.0</code>. Reduza para <code>1.5</code> para avisos mais antecipados (mais falsos positivos durante picos de matrícula). Aumente para <code>3.0</code> se o uso do [[unishort]] for irregular o suficiente para que picos de 2x sejam rotineiros.';
$string['task:cost_anomaly_check'] = 'Verificação diária de anomalias de custo do [[tutorshort]]';

// v6.4.0 signed policy bundle strings (added 2026-06-11).
$string['settings:policy_bundle_heading'] = 'Pacote de políticas assinado (atualizações de comportamento remotas)';
$string['settings:policy_bundle_heading_desc'] = 'Aplique configurações de comportamento (prompts, roteamento, acionadores de escalonamento, ajuste de RAG, política de gastos) a partir de um arquivo JSON assinado criptograficamente sem implantação de código. Uma tarefa agendada diária obtém o URL do pacote, verifica sua assinatura Ed25519 com a chave pública abaixo e aplica as configurações somente se cada chave estiver na lista de permissões integrada e a versão do pacote for mais recente que a última aplicada. Chaves de API, URLs, webhooks e configurações de segurança nunca podem ser definidas por um pacote. Crie e assine pacotes com <code>admin/cli/policy_bundle_tool.php</code> (keygen, sign, verify, status, sync).';
$string['settings:policy_bundle_enabled'] = 'Habilitar sincronização do pacote de políticas';
$string['settings:policy_bundle_enabled_desc'] = 'Quando habilitada, a tarefa diária obtém e aplica pacotes assinados. Desabilitada por padrão. Desabilitar interrompe todas as sincronizações imediatamente; as configurações já aplicadas mantêm seus valores.';
$string['settings:policy_bundle_url'] = 'URL do pacote de políticas';
$string['settings:policy_bundle_url_desc'] = 'URL HTTPS do JSON do pacote assinado (por exemplo, um objeto S3 ou GitHub raw URL). O URL passa pela mesma validação SSRF que os endpoints do provedor de IA; hosts de rede privada ou plain-http precisam de uma entrada na lista de permissões de endpoints confiáveis do SSRF.';
$string['settings:policy_bundle_pubkey'] = 'Chave pública do pacote de políticas';
$string['settings:policy_bundle_pubkey_desc'] = 'Chave pública Base64 Ed25519 usada para verificar assinaturas do pacote. Gere o par de chaves com <code>policy_bundle_tool.php --keygen</code>; a chave privada permanece com o autor do pacote e nunca deve ser enviada para nenhum lugar.';
$string['settings:policy_bundle_status'] = 'Última sincronização';
$string['settings:policy_bundle_applied_version'] = 'versão aplicada';
$string['task:policy_bundle_sync'] = 'Sincronização do pacote de políticas assinado do [[tutorshort]]';
$string['policy_bundle:invalid'] = 'Pacote de políticas rejeitado: {$a}';
$string['prompt_debug_view:retrieved_chunks'] = 'Trechos recuperados (seleção do RAG)';
$string['prompt_debug_view:retrieved_chunks_hint'] = 'Os trechos que o recuperador selecionou para esta pergunta, em ordem de classificação, com sua pontuação de relevância e a fonte (cmid). Use isto para verificar se o modelo recebeu o conteúdo do curso mais correspondente.';
$string['settings:avatar_animation_enabled'] = 'Animação de avatar';
$string['settings:avatar_animation_enabled_desc'] = 'Anima o avatar SVG gerado: piscar em repouso, mais movimento de boca sincronizado com o áudio de texto para fala enquanto o assistente fala. Respeita a preferência de movimento reduzido do dispositivo do aluno. Substituição por curso para medição A/B: defina o valor de configuração avatar_animation_course_COURSEID como 0 ou 1.';
$string['analytics:exp_heading'] = 'Comparação de experimento A/B';
$string['analytics:exp_desc'] = 'Compare o engajamento entre dois cursos no intervalo de tempo selecionado. Construído para experimentos por curso (por exemplo, a sonda de animação de avatar): coloque a substituição em um curso, deixe o outro como controle e leia a diferença aqui.';
$string['analytics:exp_course_a'] = 'Curso A';
$string['analytics:exp_course_b'] = 'Curso B';
$string['analytics:exp_compare'] = 'Comparar';
$string['analytics:exp_metric'] = 'Métrica';
$string['analytics:exp_delta'] = 'B vs A';
$string['analytics:exp_enrolled'] = 'Alunos matriculados';
$string['analytics:exp_active_users'] = 'Usuários ativos do [[tutorshort]]';
$string['analytics:exp_usage_rate'] = 'Taxa de uso (%)';
$string['analytics:exp_sessions'] = 'Sessões';
$string['analytics:exp_messages'] = 'Mensagens';
$string['analytics:exp_avg_msgs_session'] = 'Média de mensagens por sessão';
$string['analytics:exp_avg_session_minutes'] = 'Duração média da sessão (minutos)';
$string['analytics:exp_return_rate'] = 'Usuários recorrentes (%)';
$string['analytics:exp_tts_plays'] = 'Reproduções de TTS';
$string['analytics:exp_tts_per_active'] = 'Reproduções de TTS por usuário ativo';

$string['settings:redash_allowed_origin'] = 'Origem permitida para o Redash (CORS)';
$string['settings:redash_allowed_origin_desc'] = 'Deixe vazio (recomendado): a exportação é obtida de servidor para servidor pelo Redash e não precisa de nenhum cabeçalho CORS do navegador. Defina uma única origem exata (por exemplo https://redash.example.org) somente se um painel baseado em navegador precisar ler a exportação diretamente. Nunca use um curinga.';

// Soapbox speech practice (v6.7.0).
$string['privacy:metadata:local_ai_course_assistant_practice_scores:session_meta'] = 'Metadados opcionais que você forneceu para a sessão, como o nome, o tema e a duração desejada de um discurso do Soapbox. Nunca inclui áudio nem transcrição.';
$string['pedagogy:soapbox'] = 'Feedback de discurso do Soapbox ativado por padrão';
$string['pedagogy:soapbox_desc'] = 'Quando ativado, a ferramenta de prática de discurso Soapbox fica disponível em todos os cursos, a menos que o curso tenha sua própria substituição. Deixe desativado e ative-o apenas nos cursos que precisam dele (normalmente cursos de oratória e comunicação).';
$string['settings:soapbox_stt_mode'] = 'Modo de transcrição do Soapbox';
$string['settings:soapbox_stt_mode_desc'] = 'Como o Soapbox transforma um discurso gravado em texto. O servidor usa o provedor Whisper configurado (a versão auto-hospedada é gratuita; o OpenAI hospedado custa cerca de USD 0,006 por minuto). O navegador usa o reconhecimento de fala integrado do estudante (gratuito, sem servidor, funciona apenas no Chrome e no Safari). O servidor é recomendado para que a qualidade da transcrição não dependa do navegador do estudante.';
$string['settings:soapbox_stt_mode_server'] = 'Servidor (provedor Whisper)';
$string['settings:soapbox_stt_mode_browser'] = 'Navegador (gratuito, sem servidor)';
$string['soapbox:title'] = 'Soapbox';
$string['soapbox:link'] = 'Prática de discurso Soapbox';
$string['soapbox:disabled'] = 'O Soapbox não está habilitado para este curso.';
$string['soapbox:intro'] = 'Faça um discurso e receba orientação. Opcionalmente, defina um nome, um tema e uma duração desejada e, em seguida, grave-se falando. O Soapbox transcreve seu discurso, atribui notas com base em uma rubrica de oratória e fornece dicas concretas. Seu áudio e a transcrição nunca são armazenados, apenas suas notas e feedback.';
$string['soapbox:optional'] = 'opcional';
$string['soapbox:name_label'] = 'Dê um nome a este discurso';
$string['soapbox:topic_label'] = 'Tema';
$string['soapbox:time_label'] = 'Duração desejada';
$string['soapbox:no_target'] = 'Sem meta';
$string['soapbox:record'] = 'Gravar discurso';
$string['soapbox:stop'] = 'Parar';
$string['soapbox:recording'] = 'Gravando. Fale naturalmente; clique em parar quando terminar.';
$string['soapbox:transcribing'] = 'Transcrevendo seu discurso…';
$string['soapbox:scoring'] = 'Avaliando seu discurso…';
$string['soapbox:too_short'] = 'Essa gravação foi curta demais para ser avaliada. Tente pelo menos uma ou duas frases e tente novamente.';
$string['soapbox:mic_denied'] = 'É necessário acesso ao microfone para gravar. Permita o acesso ao microfone e tente novamente.';
$string['soapbox:no_browser_stt'] = 'Este navegador não oferece suporte ao reconhecimento de fala no navegador. Experimente o Chrome ou o Safari, ou peça ao seu administrador para mudar o Soapbox para a transcrição no servidor.';
...
$string['soapbox:tips_heading'] = 'Dicas para a próxima vez';
$string['soapbox:col_criterion'] = 'Critério';
$string['soapbox:col_score'] = 'Nota';
$string['soapbox:col_feedback'] = 'Feedback';
$string['soapbox:history_heading'] = 'Meus discursos';
$string['soapbox:history_empty'] = 'Você ainda não gravou nenhum discurso. Grave um acima para começar a montar seu histórico.';
$string['soapbox:untitled'] = 'Discurso sem título';
$string['soapbox:overall_badge'] = 'Geral {$a}';
$string['soapbox:toggle'] = 'Habilitar o Soapbox para este curso';
$string['soapbox:toggle_help'] = 'Os estudantes recebem uma página dedicada para gravar um discurso e receber feedback de oratória avaliado por rubrica, com dicas. Áudio e transcrições nunca são armazenados. Desativado por padrão.';
// Soapbox course-type/level + sample loader (v6.7.0).
$string['soapbox:level_label'] = 'Tipo de curso / nível de fala';
$string['soapbox:level_help'] = 'Adapta o coaching da IA e a rubrica de exemplo padrão ao tipo de curso. Os níveis de ESL recebem feedback de aprendizado de idioma; a fala geral foca nas habilidades de apresentação. Você ainda pode editar a rubrica abaixo.';
$string['soapbox:level_general'] = 'Fala geral / apresentação';
$string['soapbox:level_esl_beginner'] = 'ESL (iniciante)';
$string['soapbox:level_esl_advanced'] = 'ESL (avançado)';
$string['soapbox:edit_rubric'] = 'Editar rubrica de fala';
...
$string['cachedef_ratelimit'] = 'Limitação de taxa de requisições por usuário';
$string['cachedef_uistate'] = 'Alternâncias de interface por sessão (visualizar como estudante, revelar nomes reais)';
$string['benchmark:pagetitle'] = 'Benchmark de provedores';
$string['benchmark:intro'] = 'Envia um conjunto fixo de prompts típicos para cada provedor de AI configurado, registra o uso de tokens, o custo e a latência, e recomenda um provedor por capacidade. Cada execução faz chamadas reais de API, então uma execução custa aproximadamente de 5 a 20 centavos, dependendo de quantos provedores estão configurados.';
$string['cachedef_systemprompt'] = 'Prompt de sistema de AI montado (por curso)';
$string['cachedef_remoteconfig'] = 'Configuração remota obtida do canal de atualização';
$string['cachedef_spend'] = 'Totais de gasto de AI por período para o controle de gastos';
$string['cachedef_failover_circuit'] = 'Estado do disjuntor de failover de provedor';
$string['settings:rag_scope'] = 'Escopo de recuperação';
$string['settings:rag_scope_desc'] = 'Quando um aluno está visualizando um documento específico (uma página, livro ou PDF), se a recuperação deve ser restrita a esse documento. <b>Documento primeiro</b> fundamenta a resposta no documento atual quando ele tem trechos relevantes e recorre ao curso inteiro caso contrário. <b>Somente documento</b> nunca recorre a outra fonte: se o documento atual não tem nenhum trecho relevante, não recupera nada, então o tutor responde a partir do conhecimento geral em vez de citar páginas não relacionadas. <b>Todo o curso</b> pesquisa todo o conteúdo do curso (a página atual ainda recebe o realce de ordenação acima). Documento primeiro é recomendado, para que uma resposta sobre a página que o aluno está lendo seja fundamentada nessa página.';
$string['settings:rag_scope_document_first'] = 'Documento primeiro (preferir o documento atual, recorrer ao curso)';
$string['settings:rag_scope_document_only'] = 'Somente documento (restringir ao documento atual)';
$string['settings:rag_scope_course'] = 'Todo o curso (pesquisar todo o conteúdo do curso)';
$string['ragadmin:no_content_documents'] = '{$a->count} documento(s) não produziram texto indexável e não foram divididos em trechos (geralmente páginas majoritariamente incorporadas ou muito curtas): {$a->titles}. Se algum destes precisar ser pesquisável, adicione texto na página ou uma transcrição e depois reindexe.';
$string['privacy:metadata:sbx_rec'] = 'Gravações de apresentações do Soapbox. O objeto de mídia é excluído após o período de retenção; a transcrição é mantida para feedback e solicitações de acesso.';
$string['privacy:metadata:sbx_rec:userid'] = 'O aluno que fez a gravação.';
$string['privacy:metadata:sbx_rec:transcript'] = 'A transcrição de fala em texto da gravação.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'A duração da gravação em segundos.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'Quando a gravação foi feita.';
$string['privacy:metadata:ai_provider'] = 'Para gerar respostas de tutoria, o conteúdo criado pelo aluno é enviado ao provedor de AI configurado pelo administrador do site ou do curso.';
$string['privacy:metadata:ai_provider:message'] = 'O texto da mensagem e os anexos que o aluno envia ao tutor de AI.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'Contexto do curso e da atividade (como o nome do curso e a página atual) incluído para fundamentar a resposta.';
$string['privacy:metadata:voice_provider'] = 'Quando a entrada ou saída de voz é usada, o áudio e o texto são enviados ao provedor de fala em texto / texto em fala configurado.';
$string['privacy:metadata:voice_provider:audio'] = 'Áudio gravado do aluno falando, enviado para transcrição.';
$string['privacy:metadata:voice_provider:text'] = 'Texto enviado ao provedor para ser sintetizado em fala.';
$string['privacy:metadata:zendesk'] = 'Quando o encaminhamento para o suporte humano está habilitado e o aluno consente, os dados de contato e a mensagem dele são enviados ao Zendesk para abrir um chamado de suporte.';
$string['privacy:metadata:zendesk:name'] = 'O nome completo do aluno, usado para identificar quem solicita o suporte.';
$string['privacy:metadata:zendesk:email'] = 'O endereço de e-mail do aluno, usado para responder à solicitação de suporte.';
$string['privacy:metadata:zendesk:message'] = 'A mensagem ou o conteúdo da conversa que o aluno escolheu encaminhar.';
...
$string['analytics_js:ai_users'] = 'Usuários de AI';
$string['analytics_js:non_users'] = 'Não usuários';
$string['analytics_js:thumbs_up'] = 'Curtidas';
$string['analytics_js:thumbs_down'] = 'Descurtidas';
$string['analytics_js:hallucination_flags'] = 'Sinalizações de alucinação';
$string['analytics_js:avg_star_rating'] = 'Avaliação média em estrelas';
$string['analytics_js:avg_msgs_resolution'] = 'Média de msgs até a resolução';
$string['analytics_js:survey_respondents'] = 'Respondentes da pesquisa';
$string['analytics_js:messages'] = 'Mensagens';
$string['analytics_js:students'] = 'Estudantes';
$string['analytics_js:frequency'] = 'Frequência';
$string['analytics_js:responses'] = 'Respostas';
$string['analytics_js:error_loading'] = 'Erro ao carregar os dados';
$string['analytics_js:loading'] = 'Carregando análises...';
$string['analytics_js:no_course_data'] = 'Nenhum dado de curso disponível.';
$string['analytics_js:no_unit_data'] = 'Ainda não há dados de unidades. O acompanhamento por unidade se acumula conforme os estudantes usam o assistente.';
$string['analytics_js:no_keyword_data'] = 'Nenhum dado de palavra-chave disponível para este período.';
$string['task:soapbox_cleanup'] = 'Retenção e limpeza das gravações do Soapbox';
$string['admin:vendor_dpa:col_provider'] = 'Provedor';
$string['admin:vendor_dpa:col_optout'] = 'Recusa de treinamento';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Retenção';
$string['admin:vendor_dpa:col_tier'] = 'Limite de nível';
$string['admin:vendor_dpa:col_link'] = 'Link';
$string['admin:vendor_dpa:vendor_terms'] = 'Termos do fornecedor';
$string['admin:vendor_dpa:tier'] = 'Nível {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'Contratual (recusado)';
$string['admin:vendor_dpa:too_default_on'] = 'Ativado por padrão';
$string['admin:vendor_dpa:too_none'] = 'Sem recusa';
$string['admin:vendor_dpa:too_local'] = 'Local (sem fornecedor)';
$string['admin:vendor_dpa:too_unknown'] = 'Ainda não revisado';
$string['admin:vendor_dpa:dpa_signed'] = 'Assinado';
$string['admin:vendor_dpa:dpa_available'] = 'Disponível';
$string['admin:vendor_dpa:dpa_negotiating'] = 'Em negociação';
$string['admin:vendor_dpa:dpa_not_offered'] = 'Não oferecido';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'N/D';
$string['admin:vendor_dpa:dpa_unknown'] = 'Desconhecido';
$string['settings:soapbox_slide_vision'] = 'Feedback de design visual dos slides do Soapbox';
$string['settings:soapbox_slide_vision_desc'] = 'Permite uma única passagem de visão sobre as imagens dos slides renderizados para adicionar uma breve nota de design visual a uma apresentação avaliada. Desativado por padrão e atento à privacidade: nenhuma imagem é armazenada, e cada tarefa também precisa optar por participar com sua própria caixa de seleção Feedback de design visual dos slides. Apenas apresentações com slides que tenham um deck enviado são afetadas.';
$string['settings:soapbox_vision_provider'] = 'Provedor de visão dos slides do Soapbox';
$string['settings:soapbox_vision_provider_desc'] = 'Provedor usado para a passagem de visão dos slides. O padrão é openai. Deve ser um provedor com capacidade de visão configurado com uma chave de API (via o provedor do curso ou a lista de provedores de comparação).';
$string['settings:soapbox_vision_model'] = 'Modelo de visão dos slides do Soapbox';
$string['settings:soapbox_vision_model_desc'] = 'Modelo com capacidade de visão para a passagem de visão dos slides. O padrão é gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'Design dos slides:';
$string['soapbox:assign_manage'] = 'Tarefas de apresentação do Soapbox';
$string['soapbox:copy_link'] = 'Link do estudante';
$string['soapbox:deck_label'] = 'Slides (PDF). Envie seu deck e depois avance os slides enquanto grava.';
$string['soapbox:slide_prev'] = 'Slide anterior';
$string['soapbox:slide_next'] = 'Próximo slide';
$string['soapbox:play_slides'] = 'Reproduzir com slides';
$string['soapbox:audio_ready'] = 'Somente áudio. Seu microfone será gravado; sua câmera não é usada.';
$string['soapbox:audio_recording'] = 'Gravando áudio...';
$string['soapbox:cap_reached'] = 'Você atingiu o número máximo de gravações para esta tarefa.';
$string['soapbox:storage_unconfigured'] = 'O armazenamento de gravações ainda não foi configurado. Entre em contato com o administrador.';
$string['soapbox:bad_key'] = 'Esse envio não pertence a você.';
$string['soapbox:slides_disabled'] = 'Os slides não estão habilitados para esta tarefa.';
$string['soapbox:upload_missing'] = 'Não foi possível encontrar o envio. Tente gravar novamente.';
$string['soapbox:mode_label'] = 'Tipo de apresentação';
$string['soapbox:mode_informative'] = 'Informativa (explicar ou ensinar)';
$string['soapbox:mode_persuasive'] = 'Persuasiva (convencer)';
$string['soapbox:err_provider'] = 'Não foi possível acessar o serviço de pontuação de AI. Tente novamente em instantes.';
$string['soapbox:err_parse'] = 'A AI retornou uma resposta inesperada. Tente novamente.';
$string['soapbox:err_disabled'] = 'A prática de fala não está habilitada para este curso.';
$string['soapbox:err_transcribe'] = 'Não foi possível transcrever sua gravação. Tente novamente e verifique se o seu microfone está funcionando.';
$string['settings:outcomes_benchmark_default'] = 'Benchmark de resultado (porcentagem)';
$string['settings:outcomes_benchmark_default_desc'] = 'O benchmark definido pela instituição para o relatório de resultados: um estudante atinge um resultado quando seu domínio está igual ou acima desta porcentagem. Este é o padrão de relatório (distinto do limite de domínio do coaching). Padrão 70.';
$string['outcomes:title'] = 'Relatório de resultados';
$string['outcomes:intro'] = 'Para cada resultado do curso, o benchmark e a porcentagem de estudantes avaliados que o atingiram ou superaram. O benchmark do site é de {$a}%.';
$string['outcomes:none'] = 'Ainda não há resultados definidos para este curso.';
$string['outcomes:export'] = 'Exportar CSV';
$string['outcomes:col_outcome'] = 'Resultado';
$string['outcomes:col_benchmark'] = 'Benchmark';
$string['outcomes:col_assessed'] = 'Estudantes avaliados';
$string['outcomes:col_met'] = 'Atingiram o benchmark';
...
$string['soapbox:present_audio'] = 'Apresentação em áudio';
$string['soapbox:present_video'] = 'Apresentação em vídeo';
$string['soapbox:present_target'] = 'meta {$a->min}-{$a->max} min';
$string['soapbox:choose_topic'] = 'Escolha um tema';
$string['soapbox:record_short'] = 'Gravar';
$string['soapbox:my_recordings'] = 'Minhas gravações';
$string['soapbox:no_recordings'] = 'Ainda não há gravações.';
$string['soapbox:col_recorded'] = 'Gravado';
$string['soapbox:col_length'] = 'Duração';
$string['soapbox:col_type'] = 'Tipo';
$string['soapbox:col_recording'] = 'Gravação';
$string['soapbox:col_kept'] = 'Mantido';
$string['soapbox:col_student_link'] = 'Link do aluno';
$string['soapbox:view_download'] = 'Ver / baixar';
$string['soapbox:expired'] = 'Expirado';
$string['soapbox:retention_note'] = 'As gravações ficam disponíveis para visualização e download por {$a} dias e depois são excluídas automaticamente.';
$string['soapbox:assign_title'] = 'Tarefas do Soapbox';
$string['soapbox:assign_single_title'] = 'Tarefa do Soapbox';
$string['soapbox:assign_add'] = 'Adicionar tarefa';
$string['soapbox:assign_none'] = 'Ainda não há tarefas do Soapbox.';
$string['soapbox:assign_deleted'] = 'Tarefa excluída.';
$string['soapbox:assign_updated'] = 'Tarefa atualizada.';
$string['soapbox:assign_created'] = 'Tarefa criada.';
