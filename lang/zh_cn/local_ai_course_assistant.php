...
$string['settings:embed_input_type_mode_desc'] = '仅适用于 Voyage 嵌入。“Shared space”以同样的方式嵌入查询和文档，因此二者在更换模型后仍然可比。“Asymmetric”使用 Voyage 独立的查询投影；这是厂商建议的优化，但在本语料上两次都没能复现出任何收益，因此默认为 shared。修改此项无需重建索引。';
$string['settings:embed_input_type_shared'] = 'Shared space（推荐）';
