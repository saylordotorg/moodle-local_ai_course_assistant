...
$string['chat:consent_body'] = '{$a->product} เป็นผู้ช่วยการเรียนรู้ที่ขับเคลื่อนด้วย AI ข้อความของคุณและคำตอบของ {$a->product} จะถูกจัดเก็บในฐานข้อมูล Moodle ของ {$a->institution} และสิบรอบล่าสุดจะถูกส่งไปยังผู้ให้บริการโมเดล AI ที่ได้รับการอนุมัติเพื่อตอบคำถามของคุณ ชื่อจริงของคุณจะถูกแบ่งปันเพื่อการปรับให้เป็นส่วนตัว ไม่มีข้อมูลระบุตัวตนอื่นใดที่ถูกส่งไปยังผู้ให้บริการ AI หากคุณขอความช่วยเหลือจากมนุษย์และคำถามของคุณถูกยกระดับ การสนทนานี้ (รวมถึงชื่อและอีเมลของคุณ) อาจถูกแบ่งปันกับทีมสนับสนุนของเรา คุณสามารถดาวน์โหลด ลบ หรือหยุดใช้ {$a->product} ได้ตลอดเวลา';
...
$string['settings:current_page_content_maxchars_desc'] = 'จำนวนอักขระสูงสุดของข้อความในหน้าปัจจุบันที่แทรกเข้าไปในระบบพรอมต์ในส่วน "Current Page Content" เมื่อปิด RAG ค่าเริ่มต้น 8,000 ช่วยตอบคำถามเฉพาะหน้าได้ดีพร้อมเหลือพื้นที่สำหรับโครงสร้างและคำสั่ง (เมื่อเปิด RAG หน้าจะถูกอ้างอิงด้วยส่วนข้อความที่เกี่ยวข้องที่สุดของตัวเองโดยเอนเอียงไปทางหน้าปัจจุบัน ดังนั้นขีดจำกัดนี้จะไม่มีผล) หน้าที่ยาวมากจะถูกตัดส่วนหัวให้เหลือจำนวนอักขระนี้ ดังนั้นส่วนท้ายของหน้าที่ยาวมากอาจไม่ถูกอ้างอิง การเปิด RAG ช่วยหลีกเลี่ยงปัญหานี้ เว็บไซต์ที่คำนึงถึงต้นทุนสามารถจำกัดให้ต่ำลงได้ (เช่น 3,000-4,000) จำกัดอยู่ในช่วง 500-8,000 เป็นอิสระจาก <code>prompt_budget_chars</code>: ค่านี้จำกัดเฉพาะส่วนของหน้าเท่านั้น ส่วนงบประมาณจะจำกัดทั้งพรอมต์';
...
$string['pedagogy:program_path'] = 'เปิดใช้การรับรู้เส้นทางการเรียนรู้ล่วงหน้าโดยค่าเริ่มต้น';
$string['pedagogy:program_path_desc'] = 'เมื่อเปิดใช้ SOLA จะสามารถบอกผู้เรียนได้ว่ารายวิชาปัจจุบันนำไปสู่สิ่งใดต่อไปในโปรแกรมการเรียน (ปริญญาหรือประกาศนียบัตร) และแนวคิดในวันนี้เชื่อมโยงไปยังรายวิชาในภายหลังอย่างไร โดยจะอ่านข้อมูลจากปลั๊กอิน Moodle Programs (Degrees และ Learn) และระบุชื่อรายวิชาถัดไปอย่างเฉพาะเจาะจงเฉพาะในกรณีที่โปรแกรมกำหนดวิชาบังคับก่อนหรือลำดับที่จำเป็นไว้เท่านั้น มิฉะนั้นจะระบุเพียงตำแหน่งของผู้เรียนในเส้นทางการเรียน เป็นเพียงคำแนะนำเท่านั้น — จะไม่เปลี่ยนแปลงการลงทะเบียนหรือระดับความเชี่ยวชาญ และจะใช้เฉพาะการจัดสรรโปรแกรมของผู้เรียนปัจจุบันเองเท่านั้น และจะไม่ดำเนินการใด ๆ โดยไม่แจ้งเตือนในกรณีที่ไม่มีโปรแกรมใดเกี่ยวข้อง';

// Learning path map + next-course nudge (v5.9.0).
$string['pedagogy:learning_path'] = 'เปิดใช้แผนที่เส้นทางการเรียนรู้และการแนะนำคอร์สถัดไปโดยค่าเริ่มต้น';
$string['pedagogy:learning_path_desc'] = 'เมื่อเปิดใช้งาน SOLA จะเพิ่มแผงเส้นทางการเรียนรู้แบบภาพ (ปุ่ม "เส้นทางของฉัน" ในส่วนหัวของวิดเจ็ต) ที่แสดงโปรแกรมของผู้เรียนเป็นลำดับของคอร์ส โดยแต่ละคอร์สสามารถขยายเพื่อดูวัตถุประสงค์และความเชี่ยวชาญของผู้เรียนได้ เมื่อผู้เรียนผ่านเกณฑ์ของคอร์สปัจจุบัน (เรียนจบหรือเชี่ยวชาญวัตถุประสงค์ในสัดส่วนที่สูง) SOLA จะแสดงแบนเนอร์ "พร้อมสำหรับคอร์สถัดไป" อย่างนุ่มนวลและกล่าวถึงในบทสนทนาด้วย เป็นเพียงคำแนะนำเท่านั้น ใช้การจัดสรรโปรแกรมของผู้เรียนเอง และจะไม่ทำงานอย่างเงียบ ๆ ในกรณีที่ไม่มีโปรแกรมที่เกี่ยวข้อง';
$string['settings:learning_path_mastery_threshold'] = 'เกณฑ์ความพร้อมของเส้นทางการเรียนรู้ (%)';
$string['settings:learning_path_mastery_threshold_desc'] = 'เปอร์เซ็นต์ของวัตถุประสงค์ที่ติดตามในคอร์สที่ผู้เรียนต้องเชี่ยวชาญก่อนที่การแนะนำเส้นทางการเรียนรู้จะถือว่าพร้อมสำหรับคอร์สถัดไป การเรียนจบคอร์สใน Moodle เป็นอีกตัวกระตุ้นหนึ่ง อย่างใดเกิดขึ้นก่อนจะกระตุ้นการแนะนำ ค่าเริ่มต้นคือ 80';
$string['pathpanel_title'] = 'เส้นทางการเรียนรู้ของฉัน';
$string['pathpanel_open'] = 'เส้นทางการเรียนรู้ของฉัน';
$string['pathpanel_empty'] = 'ยังไม่มีเส้นทางโปรแกรมสำหรับคอร์สนี้';
$string['path_position'] = 'คอร์สที่ {$a->index} จาก {$a->total}';
$string['path_status_done'] = 'เสร็จสิ้น';
$string['path_status_current'] = 'คุณอยู่ที่นี่';
$string['path_status_upcoming'] = 'กำลังจะมาถึง';
$string['path_mastery_mastered'] = 'เชี่ยวชาญแล้ว';
$string['path_mastery_in_progress'] = 'กำลังดำเนินการ';
$string['path_mastery_not_started'] = 'ยังไม่เริ่ม';
$string['path_mastery_demonstrated_elsewhere'] = 'แสดงในคอร์สอื่น';
$string['nudge_ready_title'] = 'พร้อมไปต่อ';
$string['nudge_ready_body'] = 'ทำได้ดีมาก คุณพร้อมสำหรับ {$a} แล้ว';
$string['nudge_view_path'] = 'ดูเส้นทางของฉัน';
$string['nudge_dismiss'] = 'ปิด';

// v5.10.x strings (token-aware budgeting, backend retry, self-test, deployment presets, escalation consent, privacy).
$string['settings:backend_context_tokens'] = 'หน้าต่างบริบทของแบ็กเอนด์ (โทเค็น)';
$string['settings:backend_context_tokens_desc'] = 'ความยาวบริบทสูงสุด (max_model_len) ของแบ็กเอนด์ AI ของคุณ หน่วยเป็นโทเค็น ตั้งค่าเป็น 0 สำหรับโมเดลแบบโฮสต์ที่มีหน้าต่างขนาดใหญ่ (ไม่จำกัด) เมื่อตั้งค่ามากกว่า 0 (ตัวอย่างเช่น 8192 บนแบ็กเอนด์ vLLM ที่โฮสต์เอง) SOLA จะลดงบประมาณจำนวนอักขระของพรอมต์ระบบด้านบนลง เพื่อให้พรอมต์รวมกับเอาต์พุตที่สำรองไว้และประวัติการสนทนาพอดีกับหน้าต่าง แม้แต่ในภาษาที่มีโทเค็นหนาแน่น ดูหน้าวิกิ Deployment Sizing เพื่อทราบว่าค่านี้สัมพันธ์กับจำนวนผู้ใช้พร้อมกันอย่างไร';
$string['settings:backend_retry_attempts'] = 'จำนวนครั้งที่ลองใหม่กับแบ็กเอนด์';
$string['settings:backend_retry_attempts_desc'] = 'จำนวนครั้งที่จะลองใหม่เมื่อเกิดข้อผิดพลาดชั่วคราวของแบ็กเอนด์ (HTTP 429 หรือ 503) ก่อนที่จะแสดงข้อผิดพลาดให้ผู้เรียนเห็น การลองใหม่จะเกิดขึ้นก่อนที่ข้อความตอบกลับใด ๆ จะถูกสตรีมเท่านั้น ดังนั้นเอาต์พุตจะไม่ถูกทำซ้ำ ออกแบบมาสำหรับแบ็กเอนด์ขนาดเล็กที่โฮสต์เองซึ่งปฏิเสธคำขอเมื่อมีภาระงานสูง ตั้งค่าเป็น 0 เพื่อปิดใช้งาน ค่าเริ่มต้น 2';
$string['settings:backend_retry_max_wait'] = 'เวลารอสูงสุดในการลองใหม่กับแบ็กเอนด์ (วินาที)';
$string['settings:backend_retry_max_wait_desc'] = 'ขอบเขตบน หน่วยเป็นวินาที ของระยะเวลาที่จะปฏิบัติตามส่วนหัว Retry-After จากแบ็กเอนด์ก่อนที่จะลองใหม่ เมื่อแบ็กเอนด์ไม่ส่ง Retry-After มา SOLA จะใช้การถอยกลับแบบเอ็กซ์โพเนนเชียลสั้น ๆ แทน ค่าเริ่มต้น 5';
$string['prompt:truncation_hint'] = 'หมายเหตุ: ไม่สามารถค้นหาเนื้อหาบทเรียนทั้งหมดในรอบนี้ได้เนื่องจากข้อจำกัดด้านความยาว หากผู้เรียนถามเกี่ยวกับสิ่งที่คุณไม่พบในเนื้อหาที่ให้มา ให้บอกว่าคุณไม่สามารถค้นหาทั้งบทเรียนได้และแนะนำให้พวกเขาเปิดหน้าหรือกิจกรรมเฉพาะที่ครอบคลุมหัวข้อนั้น แทนที่จะระบุว่าหัวข้อนั้นไม่มีอยู่ในบทเรียน';
$string['selftest:title'] = 'การทดสอบแบ็กเอนด์ด้วยตนเอง';
$string['selftest:intro'] = 'เรียกใช้การตรวจสอบสดของแบ็กเอนด์ AI ที่คุณกำหนดค่าไว้: การรับส่งแชทขนาดเล็ก การตรวจจับหน้าต่างบริบทอัตโนมัติ (max_model_len) และการเปรียบเทียบกับการตั้งค่าหน้าต่างบริบทของแบ็กเอนด์ ขีดต่ำสุดของงบประมาณพรอมต์ระบบ และ (เมื่อเปิดใช้ RAG) การรับส่ง embedding การเรียกใช้เครือข่ายจะทำงานเฉพาะเมื่อคุณกด เรียกใช้ เท่านั้น';
$string['selftest:run'] = 'เรียกใช้การทดสอบแบ็กเอนด์ด้วยตนเอง';
$string['selftest:check'] = 'การตรวจสอบ';
$string['selftest:status'] = 'สถานะ';
$string['selftest:detail'] = 'รายละเอียด';
$string['selftest:link'] = 'หน้าการทดสอบแบ็กเอนด์ด้วยตนเอง';
$string['selftest:link_desc'] = 'เปิดหน้า <a href="{$a}">การทดสอบแบ็กเอนด์ด้วยตนเอง</a> เพื่อยืนยันว่าแบ็กเอนด์ AI ของคุณทำงานและมีขนาดที่เหมาะสม มีประโยชน์ทันทีหลังจากกำหนดค่าแบ็กเอนด์ที่โฮสต์เอง';
$string['profile:title'] = 'ค่าที่ตั้งไว้ล่วงหน้าสำหรับการปรับใช้';
$string['profile:intro'] = 'นำชุดการตั้งค่าที่แนะนำสำหรับประเภทการปรับใช้ของคุณมาใช้ ค่าต่าง ๆ จะถูกเขียนลงในการตั้งค่าปลั๊กอินปกติและยังคงแก้ไขแต่ละรายการได้ในภายหลัง การนำค่าที่ตั้งไว้ล่วงหน้ามาใช้จะเขียนทับการตั้งค่าที่แสดงไว้';
$string['profile:current'] = 'ค่าที่ตั้งไว้ล่วงหน้าที่ใช้ล่าสุด: {$a}';
$string['profile:setting'] = 'การตั้งค่า';
$string['profile:value'] = 'ค่า';
$string['profile:self_hosted_small'] = 'บริบทขนาดเล็กที่โฮสต์เอง (GPU เดี่ยว เช่น A30 24GB / vLLM ที่ 8K)';
$string['profile:hosted_large'] = 'บริบทขนาดใหญ่แบบโฮสต์ (ค่าเริ่มต้น)';
$string['profile:apply_self_hosted_small'] = 'นำค่าที่ตั้งไว้ล่วงหน้าบริบทขนาดเล็กที่โฮสต์เองมาใช้';
$string['profile:apply_hosted_large'] = 'นำค่าเริ่มต้นบริบทขนาดใหญ่แบบโฮสต์มาใช้';
$string['profile:applied'] = 'นำค่าที่ตั้งไว้ล่วงหน้า {$a} มาใช้แล้ว ขณะนี้ค่าต่าง ๆ อยู่ในการตั้งค่าปลั๊กอินของคุณแล้ว';
$string['profile:unknown'] = 'ไม่รู้จักค่าที่ตั้งไว้ล่วงหน้าสำหรับการปรับใช้';
$string['profile:link'] = 'หน้าค่าที่ตั้งไว้ล่วงหน้าสำหรับการปรับใช้';
$string['profile:link_desc'] = 'เปิดหน้า <a href="{$a}">ค่าที่ตั้งไว้ล่วงหน้าสำหรับการปรับใช้</a> เพื่อนำชุดการตั้งค่าที่แนะนำสำหรับแบ็กเอนด์แบบโฮสต์หรือที่โฮสต์เองมาใช้';
$string['settings:zendesk_require_consent'] = 'ต้องได้รับความยินยอมก่อนยกระดับไปยังฝ่ายสนับสนุน';
$string['settings:zendesk_require_consent_desc'] = 'เมื่อเปิด (แนะนำ) SOLA จะยกระดับการสนทนาไปยังโต๊ะสนับสนุน Zendesk เฉพาะหลังจากที่ผู้เรียนยอมรับประกาศความยินยอมในการใช้งานครั้งแรกแล้ว ซึ่งเปิดเผยว่าการขอความช่วยเหลือจากมนุษย์จะแบ่งปันการสนทนา (รวมถึงชื่อและอีเมล) กับฝ่ายสนับสนุน ปิดตัวเลือกนี้เฉพาะเมื่อคุณได้รับความยินยอมนั้นด้วยวิธีอื่น เมื่อปิดอยู่ การยกระดับจะส่งทันที ไม่มีผลใด ๆ เว้นแต่จะเปิดใช้งานการยกระดับ Zendesk';
$string['chat:escalation_needs_consent'] = 'ดูเหมือนว่าเรื่องนี้ต้องใช้สมาชิกจากทีมสนับสนุนของเรา ในการส่งต่อให้พวกเขา ฉันจะต้องแบ่งปันการสนทนานี้ รวมถึงชื่อและอีเมลของคุณ กับโต๊ะสนับสนุน คุณยังไม่ได้ตกลงในเรื่องนี้ ดังนั้นฉันจึงยังไม่ได้ส่งอะไรไป หากคุณต้องการความช่วยเหลือจากมนุษย์ โปรดยอมรับประกาศการแบ่งปันข้อมูลสำหรับผู้ช่วยนี้แล้วถามอีกครั้ง หรือติดต่อฝ่ายสนับสนุนโดยตรง';
$string['privacy:metadata:email_optout'] = 'การตั้งค่าการเลือกไม่รับอีเมลต่อผู้รับ (ประเภทอีเมลที่ผู้รับได้ยกเลิกการสมัครรับ)';
...
$string['settings:rag_min_similarity'] = 'ความเกี่ยวข้องขั้นต่ำ (โคไซน์)';
$string['settings:rag_min_similarity_desc'] = 'ตัดส่วนข้อความที่ดึงมาซึ่งมีความคล้ายคลึงแบบโคไซน์กับคำถามต่ำกว่าค่านี้ออก เพื่อให้คำถามที่นอกประเด็นหรือมีข้อมูลน้อยแทรกข้อความเข้ามาน้อยลง (หรือไม่มีเลย) แทนที่จะเติมจนครบ Top-K ด้วยการจับคู่ที่อ่อน ช่วงค่า 0 ถึง 1; 0 ปิดการกรองนี้ ค่าที่เหมาะสมขึ้นอยู่กับโมเดล embedding: 0.25 เหมาะกับ text-embedding-3-small เพิ่มค่าให้เข้มงวดขึ้น (บริบทน้อยลงแต่ตรงประเด็นมากขึ้น) ลดค่าให้ยืดหยุ่นมากขึ้น';
$string['settings:rag_currentpage_boost'] = 'การเพิ่มน้ำหนักหน้าปัจจุบัน';
$string['settings:rag_currentpage_boost_desc'] = 'คะแนนโบนัสเล็กน้อยที่เพิ่มให้กับคะแนนความเกี่ยวข้องของส่วนข้อความจากหน้าที่ผู้เรียนกำลังดูอยู่ เพื่อให้คำถามอย่าง "อธิบายสิ่งนี้" ให้ความสำคัญกับหน้าที่มองเห็นเมื่อคะแนนใกล้เคียงกัน มีผลต่อการจัดลำดับเท่านั้น: ไม่ได้บังคับให้ส่วนข้อความที่ไม่เกี่ยวข้องผ่านการกรองความเกี่ยวข้องขั้นต่ำ ตั้งเป็น 0 เพื่อปิด';
$string['settings:history_mode'] = 'โหมดการเลือกประวัติ';
$string['settings:history_mode_desc'] = 'วิธีการเลือกบทสนทนาในอดีตก่อนส่งไปยังโมเดล <strong>เชิงความหมาย</strong> เก็บเฉพาะบทสนทนาล่าสุดที่เกี่ยวข้องกับคำถามปัจจุบัน (และเก็บการสนทนาล่าสุดเสมอ) เพื่อไม่ให้บทสนทนาเก่าที่นอกประเด็นเพิ่มต้นทุนหรือดึงคำตอบให้ออกนอกเรื่อง โดยจะมีการเรียก embedding เพิ่มหนึ่งครั้งต่อข้อความ <strong>ตามลำดับเวลา</strong> เก็บคู่สนทนาล่าสุดตามจำนวน "Max Conversation History" โดยไม่คำนึงถึงความเกี่ยวข้อง (พฤติกรรมเดิมที่ใช้มานาน ไม่มีการเรียกเพิ่ม) หาก embedding ใช้งานไม่ได้ โหมดเชิงความหมายจะเปลี่ยนกลับไปใช้ตามลำดับเวลาโดยอัตโนมัติ';
$string['settings:history_mode_semantic'] = 'เชิงความหมาย (บทสนทนาล่าสุดที่เกี่ยวข้อง)';
$string['settings:history_mode_recency'] = 'ตามลำดับเวลา (N คู่ล่าสุด)';
$string['settings:history_semantic_minscore'] = 'เกณฑ์ความเกี่ยวข้องขั้นต่ำของประวัติ (โคไซน์)';
$string['settings:history_semantic_minscore_desc'] = 'ในโหมดประวัติเชิงความหมาย บทสนทนาในอดีตจะถูกเก็บไว้ก็ต่อเมื่อความคล้ายคลึงกับคำถามปัจจุบันมีค่าอย่างน้อยเท่ากับค่านี้ (การสนทนาล่าสุดจะถูกเก็บไว้เสมอ) ช่วงค่า 0 ถึง 1; ขึ้นอยู่กับโมเดล เพิ่มค่าให้เข้มงวดขึ้น (ประวัติน้อยลง) ลดค่าเพื่อเก็บไว้มากขึ้น';
$string['settings:history_candidates'] = 'หน้าต่างผู้สมัครประวัติ';
$string['settings:history_candidates_desc'] = 'ในโหมดประวัติเชิงความหมาย จะมีการให้คะแนนความเกี่ยวข้องเฉพาะคู่สนทนาล่าสุดตามจำนวนนี้เท่านั้น (เป็นการจำกัดต้นทุน) คู่สนทนาที่เก่ากว่าหน้าต่างนี้จะไม่ถูกส่ง ควรตั้งค่านี้ให้เท่ากับหรือมากกว่า "Max Conversation History"';
