...
$string['settings:comparison_providers_desc'] = 'เพิ่มผู้ให้บริการ AI เพิ่มเติมลงในตัวเลือก LLM ในวิดเจ็ตเพื่อให้ผู้ดูแลระบบสามารถเปรียบเทียบคำตอบจากผู้ให้บริการต่างๆ ได้ หนึ่งบรรทัดต่อผู้ให้บริการในรูปแบบ: provider_id|api_key|model1,model2 ผู้ให้บริการหลักที่กำหนดค่าไว้ด้านบนจะถูกรวมไว้โดยอัตโนมัติเสมอ เฉพาะผู้ดูแลระบบที่มีสิทธิ์จัดการเท่านั้นที่จะเห็นตัวเลือก นักเรียนจะไม่เห็น ตัวอย่าง:<br><code>claude|sk-ant-api03-...|claude-sonnet-4-5-20250929,claude-3-5-haiku-20241022<br>gemini|AIzaSy...|gemini-2.0-flash<br>deepseek|sk-...|deepseek-chat</code><br>Provider IDs ที่ถูกต้อง: openai, claude, deepseek, gemini, ollama, minimax, mistral, groq, openrouter, xai, coreai, custom.';
...
$string['task:run_meta_ai_query'] = 'รันการค้นหาวิเคราะห์ Meta-AI ตามกำหนดเวลา';
