...
$string['settings:rerank_candidates_desc'] = 'จำนวน cosine top-N ผู้สมัครที่จะส่งเข้าขั้นตอน rerank ค่าเริ่มต้น 50 window ที่ใหญ่ขึ้นให้วัสดุแก่ตัวจัดอันดับมากขึ้นโดยมีต้นทุนเพิ่มเพียงเล็กน้อย (ประมาณ 10k โทเค็นต่อการดำเนิน rerank หนึ่งครั้ง)';
