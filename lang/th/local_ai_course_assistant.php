...
$string['settings:stt_selfhosted_heading_desc'] = 'รันการแปลงเสียงเป็นข้อความบนฮาร์ดแวร์ของคุณเองโดยไม่มีค่าใช้จ่ายต่อนาที ชี้ SOLA ไปที่เซิร์ฟเวอร์การถอดเสียงที่เข้ากันได้กับ OpenAI: <code>whisper-server</code> Docker, <code>speaches</code> (faster-whisper) หรือ <code>whisper.cpp</code> server เมื่อตั้งค่า URL เซิร์ฟเวอร์ที่นี่ จะกลายเป็นเส้นทาง STT เริ่มต้น; เลือกผู้ให้บริการที่ชำระเงินใน Active STT provider ด้านบนเพื่อแทนที่ หากเซิร์ฟเวอร์อยู่ในเครือข่ายส่วนตัวหรือ http ธรรมดา ให้เพิ่ม host ไว้ใน SSRF trusted endpoints allowlist ในส่วนความปลอดภัยด้วย';
$string['settings:stt_selfhosted_url'] = 'Selfhosted STT server URL';
$string['settings:stt_selfhosted_url_desc'] = 'Base URL ของเซิร์ฟเวอร์การถอดเสียงที่เข้ากันได้กับ OpenAI เช่น <code>http://10.0.0.5:8000</code> SOLA จะเพิ่ม <code>/v1/audio/transcriptions</code> ต่อท้ายโดยอัตโนมัติ; รับ endpoint path แบบเต็มด้วยเช่นกัน เว้นว่างไว้เพื่อปิดใช้งาน selfhosted STT';
...
$string['emergency:title'] = 'การควบคุมฉุกเฉิน SOLA';
$string['emergency:page_warning'] = 'สวิตช์เหล่านี้มีผลทันทีสำหรับผู้เรียนทุกคนบนไซต์ การดำเนินการแต่ละอย่างจะบันทึกแถว audit สวิตช์แบบละเอียดปล่อยให้ SOLA ส่วนที่เหลือยังคงทำงาน; การปิดหลักจะลบ widget ออกทั้งหมด';
$string['emergency:back_to_settings'] = 'การตั้งค่า SOLA';
...
$string['emergency:flag_chat_desc'] = 'บล็อกการรับส่งข้อมูลแชทผ่าน kill flag เฉพาะ (แก้ไขใน v5.13) widget ยังคงแสดงอยู่; ผู้เรียนจะเห็นข้อความ "SOLA หยุดชั่วคราว" ที่เป็นมิตร ใช้เมื่อผู้ให้บริการ LLM ทำงานผิดปกติหรือมีค่าใช้จ่ายพุ่งสูงขึ้น';
...
$string['emergency:flag_all_desc'] = 'ปิดใช้งาน plugin ทั้งหมด: widget หายไปจากทุกหน้า, scheduled task หยุดทำงาน, เสียงถูกล้าง, RAG ปิด, outreach ปิด สวิตช์ที่แรงที่สุด — ใช้สำหรับเหตุการณ์ด้านความปลอดภัยหรือเมื่อต้องนำ SOLA ออกจากระบบทันที';
$string['emergency:settings_link'] = 'การควบคุมฉุกเฉิน';
$string['emergency:settings_link_desc'] = 'สวิตช์ปิดระบบย่อย (แชท / เสียง / RAG / outreach / หลัก) พร้อม audit logging — เทียบเท่าเว็บของ <code>admin/cli/emergency_disable.php</code> เปิด <a href="{$a}">การควบคุมฉุกเฉิน SOLA</a>';
$string['email_unsubscribe:done_title'] = 'ยกเลิกการสมัครแล้ว';
$string['email_unsubscribe:done_body'] = 'เสร็จแล้ว — {$a->email} จะไม่ได้รับอีเมลประเภทนี้จาก {$a->product} อีกต่อไป หากคุณเปลี่ยนใจ ขอให้ผู้ดูแลระบบ {$a->product} เปิดการสมัครรับข้อมูลใหม่อีกครั้ง หรือส่งการยินยอมใหม่ผ่านหน้า SOLA Recipients ของผู้ดูแลระบบ';
...
$string['settings:cost_anomaly_heading_desc'] = 'scheduled task รายวัน (<code>cost_anomaly_check</code>) ที่เปรียบเทียบค่าใช้จ่าย SOLA ทั้งไซต์ในวันนี้กับค่ามัธยฐาน 7 วันที่ผ่านมา ส่งอีเมลถึงรายชื่อผู้รับ <code>spend_notify_emails</code> (สำรองไปยังผู้ดูแล site) เมื่อค่าใช้จ่ายวันนี้เกินกว่า multiplier ที่กำหนดคูณค่ามัธยฐาน ตรวจจับสามโหมดความล้มเหลวที่เกณฑ์ 80% / 95% / 100% ที่มีอยู่ไม่ครอบคลุม: (1) คอร์สที่หลุดควบคุมซึ่งไม่ถึงเพดานสัมบูรณ์แต่คอร์สเดียวขับเคลื่อนปริมาณงาน 10 เท่าของปกติ (2) การเปิด premium tier โดยไม่ตั้งใจ (3) provider misroute ปิดใช้งานตามค่าเริ่มต้น; เทียบเท่า Redash query ใน SOLA ที่ <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>';
...
$string['analytics:exp_active_users'] = 'ผู้ใช้ SOLA ที่ใช้งานอยู่';
