...
$string['settings:premium_escalation_model_desc'] = 'ชื่อ model ที่ส่งไปยัง premium provider ค่าเริ่มต้น <code>claude-opus-4-8</code> ตามคำตัดสินของ A.10 bake-off';
