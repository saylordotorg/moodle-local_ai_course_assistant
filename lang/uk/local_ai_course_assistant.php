...
$string['pedagogy:learning_path_desc'] = 'Коли ввімкнено, SOLA додає візуальну панель навчального шляху (кнопка "мій шлях" у заголовку віджета), яка показує програму студента як послідовність курсів, кожен з яких можна розгорнути до його цілей та рівня опанування студентом. Коли студент досягає планки поточного курсу (завершення або високої частки опанованих цілей), SOLA також показує делікатний банер "готовий до наступного курсу" та згадує про це в розмові. Лише рекомендаційно; використовує власний розподіл програми студента; мовчки нічого не робить там, де жодна програма не застосовується.';
...
$string['settings:backend_retry_max_wait_desc'] = 'Верхня межа в секундах того, як довго враховувати заголовок Retry-After від бекенда перед повторною спробою. Коли бекенд не надсилає Retry-After, SOLA натомість використовує коротку експоненційну затримку. За замовчуванням 5.';
...
$string['settings:zendesk_require_consent_desc'] = 'Коли ввімкнено (рекомендовано), SOLA ескалює розмову до служби підтримки Zendesk лише після того, як учень прийняв повідомлення про згоду під час першого запуску, яке розкриває, що запит про допомогу людини надає розмову (включно з ім\'ям та електронною поштою) підтримці. Вимикайте це лише в тому разі, якщо ви отримуєте цю згоду іншим способом; коли вимкнено, ескалації надсилаються негайно. Не має ефекту, якщо не ввімкнено ескалацію Zendesk.';
...
$string['emergency:title'] = 'Аварійне керування SOLA';
$string['emergency:page_warning'] = 'Ці перемикачі негайно набирають чинності для кожного студента на сайті. Кожна дія записує рядок аудиту. Гранульовані перемикачі дозволяють решті SOLA продовжувати роботу; головне вбивство повністю видаляє віджет.';
$string['emergency:back_to_settings'] = 'Налаштування SOLA';
...
$string['emergency:flag_chat_desc'] = 'Блокує трафік чату через спеціальний kill flag (виправлення v5.13). Віджет продовжує рендеритися; студенти бачать дружнє повідомлення "SOLA призупинено". Використовуйте, коли LLM-провайдер веде себе некоректно або відбувається стрибок витрат.';
...
$string['emergency:flag_all_desc'] = 'Вимикає весь плагін: віджет зникає з кожної сторінки, заплановані завдання зупиняються, голос очищується, RAG вимкнено, outreach вимкнено. Найпотужніший перемикач — використовуйте при інциденті безпеки або коли SOLA необхідно негайно вимкнути.';
$string['emergency:settings_link'] = 'Аварійне керування';
$string['emergency:settings_link_desc'] = 'Kill-перемикачі на підсистему (чат / голос / RAG / outreach / головний) з журналом аудиту — веб-еквівалент <code>admin/cli/emergency_disable.php</code>. Відкрийте <a href="{$a}">Аварійне керування SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Відписка виконана';
$string['email_unsubscribe:done_body'] = 'Готово — {$a->email} більше не отримуватиме цей тип листів від {$a->product}. Якщо ви передумаєте, попросіть адміністратора {$a->product} повторно ввімкнути підписку або надішліть нову згоду через сторінку адміністратора SOLA Recipients.';
...
$string['task:policy_bundle_sync'] = 'SOLA синхронізація підписаного пакета політик';
...
$string['settings:policy_bundle_status'] = 'Остання синхронізація';
$string['settings:policy_bundle_applied_version'] = 'застосована версія';
$string['task:policy_bundle_sync'] = 'Синхронізація підписаного пакета політик SOLA';
$string['policy_bundle:invalid'] = 'Пакет політик відхилено: {$a}';
...
$string['analytics:exp_active_users'] = 'Активні користувачі SOLA';
