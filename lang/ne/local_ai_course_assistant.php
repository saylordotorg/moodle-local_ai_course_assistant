...
$string['pedagogy:program_path_desc'] = 'सक्रिय हुँदा, SOLA ले सिकारुलाई हालको पाठ्यक्रम तिनको कार्यक्रम (डिग्री वा प्रमाणपत्र) मा अब कहाँ अगाडि बढ्छ र आजका अवधारणाहरू पछिका पाठ्यक्रमहरूसँग कसरी जोडिन्छन् भनेर बताउन सक्छ। यसले Moodle Programs प्लगइन (Degrees र Learn) पढ्छ र कार्यक्रमले पूर्वापेक्षा वा आवश्यक क्रम परिभाषित गरेको ठाउँमा मात्र निश्चित अर्को पाठ्यक्रमको नाम लिन्छ; अन्यथा यसले मार्गमा सिकारुको स्थानलाई औंल्याउँछ। सल्लाहकारी मात्र — यसले कहिल्यै भर्ना वा निपुणता परिवर्तन गर्दैन, र सधैं हालको सिकारुको आफ्नै कार्यक्रम विनियोजन मात्र प्रयोग गर्छ। कुनै कार्यक्रम लागू नहुने ठाउँमा यसले मौन रूपमा केही गर्दैन।';
...
$string['pedagogy:learning_path_desc'] = 'सक्रिय हुँदा, SOLA ले एउटा दृश्यात्मक सिकाइ-मार्ग प्यानल (विजेट हेडरमा "मेरो मार्ग" बटन) थप्छ जसले सिकारुको कार्यक्रमलाई कोर्सहरूको शृङ्खलाको रूपमा देखाउँछ, प्रत्येकलाई यसका उद्देश्यहरू र सिकारुको दक्षता हेर्न विस्तार गर्न सकिन्छ। जब सिकारुले वर्तमान कोर्सको स्तर पूरा गर्छ (पूर्णता वा उद्देश्यहरूको ठूलो हिस्सा दक्ष), SOLA ले एउटा नरम "अर्को कोर्सका लागि तयार" ब्यानर पनि देखाउँछ र कुराकानीमा यसको उल्लेख गर्छ। केवल सल्लाहमूलक; सिकारुको आफ्नै कार्यक्रम बाँडफाँड प्रयोग गर्छ; कुनै कार्यक्रम लागू नहुँदा चुपचाप केही गर्दैन।';
...
$string['settings:backend_context_tokens_desc'] = 'तपाईंको AI ब्याकेन्डको अधिकतम कन्टेक्स्ट लम्बाइ (max_model_len), टोकनमा। ठूलो विन्डो भएका होस्ट गरिएका मोडेलहरूका लागि 0 मा सेट गर्नुहोस् (क्ल्याम्पिङ छैन)। 0 भन्दा माथि सेट गर्दा (उदाहरणका लागि स्व-होस्ट गरिएको vLLM ब्याकेन्डमा 8192), SOLA ले माथिको सिस्टम-प्रम्प्ट क्यारेक्टर बजेट घटाउँछ ताकि प्रम्प्ट साथै आरक्षित आउटपुट र वार्तालाप इतिहास विन्डोमा अट्न सकोस्, टोकन-घना भाषाहरूमा पनि। यो कसरी एकैसाथका प्रयोगकर्ताहरूसँग नक्सा हुन्छ भन्ने जान्न Deployment Sizing विकी पृष्ठ हेर्नुहोस्।';
...
$string['settings:backend_retry_max_wait_desc'] = 'पुन: प्रयास गर्नुअघि ब्याकेन्डबाटको Retry-After हेडरलाई कति लामो समय सम्मान गर्ने भन्ने माथिल्लो सीमा, सेकेन्डमा। जब ब्याकेन्डले कुनै Retry-After पठाउँदैन, SOLA ले बरु छोटो घातीय ब्याकअफ प्रयोग गर्छ। पूर्वनिर्धारित 5।';
...
$string['settings:stt_selfhosted_heading_desc'] = 'आफ्नै हार्डवेयरमा प्रति-मिनेट शून्य खर्चमा भाषण-देखि-पाठ चलाउनुहोस्। SOLA लाई कुनै पनि OpenAI-सुसंगत ट्रान्सक्रिप्सन सर्भरमा निर्देशित गर्नुहोस्: <code>whisper-server</code> Docker, <code>speaches</code> (faster-whisper), वा <code>whisper.cpp</code> सर्भर। यहाँ सर्भर URL सेट हुँदा यो पूर्वनिर्धारित STT मार्ग बन्छ; माथिको सक्रिय STT प्रदायकमा भुक्तान प्रदायक छनौट गरी ओभरराइड गर्नुहोस्। सर्भर निजी नेटवर्क वा सादा http मा भएमा, सुरक्षा खण्डमा SSRF विश्वसनीय अन्तिम बिन्दुहरूको अनुमति-सूचीमा पनि यसको होस्ट थप्नुहोस्।';
$string['settings:stt_selfhosted_url'] = 'स्व-होस्ट STT सर्भर URL';
$string['settings:stt_selfhosted_url_desc'] = 'OpenAI-सुसंगत ट्रान्सक्रिप्सन सर्भरको आधार URL, उदाहरणका लागि <code>http://10.0.0.5:8000</code>। SOLA स्वचालित रूपमा <code>/v1/audio/transcriptions</code> थप्छ; पूर्ण अन्तिम बिन्दु मार्ग पनि स्वीकार्य छ। स्व-होस्ट STT अक्षम गर्न खाली छोड्नुहोस्।';
...
$string['emergency:title'] = 'SOLA आपतकालीन नियन्त्रणहरू';
$string['emergency:page_warning'] = 'यी स्विचहरू साइटका प्रत्येक सिकारुका लागि तुरुन्तै लागू हुन्छन्। प्रत्येक कार्यले अडिट पङ्क्ति लेख्छ। विस्तृत स्विचहरूले SOLA को बाँकी भाग चलिरहन दिन्छन्; मास्टर किलले विजेटलाई पूर्णतः हटाउँछ।';
$string['emergency:back_to_settings'] = 'SOLA सेटिङहरू';
...
$string['emergency:flag_chat_desc'] = 'समर्पित किल फ्ल्याग (v5.13 सुधार) मार्फत च्याट ट्राफिक रोक्छ। विजेट रेन्डर हुन जारी राख्छ; सिकारुहरूले मैत्रीपूर्ण "SOLA रोकिएको" सन्देश देख्छन्। LLM प्रदायक गलत व्यवहार गरिरहेको वा लागत स्पाइक भइरहेको बेला प्रयोग गर्नुहोस्।';
...
$string['emergency:flag_all_desc'] = 'सम्पूर्ण प्लगइन अक्षम गर्छ: प्रत्येक पृष्ठबाट विजेट हटाइन्छ, अनुसूचित कार्यहरू रोकिन्छन्, आवाज सफा हुन्छ, RAG बन्द हुन्छ, आउटरिच बन्द हुन्छ। सबैभन्दा शक्तिशाली स्विच — सुरक्षा घटना वा SOLA तुरुन्तै अफलाइन लिनु पर्दा प्रयोग गर्नुहोस्।';
$string['emergency:settings_link'] = 'आपतकालीन नियन्त्रणहरू';
$string['emergency:settings_link_desc'] = 'अडिट लगिङसहित प्रति-उपप्रणाली किल स्विचहरू (च्याट / आवाज / RAG / आउटरिच / मास्टर) — <code>admin/cli/emergency_disable.php</code> को वेब समतुल्य। <a href="{$a}">SOLA आपतकालीन नियन्त्रणहरू</a> खोल्नुहोस्।';
$string['email_unsubscribe:done_title'] = 'सदस्यता रद्द गरियो';
$string['email_unsubscribe:done_body'] = 'सम्पन्न — {$a->email} ले {$a->product} बाट यस प्रकारको इमेल थप प्राप्त गर्नेछैन। मन परिवर्तन भएमा, {$a->product} प्रशासकलाई सदस्यता पुनः सक्षम गर्न भन्नुहोस्, वा SOLA प्राप्तकर्ता प्रशासन पृष्ठमार्फत नयाँ अप्ट-इन पठाउनुहोस्।';
...
$string['settings:cost_anomaly_multiplier_desc'] = 'अलर्ट ट्रिगर गर्न आजको खर्च यो गुणक × 7-दिन मध्यक भन्दा बढी हुनुपर्छ। पूर्वनिर्धारित <code>2.0</code>। प्रारम्भिक चेतावनीका लागि <code>1.5</code> मा घटाउनुहोस् (नामांकन बर्सटको क्रममा थप गलत सकारात्मकहरू)। Saylor को प्रयोग यति बर्स्टी छ कि 2x स्पाइकहरू नियमित हुन्छन् भने <code>3.0</code> मा बढाउनुहोस्।';
...
$string['analytics:exp_active_users'] = 'सक्रिय SOLA प्रयोगकर्ताहरू';
