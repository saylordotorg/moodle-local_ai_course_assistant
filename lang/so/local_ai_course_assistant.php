...
$string['settings:backend_retry_max_wait_desc'] = 'Xadka sare, oo lagu cabbiro ilbiriqsiyo, ee inta loo ixtiraamayo madax-furaha Retry-After ee ka yimaada backend-ka ka hor dib-u-isku-dayga. Marka backend-ku uusan dirin Retry-After, SOLA waxay halkii isticmaashaa dib-u-dhac jibbaaran oo gaaban. Caadi ahaan 5.';
...
$string['settings:stt_selfhosted_heading_desc'] = 'Ku socodsii speech-to-text hardware-kaaga gaar ah iyada oo aan qiime daqiiqad ah la bixin. SOLA u tilmaan server kasta oo turjumaad ah oo la mid ah OpenAI: Docker <code>whisper-server</code>, <code>speaches</code> (faster-whisper), ama server <code>whisper.cpp</code>. Marka URL server halkan la dejiyay, waxay noqotaa wadada STT ee caadiga ah; dooro bixiye lacag-bixinta ah Bixiyaha STT Firfircoon ee sare si aad u beddesho. Haddii server-ku ku yihiin shabakad gaar ah ama plain http, sidoo kale ku dar host-kiisa liiska la-aaminaanta ee SSRF ee qaybta Ammaanka.';
$string['settings:stt_selfhosted_url'] = 'URL-ka server-ka STT ee is-martigeliya';
$string['settings:stt_selfhosted_url_desc'] = 'URL-ka aasaasiga ah ee server-ka turjumaadda ee la mid ah OpenAI, tusaale <code>http://10.0.0.5:8000</code>. SOLA waxay si otomaatig ah u ku daraysaa <code>/v1/audio/transcriptions</code>; wadada dhamaystiran ee endpoint waa la aqbalaa sidoo kale. Ka tag madhan si aad u dami STT-da is-martigeliya.';
...
$string['emergency:title'] = 'Xukumaadka Xaalada Degdeg ah ee SOLA';
$string['emergency:page_warning'] = 'Beddelayaashaasi waxay si degdeg ah u shaqeeyaan ardayda oo dhan ee goobta. Ficil kasta wuxuu qoraa safka xiisaynta. Beddelayaasha faahfaahsan waxay kaga tagaan SOLA inteeda kale shaqeynaysa; dillaaca master-ka oo dhan wuxuu wijidhka si buuxda ka saara.';
$string['emergency:back_to_settings'] = 'Dejimaha SOLA';
...
$string['emergency:flag_chat_desc'] = 'Xukumada taraafikada wadahadallka iyada oo loo marayo calaamadda kill-ka gaar ah (dayactir v5.13). Wijidhka wuu sii samaynayaa; ardaydu waxay arkaan farriinta saaxiibka ah ee "SOLA waa la joojiyay". Isticmaal marka bixiyaha LLM-ku si khaldan u dhaqmayo ama kharashka korriintu socdaa.';
...
$string['emergency:flag_all_desc'] = 'Damisaa plugin-ka oo dhan: wijidhku waxa uu ka baxayaa bog kasta, hawlaha nidaamsan waa la joojiyaa, cod waa la nadiifiyay, RAG damay, gaadhsiinta damay. Baddelaha ugu xoogga badan — u isticmaal dhacdada amniga ama marka SOLA si degdeg ah looga baahnaan yahay in la xiro.';
$string['emergency:settings_link'] = 'Xukumaadka xaalada degdeg ah';
$string['emergency:settings_link_desc'] = 'Beddelayaasha kill per-nidaamka hoosaadka (wadahadal / cod / RAG / gaadhsiinta / master) oo leh diiwaanka xiisaynta — qeybta websaydhka ee <code>admin/cli/emergency_disable.php</code>. Fur <a href="{$a}">Xukumaadka Xaalada Degdeg ah ee SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Waa la ka baxay';
$string['email_unsubscribe:done_body'] = 'Dhameystiray — {$a->email} mar dambe waxba kama heli doonto noocaas ah ee emailka {$a->product}. Haddii aad fikradaada beddesho, codsiga maamulaha {$a->product} si uu mar kale u shido wadaagga, ama email cusub ka dir bogga SOLA Recipients ee maaraynta.';
...
$string['settings:premium_escalation_heading_desc'] = 'Waddooxidda ikhtiyaari ah per-wareeg ee modheel premium ah (Claude Opus 4.8 caadiga ah) ee prompt-yada ay heerka wadahadallka shaqada ah si cad ula dagaallanto — sida xisaabta labo-marxalad, CS, iyo sababaynta sayniska. Waxaa xaliyay bake-off A.10 2026-06-09: Opus 4.8 wuu ku guulaystay 14.97/15 vs 12.68/15 ee gpt-4o prompt-yada adag. Labada waddo oo kicin: regex matches fariinta isticmaalaha, ama liis-la-oggolaansho koorsada oo kobcisa wareeg kasta. Caadiga ah waa damay. ~5% kor-u-qaadis, raac ~$700/bil. 100k Saylor MAU kharashka wadahadallka aasaasiga ah ka sarreeya.';
...
$string['analytics:exp_active_users'] = 'Isticmaalayaasha SOLA ee firfircoon';
