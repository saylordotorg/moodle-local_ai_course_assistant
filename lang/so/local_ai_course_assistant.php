...
$string['settings:default_course_mode_desc'] = 'Waxay kontoroshaa haddii [[tutorshort]] uu ka soo muuqado koorso marka aan la sameyn xulasho koorso-koorso ah. Rakibitaannada cusub waxay u caadi yihiin "Caadi ahaan la damiyay" si maamulayaashu ay u awoodaan in ay koorso-koorso u dhiibaan laga bilaabo bogga Analytics ama bogga Course AI Settings.';
...
$string['coursesettings:sola_enabled'] = '[[tutorshort]] koorsadan';
$string['coursesettings:sola_enabled_toggle'] = 'Tus widget-ka [[tutorshort]] koorsadan';
$string['coursesettings:sola_enabled_desc'] = 'Waxay kontoroshaa haddii widget-ka sheekada [[tutorshort]] uu ka soo muuqdo koorsadan. Caadiga guud ee goobta waxaa lagu dejiyaa dejinta plug-in-ka hoosta General > Default for new courses.';
...
$string['chat:greeting'] = 'Salaan, {$a}! Waxaan ahay [[tutorshort]]. Sideen kugu caawin karaa maanta?';
$string['chat:title'] = '[[tutorshort]]';
$string['chat:assistant'] = '[[tutorshort]]';
$string['chat:open'] = 'Fur [[tutorshort]]';
...
$string['chat:voice_speaking'] = '[[tutorshort]] ayaa hadlaysa...';
...
$string['settings:cdn_heading_desc'] = 'U adeeg hantida hore ee [[tutorshort]] (JS/CSS) CDN dibadda ah halkii nidaamka faylalka Moodle. Tani waxay u oggolaataa cusboonaysiinta hore iyada oo aan la hagaajin plugin-ka. CDN URL ka banaan u dhaaf si aad u isticmaasho faylalka plugin-ka maxalliga ah.';
...
$string['chat:voice_title'] = 'Kala hadal [[tutorshort]]';
...
$string['mobile_disabled'] = '[[tutorshort]] kuma diyaara koorsigan.';
$string['mobile_placeholder'] = 'Weydii su\'aal...';
$string['mobile_welcome'] = 'Salaan, {$a}!';
$string['mobile_welcome_sub'] = 'Waxaan ahay [[tutorshort]], kaaliyahaaga barashada. Sideen ku caawin karaa?';
...
$string['settings:rag_return_scope'] = 'Baaxadda natiijada raadinta';
$string['settings:rag_return_scope_desc'] = 'Waxa lagu daro dhammaan natiijo la raadiyay. "chunk" (caadiga ah) wuxuu daraa qaybta la helay oo qiyaastii 400 eray ah. "window" wuxuu daraa qaybta la helay iyo qaybaha ku xiga oo isla boggan ka yimid. "page" wuxuu daraa bogga moduleka oo dhan ee natiijadu ka timid. window/page waxay caawiyaan marka jawaabtu ay ku faafto bog dhan, laakiin waxay keenaan prompt ka weyn.';
$string['settings:rag_window_size'] = 'Cabbirka daaqadda raadinta';
$string['settings:rag_window_size_desc'] = 'Baaxadda "window": tirada qaybaha ku xiga ee lagu daro dhinac kasta oo qayb la helay. Caadiga ah waa 1.';
$string['settings:rag_parent_max_chars'] = 'Xaddiga qaybta hooyo (xarfo)';
$string['settings:rag_parent_max_chars_desc'] = 'Tirada ugu badan ee xarfaha loo ogol yahay qayb window/page oo la balaadhiyay. Bogagga dhaafa xadka waxay ku noqdaan window, ka dibna qaybta kaliya. Caadiga ah waa 6000.';
...
$string['demo:course_fullname'] = 'Koorsada Tijaabada [[tutorshort]] (qarsoon)';
...
$string['chat:consent_body'] = '{$a->product} waa kaaliye barasho oo AI ku shaqeeya. Fariimahaaga iyo jawaabaha {$a->product} waxaa lagu kaydiyaa kaydka xogta Moodle ee {$a->institution} iyo tobanka wareeg ee ugu dambeeyay waxaa loo diraa bixiye moodal AI la ansixiyay si looga jawaabo su\'aalahaaga. Magacaaga koowaad waxaa loo wadaagaa shakhsi-ahaaneynta; macluumaad kale oo aqoonsi ah looma diro bixiyaha AI. Haddii aad codsato caawimaad bini\'aadam ah oo su\'aashaada kor loo qaado, wadahadalkan (oo ay ku jiraan magacaaga iyo emailkaaga) waxaa lala wadaagi karaa kooxdeena taageerada. Waad soo dejisan kartaa, tirtiri kartaa, ama joojin kartaa isticmaalka {$a->product} wakhti kasta.';
...
$string['settings:ssrf_trusted_endpoints_desc'] = 'Hal URL halkii xariiq. Marti-galiyaha la liiska gareeyay waxay ka gudbaan baaritaannada loopback / IP-gaar ah / kaliya-https ee SSRF baariyaha [[tutorshort]]. Tan u isticmaal kaliya LLM-yada is-martiqaada ee shabakad aad maamusho — tusaale <code>http://localhost:11434</code> Ollama maxalliga ah, <code>http://10.0.0.5:8000</code> vLLM pod isla VPC. Isbarbardhigga wuxuu u dhigmaa scheme + host + port; jid kasta waa la iska indho-tirayaa. Caadi ah madhan (xayiraad waxa kasta oo gudaha ah). Xariiqaha ka bilaaba <code>#</code> waa faallooyin.';
...
$string['flashcards:title'] = 'Kaararka xusuusta';
$string['flashcards:link'] = 'Kaararka xusuusta (hadda dib u eeg)';
$string['flashcards:intro'] = 'Dib-u-eegis ku celcelin kala fogaysan ah. Daaho jawaabta, kadibna isku qiimee adigoo isticmaalaya Mar kale, Adag ama Fudud. Kaararka kugu adkaaday ayaa dhaqso u soo noqonaya; kuwa kugu fududaaday way kala fogaanayaan.';
$string['flashcards:question'] = 'Su\'aal';
$string['flashcards:answer'] = 'Jawaab';
$string['flashcards:reveal'] = 'Muuji jawaabta';
$string['flashcards:again'] = 'Mar kale';
$string['flashcards:hard'] = 'Adag';
$string['flashcards:easy'] = 'Fudud';
$string['flashcards:no_due'] = 'Hadda ma jiro wax dib loo eego. Ka samee kaarar xusuus bog koorsada ah adigoo isticmaalaya qalabka kaaliyaha, ama soo laabo mar dambe.';
$string['flashcards:session_complete'] = 'Kulankii wuu dhammaaday. Shaqo wanaagsan.';
$string['flashcards:disabled'] = 'Kaararka xusuusta laguma furin koorsadan.';
$string['flashcards:toggle'] = 'U fur kaararka xusuusta koorsadan';
$string['flashcards:toggle_help'] = 'Wuxuu qalabka kaaliyaha ku daraa bilow "Samee kaarar xusuus" iyo bog dib-u-eegis oo ardayga ah oo ku yaal /local/ai_course_assistant/flashcards.php?courseid=X. Si caadi ah wuu damsan yahay.';
$string['flashcards:starter_generate'] = 'Ka samee kaarar xusuus boggan';
$string['flashcards:generated'] = 'Waxaa la keydiyay {$a} kaadh xusuus. Fur bogga dib-u-eegista si aad u barato.';
...
$string['settings:current_page_content_maxchars_desc'] = 'Tirada ugu badan ee xarfaha qoraalka bogga hadda oo lagu dhex geliyo amarka nidaamka sida qaybta "Current Page Content", marka RAG la damiyo. Qiimaha caadiga ah ee 8,000 wuxuu si wanaagsan u sal-dhigaa su\'aalaha bogga gaarka ah isaga oo u daaya miisaaniyad qaab-dhismeed iyo tilmaamo. (Marka RAG la furo, bogga waxaa beddelkeed lagu sal-dhigaa qaybihiisa ugu khuseeya, oo bogga hadda u janjeera, sidaas darteed xadkan ma khusayo.) Bog aad u dheer waxaa madaxa laga gooyaa ilaa tiradan xaraf, sidaas darteed dabada bog aad u dheer ayaa laga yaabaa inaan la xigaalin; furista RAG ayaa taas ka fogaata. Goobaha ka feejignaanta kharashka waxay ku xaddidi karaan qiime ka hooseeya (tusaale 3,000-4,000). Ku xaddidan xadka 500-8,000. Madax-bannaan <code>prompt_budget_chars</code>: tani waxay xaddidaysaa kaliya qaybta bogga; miisaaniyaddu waxay xaddidaysaa amarka oo dhan.';
...
$string['settings:prompt_budget_auto_tune'] = 'Habaynta tooska ah maalin kasta ee miisaaniyadda amarka nidaamka (waa laga tanaasulay)';
$string['settings:prompt_budget_auto_tune_desc'] = 'Waa laga tanaasulay. Waxba ma qabto haddii habka miisaaniyadda ee kor ku xusan aan loo dejin <strong>Go\'an</strong>. Hawl maalin kasta ah ayaa horay u qiyaasi jirtay miisaaniyadda xarfaha iyadoo la ilaalinayo gooynta oo la raacayo amarka ugu weyn ee ay aragtay. Miisaaniyadda laga soo saaro daaqadda macnaha guud ee moodalka way ka fiican tahay: ma gariirto, mana u baahna xog bilow. Labaduba sidoo kale way isku dhaceen, sababtoo ah hawshu waxay qortaa miisaaniyadda xarfaha, qiime kasta oo aan ahayn kii caadiga ah wuxuu damiyaa miisaaniyadda la soo saaray. Tan damin ku sii dey; waxaa laga saari doonaa sii deyn mustaqbalka. Talooyinka wali waxay ka muuqdaan bogga <a href="/local/ai_course_assistant/prompt_metrics.php">Cabbirrada amarka</a>.';
...
$string['comms:audit_log_title'] = 'Waxa [[tutorshort]] ii soo diray';
$string['comms:audit_log_empty'] = '[[tutorshort]] wax iimayl ah kuuma soo dirin.';
$string['comms:memory_title'] = 'Waxa [[tutorshort]] xusuustay ee ku saabsan sida aan wax u barto';
$string['comms:memory_desc'] = 'Qoraaladani waa kuwo gaar ah oo ku saabsan wada-sheekaysigaaga [[tutorshort]]. Waxay ka caawiyaan [[tutorshort]] inuu doorto hab kale marka mowduucu adag yahay. Mar kasta waad tirtiri kartaa.';
$string['comms:memory_clear'] = 'Tirtir dhammaan qoraalada xusuusta';
$string['milestone:streak_subject'] = '{$a->days} maalmood oo isku xigta gudaha {$a->coursename}';
$string['milestone:streak_body_text'] = "Salaan {\$a->firstname},\n\nWaxaad {\$a->days} maalmood oo isku xigta ka soo qayb gashay {\$a->coursename}. Joogtayntaas oo kale ayaa ah qaybta barashada ee ugu adag in la iska yeelyeelo.\n\nMar kasta oo aad diyaar tahay, [[tutorshort]] halkan buu joogaa.\n\n— {\$a->institution}";
$string['milestone:completion_subject'] = 'Waad dhammaysay {$a->coursename}';
$string['milestone:completion_body_text'] = "Salaan {\$a->firstname},\n\nWaad dhammaysay {\$a->coursename}. Taasi waa guul dhab ah oo aad gaartay.\n\nHaddii aad rabto inaad sii wadato, [[tutorshort]] wuxuu kaa caawin karaa inaad doorato koorso kale oo la xiriirta ama aad dib ugu noqoto mowduuc kuu muuqday mid xiiso leh.\n\n— {\$a->institution}";
$string['milestone:trigger_streak7'] = 'Waxaa la gaaray 7 maalmood oo firfircooni isku xigta';
$string['milestone:trigger_streak30'] = 'Waxaa la gaaray 30 maalmood oo firfircooni isku xigta';
$string['milestone:trigger_completion'] = 'Dhammaystirka koorsada waa la diiwaangeliyay';
...
$string['pedagogy:crossmastery_desc'] = 'Markii la hawlgeliyo, [[tutorshort]] waxay aqoonsanaysaa marka uu ardaygu hore u qaatay yool koorso kale (oo lagu kala saaray tixraaca kartida ama cinwaanka) waxayna qiraysaa kartidaas hore ee la helay halkii dib loogu celin lahaa. Waxay u baahan tahay raadraaca aqoonta; koorsooyinka aan lahayn yoolal si nabad ah ayay dib ugu noqonayaan. Talo keliya ayay tahay — marnaba ma beddesho dhibcaha aqoonta ee ardayga ee la keydiyay koorso kasta.';
...
$string['objectives:rebuild_links_help'] = '[[tutorshort]] waxay isku xirtaa yoolasha isku mid ah koorsooyinka dhexdooda (iyadoo loo eegayo tixraaca kartida ama cinwaanka) si ardayga horeba mawduuc meel kale ugu bartay aan dib loogu celin. Xiriirinta waxay dib isu dhisaysaa si toos ah habeen kasta; isticmaal badhankan si aad hadda dib u dhisto kadib markaad wax ka beddesho yoolasha.';
...
$string['pedagogy:learning_path_desc'] = 'Marka la shido, [[tutorshort]] waxay ku dartaa muraayad muuqaal ah oo dariiqa waxbarashada (badhan "dariiqayga" oo ku yaal madaxa widget-ka) oo muujinaya barnaamijka ardayga sida isku xigxiga koorsooyin, mid kasta oo la kala bixin karo si loo arko ujeeddooyinkiisa iyo heerka aqoonta ardayga. Marka ardaygu gaaro xadka koorsada hadda (dhammaystirka ama qayb sare oo ujeeddooyin la xaqiijiyay), [[tutorshort]] waxay sidoo kale muujinaysaa boorar khafiif ah "diyaar u ah koorsada xigta" oo ay ku xuso sheekada. Talo kaliya; waxay isticmaashaa qoondada barnaamijka ardayga; si aamusan waxba ma qabato meesha aanu barnaamij khusayn.';
...
$string['settings:backend_context_tokens'] = 'Daaqadda macnaha guud ee backend-ka (tokens)';
$string['settings:backend_context_tokens_desc'] = 'Dhererka ugu badan ee macnaha guud (max_model_len) ee backend-kaaga AI, oo lagu cabbiro tokens. U dejii 0 moodooyinka la martigeliyay ee leh daaqad ballaaran (wax xaddidaad ah ma jiraan). Marka loo dejiyo wax ka badan 0 (tusaale ahaan 8192 backend vLLM oo is-martigeliya), [[tutorshort]] waxay yaraysaa miisaaniyadda xarfaha ee prompt-ka nidaamka ee kor ku xusan si prompt-ka iyo wax-soosaarka la kaydiyay iyo taariikhda wadahadalka ay daaqadda ugu dhex galaan, xitaa luqadaha tokens-ku ku badan yihiin. Eeg bogga wiki ee Deployment Sizing si aad u ogaato sida tani ugu eg tahay isticmaalayaasha isku mar jira.';
$string['settings:backend_retry_attempts'] = 'Isku-dayada dib-u-isku-dayga backend-ka';
$string['settings:backend_retry_attempts_desc'] = 'Imisa jeer ayaa dib loo isku dayaa qalad ku-meel-gaar ah oo backend (HTTP 429 ama 503) ka hor inta aan ardayga la tusin qalad. Dib-u-isku-dayadu waxay dhacaan kaliya ka hor inta aan qoraal jawaab ah la soo dirin, sidaas darteed wax-soosaarka marnaba lama labanlaabo. Waxaa loogu talagalay backend-yo yaryar oo is-martigeliya oo diida codsiyada xilliga culayska. U dejii 0 si aad u demineyso. Caadi ahaan 2.';
$string['settings:backend_retry_max_wait'] = 'Sugitaanka ugu badan ee dib-u-isku-dayga backend-ka (ilbiriqsiyo)';
$string['settings:backend_retry_max_wait_desc'] = 'Xadka sare, oo lagu cabbiro ilbiriqsiyo, ee inta loo ixtiraamayo madax-furaha Retry-After ee ka yimaada backend-ka ka hor dib-u-isku-dayga. Marka backend-ku uusan dirin Retry-After, [[tutorshort]] waxay halkii isticmaashaa dib-u-dhac jibbaaran oo gaaban. Caadi ahaan 5.';
$string['prompt:truncation_hint'] = 'FIIRO GAAR AH: Macnaha buuxa ee koorsada lama raadin karin wareeggan sababtoo ah xaddidaadaha dhererka. Haddii ardaygu wax weydiiyo oo aadan ka heli karin macnaha la bixiyay, dheh inaadan raadin karin koorsada oo dhan oo ku tali inuu furo bogga ama dhaqdhaqaaqa gaarka ah ee mawduuca lagu daboolay, halkii aad ka sheegi lahayd inuu koorsada ka maqan yahay.';
$string['selftest:title'] = 'Is-tijaabinta backend-ka';
$string['selftest:intro'] = 'Ku socodsii hubin toos ah oo backend-kaaga AI ee la habeeyay: isweydaarsi yar oo fariimo wadahadal ah, ogaansho otomaatig ah oo daaqadda macnaha guud (max_model_len) iyo isbarbardhig dejintaada daaqadda macnaha guud ee backend-ka, sagxadda hoose ee miisaaniyadda prompt-ka nidaamka, iyo (marka RAG la shido) isweydaarsi embedding ah. Wicitaannada shabakadda waxay socdaan oo kaliya marka aad riixdo Socodsii.';
$string['selftest:run'] = 'Socodsii is-tijaabinta backend-ka';
$string['selftest:check'] = 'Hubin';
$string['selftest:status'] = 'Xaalad';
$string['selftest:detail'] = 'Faahfaahin';
$string['selftest:link'] = 'Bogga is-tijaabinta backend-ka';
$string['selftest:link_desc'] = 'Fur bogga <a href="{$a}">Is-tijaabinta backend-ka</a> si aad u xaqiijiso in backend-kaaga AI uu shaqeynayo oo si sax ah loo cabbiray. Waxaa faa\'iido leh wax yar ka dib markaad habeyso backend is-martigeliya.';
$string['profile:title'] = 'Dejintada hore ee geynta';
$string['profile:intro'] = 'Ku dabaq xirmo dejinta la talinayo oo nooca geyntaada ah. Qiyamka waxaa lagu qoraa dejinta caadiga ah ee plugin-ka waxayna shakhsi ahaan wax laga beddeli karaa ka dib. Ku dabaqida dejinta hore ayaa cusbooneysiisa dejinta liiska ku jirta.';
$string['profile:current'] = 'Dejinta hore ee ugu dambeysay la dabaqay: {$a}';
$string['profile:setting'] = 'Dejin';
$string['profile:value'] = 'Qiime';
$string['profile:self_hosted_small'] = 'Macno yar oo is-martigeliya (GPU keliya, tusaale A30 24GB / vLLM oo 8K ah)';
$string['profile:hosted_large'] = 'Macno weyn oo la martigeliyay (caadi)';
$string['profile:apply_self_hosted_small'] = 'Ku dabaq dejinta hore ee macnaha yar ee is-martigeliya';
$string['profile:apply_hosted_large'] = 'Ku dabaq qiyamka caadiga ah ee macnaha weyn ee la martigeliyay';
$string['profile:applied'] = 'Waxaa la dabaqay dejinta hore ee {$a}. Qiyamku hadda waxay ku jiraan dejinta plugin-kaaga.';
$string['profile:unknown'] = 'Dejin geyn oo aan la garanayn.';
$string['profile:link'] = 'Bogga dejintada hore ee geynta';
$string['profile:link_desc'] = 'Fur bogga <a href="{$a}">Dejintada hore ee geynta</a> si aad ugu dabaqdo xirmo dejinta la talinayo ee backend la martigeliyay ama is-martigeliya.';
$string['coursesettings:apibaseurl_rejected'] = 'Ciwaanka URL-ka aasaasiga ah ee API lama kaydin: waa inuu noqdaa dhamaad HTTPS oo dadweyne ah oo gudba hubinta amniga SSRF.';
$string['settings:escalation_intent_patterns'] = 'Qaabab ujeeddada kor u qaadista';
$string['settings:escalation_intent_patterns_desc'] = 'PCRE, no delimiters. Hal tibaax caadi ah sadar kasta; sadarrada ku bilaabma # waa la iska indhatiraa. Tikidhka taageerada waxaa la furaa oo keliya marka fariinta ardayga qudhiisu ay la mid noqoto mid ka mid ah kuwan, si aanay waxa koorsadu ka kooban tahay u kicin karin kor u qaadis magaca ardayga. Ka tag madhan si aad u isticmaasho qiyamka caadiga ah ee ku dhex jira, kuwaas oo daboolaya Ingiriisi iyo weedho caan ah oo Isbaanish, Faransiis, Jarmal iyo Boortaqiis ah. Goobaha ardaydoodu ku qoraan luqad kale waa inay halkan ku daraan qaabab: fariin aan is waafaqin macnaheedu waa in aan tikidh la furin.';
$string['settings:zendesk_require_consent'] = 'U baahan ogolaansho ka hor kor-u-qaadista taageerada';
$string['settings:zendesk_require_consent_desc'] = 'Marka la shido (la talinayo), [[tutorshort]] waxay wadahadalka u gudbisaa miiska taageerada Zendesk kaliya ka dib markuu bartaha aqbalo ogeysiiska ogolaanshaha ee marka hore, kaas oo sheegaya in codsiga caawimaad bini\'aadam ah uu la wadaago wadahadalka (oo ay ku jiraan magaca iyo emailka) taageerada. Tan kaliya dami haddii aad ogolaanshahaas hesho si kale; markay damay, kor-u-qaadistu si degdeg ah ayey u dirayaan. Saameyn ma laha ilaa kor-u-qaadista Zendesk la shido.';
$string['chat:escalation_needs_consent'] = 'Waxay u egtahay in tani u baahan tahay xubin ka tirsan kooxda taageeradeena. Si aan ugu gudbiyo iyaga, waan u baahnaan lahaa inaan la wadaago wadahadalkan, oo ay ku jiraan magacaaga iyo emailkaaga, miiska taageerada. Weli kuma aadan ogolaan taas, sidaas darteed waxba ma aanan dirin. Haddii aad rabto caawimaad bini\'aadam ah, fadlan aqbal ogeysiiska wadaagista xogta ee kaaliyahan oo mar kale weydii, ama si toos ah ula xiriir taageerada.';
$string['privacy:metadata:email_optout'] = 'Doorbidyada ka-baxitaanka email ee qof-qof ah (noocyada email ee qaataagu ka iska diiwaan-gashan yahay).';
...
$string['settings:rag_min_similarity'] = 'Khusuusnaanta ugu yar (cosine)';
$string['settings:rag_min_similarity_desc'] = 'Tuur qaybaha la soo helay kuwaas oo isu-ekaanshahooda cosine ee su\'aasha ka hooseeya qiimahan, si su\'aal mawduuca ka baxsan ama macluumaad yar leh ay u gasho qaybo yar (ama eber) halkii ay had iyo jeer ku buuxin lahayd Top-K isu-dhig daciif ah. Xadka 0 ilaa 1; 0 wuxuu damiyaa albaabka. Qiimaha saxda ah wuxuu ku xiran yahay moodelka embedding: 0.25 wuxuu u habboon yahay text-embedding-3-small. Kor u qaad si aad u adkayso (macluumaad ka yar, oo mawduuca ku saabsan), hoos u dhig si aad u fudaydiso.';
$string['settings:rag_currentpage_boost'] = 'Kor u qaadista bogga hadda';
$string['settings:rag_currentpage_boost_desc'] = 'Abaalmarin yar oo lagu daro dhibcaha khusuusnaanta ee qaybaha bogga uu ardaygu hadda eegayo, si su\'aalaha sida "sharax tan" ay u door biyaan bogga muuqda marka dhibcuhu isu dhowyihiin. Kala-soocid oo keliya: kuma qasbo qayb bog oo aan khusayn inay gudubto albaabka khusuusnaanta ugu yar. U dhig 0 si aad u demineyso.';
$string['settings:history_mode'] = 'Habka xulashada taariikhda';
$string['settings:history_mode_desc'] = 'Sida loo doorto wareegyadii hore ee wadahadalka ka hor inta aan loo dirin moodelka. <strong>Macnaha</strong> wuxuu kaliya hayaa wareegyada dhawaan ee khuseeya su\'aasha hadda (iyo had iyo jeer is-weydaarsiga ugu dambeeyay), si wareeg hore oo duugoobay oo mawduuca ka baxsan uusan u kordhin kharashka ama uusan jawaabta jidka ka leexin; wuxuu sameeyaa hal wicitaan embedding oo dheeraad ah fariin kasta. <strong>Dhawaanta</strong> wuxuu hayaa lammaanaha ugu dambeeyay ee "Max Conversation History" iyada oo aan loo eegin khusuusnaanta (hab-dhaqankii muddada dheer, wicitaan dheeraad ah ma jiro). Haddii embedding aan la heli karin, habka macnaha wuxuu si toos ah ugu noqdaa habka dhawaanta.';
$string['settings:history_mode_semantic'] = 'Macnaha (wareegyada dhawaan ee khuseeya)';
$string['settings:history_mode_recency'] = 'Dhawaanta (N lammaanaha ugu dambeeyay)';
$string['settings:history_semantic_minscore'] = 'Heerka ugu hooseeya ee khusuusnaanta taariikhda (cosine)';
$string['settings:history_semantic_minscore_desc'] = 'Habka taariikhda macnaha, wareeg hore waxaa la hayaa kaliya haddii isu-ekaanshahiisa su\'aasha hadda uu ugu yaraan yahay qiimahan (is-weydaarsiga ugu dambeeyay had iyo jeer waa la hayaa). Xadka 0 ilaa 1; wuxuu ku xiran yahay moodelka. Kor u qaad si aad u adkayso (taariikh ka yar), hoos u dhig si aad u haysato wax badan.';
$string['settings:history_candidates'] = 'Daaqada musharraxiinta taariikhda';
$string['settings:history_candidates_desc'] = 'Habka taariikhda macnaha, kaliya tiradan lammaanaha ugu dambeeyay ayaa loo qiimeeyaa khusuusnaanta (xad kharash). Lammaanaha ka da\' weyn daaqaddan lama diro. Qiimahan ku hay ama ka sarreeya "Max Conversation History".';

// v5.11.0 - v6.2.0 strings (added 2026-06-10).
$string['settings:embed_provider_voyage'] = 'Voyage AI (voyage-3.5 — la talinayo; +4 MTEB vs OpenAI 3-small, 4x macnaha guud, xog-badan)';
$string['settings:rerank_heading'] = 'RAG: Soo-saarista labo-marxalad (re-ranking)';
$string['settings:rerank_heading_desc'] = 'Marxalad labaad oo ikhtiyaari ah oo soo-saarista: cosine similarity wuxuu dooranayaa top-N fragments-candidate (caadi ahaan 50), ka dibna cross-encoder re-ranker ayaa qiimeynaya cada (weydiin, fragment), kuwa ugu wanaagsan top-K waxay galeen prompt-ka. Sidaas ayuu u damayaa caadiga; haddii re-ranker aan la habeyn ama uu fashilmo, wuxuu u soo laabaa soo-saarista cosine ee hal-marxalad.';
$string['settings:rerank_enabled'] = 'Soo-saarista labo-marxalad (Voyage rerank-2.5)';
$string['settings:rerank_enabled_desc'] = 'Marka la shido, soo-saarista RAG waxay noqotaa labo-marxalad: cosine similarity waxay soo celisaa top-N candidates (caadi ahaan 50), ka dibna cross-encoder Voyage rerank-2.5 wuxuu qiimeynayaa cada mid waxayna top-K galeen prompt-ka. Horumarinno la daabacay: +15 Recall@10 enterprise, +39% NDCG BEIR. Xisaabinta ~$0.05/MTok. Waxay u baahan tahay <code>rerank_apikey</code> hoos; haddii rerank fashilmo ama aan la habeyn, si naxariis leh ayuu u soo laabaa cosine hal-marxalad.';
$string['settings:rerank_apikey'] = 'Furaha API ee re-ranker';
$string['settings:rerank_apikey_desc'] = 'Furaha API Voyage AI ee rerank-2.5. Ka tag madhan si aad mar kale ugu isticmaasho Furaha API Embedding ee sare (deployment-yada caadiga ah ee Voyage waxay wadaagaan hal fure embed + rerank).';
$string['settings:rerank_model'] = 'Modheel re-ranker';
$string['settings:rerank_model_desc'] = 'Caadiga ahaan <code>rerank-2.5</code>. Modheel-yada cusub ee Voyage rerank waa la qeexan karaa halkan.';
...
$string['settings:stt_selfhosted_url_desc'] = 'URL-ka aasaasiga ah ee server-ka turjumaadda ee la mid ah OpenAI, tusaale <code>http://10.0.0.5:8000</code>. [[tutorshort]] waxay si otomaatig ah u ku daraysaa <code>/v1/audio/transcriptions</code>; wadada dhamaystiran ee endpoint waa la aqbalaa sidoo kale. Ka tag madhan si aad u dami STT-da is-martigeliya.';
$string['settings:stt_selfhosted_model'] = 'Modheel-ka STT ee is-martigeliya';
$string['settings:stt_selfhosted_model_desc'] = 'Magaca modheel-ka ee server-ka loo diro, oo la mid ah modheel-ka Whisper ee la soo rarayo — tusaale <code>Systran/faster-whisper-small</code> speaches ama <code>large-v3</code>. Ka tag madhan si aad u dirtid <code>whisper-1</code>, kaas oo server-yada is-martigeliya badankood ay aqbalaan ama ka hor joogaan.';
$string['settings:stt_selfhosted_apikey'] = 'Furaha API ee STT-da is-martigeliya';
$string['settings:stt_selfhosted_apikey_desc'] = 'Ikhtiyaari. Server-yada is-martigeliya badankood ma u baahna fure shabakad la aaminsan yahay; kan dejiyow kaliya haddii server-kaagu u baahan yahay token bearer.';
$string['emergency:title'] = 'Xukumaadka Xaalada Degdeg ah ee [[tutorshort]]';
$string['emergency:page_warning'] = 'Beddelayaashaasi waxay si degdeg ah u shaqeeyaan ardayda oo dhan ee goobta. Ficil kasta wuxuu qoraa safka xiisaynta. Beddelayaasha faahfaahsan waxay kaga tagaan [[tutorshort]] inteeda kale shaqeynaysa; dillaaca master-ka oo dhan wuxuu wijidhka si buuxda ka saara.';
$string['emergency:back_to_settings'] = 'Dejimaha [[tutorshort]]';
$string['emergency:state_disabled'] = 'DAMAY';
$string['emergency:state_active'] = 'Firfircoon';
$string['emergency:confirm_label'] = 'Waan garanayaa in tani si degdeg ah u saameynayso ardayda oo dhan';
$string['emergency:confirm_required'] = 'Calaamadee sanduuqa xaqiijinta ka hor inta aadan damin nidaamka hoosaadka.';
$string['emergency:reason_placeholder'] = 'Sabab (lagu diiwaan galiyay diiwaanka xiisaynta)';
$string['emergency:disable_button'] = 'Dami';
$string['emergency:restore_button'] = 'Soo celi';
$string['emergency:disabled_notice'] = 'Nidaamka hoosaadka "{$a->flag}" waa la damiyay. Dejimaha la taabay: {$a->touched}';
...
$string['emergency:flag_rag_desc'] = 'Damisaa soo-saarista iyo tusaha. Wadahadallka wuu sii wadaa iyada oo aan ku miilayn macnaha guud ee koorsada.';
$string['emergency:flag_outreach'] = 'Gaadhsiinta';
$string['emergency:flag_outreach_desc'] = 'Joojisaa emailyada digest, munaasabadda, iyo xusuus-gareenta. Wadahadallka ma saameeyaan.';
$string['emergency:flag_all'] = 'KILL-KA MASTER';
$string['emergency:flag_all_desc'] = 'Damisaa plugin-ka oo dhan: wijidhku waxa uu ka baxayaa bog kasta, hawlaha nidaamsan waa la joojiyaa, cod waa la nadiifiyay, RAG damay, gaadhsiinta damay. Baddelaha ugu xoogga badan — u isticmaal dhacdada amniga ama marka [[tutorshort]] si degdeg ah looga baahnaan yahay in la xiro.';
$string['emergency:settings_link'] = 'Xukumaadka xaalada degdeg ah';
$string['emergency:settings_link_desc'] = 'Beddelayaasha kill per-nidaamka hoosaadka (wadahadal / cod / RAG / gaadhsiinta / master) oo leh diiwaanka xiisaynta — qeybta websaydhka ee <code>admin/cli/emergency_disable.php</code>. Fur <a href="{$a}">Xukumaadka Xaalada Degdeg ah ee [[tutorshort]]</a>.';
$string['email_unsubscribe:done_title'] = 'Waa la ka baxay';
$string['email_unsubscribe:done_body'] = 'Dhameystiray — {$a->email} mar dambe waxba kama heli doonto noocaas ah ee emailka {$a->product}. Haddii aad fikradaada beddesho, codsiga maamulaha {$a->product} si uu mar kale u shido wadaagga, ama email cusub ka dir bogga [[tutorshort]] Recipients ee maaraynta.';
$string['email_unsubscribe:invalid_title'] = 'Xiriirka ka-baxitaanka ma shaqeynayso';
$string['email_unsubscribe:invalid_body'] = 'Xiriirkan ka-baxitaanka waa la dhacay ama si khaldan ayuu u sameysan yahay. Raadiiso email naga cusub ah, ama la xiriir maamulaha goobta si gacanta loogu saaro.';
$string['settings:prompt_proportions_heading'] = 'Qeybaha prompt-ka heerarka (v5.6.0)';
$string['settings:prompt_proportions_heading_desc'] = 'U qaybi miisaaniyada prompt-ka nidaamka afar qaybood: ammaanka + aqoonsiga, qaab-dhismeedka koorsada, macnaha guud ee koorsada, iyo bogga hadda jira. Miisaaniyada waa boqolkiibyo wadajira 100. Qiyamka caadiga ah ee la habeeyay si tayo leh (10 / 10 / 40 / 40) waxay ka timid benchmark-ka habaynta miisaaniyada v5.6.0; ka tagista aagga qoraalka madhan waxay isticmaashaa qiyamahaas caadiga ah. Kordhinta otomaatigga ah waxay habeeyaa qaybinta per-wareeg iyadoo ku xidnayd in bogga gaar ah uu ku jiro xaaladda.';
$string['settings:prompt_section_weights'] = 'Miisaaniyada aasaasiga ah ee qaybaha (JSON)';
$string['settings:prompt_section_weights_desc'] = 'Shay JSON oo ikhtiyaari ah oo u sawiraya qaybta kasta qiimaha boqolkiibka. Ka tag madhan si aad u isticmaasho qiyamka caadiga ee benchmark (10 / 10 / 40 / 40). Tusaale: <code>{"safety_identity": 10, "course_structure": 10, "course_content": 40, "current_page": 40}</code>. Miisaaniyadu waa inay wadajiraan 100 (±5%). <code>safety_identity</code> waxay leedahay saldhig ah 10% si uga hortagga jailbreak iyo calaamadaha qaabka bixinta ay si buuxda u soo galaan. <code>current_page + course_content</code> waa inay ahaadaan ugu yaraan 40% si modheel-ku u helo xog muhiim ah oo ku tiigsato. Qiyamka xadka ka baxsan waxay si aamusnaan ah u soo laabaan qiyamka caadiga ah ee benchmark; maamulayaasha waa inay xaqiijiyaan adoo eegaya diiwaanka debug-ka prompt-ka ka dib duubashada.';
$string['settings:prompt_context_boost_mode'] = 'Habka kordhinta macnaha guud';
$string['settings:prompt_context_boost_mode_desc'] = 'Habeynta otomaatigga ah ee u wareejisa miisaaniyada qaybta bogga hadda jira marka bog gaar ah uu ku jiro xaaladda, iyo qaybta macnaha guud ee koorsada marka aan bog la dooranin. <strong>page_focus</strong> (caadiga) waxay u wareejisaa ku dhawaad 15 dhibcood oo miisaan. <strong>aggressive</strong> waxay u wareejisaa 25 dhibcood waxayna u fiican tahay marka ardaydu si joogto ah u weydiiyan su\'aalo gaar ah oo bogg ah. <strong>off</strong> waxay damisaa kordhinta; miisaaniyada aasaasiga ah ee maamulaha-dejiyay waxay shaqeeyaan wareeg kasta iyada oo aan loo eegin macnaha guud ee bogga.';
$string['settings:prompt_context_boost_off'] = 'Damay (isticmaal miisaaniyada aasaasiga ah wareeg kasta)';
$string['settings:prompt_context_boost_page_focus'] = 'Xushmada bogga (caadiga, ~15 dhibcood oo u wareejis)';
$string['settings:prompt_context_boost_aggressive'] = 'Xooggan (~25 dhibcood oo u wareejis)';
$string['settings:prompt_section_weights_coach'] = 'Beddelka habka tababaraha (JSON, ikhtiyaari)';
$string['settings:prompt_section_weights_coach_desc'] = 'Shay JSON oo ikhtiyaari ah oo beddelaya miisaaniyada aasaasiga ah ee qaybaha si gaar ah inta lagu jiro habka tababaraha kubbadda qiimaynta (<code>quizmode=coach</code>). Waxaa waxtar leh si xoog looga sameeyo qaybin weyn oo <code>current_page</code> ah inta lagu jiro kubbadaha iyada oo aan saameynin wadahadallka caadiga ah. Ka tag madhan si loo dhaxlo miisaaniyada aasaasiga ah. Xeerarka xaqiijinta isku mid ah sida dejimaha aasaasiga ah.';
$string['prompt_debug_view:title'] = 'Daawadaha diiwaanka debug-ka prompt-ka';
$string['prompt_debug_view:subtitle'] = 'Prompt-ka nidaamka ee la isku keenay per-wareeg + kala-saarista per-qaybeed + taariikhda wadahadallka + fariinta hadda jira ee isticmaalaha + metadata-da lifaaqa, si sax ah sida modheel-ku u helay. Tan isticmaal si aad u xaqiijiso in qaybta sida Macnaha Bogga Hadda Jira ay soo gashay prompt-ka iyo si loo sameeyo debug-ka arrimaha tayada jawaabaadda iyada oo aan SSH-ga serverka loo marin.';
$string['prompt_debug_view:disabled'] = 'Diiwaangelinta debug-ka prompt-ka hadda waa DAMAY. Ma laga qori doono wax cusub ilaa la shido.';
$string['prompt_debug_view:enable_link'] = 'Fur dejimaha plugin-ka si aad u shidid "Ku qor prompt-ka nidaamka la isku keenay faylka".';
$string['prompt_debug_view:no_log_yet'] = 'Faylka diiwaanka ma jiro weli. Dir ugu yaraan hal wareeg oo wadahadal ah ka dib markad shidid diiwaanka debug-ka; faylka waxaa la abuuray markii ugu horeysa la qoro.';
$string['prompt_debug_view:empty'] = 'Faylka diiwaanka wuu jiraa laakiin waa madhan yahay. Dir wareeg wadahadal ah oo cusboonsii.';
$string['prompt_debug_view:file_status'] = 'Cabbirka faylka diiwaanka';
$string['prompt_debug_view:showing'] = 'Waxaa la muujinayaa gelitaannada ugu dambeeyay (cusub ayaa horreeya), xad';
$string['prompt_debug_view:total'] = 'Wadarta prompt-ka';
$string['prompt_debug_view:budget'] = 'Miisaaniyada qabashadda';
$string['prompt_debug_view:sections'] = 'Qaybaha (qaybaha kategori)';
$string['prompt_debug_view:assembled_prompt'] = 'Prompt-ka nidaamka la isku keenay';
$string['prompt_debug_view:history'] = 'Taariikhda wadahadallka ee modheel-ka loo diray';
$string['prompt_debug_view:current_message'] = 'Fariinta hadda jira ee isticmaalaha';
$string['prompt_debug_view:attachment'] = 'Metadata-da lifaaqa';
$string['prompt_debug_view:show_more'] = 'Muuji gelitaanno badan';
$string['settings:mastery_classifier_provider'] = 'Bixiyaha kala-saaraha';
$string['settings:mastery_classifier_provider_desc'] = 'ID bixiyaha ee loo isticmaalay kala-saaraha heerka per-wareeg. Ka tag madhan si loo dhaxlo bixiyaha AI caadiga ah. <code>openai</code> caadiga ah ee la geysanaya modheel-ka kala-saaraha <code>gpt-4o-mini</code> hoos — doorashada ugu jaban ee TIER 1 ee kala-saarista leh bixinta qaab-dhisan (~$220/bil. badbaadinno 100k MAU vs heerka wadahadallka). Marka la dejiyay, safka Bixiyaha Isbarbardhigga ee leh ID bixiyaha kan wuxuu bixiyaa furaha API, URL-ka aasaasiga ah, iyo heerka kul.';
$string['settings:premium_escalation_heading'] = 'Heerka kor-u-qaadista premium-ka (A.10)';
$string['settings:premium_escalation_heading_desc'] = 'Waddooxidda ikhtiyaari ah per-wareeg ee modheel premium ah (Claude Opus 4.8 caadiga ah) ee prompt-yada ay heerka wadahadallka shaqada ah si cad ula dagaallanto — sida xisaabta labo-marxalad, CS, iyo sababaynta sayniska. Waxaa xaliyay bake-off A.10 2026-06-09: Opus 4.8 wuu ku guulaystay 14.97/15 vs 12.68/15 ee gpt-4o prompt-yada adag. Labada waddo oo kicin: regex matches fariinta isticmaalaha, ama liis-la-oggolaansho koorsada oo kobcisa wareeg kasta. Caadiga ah waa damay. ~5% kor-u-qaadis, raac ~$700/bil. 100k [[unishort]] MAU kharashka wadahadallka aasaasiga ah ka sarreeya.';
$string['settings:premium_escalation_enabled'] = 'Shid waddooxidda kor-u-qaadista premium-ka';
$string['settings:premium_escalation_enabled_desc'] = 'Marka la shido, waddooxidda per-wareeg waxay hubisaa liiska regex ee kiciyeyaasha iyo liiska la-oggolaansho ee koorsada wareeg kasta oo wadahadal ah; wareegyadda u dhigma waxaa loogu waddooxiyay bixiyaha premium-ka. Waxay u soo laabataa bixiyaha shaqada ah haddii safka premium-ku maqan yahay ama uu ku guuldareysanayo inuu ka dhigto tusaale. Beddelayaasha xulashada LLM ee maamulaha had iyo jeer waxay ku guulaysataan iyada oo aan loo eegin.';
$string['settings:premium_escalation_provider'] = 'Bixiyaha premium-ka';
$string['settings:premium_escalation_provider_desc'] = 'ID bixiyaha ee loo maro wicitaannada premium-ka. Waa inuu la mid yahay saf ka mid ah Bixiyeyaasha Isbarbardhigga (si furaha API, URL-ka aasaasiga ah, iyo heerka kul ay ka yimaadaan isla mesha maamulayaasha horay u maareeyaan). Caadiga <code>claude</code>.';
$string['settings:premium_escalation_model'] = 'Modheel-ka premium-ka';
$string['settings:premium_escalation_model_desc'] = 'Magaca modheel-ka ee bixiyaha premium-ka loo diro. Caadiga <code>claude-sonnet-5</code> siday u qabatay bake-off A.10.';
$string['settings:premium_escalation_triggers'] = 'Regex-yada kiciyeyaasha premium-ka';
$string['settings:premium_escalation_triggers_desc'] = 'Hal regex PCRE ah sadar kasta (iyada oo aan xaddidaadaha lahayn; waafaqidda xasaasiyadda xarfaha weyn ee hoose waa si otomaatig ah loo adeegsadaa). Sadraha ku bilaabma # waa faallooyin. Ka tag madhan si aad u isticmaasho xulashada caadiga ah ee taxan ee bake-off A.10 (calaamadaha STEM ee labo-marxalad: "derive", "prove that", "step by step", xisaabta LaTeX, xidhmooyinka koodka, big-O, integrals, optimization, iwm.).';
$string['settings:premium_escalation_course_tags'] = 'Liiska la-oggolaansho ee koorsada premium-ka';
$string['settings:premium_escalation_course_tags_desc'] = 'Hal prefix magaca gaaban ee koorsada ama idnumber sadar kasta. Wareeg kasta ee koorsada u dhigma si otomaatig ah ayaa lagu kobciyaa iyada oo aan loo eegin regex fariinta (u isticmaal koorsadaha STEM-da badan meeshay kor-u-qaadisu ahaanayso mid caadi ah). Waafaqidda waa prefix aan xasaasiyadda lahayn — "MATH" waxay u dhigantaa MATH121, MATH205, iwm.';
$string['settings:spend_cap_per_course_default'] = 'Xadka kharashka caadiga ah ee koorso kasta (USD)';
$string['settings:spend_cap_per_course_default_desc'] = 'Xad difaac ah oo loo adeegsado koorsada oo dhan aan lahayn xaadoodkeeda kharashka per-koorso ah. U dejiyay tusaale <code>30</code> si aad u xaddidid kharashka bishii ee koorsada oo kasta $30 iyada oo aan loo habeyn koorsooyin gaar ah. <code>0</code> = xad caadi ah ma jiro (xaddida guud ee goobta iyo beddelyada per-koorso-ah ayaa kaliya shaqeeya). Marka koorsadu dhaafto 80% / 95% / 100% xadkan, pipeline-ka ogeysiiska spend-guard ee jira wuxuu u diri doonaa ogeysiiska maamulaha (liiska qaabilaha: <code>spend_notify_emails</code>, oo ku habboon maamulayaasha goobta). Koorsada gaar ah had iyo jeer waxay kordhin kartaa saqafkeedii adoo dejinaya beddelka per-koorso ee sare.';
$string['settings:cost_anomaly_heading'] = 'Ogaanshaha khaladaadka kharashka (v6.0)';
$string['settings:cost_anomaly_heading_desc'] = 'Hawsha nidaamsan ee maalinlaha ah (<code>cost_anomaly_check</code>) ee barbar dhigaysa kharashyada goobta oo dhan ee [[tutorshort]] ee maanta medianna socota ee 7 maalmood. Waxay u diraysaa email liiska qaabilaha <code>spend_notify_emails</code> (oo ku habboon maamulayaasha goobta) marka maanta dhaafto dhaliisha la habeeyay × mediana. Waxay ogaataa saddex habab oo fashilmo ah oo tirada xadka kharashka 80% / 95% / 100% ee jira ka maqan: (1) koorsad la waayay meesha oo xadka mutlaqka ah aan la dhaafin laakiin koorsad keliya si kedis ah u abuurta 10x xajmigii caadiga ahaa, (2) shidista ikhtiyaariyada ee heerka premium-ka, (3) waddooxidda khaldan ee bixiyaha. Caadiga ah waa damay; u dhiganta gudaha [[tutorshort]] ee su\'aalaha Redash <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
$string['settings:cost_anomaly_enabled'] = 'Shid ogaanshaha khaladaadka kharashka';
$string['settings:cost_anomaly_enabled_desc'] = 'Marka la shido, hawsha nidaamsan ee maalinlaha ah waxay qiimeysaa kharashyada maanta marka loo eego medianna socota ee 7 maalmood waxayna u diraysaa email maamulayaasha kala duwanaanshaha. 7-tii maalmood ee ugu horreysa ka dib shidista waxay soo saartaa xaalad <code>insufficient_history</code> (asaas taariikheed weli ma jirto) waxayna marna ma saarin ogeysiis. Idempotent maalin kasta: calaamad ku jirta <code>config_plugins</code> waxay joojisaa emailyada celcelin ah haddii cron mar badan uu socodsiiyo.';
$string['settings:cost_anomaly_multiplier'] = 'Dhaliisha khaladaadka';
$string['settings:cost_anomaly_multiplier_desc'] = 'Kharashyada maanta waa inay dhaafaan dhaliishahan × mediana 7-maalmoodka si ogeysiis loogu kicin. Caadiga <code>2.0</code>. Hoos u dhig <code>1.5</code> digniinadii hore (khaladaadka been-abuurka badan inta lagu jiro kululeynta qorista). Sare u qaad <code>3.0</code> haddii isticmaalka [[unishort]] uu si ku filan u xoogaan yahay in 2x-ka duffanka ay caadi yihiin.';
$string['task:cost_anomaly_check'] = 'Hubinta maalinlaha ah ee khaladaadka kharashka [[tutorshort]]';
...
$string['task:policy_bundle_sync'] = '[[tutorshort]] isku-dubbaridka xidhmada siyaasadda saxiixan';
...
$string['analytics:exp_heading'] = 'Barbardhigga tijaabada A/B';
$string['analytics:exp_desc'] = 'Barbardhig kaqeybgalka labada koors ee mudada la doortay. Waxaa loogu talagalay tijaabada koorska mid kasta (tusaale ahaan baaritaanka dhaqdhaqaaqa avatar-ka): ku dhig beddelka hal koors, ka tag midda kale inay noqoto xukumaha, oo akhri farqiga halkan.';
$string['analytics:exp_course_a'] = 'Koorska A';
$string['analytics:exp_course_b'] = 'Koorska B';
$string['analytics:exp_compare'] = 'Barbardhig';
$string['analytics:exp_metric'] = 'Cabbirka';
$string['analytics:exp_delta'] = 'B vs A';
$string['analytics:exp_enrolled'] = 'Ardayda is-diiwaagelisay';
$string['analytics:exp_active_users'] = 'Isticmaalayaasha [[tutorshort]] ee firfircoon';
$string['analytics:exp_usage_rate'] = 'Heerka isticmaalka (%)';
$string['analytics:exp_sessions'] = 'Fadhiyada';
$string['analytics:exp_messages'] = 'Fariimaha';
$string['analytics:exp_avg_msgs_session'] = 'Fariimaha celceliska ah ee fadhigii';
$string['analytics:exp_avg_session_minutes'] = 'Dhererka celceliska ee fadhiga (daqiiqo)';
...
$string['privacy:metadata:local_ai_course_assistant_practice_scores:session_meta'] = 'Macluumaad-dheeraad ah oo ikhtiyaari ah oo aad u bixisay fadhiga, sida magaca, mawduuca, iyo dhererka bartilmaameedka ah ee khudbad Soapbox. Waligeed kuma jirto cod ama qoraal-rogan.';
$string['pedagogy:soapbox'] = 'Jawaab-celinta khudbada Soapbox waa furan tahay si caadi ah';
$string['pedagogy:soapbox_desc'] = 'Marka la furo, qalabka tababarka khudbada Soapbox waa laga heli karaa koorso kasta haddii koorsadu aysan lahayn beddel u gaar ah. Ka dhig damin oo kaliya ka shidi koorsooyinka u baahan (badanaa koorsooyinka khudbadda iyo isgaarsiinta).';
$string['settings:soapbox_stt_mode'] = 'Habka qoraal-rogista Soapbox';
$string['settings:soapbox_stt_mode_desc'] = 'Sida Soapbox ugu beddesho khudbad la duubay qoraal. Server-ku wuxuu isticmaalaa bixiyaha Whisper ee la habeeyay (martigelinta-naftaada waa bilaash; OpenAI martigelinta lahaa wuxuu ku kacaa qiyaastii USD 0.006 daqiiqaddii). Barawsarku wuxuu isticmaalaa aqoonsiga hadalka ee ku dhex jira ardayga (bilaash, server la\'aan, kaliya wuxuu ka shaqeeyaa Chrome iyo Safari). Server ayaa lagu taliyaa si tayada qoraal-rogistu aysan ugu xidhnaan barawsarka ardayga.';
$string['settings:soapbox_stt_mode_server'] = 'Server (bixiyaha Whisper)';
$string['settings:soapbox_stt_mode_browser'] = 'Barawsar (bilaash, server la\'aan)';
$string['soapbox:title'] = 'Soapbox';
$string['soapbox:link'] = 'Tababarka khudbada Soapbox';
$string['soapbox:disabled'] = 'Soapbox looma furin koorsadan.';
$string['soapbox:intro'] = 'Jeedi khudbad oo hel tababar. Ikhtiyaar ahaan dejiso magac, mawduuc, iyo dhererka bartilmaameedka ah, ka dibna isduub adigoo hadlaya. Soapbox wuxuu qoraal-rogaa khudbaddaada, wuxuu ku qiimeeyaa qiyaas-hagaha hadalka, wuxuuna ku siiyaa talooyin gaar ah. Codkaaga iyo qoraal-rogista waligood lama keydiyo, oo kaliya dhibcahaaga iyo jawaab-celintaada.';
$string['soapbox:optional'] = 'ikhtiyaari';
$string['soapbox:name_label'] = 'Magacaab khudbaddan';
$string['soapbox:topic_label'] = 'Mawduuc';
$string['soapbox:time_label'] = 'Dhererka bartilmaameedka';
$string['soapbox:no_target'] = 'Bartilmaameed ma jiro';
$string['soapbox:record'] = 'Duub khudbad';
$string['soapbox:stop'] = 'Jooji';
$string['soapbox:recording'] = 'Waa la duubayaa. Si dabiici ah u hadal; guji jooji marka aad dhammeyso.';
$string['soapbox:transcribing'] = 'Qoraal-rogista khudbaddaada…';
$string['soapbox:scoring'] = 'Qiimaynta khudbaddaada…';
$string['soapbox:too_short'] = 'Duubistaas aad bay u gaaban tahay in la qiimeeyo. Isku day ugu yaraan jumlad ama laba oo isku day mar kale.';
$string['soapbox:mic_denied'] = 'Si aad u duubto waxaa loo baahan yahay helitaanka makarafoonka. Oggolow helitaanka makarafoonka oo isku day mar kale.';
$string['soapbox:no_browser_stt'] = 'Barawsarkani ma taageero aqoonsiga hadalka ee barawsarka dhexdiisa. Isku day Chrome ama Safari, ama weydiiso maamulkaaga inuu Soapbox u beddelo qoraal-rogista server-ka.';
...
$string['soapbox:tips_heading'] = 'Talooyin marka xigta';
$string['soapbox:col_criterion'] = 'Shuruud';
$string['soapbox:col_score'] = 'Dhibco';
$string['soapbox:col_feedback'] = 'Jawaab-celin';
$string['soapbox:history_heading'] = 'Khudbadahayga';
$string['soapbox:history_empty'] = 'Wali ma aad duubin khudbad. Mid kor ku duub si aad u bilowdo dhisidda taariikhdaada.';
$string['soapbox:untitled'] = 'Khudbad aan magac lahayn';
...
$string['cachedef_ratelimit'] = 'Xaddidaadda heerka codsiga ee isticmaalaha kasta';
$string['cachedef_uistate'] = 'Beddelka UI ee fadhi kasta (u-fiiri-sida-arday, muuji magacyada dhabta ah)';
$string['benchmark:pagetitle'] = 'Cabbiraadda bixiyaha';
$string['benchmark:intro'] = 'Waxay u dirtaa qaar go\'an oo ah amarro caadi ah bixiye kasta oo AI ah oo la habeeyay, waxay diiwaan gelisaa isticmaalka token, kharashka iyo daahitaanka, waxayna ku talisaa hal bixiye awood kasta. Wareeg kasta wuxuu sameeyaa wicitaanno API dhab ah, sidaas darteed wareeg kastaa wuxuu ku kacaa qiyaastii 5 ilaa 20 senti iyadoo ku xiran inta bixiye ee la habeeyay.';
$string['cachedef_systemprompt'] = 'Amarka nidaamka AI ee la isku dubariday (koorso kasta)';
$string['cachedef_remoteconfig'] = 'Habaynta fog ee laga soo qaatay kanaalka cusboonaysiinta';
$string['cachedef_spend'] = 'Wadarta kharashka AI ee muddo kasta oo loogu talagalay ilaaliyaha kharashka';
$string['cachedef_failover_circuit'] = 'Xaaladda jajabiye-wareegga ee ku-guuritaanka bixiyaha';
$string['settings:rag_scope'] = 'Baaxadda soo-ceshashada';
$string['settings:rag_scope_desc'] = 'Marka ardaygu daawanayo dukumeenti gaar ah (bog, buug, ama PDF), in soo-ceshashada lagu xaddido dukumeentigaas iyo in kale. <b>Dukumeenti-hore</b> waxay jawaabta ku salaysaa dukumeentiga hadda marka uu leeyahay jajab la xiriira, wuxuuna ku noqdaa koorsada oo dhan haddii kale. <b>Dukumeenti-kaliya</b> weligeed kuma noqoto: haddii dukumeentiga hadda uusan lahayn jajab la xiriira, waxba ma soo qaadato, sidaas darteed macallinku wuxuu ka jawaabaa aqoon guud halkii uu ka soo xiganlahaa boggag aan la xiriirin. <b>Koorsada-oo-dhan</b> waxay baartaa dhammaan waxa ku jira koorsada (bogga hadda weli wuxuu helayaa kor-u-qaadka kala habaynta ee sare). Dukumeenti-hore ayaa lagu talinayaa, sidaas darteed jawaab ku saabsan bogga uu ardaygu akhrinayo waxay ku salaysan tahay boggaas.';
$string['settings:rag_scope_document_first'] = 'Dukumeenti-hore (door bid dukumeentiga hadda, ku noqo koorsada)';
$string['settings:rag_scope_document_only'] = 'Dukumeenti-kaliya (ku xaddid dukumeentiga hadda)';
$string['settings:rag_scope_course'] = 'Koorsada-oo-dhan (baar dhammaan waxa ku jira koorsada)';
$string['ragadmin:no_content_documents'] = '{$a->count} dukumeenti(yo) ma soo saarin qoraal la indeksi karo lamana jajabin (badanaa waa bogag inta badan ku dhex-lammaan ama aad u gaaban): {$a->titles}. Haddii mid ka mid ah kuwan la baari karo, ku dar qoraal bogga ama qoraal-hadal, kadibna dib u indeksi.';
$string['privacy:metadata:sbx_rec'] = 'Duubista bandhigga Soapbox. Shayga warbaahinta waa la tirtiraa ka dib xilliga haynta; qoraalka waa la ilaaliyaa jawaab-celin iyo codsiyada gelitaanka.';
$string['privacy:metadata:sbx_rec:userid'] = 'Ardaygii sameeyay duubista.';
$string['privacy:metadata:sbx_rec:transcript'] = 'Qoraalka hadalka-loo-beddelay-qoraal ee duubista.';
$string['privacy:metadata:sbx_rec:duration_seconds'] = 'Dhererka duubista ee ilbiriqsi.';
$string['privacy:metadata:sbx_rec:timecreated'] = 'Markii duubista la sameeyay.';
$string['privacy:metadata:ai_provider'] = 'Si loo soo saaro jawaabaha macallimka, waxa qoraaga-ardayga ah waxaa loo diraa bixiyaha AI ee uu habeeyay maamulaha goobta ama koorsada.';
$string['privacy:metadata:ai_provider:message'] = 'Qoraalka fariinta iyo lifaaqyada uu ardaygu u diro macallinka AI.';
$string['privacy:metadata:ai_provider:coursecontext'] = 'Macnaha guud ee koorsada iyo hawsha (sida magaca koorsada iyo bogga hadda) oo lagu daray si loo sal-dhigo jawaabta.';
$string['privacy:metadata:voice_provider'] = 'Marka la isticmaalo gelinta ama soo-saarka codka, cod iyo qoraal waxaa loo diraa bixiyaha hadal-loo-beddelo-qoraal / qoraal-loo-beddelo-hadal ee la habeeyay.';
$string['privacy:metadata:voice_provider:audio'] = 'Cod la duubay oo ah ardaygii hadlaya, oo loo diray qoraal-samaynta.';
$string['privacy:metadata:voice_provider:text'] = 'Qoraal loo diray bixiyaha si loogu beddelo hadal.';
$string['privacy:metadata:zendesk'] = 'Marka kor-u-qaadista taageerada bini\'aadamka la awoodo oo ardaygu ogolaado, faahfaahintooda xiriirka iyo fariintooda waxaa loo diraa Zendesk si loo furo tigidh taageero.';
$string['privacy:metadata:zendesk:name'] = 'Magaca buuxa ee ardayga, oo loo isticmaalo in lagu aqoonsado codsadaha taageerada.';
$string['privacy:metadata:zendesk:email'] = 'Cinwaanka iimaylka ardayga, oo loo isticmaalo in laga jawaabo codsiga taageerada.';
$string['privacy:metadata:zendesk:message'] = 'Fariinta ama waxa ku jira wada-hadalka uu ardaygu doortay inuu kor u qaado.';
...
$string['analytics_js:ai_users'] = 'Isticmaalayaasha AI';
$string['analytics_js:non_users'] = 'Kuwa Aan Isticmaalin';
$string['analytics_js:thumbs_up'] = 'Suulka Kor';
$string['analytics_js:thumbs_down'] = 'Suulka Hoos';
$string['analytics_js:hallucination_flags'] = 'Calaamadaha Been-abuurka';
$string['analytics_js:avg_star_rating'] = 'Celceliska Qiimaynta Xiddigaha';
$string['analytics_js:avg_msgs_resolution'] = 'Celceliska Fariimaha ilaa Xallinta';
$string['analytics_js:survey_respondents'] = 'Ka-jawaabayaasha Sahanka';
$string['analytics_js:messages'] = 'Fariimaha';
$string['analytics_js:students'] = 'Ardayda';
$string['analytics_js:frequency'] = 'Inta-jeer';
$string['analytics_js:responses'] = 'Jawaabaha';
$string['analytics_js:error_loading'] = 'Khalad ka dhacay soo-rarista xogta';
$string['analytics_js:loading'] = 'Waa la soo raraya faahfaahinta...';
$string['analytics_js:no_course_data'] = 'Xog koorso ma jirto.';
$string['analytics_js:no_unit_data'] = 'Weli ma jirto xog cutub. Raadraaca cutubka wuu ururaa marka ardaydu isticmaalaan kaaliyaha.';
$string['analytics_js:no_keyword_data'] = 'Xog eray-fure ma jirto muddadan.';
$string['task:soapbox_cleanup'] = 'Haynta iyo nadiifinta duubista Soapbox';
$string['admin:vendor_dpa:col_provider'] = 'Bixiyaha';
$string['admin:vendor_dpa:col_optout'] = 'Ka-bixista tababarka';
$string['admin:vendor_dpa:col_dpa'] = 'DPA';
$string['admin:vendor_dpa:col_retention'] = 'Haynta';
$string['admin:vendor_dpa:col_tier'] = 'Xadka heerka';
$string['admin:vendor_dpa:col_link'] = 'Xiriir';
$string['admin:vendor_dpa:vendor_terms'] = 'Shuruudaha iibiyaha';
$string['admin:vendor_dpa:tier'] = 'Heerka {$a}';
$string['admin:vendor_dpa:too_contractual'] = 'Qandaraas (waa laga baxay)';
$string['admin:vendor_dpa:too_default_on'] = 'Waa shidan si caadi ah';
$string['admin:vendor_dpa:too_none'] = 'Ka-bixis ma jirto';
$string['admin:vendor_dpa:too_local'] = 'Maxalli ah (iibiye ma jiro)';
$string['admin:vendor_dpa:too_unknown'] = 'Weli lama dib-eegin';
$string['admin:vendor_dpa:dpa_signed'] = 'La saxeexay';
$string['admin:vendor_dpa:dpa_available'] = 'La heli karo';
$string['admin:vendor_dpa:dpa_negotiating'] = 'Waa laga wada-hadlayaa';
$string['admin:vendor_dpa:dpa_not_offered'] = 'Lama bixin';
$string['admin:vendor_dpa:dpa_not_applicable'] = 'N/A';
$string['admin:vendor_dpa:dpa_unknown'] = 'Lama garanayo';
$string['settings:soapbox_slide_vision'] = 'Jawaab-celinta naqshadda-muuqaalka ee slaydhka Soapbox';
$string['settings:soapbox_slide_vision_desc'] = 'U ogolow hal wareeg aragti ah sawirrada slaydhka la soo saaray si loogu daro qoraal gaaban oo naqshad-muuqaal ah bandhig la qiimeeyay. Waa demman si caadi ah waana feejignaan-arrimaha-gaarka: sawirro lama kaydiyo, hawl kastaana waa inuu ku biiro sanduuqiisa jawaab-celinta naqshadda-muuqaalka ee slaydhka. Kaliya bandhigyada slaydhka ee leh dek la soo geliyay ayaa saameeya.';
$string['settings:soapbox_vision_provider'] = 'Bixiyaha slaydh-aragti ee Soapbox';
$string['settings:soapbox_vision_provider_desc'] = 'Bixiyaha loo isticmaalo wareegga slaydh-aragtiga. Si caadi ah wuxuu u leeyahay openai. Waa inuu noqdaa bixiye aragti-awood leh oo lagu habeeyay furaha API (iyada oo loo marayo bixiyaha koorsada ama liiska bixiyayaasha isbarbardhigga).';
$string['settings:soapbox_vision_model'] = 'Moodelka slaydh-aragti ee Soapbox';
$string['settings:soapbox_vision_model_desc'] = 'Moodel aragti-awood leh oo loogu talagalay wareegga slaydh-aragtiga. Si caadi ah wuxuu u leeyahay gpt-4o-mini.';
$string['soapbox:slide_design_note'] = 'Naqshadda slaydhka:';
$string['soapbox:assign_manage'] = 'Hawlaha bandhigga Soapbox';
$string['soapbox:copy_link'] = 'Xiriirka ardayga';
$string['soapbox:deck_label'] = 'Slaydhyada (PDF). Soo geli dekaaga, kadibna hor u dhaqaajii slaydhyada markaad duubayso.';
$string['soapbox:slide_prev'] = 'Slaydhka hore';
$string['soapbox:slide_next'] = 'Slaydhka xiga';
$string['soapbox:play_slides'] = 'Ku ciyaar slaydhyada';
$string['soapbox:audio_ready'] = 'Cod kaliya. Makarafoonkaaga ayaa la duubi doonaa; kamaraddaada lama isticmaalayo.';
$string['soapbox:audio_recording'] = 'Cod ayaa la duubayaa...';
$string['soapbox:cap_reached'] = 'Waxaad gaartay tirada ugu badan ee duubista ee hawshan.';
$string['soapbox:storage_unconfigured'] = 'Kaydinta duubista weli lama habeynin. Fadlan la xiriir maamulahaaga.';
$string['soapbox:bad_key'] = 'Soo-gelintaas adiga kuma laha.';
$string['soapbox:slides_disabled'] = 'Slaydhyada llooma awoodin hawshan.';
$string['soapbox:upload_missing'] = 'Soo-gelinta lama helin. Fadlan mar kale isku day inaad duubto.';
$string['soapbox:mode_label'] = 'Nooca bandhigga';
$string['soapbox:mode_informative'] = 'Macluumaad-bixin (sharrax ama bar)';
$string['soapbox:mode_persuasive'] = 'Qanciye (ku qancin)';
$string['soapbox:err_provider'] = 'Adeegga qiimaynta AI lama gaari karin. Fadlan mar kale isku day daqiiqad kadib.';
$string['soapbox:err_parse'] = 'AI-gu wuxuu soo celiyay jawaab aan la filayn. Fadlan mar kale isku day.';
$string['soapbox:err_disabled'] = 'Ku-celcelinta hadalka looma awoodin koorsadan.';
$string['soapbox:err_transcribe'] = 'Duubistaada looma beddeli karin qoraal. Fadlan mar kale isku day, oo hubi in makarafoonkaagu shaqaynayo.';
$string['settings:outcomes_benchmark_default'] = 'Cabbiraadda natiijada (boqolkiiba)';
$string['settings:outcomes_benchmark_default_desc'] = 'Cabbiraadda machadku dhigay ee warbixinta natiijooyinka: ardaygu wuxuu buuxiyaa natiijo marka aqoontoodu ay tahay ama ka sarreyso boqolkiibkan. Tani waa halbeegga warbixineed (oo ka duwan xadka aqoonta ee macallinnimada). Si caadi ah waa 70.';
$string['outcomes:title'] = 'Warbixinta natiijooyinka';
$string['outcomes:intro'] = 'Natiijo koorso kasta, cabbiraadda iyo boqolkiiba ardayda la qiimeeyay ee buuxiyay ama ka gudbay. Cabbiraadda goobta waa {$a}%.';
$string['outcomes:none'] = 'Weli natiijo looma qeexin koorsadan.';
$string['outcomes:export'] = 'Soo saar CSV';
$string['outcomes:col_outcome'] = 'Natiijada';
$string['outcomes:col_benchmark'] = 'Cabbiraadda';
$string['outcomes:col_assessed'] = 'Ardayda la qiimeeyay';
$string['outcomes:col_met'] = 'Buuxiyay cabbiraadda';
...
$string['soapbox:present_audio'] = 'Bandhig maqal ah';
$string['soapbox:present_video'] = 'Bandhig muuqaal ah';
$string['soapbox:present_target'] = 'bartilmaameed {$a->min}-{$a->max} daqiiqo';
$string['soapbox:choose_topic'] = 'Dooro mowduuc';
$string['soapbox:record_short'] = 'Duub';
$string['soapbox:my_recordings'] = 'Duubitaannadayda';
$string['soapbox:no_recordings'] = 'Wali ma jiraan duubitaanno.';
$string['soapbox:col_recorded'] = 'La duubay';
$string['soapbox:col_length'] = 'Dhererka';
$string['soapbox:col_type'] = 'Nooca';
$string['soapbox:col_recording'] = 'Duubitaan';
$string['soapbox:col_kept'] = 'La kaydiyay';
$string['soapbox:col_student_link'] = 'Xiriirka ardayga';
$string['soapbox:view_download'] = 'Fiiri / soo dejiso';
$string['soapbox:expired'] = 'Waqtigii wuu dhamaaday';
$string['soapbox:retention_note'] = 'Duubitaannada waa la fiirin karaa oo la soo dejisan karaa muddo {$a} maalmood ah, ka dibna si toos ah ayaa loo tirtiraa.';
$string['soapbox:assign_title'] = 'Hawlaha Soapbox';
$string['soapbox:assign_single_title'] = 'Hawsha Soapbox';
$string['soapbox:assign_add'] = 'Ku dar hawl';
$string['soapbox:assign_none'] = 'Wali ma jiraan hawlo Soapbox ah.';
$string['soapbox:assign_deleted'] = 'Hawsha waa la tirtiray.';
$string['soapbox:assign_updated'] = 'Hawsha waa la cusboonaysiiyay.';
$string['soapbox:assign_created'] = 'Hawsha waa la abuuray.';
...
$string['radar_report:title'] = 'Warbixinta Learning Radar ee [[tutorshort]]';
$string['radar_report:print'] = 'Daabac / kaydi sida PDF';
$string['radar_report:generated'] = 'Waxaa la sameeyay {$a}';
$string['radar_report:query'] = 'Weydiin';
$string['radar_report:response'] = 'Jawaab';
$string['radar_report:privacy_note'] = 'Dhammaan xogta ardayda ee warbixintan waa la qariyay. Ha la wadaagin dadweynaha.';

$string['settings:hidden_categories'] = 'Qaybaha koorsooyinka ee qarsoon';
$string['settings:hidden_categories_desc'] = 'Liis magacyada ama ID-yada qaybaha koorsooyinka, oo lagu kala saaray comma, halkaas oo kaaliyaha aanu ka muuqan karin. Tusaale: "Horumarinta koorsada, 42". Kaaliyaha sidoo kale si toos ah waa la qariyaa marka habka wax ka beddelka la furan yahay.';
$string['settings:provider_heading'] = 'Bixiyaha AI iyo wada sheekaysiga';
$string['settings:provider_heading_desc'] = 'Habee madal AI, moodalka, iyo habdhaqanka wada sheekaysiga.';
$string['settings:claude_temperature_allow_prefixes'] = 'Moodallada Claude ee taageeraya cabbirka temperature';
$string['settings:claude_temperature_allow_prefixes_desc'] = 'Hordhac magac moodal mid ah sadar kasta. Moodallada Anthropic ee magacyadooda ku bilaabmaya mid ka mid ah kuwan wali waxay aqbalaan cabbirka muunad qaadista <code>temperature</code>. Moodal Claude kasta oo aan la mid ahayn hordhac kasta, temperature waa laga tagaa (moodallada fikirka laga bilaabo Opus 4.7 waxay ku diidaan qaladka HTTP 400). U dhaaf madhan si loo isticmaalo qiimaha caadiga ah ee la socda balaadhinta.';
$string['settings:max_tokens'] = 'Dhererka jawaabta ugu badan (tokens)';
$string['settings:max_tokens_desc'] = 'Tirada ugu badan ee tokens jawaab kasta oo AI. Qiimayaasha hooseeya waxay bixiyaan jawaabo gaagaaban oo degdeg ah. 512 = qiyaastii 2-3 weedho, 1024 = qiyaastii 1-2 baragaraaf, 2048 = sharraxaad dheer. Dhig 0 haddii aad rabin xadayn (qiimaha caadiga ah ee bixiyaha wuu shaqeeyaa).';
$string['settings:profile_update_interval'] = 'Muddada cusbooneysiinta astaanta ardayga';
$string['settings:profile_update_interval_desc'] = 'Kadib tiradan farriimo oo ka timid ardayga koorso gudaheed, kaaliyaha wuxuu dhisaa (ama cusbooneysiiyaa) astaan waxbarasho oo soo koobta xoogga, daciifnimada, habka waxbarashada, iyo xiisaha. Astaantan waxaa lagu daraa amarka nidaamka si jawaabaha shakhsi ahaan loo habeeyo. Dhig 0 si aad u xidho. Caadiga: 10.';
$string['settings:enable_thinking'] = 'Fikir ballaadhan (kaliya Claude)';
$string['settings:enable_thinking_desc'] = 'Wuxuu furaa fikir la qabsiga ah moodallada Claude. Claude laftiisa ayaa go\'aansada goorta iyo inta uu ka fikirayo dhibaato ka hor inta uusan jawaabin. Wuxuu kordhiyaa saxnaanta su\'aalaha adag, laakiin wuxuu kordhiyaa isticmaalka tokens iyo raagitaanka. Waxa ku jira fikirka lama tuso ardayda. Bixiyayaasha kale way iska indhatiraan habaynta.';
$string['settings:rag_sources_heading'] = 'Ilaha waxa ku jira RAG';
$string['settings:rag_sources_heading_desc'] = 'Dooro noocyada waxa ku jira koorsada ee liis samaystaha RAG ka soo saaro qoraalka. Calaamadaha xaaladda ee <a href="{$a}">bogga maamulka RAG</a> waxay muujiyaan haddii soo saar kasta uu haysto waxa uu u baahan yahay si uu u shaqeeyo (tusaale qalabka pdftotext ama liiska ogolaanshaha Cloudflare).';
$string['settings:rag_extract_pdf'] = 'Liis samee faylalka PDF (mod_resource)';
$string['settings:rag_extract_pdf_desc'] = 'Wuxuu ka soo saaraa qoraal faylalka PDF ee la soo geliyay iyada oo la marsiinayo qalabka <code>pdftotext</code> (poppler). Waddada qalabka waa si toos ah loo helaa; tilmaam hoos haddii loo baahdo.';
$string['settings:rag_pdftotext_path'] = 'Waddada qalabka pdftotext';
$string['settings:rag_pdftotext_path_desc'] = 'U dhaaf madhan si si toos ah loo helo (waxaa la hubiyaa <code>/usr/bin/pdftotext</code>, <code>/usr/local/bin/pdftotext</code> iyo <code>which pdftotext</code>). Buuxi oo kaliya haddii rakibiddaadu meel kale ku taal.';
$string['settings:rag_extract_docx'] = 'Liis samee faylalka DOCX (mod_resource)';
$string['settings:rag_extract_docx_desc'] = 'Wuxuu ka soo saaraa qoraal dukumentiyada Word ee la soo geliyay iyada oo la adeegsanayo ZipArchive ee PHP. Wax ku tiirsanaan dibadda looma baahna.';
$string['settings:rag_extract_pptx'] = 'Liis samee faylalka PPTX (mod_resource)';
$string['settings:rag_extract_pptx_desc'] = 'Wuxuu ka soo saaraa qoraal bandhigyada casriga ah ee PowerPoint ee la soo geliyay iyada oo la adeegsanayo ZipArchive ee PHP. Wuxuu maraa XML-ka sliidhyada iyo qoraallada hadleyaha sida ay sliidhyada u kala horreeyaan; wax ku tiirsanaan dibadda looma baahna. Faylalka binary ee hore <code>.ppt</code> lama taageero — dib u kaydi bandhigyadaas sida <code>.pptx</code>.';
$string['settings:rag_extract_h5p'] = 'Liis samee waxa ku jira H5P (mod_h5p)';
$string['settings:rag_extract_h5p_desc'] = 'Wuxuu maraa JSON-ka waxa ku jira H5P wuxuuna liis sameeyaa dhammaan meelaha qoraal leh (su\'aalo, jawaabo, jawaab celin, sharraxaado). Xogta metadata ee noocyada waxa ku jira H5P way ballaadhan tahay; xaalado xudduud ah waxaa laga yaabaa in la arko is barbar dhig qaldan oo yar.';
$string['settings:rag_extract_scorm'] = 'Liis samee xirmooyinka SCORM (mod_scorm)';
$string['settings:rag_extract_scorm_desc'] = 'Wuxuu furaa xirmooyinka SCORM wuxuuna liis sameeyaa <code>imsmanifest.xml</code>, dhammaan faylalka <code>.html</code>, iyo xargaha waxa ku jira Articulate Storyline. <strong>Waa la xidhay si caadi ah</strong>, sababtoo ah habaynta SCORM way qaali noqon kartaa. Cabbirka xirmada ugu badan waxaa go\'aamiya <code>rag_scorm_max_mb</code>.';
$string['settings:rag_scorm_max_mb'] = 'Cabbirka xirmada SCORM ugu badan ee liis loo sameeyo (MB)';
$string['settings:rag_scorm_max_mb_desc'] = 'Wuxuu ka boodaa xirmooyinka SCORM ee ka waaweyn qiimahan si looga fogaado isticmaalka xad dhaaf ah ee xasuusta.';
$string['settings:rag_fetch_transcripts'] = 'Soo qaado qoraallada hadalka ee muuqaalada iyo waxa ku jira is dhexgalka ah ee lagu dhex geliyay';
$string['settings:rag_fetch_transcripts_desc'] = 'Wuxuu baaraa waxa ku jira mod_page iyo mod_book si uu u helo iframe la dhex geliyay (Synthesia, YouTube, Articulate, Genially) ka dibna wuxuu soo qaataa cinwaanka qoraalka hadalka ee la socda dhex gelin kasta (wuxuu raadiyaa kor iyo hoos ka sawirka). Waxay u baahan tahay xidhiidh HTTPS oo baxaya oo ka socda server-kan una socda martigeliyaha qoraallada. <strong>Waa la xidhay si caadi ah</strong>; fur kadib marka bixiyaha qoraallada uu server-kan ku daro liiskiisa ogolaanshaha (tusaale iyada oo la marsiinayo xeer Cloudflare oo ku salaysan IP).';
$string['settings:rag_iframe_host_patterns'] = 'Qaababka martigeliyayaasha iframe';
...
$string['settings:max_content_per_resource_desc'] = 'Tirada xarfaha ugu badan ee waxa ku jira laga soo saaro bog kasta ama cutub buug. Qiimayaasha hooseeya waxay yareeyaan cabbirka amarka waxayna dedejiyaan jawaabaha.';
$string['settings:max_total_content'] = 'Wadarta waxa ku jira ugu badan (xarfo)';
$string['settings:max_total_content_desc'] = 'Wadarta xarfaha ugu badan ee waxa ku jira koorsada lagu daro amarka nidaamka. Qiimayaasha hooseeya waxay yareeyaan cabbirka amarka waxayna dedejiyaan jawaabaha.';
$string['settings:spend_guard_heading'] = 'Ilaalinta kharashka iyo hagaajiyaha';
$string['settings:spend_guard_heading_desc'] = 'Dhig xadad kharash LLM muddo kasta. Marka xadka la gaaro, [[tutorshort]] waxay hakisaa codsiyada ama waxay u wareejisaa bixiye ka jaban oo silsiladda beddelkaaga. Eeg <a href="{$a}">bogga kharashka tokens</a> si aad u ogaato xaaladda hadda ee kharashka iyo talooyinka hagaajiyaha.';
$string['settings:spend_cap_period'] = 'Muddada xadka kharashka';
$string['settings:spend_cap_period_desc'] = 'Inta jeer ee xadka kharashka dib loo dejiyo. Wuxuu la jaan qaadaa kalandarka: bishii wuxuu bilaabmaa maalinta 1aad, toddobaadkii Isniinta, maalintiina saqda dhexe.';
$string['settings:spend_cap_site'] = 'Xadka kharashka goobta oo dhan (USD)';
$string['settings:spend_cap_site_desc'] = 'Xad isku dhafan oo USD ah dhammaan koorsooyinka iyo awoodaha muddada hadda. <code>0</code> = xadaysan. Xadadka awood kasta ee hoose waa mudnaanta leh marka la dejiyo.';
$string['settings:spend_cap_chat'] = 'Xadka wada sheekaysiga (USD)';
$string['settings:spend_cap_chat_desc'] = 'Xad wada sheekaysiga iyo imtixaannada ardayda oo kaliya. <code>0</code> = xadka goobta oo dhan waa la isticmaalaa.';
$string['settings:spend_cap_voice'] = 'Xadka codka (USD)';
$string['settings:spend_cap_voice_desc'] = 'Xad codka (Realtime + TTS + STT). Codka caadi ahaan waa kharashka ugu weyn — xadid marka hore.';
$string['settings:spend_cap_rag'] = 'Xadka RAG (USD)';
$string['settings:spend_cap_rag_desc'] = 'Xad wicitaannada embedding ee dhaca inta liiska koorsooyinka la sameeyo.';
$string['settings:spend_cap_analytics'] = 'Xadka falanqaynta (USD)';
$string['settings:spend_cap_analytics_desc'] = 'Xad su\'aalaha Learning Radar ee maamulayaasha.';
$string['settings:spend_failover_chain'] = 'Silsiladda beddelka';
$string['settings:spend_failover_chain_desc'] = 'Marka xadka la gaaro, [[tutorshort]] waxay isku daydaa bixiyayaashan siday u kala horreeyaan. Hal gelin sadar kasta, qaabka <code>capability:label</code>. Calaamadaha waxay tilmaamayaan gelinta ku jirta Bixiyayaasha isbarbardhigga (loogu talagalay <code>chat</code> / <code>analytics</code>) ama Bixiyayaasha codka (loogu talagalay <code>voice</code>). Sadarrada ku bilaabmaya <code>#</code> waa faallo. Tusaale:<br><code>chat:claude-haiku<br>chat:ollama-local<br>voice:openai-prod<br>analytics:deepseek</code>';
$string['settings:failover_per_call_enabled'] = 'U wareejinta beddelka wicitaan kasta (v5.5.0)';
$string['settings:failover_per_call_enabled_desc'] = 'Marka la furo, wicitaan kasta oo wada sheekaysi wuxuu bixiyaha koowaad ku duubaa qaab silsiladda beddelka. Haddii wicitaan waqti dhammaado ama qalad 5xx dhaco, [[tutorshort]] waxay u wareejisaa gelinta xigta ee <strong>silsiladda beddelka</strong> ee kor ku xusan waxayna furtaa wareeg 15 daqiiqo ah bixiyaha guuldaraystay. Wareejin kasta waxay qortaa sadar hubin (<code>failover_fallthrough</code>); kadib marka la furo, eeg Maamulka -> [[tutorshort]] -> Diiwaanka hubinta si aad u xaqiijiso in silsiladda shaqaynayso. Waa la xidhay si caadi ah; fur oo kaliya kadib marka silsiladda la xaqiijiyo iyo marka machadkaagu xaqiijiyo in heshiisyada habaynta xogta lagama maarmaanka ah jiraan bixiye kasta oo silsiladda ku jira.';
$string['settings:failover_timeout_chat'] = 'Beddelka: waqtiga sugitaanka wada sheekaysiga (ilbiriqsiyo)';
$string['settings:failover_timeout_chat_desc'] = 'Inta muddo la sugayo tokenka ugu horreeya oo ka yimaada bixiye wada sheekaysi ka hor inta aan la wareejin. Caadiga waa 8 ilbiriqsi. Qiimayaasha hooseeya waxay degdeg uga tagaan bixiyayaasha gaabis ah, iyaga oo keenaya digniino been abuur ah oo badan codsiyada si ku meel gaar ah gaabis ah; qiimayaasha sarreeya waxay silsiladda ku hayaan bixiyaha koowaad muddo dheer. Waxaa la tixgeliyaa oo kaliya marka <strong>u wareejinta beddelka wicitaan kasta</strong> la furan yahay.';
$string['settings:spend_notify_emails'] = 'Kuwa hela digniinaha kharashka';
$string['settings:spend_notify_emails_desc'] = 'Cinwaannada iimaylka oo lagu kala saaray comma kuwaas oo la ogeysiin doono 80%, 95%, iyo 100% ee xadka. U dhaaf madhan si loo ogeysiiyo dhammaan maamulayaasha goobta.';
$string['settings:opt_cost_weight'] = 'Hagaajiye: culayska kharashka';
$string['settings:opt_cost_weight_desc'] = 'Inta hagaajiyuhu tixgeliyo kharashka marka uu darajeeyo bixiyayaasha. 0.0 wuxuu iska indhatiraa kharashka, 1.0 wuxuu hagaajiyaa kharashka oo kaliya. Waxaa la miisaamaa isla culayska tayada.';
$string['settings:opt_quality_weight'] = 'Hagaajiye: culayska tayada';
$string['settings:opt_quality_weight_desc'] = 'Inta hagaajiyuhu tixgeliyo qanacsanaanta ardayga (saamiga qiimaynta wanaagsan) marka uu darajeeyo bixiyayaasha. 0.0 wuxuu iska indhatiraa tayada.';
$string['settings:inactivity_reminder_enabled'] = 'Xasuusinta firfircoonaan la\'aanta';
$string['settings:inactivity_reminder_enabled_desc'] = 'Waxay iimayl toddobaadle u dirtaa ardayda aan koorsadooda furin muddada maalmaha la dejiyay.';
$string['settings:inactivity_threshold_days'] = 'Xadka firfircoonaan la\'aanta (maalmo)';
$string['settings:inactivity_threshold_days_desc'] = 'Immisa maalmo oo firfircoonaan la\'aan ka hor inta aan iimayl xasuusin la dirin.';
$string['settings:voice_providers_heading'] = 'Bixiyayaasha codka (Realtime, TTS, STT)';
$string['settings:voice_providers_heading_desc'] = 'Habee hal bixiye ama in ka badan oo API cod ah. Habayntahan way madax banaan yihiin bixiyaha wada sheekaysiga ee kor ku xusan iyo bixiyaha embedding ee RAG — codka wuxuu leeyahay liiskiisa bixiyayaasha, sababtoo ah hadda kaliya OpenAI iyo xAI ayaa bixiya barxadaha Realtime ee ku salaysan WebSocket, TTS, iyo STT. Isticmaal liisaska hoose si aad u doorato bixiyaha diiwaangashan ee qaban doona awood kasta. Haddii aan sadar la qeexin, habdhaqanka hore ee hal fure ayaa shaqeeya (furaha API Realtime ee kor ku xusan ama furaha weyn ee OpenAI). Goob isticmaasha Together AI / Anthropic / DeepSeek / Gemini / Mistral wada sheekaysiga waa inay halkan habeeyso ugu yaraan hal sadar si codka u shaqeeyo.';
$string['settings:voice_active_realtime'] = 'Bixiyaha Realtime firfircoon';
$string['settings:voice_active_realtime_desc'] = 'Bixiyaha codka la habeeyay ee qaban doona kalfadhiyada wakiilka codka Realtime.';
$string['settings:voice_active_tts'] = 'Bixiyaha TTS firfircoon';
$string['settings:voice_active_tts_desc'] = 'Bixiyaha codka la habeeyay ee kor u akhrin doona jawaabaha AI.';
$string['settings:voice_active_stt'] = 'Bixiyaha STT firfircoon';
$string['settings:voice_active_stt_desc'] = 'Bixiyaha u beddeli doona hadalka ardayga qoraal. U dhaaf madhan si horta loo doorbido server-ka Whisper ee aad iska leedahay haddii hoos la habeeyay, kadibna sadarka koowaad ee bixiyayaasha codka ama furaha hore.';
$string['settings:stt_selfhosted_enabled'] = 'Fur qoraalka hadalka ee server-kaaga';
$string['settings:stt_selfhosted_enabled_desc'] = 'Wuxuu isticmaalaa server-ka Whisper ee aad iska leedahay ee hoose sida waddada hadalka loo beddelo qoraal ee gelinta codka iyo Soapbox. Waxay u baahan tahay cinwaan server oo hoose. Marka la xidho, qoraalka hadalka wuxuu ku noqdaa waddada martigelisan (OpenAI Whisper) ama waddada browser-ka, xataa haddii cinwaanka la dejiyay.';
$string['settings:stt_selfhosted_warm'] = 'Kululee marka duubista Soapbox bilaabato';
$string['settings:stt_selfhosted_warm_desc'] = 'Marka la furo, bilaabista duubista Soapbox waxay u dirtaa codsi "kululayn" fudud (inta suurtagal ah) server-kaaga qoraalka hadalka, si martigeliye yaraada ilaa eber (tusaale Cloud Run) uu heli karo waqti uu ku bilaabmo inta ardaygu wali duubayo — sidaas raagitaanka bilawga qabow wuu qarsoon yahay qoraalka hadalka ee socda marka la gudbinayo. Ma laha saameyn haddii cinwaanka server-kaaga aan kor lagu dejin. Waa la xidhay si caadi ah.';
$string['settings:voice_tab_enabled'] = 'Fur tabka Codka';
$string['settings:voice_tab_enabled_desc'] = 'Waxay muujisaa tabka Codka ee shareerka hoose ee socodsiinta. Marka la xidho, ardayda waxay arkaan oo kaliya tabbadaha Wada sheekaysiga iyo Qoraallada. Awoodaha codka (tababarka wada sheekaysiga, tababarka ku dhawaaqista) way weli gaadhi karaan iyada oo la marsiinayo bilowyada wada sheekaysiga haddii si gaar ah loo furay.';
$string['settings:soapbox_heading'] = 'Soapbox';
$string['settings:soapbox_heading_desc'] = 'Tababarka bandhig af ah: sida duubitaannada qoraal loogu beddelo iyo cabbirka lagu qiimeeyo. Fur Soapbox koorso kasta iyada oo la marsiinayo furaha Soapbox ee qaybta Barashada.';
$string['settings:soapbox_max_seconds'] = 'Dhererka duubista Soapbox ugu badan (ilbiriqsiyo)';
$string['settings:soapbox_max_seconds_desc'] = 'Xad sare buuxa oo dhererka duubista hawl kasta. Macallimiinta waxay dhigi karaan xad ka gaaban. Caadiga 720 (12 daqiiqo).';
$string['settings:soapbox_max_recordings'] = 'Duubitaannada Soapbox ugu badan arday kasta iyo hawl kasta';
$string['settings:soapbox_max_recordings_desc'] = 'Xad sare buuxa oo tirada duubitaannada arday karti u leeyahay hal hawl, iyada oo aan loo eegin habaynta isku daygyada hawl kasta. Caadiga 3.';
$string['settings:soapbox_retention_days'] = 'Muddada kaydinta duubitaannada Soapbox (maalmo)';
$string['settings:soapbox_retention_days_desc'] = 'Inta muddo duubitaan lagu hayo ka hor inta aan si toos ah la tirtirin; qoraalka hadalka, dhibcaha, iyo jawaab celinta way sii jiraan. Waxaa lagu xadidaa 1–28 maalmood. Inta ka gaaban way ka fiican tahay yareynta xogta. Caadiga 7.';
$string['settings:soapbox_video_quality'] = 'Tayada muuqaalka Soapbox';
$string['settings:soapbox_video_quality_desc'] = 'Sharraxa iyo heerka bitka duubista. Kani waa sababta ugu weyn ee kharashka iyo baaxadda xidhiidhka; hadleyaha lagu qaaday muuqaal dhexdhexaad ah wuu si cad u muuqdaa xataa tayada caadiga ah. Tayada hooseeya waxay ku habboon tahay xidhiidhada daciifka ah; tayada sarreeya oo kaliya marka faahfaahinta muuqaalka ay muhiim tahay.';
$string['settings:soapbox_storage_bucket'] = 'Baaquliga kaydinta Soapbox';
$string['settings:soapbox_storage_bucket_desc'] = 'Baaquliga S3 ee duubitaannada. Caadiga: baaquliga kaydka la wadaago.';
$string['settings:soapbox_storage_region'] = 'Gobolka kaydinta Soapbox';
$string['settings:soapbox_storage_region_desc'] = 'Gobolka AWS ee baaquliga, tusaale us-east-1.';
$string['settings:soapbox_storage_prefix'] = 'Hordhaca furayaasha kaydinta Soapbox';
$string['settings:soapbox_storage_prefix_desc'] = 'Hordhaca furayaasha gudaha baaquliga. Duubitaannada waxaa lagu kaydiyaa waddadan hoosteeda, si xeer wareegga nolosha uu ku bartilmaameedsan karo.';
$string['settings:soapbox_storage_key'] = 'ID furaha gelitaanka kaydinta Soapbox';
$string['settings:soapbox_storage_key_desc'] = 'ID furaha gelitaanka qof IAM ah oo lagu xadiday PutObject/GetObject/DeleteObject hordhaca kor ku xusan.';
$string['settings:soapbox_storage_secret'] = 'Furaha gelitaanka qarsoon ee kaydinta Soapbox';
$string['settings:soapbox_storage_secret_desc'] = 'Furaha gelitaanka qarsoon oo u dhigma ID furaha gelitaanka kor ku xusan.';
$string['settings:survey_heading'] = 'Sahanka ardayda';
$string['settings:survey_heading_desc'] = 'Habee sahanka waaya aragnimada ardayga ee gudaha wada sheekaysiga. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Wax ka beddel su\'aalaha sahanka &rarr;</a>';
$string['settings:survey_enabled'] = 'Fur sahannada';
$string['settings:survey_enabled_desc'] = 'Marka la furo, ardayda waxaa laga codsan doonaa inay buuxiyaan sahan ku saabsan waaya aragnimadooda macallinka AI.';
$string['settings:survey_trigger_messages'] = 'Muuji kadib N farriimo';
$string['settings:survey_trigger_messages_desc'] = 'Waxay muujisaa casuumadda sahanka kadib marka ardaygu diro tiradan farriimo koorso gudaheed. Dhig 0 si loo muujiyo oo kaliya marka gacanta lagu bilaabo.';
$string['settings:survey_frequency'] = 'Inta jeer sahanka isticmaale kasta';
$string['settings:survey_frequency_desc'] = 'Inta jeer arday lagu casuumi karo inuu buuxiyo sahanka koorso kasta.';
$string['settings:rubric_heading'] = 'Cabbirrada tababarka';
$string['settings:rubric_heading_desc'] = 'Habee cabbirrada dhibco bixinta ee kalfadhiyada tababarka wada sheekaysiga iyo ku dhawaaqista. Dhamaadka kalfadhi tababar, ardayda waxay helaan dhibco iyo jawaab celin AI abuurtay. <a href="{$a}" class="btn btn-sm btn-outline-primary ml-2">Wax ka beddel cabbirrada &rarr;</a>';
$string['settings:practice_scoring_enabled'] = 'Fur dhibco bixinta tababarka';
$string['settings:practice_scoring_enabled_desc'] = 'Marka la furo, kadib kalfadhiyada tababarka wada sheekaysiga iyo ku dhawaaqista ardayda waxay helaan kaadh dhibco leh qiimayn cabbir kasta iyo jawaab celin.';
$string['settings:usertesting_heading'] = 'Tijaabinta isticmaalka fudud';
$string['settings:usertesting_heading_desc'] = 'Tijaabinta isticmaalka fudud oo gudaha widget-ka leh qiimayn ku salaysan hawlaha. Ardayda waxay dhammaystiraan hawlo kaaliyaha waxayna qiimeeyaan waaya aragnimadooda. Natiijooyinka waxay ka muuqdaan dashboard-ka falanqaynta.';
$string['settings:usertesting_enabled'] = 'Fur tijaabinta isticmaalka fudud';
$string['settings:usertesting_enabled_desc'] = 'Waxay muujisaa xiriirinta "Tijaabinta isticmaalka fudud" hoosta widget-ka. Marka la furo, ardayda waxay gaari karaan hawlaha tijaabinta.';
$string['settings:usertesting_external_url'] = 'Cinwaanka foomka dibadda (nooca C)';
$string['settings:usertesting_external_url_desc'] = 'Ikhtiyaari: cinwaanka foom dibadda ah (tusaale Google Forms ama Typeform). Isticmaal calaamadahan meel qabashada: {{userid}}, {{courseid}}, {{messages}}, {{session_minutes}}. Haddii la dejiyo, gujista "Tijaabinta isticmaalka fudud" waxay furtaa cinwaankan iyada oo macnaha guud la buuxiyay. U dhaaf madhan si loo isticmaalo oo kaliya guddiga tijaabinta ee gudaha widget-ka.';
$string['settings:footer_links_heading'] = 'Xiriirinta hoose';
$string['settings:footer_links_heading_desc'] = 'Habee xiriirinta ka muuqata hoosta kaaliyaha: xiriirin ikhtiyaari ah oo liiska koorsooyinka hoosta xiriirinta jawaab celinta, iyo ereyada xiriirinta jawaab celinta iyo guddigeeda.';
$string['settings:footer_courses_text'] = 'Qoraalka xiriirinta koorsooyinka';
$string['settings:footer_courses_text_desc'] = 'Qoraalka xiriirinta ka muuqata hoosta xiriirinta jawaab celinta. U dhaaf madhan si aad gebi ahaanba u qariso xiriirinta.';
$string['settings:footer_courses_url'] = 'Cinwaanka xiriirinta koorsooyinka';
$string['settings:footer_courses_url_desc'] = 'Meesha xiriirinta koorsooyinka aadayso (waxay ku furmaysaa tab cusub). Xiriirinta waa la qariyaa haddii meeshan madhan tahay.';
$string['settings:feedback_link_label'] = 'Calaamadda xiriirinta jawaab celinta';
$string['settings:feedback_link_label_desc'] = 'Waxay beddeshaa qoraalka xiriirinta jawaab celinta ee hoose, tusaale "U dir fikradaha ku saabsan [[tutorshort]] kooxda IT". U dhaaf madhan si loo isticmaalo calaamadda caadiga ah ee la turjumay "Jawaab celin".';
$string['settings:feedback_panel_intro'] = 'Hordhaca guddiga jawaab celinta';
$string['settings:feedback_panel_intro_desc'] = 'Sadarka hordhaca ka muuqda korka guddiga jawaab celinta. Wuxuu caddeeyaa halka fikradaha tagayaan. U dhaaf madhan si aan sadar hordhac ah la muujin.';
$string['settings:quiz_provider'] = 'Bixiyaha kaaliyaha imtixaanka';
$string['settings:quiz_provider_desc'] = 'ID bixiyaha (tusaale <code>claude</code> ama <code>openai</code>) ee abuurista imtixaannada. Waa inuu la mid noqdaa hal sadar oo Bixiyayaasha isbarbardhigga. U dhaaf madhan si loo isticmaalo bixiyaha wada sheekaysiga.';
$string['settings:quiz_model'] = 'Moodalka kaaliyaha imtixaanka';
$string['settings:quiz_model_desc'] = 'Magaca moodalka abuurista imtixaannada, tusaale <code>claude-haiku-4-5</code>. Labadan meel iyo bixiyaha waa in la buuxiyaa si beddelku u shaqeeyo.';
$string['settings:branding_heading'] = 'Astaanta ganacsiga';
$string['settings:branding_heading_desc'] = 'Habee magaca iyo muuqaalka kaaliyaha.';
$string['settings:institution_short_name'] = 'Magaca gaaban ee machadka';
$string['settings:institution_short_name_desc'] = 'Magaca soo gaabinta machadka ee walxaha interface-ka leh meel yar (tusaale "State U").';
$string['settings:display_name'] = 'Magaca la muujiyo ee kaaliyaha';
$string['settings:display_name_desc'] = 'Magaca buuxa ee kaaliyaha AI, sida uu ka muuqdo salaanta iyo shaashadda soo dhaweynta (tusaale "Kaaliyaha Waxbarashada Onlaynka").';
$string['settings:short_name'] = 'Magaca gaaban ee kaaliyaha';
$string['settings:short_name_desc'] = 'Magaca gaaban ee lagu isticmaalo shareerka cinwaanka iyo walxaha interface-ka leh meel yar (tusaale "Kaaliye").';
$string['settings:welcome_message'] = 'Farriinta shaashadda soo dhaweynta';
$string['settings:welcome_message_desc'] = 'Farriinta ka muuqata shaashadda soo dhaweynta booqashada koowaad. Isticmaal <code>{{firstname}}</code> magaca ardayga iyo <code>{{coursename}}</code> magaca koorsada. U dhaaf madhan si qoraalka caadiga ah loo isticmaalo.';
$string['settings:chat_greeting'] = 'Salaanta wada sheekaysiga';
$string['settings:chat_greeting_desc'] = 'Farriinta salaanta ka muuqata marka daaqadda wada sheekaysiga la furo. Isticmaal <code>{{firstname}}</code> magaca ardayga iyo <code>{{coursename}}</code> magaca koorsada. U dhaaf madhan si qoraalka caadiga ah loo isticmaalo.';
$string['settings:customavatars'] = 'Sawirro shakhsi ah';
$string['settings:customavatars_desc'] = 'Halkan soo geli sawirro PNG ama SVG afargeesle ah si aad ku darto liiska sawirrada kor ku xusan. Fayl kasta la soo geliyay wuxuu noqdaa dooro caadi ah oo la dooran karo (leh hordhac "Custom:"). Tirtir fayl liiskan si aad uga saarto liiska soo baxa. Talo: PNG 256×256 wuu si cad u muuqdaa shaashadaha Retina.';
$string['settings:anomaly_digest_heading'] = 'Learning Radar — soo koobidda waxyaabaha aan caadi ahayn';
$string['settings:anomaly_digest_heading_desc'] = 'Hubin maalinle ah oo isbarbar dhigta muddooyin socda oo qiimayn xun, kharash tokens, iyo calaamadaha daacadnimada. Marka tilmaame ka gudbo xadka la dejiyay, soo koobid waxaa loo diraa kanaallada la habeeyay. Warbixinnada la qorsheeyay su\'aal kasta, isticmaal guddiga Jadwallada ee bogga falanqaynta [[tutorshort]].';
$string['settings:anomaly_digest_enabled'] = 'Fur soo koobidda waxyaabaha aan caadi ahayn';
$string['settings:anomaly_digest_enabled_desc'] = 'Waxay socodsiisaa hawsha maalinlaha ah ee soo koobidda waxyaabaha aan caadi ahayn. Aamusan si caadi ah — waxay shaqaysaa oo kaliya marka tilmaame ka gudbo xadka.';
$string['settings:anomaly_digest_threshold_pct'] = 'Xadka digniinta (%)';
$string['settings:anomaly_digest_threshold_pct_desc'] = 'Isbeddelka boqolkiiba inta u dhaxaysa muddada dhawaan iyo tii ka horreysay ee keenta digniin. Caadiga: 50.';
$string['settings:anomaly_digest_recipient_email'] = 'Cinwaanka iimaylka qofka helaya';
$string['settings:anomaly_digest_recipient_email_desc'] = 'Cinwaanka iimaylka helaya soo koobidda waxyaabaha aan caadi ahayn. U dhaaf madhan si loo isticmaalo cinwaanka maamulaha goobta.';
$string['settings:anomaly_digest_slack_webhook'] = 'Cinwaanka webhook-ga soo gelaya ee Slack';
...
$string['privacy:metadata:outreach_log:dryrun'] = 'In safka lagu qoray hab tijaabo ah (dry-run) — iimayl dhab ah lama dirin.';
$string['flashcards:starter_saved'] = 'Waxaa boggan laga keydiyay {$a} kaadh xusuus.';
$string['flashcards:starter_open_review'] = 'Fur bogga dib-u-eegista si aad ugu barato ku celcelin kala fogaysan.';
$string['flashcards:starter_failed'] = 'Boggan kama aanan samayn karin kaararka xusuusta ({$a}). Isku day mar kale ama dooro bog nuxur badan leh.';
$string['flashcards:starter_error'] = 'Hadda boggan kama samayn karo kaararka xusuusta. Isku day mar dambe.';
$string['soapbox:no_media_support'] = 'Browserkani halkan cod kuma duubi karo. Isticmaal Chrome, Edge, Firefox ama Safari cusub adigoo adeegsanaya xiriir ammaan ah (https).';
