...
$string['settings:backend_retry_max_wait_desc'] = 'Had atas, dalam saat, berapa lama untuk mematuhi pengepala Retry-After daripada backend sebelum mencuba semula. Apabila backend tidak menghantar Retry-After, SOLA menggunakan backoff eksponen pendek sebaliknya. Lalai 5.';
...
$string['settings:zendesk_require_consent_desc'] = 'Apabila dihidupkan (disyorkan), SOLA meningkatkan perbualan ke meja sokongan Zendesk hanya selepas pelajar menerima notis kebenaran larian pertama, yang mendedahkan bahawa meminta bantuan manusia berkongsi perbualan (termasuk nama dan e-mel) dengan sokongan. Matikan ini hanya jika anda memperoleh kebenaran itu dengan cara lain; dengan ia dimatikan, peningkatan dihantar serta-merta. Tiada kesan melainkan peningkatan Zendesk didayakan.';
...
$string['emergency:title'] = 'Kawalan Kecemasan SOLA';
$string['emergency:page_warning'] = 'Suis-suis ini berkuat kuasa serta-merta untuk setiap pelajar di laman. Setiap tindakan menulis baris audit. Suis berbutir meninggalkan selebihnya SOLA berjalan; bunuh induk mengalih keluar widget sepenuhnya.';
$string['emergency:back_to_settings'] = 'Tetapan SOLA';
...
$string['emergency:flag_chat_desc'] = 'Menyekat trafik sembang melalui bendera bunuh khusus (pembetulan v5.13). Widget terus dirender; pelajar melihat mesej "SOLA dijeda" yang mesra. Gunakan apabila penyedia LLM berkelakuan buruk atau lonjakan kos sedang berlangsung.';
...
$string['emergency:flag_all_desc'] = 'Melumpuhkan keseluruhan plugin: widget hilang dari setiap halaman, tugas berjadual berhenti, suara dikosongkan, RAG dimatikan, jangkauan dimatikan. Suis yang paling kuat — gunakan untuk insiden keselamatan atau apabila SOLA mesti diambil luar talian dengan serta-merta.';
$string['emergency:settings_link'] = 'Kawalan kecemasan';
$string['emergency:settings_link_desc'] = 'Suis bunuh setiap subsistem (sembang / suara / RAG / jangkauan / induk) dengan log audit — setara web <code>admin/cli/emergency_disable.php</code>. Buka <a href="{$a}">Kawalan Kecemasan SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Berjaya berhenti melanggan';
$string['email_unsubscribe:done_body'] = 'Selesai — {$a->email} tidak akan lagi menerima jenis e-mel ini daripada {$a->product}. Jika anda berfikir semula, minta pentadbir {$a->product} untuk mendayakan semula langganan, atau hantar pilihan masuk baharu melalui halaman pentadbir Penerima SOLA.';
...
$string['analytics:exp_active_users'] = 'Pengguna SOLA aktif';
