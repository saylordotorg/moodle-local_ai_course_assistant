...
$string['settings:rerank_candidates_desc'] = 'Kung ilang cosine top-N kandidato ang magpapakain sa rerank stage. Default na 50. Ang mas malalaking window ay nagbibigay ng mas maraming materyal sa reranker na pagtrabahuhin sa maliit na dagdag na gastos (humigit-kumulang 10k token bawat rerank op).';
