...
$string['settings:backend_retry_max_wait_desc'] = 'Ang pinakamataas na hangganan, sa mga segundo, kung gaano katagal igagalang ang isang Retry-After header mula sa backend bago mag-retry. Kapag hindi nagpadala ng Retry-After ang backend, gumagamit ang SOLA ng maikling exponential backoff sa halip. Default na 5.';
...
$string['settings:stt_selfhosted_heading_desc'] = 'Patakbuhin ang speech-to-text sa sarili mong hardware nang walang gastos bawat minuto. Ituro ang SOLA sa anumang OpenAI-compatible na transcription server: <code>whisper-server</code> Docker, <code>speaches</code> (faster-whisper), o <code>whisper.cpp</code> server. Kapag nagtakda ng server URL dito, ito ang magiging default na STT path; pumili ng bayad na provider sa Active STT provider sa itaas upang i-override. Kung ang server ay nasa isang pribadong network o plain http, idagdag din ang host nito sa SSRF trusted endpoints allowlist sa seksyon ng Seguridad.';
$string['settings:stt_selfhosted_url'] = 'Selfhosted STT server URL';
$string['settings:stt_selfhosted_url_desc'] = 'Base URL ng OpenAI-compatible na transcription server, halimbawa <code>http://10.0.0.5:8000</code>. Awtomatikong idinaragdag ng SOLA ang <code>/v1/audio/transcriptions</code>; tinatanggap din ang buong endpoint path. Iwanang blangko upang i-disable ang selfhosted STT.';
...
$string['emergency:page_warning'] = 'Ang mga switch na ito ay magkakabisa kaagad para sa bawat mag-aaral sa site. Ang bawat aksyon ay nagsusulat ng isang audit row. Ang mga granular na switch ay pinapanatiling tumatakbo ang natitirang SOLA; tinatanggal ng master kill ang widget nang buo.';
...
$string['emergency:flag_chat_desc'] = 'Hina-hadlangan ang trapiko ng chat sa pamamagitan ng dedikadong kill flag (ayos sa v5.13). Patuloy na nire-render ang widget; nakikita ng mga mag-aaral ang friendly na mensaheng "SOLA naka-pause". Gamitin kapag ang isang LLM provider ay nagkakaproblema o may nagaganap na cost spike.';
...
$string['emergency:flag_all_desc'] = 'Dina-disable ang buong plugin: wala nang widget sa bawat pahina, tumitigil ang mga naka-iskedyul na gawain, nali-clear ang boses, naka-off ang RAG, naka-off ang outreach. Ang pinakamalakas na switch — gamitin para sa isang insidente sa seguridad o kapag kailangang dalhin ang SOLA offline kaagad.';
$string['emergency:settings_link'] = 'Mga emergency control';
$string['emergency:settings_link_desc'] = 'Mga per-subsystem na kill switch (chat / boses / RAG / outreach / master) na may audit logging — ang web equivalent ng <code>admin/cli/emergency_disable.php</code>. Buksan ang <a href="{$a}">SOLA Emergency Controls</a>.';
$string['email_unsubscribe:done_title'] = 'Na-unsubscribe';
$string['email_unsubscribe:done_body'] = 'Tapos na — hindi na makakatanggap ang {$a->email} ng ganitong uri ng email mula sa {$a->product}. Kung magbabago ang isip mo, hilingin sa isang administrator ng {$a->product} na muling i-enable ang subscription, o magpadala ng bagong opt-in sa pamamagitan ng pahina ng SOLA Recipients admin.';
...
$string['analytics:exp_active_users'] = 'Mga aktibong gumagamit ng SOLA';
