...
$string['settings:rerank_candidates_desc'] = 'Сколько косинусных кандидатов top-N подаётся на этап ре-ранкинга. По умолчанию 50. Большие окна дают ре-ранкеру больше материала при незначительных дополнительных затратах (~10k токенов на операцию ре-ранкинга).';
