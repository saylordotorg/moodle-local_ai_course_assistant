...
$string['settings:backend_retry_max_wait_desc'] = 'Kikomo cha juu, kwa sekunde, cha muda wa kuheshimu kichwa cha Retry-After kutoka backend kabla ya kurudia. Wakati backend haitumi Retry-After, SOLA hutumia badala yake urudishaji wa kielelezo wa muda mfupi. Chaguo-msingi 5.';
...
$string['settings:zendesk_require_consent_desc'] = 'Inapowashwa (inapendekezwa), SOLA hupandisha mazungumzo kwa dawati la usaidizi la Zendesk tu baada ya mwanafunzi kukubali notisi ya idhini ya mara ya kwanza, ambayo hueleza kwamba kuomba msaada wa binadamu hushiriki mazungumzo (ikiwa ni pamoja na jina na barua pepe) na usaidizi. Zima hii tu ikiwa unapata idhini hiyo kwa njia nyingine; ikiwa imezimwa, kupandisha hutumwa mara moja. Haina athari isipokuwa kupandisha kwa Zendesk kumewashwa.';
...
$string['emergency:title'] = 'Udhibiti wa dharura wa SOLA';
$string['emergency:page_warning'] = 'Vifungo hivi vinaanza kutumika mara moja kwa kila mwanafunzi kwenye tovuti. Kila kitendo kinaandika safu ya ukaguzi. Vifungo vya kina vinaruhusu sehemu zilizobaki za SOLA kuendelea kufanya kazi; kuua master huondoa widget kabisa.';
$string['emergency:back_to_settings'] = 'Mipangilio ya SOLA';
...
$string['emergency:flag_chat_desc'] = 'Inazuia trafiki ya mazungumzo kupitia alama maalum ya kill (marekebisho v5.13). Widget inaendelea kuonyeshwa; wanafunzi wanaona ujumbe wa kirafiki "SOLA imesimamishwa". Tumia wakati mtoa huduma wa LLM anafanya vibaya au ongezeko la gharama linaendelea.';
...
$string['emergency:flag_all_desc'] = 'Inazima programu-jalizi nzima: widget hutoweka kwenye kila ukurasa, kazi zilizopangwa zinasimama, sauti inafutwa, RAG imezimwa, ufikiaji umezimwa. Kitufe chenye nguvu zaidi — tumia kwa ajili ya tukio la usalama au wakati SOLA lazima ichukuliwe nje ya mtandao mara moja.';
$string['emergency:settings_link'] = 'Udhibiti wa dharura';
$string['emergency:settings_link_desc'] = 'Vifungo vya kill kwa kila mfumo mdogo (mazungumzo / sauti / RAG / ufikiaji / master) na uandishi wa ukaguzi — sawa na wavuti wa <code>admin/cli/emergency_disable.php</code>. Fungua <a href="{$a}">Udhibiti wa dharura wa SOLA</a>.';
$string['email_unsubscribe:done_title'] = 'Umejisajili nje';
$string['email_unsubscribe:done_body'] = 'Imekamilika — {$a->email} haitapokea tena aina hii ya barua pepe kutoka {$a->product}. Ukibadilisha mawazo yako, omba msimamizi wa {$a->product} kuwezesha tena usajili, au tuma opt-in mpya kupitia ukurasa wa SOLA Recipients katika paneli ya usimamizi.';
...
$string['settings:cost_anomaly_heading_desc'] = 'Kazi iliyopangwa ya kila siku (<code>cost_anomaly_check</code>) inayolinganisha matumizi ya leo ya SOLA kwenye tovuti nzima dhidi ya wastani wa kugeuza wa siku 7. Inatuma barua pepe kwa orodha ya wapokeaji wa <code>spend_notify_emails</code> (ikirejea kwa wasimamizi wa tovuti) wakati leo inazidi kizidishi kilichosanidiwa × wastani. Inagundua hali tatu za kushindwa ambazo vizingiti vya 80% / 95% / 100% vya kikomo cha matumizi vilivyopo vinakosa: (1) kozi inayokimbia ambapo dari kamili haijapitwa lakini kozi moja ghafla inasababisha 10x ya kiasi chake cha kawaida, (2) uanzishaji wa bahati mbaya wa ngazi ya premium, (3) upitishaji mbaya wa mtoa huduma. Imezimwa kwa chaguo-msingi; sawa na ndani ya SOLA ya hoja ya Redash kwenye <code>.drafts/sola-redash-cost-anomaly-2026-06-09.md</code>.';
...
$string['analytics:exp_active_users'] = 'Watumiaji wa SOLA wanaofanya kazi';
