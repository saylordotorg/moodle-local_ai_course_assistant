...
$string['settings:prompt_budget_mode_desc'] = 'Jinsi bajeti ya herufi ya kidokezo cha mfumo inavyoamuliwa. <strong>Kokotoa kutoka kwa modeli</strong> hupima nafasi ambayo modeli iliyosanidiwa hutoa kwa kweli — dirisha lake la muktadha, ukiondoa jibu lililotengwa na historia ya mazungumzo — kisha hutumia kubwa kati ya hiyo na bajeti isiyobadilika hapa chini. Hii ndiyo mipangilio inayopendekezwa: namba isiyobadilika tayari imewekwa mara mbili kwa kupima usanidi mmoja tu, na mara zote mbili ilionekana ndogo mno kwenye usanidi mwingine. <strong>Isiyobadilika</strong> hutumia namba iliyo hapa chini pekee. Seva inayojiendesha yenyewe inapaswa badala yake kuweka dirisha la muktadha la seva, ambalo daima hupewa kipaumbele.';
