...
$string['emergency:title'] = 'SOLA 긴급 제어';
...
$string['emergency:back_to_settings'] = 'SOLA 설정';
...
$string['emergency:flag_chat_desc'] = '전용 킬 플래그(v5.13 수정)를 통해 채팅 트래픽을 차단합니다. 위젯은 계속 렌더링되며 학습자에게는 친절한 "SOLA 일시 중지" 메시지가 표시됩니다. LLM 제공자가 오작동하거나 비용 급증이 진행 중일 때 사용합니다.';
...
$string['emergency:settings_link_desc'] = '감사 로깅이 있는 하위 시스템별 킬 스위치(채팅 / 음성 / RAG / 아웃리치 / 마스터) — <code>admin/cli/emergency_disable.php</code>의 웹 버전. <a href="{$a}">SOLA 긴급 제어</a> 열기.';
$string['email_unsubscribe:done_title'] = '구독 취소 완료';
$string['email_unsubscribe:done_body'] = '완료 — {$a->email}은(는) 더 이상 {$a->product}에서 이 유형의 이메일을 받지 않습니다. 마음이 바뀌면 {$a->product} 관리자에게 구독을 다시 활성화해 달라고 요청하거나, SOLA 수신자 관리 페이지를 통해 새 옵트인을 보내십시오.';
...
$string['analytics:exp_active_users'] = '활성 SOLA 사용자';
